---
title: Dynamo Software의 Dynamo 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/09/2022
...
description: Dynamo에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://appsource.microsoft.com/product/office/WA200004007" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Dynamo Software에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | Dynamo Software |
| 회사 웹 사이트 | [https://www.dynamosoftware.com](https://www.dynamosoftware.com) |
| 앱의 사용 약관 | [https://www.dynamosoftware.com/End-User-Terms](https://www.dynamosoftware.com/End-User-Terms) |
| 앱의 핵심 기능 | dynamo&#8217;Outlook Office 추가 기능은 기존 Dynamo 사용자가 데스크톱 Outlook 애플리케이션을 통해 Windows 웹(Office 365 및 Outlook.com)에서 Outlook 통해 Dynamo와 함께 작업할 수 있도록 지원하는 프로그램입니다. Dynamo를 열지 않고 편지 병합 초안을 보내고, 약속 및 활동을 Dynamo에 첨부하고, 연락처, 회사, 거래 및 펀드 유형의 새 항목을 만들 수 있습니다.  |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://help.dynamosoftware.com/about-dynamo-web-add-in-for...](https://help.dynamosoftware.com/about-dynamo-web-add-in-for-outlook/) |
...
이 정보는 Dynamo Software에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 제공되었습니다.
...
| 가장 최근 SOC1 인증 날짜 | 2020-06-30 |
| 앱이 서비스 조직 컨트롤(SOC 2)을 준수하나요? | 예 |
| 어떤 SOC 2 인증을 달성했나요? | type2 |
| 가장 최근 SOC2 인증 날짜 | 2020-09-30 |
...
| 개인 정보 취급 방침 URL | https://www.dynamosoftware.com/privacy-policy/ |
...
| 앱은 개인에게 개인 데이터를 수정하거나 업데이트할 수 있는 기능을 제공하나요? | 아니오 |
| 앱의 개인 데이터 처리와 관련된 위험을 식별하기 위해 정기적인 데이터 보안 및 개인 정보 검토(예: 데이터 보호 영향 평가 또는 개인 정보 보호 위험 평가)를 수행합니까? | 아니오 |
