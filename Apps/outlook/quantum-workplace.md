...
| 회사의 웹 사이트 | [https://www.quantumworkplace.com](https://www.quantumworkplace.com) |
| 앱 사용 약관 | [https://www.quantumworkplace.com/terms-of-use](https://www.quantumworkplace.com/terms-of-use) |
| 앱의 핵심 기능 | 직원이 퀀텀 작업 공간 알림 및 알림을 통해 성공할 수 있도록 합니다. |
| 회사 본사 위치 | 미국 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsAppInstallation.ReadWriteSelfForUser.All | application | ChatId가 사용됩니다. | [be93046b-63ab-4216-9bcc-78faa55eeaa7](../azure/be93046b-63ab-4216-9bcc-78faa55eeaa7.md) |
>| User.Read.All | application | User.Id (저장) - 봇 끝점으로 보낸 사용자를 상관 관계에 두는 데 사용됩니다. User.UserPrincipalName(저장되지) - 현재 사용되지 않습니다. User.Mail(저장되지 않은) - 시스템의 사용자를 저장하는 AzureAD ID와 일치하도록 하는 데 사용됩니다. | [be93046b-63ab-4216-9bcc-78faa55eeaa7](../azure/be93046b-63ab-4216-9bcc-78faa55eeaa7.md) |
