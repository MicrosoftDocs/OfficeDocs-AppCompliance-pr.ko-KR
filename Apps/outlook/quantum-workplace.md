...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsAppInstallation.ReadWriteSelfForUser.All | application | ChatId가 사용됩니다. | [be93046b-63ab-4216-9bcc-78faa55eeaa7](https://docs.microsoft.com/microsoft-365-app-certification/azure/be93046b-63ab-4216-9bcc-78faa55eeaa7) |
>| User.Read.All | application | User.Id(저장) - 봇 끝점으로 보낸 사용자를 상관 관계화하는 데 사용됩니다. User.UserPrincipalName(저장되지) - 현재 사용되지 않습니다. User.Mail(저장되지 않은) - 시스템의 사용자를 저장하는 AzureAD ID와 일치하도록 하는 데 사용됩니다. | [be93046b-63ab-4216-9bcc-78faa55eeaa7](https://docs.microsoft.com/microsoft-365-app-certification/azure/be93046b-63ab-4216-9bcc-78faa55eeaa7) |
