---
title: Quantum Workplace by Quantum Workplace에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/25/2021
...
description: Quantum Workplace, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://appsource.microsoft.com/product/office/WA104381747" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Quantum Workplace에서 Microsoft에 제공하는 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | Quantum Workplace |
| ID | WA104381747 |
| 지원되는 Office 365 클라이언트 | Windows의 Outlook 2013 이상, Mac에서 Outlook 2016 이상, 웹용 Outlook |
| 파트너 회사 이름 | Quantum Workplace |
| 회사 웹 사이트 | [https://www.quantumworkplace.com](https://www.quantumworkplace.com) |
| 앱의 사용 약관 | [https://www.quantumworkplace.com/terms-of-use](https://www.quantumworkplace.com/terms-of-use) |
| 앱의 핵심 기능 | 직원들이 Quantum Workplace 경고 및 알림을 성공적으로 수행할 수 있도록 지원합니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://www.quantumworkplace.com/product/employee-engagemen...](https://www.quantumworkplace.com/product/employee-engagement-software) |
...
이 정보는 Quantum Workplace에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직의 제어에 대해 제공되었습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsAppInstallation.ReadWriteSelfForUser.All | 응용 프로그램 | ChatId가 사용됩니다. | [be93046b-63ab-4216-9bcc-78faa55eeaa7](../azure/be93046b-63ab-4216-9bcc-78faa55eeaa7.md) |
>| User.Read.All | 응용 프로그램 | User.Id(저장됨) - 봇 엔드포인트로 전송된 사용자의 상관 관계를 지정하는 데 사용됩니다. User.UserPrincipalName(저장되지 않음) - 현재 사용되지 않음; User.Mail(저장되지 않음) - 시스템의 사용자를 저장하는 AzureAD ID와 일치시키는 데 사용됩니다. | [be93046b-63ab-4216-9bcc-78faa55eeaa7](../azure/be93046b-63ab-4216-9bcc-78faa55eeaa7.md) |
