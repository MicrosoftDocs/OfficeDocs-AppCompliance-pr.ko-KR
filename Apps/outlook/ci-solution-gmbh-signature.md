---
title: ci 솔루션 GmbH별 CI-Signature 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/24/2021
...
description: CI 서명, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://appsource.microsoft.com/product/office/WA200002458" target="_blank">AppSource에서 보기</a>
...
| 앱의 핵심 기능 | CI-Sign 서버 쪽에서 생성된 Outlook 및 OWA에 표시되는 서명을 추가하고 CI-Disclaimer 서명이 회사 ID 요구 사항 및 법적으로 필요한 요구 사항을 충족하기 위해 서버 쪽에 추가되는 경우 미리 보기를 추가합니다.  |
| 회사 본사 위치 | 독일 |
| 앱 정보 페이지 | [https://www.ci-solution.com/support/de/](https://www.ci-solution.com/support/de/) |
