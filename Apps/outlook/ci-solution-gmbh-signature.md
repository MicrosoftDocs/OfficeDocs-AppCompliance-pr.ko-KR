---
title: ci 솔루션 gmbH의 CI-Signature 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/24/2021
...
| 회사의 웹 사이트 | [https://www.ci-solution.com](https://www.ci-solution.com) |
| 앱 사용 약관 | [https://www.ci-solution.com/agb](https://www.ci-solution.com/agb) |
| 앱의 핵심 기능 | Outlook 회사 ID 요구 사항 및 법적으로 필요한 요구 사항을 충족하기 위해 CI-Sign CI-Disclaimer 서버에 서명이 추가될 경우 CI-Sign 및 서버에서 생성된 OWA에 표시되는 서명을 추가합니다.  |
| 회사 본사 위치 | 독일 |
