...
| 앱의 핵심 기능 | 회사 ID 요구 사항 및 법적으로 필요한 요구 사항을 충족하기 위해 Outlook 서버에 서명이 추가될 경우 CI-Sign 및 서버에서 생성된 OWA에 표시되는 서명을 추가하고CI-Disclaimer 서명을 서버에 추가하는 경우 미리 보기를 추가합니다.  |
| 회사 본사 위치 | 독일 |
| 앱 정보 페이지 | |
