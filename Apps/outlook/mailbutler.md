---
title: Mailbutler의 Mailbutler에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/09/2021
...
description: Mailbutler, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보
...
ms.locfileid: "63540926"
---
# <a name="mailbutler"></a>Mailbutler

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2021년 11월 4일</p>

* <a href="https://appsource.microsoft.com/product/office/WA200001031" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Mailbutler에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | Mailbutler |
| 회사의 웹 사이트 | [https://www.mailbutler.io](https://www.mailbutler.io) |
| 앱 사용 약관 | [https://www.mailbutler.io/terms-and-conditions](https://www.mailbutler.io/terms-and-conditions) |
| 앱의 핵심 기능 | Mailbutler는 생산성을 최대화하고 전자 메일을 유지하는 데 필요한 모든 것을 제공하는 전자 메일 플러그 인입니다. Mailbutler는 받은 편지함에서 바로 액세스할 수 있는 유용한 생산성 향상 기능을 다수 제공합니다. 해당 기능은 고객 커뮤니케이션을 개선하고, 브랜드를 유지하며, 전자 메일 게임을 최적화하는 데 도움이 됩니다. |
| 회사 본사 위치 | 독일 |
| 앱 정보 페이지 | [https://www.mailbutler.io](https://www.mailbutler.io) |
...
이 정보는 Mailbutler에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직에서 제공하는 컨트롤에 대해 제공됩니다.
...
| 데이터베이스에 저장되는 데이터는 무엇입니까? | 전자 메일 ID, 전자 메일 메타데이터(제목, 보낸 사람/받는 사람, 고객이 승인하는 경우), 연락처 데이터(사용자가 가져온 경우) |
...
| 개인 정보 취급 방침 URL | https://www.mailbutler.io/privacy-policy-mailbutler/ |
