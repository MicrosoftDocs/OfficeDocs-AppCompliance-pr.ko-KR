---
title: 아웃리치별 Outlook 대한 아웃리치 판매 참여에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Outlook 대한 아웃리치 영업 참여, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
ms.locfileid: "64879475"
---
# <a name="outreach-sales-engagement-for-outlook"></a>Outlook 대한 아웃리치 판매 참여

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2021년 6월 14일</p>

* <a href="https://appsource.microsoft.com/product/office/WA104381052" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Microsoft에 대한 아웃리치에서 제공하는 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | Outlook 대한 아웃리치 판매 참여 |
| ID | WA104381052 |
| 지원되는 Office 365 클라이언트 | Outlook 2013 이상 mac에서 Windows, Outlook 2016 이상, 웹용 Outlook |
| 파트너 회사 이름 | 봉사 활동 |
| 회사 웹 사이트 | [https://www.outreach.io](https://www.outreach.io) |
| 앱의 사용 약관 | [https://www.outreach.io/terms](https://www.outreach.io/terms) |
| 앱의 핵심 기능 | 아웃리치는 기업이 생산성을 크게 높이고 고객과 더 스마트하고 통찰력 있는 참여를 유도하는 데 도움이 되는 가장 크고 빠르게 성장하는 판매 참여 플랫폼입니다. 영업 자동화에서 대화 인텔리전스, 구매자 감정 분석, 팀 성과 보고&#8212; 및 훨씬 더 많은&#8212; 아웃리치는 영업 담당자와 리더가 생산성을 높이고, 더 많은 판매 기회를 창출하고, 판매 목표를 달성하는 데 도움이 되는 통합 영업 참여 플랫폼입니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://www.outreach.io/product](https://www.outreach.io/product) |
| 앱을 실행하는 데 사용되는 호스팅 환경 또는 서비스 모델은 무엇인가요? |  |
| 앱에서 사용하는 호스팅 클라우드 공급자는 무엇인가요? | Azure, GCP, AWS |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대한 아웃리치에서 제공되었습니다.
