...
| 파트너 회사 이름 | 아웃리치 |
| 회사의 웹 사이트 | [https://www.outreach.io](https://www.outreach.io) |
| 앱 사용 약관 | [https://www.outreach.io/terms](https://www.outreach.io/terms) |
| 앱의 핵심 기능 | 아웃리치는 기업이 획기적으로 생산성을 높이고 고객과의 보다 똑똑하고 더 통찰력 있는 참여를 유도하는 데 도움이 되는 가장 크고 빠르게 성장하는 판매 참여 플랫폼입니다. 판매 자동화에서부터 대화 인텔리전스, 구매자 정서 분석, 팀 성과 보고&#8212; 등 훨씬 더 많은&#8212; Outreach는 영업 리더와 리더가 생산성을 높이고, 더 많은 판매 기회를 생성하고, 판매 목표를 달성하는 데 도움이 되는 통합 판매 참여 플랫폼입니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://www.outreach.io/product](https://www.outreach.io/product) |
| 앱을 실행하기 위해 사용되는 호스팅 환경 또는 서비스 모델은 무엇입니까? |  |
| 앱에서 어떤 호스팅 클라우드 공급자를 사용하나요? | Azure, GCP, AWS |
