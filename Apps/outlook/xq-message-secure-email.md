...
description: XQ 보안 전자 메일, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용할 수 있는 모든 보안 및 규정 준수 정보
...
| 파트너 회사 이름 | XQ 메시지 |
| 회사의 웹 사이트 | [https://xqmsg.co](https://xqmsg.co) |
| 앱 사용 약관 | [https://xqmsg.com/terms.html](https://xqmsg.com/terms.html) |
| 앱의 핵심 기능 | 전자 메일에서 파일로의 &#8212; 통신을 모두 보호합니다. |
| 회사 본사 위치 | 미국 |
