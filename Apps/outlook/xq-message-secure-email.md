---
title: XQ 메시지별 XQ 보안 전자 메일에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/10/2021
...
description: XQ Secure Email, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://appsource.microsoft.com/product/office/WA200000090" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Microsoft에 대한 XQ 메시지에서 제공하는 정보:
...
| 파트너 회사 이름 | XQ 메시지 |
| 회사 웹 사이트 | [https://xqmsg.co](https://xqmsg.co) |
| 앱의 사용 약관 | [https://xqmsg.com/terms.html](https://xqmsg.com/terms.html) |
| 앱의 핵심 기능 | 전자 메일에서 파일로 &#8212; 모든 통신을 보호합니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://xqmsg.co/about](https://xqmsg.co/about) |
...
이 정보는 XQ 메시지에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
