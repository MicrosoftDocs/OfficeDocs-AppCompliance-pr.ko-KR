---
title: 내 메일을 승격하여 내 메일을 승격하기 위한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/13/2022
...
description: 내 메일 향상, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
---
# <a name="boost-my-mail"></a>내 메일 승격

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 5월 5일</p>

* <a href="https://appsource.microsoft.com/product/office/WA200004085" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Microsoft에 내 메일을 승격하여 제공한 정보:
...
| 파트너 회사 이름 | 내 메일 승격 |
| 회사 웹 사이트 | [https://www.boostmymail.com/fr](https://www.boostmymail.com/fr) |
| 앱의 사용 약관 | [https://www.boostmymail.com/fr/conditions-dutilisations/](https://www.boostmymail.com/fr/conditions-dutilisations/) |
| 앱의 핵심 기능 | Outlook 아름다운 회사 전자 메일 서명을 중앙에서 관리 |
| 회사 본사 위치 | 프랑스 |
| 앱 정보 페이지 | |
...
이 정보는 Boost My Mail에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 제공되었습니다.
