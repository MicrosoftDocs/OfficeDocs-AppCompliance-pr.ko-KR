---
title: PexipAS의 Outlook 위한 Pexip One에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/29/2021
...
description: Pexip One for Outlook, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://appsource.microsoft.com/product/office/WA200003137" target="_blank">AppSource에서 보기</a>
...
| 파트너 회사 이름 | PexipAS |
| 회사 웹 사이트 | [https://www.pexip.com](https://www.pexip.com) |
| 앱의 사용 약관 | [https://www.pexip.com/terms](https://www.pexip.com/terms) |
| 앱의 핵심 기능 | Pexip One을 사용하면 사용자가 기존 모임 준비 워크플로를 사용하는 동안 보안 모임을 쉽게 만들 수 있습니다. Pexip One은 화면 공유, 음성 및 비디오 채팅 기능을 제공합니다. |
| 회사 본사 위치 | 노르웨이 |
| 앱 정보 페이지 | |
...
이 정보는 PexipAS에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | 위임 | 사용자를 위한 이벤트 데이터는 플랫폼에서 모임을 예약하고 모임 메타데이터의 변경 내용을 추적하는 데 사용됩니다. | [69609b5a-e416-4d72-b10b-8903e84780c3](../azure/69609b5a-e416-4d72-b10b-8903e84780c3.md) |
