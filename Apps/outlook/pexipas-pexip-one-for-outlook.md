---
title: PexipAS에서 사용할 수 있는 Pexip Outlook 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/29/2021
...
description: CSA STAR 레지스트리의 Outlook Pexip One, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용할 수 있는 모든 보안 및 규정 준수 정보
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | 위임 | 사용자에 대한 이벤트 데이터는 플랫폼에서 모임을 예약하고 모임 메타데이터에 대한 변경 내용을 추적하는 데 사용됩니다. | [69609b5a-e416-4d72-b10b-8903e84780c3](../azure/69609b5a-e416-4d72-b10b-8903e84780c3.md) |
