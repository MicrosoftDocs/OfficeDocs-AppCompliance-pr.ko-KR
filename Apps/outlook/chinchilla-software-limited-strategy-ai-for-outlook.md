---
title: Chinchilla Software Limited의 Outlook 전략 AI에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/14/2021
...
description: CSA STAR 레지스트리의 Outlook 전략-AI, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
ms.locfileid: "63544636"
---
# <a name="strategy-ai-for-outlook"></a>전략 AI for Outlook

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2021년 12월 1일</p>

* <a href="https://appsource.microsoft.com/product/office/WA200003576" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Chinchilla Software Limited에서 Microsoft로 제공되는 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | 전략 AI for Outlook |
| ID | WA200003576 |
| Office 365 클라이언트 지원 | Outlook 2013 이상은 Mac, Windows Outlook 2016 이상에서 웹용 Outlook |
| 파트너 회사 이름 | Chinchilla Software Limited |
| 회사의 웹 사이트 | [https://www.strategy-ai.com](https://www.strategy-ai.com) |
| 앱 사용 약관 | [https://www.strategy-ai.com/terms](https://www.strategy-ai.com/terms) |
| 앱의 핵심 기능 | 일관되고 교차 비즈니스, 플랫폼 간 데이터 기여 제공 |
| 회사 본사 위치 | 뉴질랜드 |
| 앱 정보 페이지 | |
...
이 정보는 Chinchilla Software Limited에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직이 사용할 컨트롤에 대해 제공됩니다.
...
| 개인 정보 취급 방침 URL | https://www.strategy-ai.com/privacy |
