---
title: Adobe Inc.의 Outlook 대한 Adobe Sign Add-In 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/23/2022
...
description: Outlook, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 대한 Adobe Sign Add-In 사용 가능한 모든 보안 및 규정 준수 정보입니다.
