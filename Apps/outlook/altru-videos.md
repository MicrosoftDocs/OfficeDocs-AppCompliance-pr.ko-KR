...
description: Altru Videos에 대한 사용 가능한 모든 보안 및 규정 준수 정보 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보.
...
---
# <a name="altru-videos"></a>이트루 동영상

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>최종 업데이트: 2021년 2월 27일</p>

* <a href="https://appsource.microsoft.com/product/office/WA200000026" target="_blank">앱소스에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

알트루에서 마이크로소프트에 제공한 정보:
...
| 파트너 회사 이름 | 이트루 |
| 파트너 웹사이트의 URL | [https://www.altrulabs.com/](https://www.altrulabs.com/) |
| 개인정보 처리방침의 URL | [https://www.altrulabs.com/privacy](https://www.altrulabs.com/privacy) |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 조직에서 앱이 수집하는 데이터에 대한 제어에 대해 Altru에서 제공했습니다.
...
이 정보는 이 앱이 인증, 권한 부여, 응용 프로그램 등록 모범 사례 및 기타 ID 기준을 처리하는 방법에 대해 Altru에서 제공했습니다.
