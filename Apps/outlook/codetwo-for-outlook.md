---
title: CodeTwo에 의해 Outlook CodeTwo에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/10/2021
...
description: Outlook CodeTwo에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://appsource.microsoft.com/product/office/WA200003022" target="_blank">AppSource에서 보기</a>
...
| 앱의 핵심 기능 | 자동 전자 메일 서명, 메시지의 &amp; 법적 면책 조항 마케팅 배너. |
| 회사 본사 위치 | 폴란드 |
