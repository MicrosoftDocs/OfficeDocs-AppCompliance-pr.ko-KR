---
title: Egnyte, Inc.의 Outlook용 Egnyte 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/01/2022
...
description: Outlook용 Egnyte에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
ms.locfileid: "66656528"
---
# <a name="egnyte-for-outlook"></a>Outlook용 Egnyte

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 3월 8일</p>

* <a href="https://appsource.microsoft.com/product/office/WA200004177" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Egnyte, Inc.에서 Microsoft에 제공한 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | Outlook용 Egnyte |
| ID | WA200004177 |
| 지원되는 Office 365 클라이언트 | Windows의 Outlook 2013 이상, Mac에서 Outlook 2016 이상, 웹용 Outlook |
| 파트너 회사 이름 | Egnyte, Inc. |
| 회사 웹 사이트 | [https://www.egnyte.com](https://www.egnyte.com) |
| 앱의 사용 약관 | [https://www.egnyte.com/terms-and-conditions/01-2020](https://www.egnyte.com/terms-and-conditions/01-2020) |
| 앱의 핵심 기능 | Egnyte에서 Outlook의 전자 메일로 파일을 쉽게 공유하거나 받은 편지함을 남기지 않고 Outlook의 전자 메일 및 첨부 파일을 Egnyte 폴더에 직접 저장 |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://helpdesk.egnyte.com/hc/en-us/articles/4427124922125](https://helpdesk.egnyte.com/hc/en-us/articles/4427124922125) |
...
이 정보는 Egnyte, Inc.에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
...
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 전자 메일 주소, 테넌트 ID, 토큰, 메시지 및 첨부 파일 ID 및 해당 내용 |
...
| 개인 정보 취급 방침 URL | https://www.egnyte.com/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Mail.Read.Shared | 위임 | 사용자가 액세스할 수 있는 전자 메일 세부 정보를 읽는 데 필요 | [092aa7d1-522d-4d9d-90b6-7186e28eaf4a](../azure/092aa7d1-522d-4d9d-90b6-7186e28eaf4a.md) |
>| User.Read | 위임 | 권한 부여 목적으로 사용자의 유효성을 검사하는 데 필요 | [092aa7d1-522d-4d9d-90b6-7186e28eaf4a](../azure/092aa7d1-522d-4d9d-90b6-7186e28eaf4a.md) |
>| 전자 메일 | 위임 | 유효성 검사 액세스 토큰에 필요 | [092aa7d1-522d-4d9d-90b6-7186e28eaf4a](../azure/092aa7d1-522d-4d9d-90b6-7186e28eaf4a.md) |
>| offline_access | 위임 | OAuth 2.0을 사용할 때 새로 고침 토큰을 명시적으로 요청하는 데 필요 | [092aa7d1-522d-4d9d-90b6-7186e28eaf4a](../azure/092aa7d1-522d-4d9d-90b6-7186e28eaf4a.md) |
>| openid | 위임 | 사용자에게 기본 정보를 읽는 데 필요 | [092aa7d1-522d-4d9d-90b6-7186e28eaf4a](../azure/092aa7d1-522d-4d9d-90b6-7186e28eaf4a.md) |
>| 프로필 | 위임 | 기본 사용자 정보를 읽는 데 필요 | [092aa7d1-522d-4d9d-90b6-7186e28eaf4a](../azure/092aa7d1-522d-4d9d-90b6-7186e28eaf4a.md) |
