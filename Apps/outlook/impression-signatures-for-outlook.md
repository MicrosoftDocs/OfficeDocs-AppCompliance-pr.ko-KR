---
title: 노출 서명별 Outlook 대한 노출 서명에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/04/2021
...
description: Outlook 대한 노출 서명, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
ms.locfileid: "64879875"
---
# <a name="impression-signatures-for-outlook"></a>Outlook 대한 노출 서명

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2021년 7월 2일</p>

* <a href="https://appsource.microsoft.com/product/office/WA200003199" target="_blank">AppSource에서 보기</a>
...
| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | Outlook 대한 노출 서명 |
| ID | WA200003199 |
| 지원되는 Office 365 클라이언트 | mac에서 Outlook 2016 이상 Windows Outlook 2016 이상, 웹용 Outlook |
| 파트너 회사 이름 | 노출 서명 |
| 회사 웹 사이트 | [https://www.impression-signatures.com](https://www.impression-signatures.com) |
| 앱의 사용 약관 | [https://www.iubenda.com/terms-and-conditions/8039352](https://www.iubenda.com/terms-and-conditions/8039352) |
| 앱의 핵심 기능 | 노출 서명은 ECT Act 규격 eSignatures 및 보안 문서 배달을 제공합니다. 서명 워크플로를 관리하고 서명된 문서에 추가된 보안 보관 체인을 반환합니다.  |
| 회사 본사 위치 | 남아프리카 공화국 |
| 앱 정보 페이지 | |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대한 인상 서명에 의해 제공되었습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| openid | 모두 | 데이터 및 디렉터리 데이터를 인증합니다. | [be181d9c-9060-40a0-a692-b29f2e314d16](../azure/be181d9c-9060-40a0-a692-b29f2e314d16.md) |
