---
title: OnePlace Solutions에서 Outlook OnePlaceMail에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/30/2021
...
description: Outlook OnePlaceMail에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://appsource.microsoft.com/product/office/WA104380723" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

OnePlace Solutions에서 Microsoft에 제공하는 정보:
...
| 회사 웹 사이트 | [https://www.oneplacesolutions.com](https://www.oneplacesolutions.com) |
| 앱의 사용 약관 | [https://www.oneplacesolutions.com/eula.html](https://www.oneplacesolutions.com/eula.html) |
| 앱의 핵심 기능 | OnePlaceMail을 사용하면 전자 메일 및 첨부 파일을 SharePoint, OneDrive 및 Teams 저장할 수 있습니다. 또한 전자 메일을 작성할 때 SharePoint, OneDrive 및 Teams 콘텐츠를 사용할 수 있습니다. |
| 회사 본사 위치 | 오스트레일리아 |
| 앱 정보 페이지 | [https://www.oneplacesolutions.com/oneplacemail-sharepoint-a...](https://www.oneplacesolutions.com/oneplacemail-sharepoint-app-for-outlook.html) |
...
이 정보는 OnePlace Solutions에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.ReadWrite.All | 위임 | 현재 사용자가 멤버인지 Teams 확인하는 데 필요합니다. | [44a72516-136f-4a55-ae26-ef09977230be](../azure/44a72516-136f-4a55-ae26-ef09977230be.md) |
>| Mail.ReadWrite.Shared | 위임 | 메일 속성에 액세스하여 SharePoint 열을 설정하고 메일 항목의 SharePoint 범주에 전송된 항목을 추가하는 데 필요합니다. | [44a72516-136f-4a55-ae26-ef09977230be](../azure/44a72516-136f-4a55-ae26-ef09977230be.md) |
>| MailboxSettings.ReadWrite | 위임 | 수집되거나 사용되는 데이터가 없으므로 사용자 사서함의 마스터 범주 목록에 범주를 추가하는 데 사용됩니다. | [44a72516-136f-4a55-ae26-ef09977230be](../azure/44a72516-136f-4a55-ae26-ef09977230be.md) |
>| Sites.ReadWrite.All | 위임 | 앱이 SharePoint 업로드한 항목에 대한 속성을 설정하는 데 필요합니다. | [44a72516-136f-4a55-ae26-ef09977230be](../azure/44a72516-136f-4a55-ae26-ef09977230be.md) |
>| User.Read | 위임 | Microsoft Graph 인증에 필요합니다. | [44a72516-136f-4a55-ae26-ef09977230be](../azure/44a72516-136f-4a55-ae26-ef09977230be.md) |
>| User.ReadBasic.All | 위임 | 사용자 선택기 필드에 사용자 프로필 이미지를 표시하는 데 필요합니다. | [44a72516-136f-4a55-ae26-ef09977230be](../azure/44a72516-136f-4a55-ae26-ef09977230be.md) |
>| User.ReadBasic.All | 위임 | 사용자 선택기 필드에 사용자 프로필 이미지를 표시하는 데 필요합니다. | [44a72516-136f-4a55-ae26-ef09977230be](../azure/44a72516-136f-4a55-ae26-ef09977230be.md) |
>| User.ReadWrite.All | 위임 | 테넌시 Office 365 사용자 내에서 Teams 서비스를 사용할 수 있는지 확인하는 데 필요합니다. | [44a72516-136f-4a55-ae26-ef09977230be](../azure/44a72516-136f-4a55-ae26-ef09977230be.md) |
