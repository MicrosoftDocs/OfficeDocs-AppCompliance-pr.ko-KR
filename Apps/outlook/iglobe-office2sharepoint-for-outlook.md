---
title: iGlobe에서 Outlook Office2SharePoint에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/28/2021
...
description: Outlook Office2SharePoint에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://appsource.microsoft.com/product/office/WA104380689" target="_blank">AppSource에서 보기</a>
...
| ID | WA104380689 |
| 지원되는 Office 365 클라이언트 | Outlook 2013 이상 Windows, mac에서 Outlook 2016 이상, iOS에서 Outlook, Android에서 Outlook 웹용 Outlook |
| 파트너 회사 이름 | iGlobe |
