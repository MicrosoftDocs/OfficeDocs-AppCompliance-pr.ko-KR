---
title: salesforce.com 별 Salesforce에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/02/2021
...
description: Salesforce에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://appsource.microsoft.com/product/office/WA104379334" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Microsoft에 salesforce.com 제공하는 정보:
...
| 회사 웹 사이트 | [https://www.salesforce.com](https://www.salesforce.com) |
| 앱의 사용 약관 | [https://www.salesforce.com/content/dam/web/en_us/www/docume...](https://www.salesforce.com/content/dam/web/en_us/www/documents/legal/Agreements/software-order-form-supplements/Salesforce_Outlook_TOU_Order_Form_Addendum.pdf) |
| 앱의 핵심 기능 | Outlook Salesforce를 바로 경험할 수 있습니다. 통합은 푸시, 설치 또는 유지 관리할 소프트웨어가 없는 100% 클라우드입니다. Salesforce와 Outlook 전환하지 않고 전자 메일 및 약속과 관련된 모든 연락처, 잠재 고객, 계정, 기회 및 사례를 봅니다. Salesforce 데이터는 Outlook 직접 표시됩니다. 사용자 지정 개체 레코드를 포함한 새 Salesforce 레코드를 Outlook 직접 만듭니다. 작성할 때도 한 번의 클릭으로 Salesforce 레코드에 전자 메일 및 약속 추가 |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직의 제어에 대한 salesforce.com 제공되었습니다.
