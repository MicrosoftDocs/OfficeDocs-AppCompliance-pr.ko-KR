---
title: Flow Simulation Ltd.의 이메일 반응기 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/04/2022
...
description: Email Reactor에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
ms.locfileid: "65229415"
---
# <a name="email-reactor"></a>전자 메일 반응기

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 5월 4일</p>

* <a href="https://appsource.microsoft.com/product/office/WA104379506" target="_blank">AppSource에서 보기</a>
...
| 앱의 사용 약관 | [https://www.flosim.com/reactor/EULA.html](https://www.flosim.com/reactor/EULA.html) |
| 앱의 핵심 기능 | 시간 절약 전자 메일 응답 초안 도구 |
| 회사 본사 위치 | 영국 및 북아일랜드(해당) |
| 앱 정보 페이지 | [https://www.flosim.com/reactor/Email_Reactor.html](https://www.flosim.com/reactor/Email_Reactor.html) |
