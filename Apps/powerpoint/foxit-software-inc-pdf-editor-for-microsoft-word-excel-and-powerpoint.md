---
title: Foxit Software Inc.Microsoft Word, Excel 및 PowerPoint Foxit PDF Editor에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: CSA STAR 레지스트리의 Microsoft Word, Excel 및 PowerPoint, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대한 Foxit PDF 편집기에서 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
ms.locfileid: "64602573"
---
# <a name="foxit-pdf-editor-for-microsoft-word-excel-and-powerpoint"></a>Foxit PDF Editor for Microsoft Word, Excel 및 PowerPoint

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 3월 17일</p>

* <a href="https://appsource.microsoft.com/product/office/WA200003206" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Microsoft에 Foxit Software Inc.에서 제공하는 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | Foxit PDF Editor for Microsoft Word, Excel 및 PowerPoint |
| ID | WA200003206 |
| Office 365 클라이언트 지원 | Excel 2016 mac, Excel 2013 이상은 mac, Windows, 웹용 Excel, Word 2016 or later on Mac, 웹용 Word, Word 2013 or later on Windows, PowerPoint 2016 or later on Mac, 웹용 PowerPoint PowerPoint 2013 이상을 Windows |
| 파트너 회사 이름 | Foxit Software Inc. |
| 회사의 웹 사이트 | [https://www.foxit.com](https://www.foxit.com) |
| 앱 사용 약관 | [https://www.foxit.com/product/terms-of-service.html](https://www.foxit.com/product/terms-of-service.html) |
| 앱의 핵심 기능 | Microsoft Teams Microsoft Teams용 Foxit PDF 편집기를 사용하면 1.Secure collaboration-Share PDF를 남기지 않고도 더 많은 작업을 할 수 있습니다. 1.Secure collaboration-Share PDF를 사용하여 채널의 모든 사용자와 공동 작업하고, Microsoft SharePoint 또는 1개 드라이브에 저장된 문서 또는&#65307; 2.고품질 보기 PDF를 쉽고 안전하게 볼 수 있습니다. Microsoft Teams&#65307; 3.Annotate PDF-Provide 피드백을 문서에 추가하고 PDF 도구를 주석으로 작성합니다. |
| 회사 본사 위치 | 중국 |
| 앱 정보 페이지 | |
...
이 정보는 Foxit Software Inc.에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직이 사용할 컨트롤에 대해 제공됩니다.
...
| 데이터베이스에 저장되는 데이터는 무엇입니까? | 전자 메일, 사용자 이름, 사용자 ID |
...
| MFA(다단계 인증)를 사용할 수 있습니다. | CodeRepositories |
...
| 개인 정보 취급 방침 URL | https://www.foxit.com/company/privacy-policy.html |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite.All | 위임 | 사용자 문서를 읽고 문서를 저장합니다. | [959a79dd-69d0-4d05-b9a8-b9f02e28c049](../azure/959a79dd-69d0-4d05-b9a8-b9f02e28c049.md) |
