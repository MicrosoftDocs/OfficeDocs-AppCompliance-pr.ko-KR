---
title: 체리웨어별 Showmaster(도우미 플러그 인)에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/19/2022
...
description: Showmaster(도우미 플러그 인), 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://appsource.microsoft.com/product/office/WA200003676" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

체리웨어에서 Microsoft에 제공하는 정보:
...
| 앱의 핵심 기능 | Showmaster는 대기 시간 동안 대화 주위에 흥미 진진한 프레임을 만들고 헤드 라인, 카운트 다운, 음악 등으로 중단되는 PowerPoint 추가 기능입니다. |
| 회사 본사 위치 | 독일 |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대한 체리웨어에서 제공되었습니다.
