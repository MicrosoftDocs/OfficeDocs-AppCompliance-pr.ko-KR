---
title: 스테이터웨어의 Showmaster(도우미 플러그 인)에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/19/2022
...
description: Showmaster(도우미 플러그 인), 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
ms.locfileid: "63545246"
---
# <a name="showmaster-helper-plugin"></a>Showmaster(도우미 플러그 인)

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2021년 12월 8일</p>

* <a href="https://appsource.microsoft.com/product/office/WA200003676" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

도미니크웨어에서 Microsoft에 제공한 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | Showmaster(도우미 플러그 인) |
| ID | WA200003676 |
| Office 365 클라이언트 지원 | PowerPoint 2016 Mac, 웹용 PowerPoint, PowerPoint 2013 이상에서 Windows |
| 파트너 회사 이름 | 나만의 에기 |
| 회사의 웹 사이트 | [https://www.cherryware.com](https://www.cherryware.com) |
| 앱 사용 약관 | [https://showmaster.app/terms/](https://showmaster.app/terms/) |
| 앱의 핵심 기능 | Showmaster는 PowerPoint 동안 대화에 흥미로운 프레임을 만들고 헤드라인, 카운트다운, 음악 등에서 흥미로운 프레임을 만듭니다. |
| 회사 본사 위치 | 독일 |
| 앱 정보 페이지 | [https://showmaster.app](https://showmaster.app) |
...
이 정보는 이 앱이 조직 데이터를 수집 및 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직에서 제공하는 컨트롤에 대한 도미니크웨어에서 제공했습니다.
