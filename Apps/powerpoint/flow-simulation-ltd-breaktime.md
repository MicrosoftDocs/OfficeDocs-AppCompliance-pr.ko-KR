---
title: Flow Simulation Ltd.의 중단 시간에 대한 애플리케이션 정보입니다.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/04/2022
...
description: 중단 시간에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
ms.locfileid: "65229410"
---
# <a name="breaktime"></a>중단 시간

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 5월 4일</p>

* <a href="https://appsource.microsoft.com/product/office/WA200001661" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Flow Simulation Ltd.에서 Microsoft에 제공한 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | 중단 시간 |
| ID | WA200001661 |
| 지원되는 Office 365 클라이언트 | mac, 웹용 PowerPoint, PowerPoint 2013 이상에서 PowerPoint 2016 이상 Windows |
| 파트너 회사 이름 | Flow Simulation Ltd. |
| 회사 웹 사이트 | [https://www.flosim.com](https://www.flosim.com) |
| 앱의 사용 약관 | [https://www.flosim.com/breaktime/EULA.html](https://www.flosim.com/breaktime/EULA.html) |
| 앱의 핵심 기능 | 휴식 시간이기 때문에 언제 돌아올지 모두에게 빠르게 알릴 수 있는 방법입니다! |
| 회사 본사 위치 | 영국 및 북아일랜드(해당) |
| 앱 정보 페이지 | [https://www.flosim.com/breaktime/Breaktime.html](https://www.flosim.com/breaktime/Breaktime.html) |
...
이 정보는 Flow Simulation Ltd.에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 제공했습니다.
