---
title: 4Mata에 대한 애플리케이션 정보 - CLOUDIGNITE LLC의 목록 서식 디자이너
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/31/2022
...
description: 4Mata에 사용 가능한 모든 보안 및 규정 준수 정보 - CSA STAR 레지스트리의 서식 지정 디자이너, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보를 나열합니다.
...
---
# <a name="4mata---list-formatting-designer"></a>4Mata - 목록 서식 디자이너

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 5월 31일</p>

* <a href="https://appsource.microsoft.com/product/office/WA200002892" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

CLOUDIGNITE LLC에서 Microsoft에 제공하는 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | 4Mata - 목록 서식 디자이너 |
| ID | WA200002892 |
| 지원되는 Office 365 클라이언트 | SharePoint 2016 이상 |
| 파트너 회사 이름 | CLOUDIGNITE LLC |
| 회사 웹 사이트 | [https://4mata.com](https://4mata.com) |
| 앱의 사용 약관 | [https://docs.4mata.com/legal/terms-of-service](https://docs.4mata.com/legal/terms-of-service) |
| 앱의 핵심 기능 | 4Mata by CloudIgnite는 SharePoint 목록 및 양식을 디자인하고 서식을 지정하여 기업이 데이터를 시각화할 수 있도록 하는 도구 집합입니다.  이 애플리케이션을 사용하면 사용자는 비즈니스 프로세스 요구 사항과 편리하게 통합할 수 있도록 보고서, 청구서, 제품 세부 정보 게시 및 연락처 정보 수집을 위해 고도로 사용자 지정된 복잡한 SharePoint 양식 및 목록을 직관적으로 구성할 수 있습니다.  |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://4mata.com](https://4mata.com) |
...
이 정보는 CLOUDIGNITE LLC에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
