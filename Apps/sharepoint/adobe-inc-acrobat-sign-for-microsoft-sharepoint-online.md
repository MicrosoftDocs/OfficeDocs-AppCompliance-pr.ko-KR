---
title: Adobe Inc.의 Microsoft Office SharePoint Online 대한 Adobe Acrobat Sign에 대한 애플리케이션 정보입니다.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/23/2022
...
description: Adobe Acrobat Sign for Microsoft Office SharePoint Online 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://appsource.microsoft.com/product/office/WA104381012" target="_blank">AppSource에서 보기</a>
...
| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | Adobe Acrobat Sign for Microsoft Office SharePoint Online |
| ID | WA104381012 |
...
| 앱의 핵심 기능 | Adobe Sign을 Teams 추가할 때 문서 서명 워크플로가 빠르게 이동하도록 합니다. 이제 Teams 문서를 서명하고, Microsoft에서 선호하는 전자 서명 솔루션으로 모든 &#8212; 법적 구속력이 있는 전자 서명 및 승인을 위해 보낼 수 있습니다. |
| 회사 본사 위치 | 미국 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 위임 | 사용자 역할을 얻고 사용자에게 애플리케이션 기능에 대한 특정 권한이 부여되었는지 유효성을 검사합니다. | [99a3ad8d-8682-4f2a-9c2c-b4b27e99585c](../azure/99a3ad8d-8682-4f2a-9c2c-b4b27e99585c.md) |
