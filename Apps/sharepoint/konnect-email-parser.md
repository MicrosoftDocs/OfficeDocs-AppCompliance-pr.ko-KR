---
title: Konnect eMail의 Konnect eMail 파서에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/01/2022
...
description: Konnect eMail Parser, 해당 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
ms.locfileid: "64877345"
---
# <a name="konnect-email-parser"></a>Konnect eMail Parser

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 2월 1일</p>

* <a href="https://appsource.microsoft.com/product/office/WA200001893" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Konnect eMail에서 Microsoft에 제공하는 정보:
...
| 회사 웹 사이트 | [https://www.konnectemail.com](https://www.konnectemail.com) |
| 앱의 사용 약관 | [https://www.konnectemail.com/eula](https://www.konnectemail.com/eula) |
| 앱의 핵심 기능 | 전자 메일 특성을 메타데이터로 자동으로 캡처합니다. |
| 회사 본사 위치 | 오스트레일리아 |
| 앱 정보 페이지 | [https://www.konnectemail.com/sharepoint-email-management](https://www.konnectemail.com/sharepoint-email-management) |
...
이 정보는 Konnect eMail에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 사용자 메일 데이터 |
