---
title: Dropbox Inc.의 SharePoint HelloSign에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/10/2021
...
description: SharePoint HelloSign에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://appsource.microsoft.com/product/office/WA200003245" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Dropbox Inc.에서 Microsoft에 제공한 정보:
...
| 회사 웹 사이트 | [https://hellosign.com](https://hellosign.com) |
| 앱의 사용 약관 | [https://hellosign.com/terms](https://hellosign.com/terms) |
| 앱의 핵심 기능 | eSignature, 디지털 워크플로 및 전자 팩스 솔루션을 포함하는 HelloSign&#8217;디지털 워크플로 플랫폼 &#8211; &#8212; 80,000명 이상의 고객과 수백만 명의 사람들이 더 빠르게 비즈니스를 수행하는 데 도움이 됩니다. 우리는 고객이 거래를 더 빨리 마감하고, 신입 사원을 쉽게 등록하고, 오류없이 문서를 완성하는 데 도움을 줍니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://www.hellosign.com/integrations](https://www.hellosign.com/integrations) |
...
이 정보는 Dropbox Inc.에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 테넌트 ID, 사이트 ID, 전자 메일, 드라이브 ID, 드라이브 항목 ID |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 테넌트 ID, 사이트 ID, 전자 메일, 드라이브 ID, 드라이브 항목 ID |
...
| 개인 정보 취급 방침 URL | https://www.hellosign.com/privacy |
...
| 앱에서 위의 라이브러리 중 하나를 사용하지 않는 경우 어떤 인증 라이브러리 또는 라이브러리를 사용하나요? | Microsoft ID 플랫폼 및 OAuth 2.0 권한 부여 코드 흐름이 사용됩니다.https://docs.microsoft.com/en-us/azure/active-directory/develop/v2-oauth2-auth-code-flow |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite.All | 응용 프로그램 | 전자 서명된 파일을 SharePoint 다시 업로드하려면 | [6fcff87e-0f86-49c3-81eb-bc028d1ccfe6](../azure/6fcff87e-0f86-49c3-81eb-bc028d1ccfe6.md) |
>| Sites.ReadWrite.All | 응용 프로그램 | 전자 서명된 파일을 SharePoint 다시 업로드하려면 | [6fcff87e-0f86-49c3-81eb-bc028d1ccfe6](../azure/6fcff87e-0f86-49c3-81eb-bc028d1ccfe6.md) |
>| User.Read | 위임 | 사용자의 전자 메일을 받으려면 | [6fcff87e-0f86-49c3-81eb-bc028d1ccfe6](../azure/6fcff87e-0f86-49c3-81eb-bc028d1ccfe6.md) |
