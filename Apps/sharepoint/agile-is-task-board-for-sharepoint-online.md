---
title: Agile-IS에서 SharePoint Online에 대한 Agile 작업 보드에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/08/2022
...
description: SharePoint Online용 Agile 작업 위원회, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
ms.locfileid: "64753903"
---
# <a name="agile-task-board-for-sharepoint-online"></a>SharePoint Online용 Agile 작업 위원회

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 4월 8일</p>

* <a href="https://appsource.microsoft.com/product/office/WA200002087" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Agile-IS에서 Microsoft에 제공하는 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | SharePoint Online용 Agile 작업 위원회 |
| ID | WA200002087 |
| 지원되는 Office 365 클라이언트 | SharePoint 2016 이상 |
| 파트너 회사 이름 | Agile-IS |
| 회사 웹 사이트 | [https://www.agile-is.de](https://www.agile-is.de) |
| 앱의 사용 약관 | [https://www.agile-is.de/en/termsofuse](https://www.agile-is.de/en/termsofuse) |
| 앱의 핵심 기능 | Agile 작업 위원회는 사용자와 팀이 민첩한 프로젝트의 개요를 더 잘 파악할 수 있도록 도와줍니다. 물리적 보드를 디지털 버전으로 변환합니다. 상태 표시를 위한 열, 스윔 레인 수, 맵의 메타데이터 기반 색 지정, 책임 할당, 끌어서 놓기 편집 및 기타 많은 설정과 같은 기능을 사용하여 프로세스를 매핑할 수 있습니다. 모든 데이터는 M365 테넌트 내에 유지됩니다. |
| 회사 본사 위치 | 독일 |
| 앱 정보 페이지 | [https://www.agile-is.de/en/agiletaskboard](https://www.agile-is.de/en/agiletaskboard) |
...
이 정보는 Agile-IS에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 아니요 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | UPN의 주르 리젠츠베르왈퉁; Unternehmensdaten zur Rechnungslegung |
...
| 개인 정보 취급 방침 URL | https://www.agile-is.de/en/telemetry |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AppCatalog.Read.All | 위임 | 앱에서 현재 설치된 앱 꼭짓점을 쿼리할 수 있습니다. 올바른 앱 리소스를 제공하는 데 사용됩니다. | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
>| GroupMember.Read.All | 위임 | 그룹 구성원을 읽고 Planner 작업을 할당합니다.  | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
>| Tasks.ReadWrite | 위임 | Planner 계획 및 작업 작업   | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
>| TeamsActivity.Send | 위임 | 팀 활동에 메시지 보내기 | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
>| TeamsAppInstallation.ReadForTeam | 위임 | 앱에서 현재 설치된 앱 꼭짓점을 쿼리할 수 있습니다. 올바른 앱 리소스를 제공하는 데 사용됩니다. | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
>| User.Read | 위임 | 사용자가 로그인하고 기본 프로필 정보를 읽을 수 있도록 허용 | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
>| User.ReadBasic.All | 위임 | 사용자가 다른 사용자의 기본 프로필 정보를 읽을 수 있도록 허용 | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
