---
title: Zynyo의 SharePoint Online에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/24/2022
...
description: Zynyo Sign for SharePoint Online, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://appsource.microsoft.com/product/office/WA200003673" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Zynyo가 Microsoft에 제공한 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | Zynyo Sign for SharePoint Online |
| ID | WA200003673 |
| Office 365 클라이언트 지원 | SharePoint 2016 이상 |
| 파트너 회사 이름 | Zynyo |
| 회사의 웹 사이트 | [https://zynyo.com](https://zynyo.com) |
| 앱 사용 약관 | [https://zynyo.com/Algemene%20Voorwaarden%20Zynyo%20BV.pdf](https://zynyo.com/Algemene%20Voorwaarden%20Zynyo%20BV.pdf) |
| 앱의 핵심 기능 | Alle documenten eenvoudig en rechtsgeldig digitaal laten ondertekenen. |
| 회사 본사 위치 | 네덜란드(the) |
| 앱 정보 페이지 | [https://zynyo.com/signing-service-diensten/sharepoint/](https://zynyo.com/signing-service-diensten/sharepoint/) |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 조직에서 수집하는 데이터를 통해 조직이 제공하는 컨트롤에 대해 Zynyo에서 제공했습니다.
...
| 데이터베이스에 저장되는 데이터는 무엇입니까? | 사용자가 서명 요청을 제출하면 선택한 문서 및 입력한 데이터가 저장됩니다. 여기에는 이름, 전자 메일 및 전화 번호와 같은 고객 데이터가 포함됩니다. 이 데이터는 서명 요청이 만료되면 기본적으로 30일 동안 삭제됩니다. |
...
| 개인 정보 취급 방침 URL | https://zynyo.com/Zynyo-Privacyverklaring.pdf |
