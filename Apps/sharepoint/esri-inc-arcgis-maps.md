...
ms.locfileid: "65225152"
---
# <a name="arcgis-maps-overview"></a>ArcGIS 지도 개요
...
>고객 관리자는 조직 또는 프로젝트 수준에서 데이터에 대한 사용자 액세스를 제어할 수 있습니다. 데이터를 읽거나 쓰기 전에 액세스 제어 목록에 대해 요청을 확인합니다. 최종 사용자 및 외부 서비스와 전송 중인 데이터는 HTTPS(TLS 1.2만 해당)로 암호화됩니다.
...
<iframe height='1020' title='Microsoft Cloud App Security 정보' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/27233' frameborder='no'></iframe>
...
이 정보는 Esri, Inc.에서 이 앱이 인증, 권한 부여, 애플리케이션 등록 모범 사례 및 기타 ID 기준을 처리하는 방법에 대해 제공했습니다.
