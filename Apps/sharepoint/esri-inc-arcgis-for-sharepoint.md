...
description: CSA STAR 레지스트리의 SharePoint, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 ArcGIS에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
