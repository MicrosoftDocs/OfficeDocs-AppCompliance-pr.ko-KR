---
title: Esri, Inc.의 SharePoint ArcGIS 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/04/2021
...
description: SharePoint ArcGIS에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://appsource.microsoft.com/product/office/WA200003118" target="_blank">AppSource에서 보기</a>
...
| 파트너 회사 이름 | 주식회사 에스리 |
| 회사 웹 사이트 | [https://www.esri.com](https://www.esri.com) |
| 앱의 사용 약관 | [https://www.esri.com/en-us/legal/terms/master-agreement-pro...](https://www.esri.com/en-us/legal/terms/master-agreement-product) |
| 앱의 핵심 기능 | ArcGIS Online에는 수천 개의 토픽에 대한 앱, 신뢰할 수 있는 맵 및 데이터 모음, 데이터를 시각화하는 데 필요한 최신 매핑 도구, 데이터에서 의미 있는 패턴을 검색 및 전달하기 위한 분석 및 사용자와 콘텐츠를 쉽게 관리하고 모든 사람이 지도를 만들고 공유할 수 있도록 하는 관리 도구가 포함되어 있습니다. ArcGIS는 조직의 모든 사용자에게 언제 어디서나 모든 디바이스에서 지도를 검색, 사용, 만들기 및 공유할 수 있는 기능을 제공합니다. |
| 회사 본사 위치 | 미국 |
...
이 정보는 Esri, Inc.에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직의 제어에 대해 제공되었습니다.
