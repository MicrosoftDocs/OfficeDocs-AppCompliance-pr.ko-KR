---
title: Adobe Inc.의 Adobe Sign for SharePoint 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
ms.date: 10/04/2021
ms.topic: article
...
description: Adobe Sign for SharePoint, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 대해 사용 가능한 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://appsource.microsoft.com/product/office/WA104381012" target="_blank">AppSource의 보기</a>
...
| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | Adobe Sign for SharePoint |
| ID | WA104381012 |
...
>|:----------------|:------------------------------------------------|:--------------------------------------------------------|:--------------------------------------------------|:--------------------|
>| Directory.Read.All | 위임 | 사용자에게 응용 프로그램 기능에 대한 특정 사용 권한이 부여된 경우 사용자 역할을 부여하고 유효성을 검사합니다. | 액세스 토큰을 새로 고치기 위해 현재 토큰이 만료된 경우  | [99a3ad8d-8682-4f2a-9c2c-b4b27e99585c](https://docs.microsoft.com/microsoft-365-app-certification/azure/99a3ad8d-8682-4f2a-9c2c-b4b27e99585c) |
...
>|:--------|:-----------------------|:----------------------------|:--------------------------------------|:-------------------|:-----------------------------------|
>| SharePoint REST API | 예 | SharePoint 역할 | 목록 항목에 대한 액세스 권한을 부여/거부하기 위한 사용자 역할 기반 | DB에 저장하지 않습니다. | 해당 없음 |
