...
| 앱의 핵심 기능 | Adobe Sign을 추가하여 문서 서명 워크플로를 빠르게 Teams. 이제 Teams Microsoft의 기본 설정 전자 서명 솔루션으로 문서에 서명하고, 법적 구속력이 있는 전자 &#8212; 승인을 위해 문서를 보낼 수 있습니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
