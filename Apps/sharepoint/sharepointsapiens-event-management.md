---
title: SharePointSapiens의 SharePoint|Sapiens 이벤트 관리에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: SharePoint|sapiens 이벤트 관리, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
ms.locfileid: "63778438"
---
# <a name="sharepointsapiens-event-management"></a>SharePoint|sapiens 이벤트 관리

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 3월 22일</p>

* <a href="https://appsource.microsoft.com/product/office/WA104380834" target="_blank">AppSource의 보기</a>
...
| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | SharePoint-sapiens 이벤트 관리 |
| ID | WA104380834 |
...
| 앱의 핵심 기능 | 이벤트 관리 추가 기능을 사용하면 다양한 유형의 이벤트를 구성할 수 있습니다. 몇 가지 간단한 단계에서 다음에 이벤트를 예약할 수 있습니다. 참가자는 클릭 한 번으로 온라인으로 등록할 수 있습니다. 이끌이는 내부 또는 외부 사용자를 대신 등록하거나 전자 메일로 초대를 보낼 수도 있습니다. 참가자는 전자 메일을 통해 모임 요청 및 업데이트를 받으며 일정에 항상 최신 Outlook 합니다. 추가 기능에서 모든 참석자에 대한 추적을 한 장소에 보관합니다. |
| 회사 본사 위치 | 오스트리아 |
| 앱 정보 페이지 | [https://www.sharepointsapiens.com/event-management-office36...](https://www.sharepointsapiens.com/event-management-office365/) |
