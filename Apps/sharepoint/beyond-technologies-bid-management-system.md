...
description: CSA STAR 레지스트리의 Bid Management System, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용할 수 있는 모든 보안 및 규정 준수 정보
...
| 앱의 핵심 기능 | 제안 SharePoint/제안 관리 소프트웨어가 지원되어 바이트 활동을 디지털화할 수 있습니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
