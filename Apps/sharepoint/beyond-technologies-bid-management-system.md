---
title: 기술 이상의 바이 Bid Management System에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/03/2022
...
description: CSA STAR 레지스트리의 Bid Management System, 해당 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보
...
* <a href="https://appsource.microsoft.com/product/office/WA200001787" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Beyond Technologies에서 Microsoft에 제공하는 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | Bid Management System |
| ID | WA200001787 |
| Office 365 클라이언트 지원 | SharePoint 2013 이상 |
| 파트너 회사 이름 | Beyond Technologies |
| 회사의 웹 사이트 | [https://www.beyondintranet.com](https://www.beyondintranet.com) |
| 앱 사용 약관 | [https://www.beyondintranet.com/eula](https://www.beyondintranet.com/eula) |
| 앱의 핵심 기능 | 제안 SharePoint/Bid Management Software를 통해 바이트 활동을 디지털화할 수 있습니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://www.beyondintranet.com/bid-management-software](https://www.beyondintranet.com/bid-management-software) |
...
이 정보는 Beyond Technologies에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터에 대해 조직에서 제공하는 컨트롤에 대해 제공됩니다.
...
| 데이터베이스에 저장되는 데이터는 무엇입니까? | 사용자 전자 메일 및 SharePoint URL |
...
| 개인 정보 취급 방침 URL | https://www.beyondintranet.com/privacypolicy |
