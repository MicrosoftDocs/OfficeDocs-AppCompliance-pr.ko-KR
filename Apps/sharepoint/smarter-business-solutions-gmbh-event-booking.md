...
description: Smarter Event Booking에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보
...
| 회사의 웹 사이트 | [https://smarterbusiness.at](https://smarterbusiness.at) |
| 앱 사용 약관 | [https://www.smarterbusiness.at/en/terms-of-use-for-smarter-...](https://www.smarterbusiness.at/en/terms-of-use-for-smarter-event-booking) |
| 앱의 핵심 기능 | 스마트 이벤트 예약을 사용하면 Microsoft365 사용자가 이전에 만든 이벤트에 등록할 수 있습니다. |
| 회사 본사 위치 | 오스트리아 |
| 앱 정보 페이지 | [https://www.smarterbusiness.at/en/smarter-event-booking](https://www.smarterbusiness.at/en/smarter-event-booking) |
