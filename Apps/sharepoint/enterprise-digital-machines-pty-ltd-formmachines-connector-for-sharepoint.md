---
title: 엔터프라이즈 디지털 컴퓨터 PTY LTD의 SharePoint FormMachines 커넥터에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/25/2022
...
| 앱의 핵심 기능 | FormMachines를 Teams 목록을 읽고 쓸 수 SharePoint 제공합니다. |
| 회사 본사 위치 | 오스트레일리아 |
...
| 데이터베이스에 저장되는 데이터는 무엇입니까? | 고객이 디자인한 양식 서식 파일 및 양식 전송 |
...
| 개인 정보 취급 방침 URL | https://www.formmachines.com/dist/docs#/statements_and_agreements/privacy |
