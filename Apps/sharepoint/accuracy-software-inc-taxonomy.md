---
title: 정확도 소프트웨어 Inc.의 분류에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/18/2022
...
description: 분류, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://appsource.microsoft.com/product/office/WA200003006" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Microsoft에 대한 Accuracy Software Inc.에서 제공하는 정보:
...
| 파트너 회사 이름 | 정확도 소프트웨어 Inc. |
| 회사 웹 사이트 | [https://accuracysoftware.ca](https://accuracysoftware.ca) |
| 앱의 사용 약관 | [https://accuracysoftware.ca/taxonomy-terms-of-service](https://accuracysoftware.ca/taxonomy-terms-of-service) |
| 앱의 핵심 기능 | 분류는 다양한 이해 관계자와 메신저 전문가의 협업을 통해 파일 계획을 만들고 검토하고 전체 조직에 게시할 수 있도록 하여 파일 분류 계획을 관리하는 효과적인 방법을 제공합니다. 또한 분류를 사용하면 Microsoft 규정 준수 센터로 가져올 수 있는 M365 보존 레이블 내보내기를 생성하고 SharePoint 용어 저장소로 가져올 수 있는 용어 집합 형식으로 파일 계획을 내보낼 수 있습니다. |
| 회사 본사 위치 | 캐나다 |
...
| 앱에서 사용하는 호스팅 클라우드 공급자는 무엇인가요? | 클라이언트 SharePoint 테넌트 |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 Accuracy Software Inc.에서 제공했습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 아니요 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 파일 계획 분류 데이터 |
