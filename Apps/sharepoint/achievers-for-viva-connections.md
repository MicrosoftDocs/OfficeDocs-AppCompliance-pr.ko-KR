---
title: 달성자의 Viva Connections 위한 달성자를 위한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/06/2022
...
description: Viva Connections 대한 달성자, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
ms.locfileid: "66656398"
---
# <a name="achievers-for-viva-connections"></a>Viva Connections 달성자

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 6월 10일</p>

* <a href="https://appsource.microsoft.com/product/office/WA200004313" target="_blank">AppSource에서 보기</a>
...
| 앱의 핵심 기능 | 달성자 플랫폼을 사용하여 축하 카드에 서명하고, 자기 인식 및 추세 인식을 보는 회원을 위한 빠른 액션 카드 |
| 회사 본사 위치 | 캐나다 |
| 앱 정보 페이지 | |
...
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 테넌트 ID, 사용자 ID |
