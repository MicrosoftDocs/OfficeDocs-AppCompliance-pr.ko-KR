---
title: Microsoft 365 대한 iGlobe CRM Office 365 애플리케이션 정보
ms.author: elmalova
author: elenamalova
ms.date: 06/22/2021
ms.topic: article
...
ms.locfileid: "65225029"
---
# <a name="application-information-for-iglobe-crm-office-365-for-microsoft-365"></a>Microsoft 365 iGlobe CRM Office 365 대한 애플리케이션 정보
...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| Calendars.ReadWrite | 위임 | 애플리케이션 데이터베이스에 데이터가 저장되지 않습니다. | canlendar에서 iGlobe로 모임 보고서를 dreating할 때 사용자 일정에 액세스할 수 있음 | 0bb1641a-3b3b-47f7-a11e-01279d92abfb |
>| Contacts.ReadWrite | 위임 | Directory.AccessAsUser.All | 앱에서 로그인한 사용자와 디렉터리의 정보에 동일한 액세스 권한을 가질 수 있습니다. | 0bb1641a-3b3b-47f7-a11e-01279d92abfb |
>| Directory.Read.All | 위임 | 애플리케이션 데이터베이스에 데이터가 저장되지 않습니다. | 사용 권한을 확인하고 사이트 및 목록을 가져옵니다. 폴더를 만들고, 파일을 가져와 파일을 저장합니다. | 0bb1641a-3b3b-47f7-a11e-01279d92abfb |
>| Directory.ReadWrite.All | 위임 | 애플리케이션 데이터베이스에 데이터가 저장되지 않습니다. | 앱에서 로그인한 사용자와 디렉터리의 정보에 동일한 액세스 권한을 가질 수 있습니다. | 0bb1641a-3b3b-47f7-a11e-01279d92abfb |
>| Files.ReadWrite.All | 위임 | 애플리케이션 데이터베이스에 데이터가 저장되지 않습니다. | 읽기, 업데이트, Panner 작업 만들기, 최근 사용자 및 공유 파일 읽기, SharePoint 목록, 라이브러리 및 파일을 가져옵니다. 파일 및 데이터를 SharePoint 목록에 저장합니다. | 0bb1641a-3b3b-47f7-a11e-01279d92abfb |
>| Group.Read.All | 위임 | 애플리케이션 데이터베이스에 데이터가 저장되지 않습니다. | 읽기, 업데이트, Panner 작업 만들기, 최근 사용자 및 공유 파일 읽기, SharePoint 목록, 라이브러리 및 파일을 가져옵니다. SharePoint 목록에 파일을 저장합니다. | 0bb1641a-3b3b-47f7-a11e-01279d92abfb |
>| Group.ReadWrite.All | 위임 | 애플리케이션 데이터베이스에 데이터가 저장되지 않습니다. | 읽기, 업데이트, Panner 작업 만들기, 최근 사용자 및 공유 파일 읽기, SharePoint 목록, 라이브러리 및 파일을 가져옵니다. SharePoint 목록에 파일을 저장합니다. iGlobe CRM Office 365 통합 | 0bb1641a-3b3b-47f7-a11e-01279d92abfb |
>| Mail.ReadWrite | 위임 | 애플리케이션 데이터베이스에 데이터가 저장되지 않습니다. | iGlobe CRM에 eamil을 사용하고 iGlobe에서 새로운 e-amil로 informatiopn을 가져옵니다. | 0bb1641a-3b3b-47f7-a11e-01279d92abfb |
>| Sites.Manage.All | 위임 | 애플리케이션 데이터베이스에 데이터가 저장되지 않습니다. | iGlobe CRM에서 항목 및 목록 만들기, 편집 및 삭제 | 0bb1641a-3b3b-47f7-a11e-01279d92abfb |
>| Sites.Read.All | 위임 | 애플리케이션 데이터베이스에 데이터가 저장되지 않습니다. | iGlobe CRM에서 항목 읽기 | 0bb1641a-3b3b-47f7-a11e-01279d92abfb |
>| Sites.ReadWrite.All | 위임 | 애플리케이션 데이터베이스에 데이터가 저장되지 않습니다. | iGlobe CRM에서 항목 및 목록 편집 및 삭제 | 0bb1641a-3b3b-47f7-a11e-01279d92abfb |
>| Tasks.ReadWrite | 위임 | 애플리케이션 데이터베이스에 데이터가 저장되지 않습니다. | iGlobe CRM에서 Planner 작업 만들기 | 0bb1641a-3b3b-47f7-a11e-01279d92abfb |
>| User.Read | 위임 | 애플리케이션 데이터베이스에 데이터가 저장되지 않습니다. | speficic 사용자에 대한 iGlobe CRM의 정보를 얻으려면 | 0bb1641a-3b3b-47f7-a11e-01279d92abfb |
