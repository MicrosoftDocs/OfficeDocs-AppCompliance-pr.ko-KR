...
>| Directory.AccessAsUser.All | 위임 | 일부&#8217;데이터만 저장할 수 없습니다. | 사용자가 워크플로에서 승인자를 선택하는 등 응용 프로그램의 다양한 장소에서 다른 사용자를 선택할 수 있습니다. | 2a651f59-97ce-42bb-97d7-cf7a2af4b635 |
...
>| Mail.Send | 위임 | 알림&#8217;, 받는 사람(ID만), 요청 ID와 같은 이 작업의 메타데이터를 다시 저장해야 합니다. | 앱이 승인 워크플로 중에 알림 전자 메일을 보낼 수 있습니다. | 2a651f59-97ce-42bb-97d7-cf7a2af4b635 |
...
>| User.Read.All | 위임 | 일부&#8217;데이터만 저장할 수 없습니다. | 앱에서 모든 사용자의 프로필 속성, 보고서 및 관리자의 전체 집합을 읽을 수 있도록 허용합니다. 특히 대상 지정 프로세스 중에 현재 사용자 프로필을 기준으로 일부 콘텐츠를 필터링하는 데 사용됩니다. | 2a651f59-97ce-42bb-97d7-cf7a2af4b635 |
...
>수집된 모든 데이터는 여기에 설명되어 있습니다. https://developers.salestim.com/platform/datamanagement.html#application-data 설명된 바와 같이 로그는 15일 동안 일시적으로 저장된 다음 자동으로 삭제됩니다.
