---
title: officeatwork | 애플리케이션 정보 OneNote officeatwork별 Office 이미지 선택기
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/25/2022
...
description: OneNote 보안, 규정 준수 및 데이터 처리 관행에 대한 업계 표준 및 제어에 대해 Microsoft에서 검토했습니다. officeatwork | 사용할 수 있는 모든 보안 및 규정 준수 정보 Office 대한 이미지 선택기, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보.
...
ms.locfileid: "64784337"
---
# <a name="onenote--officeatwork--image-chooser-for-office"></a>OneNote | officeatwork | Office 대한 이미지 선택기
