---
title: Talkdesk, Inc.의 Talkdesk Microsoft Teams 커넥터에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/07/2022
...
description: Talkdesk Microsoft Teams 커넥터, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
---
# <a name="talkdesk-microsoft-teams-connector"></a>Talkdesk Microsoft Teams 커넥터
...
* <a href="https://appsource.microsoft.com/product/web-apps/talkdeskinc1579824950513.talkdesk_for_teams" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Talkdesk, Inc.에서 Microsoft에 제공한 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | Talkdesk Microsoft Teams 커넥터 |
| ID | talkdeskinc1579824950513.talkdesk_for_teams |
| 파트너 회사 이름 | Talkdesk, Inc. |
| 회사 웹 사이트 | [https://www.talkdesk.com](https://www.talkdesk.com) |
| 앱의 사용 약관 | [https://www.talkdesk.com/terms-of-service](https://www.talkdesk.com/terms-of-service) |
| 앱의 핵심 기능 | 디렉터리 및 직접 라우팅을 가능하게 하는 Talkdesk에 Microsoft Teams 통합 |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
...
이 정보는 Talkdesk, Inc.에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 사용자 프로필 데이터 - 이름, 성, 전체 이름, 전자 메일 주소, 전화 번호 |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 사용자 프로필 데이터 - 이름, 성, 전체 이름, 전자 메일 주소, 전화 번호 |
...
| 앱 및 이를 지원하는 침입에 대해 분기별 취약성 검사를 수행합니까? | 아니오 |
...
| 앱에 고객 데이터를 수집, 사용, 공유 및 저장하는 방법을 설명하는 외부 개인 정보 보호 알림이 있나요? | 아니오 |
...
| 앱에서 위의 라이브러리 중 하나를 사용하지 않는 경우 어떤 인증 라이브러리 또는 라이브러리를 사용하나요? | https://rubygems.org/gems/oauth2, v1.4.4 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read.All | 위임 | MS Teams 사용자의 프로필 데이터를 수집하는 데 필요 | [10d8604b-e6ea-4c59-8414-aca1bf1ffda8](../azure/10d8604b-e6ea-4c59-8414-aca1bf1ffda8.md) |
>| offline_access | 위임 | 액세스 권한을 부여한 사용자가 로그인하지 않은 경우에도 앱에서 데이터를 볼 수 있습니다. | [10d8604b-e6ea-4c59-8414-aca1bf1ffda8](../azure/10d8604b-e6ea-4c59-8414-aca1bf1ffda8.md) |
