---
title: MURAL별 MURAL에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/13/2022
...
description: MURAL, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://appsource.microsoft.com/product/web-apps/tactivosincdbamural1608253315049.sol-43803-aek" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

MURAL에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | MURAL |
| 회사 웹 사이트 | [https://www.mural.co](https://www.mural.co) |
| 앱의 사용 약관 | [https://www.mural.co/terms/terms-of-use](https://www.mural.co/terms/terms-of-use) |
| 앱의 핵심 기능 | 시각적으로 생각하고 공동 작업 |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://support.mural.co](https://support.mural.co) |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대한 MURAL에서 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | MURAL에는 로그인 목적으로 이름, 성 및 전자 메일 주소만 필요합니다. 처리/저장할 데이터의 종류는 고객에 따라 달라집니다. |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | MURAL은 로그인 목적으로 사용자의 이름, 성 및 전자 메일만 저장합니다. 저장된 다른 모든 정보는 고객이 벽화에 저장하는 정보에 따라 달라집니다. |
...
| 가장 최근 SOC2 인증 날짜 | 2021-04-01 |
| 앱이 서비스 조직 컨트롤(SOC 3)을 준수하나요? | 예 |
| 가장 최근 SOC3 인증 날짜 | 2021-04-01 |
...
| 개인 정보 취급 방침 URL | https://www.mural.co/terms/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.Read | 위임 | 문서를 MURAL에 업로드하는 데 필요한 Files.read입니다. | [a1ef3a23-74fc-4c91-909f-691cc47a1c8e](../azure/a1ef3a23-74fc-4c91-909f-691cc47a1c8e.md) |
>| User.Read | 위임 | 계정 생성을 위해 벽화에 이름, 성 및 전자 메일이 필요하기 때문에 User.read입니다. | [a1ef3a23-74fc-4c91-909f-691cc47a1c8e](../azure/a1ef3a23-74fc-4c91-909f-691cc47a1c8e.md) |
