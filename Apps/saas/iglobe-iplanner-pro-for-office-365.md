---
title: iGlobe의 Office 365 iPlanner Pro용 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/04/2022
...
description: iPlanner Pro for Office 365 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 7월 4일</p>
...
| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | iPlanner Pro for Office 365 |
| ID | 17859280.iplannerpro |
| 파트너 회사 이름 | iGlobe |
| 회사 웹 사이트 | [https://www.iglobecrm.com](https://www.iglobecrm.com) |
| 앱의 사용 약관 | [https://iglobecrm.com/content/end-user-license-agreement-ig...](https://iglobecrm.com/content/end-user-license-agreement-iglobe-iplanner-add-ins) |
| 앱의 핵심 기능 | 모든 장치의 Outlook에서 손끝에 있는 Office 365 Planner Teams에서 Planner &amp; 작업을 가져옵니다. 작업을 관리하고 만드는 것이 더 쉬워졌습니다. Windows용 Outlook, MAC, IOS 또는 웹 메일의 맨 끝에 있는 Office 365 Planner &amp; Teams에서 Planner 작업을 가져옵니다. |
| 회사 본사 위치 | 덴마크 |
...
| 앱에서 처리되는 데이터는 무엇인가요? | 사용자와 iGlobe가 조직&#8217;라이선스 계정을 관리할 수 있도록 수집된 데이터는 전자 메일 및 이름을 수집합니다. 수집된 정보는 앱 라이선스 관리 페이지에서 조직 앱 관리자가 볼 수 있습니다. |
...
| 지원되는 정책 유형 나열 | Azure AD SSO, 보안 기본값 및 기타 일반적인 정책(예: 레거시 인증 차단* 관리자용 MFA 필요* Azure 관리에 MFA 필요* 모든 사용자에 대해 MFA 필요* |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | 위임 | 기한을 사용하여 iPlanner Pro에서 일정 항목을 만들어 사용자 일정에 항목을 추가할 수 있도록 허용 | [a6f5c2f4-0bc2-48bf-8afe-6c93583a152b](../azure/a6f5c2f4-0bc2-48bf-8afe-6c93583a152b.md) |
>| Directory.AccessAsUser.All | 위임 | 로그인한 사용자와 디렉터리의 정보에 동일한 액세스 권한을 가질 수 있습니다. 사용자 권한 수준을 유지하는지 확인 | [a6f5c2f4-0bc2-48bf-8afe-6c93583a152b](../azure/a6f5c2f4-0bc2-48bf-8afe-6c93583a152b.md) |
>| Files.Read | 위임 | Azure Ad SSO 및 iPlanner Pro에 필요한 파일을 열고 파일을 저장할 수 있는 사용자 파일을 읽을 수 있어야 합니다. | [a6f5c2f4-0bc2-48bf-8afe-6c93583a152b](../azure/a6f5c2f4-0bc2-48bf-8afe-6c93583a152b.md) |
>| Group.Read.All | 위임 | iPlanner Pro는 사용자가 구성원인 플랜과 로그인한 사용자에게 할당된 작업을 가져올 수 있습니다. | [a6f5c2f4-0bc2-48bf-8afe-6c93583a152b](../azure/a6f5c2f4-0bc2-48bf-8afe-6c93583a152b.md) |
>| Group.ReadWrite.All | 위임 | 사용자가 iPlanner Pro에서 Planner HUB를 보고, 사용자가 할당한 다른 작업 및 작업을 읽을 수 있도록 허용 | [a6f5c2f4-0bc2-48bf-8afe-6c93583a152b](../azure/a6f5c2f4-0bc2-48bf-8afe-6c93583a152b.md) |
>| Mail.Read | 위임 | 메일을 읽을 수 있으므로 사용자가 선택한 메일의 작업에서 메일 또는 메일의 첨부 파일을 저장할 수 있습니다. | [a6f5c2f4-0bc2-48bf-8afe-6c93583a152b](../azure/a6f5c2f4-0bc2-48bf-8afe-6c93583a152b.md) |
>| User.Read | 위임 | Azure AD SSO에 필요하고 사용자가 iPlanner Pro에 로그인할 수 있으며 앱에서 로그인한 사용자의 프로필을 읽을 수 있습니다. | [a6f5c2f4-0bc2-48bf-8afe-6c93583a152b](../azure/a6f5c2f4-0bc2-48bf-8afe-6c93583a152b.md) |
>| User.ReadBasic.All | 위임 | iPlanner Pro가 로그인한 사용자의 프로필을 읽을 수 있도록 하여 사용자 작업을 가져올 수 있습니다. 사용자가 iPlanner Pro에서 Planner HUB를 보고, 사용자가 할당한 다른 작업 및 작업을 읽을 수 있도록 허용 | [a6f5c2f4-0bc2-48bf-8afe-6c93583a152b](../azure/a6f5c2f4-0bc2-48bf-8afe-6c93583a152b.md) |
>| 프로필 | 위임 | Azure AD SSO에 필요하고 사용자가 로그인한 사용자 사진을 볼 수 있도록 하여 사용자가 올바른 로그인인지 확인합니다. | [a6f5c2f4-0bc2-48bf-8afe-6c93583a152b](../azure/a6f5c2f4-0bc2-48bf-8afe-6c93583a152b.md) |
