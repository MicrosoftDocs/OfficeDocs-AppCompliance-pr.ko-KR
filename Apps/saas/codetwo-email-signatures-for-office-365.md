---
title: CodeTwo에서 Office 365 대한 CodeTwo Email 서명에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/23/2022
...
description: Office 365 대한 CodeTwo Email 서명, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
ms.locfileid: "66784992"
---
# <a name="codetwo-email-signatures-for-office-365"></a>Office 365 대한 CodeTwo Email 서명

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 2월 23일</p>

* <a href="https://appsource.microsoft.com/product/web-apps/codetwo.3d2daeb9-a008-4070-a35c-cda39bd30a69" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

CodeTwo에서 Microsoft에 제공한 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | Office 365 대한 CodeTwo Email 서명 |
| ID | codetwo.3d2daeb9-a008-4070-a35c-cda39bd30a69 |
| 파트너 회사 이름 | CodeTwo |
| 회사 웹 사이트 | [https://www.codetwo.com](https://www.codetwo.com) |
| 앱의 사용 약관 | [https://www.codetwo.com/license-agreement](https://www.codetwo.com/license-agreement) |
| 앱의 핵심 기능 | Office 365 CodeTwo Email 서명은 모든 전자 메일 클라이언트 &amp; 디바이스에서 보낸 메시지에 자동 전자 메일 서명, 법적 고지 사항 및 브랜딩을 추가하는 Azure 기반 클라우드 서비스입니다. 이를 통해 개인(관리자 또는 위임된 사용자) 또는 팀이 Microsoft 365(Office 365) 조직에서 전자 메일 서명을 중앙에서 관리할 수 있습니다. 사용자가 입력한 대로 클라우드에서(전자 메일을 보낸 후) 또는 Outlook에서 직접 서명을 추가할 수 있습니다. |
| 회사 본사 위치 | 폴란드 |
...
이 정보는 CodeTwo에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 사용자 프로필 데이터, 사용자 메일 데이터 |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 사용자 프로필 데이터 |
...
| 개인 정보 취급 방침 URL | https://www.codetwo.com/regulations/dpa/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 위임 | 사용자가 앱에 로그인할 수 있도록 허용하고 앱에서 로그인한 사용자의 프로필을 읽을 수 있도록 합니다. 또한 앱에서 로그인한 사용자의 기본 회사 정보를 읽을 수 있습니다. | [2a93620e-4345-4e3b-9bae-0195f08aab69](../azure/2a93620e-4345-4e3b-9bae-0195f08aab69.md) |
>| User.Read | 위임 | 사용자가 앱에 로그인할 수 있도록 허용하고 앱에서 로그인한 사용자의 프로필을 읽을 수 있도록 합니다. 또한 앱에서 로그인한 사용자의 기본 회사 정보를 읽을 수 있습니다. | [7afd058a-f568-4496-96b1-28d06ab3500f](../azure/7afd058a-f568-4496-96b1-28d06ab3500f.md) |
>| Directory.AccessAsUser.All | 위임 | 앱에서 로그인한 사용자와 디렉터리의 정보에 동일한 액세스 권한을 가질 수 있습니다. | [cb657bc2-9910-4b9c-82a0-6f4f3a47006b](../azure/cb657bc2-9910-4b9c-82a0-6f4f3a47006b.md) |
>| Directory.Read.All | 둘 다 | 앱에서 사용자, 그룹 및 앱과 같은 조직&#8217;디렉터리의 데이터를 읽을 수 있습니다. | [cb657bc2-9910-4b9c-82a0-6f4f3a47006b](../azure/cb657bc2-9910-4b9c-82a0-6f4f3a47006b.md) |
>| User.ReadBasic.All | 위임 | 앱에서 로그인한 사용자를 대신하여 조직의 다른 사용자의 기본 프로필 속성 집합을 읽을 수 있습니다. 여기에는 표시 이름, 이름 및 성, 전자 메일 주소 및 사진이 포함됩니다. 정보는 사용자의 전자 메일 서명을 자동으로 개인 설정하기 위해 사용됩니다. | [cb657bc2-9910-4b9c-82a0-6f4f3a47006b](../azure/cb657bc2-9910-4b9c-82a0-6f4f3a47006b.md) |
>| User.Read | 위임 | 사용자가 앱에 로그인할 수 있도록 허용하고 앱에서 로그인한 사용자의 프로필을 읽을 수 있도록 합니다. 또한 앱에서 로그인한 사용자의 기본 회사 정보를 읽을 수 있습니다. CodeTwo 서비스에 사용자를 등록하는 데 사용됩니다. | [ce60db2f-439f-4e45-bfdc-d4c827c1820d](../azure/ce60db2f-439f-4e45-bfdc-d4c827c1820d.md) |
>| 전자 메일 | 위임 | 앱에서 사용자의 기본 전자 메일 주소를 읽을 수 있습니다. CodeTwo 서비스에 사용자를 등록하는 데 사용됩니다. | [ce60db2f-439f-4e45-bfdc-d4c827c1820d](../azure/ce60db2f-439f-4e45-bfdc-d4c827c1820d.md) |
>| offline_access | 위임 | 사용자가 현재 앱을 사용하지 않는 경우에도 앱에서 액세스 권한을 부여한 데이터를 보고 업데이트할 수 있습니다. 이렇게 하면 앱에 추가 권한이 부여되지 않습니다. | [ce60db2f-439f-4e45-bfdc-d4c827c1820d](../azure/ce60db2f-439f-4e45-bfdc-d4c827c1820d.md) |
>| openid | 위임 | 사용자가 회사 또는 학교 계정으로 앱에 로그인할 수 있도록 허용하고 앱에서 기본 사용자 프로필 정보를 볼 수 있도록 합니다. CodeTwo 서비스에 사용자를 등록하는 데 사용됩니다. | [ce60db2f-439f-4e45-bfdc-d4c827c1820d](../azure/ce60db2f-439f-4e45-bfdc-d4c827c1820d.md) |
