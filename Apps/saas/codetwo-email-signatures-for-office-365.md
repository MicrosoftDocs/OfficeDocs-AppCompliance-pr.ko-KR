---
title: CodeTwo의 Office 365 대한 CodeTwo 전자 메일 서명에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/23/2022
...
description: Office 365 CodeTwo 전자 메일 서명, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
---
# <a name="codetwo-email-signatures-for-office-365"></a>Office 365 대한 CodeTwo 전자 메일 서명
...
| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | Office 365 대한 CodeTwo 전자 메일 서명 |
...
| 앱의 핵심 기능 | Office 365 대한 CodeTwo 이메일 서명은 모든 전자 메일 클라이언트 &amp; 디바이스에서 보낸 메시지에 자동 전자 메일 서명, 법적 고지 사항 및 브랜딩을 추가하는 Azure 기반 클라우드 서비스입니다. 이를 통해 개인(관리자 또는 위임된 사용자) 또는 팀이 Microsoft 365(Office 365) 조직에서 전자 메일 서명을 중앙에서 관리할 수 있습니다. 사용자가 입력한 대로 클라우드에서(전자 메일을 보낸 후) 또는 Outlook에서 직접 서명을 추가할 수 있습니다. |
| 회사 본사 위치 | 폴란드 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 위임 | 사용자가 앱에 로그인할 수 있도록 허용하고 앱에서 로그인한 사용자의 프로필을 읽을 수 있도록 합니다. 또한 앱에서 로그인한 사용자의 기본 조직 정보를 읽을 수 있습니다. | [2a93620e-4345-4e3b-9bae-0195f08aab69](../azure/2a93620e-4345-4e3b-9bae-0195f08aab69.md) |
