---
title: Luware AG의 Microsoft Teams 대한 Luware 준수 기록에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/10/2021
...
description: Microsoft Teams 대한 Luware 준수 기록, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
ms.locfileid: "64881435"
---
# <a name="luware-compliance-recording-for-microsoft-teams"></a>Microsoft Teams 대한 Luware 준수 기록

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2021년 10월 21일</p>

* <a href="https://appsource.microsoft.com/product/web-apps/luwareagzurich.recording_azure_marketplace" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Luware AG에서 Microsoft에 제공하는 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | Microsoft Teams 대한 Luware 준수 기록 |
...
| 앱의 핵심 기능 | 모든 통신 모드를 캡처, 보관, 분석 및 검색하는 데 도움이 되는 클라우드 솔루션입니다. |
| 회사 본사 위치 | 스위스 |
| 앱 정보 페이지 | [https://luware.com/en/solution/microsoft-teams-recording/](https://luware.com/en/solution/microsoft-teams-recording/) |
...
이 정보는 Luware AG에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 발신자/수신자 정보(전화 번호, upn, 기간, 전자 메일 &amp; 메신저 주소 등), 통화 세부 정보, 메타 데이터,  |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | Azure 개체 ID, UPN, 전자 메일 &amp; 메신저 주소, 표시 이름, 이름, 성, 위치(선택 사항), 부서(선택 사항) |
| 기본 침입이 Microsoft 고객 데이터를 처리하거나 저장하는 경우 이 데이터는 지리적으로 저장되는 위치는 어디인가요? | 스위스 |
...
| 개인 정보 취급 방침 URL | https://luware.com/en/privacy-policy/ |
...
| 앱에서 위의 라이브러리 중 하나를 사용하지 않는 경우 어떤 인증 라이브러리 또는 라이브러리를 사용하나요? | Oauth 2.0 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calls.AccessMedia.All | 응용 프로그램 | Teams 기록 | [5e5d72e0-2df7-4ca7-be58-81dc28d3bdad](../azure/5e5d72e0-2df7-4ca7-be58-81dc28d3bdad.md) |
>| Calls.Initiate.All | 응용 프로그램 | Teams 기록 | [5e5d72e0-2df7-4ca7-be58-81dc28d3bdad](../azure/5e5d72e0-2df7-4ca7-be58-81dc28d3bdad.md) |
>| Calls.InitiateGroupCall.All | 응용 프로그램 | Teams 기록 | [5e5d72e0-2df7-4ca7-be58-81dc28d3bdad](../azure/5e5d72e0-2df7-4ca7-be58-81dc28d3bdad.md) |
>| Calls.JoinGroupCall.All | 응용 프로그램 | Teams 기록 | [5e5d72e0-2df7-4ca7-be58-81dc28d3bdad](../azure/5e5d72e0-2df7-4ca7-be58-81dc28d3bdad.md) |
>| Calls.JoinGroupCallasGuest.All | 응용 프로그램 | Teams 기록 | [5e5d72e0-2df7-4ca7-be58-81dc28d3bdad](../azure/5e5d72e0-2df7-4ca7-be58-81dc28d3bdad.md) |
>| Group.Read.All | 응용 프로그램 | Teams 기록 | [5e5d72e0-2df7-4ca7-be58-81dc28d3bdad](../azure/5e5d72e0-2df7-4ca7-be58-81dc28d3bdad.md) |
>| GroupMember.Read.All | 응용 프로그램 | Teams 기록 | [5e5d72e0-2df7-4ca7-be58-81dc28d3bdad](../azure/5e5d72e0-2df7-4ca7-be58-81dc28d3bdad.md) |
>| OnlineMeetings.Read.All | 응용 프로그램 | Teams 기록 | [5e5d72e0-2df7-4ca7-be58-81dc28d3bdad](../azure/5e5d72e0-2df7-4ca7-be58-81dc28d3bdad.md) |
>| OnlineMeetings.ReadWrite.All | 응용 프로그램 | Teams 기록 | [5e5d72e0-2df7-4ca7-be58-81dc28d3bdad](../azure/5e5d72e0-2df7-4ca7-be58-81dc28d3bdad.md) |
>| User.Read | 위임 | Single Sign-On | [5e5d72e0-2df7-4ca7-be58-81dc28d3bdad](../azure/5e5d72e0-2df7-4ca7-be58-81dc28d3bdad.md) |
>| User.Read.All | 응용 프로그램 | Teams 기록 | [5e5d72e0-2df7-4ca7-be58-81dc28d3bdad](../azure/5e5d72e0-2df7-4ca7-be58-81dc28d3bdad.md) |
