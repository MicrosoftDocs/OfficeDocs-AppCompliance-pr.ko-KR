---
title: CallCabinet Corporation의 CallCabinet Atmos 규정 준수 기록 및 분석에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/07/2022
...
description: CallCabinet Atmos 규정 준수 기록 및 분석, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
ms.locfileid: "66704007"
---
# <a name="callcabinet-atmos-compliance-recording-and-analytics"></a>CallCabinet Atmos 규정 준수 기록 및 분석
...
* <a href="https://appsource.microsoft.com/product/web-apps/callcabinetcorporation1584393576335.atmos" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

CallCabinet Corporation에서 Microsoft에 제공한 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | CallCabinet Atmos 규정 준수 기록 및 분석 |
| ID | callcabinetcorporation1584393576335.atmos |
| 파트너 회사 이름 | CallCabinet Corporation |
| 회사 웹 사이트 | [https://www.callcabinet.com](https://www.callcabinet.com) |
| 앱의 사용 약관 | [https://www.callcabinet.com/terms-and-conditions/](https://www.callcabinet.com/terms-and-conditions/) |
| 앱의 핵심 기능 | Atmos by CallCabinet은 Microsoft Teams 및 기타 공동 작업 또는 컨택 센터 시스템을 위한 Azure 네이티브 규정 준수 통화 녹음, AI 분석 및 QA SaaS 솔루션입니다. |
| 회사 본사 위치 | 미국 |
...
이 정보는 CallCabinet Corporation에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직의 제어에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 녹화된 Teams 대화, 비디오 및 화면 공유 |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 녹화된 Teams 대화, 비디오 및 화면 공유 |
