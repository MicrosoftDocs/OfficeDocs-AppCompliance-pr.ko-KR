...
* <a href="https://appsource.microsoft.com/product/web-apps/geomant.buzzeasy_teams_contact_center" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Zrt에서 제공하는 Geomant-Algotech. Microsoft에:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | Buzzeasy Contact Center for Teams |
| ID | geomant.buzzeasy_teams_contact_center |
| 파트너 회사 이름 | Geomant-Algotech Zrt. |
| 회사의 웹 사이트 | [https://www.buzzeasy.com](https://www.buzzeasy.com) |
...
이 정보는 Zrt에서 Geomant-Algotech 있습니다. 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터를 통해 조직이 하게 될 컨트롤에 대한 정보를 제공합니다.
...
| 데이터베이스에 저장되는 데이터는 무엇입니까? | Microsoft JWT User and refresh Token, Microsoft Application ID, App Secret, M365 Email content from Graph API |
