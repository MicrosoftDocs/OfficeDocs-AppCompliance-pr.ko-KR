...
* <a href="https://appsource.microsoft.com/product/web-apps/competellaab.sol-52202-iyi" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Competella AB에서 Microsoft에 제공한 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | Competella Communication Suite |
...
이 정보는 Competella AB에서 이 앱이 조직 데이터를 수집 및 저장하는 방법 및 조직이 수집하는 데이터를 통해 조직이 제공하는 컨트롤에 대해 제공됩니다.
...
| 데이터베이스에 저장되는 데이터는 무엇입니까? | 사용자 프로필 정보 및 대화 로그 |
...
| 개인 정보 취급 방침 URL | www.competella.com |
