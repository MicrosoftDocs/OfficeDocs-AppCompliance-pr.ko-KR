...
description: 마법사에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
ms.locfileid: "65225322"
---
# <a name="officeatwork-wizard-overview"></a>officeatwork 마법사 개요
...
* <a href="https://appsource.microsoft.com/product/web-apps/officeatwork-ag.wizard" target="_blank">AppSource에서 보기</a>
...
| 앱의 핵심 기능 | 몇 번의 클릭만으로 개인 설정된 문서를 만들고 개인 설정된 콘텐츠를 삽입합니다. |
| 회사 본사 위치 | 스위스 |
