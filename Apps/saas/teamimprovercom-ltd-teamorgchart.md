---
title: TeamImprover.Com Ltd의 TeamOrgChart에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/14/2022
...
description: TeamOrgChart, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://appsource.microsoft.com/product/web-apps/teamorgchart.66763c6e-79ef-434a-b4b5-8c64c980ac13" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

TeamImprover.Com Ltd에서 Microsoft에 제공한 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | TeamOrgChart |
| ID | teamorgchart.66763c6e-79ef-434a-b4b5-8c64c980ac13 |
| 파트너 회사 이름 | TeamImprover.Com Ltd |
| 회사 웹 사이트 | [https://teamimprover.com](https://teamimprover.com) |
| 앱의 사용 약관 | [https://teamorgchart.com/termsofservice](https://teamorgchart.com/termsofservice) |
| 앱의 핵심 기능 | 조직도 만들기, 공유, 검색 및 인쇄 |
| 회사 본사 위치 | 영국 및 북아일랜드(해당) |
| 앱 정보 페이지 | [https://teamorgchart.com/website/features.cshtml](https://teamorgchart.com/website/features.cshtml) |
...
이 정보는 TeamImprover.Com Ltd에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 조직 계층 정보는 애플리케이션에서 처리됩니다.   |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | TeamOrgChart는 차트 이름, 규칙, 책갈피, 표시 수준 수 등 차트를 설명하는 메타 데이터를 저장합니다. |
...
| 개인 정보 취급 방침 URL | https://teamorgchart.com/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 위임 | 애플리케이션은 Azure AD에서 조직도를 빌드하고 표시합니다.  Azure AD에서 사용자 정보를 읽을 수 있어야 합니다.  | [b12699ab-e60a-46b1-8c9e-231d489947aa](../azure/b12699ab-e60a-46b1-8c9e-231d489947aa.md) |
>| User.Read.All | 위임 | 애플리케이션은 Azure AD에서 조직도를 빌드하고 표시합니다.  Azure AD에서 사용자 정보를 읽을 수 있어야 합니다.  | [b12699ab-e60a-46b1-8c9e-231d489947aa](../azure/b12699ab-e60a-46b1-8c9e-231d489947aa.md) |
