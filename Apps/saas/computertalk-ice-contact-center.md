---
title: ComputerTalk의 ice Contact Center에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/01/2022
...
description: CSA STAR 레지스트리의 ice 연락처 센터, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용 가능한 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://appsource.microsoft.com/product/web-apps/computertalk.ice-contact-center" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

ComputerTalk에서 Microsoft에 제공한 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | ice Contact Center |
| ID | computertalk.ice-contact-center |
| 파트너 회사 이름 | ComputerTalk |
| 회사의 웹 사이트 | [https://www.computer-talk.com](https://www.computer-talk.com) |
| 앱 사용 약관 | [https://www.computer-talk.com/product/enterprise-contact-ce...](https://www.computer-talk.com/product/enterprise-contact-center/ice-contact-center-for-teams) |
| 앱의 핵심 기능 | ice는 통화 라우팅, 녹음/ 모니터링 및 보고를 비롯한 서비스 기능으로 연락처 센터를 제공합니다. |
| 회사 본사 위치 | 캐나다 |
| 앱 정보 페이지 | [https://www.computer-talk.com/product/enterprise-contact-ce...](https://www.computer-talk.com/product/enterprise-contact-center/ice-contact-center-for-teams) |
...
이 정보는 ComputerTalk에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직에서 제공하는 컨트롤에 대해 제공됩니다.
...
| 데이터베이스에 저장되는 데이터는 무엇입니까? | AzureADGuid(계정 연결).  전자 메일 주소 및 전화 번호는 전자 메일 주소에서 가져올 수 AAD. |
