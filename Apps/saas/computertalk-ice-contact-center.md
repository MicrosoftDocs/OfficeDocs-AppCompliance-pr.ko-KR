---
title: ComputerTalk별 ice Contact Center에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/01/2022
...
ComputerTalk에서 Microsoft에 제공하는 정보:
...
| 회사 웹 사이트 | [https://www.computer-talk.com](https://www.computer-talk.com) |
| 앱의 사용 약관 | [https://www.computer-talk.com/product/enterprise-contact-ce...](https://www.computer-talk.com/product/enterprise-contact-center/ice-contact-center-for-teams) |
| 앱의 핵심 기능 | ice는 통화 라우팅, 기록, 모니터링 및 보고를 비롯한 서비스 기능으로 컨택 센터를 제공합니다. |
| 회사 본사 위치 | 캐나다 |
...
이 정보는 ComputerTalk에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | AzureADGuid(계정 연결).  AAD 전자 메일 주소 및 전화 번호를 가져올 수 있습니다. |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | AzureADGuid(계정 연결).  AAD 전자 메일 주소 및 전화 번호를 가져올 수 있습니다. |
