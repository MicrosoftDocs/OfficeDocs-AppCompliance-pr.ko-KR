---
title: Content Guru별 Storm Cloud Contact Center Teams 통합에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/07/2022
...
description: Storm Cloud Contact Center Teams 통합, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
---
# <a name="storm-cloud-contact-center-teams-integration"></a>Storm Cloud Contact Center Teams 통합
...
* <a href="https://appsource.microsoft.com/product/web-apps/contentguru1616168120869.storm_cloud_contact_center_teams_integration" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

콘텐츠 전문가가 Microsoft에 제공한 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | Storm Cloud Contact Center Teams 통합 |
| ID | contentguru1616168120869.storm_cloud_contact_center_teams_integration |
| 파트너 회사 이름 | 콘텐츠 전문가 |
| 회사 웹 사이트 | [https://www.contentguru.com/microsoft-teams-integration/.](https://www.contentguru.com/microsoft-teams-integration/.) |
| 앱의 사용 약관 | [https://www.contentguru.com/about-us/terms-of-use/](https://www.contentguru.com/about-us/terms-of-use/) |
| 앱의 핵심 기능 | 통합 CCaaS 솔루션을 위해 Storm Cloud Contact Center를 Microsoft Teams와 통합합니다. |
| 회사 본사 위치 | 영국 및 북아일랜드(해당) |
| 앱 정보 페이지 | [https://www.contentguru.com/microsoft-teams-integration/](https://www.contentguru.com/microsoft-teams-integration/) |
...
이 정보는 Content Guru에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 제공했습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | EUII(미국 사용자 참조), OII(MS 조직 참조), 통화 세부 정보 및 EUII(사용자 프로필 데이터) |
...
| 개인 정보 취급 방침 URL | https://www.contentguru.com/about-us/privacy-cookies-policy/ |
