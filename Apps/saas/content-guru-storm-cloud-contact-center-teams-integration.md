---
title: 콘텐츠 Guru의 통합을 Teams 클라우드 연락처 센터에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/11/2022
...
description: 클라우드 연락처 센터 통합, 데이터 Teams 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용할 수 있는 모든 보안 및 규정 준수 정보
...
ms.locfileid: "63459844"
---
# <a name="storm-cloud-contact-center-teams-integration"></a>스와일드 클라우드 연락처 센터 Teams 통합

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 3월 10일</p>

* <a href="https://appsource.microsoft.com/product/web-apps/contentguru1616168120869.storm_cloud_contact_center_teams_integration" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Content Guru가 Microsoft에 제공한 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | 스와일드 클라우드 연락처 센터 Teams 통합 |
| ID | contentguru1616168120869.storm_cloud_contact_center_teams_integration |
| 파트너 회사 이름 | 콘텐츠 Guru |
| 회사의 웹 사이트 | [https://www.contentguru.com/microsoft-teams-integration/.](https://www.contentguru.com/microsoft-teams-integration/.) |
| 앱 사용 약관 | [https://www.contentguru.com/about-us/terms-of-use/](https://www.contentguru.com/about-us/terms-of-use/) |
| 앱의 핵심 기능 | 통합 CCaaS 솔루션에 Microsoft Teams 클라우드 연락처 센터를 통합합니다. |
...
이 정보는 콘텐츠 Guru에서 이 앱이 조직 데이터를 수집 및 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직이 하게 될 컨트롤에 대해 제공했습니다.
