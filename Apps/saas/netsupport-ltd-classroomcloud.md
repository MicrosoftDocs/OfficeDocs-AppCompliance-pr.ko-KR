...
* <a href="https://appsource.microsoft.com/product/web-apps/netsupportltd1595255396224.classroom_cloud" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

NETSUPPORT LTD에서 제공하는 정보입니다. Microsoft에:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | Classroom.cloud |
| ID | netsupportltd1595255396224.classroom_cloud |
| 파트너 회사 이름 | NETSUPPORT LTD. |
| 회사의 웹 사이트 | [https://www.NetSupportSoftware.com](https://www.NetSupportSoftware.com) |
...
이 정보는 NETSUPPORT LTD에서 제공됩니다. 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터를 통해 조직이 하게 될 컨트롤에 대한 정보를 제공합니다.
...
| 데이터베이스에 저장되는 데이터는 무엇입니까? | 전자 메일 주소, 장치 ID |
...
| 개인 정보 취급 방침 URL | https://classroom.cloud/data-processing-agreement/ |
...
>|:------------------------|:--------------------|:------------------------------------|
>| Team.ReadBasic.All | application | 학생 Teams 온라인 보안 모니터링을 제공하기 위해 classroom.cloud 통합에 사용됩니다. |
>| Channel.ReadBasic.All | application | 학생 Teams 온라인 보안 모니터링을 제공하기 위해 classroom.cloud 통합에 사용됩니다. |
>| ChannelMessage.Read.All | application | 학생 Teams 온라인 보안 모니터링을 제공하기 위해 classroom.cloud 통합에 사용됩니다. |
>| ChannelSettings.Read.All | application | 학생 Teams 온라인 보안 모니터링을 제공하기 위해 classroom.cloud 통합에 사용됩니다. |
>| Chat.Read.All | application | 학생 Teams 온라인 보안 모니터링을 제공하기 위해 classroom.cloud 통합에 사용됩니다. |
>| Directory.Read.All | application | 학생 Teams 온라인 보안 모니터링을 제공하기 위해 classroom.cloud 통합에 사용됩니다. |
