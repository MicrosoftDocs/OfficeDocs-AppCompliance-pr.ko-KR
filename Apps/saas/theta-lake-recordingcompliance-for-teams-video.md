---
title: Theta Lake의 Teams 비디오용 Theta Lake 기록 &amp; 규정 준수에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/16/2022
...
description: Teams 비디오용 Theta Lake 기록 &amp; 규정 준수, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
ms.locfileid: "66809049"
---
# <a name="theta-lake-recording-amp-compliance-for-teams-video"></a>Teams용 Theta Lake 기록 &amp; 규정 준수 비디오

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 3월 7일</p>

* <a href="https://appsource.microsoft.com/product/web-apps/thetalake.thetalake_recording_and_compliance_for_teams" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Theta Lake에서 Microsoft에 제공하는 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | Teams용 Theta Lake 기록 &amp; 규정 준수 비디오 |
| ID | thetalake.thetalake_recording_and_compliance_for_teams |
| 파트너 회사 이름 | 세타 호수 |
| 회사 웹 사이트 | [https://thetalake.com](https://thetalake.com) |
| 앱의 사용 약관 | [https://thetalake.com/privacy-policy](https://thetalake.com/privacy-policy) |
| 앱의 핵심 기능 | Microsoft Teams 오디오 및 비디오 모임에 대한 기록, 보관, 규정 준수 및 위험 완화 |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
...
이 정보는 Theta Lake에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | Microsoft 비디오, Microsoft Teams 채팅 |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | Microsoft 비디오, Microsoft Teams 채팅 |
...
| 개인 정보 취급 방침 URL | https://thetalake.com/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calls.JoinGroupCall.All | 위임 | Graph API 통화 레코드를 수신하려면 액세스해야 합니다. | [1cc8eecf-56f3-4137-a0fe-4b0466ca0677](../azure/1cc8eecf-56f3-4137-a0fe-4b0466ca0677.md) |
