---
title: Theta Lake의 &amp; 비디오에 대한 세타 호 기록 Teams 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/16/2022
...
description: Theta Lake Recording &amp; Compliance for Teams Video, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용할 수 있는 모든 보안 및 규정 준수 정보
...
* <a href="https://appsource.microsoft.com/product/web-apps/thetalake.thetalake_recording_and_compliance_for_teams" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Theta Lake에서 Microsoft에 제공한 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | Theta Lake Recording Compliance &amp; for Teams Video |
| ID | thetalake.thetalake_recording_and_compliance_for_teams |
| 파트너 회사 이름 | 세타 호 |
| 회사의 웹 사이트 | [https://thetalake.com](https://thetalake.com) |
| 앱 사용 약관 | [https://thetalake.com/privacy-policy](https://thetalake.com/privacy-policy) |
| 앱의 핵심 기능 | 오디오 및 비디오 모임에 대한 기록Microsoft Teams 보관, 규정 준수 및 위험 완화 |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
...
이 정보는 Theta Lake에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직에서 제공하는 컨트롤에 대해 제공됩니다.
...
| 데이터베이스에 저장되는 데이터는 무엇입니까? | Microsoft 비디오, Microsoft Teams 채팅 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calls.JoinGroupCall.All | 위임 | Graph 레코드를 수신하기 위해 API에 액세스해야 합니다. | [1cc8eecf-56f3-4137-a0fe-4b0466ca0677](../azure/1cc8eecf-56f3-4137-a0fe-4b0466ca0677.md) |
