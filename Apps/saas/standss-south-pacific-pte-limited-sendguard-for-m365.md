---
title: 독립 실행형(남 태평양) PTE Limited의 M365용 SendGuard에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
ms.date: 12/10/2021
ms.topic: article
...
description: M365용 SendGuard에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보
...
---
# <a name="sendguard-for-m365"></a>M365용 SendGuard
...
독립 실행형(남 태평양) PTE Limited에서 Microsoft에 제공한 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | M365용 SendGuard |
| ID | standssouthpacificltd1581455821226.emailnotes |
| 파트너 회사 이름 | 독립 실행형(남 태평양) PTE Limited |
| 회사의 웹 사이트 | [https://www.standss.com](https://www.standss.com) |
...
| 앱의 핵심 기능 | Outlook M365용 SendGuard는 의도하지 않은 받는 사람에게 중요한 정보, 기밀 또는 부적절한 정보를 전자 메일로 전송하는 것을 감지, 프롬프트, 경고 및 보호하는 위험 및 규정 준수 도구입니다. |
| 회사 본사 위치 | 피지 |
| 앱 정보 페이지 | |
...
이 정보는 독립 실행형(남 태평양) PTE Limited에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직이 제어할 수 있는 컨트롤에 의해 제공됩니다.
...
| 개인 정보 취급 방침 URL | http://www.standss.com/sr/sg_m365/privacy_policy.asp |
...
| 지원되는 정책 유형 나열 | 관리 역할을 가진 사용자에 대한 다단계 인증 필요 |
