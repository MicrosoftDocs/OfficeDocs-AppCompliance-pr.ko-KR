---
title: Puzzel AS에 의한 Puzzel Microsoft Teams 통합에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/07/2022
...
description: Puzzel Microsoft Teams 통합, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
| 앱의 핵심 기능 | Puzzel이 Microsoft Teams와 통합되어 에이전트가 더 가까워지고 협업이 더 쉬워집니다. 에이전트는 Puzzel 에이전트 애플리케이션을 종료하지 않고도 Teams를 호출하고, 메시지를 보내고, 연락처를 검색하고 전송할 수 있습니다. 사용자는 다른 에이전트가 온라인, 바쁜, 멀리 또는 통화 중인지 여부와 조직 전체의 다른 모든 동료의 현재 상태도 확인할 수 있습니다. 에이전트는 Teams에서 연락처&#8217; 일정 및 일정을 보고 계획, 모임 및 통화를 더 잘 맞출 수 있습니다. |
| 회사 본사 위치 | 노르웨이 |
