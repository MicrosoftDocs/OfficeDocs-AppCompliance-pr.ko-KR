---
title: Puzzel AS의 Puzzel Microsoft Teams 통합에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/09/2022
...
description: Puzzel Microsoft Teams Integration, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
---
# <a name="puzzel-microsoft-teams-integration"></a>Puzzel Microsoft Teams 통합

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 6월 9일</p>

* <a href="https://appsource.microsoft.com/product/web-apps/puzzel-5257631.puzzel_teams_integration" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Puzzel AS에서 Microsoft에 제공한 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | Puzzel Microsoft Teams 통합 |
| ID | puzzel-5257631.puzzel_teams_integration |
| 파트너 회사 이름 | Puzzel AS |
| 회사 웹 사이트 | [https://www.puzzel.com](https://www.puzzel.com) |
| 앱의 사용 약관 | [https://www.puzzel.com/neighbourhood/trust-centre/privacy-p...](https://www.puzzel.com/neighbourhood/trust-centre/privacy-policy) |
| 앱의 핵심 기능 | Puzzel과 Microsoft Teams 통합하면 에이전트가 더 가까워지고 협업이 더 쉬워집니다. 에이전트는 Puzzel 에이전트 애플리케이션을 종료하지 않고도 Teams 통화를 하고, 메시지를 보내고, 연락처를 검색하고 전송할 수 있습니다. 사용자는 다른 에이전트가 온라인, 바쁜, 멀리 또는 통화 중인지 여부와 조직 전체의 다른 모든 동료의 현재 상태도 확인할 수 있습니다. 에이전트는 Teams 일정 및 일정을&#8217; 연락처를 보고 계획, 모임 및 통화를 더 잘 맞출 수 있습니다. |
| 회사 본사 위치 | 노르웨이 |
| 앱 정보 페이지 | [https://www.puzzel.com/microsoft-teams](https://www.puzzel.com/microsoft-teams) |
...
이 정보는 Puzzel AS에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 현재 상태 데이터, 사용자 데이터, 일정 데이터 |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 사용자 데이터, 일정 데이터 |
| 기본 침입이 Microsoft 고객 데이터를 처리하거나 저장하는 경우 이 데이터는 지리적으로 저장되는 위치는 어디인가요? | 노르웨이, 영국 및 북아일랜드(해당) |
...
| 개인 정보 취급 방침 URL | https://www.puzzel.com/neighbourhood/trust-centre |
