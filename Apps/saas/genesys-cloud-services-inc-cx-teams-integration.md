---
title: Genesys cloud CX Teams Integration by Genesys Cloud Services, Inc.에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/07/2022
...
description: Genesys Cloud CX Teams 통합, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
---
# <a name="genesys-cloud-cx-teams-integration"></a>Genesys Cloud CX Teams 통합

<p></p><a href="https://aka.ms/appcertification" alt="This Microsoft 365 Certified app has been reviewed by Microsoft against industry standards and controls for security, compliance, and data handling practices. Where applicable, Microsoft has verified the developer's claims of compliance with reasonable and effective practices." target="_blank"><img alt="Click here for more information on the Microsoft Certified app program." src="../media/certified.png" width="650" /></a>
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 2월 28일</p>

* <a href="https://appsource.microsoft.com/product/web-apps/genesyslabs.genesys-cloud_teams_integration" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Genesys Cloud Services, Inc에서 Microsoft에 제공한 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | Genesys Cloud CX Teams 통합 |
| ID | genesyslabs.genesys-cloud_teams_integration |
| 파트너 회사 이름 | Genesys Cloud Services, Inc. |
| 회사 웹 사이트 | [https://www.genesys.com](https://www.genesys.com) |
| 앱의 사용 약관 | [https://help.mypurecloud.com/articles/global-genesys-cloud-...](https://help.mypurecloud.com/articles/global-genesys-cloud-service-terms-and-conditions/) |
| 앱의 핵심 기능 | Genesys Cloud CX&#8482; Integration for Microsoft Teams |
| 회사 본사 위치 | 미국 |
...
이 정보는 Genesys Cloud Services, Inc.에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Presence.Read.All | 둘 다 | 연락처 센터 에이전트는 전화를 옮기기 전에 동료의 현재 상태를 볼 수 있어야 합니다. | [728ece5a-0f26-4c43-9705-cea9debe3fb5](../azure/728ece5a-0f26-4c43-9705-cea9debe3fb5.md) |
