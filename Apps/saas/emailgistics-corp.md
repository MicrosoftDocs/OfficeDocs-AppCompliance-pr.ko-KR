---
title: Emailgistics Corp.의 Emailgistics에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/21/2022
...
description: Emailgistics, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
ms.locfileid: "64881055"
---
# <a name="emailgistics"></a>전자 메일 분석

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 1월 20일</p>

* <a href="https://appsource.microsoft.com/product/web-apps/emailgistics.emailgistics_shared_email" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Emailgistics Corp.에서 Microsoft에 제공한 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | 전자 메일 분석 |
| ID | emailgistics.emailgistics_shared_email |
| 파트너 회사 이름 | Emailgistics Corp. |
| 회사 웹 사이트 | [https://emailgistics.com](https://emailgistics.com) |
| 앱의 사용 약관 | [https://emailgistics.com/tos](https://emailgistics.com/tos) |
| 앱의 핵심 기능 | Microsoft 365용 팀 받은 편지함 전자 메일 관리 소프트웨어 |
| 회사 본사 위치 | 캐나다 |
| 앱 정보 페이지 | [https://emailgistics.com/how-it-works](https://emailgistics.com/how-it-works) |
...
이 정보는 Emailgistics Corp.에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 공유 사서함 데이터 |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 메일 머리글 데이터(제목, 주소, 타임스탬프) |
...
| 개인 정보 취급 방침 URL | https://emailgistics.com/privacy |
...
| 앱에서 위의 라이브러리 중 하나를 사용하지 않는 경우 어떤 인증 라이브러리 또는 라이브러리를 사용하나요? | golang.org/x/oauth2 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Mail.ReadWrite | 위임 | 액세스 권한을 읽어 공유 사서함의 메시지에 대한 정보를 가져옵니다. 메시지 정보는 고객 정의 규칙(예: &#8220;청구서&#8221; 포함된 경우 사용자 A에 배포), 대화를 올바르게 추적(대화 기록 및 자동 할당의 경우) 및 보고(예: 메시지 세부 정보 보고서 열기)를 실행하는 데 필요합니다.
규칙(예: 자동 회신)에서 메시지를 보내고 메시지 제목을 Emailgistics 대화 ID로 업데이트하기 위한 액세스 권한을 작성합니다. | [2c9fb9b7-5112-4a91-af52-f98682bc7bf3](../azure/2c9fb9b7-5112-4a91-af52-f98682bc7bf3.md) |
>| Mail.Send | 위임 | Emailgistics가 공유 사서함에서 전자 메일 메시지를 보낼 수 있도록 허용합니다. 이 권한은 규칙(예: 자동 회신)에서 메시지를 보내는 데 필요합니다. | [2c9fb9b7-5112-4a91-af52-f98682bc7bf3](../azure/2c9fb9b7-5112-4a91-af52-f98682bc7bf3.md) |
>| MailboxSettings.ReadWrite | 위임 | Emailgistics에서 공유 사서함 이름을 가져와서 초기 처리, 규칙 실행 및 자동 할당을 위해 들어오는 메시지를 숨겨진 수신 폴더로 라우팅하는 사서함 규칙을 만들 수 있습니다. | [2c9fb9b7-5112-4a91-af52-f98682bc7bf3](../azure/2c9fb9b7-5112-4a91-af52-f98682bc7bf3.md) |
>| User.Read | 위임 | Emailgistics가 공유 사서함으로 로그인하고 서비스 주체 ID, 전자 메일 주소 및 사용자 이름과 같은 기본 정보를 읽을 수 있도록 허용합니다. | [2c9fb9b7-5112-4a91-af52-f98682bc7bf3](../azure/2c9fb9b7-5112-4a91-af52-f98682bc7bf3.md) |
>| User.ReadBasic.All | 위임 | Emailgistics가 테넌트에서 사용자에 대한 기본 정보를 읽을 수 있도록 허용합니다. 사서함 구성원의 전자 메일 주소 및 이름 변경 내용을 검색하고 Emailgistics에서 추적 및 보고 목적으로 사용되는 이 정보를 자동으로 업데이트하는 데 필요합니다. 이 권한은 공유 사서함을 넘어 범위가 확장되는 유일한 권한입니다. | [2c9fb9b7-5112-4a91-af52-f98682bc7bf3](../azure/2c9fb9b7-5112-4a91-af52-f98682bc7bf3.md) |
>| offline_access | 위임 | Emailgistics가 작동할 때마다 사용자가 로그인하도록 요구하는 대화형 브라우저 기반 앱 대신 백 엔드 애플리케이션으로 작동할 수 있습니다. 이 권한을 통해 Emailgistics는 상수 액세스를 유지하기 위해 필요에 따라 새로 고칠 수 있는 새로 고침 토큰을 가져올 수 있습니다. | [2c9fb9b7-5112-4a91-af52-f98682bc7bf3](../azure/2c9fb9b7-5112-4a91-af52-f98682bc7bf3.md) |
