---
title: FluentPro Software Corporation의 Project Migrator에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/31/2022
...
description: Project Migrator, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
ms.locfileid: "65811255"
---
# <a name="project-migrator"></a>Project Migrator

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 5월 30일</p>

* <a href="https://appsource.microsoft.com/product/web-apps/fluentpro-4571949.project_migrator" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

FluentPro Software Corporation에서 Microsoft에 제공한 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | Project Migrator |
| ID | fluentpro-4571949.project_migrator |
| 파트너 회사 이름 | FluentPro Software Corporation |
| 회사 웹 사이트 | [https://fluentpro.com](https://fluentpro.com) |
| 앱의 사용 약관 | [https://projectmigrator.com/terms-of-use/](https://projectmigrator.com/terms-of-use/) |
| 앱의 핵심 기능 | 가장 인기 있는 프로젝트 관리 소프트웨어 간에 프로젝트를 마이그레이션합니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://projectmigrator.com](https://projectmigrator.com) |
...
이 정보는 FluentPro Software Corporation에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직의 제어에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 사용자 프로필 데이터, MS365 그룹 데이터, 웹 데이터에 대한 Project. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 위임 | Planner 데이터 읽기 및 쓰기 | [77b31e8c-65d0-484d-a72f-9404ec9dfcfa](../azure/77b31e8c-65d0-484d-a72f-9404ec9dfcfa.md) |
>| Group.ReadWrite.All | 위임 | Planner 데이터 읽기 및 쓰기 | [77b31e8c-65d0-484d-a72f-9404ec9dfcfa](../azure/77b31e8c-65d0-484d-a72f-9404ec9dfcfa.md) |
>| Sites.ReadWrite.All | 위임 | Planner 데이터 읽기 및 쓰기 | [77b31e8c-65d0-484d-a72f-9404ec9dfcfa](../azure/77b31e8c-65d0-484d-a72f-9404ec9dfcfa.md) |
>| User.Read | 위임 | Planner 데이터 읽기 및 쓰기 | [77b31e8c-65d0-484d-a72f-9404ec9dfcfa](../azure/77b31e8c-65d0-484d-a72f-9404ec9dfcfa.md) |
>| User.ReadBasic.All | 위임 | Planner 데이터 읽기 및 쓰기 | [77b31e8c-65d0-484d-a72f-9404ec9dfcfa](../azure/77b31e8c-65d0-484d-a72f-9404ec9dfcfa.md) |
>| offline_access | 위임 | Planner 데이터의 마이그레이션 실패 다시 시작 | [77b31e8c-65d0-484d-a72f-9404ec9dfcfa](../azure/77b31e8c-65d0-484d-a72f-9404ec9dfcfa.md) |
>| User.Read | 위임 | 사용자 로그인 | [c36d31a2-8de1-4eb5-9e7d-01da45244c04](../azure/c36d31a2-8de1-4eb5-9e7d-01da45244c04.md) |
>| 전자 메일 | 위임 | 사용자의 사서함 읽기 | [c36d31a2-8de1-4eb5-9e7d-01da45244c04](../azure/c36d31a2-8de1-4eb5-9e7d-01da45244c04.md) |
>| openid | 위임 | 사용자 로그인 | [c36d31a2-8de1-4eb5-9e7d-01da45244c04](../azure/c36d31a2-8de1-4eb5-9e7d-01da45244c04.md) |
>| 프로필 | 위임 | 사용자 로그인 | [c36d31a2-8de1-4eb5-9e7d-01da45244c04](../azure/c36d31a2-8de1-4eb5-9e7d-01da45244c04.md) |
>| Directory.Read.All | 위임 | 웹 데이터에 대한 Project 읽기 및 쓰기 | [ca9b0417-d519-4ed6-ae2a-d939583a083c](../azure/ca9b0417-d519-4ed6-ae2a-d939583a083c.md) |
>| Group.Read.All | 위임 | 웹 데이터에 대한 Project 읽기 및 쓰기 | [ca9b0417-d519-4ed6-ae2a-d939583a083c](../azure/ca9b0417-d519-4ed6-ae2a-d939583a083c.md) |
>| Group.ReadWrite.All | 위임 | 웹 데이터에 대한 Project 읽기 및 쓰기 | [ca9b0417-d519-4ed6-ae2a-d939583a083c](../azure/ca9b0417-d519-4ed6-ae2a-d939583a083c.md) |
>| User.Read | 위임 | 웹 데이터에 대한 Project 읽기 및 쓰기 | [ca9b0417-d519-4ed6-ae2a-d939583a083c](../azure/ca9b0417-d519-4ed6-ae2a-d939583a083c.md) |
>| User.ReadBasic.All | 위임 | 웹 데이터에 대한 Project 읽기 및 쓰기 | [ca9b0417-d519-4ed6-ae2a-d939583a083c](../azure/ca9b0417-d519-4ed6-ae2a-d939583a083c.md) |
