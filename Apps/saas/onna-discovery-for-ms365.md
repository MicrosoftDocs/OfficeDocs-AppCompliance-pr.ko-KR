---
title: Onna의 MS365용 Onna 검색에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/22/2021
...
description: MS365용 Onna Discovery에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보
...
ms.locfileid: "63552227"
---
# <a name="onna-discovery-for-ms365"></a>MS365용 Onna 검색

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2021년 11월 2일</p>

* <a href="https://appsource.microsoft.com/product/web-apps/onna1600902517721.onna-discovery-1" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Onna에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | Onna |
| 회사의 웹 사이트 | [https://onna.com](https://onna.com) |
| 앱 사용 약관 | [https://onna.com/master-subscription-agreement](https://onna.com/master-subscription-agreement) |
| 앱의 핵심 기능 | Onna는 데이터 수집, 검색 및 초기 사례 평가를 Microsoft 365 |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://onna.com/features](https://onna.com/features) |
...
이 정보는 Onna에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직이 제공하는 컨트롤에 대해 제공됩니다.
...
| 데이터베이스에 저장되는 데이터는 무엇입니까? | 전자 메일, 전자 메일 주소, 사용자 ID, 채팅, 파일. 보존 및 제거 정책은 최종 사용자가 구성할 수 있습니다.  |
...
| 개인 정보 취급 방침 URL | https://onna.com/privacy-policy/ |
