---
title: WORKSTREAMPEOPLE BV에서 사용할 수 있는 Anywhere365 Teams 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: CSA STAR 레지스트리의 Anywhere365 Teams, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용 가능한 모든 보안 및 규정 준수 정보입니다.
...
ms.locfileid: "64602494"
---
# <a name="anywhere365-contact-center-for-teams"></a>Anywhere365 Teams

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 3월 14일</p>

* <a href="https://appsource.microsoft.com/product/web-apps/workstreampeople.anywhere365contactcenterforteams" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

WORKSTREAMPEOPLE BV에서 Microsoft에 제공하는 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | Anywhere365 Teams |
| ID | workstreampeople.anywhere365contactcenterforteams |
| 파트너 회사 이름 | WORKSTREAMPEOPLE BV |
| 회사의 웹 사이트 | [https://anywhere365.io](https://anywhere365.io) |
| 앱 사용 약관 | [https://anywhere365.io/wspstorage/2022/02/Anywhere365-Dialo...](https://anywhere365.io/wspstorage/2022/02/Anywhere365-Dialogue-Cloud-Agreement_202112_V3.6.pdf) |
| 앱의 핵심 기능 | Anywhere365&#174; Dialogue Cloud platform for Omnichannel Communications는 Azure, Sharepoint 및 Teams Dynamics 365, PowerApps 및 PowerBI에 완전히 통합된 Teams Microsoft 인증 연락처 센터입니다. 낮은 코드 통신 자동화 플랫폼 Dialogue Studio를 사용하여 모든 API 기반 봇 프레임워크, 통신 계층 및 인텔리전스 시스템과 통합할 수 있습니다. |
| 회사 본사 위치 | 네덜란드(the) |
| 앱 정보 페이지 | [https://anywhere365.io/category/anywhere365-dialogue-cloud/](https://anywhere365.io/category/anywhere365-dialogue-cloud/) |
...
이 정보는 WORKSTREAMPEOPLE BV에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터에 대해 조직에서 제공하는 컨트롤에 대해 제공합니다.
...
| 데이터베이스에 저장되는 데이터는 무엇입니까? | 통신 현재 &amp; 상태 데이터 |
| Microsoft 고객 데이터를 원본으로 사용하여 처리하거나 저장하는 경우 이 데이터는 지리적으로 저장되는 위치입니다. | 네덜란드(더), 미국, 싱가포르 |
...
| 개인 정보 취급 방침 URL | https://anywhere365.io/wp-content/uploads/2021/07/Anywhere365-Privacy-Policy-2021.pdf |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 위임 | 고객 도메인 수집 | [d1762bac-3696-429d-ab0b-2a61463d6b7a](../azure/d1762bac-3696-429d-ab0b-2a61463d6b7a.md) |
>| Presence.Read.All | 위임 | 고객 현재 상태 세부 정보를 수집합니다. | [d1762bac-3696-429d-ab0b-2a61463d6b7a](../azure/d1762bac-3696-429d-ab0b-2a61463d6b7a.md) |
>| User.ReadBasic.All | 위임 | 고객 표시 이름 수집 | [d1762bac-3696-429d-ab0b-2a61463d6b7a](../azure/d1762bac-3696-429d-ab0b-2a61463d6b7a.md) |
