---
title: SaaS 앱에 대한 사용자 가이드
author: LGerrard
ms.author: legerrar
manager: tonybal
description: Microsoft 365 앱 준수 프로그램 SaaS에 대한 ISV 사용자 가이드
...
## <a name="3-publisher-attestation-workflow"></a>3. Publisher 증명 워크플로
...
![파트너 센터의 상업용 Marketplace](../media/NewPChomepage.png)

  
**2단계**: 'Marketplace 제품'을 선택한 후 '상업용 Marketplace'로 전환합니다.

![상업용 Marketplace에서 앱 선택](../media/NewPCOffersOffice.png)

목록에서 앱을 선택하면 '앱 준수' 옵션과 함께 다른 탐색 모음이 나타납니다.
  
**3단계**: '앱 준수' 선택
  
![상업용 Marketplace의 앱 규정 준수](../media/PCappcompliance3.png)
  
**4단계**: Publisher 증명에 대한 자체 평가 설문지를 작성합니다.

![Publisher 증명 완료](../media/UserGuidePhotos/5.5.png)
...
![내보내기 가져오기 기능](../media/UserGuidePhotos/06.png)
 
**5단계**: 완료되면 '제출'을 클릭하면 평가가 '검토 중'이 됩니다.
 
 ![제출 Publisher 인증](../media/UserGuidePhotos/07.png) ![확인 제출](../media/UserGuidePhotos/08.png)
...
![Publisher 증명 거부됨](../media/UserGuidePhotos/09.png)
...
- 승인 시 파트너는 다음을 수행할 수 있습니다.
 ...
 ![Publisher 증명 완료됨](../media/UserGuidePhotos/10.png)       
...
![Microsoft 365 인증 시작](../media/UserGuidePhotos/13.png) 
...
![Submit 초기 문서 제출](../media/UserGuidePhotos/15.png)
  
제출을 클릭하면 초기 문서 제출이 검토됩니다.

![검토 중인 초기 문서 제출](../media/UserGuidePhotos/16.png)
...
![완전한 제어 요구 사항](../media/UserGuidePhotos/18.png)
...
![사후 인증 승인](../media/UserGuidePhotos/27.png)
...
![Renewel 승인됨](../media/UserGuidePhotos/31.png)
  
**2단계**: 이전 Publisher 증명 답변을 검토하고 필요에 따라 최신 정보로 업데이트합니다. 
  
준비가 되면 갱신을 위해 Publisher 증명을 제출합니다. M365 앱 준수 분석가가 검토합니다.

![증명으로 갱신](../media/UserGuidePhotos/29.png)
  
**Publisher 증명 갱신 승인됨:**
  
![갱신을 위해 제출](../media/UserGuidePhotos/30.png)
...
![증명 갱신](../media/UserGuidePhotos/32.png) 
