...
![초기 제출 ](../media/UserGuidePhotos/14.png)
 ![ 초기 제출 2](../media/UserGuidePhotos/15.png)
...
![완전한 제어 요구 ](../media/UserGuidePhotos/18.png)
 ![ 사항업로드 ](../media/UserGuidePhotos/19.png)
 ![ 증거 보장 제어 요구 사항이 완료되었습니다.](../media/UserGuidePhotos/20.png)
...
![증거 업데이트 ](../media/UserGuidePhotos/22.png)
 ![ 필요 검토에서 증거를 업데이트해야 하는 ](../media/UserGuidePhotos/23.png)
 ![ 증거 이해](../media/UserGuidePhotos/24.png)
