---
title: Canon EMEA의 B2B 파트너용 Canon EMEA 서비스 비용 계산기에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: B2B 파트너용 Canon EMEA 서비스 비용 계산기, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
ms.locfileid: "64879885"
---
# <a name="canon-emea-service-cost-calculator-for-b2b-partners"></a>B2B 파트너를 위한 Canon EMEA 서비스 비용 계산기

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2021년 8월 3일</p>

* <a href="https://appsource.microsoft.com/product/office/WA200003098" target="_blank">AppSource에서 보기</a>
...
| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | B2B 파트너를 위한 Canon EMEA 서비스 비용 계산기 |
| ID | WA200003098 |
| 지원되는 Office 365 클라이언트 | Windows 2013년 이후 Excel Mac에서 Excel 2016 이상 웹용 Excel |
| 파트너 회사 이름 | Canon EMEA |
| 회사 웹 사이트 | [https://www.canon-europe.com](https://www.canon-europe.com) |
| 앱의 사용 약관 | [https://partners.canon-europe.com/partners/s/Terms%20and%20...](https://partners.canon-europe.com/partners/s/Terms%20and%20Conditions%20-%20English%20(Partner%20Portal)) |
| 앱의 핵심 기능 | Canon 프린터의 정확하고 투명하며 생산적인 서비스 비용 계산(B2B) |
| 회사 본사 위치 | 네덜란드 (the) |
| 앱 정보 페이지 | |
...
이 정보는 Canon EMEA에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
