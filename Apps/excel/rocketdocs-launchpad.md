---
title: RocketDocs의 RocketDocs 시작 패드에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/24/2022
...
description: RocketDocs LaunchPad, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보
...
* <a href="https://appsource.microsoft.com/product/office/WA200003648" target="_blank">AppSource의 보기</a>
...
| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | RocketDocs LaunchPad |
| ID | WA200003648 |
| Office 365 클라이언트 지원 | Excel 2016 Mac, Excel 2016 이상, Windows, 웹용 Excel Word 2016, mac, 웹용 Word, Word 2016 이상에서 Windows, Word 2016 이상으로 Windows |
| 파트너 회사 이름 | RocketDocs |
| 회사의 웹 사이트 | [https://rocketdocs.com](https://rocketdocs.com) |
| 앱 사용 약관 | [https://rocketdocs.com/end-user-license-agreement/](https://rocketdocs.com/end-user-license-agreement/) |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직이 제어할 수 있는 방법에 대해 RocketDocs에서 제공했습니다.
