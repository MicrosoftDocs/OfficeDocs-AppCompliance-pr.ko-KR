---
title: MeaningCloud의 앱에 대한 MeaningCloud 텍스트 Excel 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/20/2021
...
description: CSA STAR 레지스트리의 Excel, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용 가능한 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://appsource.microsoft.com/product/office/WA200002421" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

MeaningCloud에서 Microsoft에 제공하는 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | MeaningCloud Text Analytics for Excel |
| ID | WA200002421 |
| Office 365 클라이언트 지원 | Excel 2016 Mac, Excel 2013 이상에서 Windows 웹용 Excel |
| 파트너 회사 이름 | MeaningCloud |
| 회사의 웹 사이트 | [https://meaningcloud.com](https://meaningcloud.com) |
| 앱 사용 약관 | [https://www.meaningcloud.com/terms-and-conditions](https://www.meaningcloud.com/terms-and-conditions) |
| 앱의 핵심 기능 | 스프레드시트에서 직접 텍스트 Excel 수행 |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://www.meaningcloud.com/developer/excel-365-addin](https://www.meaningcloud.com/developer/excel-365-addin) |
...
이 정보는 MeaningCloud에서 이 앱이 조직 데이터를 수집 및 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직이 가지는 컨트롤에 대해 제공됩니다.
...
| 개인 정보 취급 방침 URL | https://www.meaningcloud.com/data-protection-policy |
