---
title: 의미 클라우드에 의해 Excel 위한 의미 클라우드 텍스트 분석을 위한 응용 프로그램 정보 클라우드
ms.author: elmalova
author: elenamalova
ms.date: 12/29/2020
ms.topic: article
...
description: Excel 위한 MeaningCloud 텍스트 분석, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 대한 사용 가능한 모든 보안 및 규정 준수 정보.
...
ms.locfileid: "52548818"
---
# <a name="meaningcloud-text-analytics-for-excel"></a>Excel 위한 의미 클라우드 텍스트 분석

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>최종 업데이트: 2020년 12월 29일</p>

* <a href="https://appsource.microsoft.com/product/office/WA200002421" target="_blank">앱소스에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

마이크로소프트에 의미 클라우드에서 제공 하는 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | Excel 위한 의미 클라우드 텍스트 분석 |
| ID | WA200002421 |
...
| 개인정보 처리방침의 URL | [https://www.meaningcloud.com/data-protection-policy](https://www.meaningcloud.com/data-protection-policy) |
| 이용 약관의 URL | [https://www.meaningcloud.com/terms-and-conditions](https://www.meaningcloud.com/terms-and-conditions) |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 조직에서 앱이 수집하는 데이터에 대한 제어에 대해 MeaningCloud에서 제공했습니다.
...
<iframe height='1020' title='Microsoft Cloud App Security 정보' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/36382' frameborder='no' style='width: 100%;'></iframe>
...
이 정보는 이 앱이 인증, 권한 부여, 응용 프로그램 등록 모범 사례 및 기타 ID 기준을 처리하는 방법에 대해 MeaningCloud에서 제공했습니다.
