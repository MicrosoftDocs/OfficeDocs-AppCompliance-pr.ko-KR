...
<p>개발자가 마지막으로 업데이트한 날짜: 2021년 5월 19일</p>
...
| ID | WA200002784 |
| 지원되는 Office 365 클라이언트 | mac, Excel 2016 이상 Windows Excel 2016 이상, 웹용 Excel |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 모두 | 사용자가 사이트를 통해 공유된 통합 문서의 정보를 가져올 수 있는 액세스 권한이 있는 사이트 모음을 읽습니다. | [7040f194-bf08-400e-acb1-69df7939416a](../azure/7040f194-bf08-400e-acb1-69df7939416a.md) |
>| Files.ReadWrite.All | 모두 | 테이블 및 시트와 같은 통합 문서 콘텐츠를 읽고 해당 테이블에 콘텐츠를 쓸 수 있습니다. | [7040f194-bf08-400e-acb1-69df7939416a](../azure/7040f194-bf08-400e-acb1-69df7939416a.md) |
