---
title: Celigo CloudExtend의 NetSuite용 CloudExtend Analytics에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/17/2022
...
description: NetSuite용 CloudExtend Analytics, 해당 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 6월 7일</p>

* <a href="https://appsource.microsoft.com/product/office/WA200002784" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Celigo CloudExtend에서 Microsoft에 제공한 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | NetSuite용 CloudExtend Analytics |
| ID | WA200002784 |
| 지원되는 Office 365 클라이언트 | Mac에서 Excel 2016 이상, Windows에서 Excel 2016 이상, 웹용 Excel |
| 파트너 회사 이름 | Celigo CloudExtend |
| 회사 웹 사이트 | [https://www.cloudextend.io](https://www.cloudextend.io) |
| 앱의 사용 약관 | [https://www.cloudextend.io/agreements/ssa/2019-12/](https://www.cloudextend.io/agreements/ssa/2019-12/) |
| 앱의 핵심 기능 | NetSuite 사용자의 경우 CLOUDExtend Analytics for NetSuite(CEAN)는 데이터를 시각화하여 적절한 시기에 올바른 비즈니스 결정을 내리는 데 필요한 모든 인사이트를 제공합니다. CEAN은 NetSuite 데이터에 대한 인사이트를 얻기 위해 데이터를 사용자 지정하고 제어할 수 있는 유연성을 제공하는 모든 필요한 도구를 제공하는 도구입니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://www.cloudextend.io/netsuite/excel-integration/p/ana...](https://www.cloudextend.io/netsuite/excel-integration/p/analytics-for-netsuite/) |
...
이 정보는 Celigo CloudExtend에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 앱을 통해 처리하기로 선택한 사용자의 비즈니스 데이터입니다. |
...
| 개인 정보 취급 방침 URL | https://www.cloudextend.io/privacy/ |
...
| 앱에서 위의 라이브러리 중 하나를 사용하지 않는 경우 어떤 인증 라이브러리 또는 라이브러리를 사용하나요? | OAuth 2.0 권한 부여 코드 흐름 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite.All | 응용 프로그램 | Excel 통합 문서를 최신 데이터로 주기적으로 업데이트하려면 | [7040f194-bf08-400e-acb1-69df7939416a](../azure/7040f194-bf08-400e-acb1-69df7939416a.md) |
>| Sites.ReadWrite.All | 응용 프로그램 | 사용자가 SharePoint 위치에 있는 경우 작업 중인 Excel에 대한 정보를 가져옵니다. | [7040f194-bf08-400e-acb1-69df7939416a](../azure/7040f194-bf08-400e-acb1-69df7939416a.md) |
>| offline_access | 위임 | 고객이 로그인하지 않은 경우 Excel에 쓸 수 있도록 합니다. Excel 테이블에 데이터를 쓰는 예약된 작업이 있으므로 이 작업이 필요합니다. | [7040f194-bf08-400e-acb1-69df7939416a](../azure/7040f194-bf08-400e-acb1-69df7939416a.md) |
