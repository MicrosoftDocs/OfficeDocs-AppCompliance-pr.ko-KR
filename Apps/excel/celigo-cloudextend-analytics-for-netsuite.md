...
description: NetSuite용 CloudExtend Analytics, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보
...
* <a href="https://appsource.microsoft.com/product/office/WA200002784" target="_blank">AppSource의 보기</a>
...
| 회사의 웹 사이트 | [https://www.cloudextend.io](https://www.cloudextend.io) |
| 앱 사용 약관 | [https://www.cloudextend.io/agreements/ssa/2019-12/](https://www.cloudextend.io/agreements/ssa/2019-12/) |
| 앱의 핵심 기능 | NetSuite 사용자의 경우 NETSuite(CEAN)에 대한 CloudExtend Analytics가 데이터를 시각화하여 올바른 비즈니스 결정을 내리는 데 필요한 모든 인사이트를 제공합니다. CEAN은 NetSuite 데이터에 대한 정보를 얻을 수 있도록 데이터를 사용자 지정하고 제어할 수 있는 유연성을 제공하는 모든 필수 도구를 제공하는 도구입니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
...
이 정보는 Celigo CloudExtend에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직이 하게 될 컨트롤에 대해 제공됩니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 둘 다 | 사용자가 사이트를 통해 공유되는 통합 문서의 정보를 얻을 수 있는 액세스 권한이 있는 사이트 모음 읽기 | [7040f194-bf08-400e-acb1-69df7939416a](../azure/7040f194-bf08-400e-acb1-69df7939416a.md) |
>| Files.ReadWrite.All | 둘 다 | 테이블 및 시트와 같은 통합 문서 콘텐츠를 읽고 해당 테이블에 콘텐츠를 쓸 수 있습니다. | [7040f194-bf08-400e-acb1-69df7939416a](../azure/7040f194-bf08-400e-acb1-69df7939416a.md) |
