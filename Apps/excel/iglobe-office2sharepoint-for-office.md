---
title: Office2SharePoint for Office 개요
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/16/2021
...
description: Office Office2SharePoint, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
ms.locfileid: "64784197"
---
# <a name="office2sharepoint-for-office-overview"></a>Office2SharePoint for Office 개요
...
* <a href="https://appsource.microsoft.com/product/office/WA104381787" target="_blank">AppSource에서 보기</a>
...
| ID | WA104381787 |
| 지원되는 Office 365 클라이언트 | Windows Mac, 웹용 Word, Word 2016 이상에서 Windows, 웹용 Excel, Word 2016 이상에서 Excel 2016 이상의 Mac에서 Excel 2016 이상 PowerPoint 2016  Mac, 웹용 PowerPoint, PowerPoint 2016 이상에서 Windows |
| 파트너 회사 이름 | iGlobe |
...
| 앱의 핵심 기능 | Office2SharePoint - Outlook SharePoint 및 Teams 작업하고 쉬운 방법을 Office. 팀 구성원 간의 통신 장벽을 허물면 SharePoint Teams &amp; 모든 사용자가 문서와 전자 메일 첨부 파일에 액세스할 수 있습니다. 모든 장치 및 플랫폼에서 전자 메일 및 메일 첨부 파일을 Outlook 직접 SharePoint 또는 Teams 저장합니다. Office2SharePoint 앱 서비스 권한 수준은 Outlook 추가 기능과 Office 추가 기능 모두에 대해 설정됩니다. |
| 회사 본사 위치 | 덴마크 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.AccessAsUser.All | 위임 | 애플리케이션 데이터베이스에 데이터가 저장되지 않습니다. | [5971c986-9d39-409c-a6f8-1385b1f690ef](../azure/5971c986-9d39-409c-a6f8-1385b1f690ef.md) |
>| Directory.Read.All | 위임 | 애플리케이션 데이터베이스에 데이터가 저장되지 않습니다. | [5971c986-9d39-409c-a6f8-1385b1f690ef](../azure/5971c986-9d39-409c-a6f8-1385b1f690ef.md) |
>| Directory.ReadWrite.All | 위임 | 애플리케이션 데이터베이스에 데이터가 저장되지 않습니다. | [5971c986-9d39-409c-a6f8-1385b1f690ef](../azure/5971c986-9d39-409c-a6f8-1385b1f690ef.md) |
>| Group.Read.All | 위임 | 애플리케이션 데이터베이스에 데이터가 저장되지 않습니다. | [5971c986-9d39-409c-a6f8-1385b1f690ef](../azure/5971c986-9d39-409c-a6f8-1385b1f690ef.md) |
>| Group.ReadWrite.All | 위임 | 애플리케이션 데이터베이스에 데이터가 저장되지 않습니다. | [5971c986-9d39-409c-a6f8-1385b1f690ef](../azure/5971c986-9d39-409c-a6f8-1385b1f690ef.md) |
>| Mail.ReadWrite | 위임 | 애플리케이션 데이터베이스에 데이터가 저장되지 않습니다. | [5971c986-9d39-409c-a6f8-1385b1f690ef](../azure/5971c986-9d39-409c-a6f8-1385b1f690ef.md) |
>| Sites.Manage.All | 위임 | 애플리케이션 데이터베이스에 데이터가 저장되지 않습니다. | [5971c986-9d39-409c-a6f8-1385b1f690ef](../azure/5971c986-9d39-409c-a6f8-1385b1f690ef.md) |
>| Sites.Read.All | 위임 | 애플리케이션 데이터베이스에 데이터가 저장되지 않습니다. | [5971c986-9d39-409c-a6f8-1385b1f690ef](../azure/5971c986-9d39-409c-a6f8-1385b1f690ef.md) |
>| Sites.ReadWrite.All | 위임 | 애플리케이션 데이터베이스에 데이터가 저장되지 않습니다. | [5971c986-9d39-409c-a6f8-1385b1f690ef](../azure/5971c986-9d39-409c-a6f8-1385b1f690ef.md) |
>| User.Read | 위임 | 애플리케이션 데이터베이스에 데이터가 저장되지 않습니다. | [5971c986-9d39-409c-a6f8-1385b1f690ef](../azure/5971c986-9d39-409c-a6f8-1385b1f690ef.md) |
