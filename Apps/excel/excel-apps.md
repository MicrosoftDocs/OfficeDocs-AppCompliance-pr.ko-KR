...
description: 모든 Microsoft Excel 앱에 사용 가능한 모든 보안 및 규정 준수 정보입니다.
...
Microsoft는 Microsoft 365 개발자 파트너와 협력하여 조직에서 사용하는 Microsoft Excel 앱 및 추가 기능에 대해 신속하게 결정을 내리는 데 필요한 정보를 제공합니다. 이 보안, 데이터 처리 및 규정 준수 정보는 조직이 이러한 앱을 사용할 경우 위험을 평가하고 관리하는 데 도움이 됩니다.
...
| [Excel 대한 MeaningCloud Text Analytics](./meaningcloud-text-analytics-for-excel.md) | MeaningCloud | **✓** |  |
...
| [Excel 대한 ZEMA](./ze-powergroup-zema-for-excel.md) | ZE PowerGroup | **✓** |  |
