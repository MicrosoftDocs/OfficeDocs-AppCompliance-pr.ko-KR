...
* <a href="https://appsource.microsoft.com/product/office/WA104381807" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Microsoft에 Supermetrics에서 제공하는 정보:
...
| 앱의 핵심 기능 | 고급 인식을 사용하면 비즈니스는 Facebook 광고, Google Analytics, 인바구니 등의 70개 이상의 마케팅 및 판매 플랫폼에서 사일로된 데이터를 집계할 수 있으며 보고를 위해 데이터를 Excel 직접 전송할 수 있습니다. 이를 통해 다음을 수행할 수 있습니다. - 수동 데이터 가져오기 작업을 자동화합니다. - 마케팅 데이터를 분석하고 시각화하기 위해 Excel 수식 및 도구를 사용합니다. - 단일 데이터 원본에서 직접 여러 데이터 원본을 보고 큰 그림을 Excel. |
| 회사 본사 위치 | 핀란드 |
| 앱 정보 페이지 | |
...
이 정보는 이 앱이 조직 데이터를 수집 및 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직에서 제공하는 컨트롤에 대한 Supermetrics를 통해 제공됩니다.
...
| 데이터베이스에 저장되는 데이터는 무엇입니까? | 이름, 전자 메일 주소, 연락처 정보 |
...
| 가장 최근 SOC1 인증 날짜 |  2020-12-15 |
| 앱이 SOC(서비스 조직 제어)를 준수하나요? | 예 |
| 어떤 SOC 2 인증을 획득했나요? |  type2 |
| 가장 최근 SOC2 인증 날짜 |  2021-07-07 |
...
| 개인 정보 취급 방침 URL | https://supermetrics.com/privacy-policy |
