...
ms.locfileid: "64784547"
---
# <a name="sheetgo-application-information"></a>SHEETGO 애플리케이션 정보

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2021년 11월 1일</p>

* <a href="https://appsource.microsoft.com/product/office/WA200002128" target="_blank">AppSource에서 보기</a>
...
| 회사 웹 사이트 | [https://www.sheetgo.com](https://www.sheetgo.com) |
| 앱의 사용 약관 | [https://www.sheetgo.com/legal/terms/](https://www.sheetgo.com/legal/terms/) |
| 앱의 핵심 기능 | Sheetgo는 사용자가 온라인 스프레드시트를 연결하고 자동화된 데이터 관리 시스템을 빌드할 수 있는 워크플로 자동화 플랫폼입니다. Sheetgo 웹앱은 다양한 템플릿과 함께 워크플로를 만들고 관리하기 위한 플랫폼을 제공합니다. Google Sheets용 Excel 및 추가 기능에 대한 Sheetgo 추가 기능을 사용하면 사용자가 스프레드시트 내에서 직접 연결하고 자동화할 수 있으며, Teams 앱을 사용하면 워크플로 작성자가 채널 및 그룹 채팅에서 동료와 연결된 파일을 공유할 수 있습니다. |
| 회사 본사 위치 | 스페인 |
...
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 파일 크기, 스프레드시트 소유자, 스프레드시트 사용자, 마지막으로 수정한 날짜, 파일 이름 등과 같은 스프레드시트 메타데이터 스프레드시트 데이터는 저장하지 않습니다. |
...
| 개인 정보 취급 방침 URL | https://www.sheetgo.com/legal/privacy |
