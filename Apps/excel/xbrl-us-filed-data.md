---
title: XBRL US별 XBRL 파일 데이터에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/10/2021
...
description: XBRL 파일 데이터에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://appsource.microsoft.com/product/office/WA200002591" target="_blank">AppSource에서 보기</a>
...
| 파트너 회사 이름 | XBRL US |
| 회사 웹 사이트 | [https://xbrl.us](https://xbrl.us) |
| 앱의 사용 약관 | [https://xbrl.us/terms-of-agreement](https://xbrl.us/terms-of-agreement) |
| 앱의 핵심 기능 | XBRL US는 비영리 컨소시엄 건물이며 미국 XBRL US의 자유롭고 개방적이며 비독립적인 비즈니스 보고 표준을 지원하여 증권 및 Exchange 위원회(SEC), FERC(연방 에너지 규제 위원회) 및 에너지부와 같은 정부 기관의 데이터 표준 개발 및 구현을 주도했습니다. XBRL US는 데이터를 모니터링하고 SEC에서 사용하는 데이터 품질 표준을 작성하여 상장 기업이 우수한 품질의 XBRL 재무제서를 만들 수 있도록 지원합니다.  |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://xbrl.us/xbrl-api-community](https://xbrl.us/xbrl-api-community) |
| 앱을 실행하는 데 사용되는 호스팅 환경 또는 서비스 모델은 무엇인가요? |  |
| 앱에서 사용하는 호스팅 클라우드 공급자는 무엇인가요? | GitHub |
...
이 정보는 XBRL US에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 제공되었습니다.
