...
description: XBRL Filed Data, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용 가능한 모든 보안 및 규정 준수 정보입니다.
...
| 파트너 회사 이름 | XBRL US |
| 회사의 웹 사이트 | [https://xbrl.us](https://xbrl.us) |
| 앱 사용 약관 | [https://xbrl.us/terms-of-agreement](https://xbrl.us/terms-of-agreement) |
| 앱의 핵심 기능 | XBRL US는 비영리 컨소시엄을 구축하고 지원하는 비영리 컨소시엄으로, 미국 XBRL US의 무료, 개방형 비영리 비즈니스 보고 표준인 SEC(Securities and Exchange Commission), FERC(연방 에너지 규제 위원회) 및 에너지부 등 정부 기관을 위한 데이터 표준 개발 및 구현을 주도하고 있습니다. XBRL US는 데이터를 모니터링하고 SEC에서 사용하는 데이터 품질 표준을 구축하여 공공 기업이 양질의 XBRL 재무 제표를 만드는 데 도움을 줄 수 있습니다.  |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://xbrl.us/xbrl-api-community](https://xbrl.us/xbrl-api-community) |
| 앱을 실행하기 위해 사용되는 호스팅 환경 또는 서비스 모델은 무엇입니까? |  |
| 앱에서 어떤 호스팅 클라우드 공급자를 사용하나요? | GitHub |
