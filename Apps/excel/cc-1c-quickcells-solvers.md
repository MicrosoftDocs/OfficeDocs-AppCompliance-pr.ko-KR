---
title: CC-1C에 의한 퀵셀 솔버용 애플리케이션 정보
ms.author: elmalova
author: elenamalova
ms.date: 01/05/2021
ms.topic: article
...
description: QuickCells 솔버, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 대한 사용 가능한 모든 보안 및 규정 준수 정보.
...
---
# <a name="quickcells-solvers"></a>퀵셀 솔버

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>최종 업데이트: 2021년 1월 5일</p>

* <a href="https://appsource.microsoft.com/product/office/WA200001864" target="_blank">앱소스에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

CC-1C에서 Microsoft에 제공하는 정보:
...
| 개인정보 처리방침의 URL | [https://quickcells.co/legal/privacy](https://quickcells.co/legal/privacy) |
| 이용 약관의 URL | [https://quickcells.co/legal/tos](https://quickcells.co/legal/tos) |
...
이 정보는 CC-1C에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직이 가질 수 있는 제어에 대해 제공했습니다.
...
<iframe height='1020' title='Microsoft Cloud App Security 정보' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/36363' frameborder='no' style='width: 100%;'></iframe>

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/36363" target="_blank">새 탭에서 보기</a>
...
이 정보는 CC-1C에서 이 앱이 인증, 권한 부여, 응용 프로그램 등록 모범 사례 및 기타 ID 기준을 처리하는 방법에 대해 제공했습니다.
