---
title: ZE PowerGroup에 의해 Excel ZEMA에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
ms.date: 02/17/2022
ms.topic: article
...
description: CSA STAR 레지스트리의 Excel, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 ZEMA에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://appsource.microsoft.com/product/office/WA200002229" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

ZE PowerGroup에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | ZE PowerGroup |
| 회사의 웹 사이트 | [https://www.ze.com](https://www.ze.com) |
| 앱 사용 약관 | [https://www.ze.com/terms-of-use/](https://www.ze.com/terms-of-use/) |
| 앱의 핵심 기능 | ZEMA 데이터 및 분석을 통합 문서에 빠르고 Excel 가져올 수 있습니다. |
| 회사 본사 위치 | 캐나다 |
| 앱 정보 페이지 | |
...
이 정보는 ZE PowerGroup에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직이 사용할 컨트롤에 대해 제공됩니다.
