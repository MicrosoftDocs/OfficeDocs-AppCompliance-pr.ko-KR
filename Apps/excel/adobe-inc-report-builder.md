---
title: Adobe Inc.의 Report Builder 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/02/2021
...
description: Report Builder 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://appsource.microsoft.com/product/office/WA200003101" target="_blank">AppSource에서 보기</a>
...
| 파트너 회사 이름 | Adobe Inc. |
| 회사 웹 사이트 | [https://experiencecloud.adobe.com](https://experiencecloud.adobe.com) |
| 앱의 사용 약관 | [https://wwwimages.adobe.com/content/dam/acom/en/legal/licen...](https://wwwimages.adobe.com/content/dam/acom/en/legal/licenses-terms/pdf/EULA-en_US-20190910_1413.pdf) |
| 앱의 핵심 기능 | Adobe Customer Journey Analytics 데이터를 사용하여 Excel 보고서를 만듭니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
