---
title: Adobe Inc.Report Builder 응용 프로그램 정보입니다.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/02/2021
...
description: CSA STAR 레지스트리의 Report Builder, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용 가능한 모든 보안 및 규정 준수 정보입니다.
...
| 파트너 회사 이름 | Adobe Inc. |
| 회사의 웹 사이트 | [https://experiencecloud.adobe.com](https://experiencecloud.adobe.com) |
| 앱 사용 약관 | [https://wwwimages.adobe.com/content/dam/acom/en/legal/licen...](https://wwwimages.adobe.com/content/dam/acom/en/legal/licenses-terms/pdf/EULA-en_US-20190910_1413.pdf) |
| 앱의 핵심 기능 | Adobe customer Excel 데이터를 사용하여 사용자 보고서를 만들 수 있습니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
