---
title: Indicadores Economicos Chile by Birdie에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/31/2022
...
description: Indicadores Economicos Chile에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
ms.locfileid: "65818517"
---
# <a name="indicadores-economicos-chile"></a>Indicadores Economicos Chile

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 5월 30일</p>

* <a href="https://appsource.microsoft.com/product/office/WA104381100" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Microsoft에 대한 버디에서 제공하는 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | Indicadores Economicos Chile |
| ID | WA104381100 |
| 지원되는 Office 365 클라이언트 | mac에서 Windows, 웹용 Excel, Excel 2016 이상에서 Excel 2013 서비스 팩 1 이상 |
| 파트너 회사 이름 | 버디 |
| 회사 웹 사이트 | [https://www.birdie.cl](https://www.birdie.cl) |
| 앱의 사용 약관 | [https://www.birdie.cl/software/privacidad](https://www.birdie.cl/software/privacidad) |
| 앱의 핵심 기능 | Obt&#233;n el valor de la Unidad de Fomento (UF), Euro, D&#243;lar y UTM de Chile de manera sencilla |
| 회사 본사 위치 | 칠레 |
| 앱 정보 페이지 | |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 Birdie에서 제공했습니다.
