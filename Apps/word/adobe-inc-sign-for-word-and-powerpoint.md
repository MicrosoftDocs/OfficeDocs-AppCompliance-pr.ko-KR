...
| 앱의 핵심 기능 | Adobe Sign for Office. 이제 Word 및 PowerPoint 같은 Office 앱에서 문서에 서명하고 법적 구속력이 있는 전자 서명 및 승인을 &#8212; Microsoft의 기본 설정 전자 서명 솔루션으로 전송할 수 있습니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
