...
description: LegalMind Word AddIn, 해당 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://appsource.microsoft.com/product/office/WA200002192" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

LegalMind에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | LegalMind |
| 회사 웹 사이트 | [https://www.legalmind.cn](https://www.legalmind.cn) |
| 앱의 사용 약관 | [https://www.legalmind.cn](https://www.legalmind.cn) |
...
이 정보는 LegalMind에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직의 제어에 대해 제공되었습니다.
