---
title: xLaw에 대한 응용 프로그램 정보 - evertn에 의한 지식 관리 시스템
ms.author: elmalova
author: elenamalova
ms.date: 02/26/2021
ms.topic: article
...
description: xLaw에 대한 모든 사용 가능한 보안 및 규정 준수 정보 정보 - 지식 관리 시스템, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안 / 규정 준수 정보.
...
<p>최종 업데이트: 2021년 2월 26일</p>

* <a href="https://appsource.microsoft.com/product/office/WA104381077" target="_blank">앱소스에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

에버틴에서 마이크로소프트에 제공한 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | xLaw - 지식 관리 시스템 |
| ID | WA104381077 |
| 지원되는 Office 365 클라이언트 | Word 2016 또는 이후 맥, 웹용 Word, Word 2013 또는 이후 Windows |
| 파트너 회사 이름 | 에버틴 (주) |
| 파트너 웹사이트의 URL | [https://xlaw.eu/](https://xlaw.eu/) |
| 개인정보 처리방침의 URL | [https://xlaw.eu/en/privacypolicy.html](https://xlaw.eu/en/privacypolicy.html) |
| 이용 약관의 URL | [https://xlaw.eu/en/tos.html](https://xlaw.eu/en/tos.html) |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터를 통해 조직이 가질 수 있는 제어에 대해 Evertn에서 제공했습니다.
...
이 정보는 이 앱이 인증, 권한 부여, 응용 프로그램 등록 모범 사례 및 기타 ID 기준을 처리하는 방법에 대해 evertn에서 제공했습니다.
