---
title: GrammarSoft ApS에 의한 RetMig &amp; Kommaforslag에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: RetMig &amp; Kommaforslag, 해당 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://appsource.microsoft.com/product/office/WA104382003" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

GrammarSoft ApS에서 Microsoft에 제공하는 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | RetMig &amp; Kommaforslag |
| ID | WA104382003 |
| 지원되는 Office 365 클라이언트 | mac, Word 2016 이상 Windows Word 2016 이상, 웹용 Word |
| 파트너 회사 이름 | GrammarSoft ApS |
| 회사 웹 사이트 | [https://retmig.dk](https://retmig.dk) |
| 앱의 사용 약관 | [https://retmig.dk/terms](https://retmig.dk/terms) |
| 앱의 핵심 기능 | RetMig er en avanceret stave- og grammatikkontrol for dansk, mens Kommaforslag retter kommafejl. |
| 회사 본사 위치 | 덴마크 |
| 앱 정보 페이지 | [https://retmig.dk](https://retmig.dk) |
...
이 정보는 GrammarSoft ApS에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
