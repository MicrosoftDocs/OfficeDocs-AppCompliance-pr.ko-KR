...
ms.locfileid: "65269963"
---
# <a name="document-drafter"></a>문서 초안

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2021년 12월 10일</p>

* <a href="https://appsource.microsoft.com/product/office/WA200003634" target="_blank">AppSource에서 보기</a>
...
| 앱의 핵심 기능 | 이 추가 기능을 사용하면 MS Word에서 직접 문서 초안 서식 파일에 액세스할 수 있습니다. |
| 회사 본사 위치 | 덴마크 |
| 앱 정보 페이지 | [https://gmeadow.com/addin-support/](https://gmeadow.com/addin-support/) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 모두 | 애플리케이션에서 생성된 문서를 저장할 때 사용자가 폴더를 찾아보는 데 필요한 채널에서 사람 라이브러리를 읽으려면 | [1c529524-183e-40db-b1d7-1acf275354b4](../azure/1c529524-183e-40db-b1d7-1acf275354b4.md) |
