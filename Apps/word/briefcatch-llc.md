---
title: BriefCatch LLC의 BriefCatch에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/04/2022
...
description: BriefCatch에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://appsource.microsoft.com/product/office/WA200003725" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

BriefCatch LLC에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | BriefCatch LLC |
| 회사 웹 사이트 | [https://briefcatch.com](https://briefcatch.com) |
| 앱의 사용 약관 | [https://briefcatch.com/briefcatch-end-user-license-agreemen...](https://briefcatch.com/briefcatch-end-user-license-agreement/) |
| 앱의 핵심 기능 | 전문가의 법률 편집. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://briefcatch.com/version-3/](https://briefcatch.com/version-3/) |
...
이 정보는 BriefCatch LLC에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
