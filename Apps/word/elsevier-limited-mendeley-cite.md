---
title: ELSEVIER LIMITED에 의해 멘델리 인용에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/27/2022
...
description: Mendeley Cite, 해당 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
ms.locfileid: "66249953"
---
# <a name="mendeley-cite"></a>멘델리 인용

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 6월 27일</p>

* <a href="https://appsource.microsoft.com/product/office/WA104382081" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

ELSEVIER에서 Microsoft로 제한한 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | 멘델리 인용 |
| ID | WA104382081 |
| 지원되는 Office 365 클라이언트 | iPad의 Word, Windows에서 Word 2016 이상, Mac에서 Word 2016 이상, 웹의 Word |
| 파트너 회사 이름 | ELSEVIER LIMITED |
| 회사 웹 사이트 | [https://www.mendeley.com/search/](https://www.mendeley.com/search/) |
| 앱의 사용 약관 | [https://www.mendeley.com/terms/](https://www.mendeley.com/terms/) |
| 앱의 핵심 기능 | 작성할 때 인용합니다. 인용 및 참고 문헌을 생성하고 인용 스타일을 변경합니다. |
...
이 정보는 ELSEVIER LIMITED에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직의 제어에 대해 제공되었습니다.
