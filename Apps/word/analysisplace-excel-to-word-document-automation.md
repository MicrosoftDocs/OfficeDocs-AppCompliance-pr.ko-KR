...
<p>최종 업데이트: 2021년 2월 15일</p>

* <a href="https://appsource.microsoft.com/product/office/WA104380955" target="_blank">앱소스에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

분석에 의해 제공 된 정보마이크로 소프트에 장소 :

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | Excel 문서 자동화 |
| ID | WA104380955 |
| 지원되는 Office 365 클라이언트 | Excel 2016 또는 나중에 맥에서, Excel 2016 또는 나중에 Windows, Word 2016 또는 나중에 맥, Word 2016 또는 나중에 Windows, PowerPoint 2016 또는 나중에 맥, PowerPoint 2016 또는 나중에 Windows, 웹용 Excel, 웹용 Word, 웹용 PowerPoint |
| 파트너 회사 이름 | 분석 장소 |
| 파트너 웹사이트의 URL | [https://analysisplace.com/](https://analysisplace.com/) |
| 개인정보 처리방침의 URL | [https://analysisplace.com/Privacy](https://analysisplace.com/Privacy) |
| 이용 약관의 URL | [https://analysisplace.com/Terms](https://analysisplace.com/Terms) |
...
이 정보는 AnalysisPlace에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직에서 가질 수 있는 제어에 대해 제공했습니다.
...
>사용자 이름, 회사 이름 및 이메일이 저장됩니다. 2년 동안 비활성 상태였던 계정에 대해 제거됩니다.
...
<iframe height='1020' title='Microsoft Cloud App Security 정보' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/29278' frameborder='no' style='width: 100%;'></iframe>

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/29278" target="_blank">새 탭에서 보기</a>
...
이 정보는 이 앱이 인증, 권한 부여, 응용 프로그램 등록 모범 사례 및 기타 ID 기준을 처리하는 방법에 대해 AnalysisPlace에서 제공했습니다.
