...
<p>개발자가 마지막으로 업데이트한 날짜: 2021년 2월 15일</p>
...
>사용자 이름, 회사 이름 및 전자 메일이 저장됩니다. 이러한 계정은 2년 동안 비활성인 계정에 대해 제거됩니다.
...
이 정보는 AnalysisPlace에서 이 앱이 인증, 권한 부여, 응용 프로그램 등록 모범 사례 및 기타 ID 조건을 처리하는 방법에 대해 제공했습니다.
