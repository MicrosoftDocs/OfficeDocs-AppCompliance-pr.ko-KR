---
title: LeasePilot별 Clausebook에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/27/2022
...
description: CSA STAR 레지스트리의 Clausebook, 해당 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://appsource.microsoft.com/product/office/WA200004044" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

LeasePilot에서 Microsoft에 제공한 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | Clausebook |
| ID | WA200004044 |
| 지원되는 Office 365 클라이언트 | Mac, 웹의 Word, Word 2016 이상 Windows에서 Word 2016 이상 |
| 파트너 회사 이름 | LeasePilot |
| 회사 웹 사이트 | [https://clausebook.com](https://clausebook.com) |
| 앱의 사용 약관 | [https://clausebook.com/terms](https://clausebook.com/terms) |
| 앱의 핵심 기능 | Clausebook은 문서 초안 작성 도우미입니다! 팀이 빠른 초안 작성 및 조직 관행을 제도화하기 위해 양식 및 절 라이브러리를 캡처, 구성, 초안 작성 및 공유하는 데 도움이 됩니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
| 앱을 실행하는 데 사용되는 호스팅 환경 또는 서비스 모델은 무엇인가요? | Paas |
| 앱에서 사용하는 호스팅 클라우드 공급자는 무엇인가요? | 기타, Vercel |
...
이 정보는 LeasePilot에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직의 제어에 대해 제공되었습니다.
