---
title: Loio Contract Review Software by Loio Inc.에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Loio Contract Review Software, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
ms.locfileid: "64875245"
---
# <a name="loio-contract-review-software"></a>Loio 계약 검토 소프트웨어

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2021년 6월 24일</p>

* <a href="https://appsource.microsoft.com/product/office/WA200002273" target="_blank">AppSource에서 보기</a>
...
| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | Loio 계약 검토 소프트웨어 |
| ID | WA200002273 |
| 지원되는 Office 365 클라이언트 | mac, 웹용 Word, Word 2013 이상에서 Word 2016 이상 Windows |
| 파트너 회사 이름 | Loio Inc. |
| 회사 웹 사이트 | [https://loio.com](https://loio.com) |
| 앱의 사용 약관 | [https://loio.com/terms-of-use/](https://loio.com/terms-of-use/) |
| 앱의 핵심 기능 | Loio 계약 도우미를 사용하여 더 빠르고 정확하게 계약을 분석합니다 &amp; . |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://loio.com](https://loio.com) |
...
이 정보는 Loio Inc.에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 제공되었습니다.
