---
title: Loio 계약 소프트웨어 검토에 대한 응용 프로그램 정보 Loio Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Loio 계약 검토 소프트웨어, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용 가능한 모든 보안 및 규정 준수 정보입니다.
...
ms.locfileid: "63550467"
---
# <a name="loio-contract-review-software"></a>Loio 계약 소프트웨어 검토
...
| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | Loio 계약 소프트웨어 검토 |
| ID | WA200002273 |
| Office 365 클라이언트 지원 | Word 2016 Mac, 웹용 Word Word 2013 이상에서 Windows |
| 파트너 회사 이름 | Loio Inc. |
| 회사의 웹 사이트 | [https://loio.com](https://loio.com) |
| 앱 사용 약관 | [https://loio.com/terms-of-use/](https://loio.com/terms-of-use/) |
| 앱의 핵심 기능 | &amp; Loio 계약 도우미를 사용하여 보다 빠르고 정확하게 분석 계약을 검토합니다. |
| 회사 본사 위치 | 미국 |
