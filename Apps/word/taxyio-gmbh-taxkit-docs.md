---
title: Taxy.io GmbH의 TaxKit Docs에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: TaxKit Docs, 해당 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
ms.locfileid: "64880855"
---
# <a name="taxkit-docs"></a>TaxKit 문서

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2021년 7월 21일</p>

* <a href="https://appsource.microsoft.com/product/office/WA200002849" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Taxy.io GmbH에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | Taxy.io GmbH |
| 회사 웹 사이트 | [https://www.taxy.io](https://www.taxy.io) |
| 앱의 사용 약관 | [https://go.microsoft.com](https://go.microsoft.com) |
| 앱의 핵심 기능 | TaxKit Docs는 세무 고문이 작업 중인 문서 및 사례에 대한 관련 법률 자료를 찾는 데 도움이 됩니다. 이렇게 하면 고객에게 보다 효과적으로 조언할 수 있습니다. |
| 회사 본사 위치 | 독일 |
| 앱 정보 페이지 | |
...
이 정보는 Taxy.io GmbH에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
