...
| 회사의 웹 사이트 | [https://www.taxy.io](https://www.taxy.io) |
| 앱 사용 약관 | [https://go.microsoft.com](https://go.microsoft.com) |
| 앱의 핵심 기능 | TaxKit 문서는 세무 자문가가 관련 법적 법적 자문을 찾을 수 있는 문서와 사례를 찾는 데 도움이 됩니다. 이를 통해 클라이언트에게 보다 효과적으로 조언할 수 있습니다. |
| 회사 본사 위치 | 독일 |
| 앱 정보 페이지 | |
