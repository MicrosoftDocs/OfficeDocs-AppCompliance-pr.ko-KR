...
| 앱 사용 약관 | [https://appsource.microsoft.com](https://appsource.microsoft.com) |
| 앱의 핵심 기능 | AuditBoard 구독자가 &amp; AB 내러션을 편집하는 동안 AB 사이트에 링크 데이터를 포함할 수 있습니다.  |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
