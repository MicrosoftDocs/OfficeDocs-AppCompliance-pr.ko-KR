---
title: ValidSign by ValidSign에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2022
...
description: ValidSign에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://appsource.microsoft.com/product/office/WA200001890" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

ValidSign에서 Microsoft에 제공한 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | ValidSign |
| ID | WA200001890 |
| 지원되는 Office 365 클라이언트 | Mac, 웹의 Word, Windows의 Word 2013 이상에서 Word 2016 이상 |
| 파트너 회사 이름 | ValidSign |
| 회사 웹 사이트 | [https://www.validsign.eu](https://www.validsign.eu) |
| 앱의 사용 약관 | [https://www.validsign.eu/word-license-terms/](https://www.validsign.eu/word-license-terms/) |
| 앱의 핵심 기능 | ValidSign Word 추가 기능을 사용하여 더 스마트하고 효율적인 작업 |
| 회사 본사 위치 | 네덜란드 (the) |
| 앱 정보 페이지 | [https://www.validsign.eu/connectors/word/](https://www.validsign.eu/connectors/word/) |
...
이 정보는 ValidSign에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
...
| 개인 정보 취급 방침 URL | https://www.validsign.eu/validsign-privacy-statement/ |
