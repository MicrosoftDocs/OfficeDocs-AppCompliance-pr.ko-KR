---
title: officeatwork별 Office 템플릿 선택기용 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/25/2022
...
description: officeatwork | 사용할 수 있는 모든 보안 및 규정 준수 정보 Office 대한 템플릿 선택기, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보.
...
---
# <a name="application-information-for-officeatwork--template-chooser-for-office"></a>officeatwork | 대한 애플리케이션 정보 Office 대한 템플릿 선택기
...
* <a href="https://appsource.microsoft.com/product/office/WA104380050" target="_blank">AppSource에서 보기</a>
...
| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | officeatwork - Office 대한 템플릿 선택기 |
| ID | WA104380050 |
| 지원되는 Office 365 클라이언트 | Windows, 웹용 Excel, Word on iPad, Mac, Excel 웹용 Word, Word 2013 이상에서 Windows, 웹용 Excel, word 2013 이상에서 iPad, Word 2016 Excel 2016 이상에서 Excel Windows 2016년 Project Windows mac, 웹용 PowerPoint, PowerPoint 2013 이상에서 iPad, PowerPoint 2016 이상 PowerPoint Windows |
...
| 앱의 핵심 기능 | Office, Teams, SharePoint Online 및 기타 앱에서 중앙에서 공유되는 템플릿에 액세스합니다. |
| 회사 본사 위치 | 스위스 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite.All | 위임 | 즐겨찾기 및 OneDrive 기능 사용 | [dae2eacf-3eb5-4440-baff-984fbd5cae68](../azure/dae2eacf-3eb5-4440-baff-984fbd5cae68.md) |
>| Group.ReadWrite.All | 위임 | Teams 기능 사용 | [dae2eacf-3eb5-4440-baff-984fbd5cae68](../azure/dae2eacf-3eb5-4440-baff-984fbd5cae68.md) |
>| GroupMember.Read.All | 위임 | Teams 기능 사용 | [dae2eacf-3eb5-4440-baff-984fbd5cae68](../azure/dae2eacf-3eb5-4440-baff-984fbd5cae68.md) |
>| Sites.Read.All | 위임 | SharePoint 저장된 사용자 템플릿 파일을 읽습니다. | [dae2eacf-3eb5-4440-baff-984fbd5cae68](../azure/dae2eacf-3eb5-4440-baff-984fbd5cae68.md) |
...
>| offline_access | 위임 | 이전 Office 호스트에 대해 자동화된 로그인 사용 | [dae2eacf-3eb5-4440-baff-984fbd5cae68](../azure/dae2eacf-3eb5-4440-baff-984fbd5cae68.md) |
