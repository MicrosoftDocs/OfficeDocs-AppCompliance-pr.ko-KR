---
title: 디지털 과학의 SmartCite for Papers에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/03/2021
...
description: SmartCite for Papers, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://appsource.microsoft.com/product/office/WA104380917" target="_blank">AppSource에서 보기</a>
...
| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | SmartCite for Papers |
| ID | WA104380917 |
| 지원되는 Office 365 클라이언트 | mac, Word 2016 이상 Windows Word 2016 이상, 웹용 Word |
| 파트너 회사 이름 | 디지털 과학 |
| 회사 웹 사이트 | [https://papersapp.com](https://papersapp.com) |
| 앱의 사용 약관 | [https://www.papersapp.com/terms](https://www.papersapp.com/terms) |
| 앱의 핵심 기능 | ReadCube Papers 라이브러리에서 참조를 인용하고 참고 문헌을 자동으로 생성합니다. |
| 회사 본사 위치 | 미국 |
...
이 정보는 디지털 과학에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
