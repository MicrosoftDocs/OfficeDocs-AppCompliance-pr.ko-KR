---
title: kRevealLLC별 CrossCheck에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/01/2021
...
description: CrossCheck, 해당 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://appsource.microsoft.com/product/office/WA200003198" target="_blank">AppSource에서 보기</a>
...
| 회사 웹 사이트 | [https://kreveal.com](https://kreveal.com) |
| 앱의 사용 약관 | [https://crosscheck.krevealaddins.com/docs/license.htm](https://crosscheck.krevealaddins.com/docs/license.htm) |
| 앱의 핵심 기능 | CrossCheck는 문서 검토를 간소화하고 일반적인 초안 작성 실수를 정확히 파악합니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://admin.krevealaddins.com/help](https://admin.krevealaddins.com/help) |
...
이 정보는 kRevealLLC에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| openid | 응용 프로그램 | 데이터가 수집되거나 사용되지 않습니다. | [5edad654-f2d5-41d8-bfc0-92c2735252e1](../azure/5edad654-f2d5-41d8-bfc0-92c2735252e1.md) |
