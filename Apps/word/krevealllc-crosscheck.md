...
| 회사의 웹 사이트 | [https://kreveal.com](https://kreveal.com) |
| 앱 사용 약관 | [https://crosscheck.krevealaddins.com/docs/license.htm](https://crosscheck.krevealaddins.com/docs/license.htm) |
| 앱의 핵심 기능 | CrossCheck은 문서 검토를 간소화하고 일반적인 초안 작성 실수를 고정합니다. |
| 회사 본사 위치 | 미국 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| openid | application | 데이터가 수집되거나 사용되지 않습니다. | [5edad654-f2d5-41d8-bfc0-92c2735252e1](../azure/5edad654-f2d5-41d8-bfc0-92c2735252e1.md) |
