---
title: N2VEC TECNOLOGIA의 Jus2vec에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/18/2022
...
description: Jus2vec에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
ms.locfileid: "64906432"
---
# <a name="jus2vec"></a>Jus2vec

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 4월 18일</p>

* <a href="https://appsource.microsoft.com/product/office/WA200002506" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

N2VEC TECNOLOGIA에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | N2VEC TECNOLOGIA |
| 회사 웹 사이트 | [https://info.jus2vec.com](https://info.jus2vec.com) |
| 앱의 사용 약관 | [https://info.jus2vec.com/termos-de-uso.html](https://info.jus2vec.com/termos-de-uso.html) |
| 앱의 핵심 기능 | Busca por Jurisprud&#234;ncias usando Intelig&#234;ncia Artificial |
| 회사 본사 위치 | 브라질 |
| 앱 정보 페이지 | |
...
이 정보는 N2VEC TECNOLOGIA에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
