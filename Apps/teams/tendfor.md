---
title: Tendfor by Tendfor에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/16/2022
...
description: Tendfor에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/212fcd92-bc06-4746-85c4-f7b5d39579ba" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002996" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Tendfor에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | Tendfor |
| 회사 웹 사이트 | [https://www.tendfor.com](https://www.tendfor.com) |
| 앱의 사용 약관 | [https://tendfor.com/tendfor_docs/en/StandardContractMarch20...](https://tendfor.com/tendfor_docs/en/StandardContractMarch2019.pdf) |
| 앱의 핵심 기능 | Microsoft Teams 위한 완전한 기능을 갖춘 컨택 센터 및 전화 교환 콘솔. |
| 회사 본사 위치 | 스웨덴 |
| 앱 정보 페이지 | [https://www.tendfor.com](https://www.tendfor.com) |
...
이 정보는 Tendfor에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 사용자 프로필 데이터, 사용자 일정 데이터, 통화 미디어 |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 사용자 프로필 데이터, 사용자 일정 데이터 |
...
| 지원되는 정책 유형 나열 | Azure에서 지원되는 모든 항목 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 위임 | 사용자를 로그인할 수 있도록 하려면 | [b7e8237f-d86d-4874-8f8b-7faa8f768436](../azure/b7e8237f-d86d-4874-8f8b-7faa8f768436.md) |
>| User.Read.All | 응용 프로그램 | 사용자 정보를 가져올 수 있도록 하려면 | [b7e8237f-d86d-4874-8f8b-7faa8f768436](../azure/b7e8237f-d86d-4874-8f8b-7faa8f768436.md) |
>| User.Read.All | 위임 | 사용자 정보를 가져올 수 있도록 하려면 | [b7e8237f-d86d-4874-8f8b-7faa8f768436](../azure/b7e8237f-d86d-4874-8f8b-7faa8f768436.md) |
