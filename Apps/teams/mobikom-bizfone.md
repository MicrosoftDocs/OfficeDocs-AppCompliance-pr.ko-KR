---
title: Bizfone by MobiKOM에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/26/2021
...
description: Bizfone에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/5be25d59-35cd-4318-83b0-2a5d5668ddcd" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000874" target="_blank">AppSource에서 보기</a>
...
| 파트너 회사 이름 | MobiKOM |
| 회사 웹 사이트 | [https://mobikom.dk](https://mobikom.dk) |
| 앱의 사용 약관 | [https://mobikom.dk/salgs-og-leveringsbetingelser/](https://mobikom.dk/salgs-og-leveringsbetingelser/) |
| 앱의 핵심 기능 | H&#229;ndter dine telefonopkald i Teams, og f&#229; overblik over dine kolleger. |
| 회사 본사 위치 | 덴마크 |
| 앱 정보 페이지 | [https://mobikom.dk/faq/](https://mobikom.dk/faq/) |
| 앱을 실행하는 데 사용되는 호스팅 환경 또는 서비스 모델은 무엇인가요? |  |
| 앱에서 사용하는 호스팅 클라우드 공급자는 무엇인가요? | Azure, SelfHosted |
...
이 정보는 MobiKOM에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | 위임 | 일정은 동료에게 자신의 칼란다를 표시하고 전화 통신을 설정하기 위해 모임을 사용할 수 있는 사용자에게 사용됩니다. | [1dd6ac57-e6f0-4995-a57f-b6d074c16e11](../azure/1dd6ac57-e6f0-4995-a57f-b6d074c16e11.md) |
>| Contacts.Read | 위임 | 대화 상대에게 쉽게 전화를 걸 수 있도록 앱에 표시하려는 경우 사용자 연락처를 저장할 수 있습니다. | [1dd6ac57-e6f0-4995-a57f-b6d074c16e11](../azure/1dd6ac57-e6f0-4995-a57f-b6d074c16e11.md) |
>| User.Read | 위임 | 이 애플리케이션에서 읽은 사용자는 식별 목적으로 사용됩니다. | [1dd6ac57-e6f0-4995-a57f-b6d074c16e11](../azure/1dd6ac57-e6f0-4995-a57f-b6d074c16e11.md) |
>| User.Read | 위임 | 데이터를 저장하지 않습니다. 애플리케이션은 인증 목적으로만 사용됩니다. | [fc8f7563-e8ea-4b6d-9622-82775a21a35a](../azure/fc8f7563-e8ea-4b6d-9622-82775a21a35a.md) |
