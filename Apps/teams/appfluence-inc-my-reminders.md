---
title: Appfluence Inc.의 내 미리 알림에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/01/2022
...
description: My Reminders에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
ms.locfileid: "66656344"
---
# <a name="my-reminders"></a>내 미리 알림

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 6월 23일</p>

* <a href="https://teams.microsoft.com/l/app/ae64c32a-0eab-47d9-91e4-b693569f7fc3" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004342" target="_blank">AppSource에서 보기</a>
...
| 앱의 사용 약관 | [https://teamsreminder.com/eula](https://teamsreminder.com/eula) |
| 앱의 핵심 기능 | 챗봇을 통해 다시 보낼 미리 알림 메시지를 예약합니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://teamsreminder.com](https://teamsreminder.com) |
...
| 앱에서 처리되는 데이터는 무엇인가요? | 사용자가 미리 알림이 특정 대화와 관련이 있는지 여부를 나타내는 데 도움이 되도록 Teams에서 사용자의 채팅을 나열합니다. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Chat.ReadBasic | 위임 | 미리 알림이 채팅과 연결되어 있는지 이해할 수 있도록 채팅에 있는 사용자를 표시합니다. | [6b0ce2dd-a270-4ade-babb-7cf54bab8edd](../azure/6b0ce2dd-a270-4ade-babb-7cf54bab8edd.md) |
>| User.Read | 위임 | 사용자 로그인 및 사용자 이름 알아보기 | [6b0ce2dd-a270-4ade-babb-7cf54bab8edd](../azure/6b0ce2dd-a270-4ade-babb-7cf54bab8edd.md) |
>| User.ReadBasic.All | 위임 | 개인 채팅과 관련된 미리 알림을 예약할 때 관련 협력자의 아바타 표시 | [6b0ce2dd-a270-4ade-babb-7cf54bab8edd](../azure/6b0ce2dd-a270-4ade-babb-7cf54bab8edd.md) |
>| offline_access | 위임 | 미리 알림 배달을 위해 일정 시간에 앱이 사용자 역할을 하도록 허용 | [6b0ce2dd-a270-4ade-babb-7cf54bab8edd](../azure/6b0ce2dd-a270-4ade-babb-7cf54bab8edd.md) |
>| 프로필 | 위임 | 사용자 로그인 및 사용자 이름 알아보기 | [6b0ce2dd-a270-4ade-babb-7cf54bab8edd](../azure/6b0ce2dd-a270-4ade-babb-7cf54bab8edd.md) |
