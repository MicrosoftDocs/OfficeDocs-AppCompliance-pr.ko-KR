---
title: Zoho Corporation Private Limited의 Zoho 서명에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/17/2022
...
description: Zoho Sign, 해당 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* [Teams 스토어에서 보기](https://teams.microsoft.com/l/app/7a22873b-81e6-48ed-aee3-6f0e7dd5a104)
* [AppSource에서 보기](https://appsource.microsoft.com/product/office/WA104382011)
...
| 앱의 핵심 기능 | Zoho Sign은 안전하고 클라우드 기반의 디지털 서명 앱으로, 법적, 전자적으로 비즈니스 서류에 서명, 보내기 및 관리할 수 있습니다. 전자 서명 워크플로를 손쉽게 만들어 서명을 수집하고, 서명자를 인증하고, 미리 알림을 트리거하고, 서명 및 승인 상태를 실시간으로 추적할 수 있습니다. Zoho Sign을 사용하면 웹 브라우저 및 이동 중에도 Microsoft 앱에서 직접 모든 서류를 관리할 수 있습니다. |
| 회사 본사 위치 | 미국 |
...
| 기본 침입이 Microsoft 고객 데이터를 처리하거나 저장하는 경우 이 데이터는 지리적으로 저장되는 위치는 어디인가요? | 인도, 일본, 오스트레일리아, 중국, 네덜란드(해당), 아일랜드, 미국 |
