...
description: CSA STAR 레지스트리의 Zoho Sign, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용할 수 있는 모든 보안 및 규정 준수 정보
...
* <a href="https://teams.microsoft.com/l/app/7a22873b-81e6-48ed-aee3-6f0e7dd5a104" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA104382011" target="_blank">AppSource의 보기</a>
...
| 회사의 웹 사이트 | [https://www.zoho.com](https://www.zoho.com) |
| 앱 사용 약관 | [https://www.zoho.com/terms.html](https://www.zoho.com/terms.html) |
| 앱의 핵심 기능 | Zoho Sign은 법률 및 전자적으로 비즈니스 문서에 서명하고, 보내고, 관리할 수 있는 안전한 클라우드 기반 디지털 서명 앱입니다. 쉽게 전자 서명 워크플로를 만들어 서명을 수집하고, 서명자 인증하고, 미리 알림을 트리거하고, 실시간으로 서명 및 승인 상태를 추적할 수 있습니다. 또한 Zoho Sign을 사용하면 웹 브라우저와 모바일 앱으로 이동하여 Microsoft 앱에서 직접 모든 서류를 관리할 수 있습니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://www.zoho.com/sign/help/teams-extension.html](https://www.zoho.com/sign/help/teams-extension.html) |
...
| 데이터베이스에 저장되는 데이터는 무엇입니까? | 사용자 ID, 사용자 이름, 전자 메일 주소 |
| Microsoft 고객 데이터를 원본으로 사용하여 처리하거나 저장하는 경우 이 데이터는 지리적으로 저장되는 위치입니다. | 인도, 일본, 오스트레일리아, 중국, 네덜란드(the), 아일랜드, 미국 |
...
| 지원되는 정책 유형 나열 | Multi-Factor Authentication, 특정 응용 프로그램에 대해 조직 관리 장치 필요, 위험한 로그인 동작 차단, 관리 역할이 아는 사람에 대한 액세스 제한  |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 위임 | 로그인 및 사용자 프로필 읽기 | [a67ee0a9-b008-4e90-986d-1eb8d55a81d6](../azure/a67ee0a9-b008-4e90-986d-1eb8d55a81d6.md) |
