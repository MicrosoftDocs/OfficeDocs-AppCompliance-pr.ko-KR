---
title: Lucid Software의 Lucidspark Whiteboard에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/14/2021
...
description: Lucidspark Whiteboard에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/e9ab21fa-5fd5-48bb-a85d-4de7ced89cd1" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002583" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Lucid Software에서 Microsoft에 제공한 정보:
...
| 회사 웹 사이트 | [https://lucid.co](https://lucid.co) |
| 앱의 사용 약관 | [https://lucid.co/tos](https://lucid.co/tos) |
| 앱의 핵심 기능 | Lucidspark는 팀이 최상의 아이디어를 실현할 수 있는 클라우드 기반 가상 화이트보드입니다. 원격으로 작업하든 직접 작업하든 관계없이 실시간으로 브레인스토밍하고 팀으로 공동 작업할&#8217;있습니다. Lucidspark는 사람들이 노트와 낙서를 구성하고 프레젠테이션 준비 개념으로 전환하는 데 도움이 됩니다. 다음 단계로&#8217;때 팀은 워크플로를 개발하고 문서를 처리하여 아이디어를 현실로 전환할 수 있습니다. |
| 회사 본사 위치 | 미국 |
...
이 정보는 Lucid Software에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
