---
title: Lucidspark Whiteboard에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/14/2021
...
description: Lucidspark Whiteboard에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보
...
ms.locfileid: "63544386"
---
# <a name="lucidspark-whiteboard"></a>Lucidspark Whiteboard

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2021년 5월 13일</p>

* <a href="https://teams.microsoft.com/l/app/e9ab21fa-5fd5-48bb-a85d-4de7ced89cd1" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002583" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Lucid Software에서 Microsoft에 제공하는 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | Lucidspark Whiteboard |
| ID | WA200002583 |
| Office 365 클라이언트 지원 | Microsoft Teams |
| 파트너 회사 이름 | Lucid Software |
| 회사의 웹 사이트 | [https://lucid.co](https://lucid.co) |
| 앱 사용 약관 | [https://lucid.co/tos](https://lucid.co/tos) |
| 앱의 핵심 기능 | Lucidspark는 팀이 최상의 아이디어를 밝게 할 수 있는 클라우드 기반 가상 화이트보드입니다. 원격으로 작업하는지, 아니면 대면적으로 작업하는지 여부에&#8217;실시간으로 팀으로 브레인스토마하고 공동 작업을 할 수 있습니다. Lucidspark를 사용하면 메모와 비명을 구성하여 프레젠테이션에 사용할 수 있는 개념으로 전환할 수 있습니다. 다음&#8217;시간이 지났을 때 팀은 워크플로를 개발하고 문서를 처리하여 아이디어를 현실로 전환할 수 있습니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://lucidchart.zendesk.com](https://lucidchart.zendesk.com) |
...
이 정보는 Lucid Software에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직에서 제공하는 컨트롤에 대해 제공됩니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| 전자 메일 | 위임 | 이름 및 전자 메일 주소입니다. | [3557d5c0-bcab-410b-8a03-f7045aa48de0](../azure/3557d5c0-bcab-410b-8a03-f7045aa48de0.md) |
>| openid | 위임 | 이름 및 전자 메일 주소입니다. | [3557d5c0-bcab-410b-8a03-f7045aa48de0](../azure/3557d5c0-bcab-410b-8a03-f7045aa48de0.md) |
>| 프로필 | 위임 | 이름 및 전자 메일 주소입니다. | [3557d5c0-bcab-410b-8a03-f7045aa48de0](../azure/3557d5c0-bcab-410b-8a03-f7045aa48de0.md) |
