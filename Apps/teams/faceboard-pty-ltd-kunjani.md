---
title: PTY(FACEBOARD) LTD의 쿤자니 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/10/2021
...
description: 쿤자니에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보.
...
* <a href="https://teams.microsoft.com/l/app/6b4ac65a-764d-4021-bf3f-40cb2d137a33" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003049" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

PTY(FACEBOARD) LTD에서 Microsoft에 제공하는 정보:
...
| 회사 웹 사이트 | [https://www.kunjani.co](https://www.kunjani.co) |
| 앱의 사용 약관 | [https://www.kunjani.co/termsandconditions](https://www.kunjani.co/termsandconditions) |
| 앱의 핵심 기능 | 사용자가 디자인한 대화형 쿤자니 게임으로 모임에 활기를 더하세요. |
| 회사 본사 위치 | 영국 및 북아일랜드(해당) |
| 앱 정보 페이지 | [https://Kunjani.co](https://Kunjani.co) |
...
이 정보는 FACEBOARD(PTY) LTD에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
