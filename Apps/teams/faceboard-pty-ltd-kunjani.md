...
description: Kunjani, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보
...
| 회사의 웹 사이트 | [https://www.kunjani.co](https://www.kunjani.co) |
| 앱 사용 약관 | [https://www.kunjani.co/termsandconditions](https://www.kunjani.co/termsandconditions) |
| 앱의 핵심 기능 | 사용자가 디자인한 대화형 Kunjani 게임으로 모임에 활약합니다. |
