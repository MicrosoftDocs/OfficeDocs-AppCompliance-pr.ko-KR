...
description: CSA STAR 레지스트리의 Pro, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용할 수 있는 모든 보안 및 규정 준수 정보
...
| 앱의 핵심 기능 | 연락처 Pro 연락처는 비즈니스용 공동 작업 연락처 Microsoft Teams. |
| 회사 본사 위치 | 프랑스 |
| 앱 정보 페이지 | |
