---
title: 푸시 보안으로 푸시 보안을 위한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2022
...
description: 푸시 보안, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
ms.locfileid: "66817695"
---
# <a name="push-security"></a>푸시 보안

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 7월 12일</p>

* <a href="https://teams.microsoft.com/l/app/db06ca6c-96a2-48ef-804e-54295b5c035a" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002833" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Microsoft에 푸시 보안에서 제공하는 정보:
...
| 파트너 회사 이름 | 푸시 보안 |
| 회사 웹 사이트 | [https://pushsecurity.com](https://pushsecurity.com) |
| 앱의 사용 약관 | [https://pushsecurity.com/legal/terms/](https://pushsecurity.com/legal/terms/) |
| 앱의 핵심 기능 | 직원들이 앱을 안전하게 사용할 수 있도록 하여 회사가 SaaS를 통해 생산성을 높일 수 있도록 지원합니다. |
| 회사 본사 위치 | 영국 및 북아일랜드(해당) |
| 앱 정보 페이지 | [https://pushsecurity.com/kb/10004/](https://pushsecurity.com/kb/10004/) |
...
이 정보는 푸시 보안에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 푸시는 고객의 근무 시간을 처리하여 고객이 작업할 때 경고를 제공합니다.  |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 푸시는 고객의 근무 시간을 저장하여 고객이 작업할 때 경고를 제공합니다.  |
...
| 개인 정보 취급 방침 URL | https://pushsecurity.com/legal/privacy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | 응용 프로그램 | 봇을 더 쉽게 설치할 수 있도록 채널 나열  | [4ed8651a-5a01-44f0-abdf-536bbc441c02](../azure/4ed8651a-5a01-44f0-abdf-536bbc441c02.md) |
>| MailboxSettings.Read | 응용 프로그램 | 시간 후에 메시지를 표시하지 않도록 고객의 근무 시간을 쿼리합니다. | [4ed8651a-5a01-44f0-abdf-536bbc441c02](../azure/4ed8651a-5a01-44f0-abdf-536bbc441c02.md) |
>| Team.ReadBasic.All | 응용 프로그램 | 봇을 더 쉽게 설치할 수 있도록 팀 나열  | [4ed8651a-5a01-44f0-abdf-536bbc441c02](../azure/4ed8651a-5a01-44f0-abdf-536bbc441c02.md) |
>| TeamsAppInstallation.ReadWriteSelfForTeam.All | 응용 프로그램 | 봇이 팀을 위해 자체 설치하도록 허용 | [4ed8651a-5a01-44f0-abdf-536bbc441c02](../azure/4ed8651a-5a01-44f0-abdf-536bbc441c02.md) |
>| TeamsAppInstallation.ReadWriteSelfForUser.All | 응용 프로그램 | 봇이 사용자에 대해 자체 설치하도록 허용 | [4ed8651a-5a01-44f0-abdf-536bbc441c02](../azure/4ed8651a-5a01-44f0-abdf-536bbc441c02.md) |
>| User.Read.All | 응용 프로그램 | 사용자에게 메시지를 표시할 수 있도록 사용자 나열 | [4ed8651a-5a01-44f0-abdf-536bbc441c02](../azure/4ed8651a-5a01-44f0-abdf-536bbc441c02.md) |
