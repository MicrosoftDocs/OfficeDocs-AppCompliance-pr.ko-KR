---
title: O2S용 응용 프로그램 정보 - iGlobe의 Office2SharePoint
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/27/2022
...
description: O2S - Office2SharePoint, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 6월 27일</p>

* <a href="https://teams.microsoft.com/l/app/281db76e-2714-4cc4-b8d8-bd87ac3190af" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003656" target="_blank">AppSource에서 보기</a>
...
| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | O2S - Office2SharePoint |
| ID | WA200003656 |
| 지원되는 Office 365 클라이언트 | Microsoft Teams |
| 파트너 회사 이름 | iGlobe |
| 회사 웹 사이트 | [https://www.iglobecrm.com](https://www.iglobecrm.com) |
| 앱의 사용 약관 | [https://www.iglobecrm.com/content/end-user-license-agreemen...](https://www.iglobecrm.com/content/end-user-license-agreement-office2sharepoint) |
| 앱의 핵심 기능 | Microsoft Teams, SharePoint, Outlook, Office 및 OneDrive에서 통합된 Microsoft 365 사용자 환경을 제공하여 일상 업무를 보다 쉽게 수행할 수 있습니다.  |
| 회사 본사 위치 | 덴마크 |
| 앱 정보 페이지 | [https://o2s.iglobe.dk](https://o2s.iglobe.dk) |
...
| 다음을 위해 MFA(다단계 인증)를 사용하도록 설정했습니다. | 자격 증명, CodeRepositories, DNSManagement |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.AccessAsUser.All | 위임 | 앱에서 로그인한 사용자와 디렉터리의 정보에 동일한 액세스 권한을 가질 수 있습니다. | [5971c986-9d39-409c-a6f8-1385b1f690ef](../azure/5971c986-9d39-409c-a6f8-1385b1f690ef.md) |
>| Directory.Read.All | 위임 | 사용 권한을 확인하고 사이트 및 목록을 가져옵니다. 폴더를 만들고, 파일을 가져와 파일을 저장합니다. | [5971c986-9d39-409c-a6f8-1385b1f690ef](../azure/5971c986-9d39-409c-a6f8-1385b1f690ef.md) |
>| Directory.ReadWrite.All | 위임 | 사용 권한을 확인하고 사이트 및 목록을 가져옵니다. 폴더를 만들고, 파일을 가져와 파일을 저장합니다. | [5971c986-9d39-409c-a6f8-1385b1f690ef](../azure/5971c986-9d39-409c-a6f8-1385b1f690ef.md) |
>| Group.Read.All | 위임 | 사용 권한을 확인하고 사이트 및 목록을 가져옵니다. 폴더를 만들고, 파일을 가져와 파일을 저장합니다. | [5971c986-9d39-409c-a6f8-1385b1f690ef](../azure/5971c986-9d39-409c-a6f8-1385b1f690ef.md) |
>| Group.ReadWrite.All | 위임 | 사용 권한을 확인하고 사이트 및 목록을 가져옵니다. 폴더를 만들고, 파일을 가져와 파일을 저장합니다. | [5971c986-9d39-409c-a6f8-1385b1f690ef](../azure/5971c986-9d39-409c-a6f8-1385b1f690ef.md) |
>| Sites.Manage.All | 위임 | 애플리케이션에서 로그인한 사용자를 대신하여 모든 사이트 모음에서 문서 라이브러리 및 목록을 만들거나 삭제할 수 있습니다. | [5971c986-9d39-409c-a6f8-1385b1f690ef](../azure/5971c986-9d39-409c-a6f8-1385b1f690ef.md) |
>| Sites.Read.All | 위임 | 사용 권한을 확인하고 사이트 및 목록을 가져옵니다. 폴더를 만들고, 파일을 가져와 파일을 저장합니다. | [5971c986-9d39-409c-a6f8-1385b1f690ef](../azure/5971c986-9d39-409c-a6f8-1385b1f690ef.md) |
>| Sites.ReadWrite.All | 위임 | 권한과 사이트 및 목록을 얻기 위해 도대체. 폴더를 만들고, 파일을 가져와 파일을 저장합니다. | [5971c986-9d39-409c-a6f8-1385b1f690ef](../azure/5971c986-9d39-409c-a6f8-1385b1f690ef.md) |
>| User.Read | 위임 | 사용자 SharePoint 사이트, OneDrive 및 그룹 사이트를 가져옵니다. | [5971c986-9d39-409c-a6f8-1385b1f690ef](../azure/5971c986-9d39-409c-a6f8-1385b1f690ef.md) |
...
| [**운영 보안**](../docs/certification-submission-guide.md#operational-security) | **해당(N/A)** |
...
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;정보 보안 위험 관리 | 해당 없음 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;인시던트 대응 | 해당 없음 |
| [**데이터 처리 보안 &amp; 개인 정보**](../docs/certification-submission-guide.md#data-handling-security-and-privacy) | **해당(N/A)** |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;전송 중인 데이터 | 해당 없음 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;미사용 데이터 | 해당 없음 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;데이터 보존 및 삭제 | 해당 없음 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;데이터 액세스 관리 | 해당 없음 |
