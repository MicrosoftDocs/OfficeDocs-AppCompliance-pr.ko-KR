---
title: qbo by Unscrambl에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/29/2021
...
description: qbo, 해당 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/834c6939-152c-450b-a305-c65b4dd5d1c7" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001708" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Unscrambl에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | Unscrambl |
| 회사 웹 사이트 | [https://unscrambl.com](https://unscrambl.com) |
| 앱의 사용 약관 | [https://unscrambl.com/service-agreement](https://unscrambl.com/service-agreement) |
| 앱의 핵심 기능 | Unscrambl qbo 인사이트로 구동되는 qbo는 동급 최고의 NLP를 사용하여 분석을 대화형으로 만듭니다. 사용자는 질문을 입력하고 qbo는 가장 관련성이 큰 인사이트와 시각화를 스냅으로 표시합니다. 사용자는 동료와 적극적으로 공동 작업하고, 결정을 내리고, 프레젠테이션 준비 보드에서 결과를 캡처할 수 있습니다. qbo를 사용하면 조직의 모든 사용자가 데이터 기반 의사 결정을 내릴 수 있습니다. qbo는 다양한 클라우드 또는 온-프레미스 원본에 직접 연결되며 Microsoft Teams 또는 브라우저를 통해 액세스할 수 있습니다. |
| 회사 본사 위치 | 미국 |
...
이 정보는 Unscrambl에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 계정 만들기에 이름 및 전자 메일 주소 사용 |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 이름 및 전자 메일 주소 |
...
| 개인 정보 취급 방침 URL | https://qbo.ai/legal/ |
