---
title: Unscrambl에 의해 qbo에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
ms.date: 02/01/2021
ms.topic: article
...
description: QBO에 대한 사용 가능한 모든 보안 및 규정 준수 정보 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보.
...
<p>최종 업데이트: 2021년 2월 1일</p>

* <a href="https://teams.microsoft.com/l/app/834c6939-152c-450b-a305-c65b4dd5d1c7" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001708" target="_blank">앱소스에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

언스크램블에서 마이크로소프트에 제공하는 정보:
...
| 파트너 회사 이름 | Unscrambl |
| 파트너 웹사이트의 URL | [https://qbo.ai](https://qbo.ai) |
| Teams 응용 프로그램 정보 페이지의 URL | [https://qbo.ai](https://qbo.ai) |
| 개인정보 처리방침의 URL | [https://qbo.ai/legal/](https://qbo.ai/legal/) |
| 이용 약관의 URL | [https://qbo.ai/legal/#service](https://qbo.ai/legal/#service) |
...
이 정보는 Unscrambl에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 조직에서 앱이 수집하는 데이터에 대한 제어에 대해 제공했습니다.
...
>|:-------------------|:-------------------|:--------------------------|:--------------------------|:---------------------------------------------------|:--------------------------|
>| 봇 프레임워크 API | 예 | 사용자의 이메일에서 식별된 도메인 이름 | 사용자가 원하는 경우 보고서를 발송하기 위한 이메일을 수집합니다. | 이메일만 | 사용자 프로필의 일부로 저장됨 |
...
>|:--------------------------------|:---------------------|:--------------------------|
>| 우리는 사용자가 자신에게 보고서의 PDF를 이메일로 보낼 수 있습니다 응용 프로그램 기능이 있습니다. | 전자 메일 주소 | 우리는 사용자가 자신에게 보고서의 PDF를 이메일로 보낼 수 있습니다 응용 프로그램 기능이, 이것은 사용자 프로필의 일부로 저장됩니다. |
...
>이 데이터는 Azure(동남 아시아)의 VM에서 호스팅되는 MariaDB에 저장됩니다. VM에 대한 액세스는 IP가 제한되고 암호가 보호되며 DB에 대한 액세스도 암호로 보호됩니다.
...
이 정보는 이 앱이 인증, 권한 부여, 응용 프로그램 등록 모범 사례 및 기타 ID 기준을 처리하는 방법에 대해 Unscrambl에서 제공되었습니다.
