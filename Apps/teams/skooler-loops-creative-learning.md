---
title: 루프에 대한 애플리케이션 정보 - Skooler의 크리에이티브 Learning
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/26/2021
...
description: 루프에 사용 가능한 모든 보안 및 규정 준수 정보 - Creative Learning, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/d612b92e-2828-4a94-9e83-92dee316bdb3" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003074" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Skooler에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | Skooler |
| 회사 웹 사이트 | [https://www.loopseducation.com](https://www.loopseducation.com) |
| 앱의 사용 약관 | [https://www.loopseducation.com/assets/terms.en-US.201126.pdf](https://www.loopseducation.com/assets/terms.en-US.201126.pdf) |
| 앱의 핵심 기능 | 루프는 대화형 마인드 맵을 통해 가르치고 학습하는 도구입니다. |
| 회사 본사 위치 | 스웨덴 |
| 앱 정보 페이지 | |
| 앱을 실행하는 데 사용되는 호스팅 환경 또는 서비스 모델은 무엇인가요? |  |
| 앱에서 사용하는 호스팅 클라우드 공급자는 무엇인가요? | AWS, GleSYS |
...
이 정보는 Skooler에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직의 제어에 대해 제공되었습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 위임 | Microsoft로 로그인할 수 있도록 하는 UPN입니다. 프로필 미리 채우기의 이름 및 성을 지정합니다. | [dc171e47-c074-4bc2-9e7b-3856b71e0630](../azure/dc171e47-c074-4bc2-9e7b-3856b71e0630.md) |
