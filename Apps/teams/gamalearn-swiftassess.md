---
title: GamaLearn의 SwiftAssess 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/20/2021
...
description: SwiftAssess에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/0cd07157-f297-4c2c-a23b-64577bceea6c" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001973" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

GamaLearn에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | GamaLearn |
| 회사 웹 사이트 | [https://gamalearn.com](https://gamalearn.com) |
| 앱의 사용 약관 | [https://swiftassess.com/terms-and-conditions](https://swiftassess.com/terms-and-conditions) |
| 앱의 핵심 기능 | 조직의 모든 수준에서 평가 변환 전략 작성, 제공 및 추적을 통해 여정을 안내하는 시도된 방법론 및 기능에 이르기까지 모든 평가 요구 사항에 대한 원스톱 상점입니다. SwiftAssess는 여러 기관의 실제 평가 프로세스를 간소화하고 자동화하는 여러 주요 솔루션, 기능 및 워크플로를 제공합니다. 보안, 접근성, 분석, 항목 뱅킹 등과 관련된 업계 표준을 다룹니다. |
| 회사 본사 위치 | 아랍에미리트(해당) |
| 앱 정보 페이지 | [https://swiftassess.com/about/partners/microsoft#Teams](https://swiftassess.com/about/partners/microsoft#Teams) |
...
이 정보는 GamaLearn에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 제공되었습니다.
