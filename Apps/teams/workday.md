...
description: Workday, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용 가능한 모든 보안 및 규정 준수 정보입니다.
...
| 파트너 회사 이름 | Workday |
| 회사의 웹 사이트 | [https://www.workday.com/en-us/homepage.html](https://www.workday.com/en-us/homepage.html) |
| 앱 사용 약관 | [https://nw.myworkday.com/microsoftteams/post-license/](https://nw.myworkday.com/microsoftteams/post-license/) |
| 앱의 핵심 기능 | 간편하고 Teams 없는 HR 및 재무 작업을 위해 Workday를 추가하세요!  앱 보안 및 데이터 개인 정보 보호에 대한 자세한 내용은 Workday 고객은 Workday의 자연 작업 영역 혁신 서비스 설명 및 Workday의 자연 작업 영역 사용자 Community. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://nw.myworkday.com/microsoftteams/](https://nw.myworkday.com/microsoftteams/) |
...
| 데이터베이스에 저장되는 데이터는 무엇입니까? | Microsoft 테넌트 ID, 사용자 AAD 개체 ID, 대화 ID |
