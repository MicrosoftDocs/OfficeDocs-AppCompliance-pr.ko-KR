---
title: PigeonLab Pte Ltd의 비둘기 구멍 라이브 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/26/2022
...
description: Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보, 비둘기 구멍 라이브에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책.
...
ms.locfileid: "65749447"
---
# <a name="pigeonhole-live"></a>비둘기 구멍 라이브

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 5월 23일</p>

* <a href="https://teams.microsoft.com/l/app/96ecd0d3-9351-4fcb-ac50-08c85e36ab26" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001472" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Microsoft에 대한 PigeonLab Pte Ltd에서 제공하는 정보:
...
| 파트너 회사 이름 | PigeonLab Pte Ltd |
| 회사 웹 사이트 | [https://pigeonholelive.com](https://pigeonholelive.com) |
| 앱의 사용 약관 | [https://pigeonholelive.com/terms](https://pigeonholelive.com/terms) |
| 앱의 핵심 기능 | Q&amp;As, 설문 조사 및 퀴즈를 사용하여 모임에서 대화형 작업 향상 |
| 회사 본사 위치 | 싱가포르 |
| 앱 정보 페이지 | [https://pigeonholelive.com/microsoft-teams-meetings/](https://pigeonholelive.com/microsoft-teams-meetings/) |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직의 제어에 대해 PigeonLab Pte Ltd에서 제공했습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 전자 메일 및 이름, 비둘기 구멍 라이브의 대상 그룹 대화형 사용의 일부로 캡처된 기타 데이터 |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 전자 메일 및 이름, 비둘기 구멍 라이브의 대상 그룹 대화형 사용의 일부로 캡처된 기타 데이터 |
...
| 개인 정보 취급 방침 URL | https://www.pigeonholelive.com/privacy |
