---
title: Rungway별 Rungway에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/27/2022
...
description: Rungway에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/4bea8f81-966b-45fe-8c33-4c8843fda977" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004123" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Rungway에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | Rungway |
| 회사 웹 사이트 | [https://app.rungway.com](https://app.rungway.com) |
| 앱의 사용 약관 | [https://support.rungway.com/terms-conditions.html](https://support.rungway.com/terms-conditions.html) |
| 앱의 핵심 기능 | 질문하고 익명으로 문제를 제기합니다. 공유된 조언을 계속 진행하세요.   |
| 회사 본사 위치 | 영국 및 북아일랜드(해당) |
| 앱 정보 페이지 | [https://www.rungway.com/product-overview](https://www.rungway.com/product-overview) |
...
이 정보는 Rungway에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 사용자 전자 메일 주소, 사용자 프로필 정보(클라이언트당 사용자 지정 가능 및 사용자가 입력) |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 사용자 전자 메일 주소, 사용자 프로필 정보(클라이언트당 사용자 지정 가능 및 사용자가 입력) |
...
| 개인 정보 취급 방침 URL | https://support.rungway.com/privacy-policy.html |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 위임 | 사용자 프로필 읽기에 &amp; 로그인하려면 | [4bea8f81-966b-45fe-8c33-4c8843fda977](../azure/4bea8f81-966b-45fe-8c33-4c8843fda977.md) |
>| 전자 메일 | 위임 | 사용자 인증을 식별 &amp; 하려면 | [4bea8f81-966b-45fe-8c33-4c8843fda977](../azure/4bea8f81-966b-45fe-8c33-4c8843fda977.md) |
>| offline_access | 위임 | 데이터에 대한 액세스 유지 관리 | [4bea8f81-966b-45fe-8c33-4c8843fda977](../azure/4bea8f81-966b-45fe-8c33-4c8843fda977.md) |
>| openid | 위임 | 사용자를 로그인하려면 | [4bea8f81-966b-45fe-8c33-4c8843fda977](../azure/4bea8f81-966b-45fe-8c33-4c8843fda977.md) |
>| 프로필 | 위임 | 사용자의 기본 프로필을 보려면 | [4bea8f81-966b-45fe-8c33-4c8843fda977](../azure/4bea8f81-966b-45fe-8c33-4c8843fda977.md) |
