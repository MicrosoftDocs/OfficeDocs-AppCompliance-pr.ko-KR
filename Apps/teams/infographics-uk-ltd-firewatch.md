---
title: Infographics UK Ltd.의 FireWatch 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/30/2021
...
description: FireWatch에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/822055b4-508e-49c8-b7cc-c891ccb5c4eb" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003303" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Infographics UK Ltd.에서 Microsoft에 제공하는 정보:
...
| 회사 웹 사이트 | [https://www.infographics.co.uk](https://www.infographics.co.uk) |
| 앱의 사용 약관 | [https://www.infographics.co.uk/terms-and-conditions/](https://www.infographics.co.uk/terms-and-conditions/) |
| 앱의 핵심 기능 | FireWatch 커넥트 사용하면 FireWatch 애플리케이션을 Microsoft Teams 통합하여 사용자가 Microsoft Teams 내에서 직접 작업을 완료할 수 있습니다. 현재 Microsoft Teams 봇을 통해 사용자 지원 및 지원을 제공하여 Microsoft Teams 사용자 환경 내에서 직접 온/오프 업무를 예약할 수 있습니다. 향후 릴리스에는 FireWatch 휴일 요청, 작업 미리 알림 등을 포함하여 봇 및 카드를 통한 추가 작업에 대한 지원이 포함됩니다. |
...
이 정보는 Infographics UK Ltd.에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직의 제어에 대해 제공되었습니다.
