...
| 파트너 회사 이름 | 의사 결정 지점 |
| 회사의 웹 사이트 | [https://decisionpoint.ai](https://decisionpoint.ai) |
| 앱 사용 약관 | [https://beagleanalytics.ai/wp-content/uploads/2021/02/Terms...](https://beagleanalytics.ai/wp-content/uploads/2021/02/Terms-of-Use.pdf) |
| 앱의 핵심 기능 | 비글은 MS와 같은 플랫폼과 통합된 채팅 기반 BI 도구 Teams. 비글은 채택의 장벽을 낮추고 공동 작업 앱을 통해 사용자에게 데이터를 제공하여 교육(개인)의 필요성을 제거합니다.  비글은 사용자에게 인사이트 카드 형태로 관련 데이터를 표시하고 필터를 사용하여 심층 분석할 수 있도록 하여 의사 결정의 속도가 빨라집니다.  |
| 회사 본사 위치 | 인도 |
