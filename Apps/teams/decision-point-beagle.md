---
title: 의사 결정 지점별 비글에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/27/2021
...
description: Beagle에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/a0f836a9-178e-4407-9c26-4579dcd17bd1" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002687" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

의사 결정 지점에서 Microsoft로 제공하는 정보:
...
| 파트너 회사 이름 | 의사 결정 지점 |
| 회사 웹 사이트 | [https://decisionpoint.ai](https://decisionpoint.ai) |
| 앱의 사용 약관 | [https://beagleanalytics.ai/wp-content/uploads/2021/02/Terms...](https://beagleanalytics.ai/wp-content/uploads/2021/02/Terms-of-Use.pdf) |
| 앱의 핵심 기능 | 비글은 MS Teams 같은 플랫폼과 통합된 채팅 기반 BI 도구입니다. Beagle은 채택의 장벽을 낮추고 공동 작업 앱을 통해 사람들에게 데이터를 가져와 (개인의) 교육 필요성을 제거합니다.  Beagle은 인사이트 카드의 형태로 사용자에게 관련 데이터를 표시하고 필터를 사용하여 심층 분석하고 의사 결정을 더 빠르게 할 수 있도록 합니다.  |
| 회사 본사 위치 | 인도 |
| 앱 정보 페이지 | [https://beagleanalytics.ai](https://beagleanalytics.ai) |
...
이 정보는 의사 결정 지점에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 제공되었습니다.
