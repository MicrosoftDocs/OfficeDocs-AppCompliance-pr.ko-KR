---
title: 8x8 by 8x8, Inc.에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/16/2021
...
description: 8x8에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/bab6487a-dbe6-426f-b329-b7ef0d0fd5ba" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002665" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

8x8, Inc에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | 8x8, Inc |
| 회사 웹 사이트 | [https://www.8x8.com](https://www.8x8.com) |
| 앱의 사용 약관 | [https://www.8x8.com/terms-and-conditions](https://www.8x8.com/terms-and-conditions) |
| 앱의 핵심 기능 | 8x8 Voice는 PSTN 호출을 만들거나 수신하는 클라우드 기반 직접 라우팅 서비스입니다. 엔터프라이즈급 전화 통신 + 컨택 센터 기능을 사용하는 기본 환경입니다. 47개국의 무제한 통화 요금제 + 43개국, 분석, SMS, MMS 및 팩스의 PSTN 대체 서비스. 지역 또는 국제적으로 경제적인 통화 플랜을 얻고, Microsoft 365 최대한 활용하기 위해 Microsoft가 아직 플랜을 제공하지&#8217;않는 국가로 PSTN 통화를 확장합니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://www.8x8.com/products/integrations/8x8-voice-for-mic...](https://www.8x8.com/products/integrations/8x8-voice-for-microsoft-teams) |
| 앱을 실행하는 데 사용되는 호스팅 환경 또는 서비스 모델은 무엇인가요? |  |
| 앱에서 사용하는 호스팅 클라우드 공급자는 무엇인가요? | AWS, OracleCloud |
...
이 정보는 8x8, Inc에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
