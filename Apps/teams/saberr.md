...
description: Saberr에 대한 사용 가능한 모든 보안 및 규정 준수 정보 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보.
...
<p>최종 업데이트: 2021년 2월 11일</p>

* <a href="https://teams.microsoft.com/l/app/d3a07709-eb0e-421c-8609-b61b0600e645" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001501" target="_blank">앱소스에서 보기</a>
...
| 파트너 회사 이름 | Saberr |
| 파트너 웹사이트의 URL | [https://saberr.com](https://saberr.com) |
| Teams 응용 프로그램 정보 페이지의 URL | [https://help.saberr.com/en/articles/3854472-use-coachbot-in...](https://help.saberr.com/en/articles/3854472-use-coachbot-in-microsoft-teams-to-get-notifications-and-quick-actions) |
| 개인정보 처리방침의 URL | [https://help.saberr.com/en/articles/3853094-privacy-for-use...](https://help.saberr.com/en/articles/3853094-privacy-for-users-of-coachbot-s-microsoft-teams-or-slack-integrations) |
| 이용 약관의 URL | [https://help.saberr.com/en/articles/3853596-terms-and-condi...](https://help.saberr.com/en/articles/3853596-terms-and-conditions) |
...
이 정보는 Saberr에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직이 가질 수 있는 제어에 대해 제공했습니다.
...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| User.Read | 위임 | 이메일, 이름 및 성. API에서 계정 생성에 사용됩니다. | 이메일, 이름 및 성. API에서 계정 생성에 사용됩니다. | 9de91aee-708c-4d9f-958b-109fdb79d993 |
...
>|:-------------------|:--------------------------|:--------------------------|
>| AWS, 슬랙, 파이프 드라이브, 구글, 메일 침팬지, 인터콤, 크로노피 | 회사 이름, 사용자 이름, 사용자 이메일 주소 | 모임과 같은 기능을 사용하려면 사용자와 연결해야 합니다. 당사는 이러한 인앱 조직을 설립하고 계약 + 지원을 수행하는 데 필요한 EUII/OII만 이전합니다. |
...
>|:--------------------------------|:---------------------|:--------------------------|
>| API에서 계정 생성을 위해 이메일, 이름 및 성이 필요합니다. | 이메일, 이름, 성 | API에서 계정 생성에 필요 |
...
이 정보는 이 앱이 인증, 권한 부여, 응용 프로그램 등록 모범 사례 및 기타 ID 기준을 처리하는 방법에 대해 Saberr에서 제공했습니다.
