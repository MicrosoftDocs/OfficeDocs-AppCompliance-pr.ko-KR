---
title: Aros 클라우드 APS의 참석자에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/16/2022
...
description: 'CSA STAR 레지스트리의 참석자, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용 가능한 모든 보안 및 규정 준수 정보'
...
* <a href="https://teams.microsoft.com/l/app/30b8d518-2535-4919-ab8b-d0fab193380f" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003856" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Aros Cloud ApS에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | Aros Cloud ApS |
| 회사의 웹 사이트 | [https://www.attender.uk](https://www.attender.uk) |
| 앱 사용 약관 | [https://www.attender.uk/wp-content/uploads/2022/02/Terms-of...](https://www.attender.uk/wp-content/uploads/2022/02/Terms-of-use.pdf) |
| 앱의 핵심 기능 | 학생 드롭아웃을 낮추고 교육 시간을 절약하는 학교의 빠른 참석 등록입니다. |
| 회사 본사 위치 | 덴마크 |
| 앱 정보 페이지 | [https://www.attender.uk](https://www.attender.uk) |
...
이 정보는 Aros Cloud ApS에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직이 제어할 수 있는 방법에 대해 제공했습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기반 인프라가 Microsoft 고객 또는 장치와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇입니까? | 사용자 UPN 이름, 사용자 표시 이름, 학생 참석 데이터, 학생 프로필 사진, 교사 및 학생 시간표 데이터 |
| 앱에서 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기반 인프라에 Microsoft 고객 데이터가 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇입니까? | 사용자 UPN 이름, 사용자 표시 이름, 학생 참석 데이터, 학생 프로필 사진, 교사 및 학생 시간표 데이터 |
| Microsoft 고객 데이터를 원본으로 사용하여 처리하거나 저장하는 경우 이 데이터는 지리적으로 저장되는 위치입니다. | 덴마크 |
...
| 개인 정보 취급 방침 URL | https://www.attender.uk/wp-content/uploads/2022/02/Privacy-Statement.pdf |
...
| 지원되는 정책 유형 나열 | Azure AD에서 모두 지원 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.Read.All | 위임 | 사용자 역할 결정 | [3741153e-2490-463c-aff7-5283fb1bd1b4](../azure/3741153e-2490-463c-aff7-5283fb1bd1b4.md) |
>| GroupMember.Read.All | 위임 | 사용자 역할 결정 | [3741153e-2490-463c-aff7-5283fb1bd1b4](../azure/3741153e-2490-463c-aff7-5283fb1bd1b4.md) |
>| User.Read | 위임 | 로그인 | [3741153e-2490-463c-aff7-5283fb1bd1b4](../azure/3741153e-2490-463c-aff7-5283fb1bd1b4.md) |
>| 전자 메일 | 위임 | 사용자 로그인 이름을 얻습니다. | [3741153e-2490-463c-aff7-5283fb1bd1b4](../azure/3741153e-2490-463c-aff7-5283fb1bd1b4.md) |
>| openid | 위임 | Single Sign-On | [3741153e-2490-463c-aff7-5283fb1bd1b4](../azure/3741153e-2490-463c-aff7-5283fb1bd1b4.md) |
>| 프로필 | 위임 | 사용자 정보 | [3741153e-2490-463c-aff7-5283fb1bd1b4](../azure/3741153e-2490-463c-aff7-5283fb1bd1b4.md) |
