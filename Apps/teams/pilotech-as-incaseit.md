---
title: Pilotech AS의 InCaseIT에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/20/2021
...
description: InCaseIT, 해당 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/4420b597-c1d5-4d40-ba81-2b2a78575c81" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003265" target="_blank">AppSource에서 보기</a>
...
| 회사 웹 사이트 | [https://incaseit.com](https://incaseit.com) |
| 앱의 사용 약관 | [https://www.manula.com/manuals/pilotech-as/incaseit2/1/en/t...](https://www.manula.com/manuals/pilotech-as/incaseit2/1/en/topic/1-4-terms-of-use) |
| 앱의 핵심 기능 | 위기 관리 시스템. 위기 및 사고의 준비 및 처리를 위한 시스템입니다. |
| 회사 본사 위치 | 노르웨이 |
| 앱 정보 페이지 | [https://www.manula.com/manuals/pilotech-as/incaseit2/1/en/t...](https://www.manula.com/manuals/pilotech-as/incaseit2/1/en/topic/introduction-to-incaseit-version-2-0) |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 Pilotech AS에서 제공했습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | 위임 | 사용되는 유일한 데이터는 애플리케이션이 액세스 토큰을 사용하여 Graph API를 호출할 수 있도록 사용자가 명시적으로 확인하는 것입니다. | [9af6eceb-6a8b-4710-b51d-dde2ac01cc71](../azure/9af6eceb-6a8b-4710-b51d-dde2ac01cc71.md) |
>| OnlineMeetings.ReadWrite | 위임 | 사용되는 유일한 데이터는 애플리케이션이 액세스 토큰을 사용하여 Graph API를 호출할 수 있도록 사용자가 명시적으로 확인하는 것입니다. | [9af6eceb-6a8b-4710-b51d-dde2ac01cc71](../azure/9af6eceb-6a8b-4710-b51d-dde2ac01cc71.md) |
>| User.Read | 위임 | 사용되는 유일한 데이터는 애플리케이션이 액세스 토큰을 사용하여 Graph API를 호출할 수 있도록 사용자가 명시적으로 확인하는 것입니다. | [9af6eceb-6a8b-4710-b51d-dde2ac01cc71](../azure/9af6eceb-6a8b-4710-b51d-dde2ac01cc71.md) |
