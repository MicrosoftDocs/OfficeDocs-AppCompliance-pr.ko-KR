---
title: Cireson의 Tikit 가상 에이전트에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/29/2022
...
description: Tikit 가상 에이전트, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
ms.locfileid: "66564632"
---
# <a name="tikit-virtual-agent"></a>Tikit 가상 에이전트

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 5월 4일</p>

* <a href="https://teams.microsoft.com/l/app/55f323bf-3622-4624-b3b5-0582d8be4ad5" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004288" target="_blank">AppSource에서 보기</a>
...
| 파트너 회사 이름 | Cireson |
| 회사 웹 사이트 | [https://tikit.ai](https://tikit.ai) |
| 앱의 사용 약관 | [https://tikit.ai/terms-service/](https://tikit.ai/terms-service/) |
| 앱의 핵심 기능 | Tikit&#8217;가상 에이전트: 최종 사용자는 모든 지원 티켓팅 요구 사항에 대한 솔루션을&#8217;. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://tikit.ai](https://tikit.ai) |
...
이 정보는 Cireson에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 사용자 프로필 및 사용자 메일 데이터 |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 사용자 프로필(Azure Active Directory 정보 - 이름, 제목 등) |
...
| Microsoft 고객 데이터를 공유하는 타사 서비스와 데이터 공유 계약이 있나요? | 아니요 |
...
| 개인 정보 취급 방침 URL | https://www.tikit.ai/privacy-statement/ |
...
| 지원되는 정책 유형 나열 | 다단계 인증, 등록된 Intune 디바이스만 특정 서비스에 액세스할 수 있도록 허용, 사용자 위치 및 IP 범위 제한 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.AccessAsUser.All | 위임 | 애플리케이션 내에서 RBAC에 대한 역할 할당을 읽는 데 사용됩니다. | [55f323bf-3622-4624-b3b5-0582d8be4ad5](../azure/55f323bf-3622-4624-b3b5-0582d8be4ad5.md) |
>| Directory.Read.All | 위임 | 애플리케이션 내에서 RBAC에 대한 역할 할당을 읽는 데 사용됩니다. | [55f323bf-3622-4624-b3b5-0582d8be4ad5](../azure/55f323bf-3622-4624-b3b5-0582d8be4ad5.md) |
>| Group.Read.All | 둘 다 | 애플리케이션 내에서 RBAC에 대한 역할 할당을 읽는 데 사용됩니다. | [55f323bf-3622-4624-b3b5-0582d8be4ad5](../azure/55f323bf-3622-4624-b3b5-0582d8be4ad5.md) |
>| User.Read | 위임 | 로그인 | [55f323bf-3622-4624-b3b5-0582d8be4ad5](../azure/55f323bf-3622-4624-b3b5-0582d8be4ad5.md) |
>| User.Read.All | 응용 프로그램 | 로그인 | [55f323bf-3622-4624-b3b5-0582d8be4ad5](../azure/55f323bf-3622-4624-b3b5-0582d8be4ad5.md) |
>| User.ReadBasic.All | 위임 | 로그인 | [55f323bf-3622-4624-b3b5-0582d8be4ad5](../azure/55f323bf-3622-4624-b3b5-0582d8be4ad5.md) |
>| 전자 메일 | 위임 | 로그인 권한 | [55f323bf-3622-4624-b3b5-0582d8be4ad5](../azure/55f323bf-3622-4624-b3b5-0582d8be4ad5.md) |
>| openid | 위임 | 로그인 | [55f323bf-3622-4624-b3b5-0582d8be4ad5](../azure/55f323bf-3622-4624-b3b5-0582d8be4ad5.md) |
>| 프로필 | 위임 | 로그인 | [55f323bf-3622-4624-b3b5-0582d8be4ad5](../azure/55f323bf-3622-4624-b3b5-0582d8be4ad5.md) |
