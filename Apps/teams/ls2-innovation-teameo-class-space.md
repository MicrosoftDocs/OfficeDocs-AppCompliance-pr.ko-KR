---
title: LS2 혁신을 위한 Teameo 클래스 공간에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/03/2022
...
description: Teameo Class Space, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용 가능한 모든 보안 및 규정 준수 정보
...
* <a href="https://teams.microsoft.com/l/app/ec7d1cd2-2a06-4f96-baa5-1cc88026a835" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003630" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

LS2 혁신에서 Microsoft에 제공하는 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | Teameo Class Space |
| ID | WA200003630 |
| Office 365 클라이언트 지원 | Microsoft Teams |
| 파트너 회사 이름 | LS2 Innovation |
| 회사의 웹 사이트 | [https://teameo.io](https://teameo.io) |
| 앱 사용 약관 | [https://teameo.io/legal/terms-of-service.html](https://teameo.io/legal/terms-of-service.html) |
| 앱의 핵심 기능 | Teameo 수업 공간을 통해 교사는 과정 세부 정보, 응용 프로그램 및 링크를 표시 할 수 있습니다. |
| 회사 본사 위치 | 캐나다 |
| 앱 정보 페이지 | |
...
이 정보는 LS2 혁신을 통해 이 앱이 조직 데이터를 수집 및 저장하는 방법과 조직에서 수집하는 데이터를 통해 조직이 하게 될 컨트롤에 대해 제공됩니다.
...
| 데이터베이스에 저장되는 데이터는 무엇입니까? | 사용자 정보(이름, 전자 메일), 테넌트 정보(ID, 이름) |
...
| 개인 정보 취급 방침 URL | https://teameo.io/legal/privacy-policy.html |
