...
description: Nugget에 대한 사용 가능한 모든 보안 및 규정 준수 정보 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보.
...
* <a href="https://teams.microsoft.com/l/app/4e85cc82-5187-4059-af36-a49e7db32bee" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001737" target="_blank">앱소스에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

판비바에서 마이크로소프트에 제공하는 정보:
...
| 파트너 회사 이름 | Panviva |
| 파트너 웹사이트의 URL | [https://www.panviva.com](https://www.panviva.com) |
| 개인정보 처리방침의 URL | [https://www.panviva.com/privacy-policy](https://www.panviva.com/privacy-policy) |
| 이용 약관의 URL | [https://www.panviva.com/terms-and-conditions](https://www.panviva.com/terms-and-conditions) |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 조직에서 앱이 수집하는 데이터에 대한 제어에 대해 Panviva에서 제공했습니다.
...
>예.
사용자 id가 저장될 Teams : 이 에 필요한 테넌트에 대한 정보와 사용자가 관리자인지 아닌지에 대한 정보를 검색할 수 있습니다.
Teams 조직 ID : 테넌트의 사용자를 검색하고 특정 테넌트의 구독 세부 정보를 검색할 수 있도록 저장됩니다.

#### <a name="organizational-controls-for-data-stored-by-partner"></a>파트너가 저장한 데이터에 대한 조직 제어

조직의 관리자가 파트너 시스템에서 자신의 정보를 제어하는 방법을 설명해 보세요. 예를 들어 삭제, 보존, 감사, 보관, 최종 사용자 정책 등

>Azure CosmosDB를 사용하여 모든 응용 프로그램 데이터를 저장합니다. 데이터에 액세스하려면 엔드포인트와 키가 필요하며, 둘 다 데이터에 액세스하는 데 사용되는 구성 서비스에 주입됩니다. 구성 서비스는 봇 앱 서비스의 요청에서 수신하는 베어러 토큰으로만 요청을 처리합니다. 이 토큰은 사용자가 팀 인터페이스의 봇에 로그인할 때 원래 Okta에 의해 만들어집니다. 이 데이터는 2단계 인증을 사용하여 Microsoft Azure 플랫폼에 로그인해야 하는 Panviva 관리자에 의해 액세스할 수 있습니다. 이메일 및 사용자 이름은 OKTA에 저장되며 구성 서비스에서 액세스하는 키 자격 증명 모음에 저장된 개인 키만 액세스할 수 있습니다. 구성 서비스만 관리되는 ID를 사용하여 키 자격 증명에 액세스할 수 있으며 앱에 저장되지 않습니다.
