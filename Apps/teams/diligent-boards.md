...
description: CSA STAR 레지스트리의 Boards, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
ms.locfileid: "63549416"
---
# <a name="diligent-boards"></a>Diligent Boards

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2021년 11월 9일</p>

* <a href="https://teams.microsoft.com/l/app/df797265-8679-421c-a75c-3540540daf42" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003544" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Microsoft에 부지런히 제공한 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | Diligent Boards |
| ID | WA200003544 |
| Office 365 클라이언트 지원 | Microsoft Teams |
| 파트너 회사 이름 | Diligent |
| 회사의 웹 사이트 | [https://www.diligent.com](https://www.diligent.com) |
| 앱 사용 약관 | [https://diligent.com/terms-of-use](https://diligent.com/terms-of-use) |
| 앱의 핵심 기능 | 최신&#8217;동급 최고의 거버넌스 소프트웨어에 액세스하여 Microsoft Teams. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
...
이 정보는 이 앱이 조직 데이터를 수집 및 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직이 하게 될 컨트롤에 대해 신성하게 제공했습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기반 인프라가 Microsoft 고객 또는 장치와 관련된 데이터를 처리하나요? | 아니요 |
| 앱 또는 기반 인프라에 Microsoft 고객 데이터가 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇입니까? | Microsoft Teams 테넌트 ID 및 Teams ID |
...
| 가장 최근 SOC1 인증 날짜 |  2021-04-08 |
| 앱이 SOC(서비스 조직 제어)를 준수하나요? | 예 |
| 어떤 SOC 2 인증을 획득했나요? |  type2 |
| 가장 최근 SOC2 인증 날짜 |  2021-04-08 |
...
| 개인 정보 취급 방침 URL | https://diligent.com/privacy-policy |
