---
title: 유럽 코드 팩터리 s.r.o별 vimheslo에 대한 애플리케이션 정보입니다.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/08/2022
...
description: vimheslo에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/73ee6b52-6b68-41c1-a7c5-91919e05b845" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003843" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

유럽 코드 팩터리 s.r.o에서 제공하는 정보 Microsoft에 다음을 수행합니다.
...
| 파트너 회사 이름 | European Code Factory s.r.o. |
| 회사 웹 사이트 | [https://ecodef.cz](https://ecodef.cz) |
| 앱의 사용 약관 | [https://ecodef.cz/terms_of_use.html](https://ecodef.cz/terms_of_use.html) |
| 앱의 핵심 기능 | 암호 관리자 |
| 회사 본사 위치 | 체코 |
| 앱 정보 페이지 | [https://vimheslo.cz](https://vimheslo.cz) |
...
이 정보는 유럽 코드 팩터리 s.r.o에서 제공되었습니다. 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 설명합니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.Read.All | 위임 | 데이터는 OneDrive 또는 SharePoint 문서 라이브러리에 저장되며 애플리케이션은 데이터를 읽어야 합니다. | [73ee6b52-6b68-41c1-a7c5-91919e05b845](/microsoft-365-app-certification/azure/73ee6b52-6b68-41c1-a7c5-91919e05b845) |
>| Sites.Read.All | 위임 | 팀 컨텍스트의 애플리케이션은 관련 SharePoint 문서 라이브러리에 데이터를 저장합니다. 애플리케이션은 데이터가 있는 파일이 있는 경로를 설정하기 위해 사이트 이름을 읽어야 합니다. | [73ee6b52-6b68-41c1-a7c5-91919e05b845](/microsoft-365-app-certification/azure/73ee6b52-6b68-41c1-a7c5-91919e05b845) |
>| User.Read | 위임 | 애플리케이션은 개인 데이터를 저장하기 위해 개인 OneDrive 알고 있어야 합니다. | [73ee6b52-6b68-41c1-a7c5-91919e05b845](/microsoft-365-app-certification/azure/73ee6b52-6b68-41c1-a7c5-91919e05b845) |
>| 전자 메일 | 위임 | 데이터 공유를 허용합니다. | [73ee6b52-6b68-41c1-a7c5-91919e05b845](/microsoft-365-app-certification/azure/73ee6b52-6b68-41c1-a7c5-91919e05b845) |
