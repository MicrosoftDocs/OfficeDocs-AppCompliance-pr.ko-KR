---
title: NetForce 365 GmbH의 HubSite 365에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/27/2022
...
description: HubSite 365에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보
...
* <a href="https://teams.microsoft.com/l/app/ef56f507-2c71-4bb1-ba4a-0a7016f7a210" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003704" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

NetForce 365 GmbH에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | NetForce 365 GmbH |
| 회사의 웹 사이트 | [https://www.netforce365.com](https://www.netforce365.com) |
| 앱 사용 약관 | [https://netforce365.com/en/tus](https://netforce365.com/en/tus) |
| 앱의 핵심 기능 | 최신 뉴스, 지식 및 이벤트 관련 정보를 찾아 Microsoft 365. |
| 회사 본사 위치 | 독일 |
| 앱 정보 페이지 | |
...
이 정보는 NetForce 365 GmbH에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직에서 제공하는 컨트롤에 대해 제공됩니다.
...
| 데이터베이스에 저장되는 데이터는 무엇입니까? | 사용자 전자 메일 주소, 이름 및 성 |
...
| 개인 정보 취급 방침 URL | https://teams.hubsite365.com/privacy-policy |
