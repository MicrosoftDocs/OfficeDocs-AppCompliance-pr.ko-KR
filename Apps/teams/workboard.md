---
title: Workboard별 Workboard에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/04/2021
...
| Teams 애플리케이션 정보 페이지의 URL | [https://www.workboard.com/microsoft/](https://www.workboard.com/microsoft/) |
...
이 정보는 Workboard에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
...
>|:---------------------------------------|:-----------------------------------|:------------------------------------|
>| 사용자 ID는 WorkBord에서 Teams 보내는 사전 알림에 사용됩니다. | 사용자 전자 메일 주소 및 ID | 사용자를 WorkBoard의 사용자 ID에 매핑하는 데 사용됩니다. |
...
>WorkBoard는 파트너의 시스템에 조직 데이터를 저장하지 않습니다.
...
<iframe height='1020' title='Microsoft Cloud App Security 정보' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/29004' frameborder='no'></iframe>
...
이 정보는 이 앱이 인증, 권한 부여, 애플리케이션 등록 모범 사례 및 기타 ID 조건을 처리하는 방법에 대한 Workboard에서 제공되었습니다.
