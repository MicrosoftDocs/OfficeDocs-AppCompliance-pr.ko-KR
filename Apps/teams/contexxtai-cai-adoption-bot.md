...
---
# <a name="cai-adoption-bot"></a>C.AI 채택 봇
...
| 파트너 웹 사이트의 URL | [https://www.contexxt.ai](https://www.contexxt.ai) |
| 응용 프로그램 Teams 페이지의 URL입니다. | [https://contexxt.ai/sphere/cai-adoption-bot](https://contexxt.ai/sphere/cai-adoption-bot) |
...
>|:--------------------------------|:---------------------|:--------------------------|
>| 기술적으로 피할 수 없습니다. Microsoft Teams(사용자 ID)를 자동으로 전송합니다. | 아니요 |  |
...
>파트너 시스템의 데이터에 대한 액세스나 제어 권한이 없습니다.
