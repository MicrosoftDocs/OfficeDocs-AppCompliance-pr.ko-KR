---
title: contexxt.ai C.AI 입양 봇에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
ms.date: 04/28/2021
ms.topic: article
...
description: C.AI 채택 봇에 대한 사용 가능한 모든 보안 및 규정 준수 정보 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보.
...
* <a href="https://teams.microsoft.com/l/app/f5323aab-3063-46cb-b632-ee01d95de494" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002633" target="_blank">앱소스에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

contexxt.ai Microsoft에 제공하는 정보:
...
| 파트너 웹사이트의 URL | [https://www.contexxt.ai](https://www.contexxt.ai) |
| Teams 응용 프로그램 정보 페이지의 URL | [https://contexxt.ai/sphere/cai-adoption-bot](https://contexxt.ai/sphere/cai-adoption-bot) |
| 개인정보 처리방침의 URL | [https://contexxt.ai/privacy-policy/](https://contexxt.ai/privacy-policy/) |
| 이용 약관의 URL | [https://contexxt.ai/terms-of-use/](https://contexxt.ai/terms-of-use/) |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 조직에서 앱이 수집하는 데이터에 대한 제어에 대한 contexxt.ai 제공되었습니다.
...
>|:--------------------------------|:---------------------|:--------------------------|
>| 기술적으로 피할 수 Microsoft Teams 자동으로 (사용자 ID)를 보냅니다. | 아니요 |  |
...
>당사는 파트너 시스템의 데이터에 액세스하거나 제어할 수 없습니다.
...
이 정보는 이 앱이 인증, 권한 부여, 응용 프로그램 등록 모범 사례 및 기타 ID 기준을 처리하는 방법에 대해 contexxt.ai 제공되었습니다.
