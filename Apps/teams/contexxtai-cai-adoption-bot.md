...
| 앱의 핵심 기능 | 전체 채택 제품군을 사용하는 경우 포함 &quot; 개인 코칭 부스터&quot;는 개인용 코칭 엔진(C.AI Adoption Analytics) &amp; 분석으로 Graph API 사용자로부터의 Exchange Teams. 이 데이터를 기반으로 봇 알고리즘(C.AI 채택 &amp; 봇)은 특정 학습 상황을 감지하여 사용자에게 빠른 팁을 전송합니다. 예: 사용자가 Teams 제목을 추가하지 않은 경우 봇에서는 사용자가 해당 작업을 하는 방법을 모르는 것으로 가정하고 사용자 지정된 학습 자료를 전송합니다. 분석이 없는 경우 QA&amp; 봇일 것입니다. |
| 회사 본사 위치 | 독일 |
...
| 앱에서 처리되는 데이터는 무엇입니까? | 사용자 프로필, 사용자 프로필, Exchange 및 Teams 및 집계된 메타데이터 |
| 앱에서 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기반 인프라에 Microsoft 고객 데이터가 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇입니까? | 사용자 프로필, 사용자 프로필, Exchange 및 Teams 및 집계된 메타데이터 |
...
| 개인 정보 취급 방침 URL | https://contexxt.ai/privacy-policy/ |
...
| 지원되는 정책 유형 나열 | 관리자는 MFA를 사용할 수 있습니다. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | application | 시간 관리 모범 사례에 대한 달력 사용 현황 데이터 읽기 | [abe28a0d-6acc-47d8-9169-cfcc2553bc13](../azure/abe28a0d-6acc-47d8-9169-cfcc2553bc13.md) |
>| CallRecords.Read.All | application | 모임 Teams 모범 사례에 대한 통화 사용 현황 데이터 읽기 | [abe28a0d-6acc-47d8-9169-cfcc2553bc13](../azure/abe28a0d-6acc-47d8-9169-cfcc2553bc13.md) |
>| ChannelMessage.Read.All | application | 메시지 Teams 모범 사례에 대한 Teams 채널 사용 현황 데이터 읽기 | [abe28a0d-6acc-47d8-9169-cfcc2553bc13](../azure/abe28a0d-6acc-47d8-9169-cfcc2553bc13.md) |
>| Chat.Read.All | application | 채팅 Teams 모범 사례에 대한 Teams 채팅 사용 현황 데이터 읽기 | [abe28a0d-6acc-47d8-9169-cfcc2553bc13](../azure/abe28a0d-6acc-47d8-9169-cfcc2553bc13.md) |
>| Directory.Read.All | 둘 다 | 봇과 상호 작용하기 위한 사용자 프로필 데이터 읽기 | [abe28a0d-6acc-47d8-9169-cfcc2553bc13](../azure/abe28a0d-6acc-47d8-9169-cfcc2553bc13.md) |
>| Group.Read.All | application | Teams 모범 사례에 대한 Teams 사용 현황 데이터 읽기 | [abe28a0d-6acc-47d8-9169-cfcc2553bc13](../azure/abe28a0d-6acc-47d8-9169-cfcc2553bc13.md) |
>| Group.ReadWrite.All | application | 선택 사항: Planner 모범 사례를 위해 Planner에 임시로 서비스 사용자 계정을 작성하려면 | [abe28a0d-6acc-47d8-9169-cfcc2553bc13](../azure/abe28a0d-6acc-47d8-9169-cfcc2553bc13.md) |
>| Mail.Read | application | 전자 메일 관리 모범 사례에 대한 메일 메타데이터 읽기 | [abe28a0d-6acc-47d8-9169-cfcc2553bc13](../azure/abe28a0d-6acc-47d8-9169-cfcc2553bc13.md) |
>| Tasks.Read | 위임 | Planner 모범 사례에 대한 Planner 사용 현황 데이터를 읽으면 | [abe28a0d-6acc-47d8-9169-cfcc2553bc13](../azure/abe28a0d-6acc-47d8-9169-cfcc2553bc13.md) |
>| User.Read.All | application | 사용자 메타데이터(그룹 구성원과 같은 사용자 메타데이터)를 읽고 Teams 모범 사례 | [abe28a0d-6acc-47d8-9169-cfcc2553bc13](../azure/abe28a0d-6acc-47d8-9169-cfcc2553bc13.md) |
...
|:------------|:---------------------------------------|
| [**응용 프로그램 보안**](../docs/certification-submission-guide.md#application-security) | **PASS** |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;침투 테스트 | 범위 내 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;취약점 평가 검토(DAST/SAST/침투 테스트) | 범위 내 |
| [**운영 보안**](../docs/certification-submission-guide.md#operational-security) | **PASS** |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;맬웨어 보호 - 바이러스 백신 | 범위 내 |
...
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;정보 보안 위험 관리 | 범위 내 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;인시던트 대응 | 범위 내 |
| [**데이터 처리 보안 개인 정보 &amp;**](../docs/certification-submission-guide.md#data-handling-security-and-privacy) | **PASS** |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;전송 중 데이터 | 범위 내 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;미사시 데이터 | 범위 내 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;데이터 보존 및 폐기 | 범위 내 |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;데이터 액세스 관리 | 범위 내 |
