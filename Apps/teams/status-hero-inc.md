---
title: 상태 영웅에 의해 상태 영웅에 대한 응용 프로그램 정보, Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/10/2022
...
description: Status Hero에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/7917afd4-9825-4c1d-b683-ce1fcb77d5b4" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004205" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Status Hero, Inc.가 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | Status Hero, Inc. |
| 회사 웹 사이트 | [https://statushero.com](https://statushero.com) |
| 앱의 사용 약관 | [https://statushero.com/terms](https://statushero.com/terms) |
| 앱의 핵심 기능 | Status Hero는 팀 도구의 비동기 체크 인 및 데이터를 간결하고 통찰력 있는 보고서로 바꿉니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://statushero.com/integrations/microsoft-teams](https://statushero.com/integrations/microsoft-teams) |
...
이 정보는 Status Hero, Inc.에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직의 제어에 대해 제공되었습니다.
...
| 개인 정보 취급 방침 URL | https://statushero.com/privacy |
