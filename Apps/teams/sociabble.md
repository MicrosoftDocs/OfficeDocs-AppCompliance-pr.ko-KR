...
description: CSA STAR 레지스트리의 Sociabble, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용 가능한 모든 보안 및 규정 준수 정보입니다.
...
| 파트너 회사 이름 | Sociabble |
| 회사의 웹 사이트 | [https://www.sociabble.com](https://www.sociabble.com) |
| 앱 사용 약관 | [https://www.sociabble.com/terms-of-use/](https://www.sociabble.com/terms-of-use/) |
| 앱의 핵심 기능 | 콘텐츠를 소개하고 직원의 지지를 통해 도달을 확대합니다. |
| 회사 본사 위치 | 프랑스 |
