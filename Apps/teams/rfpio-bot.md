---
title: RFPIO별 RFPIO 봇에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/03/2021
...
description: RFPIO 봇에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/77c23de0-bcf9-4f27-91c9-135a82ee2543" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001880" target="_blank">AppSource에서 보기</a>
...
| 파트너 회사 이름 | RFPIO |
| 회사 웹 사이트 | [https://www.rfpio.com](https://www.rfpio.com) |
| 앱의 사용 약관 | [https://www.rfpio.com/terms-of-service/](https://www.rfpio.com/terms-of-service/) |
| 앱의 핵심 기능 | RFPIO는 최고의 RFP 응답 관리 솔루션이자 업계 최초의 AI 지원 RFP 소프트웨어로, RFP, RFIs, 보안 설문지 및 DDQ에 대한 응답을 관리하는 세계에서 가장 똑똑한 회사 중 일부가 신뢰합니다.  |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://www.rfpio.com/product/](https://www.rfpio.com/product/) |
| 앱을 실행하는 데 사용되는 호스팅 환경 또는 서비스 모델은 무엇인가요? |  |
| 앱에서 사용하는 호스팅 클라우드 공급자는 무엇인가요? | Azure, AWS, GCP |
...
이 정보는 RFPIO에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
