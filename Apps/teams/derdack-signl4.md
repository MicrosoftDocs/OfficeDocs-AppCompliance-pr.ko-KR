...
description: SIGNL4에 대한 사용 가능한 모든 보안 및 규정 준수 정보 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보.
...
* <a href="https://teams.microsoft.com/l/app/bd19c878-00b7-47cd-9b65-74a2def84427" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001239" target="_blank">앱소스에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

마이크로소프트에 Derdack SIGNL4에 의해 제공 된 정보:
...
| 파트너 웹사이트의 URL | [https://www.signl4.com](https://www.signl4.com) |
| 개인정보 처리방침의 URL | [https://www.signl4.com/privacy-policy/](https://www.signl4.com/privacy-policy/) |
| 이용 약관의 URL | [https://www.signl4.com/terms_of_use/](https://www.signl4.com/terms_of_use/) |
...
이 정보는 Derdack SIGNL4에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직이 가질 수 있는 제어에 대해 제공했습니다.
...
>|:-------------------|:--------------------------|:--------------------------|
>| 다시 전자 메일 주소, 이메일 주소는 앱을 사용할 때 고객에게 청구 알림을 보내야 합니다. Twilio, 전화 번호, SMS 문자 메시지를 통해 경고를 보내는 콘텐츠 경고 |  | Azure 관리 API, Azure 모니터 경고가 수집되고, 컬렉션은 시스템이 해당 경고에 대한 알림을 전송하기 때문에 발생합니다. |
...
>이메일 주소 정보는 로그에 포함되어 있습니다. 또한 조직에서 제출한 추가 경고 콘텐츠 데이터가 로그에 포함될 수 있습니다. 이를 방지하기 위해 조직은 앱에서 계정을 종료할 수 있습니다.
로그의 데이터는 고객 ma가 앱에 대해 가지고 있는 문제를 지원하고 문제 해결하려면 필요합니다.

#### <a name="organizational-controls-for-data-stored-by-partner"></a>파트너가 저장한 데이터에 대한 조직 제어

조직의 관리자가 파트너 시스템에서 자신의 정보를 제어하는 방법을 설명해 보세요. 예를 들어 삭제, 보존, 감사, 보관, 최종 사용자 정책 등

>데이터는 유럽의 Azure 데이터 센터에 저장됩니다. 관리자에 대 한 액세스 가능 합니다. AAD 인증을 사용하여 2FA. 저장소 계정에 대한 액세스 키도 액세스를 관리하는 데 사용됩니다.
