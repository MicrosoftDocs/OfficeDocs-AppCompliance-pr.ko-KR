...
* <a href="https://teams.microsoft.com/l/app/90381cb0-998f-4ba3-9699-130201de5ddb" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA104381384" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Ataira에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | Ataira |
| 회사 웹 사이트 | [https://www.ataira.com](https://www.ataira.com) |
| 앱의 사용 약관 | [https://www.ataira.com/TermsofUse](https://www.ataira.com/TermsofUse) |
| 앱의 핵심 기능 | Ataira 추가 기능을 사용하면 Power BI 대시보드 및 보고서를 볼 수 있습니다. 회사 그룹 및 팀에 알림을 보내고, 후속 작업을 추가하고, Power BI 공개 링크를 포함하고, 보고서의 데이터 요소에 주석을 추가하고, 데이터 파일을 Power BI 보고서에 데이터 원본으로 추가하고, 실시간으로 업데이트합니다. 비즈니스 인텔리전스 팀이 한 위치에서 비즈니스 인텔리전스 활동을 보다 긴밀하게 협업할 수 있도록 합니다. |
| 회사 본사 위치 | 미국 |
...
이 정보는 Ataira에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
...
| 지원되는 정책 유형 나열 | 다단계 인증을 통해 등록된 Intune 디바이스만 사용자 위치 및 IP 범위를 제한하는 특정 서비스에 액세스할 수 있습니다. |
