...
ms.locfileid: "61420863"
---
# <a name="team-tracker"></a>팀 추적기
...
| 회사의 웹 사이트 | [https://team-tracker.com](https://team-tracker.com) |
| 앱 사용 약관 | [https://team-tracker.com/terms-and-conditions.html](https://team-tracker.com/terms-and-conditions.html) |
| 앱의 핵심 기능 | Team Tracker는 hot desk 예약을 위한 사용자 첫 번째 앱으로, 해당 작업 보기 |
...
이 정보는 Team Tracker Ltd에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직에서 제공하는 컨트롤에 대해 제공됩니다.
...
>|:------------------------|:--------------------|:------------------------------------|
>| Calendars.ReadWrite | 위임 | 사용자가 몇 주 동안 활동을 설정하고 나면 Team Tracker는 선택에 따라 사용자 일정 및 가용성을 업데이트합니다.  |
>| 전자 메일 | 위임 | 사용자 전자 메일을 확인하는 데 사용됩니다. |
>| MailboxSettings.Read | 위임 | 일정 이벤트를 만드는 데 사용되는 시간제 |
>| openid | 위임 | 사용자가 자신의 계정으로 로그인할 Office 365 있습니다. |
>| 프로필 | 위임 | 프로필에 대한 사용자 기본 정보 확인 |
>| User.Read | 위임 | 프로필에 대한 사용자 정보 확인 |
