...
description: Creately, 해당 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/dddf988d-00af-480f-b419-76a357a72460" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004335" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Creately에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | Creately |
| 회사 웹 사이트 | [https://creately.com](https://creately.com) |
| 앱의 사용 약관 | [https://creately.com/tos](https://creately.com/tos) |
| 앱의 핵심 기능 | Creately를 사용하면 이전과는 전혀 다른 시각적 공동 작업을 경험할 수 있습니다. 이제 Microsoft Teams를 벗어나지 않고 모든 작업을 계획, 분석 및 실행합니다. 자유로운 형식의 무한 시각적 캔버스를 만들어 생각을 구성하고, 솔루션을 브레인스토밍하고, 프로세스를 설계하고, 팀원과 실시간으로 협업할 수 있습니다. |
| 회사 본사 위치 | 오스트레일리아 |
| 앱 정보 페이지 | |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 Creately에서 제공했습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 사용자 전자 메일, 사용자 전체 이름 |
...
| 개인 정보 취급 방침 URL | https://creately.com/privacy/ |
