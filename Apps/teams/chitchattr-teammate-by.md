...
>|:----------------|:------------------------------------------------|:--------------------------------------------------------|:--------------------------------------------------|:--------------------|
>| People.Read | 위임 | 관리자는 이 앱을 통해 특정 환경을 대상으로 할 사용자를 선택할 수 있으므로 사용자의 이름, 전자 메일 및 Azure AD 개체 ID를 저장해야 합니다. | 관리자는 이 앱을 통해 특정 환경을 대상으로 할 사용자를 선택할 수 있으므로 사용자의 이름, 전자 메일 및 Azure AD 개체 ID를 저장해야 합니다. | [a8e903c7-3b7f-4ec5-a474-b5d32e595f50](https://docs.microsoft.com/microsoft-365-app-certification/azure/a8e903c7-3b7f-4ec5-a474-b5d32e595f50) |
