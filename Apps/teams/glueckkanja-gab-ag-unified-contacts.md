---
title: glueckkanja-gab AG로 통합 연락처에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: CSA STAR 레지스트리의 통합 연락처, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용 가능한 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/085251c0-aef3-11ea-bccf-6fc12269b243" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003877" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

glueckkanja-gab AG에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | glueckkanja-gab AG |
| 회사의 웹 사이트 | [https://www.glueckkanja-gab.com/en](https://www.glueckkanja-gab.com/en) |
| 앱 사용 약관 | [https://www.glueckkanja-gab.com/en/products/unified-contact...](https://www.glueckkanja-gab.com/en/products/unified-contacts/terms-and-conditions) |
| 앱의 핵심 기능 | Azure AD, 회사 연락처, Exchange Online 개인 연락처에 대한 통합 검색. |
| 회사 본사 위치 | 독일 |
| 앱 정보 페이지 | [https://www.glueckkanja-gab.com/en/products/unified-contacts](https://www.glueckkanja-gab.com/en/products/unified-contacts) |
...
이 정보는 glueckkanja-gab AG에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직에서 제공하는 컨트롤에 대해 제공됩니다.
...
| 개인 정보 취급 방침 URL | https://www.glueckkanja-gab.com/en/products/unified-contacts/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Contacts.Read.Shared | 위임 | 통합 연락처는 기본 기능을 제공하려면 고객 테넌트의 연락처 데이터에 액세스해야 합니다. | [83ff0fe1-a544-4390-bd72-3aaaa040db7e](../azure/83ff0fe1-a544-4390-bd72-3aaaa040db7e.md) |
>| Directory.Read.All | 위임 | 통합 연락처는 기본 기능을 제공하려면 고객 테넌트의 연락처 데이터에 액세스해야 합니다. | [83ff0fe1-a544-4390-bd72-3aaaa040db7e](../azure/83ff0fe1-a544-4390-bd72-3aaaa040db7e.md) |
>| User.Read | 위임 | 통합 연락처는 기본 기능을 제공하려면 고객 테넌트의 연락처 데이터에 액세스해야 합니다. | [83ff0fe1-a544-4390-bd72-3aaaa040db7e](../azure/83ff0fe1-a544-4390-bd72-3aaaa040db7e.md) |
