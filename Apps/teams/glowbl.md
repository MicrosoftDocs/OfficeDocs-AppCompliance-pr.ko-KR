---
title: Glowbl by Glowbl에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/19/2022
...
description: Glowbl에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
ms.locfileid: "66892074"
---
# <a name="glowbl"></a>네온블 (색)

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2021년 12월 20일</p>

* <a href="https://teams.microsoft.com/l/app/4a32acb6-9163-4dfe-9427-d51a3f53ef42" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004368" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Glowbl에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | 네온블 (색) |
| 회사 웹 사이트 | [https://www.glowbl.com](https://www.glowbl.com) |
| 앱의 사용 약관 | [https://www.glowbl.com/en/terms-of-use/](https://www.glowbl.com/en/terms-of-use/) |
| 앱의 핵심 기능 | Microsoft Teams 인증을 사용하여 글로우블에 원활하게 들어가세요. - 각 학습 세션에 대해 만든 팀 탭에 글로우블 공간 추가- 네온블 가상 공간에서 직접 Outlook 일정에 이벤트 만들기, 공유 및 프로젝트 SharePoint 또는 One 드라이브 파일(Microsoft Word, Microsoft Excel 및 Microsoft Powerpoint)을 네온블 스마트 테이블에서 새 브라우저 창을 열거나 화면을 공유하지 않고도 |
| 회사 본사 위치 | 프랑스 |
| 앱 정보 페이지 | |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 Glowbl에서 제공했습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 사용자 메일, 이름, 성 |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 사용자 메일, 이름, 성 |
| 기본 침입이 Microsoft 고객 데이터를 처리하거나 저장하는 경우 이 데이터는 지리적으로 저장되는 위치는 어디인가요? | 프랑스 |
...
| 개인 정보 취급 방침 URL | https://www.glowbl.com/en/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.Read | 위임 | 사용자가 Glowbl 세션에서 문서를 표시해야 하는 경우에만(Sharepoint 선택기) | [12d736b4-dd63-4d2a-a527-e4ab0edb08e9](../azure/12d736b4-dd63-4d2a-a527-e4ab0edb08e9.md) |
>| Files.Read.All | 위임 | 사용자가 Glowbl 세션에서 문서를 표시해야 하는 경우에만(Sharepoint 선택기) | [12d736b4-dd63-4d2a-a527-e4ab0edb08e9](../azure/12d736b4-dd63-4d2a-a527-e4ab0edb08e9.md) |
>| User.Read | 위임 | 사용자 로그인 및 사용자 프로필 읽기 | [12d736b4-dd63-4d2a-a527-e4ab0edb08e9](../azure/12d736b4-dd63-4d2a-a527-e4ab0edb08e9.md) |
>| 전자 메일 | 위임 | 전자 메일에 따라 Glowbl 공간 액세스 규칙에 대한 사용자 전자 메일 가져오기 | [12d736b4-dd63-4d2a-a527-e4ab0edb08e9](../azure/12d736b4-dd63-4d2a-a527-e4ab0edb08e9.md) |
>| openid | 위임 | 사용자 로그인 | [12d736b4-dd63-4d2a-a527-e4ab0edb08e9](../azure/12d736b4-dd63-4d2a-a527-e4ab0edb08e9.md) |
>| 프로필 | 위임 | Glowbl 세션에서 참가자를 나열하는 사용자 기본 프로필 보기 | [12d736b4-dd63-4d2a-a527-e4ab0edb08e9](../azure/12d736b4-dd63-4d2a-a527-e4ab0edb08e9.md) |
