---
title: DewMaker Design, Inc.의 방화벽 도우미에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
ms.date: 02/08/2022
ms.topic: article
...
description: 방화벽 도우미, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보
...
ms.locfileid: "62477532"
---
# <a name="firewall-assistant"></a>방화벽 도우미

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 2월 7일</p>

* <a href="https://teams.microsoft.com/l/app/40b745ad-16a8-4eda-bf1c-5b48b0dc947d" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003363" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

DewMaker Design, Inc.에서 Microsoft에 제공하는 정보:
...
| 회사의 웹 사이트 | [https://dewmaker.com](https://dewmaker.com) |
| 앱 사용 약관 | [https://teamwell.services/terms.html](https://teamwell.services/terms.html) |
| 앱의 핵심 기능 | Azure 응용 SQL Server 방화벽 규칙의 셀프 서비스 관리는 Microsoft Teams. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
...
이 정보는 DewMaker Design, Inc.에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터에 대해 조직에서 사용할 컨트롤에 대해 제공됩니다.
...
| 데이터베이스에 저장되는 데이터는 무엇입니까? | 전자 메일 주소(MS 로그인용) 및 Azure 구독 끝점 데이터 |
