---
title: Adobe의 Adobe Creative Cloud Express에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/07/2022
...
description: Adobe Creative Cloud Express, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/85d6a7d0-94aa-11ea-a1d7-2f19374441f9" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003946" target="_blank">AppSource에서 보기</a>
...
| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | Adobe Creative Cloud Express |
| ID | WA200003946 |
| 지원되는 Office 365 클라이언트 | Microsoft Teams |
| 파트너 회사 이름 | Adobe |
| 회사 웹 사이트 | [https://www.adobe.com/express/](https://www.adobe.com/express/) |
| 앱의 사용 약관 | [https://www.adobe.com/legal/terms.html](https://www.adobe.com/legal/terms.html) |
| 앱의 핵심 기능 | Adobe Spark를 사용하면 멋진 시각적 스토리, 영향력 있는 소셜 그래픽, 웹 페이지 및 짧은 비디오를 몇 분 안에 만들 수 있습니다. 이제 Microsoft Teams 쉽게 공유 |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://www.adobe.com/express](https://www.adobe.com/express) |
...
| 개인 정보 취급 방침 URL | https://www.adobe.com/privacy/policy.html |
