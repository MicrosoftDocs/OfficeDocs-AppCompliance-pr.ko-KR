---
title: 구데라에 의해 구데라에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
ms.date: 02/09/2021
ms.topic: article
...
description: Goodera에 대한 사용 가능한 모든 보안 및 규정 준수 정보 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보.
...
<p>최종 업데이트: 2021년 2월 9일</p>

* <a href="https://teams.microsoft.com/l/app/bc78ef2f-db9c-4bac-83de-1571f9dedf2d" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002136" target="_blank">앱소스에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

구데라가 마이크로소프트에 제공한 정보:
...
| 파트너 회사 이름 | Goodera |
| 파트너 웹사이트의 URL | [https://about.goodera.com](https://about.goodera.com) |
| Teams 응용 프로그램 정보 페이지의 URL | [해당 없음](N/A) |
| 개인정보 처리방침의 URL | [https://about.goodera.com/privacy](https://about.goodera.com/privacy) |
| 이용 약관의 URL | [https://about.goodera.com/terms](https://about.goodera.com/terms) |
...
이 정보는 구데라가 이 앱이 조직 데이터를 수집하고 저장하는 방법과 조직에서 앱이 수집하는 데이터에 대한 제어에 대해 제공했습니다.
...
>|:--------------------------------|:---------------------|:--------------------------|
>| 사용자를 식별하고 자원 봉사 기회에 등록할 수 있도록 사용자의 이메일 ID에 액세스합니다. | 이메일 ID | 이 PII는 사용자가 등록한 자원 봉사 기회를 알 수 있도록 만 저장됩니다. |
...
<iframe height='1020' title='Microsoft Cloud App Security 정보' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/36432' frameborder='no' style='width: 100%;'></iframe>

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/36432" target="_blank">새 탭에서 보기</a>
...
이 정보는 이 앱이 인증, 권한 부여, 응용 프로그램 등록 모범 사례 및 기타 ID 기준을 처리하는 방법에 대해 Goodera에서 제공되었습니다.
