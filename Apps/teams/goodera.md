---
title: Goodera by Goodera에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/17/2021
...
description: Goodera에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 Goodera에서 제공했습니다.
...
>|:---------------------------------------|:-----------------------------------|:------------------------------------|
>| Microsoft는 사용자를 식별하고 자원 봉사 기회에 등록하는 데 도움을 줄 수 있도록 사용자의 이메일 ID에 액세스합니다. | 전자 메일 ID | 이 PII는 사용자가 등록한 자원 봉사 기회를 알 수 있도록 저장됩니다. |
...
<iframe height='1020' title='Microsoft Cloud App Security 정보' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/36432' frameborder='no'></iframe>
...
이 정보는 이 앱이 인증, 권한 부여, 애플리케이션 등록 모범 사례 및 기타 ID 기준을 처리하는 방법에 대한 Goodera에서 제공되었습니다.
