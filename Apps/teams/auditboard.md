---
title: AuditBoard의 AuditBoard에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/10/2022
...
description: AuditBoard, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보
...
* <a href="https://teams.microsoft.com/l/app/c37d6bf9-d665-4119-b4e4-c641ee74fe09" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003600" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

AuditBoard에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | AuditBoard |
| 회사의 웹 사이트 | [https://www.auditboard.com](https://www.auditboard.com) |
| 앱 사용 약관 | [https://www.auditboard.com/terms-of-use/](https://www.auditboard.com/terms-of-use/) |
| 앱의 핵심 기능 | AuditBoard 구독자가 감사판에서 알림을 받을 수 Microsoft Teams. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
...
이 정보는 AuditBoard에서 이 앱이 조직 데이터를 수집 및 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직이 하게 될 컨트롤에 대해 제공됩니다.
...
| 개인 정보 취급 방침 URL | https://www.auditboard.com/privacy-policy/ |
