---
title: Librestream의 Onsight 커넥트 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2021
...
description: Onsight 커넥트 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://appsource.microsoft.com/product/office/WA200002769" target="_blank">AppSource에서 보기</a>
...
| 회사 웹 사이트 | [https://librestream.com](https://librestream.com) |
| 앱의 사용 약관 | [https://librestream.com/support-archives/software-eula/](https://librestream.com/support-archives/software-eula/) |
| 앱의 핵심 기능 | 신속하게 문제를 검사하고 해결하는 데 필요한 콘텐츠, 사람, 스마트 데이터 및 지침에 즉시 액세스할 수 있도록 작업자와 고객에게 권한을 부여하도록 디지털 변환 전략을 개선합니다. 전 세계에 배포된 Onsight 증강 현실 플랫폼은 제조, 항공, 에너지, 중장비 및 현장 서비스 같은 산업에서 운영 효율성을 높입니다. |
| 회사 본사 위치 | 캐나다 |
| 앱 정보 페이지 | |
...
이 정보는 Librestream에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 제공되었습니다.
