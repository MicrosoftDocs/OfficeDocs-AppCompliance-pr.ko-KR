...
description: Onsight 커넥트, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용할 수 있는 모든 보안 및 규정 준수 정보
...
| 회사의 웹 사이트 | [https://librestream.com](https://librestream.com) |
| 앱 사용 약관 | [https://librestream.com/support-archives/software-eula/](https://librestream.com/support-archives/software-eula/) |
| 앱의 핵심 기능 | 디지털 변환 전략을 향상하여 문제를 신속하게 검사하고 해결하는 데 필요한 콘텐츠, 사용자, 스마트 데이터 및 지침에 즉시 액세스할 수 있도록 합니다. 전 세계에 배포된 Onsight Augmented Reality Platform은 제조, 항공, 에너지, 중장비 및 소프트웨어와 같은 산업에서 운영 효율성을 현장 서비스. |
| 회사 본사 위치 | 캐나다 |
| 앱 정보 페이지 | |
