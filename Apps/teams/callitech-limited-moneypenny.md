---
title: CALLITECH LIMITED의 Moneypenny에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
ms.date: 11/08/2021
ms.topic: article
...
description: Moneypenny, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보
...
* <a href="https://teams.microsoft.com/l/app/ff5b7b81-ef94-441d-bc7c-eb04e53a188f" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003396" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

CALLITECH LIMITED에서 Microsoft로 제공한 정보:
...
| 회사의 웹 사이트 | [https://www.moneypenny.com](https://www.moneypenny.com) |
| 앱 사용 약관 | [https://www.moneypenny.com/uk/microsoft-teams-terms-and-con...](https://www.moneypenny.com/uk/microsoft-teams-terms-and-conditions/) |
| 앱의 핵심 기능 | 앱의 핵심 기능은 사용자가 Teams 봇을 통해 Moneypenny에서 전화를 받기 위해 조직을 온보드하는 것입니다. |
...
이 정보는 CALLITECH LIMITED에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직에서 제공하는 컨트롤에 대해 제공됩니다.
...
| 데이터베이스에 저장되는 데이터는 무엇입니까? | Microsoft 테넌트 ID, Microsoft 개체 ID |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calls.AccessMedia.All | application | 봇에서 사용자로 미디어를 Teams | [8277a51c-3ad6-446c-9b7e-e3f6e27257c1](https://docs.microsoft.com/microsoft-365-app-certification/azure/8277a51c-3ad6-446c-9b7e-e3f6e27257c1) |
>| Calls.Initiate.All | application | 봇을 통해 Teams 사용자에게 전화를 걸기 위해 | [8277a51c-3ad6-446c-9b7e-e3f6e27257c1](https://docs.microsoft.com/microsoft-365-app-certification/azure/8277a51c-3ad6-446c-9b7e-e3f6e27257c1) |
