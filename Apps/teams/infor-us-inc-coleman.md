---
title: INFOR(미국), INC.의 Infor Coleman에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/06/2021
...
description: Infor Coleman에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보.
...
* <a href="https://teams.microsoft.com/l/app/b9a120c7-9103-4e04-90b8-91c9db422a6e" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003314" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

INFOR(미국), INC에서 제공하는 정보 Microsoft에 다음을 수행합니다.
...
| 파트너 회사 이름 | INFOR (US), INC. |
| 회사 웹 사이트 | [https://www.infor.com](https://www.infor.com) |
| 앱의 사용 약관 | [https://www.infor.com/about/legal](https://www.infor.com/about/legal) |
| 앱의 핵심 기능 | Infor Coleman Digital Assistant는 Infor Cloudsuites에 자연어 확장성 및 접근성을 사용하도록 설정하여 인간의 작업 잠재력을 최대화하는 대화형 인터페이스를 제공합니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
...
이 정보는 INFOR(미국), INC.에서 제공되었습니다. 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 설명합니다.
