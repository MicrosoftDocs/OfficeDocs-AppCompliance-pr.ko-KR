...
<span data-ttu-id="f7f4e-108">벽화에서 마이크로소프트에 제공 하는 정보:</span><span class="sxs-lookup"><span data-stu-id="f7f4e-108">Information provided by MURAL to Microsoft:</span></span>
