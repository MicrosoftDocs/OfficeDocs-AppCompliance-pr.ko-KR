---
title: Adobe Express의 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/07/2022
...
description: Adobe Express에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
| 앱의 핵심 기능 | Adobe Spark를 사용하면 멋진 시각적 스토리, 영향력 있는 소셜 그래픽, 웹 페이지 및 짧은 비디오를 몇 분 안에 만들 수 있습니다. 이제 Microsoft Teams에서 쉽게 공유 |
| 회사 본사 위치 | 미국 |
