...
<p>최종 업데이트: 2020년 10월 15일</p>

* <a href="https://teams.microsoft.com/l/app/6adc8d55-eb37-4537-a66d-743b3cd4511b" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA104382058" target="_blank">앱소스에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

클락소온에서 마이크로소프트에 제공한 정보:
...
| 파트너 회사 이름 | Klaxoon |
| 파트너 웹사이트의 URL | [https://klaxoon.com](https://klaxoon.com) |
| 개인정보 처리방침의 URL | [https://klaxoon.com/privacy](https://klaxoon.com/privacy) |
| 이용 약관의 URL | [https://klaxoon.com/static/terms.pdf](https://klaxoon.com/static/terms.pdf) |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직이 가질 수 있는 제어에 대해 Klaxoon에서 제공했습니다.
...
>|:--------------------------------|:---------------------|:--------------------------|
>| 우리는 사용자 응답을 개인화하기 위해 명단을 사용합니다. 예를 들어: 안녕하세요 {{주어진이름}}, 당신의 질문에 감사드립니다! | 아니요 |  |
...
>클락시온 클라우드 시스템에 저장됩니다. 암호화를 미사용으로 설정합니다. Klaxoon 서버에 대한 액세스는 HTTPS / SSH 모드 (SSH 키 + 암호)의 특정 IP 주소 범위로 제한됩니다. 이 액세스는 독특한 요새를 통해서만 가능합니다.
