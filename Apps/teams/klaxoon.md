---
title: Klaxoon의 Klaxoon에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/21/2022
...
description: Klaxoon에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
ms.locfileid: "66548107"
---
# <a name="klaxoon"></a>Klaxoon

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 6월 21일</p>

* <a href="https://teams.microsoft.com/l/app/6adc8d55-eb37-4537-a66d-743b3cd4511b" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA104382058" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Klaxoon에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | Klaxoon |
| 회사 웹 사이트 | [https://klaxoon.com](https://klaxoon.com) |
| 앱의 사용 약관 | [https://static.klaxoon.com/website/pdf/eula.pdf](https://static.klaxoon.com/website/pdf/eula.pdf) |
| 앱의 핵심 기능 | Klaxoon은 팀워크 효율성을 높이기 위해 설계된 전체 공동 작업 도구 모음(화이트보드, 설문 조사, 퀴즈, 라이브 폴링 등)에 액세스할 수 있습니다. Klaxoon 제품군은 웹앱, 모바일 앱(Apple/Android) 또는 Microsoft Teams에서 직접 액세스할 수 있습니다(Tab 통합을 통해). |
| 회사 본사 위치 | 프랑스 |
| 앱 정보 페이지 | [https://klaxoon.com](https://klaxoon.com) |
| 앱을 실행하는 데 사용되는 호스팅 환경 또는 서비스 모델은 무엇인가요? | 하이브리드 |
| 앱에서 사용하는 호스팅 클라우드 공급자는 무엇인가요? | Azure, Aws, 기타 |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 Klaxoon에서 제공했습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | email, firstname, lastname, avatar |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | email, firstname, lastname, avatar |
| 기본 침입이 Microsoft 고객 데이터를 처리하거나 저장하는 경우 이 데이터는 지리적으로 저장되는 위치는 어디인가요? | 미국, 프랑스, 독일의 미국 |
...
| 개인 정보 취급 방침 URL | https://static.klaxoon.com/website/pdf/privacy-policy.pdf |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 위임 | 사용자 ID 및 계정 만들기 | [ef685106-cba6-4374-a250-a89d51df6e34](../azure/ef685106-cba6-4374-a250-a89d51df6e34.md) |
>| 전자 메일 | 위임 | 사용자 ID 및 계정 만들기 | [ef685106-cba6-4374-a250-a89d51df6e34](../azure/ef685106-cba6-4374-a250-a89d51df6e34.md) |
>| offline_access | 위임 | 사용자 ID 및 계정 만들기 | [ef685106-cba6-4374-a250-a89d51df6e34](../azure/ef685106-cba6-4374-a250-a89d51df6e34.md) |
>| openid | 위임 | 사용자 ID 및 계정 만들기 | [ef685106-cba6-4374-a250-a89d51df6e34](../azure/ef685106-cba6-4374-a250-a89d51df6e34.md) |
>| 프로필 | 위임 | 사용자 ID 및 계정 만들기 | [ef685106-cba6-4374-a250-a89d51df6e34](../azure/ef685106-cba6-4374-a250-a89d51df6e34.md) |
