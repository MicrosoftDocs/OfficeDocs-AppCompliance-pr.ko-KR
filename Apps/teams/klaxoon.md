...
| 파트너 회사 이름 | Klaxoon |
| 회사의 웹 사이트 | [https://klaxoon.com](https://klaxoon.com) |
| 앱 사용 약관 | [https://static.klaxoon.com/website/pdf/eula.pdf](https://static.klaxoon.com/website/pdf/eula.pdf) |
| 앱의 핵심 기능 | Klaxoon은 팀워크 효율성을 높이기 위해 설계된 전체 공동 작업 도구 모음(화이트보드, 설문 조사, 퀴즈, 라이브 폴링 등)에 액세스할 수 있습니다. Klaxoon 제품군은 웹앱, 모바일 앱(Apple/Android) 또는 탭 통합을 통해 Microsoft Teams 직접 액세스할 수 있습니다. |
| 회사 본사 위치 | 프랑스 |
| 앱 정보 페이지 | [https://klaxoon.com](https://klaxoon.com) |
| 앱을 실행하기 위해 사용되는 호스팅 환경 또는 서비스 모델은 무엇입니까? |  |
| 앱에서 어떤 호스팅 클라우드 공급자를 사용하나요? | AWS, Azure, 클라래et |
