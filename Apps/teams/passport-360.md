---
title: Passport 360 by Passport 360의 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/29/2022
...
description: Passport 360에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/585570bb-e996-4b0b-89cf-0b5d610ecb65" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004322" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Passport 360에서 Microsoft로 제공하는 정보:
...
| 파트너 회사 이름 | Passport 360 |
| 회사 웹 사이트 | [https://www.passport360.com](https://www.passport360.com) |
| 앱의 사용 약관 | [https://www.passport360.com/privacy-policy/](https://www.passport360.com/privacy-policy/) |
| 앱의 핵심 기능 | 공급업체 전체에서 건강 및 안전 프로세스를 디지털화하는 SaaS 솔루션 |
| 회사 본사 위치 | 오스트레일리아 |
| 앱 정보 페이지 | |
...
이 정보는 Passport 360에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 아니요 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 테넌트 ID; 사용자 원칙 이름 |
| 기본 침입이 Microsoft 고객 데이터를 처리하거나 저장하는 경우 이 데이터는 지리적으로 저장되는 위치는 어디인가요? | 오스트레일리아, 남아프리카 공화국, 캐나다 |
...
| 개인 정보 취급 방침 URL | https://www.passport360.com/privacy-policy-2/ |
