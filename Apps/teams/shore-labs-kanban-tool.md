---
title: Kanban Tool by Shore Labs에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Kanban Tool, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/b3c15d4f-1972-4836-a1eb-7575dd56a17e" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002121" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Shore Labs에서 Microsoft에 제공한 정보:
...
| 회사 웹 사이트 | [https://www.shorelabs.com](https://www.shorelabs.com) |
| 앱의 사용 약관 | [https://kanbantool.com/policy/terms-of-service](https://kanbantool.com/policy/terms-of-service) |
| 앱의 핵심 기능 | kanban 보드에서 작업 및 추적 시간을 시각화합니다. |
| 회사 본사 위치 | 폴란드 |
| 앱 정보 페이지 | [https://kanbantool.com](https://kanbantool.com) |
| 앱을 실행하는 데 사용되는 호스팅 환경 또는 서비스 모델은 무엇인가요? |  |
| 앱에서 사용하는 호스팅 클라우드 공급자는 무엇인가요? | AWS, SelfHosted, GCP |
...
이 정보는 Shore Labs에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 제공되었습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| 전자 메일 | 위임 | 통신, ID 일치 및 알림 배달을 위한 사용자의 이메일 주소입니다. | [4e820d60-9e62-403c-accd-857b987cc13c](../azure/4e820d60-9e62-403c-accd-857b987cc13c.md) |
>| Team.ReadBasic.All | 위임 | 사용자가 직접 구성원인 팀의 식별자 및 이름입니다. Kanban 도구에서 사용자를 올바른 그룹에 자동으로 할당하는 데 사용됩니다. | [a8ead1a3-85e1-42a3-9ed0-9afb97482b31](../azure/a8ead1a3-85e1-42a3-9ed0-9afb97482b31.md) |
>| User.Read | 위임 | 로그인한 사용자의 기본 회사 정보입니다. 새 계정에 대한 계정 세부 정보를 채우고 단일 Sign-On 기능을 제공하기 위해 조직에 속한 사용자를 인식하는 데 사용됩니다. | [a8ead1a3-85e1-42a3-9ed0-9afb97482b31](../azure/a8ead1a3-85e1-42a3-9ed0-9afb97482b31.md) |
>| offline_access | 위임 | 사용자의 로그인 시 앱 액세스 권한을 부여한 데이터의 'Microsoft로 로그인' 기능 및 동기화를 허용합니다. | [a8ead1a3-85e1-42a3-9ed0-9afb97482b31](../azure/a8ead1a3-85e1-42a3-9ed0-9afb97482b31.md) |
>| openid | 위임 | 사용자가 'Microsoft로 로그인' 단추를 통해 회사 또는 학교 계정으로 앱에 로그인할 수 있는 ID 토큰을 엽니다. | [a8ead1a3-85e1-42a3-9ed0-9afb97482b31](../azure/a8ead1a3-85e1-42a3-9ed0-9afb97482b31.md) |
>| 프로필 | 위임 | Kanban 도구에서 자동 채워지고 Microsoft Teams 변경 내용과 동기화할 사용자 이름입니다. | [a8ead1a3-85e1-42a3-9ed0-9afb97482b31](../azure/a8ead1a3-85e1-42a3-9ed0-9afb97482b31.md) |
