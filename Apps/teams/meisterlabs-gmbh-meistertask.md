---
title: 마이스터랩스 GmbH의 마이스터태스크 신청 정보
ms.author: elmalova
author: elenamalova
ms.date: 12/16/2019
ms.topic: article
...
description: 마이스터태스크(MeisterTask)의 사용 가능한 모든 보안 및 규정 준수 정보 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보, CSA STAR 레지스트리의 보안/규정 준수 정보.
...
* <a href="https://teams.microsoft.com/l/app/4d0f0848-3fdd-4046-9976-d5568c8b71f4" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA104381349" target="_blank">앱소스에서 보기</a>
...
| 파트너 웹사이트의 URL | [https://www.meistertask.com](https://www.meistertask.com) |
| Teams 응용 프로그램 정보 페이지의 URL | [https://support.meistertask.com/](https://support.meistertask.com/) |
| 개인정보 처리방침의 URL | [https://www.meistertask.com/privacy](https://www.meistertask.com/privacy) |
| 이용 약관의 URL | [https://www.meistertask.com/legal](https://www.meistertask.com/legal) |
...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| User.Read | 위임 | ID, 디스플레이 이름, 전자 메일 주소. | 인증 및 가입을 위해. |  |
...
>위에서 언급한 모든 EUII 및 OII는 디버깅 목적으로 사용되는 로그 파일에 사용될 수 있습니다. 모든 로그 데이터는 늦어도 6개월 후에 자동으로 삭제됩니다.

#### <a name="organizational-controls-for-data-stored-by-partner"></a>파트너가 저장한 데이터에 대한 조직 제어

조직의 관리자가 파트너 시스템에서 자신의 정보를 제어하는 방법을 설명해 보세요. 예를 들어 삭제, 보존, 감사, 보관, 최종 사용자 정책 등

>고객 관리자는 데이터를 삭제하고 계정을 닫을 수 있습니다. 보존 기간을 사용자 지정할 수 없습니다. 현재 감사를 사용할 수 없습니다. 사용자 생성 데이터는 수동으로 보관하거나 공용 API를 통해 액세스할 수 https://developers.meistertask.com/) 있습니다(. 최종 사용자 정책은 에서 사용할 수 https://www.meistertask.com/privacy https://www.meistertask.com/terms 있습니다.
