...
description: Micromate, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
| 회사의 웹 사이트 | [https://paixon.ch](https://paixon.ch) |
| 앱 사용 약관 | [https://micromate.ai/de/nutzungsbedingungen/](https://micromate.ai/de/nutzungsbedingungen/) |
...
| 앱에서 어떤 호스팅 클라우드 공급자를 사용하나요? | Cloudscale |
