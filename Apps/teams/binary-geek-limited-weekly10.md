---
title: 이진 괴짜 제한에 의한 Weekly10에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/26/2021
...
description: Weekly10에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/c80cee99-d17f-4b2d-a2a4-57652ffd2a4b" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001441" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

이진 괴짜가 Microsoft로 제한하여 제공한 정보:
...
| 회사 웹 사이트 | [https://www.weekly10.com](https://www.weekly10.com) |
| 앱의 사용 약관 | [https://www.weekly10.com/terms/customer](https://www.weekly10.com/terms/customer) |
| 앱의 핵심 기능 | 주간 체크 인을 통해 피드백을 늘리고, 성과를 관리하고, 직원 참여를 측정합니다. |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직의 제어에 대한 Binary Geek Limited에서 제공되었습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 응용 프로그램 | Azure AD에서 Weekly10으로 사용자 동기화(선택 사항) | [2cc7f3cd-05e3-4ebb-b9f9-d92f1bcda7fb](../azure/2cc7f3cd-05e3-4ebb-b9f9-d92f1bcda7fb.md) |
>| Calendars.ReadWrite | 응용 프로그램 | 직원 가용성 및 자동 모임 예약 확인(선택 사항) | [494610b2-b490-4f54-8384-312d6f9b4869](../azure/494610b2-b490-4f54-8384-312d6f9b4869.md) |
>| User.Read | 위임 | Azure AD에서 SSO 용도로 사용자 확인 | [6fd1421e-89e8-4a8b-bd01-9397656a50d5](../azure/6fd1421e-89e8-4a8b-bd01-9397656a50d5.md) |
