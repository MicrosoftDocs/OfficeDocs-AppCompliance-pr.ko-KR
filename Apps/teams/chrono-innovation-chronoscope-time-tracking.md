---
title: Chrono Innovation의 Chronoscope 시간 추적을 위한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Chronoscope 시간 추적, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용 가능한 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/5b3ded07-fa1a-4fd8-a323-e5fe3f8cf740" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003095" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Chrono Innovation에서 Microsoft에 제공한 정보:
...
| 회사 웹 사이트 | [https://www.chronoinnovation.com](https://www.chronoinnovation.com) |
| 앱의 사용 약관 | [https://www.chronoscope.app/terms-of-service](https://www.chronoscope.app/terms-of-service) |
| 앱의 핵심 기능 | Chronoscope는 데이터 정확도를 높이고 시간 입력 오류를 줄이는 지능형 시간 관리 플랫폼입니다. Chronoscope는 기존 에코시스템과 통합되는 지능형 도우미를 통해 시간 입력을 용이하게 하고 더 나은 비즈니스 의사 결정을 내리기 위해 데이터에 대한 가시성을 제공합니다. |
| 회사 본사 위치 | 캐나다 |
| 앱 정보 페이지 | [https://www.chronoscope.app](https://www.chronoscope.app) |
...
이 정보는 Chrono Innovation에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 제공되었습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AccessReview.Read.All | 응용 프로그램 | teams tenantId, teams addObjectId 및 teams 사용자 계정 정보입니다. Chronoscope 사용자를 연결할 때 사용자의 수동 단계 없이 계정을 연결할 수 있도록 전자 메일이 Teams 계정과 일치하는지 확인합니다. | [9bc8244d-a186-4b12-809e-c47b3eee73c6](../azure/9bc8244d-a186-4b12-809e-c47b3eee73c6.md) |
