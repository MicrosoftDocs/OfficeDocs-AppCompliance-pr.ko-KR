...
description: Chronoscope 시간 추적, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
| 회사의 웹 사이트 | [https://www.chronoinnovation.com](https://www.chronoinnovation.com) |
| 앱 사용 약관 | [https://www.chronoscope.app/terms-of-service](https://www.chronoscope.app/terms-of-service) |
| 앱의 핵심 기능 | Chronoscope는 데이터 정확도를 높이고 시간 입력 오류를 줄이는 지능형 시간 관리 플랫폼입니다. Chronoscope는 기존 에코시스템과 통합되는 지능형 도우미를 통해 시간 입력을 용이하게 하여 더 나은 비즈니스 의사 결정을 내릴 수 있도록 데이터에 대한 가시성을 제공합니다. |
| 회사 본사 위치 | 캐나다 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AccessReview.Read.All | application | teams tenantId , teams는ObjectId 및 팀 사용자 계정 정보를 추가합니다. Chronoscope 사용자를 연결하는 경우 사용자의 수동 단계 없이 계정을 연결하기 위해 전자 메일이 Teams 계정과 일치하는지 확인 중입니다. | [9bc8244d-a186-4b12-809e-c47b3eee73c6](../azure/9bc8244d-a186-4b12-809e-c47b3eee73c6.md) |
