...
| 회사의 웹 사이트 | [https://qchange.com](https://qchange.com) |
| 앱 사용 약관 | [https://www.qchange.com/terms-of-service](https://www.qchange.com/terms-of-service) |
| 앱의 핵심 기능 | LX는 모든 사람이 리더십을 주도하고 성장할 수 있는 가장 빠른 방법인 것이기 때문에 모임과 문화가 더 좋습니다. |
| 회사 본사 위치 | 미국 |
...
| 앱에서 어떤 호스팅 클라우드 공급자를 사용하나요? | AWS, Mongodb, Azure |
