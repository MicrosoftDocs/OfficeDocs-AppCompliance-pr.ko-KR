---
title: qChange Software Solution, Inc.의 qChange 리더 환경에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/12/2021
...
description: qChange 리더 환경, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/32dbfdc9-7832-4969-ad02-77a4902fae35" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001639" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

qChange Software Solution, Inc.에서 Microsoft에 제공한 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | qChange Leader 환경 |
| ID | WA200001639 |
| 지원되는 Office 365 클라이언트 | Microsoft Teams |
| 파트너 회사 이름 | qChange Software Solution, Inc. |
| 회사 웹 사이트 | [https://qchange.com](https://qchange.com) |
| 앱의 사용 약관 | [https://www.qchange.com/terms-of-service](https://www.qchange.com/terms-of-service) |
| 앱의 핵심 기능 | LX는 모든 사람의 리더십을 안내하고 성장시키는 가장 빠른 방법이므로 회의와 문화가 더 좋습니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://www.qchange.com/leader-experience](https://www.qchange.com/leader-experience) |
| 앱을 실행하는 데 사용되는 호스팅 환경 또는 서비스 모델은 무엇인가요? |  |
| 앱에서 사용하는 호스팅 클라우드 공급자는 무엇인가요? | AWS, Mongodb, Azure |
...
이 정보는 qChange Software Solution, Inc.에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 위임 | 사용자 일정 정보 및 아바타 | [c35f7dcf-1079-4510-a6ec-1f69659c98c1 32dbfdc9-7832-4969-ad02-77a4902fae35](../azure/c35f7dcf-1079-4510-a6ec-1f69659c98c1 32dbfdc9-7832-4969-ad02-77a4902fae35.md) |
