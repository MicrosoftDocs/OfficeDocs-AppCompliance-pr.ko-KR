---
title: FactSet Research Systems Inc.의 FactSet에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/24/2021
...
description: FactSet에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/95fb5da0-6ced-4247-9d62-294f8fcb75df" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002146" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

FactSet Research Systems Inc.에서 Microsoft에 제공한 정보:
...
| 회사 웹 사이트 | [https://www.factset.com](https://www.factset.com) |
| 앱의 사용 약관 | [https://www.factset.com/hubfs/Misc/FactSet%20Teams%20Terms%...](https://www.factset.com/hubfs/Misc/FactSet%20Teams%20Terms%20of%20Use.pdf) |
| 앱의 핵심 기능 | Microsoft Teams FactSet을 사용하면 StreetAccount에서 큐레이팅된 뉴스 요약을 받게 되므로 글로벌 시장에 영향을 주는 주요 스토리를 계속 확인할 수 있습니다. FactSet&#8217;업계 최고의 콘텐츠를 쿼리하여 자세한 회사 정보를 쿼리하고 동료 및 그룹과 공유할 수 있으므로 애플리케이션 간에 전환하지 않고도 손쉽게 협업할 수 있습니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
...
이 정보는 FactSet Research Systems Inc.에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 제공되었습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 응용 프로그램 | 확인 및 로깅의 이름 및 전자 메일, 자동 관리 메시지 전송을 위한 대화 ID | [95fb5da0-6ced-4247-9d62-294f8fcb75df](../azure/95fb5da0-6ced-4247-9d62-294f8fcb75df.md) |
