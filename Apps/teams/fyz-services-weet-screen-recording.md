...
description: Weet 화면 기록에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsAppInstallation.ReadWriteSelfForUser.All | 위임 | Weet 앱이 이미 설치되어 있는 경우 검색 허용 | [32eae2b8-2111-431f-9263-e8e1120d0a97](../azure/32eae2b8-2111-431f-9263-e8e1120d0a97.md) |
>| User.Read | 위임 | 어떤 데이터도 수집하지 않지만 사용자가 자동 등록 기능을 사용할 수 있도록 전자 메일만 사용 | [32eae2b8-2111-431f-9263-e8e1120d0a97](../azure/32eae2b8-2111-431f-9263-e8e1120d0a97.md) |
>| User.ReadBasic.All | 위임 | 어떤 데이터도 수집하지 않지만 사용자가 자동 등록 기능을 사용할 수 있도록 전자 메일만 사용 | [32eae2b8-2111-431f-9263-e8e1120d0a97](../azure/32eae2b8-2111-431f-9263-e8e1120d0a97.md) |
>| offline_access | 위임 | 어떤 데이터도 수집하지 않지만 사용자가 자동 등록 기능을 사용할 수 있도록 전자 메일만 사용 | [32eae2b8-2111-431f-9263-e8e1120d0a97](../azure/32eae2b8-2111-431f-9263-e8e1120d0a97.md) |
>| openid | 위임 | 어떤 데이터도 수집하지 않지만 사용자가 자동 등록 기능을 사용할 수 있도록 전자 메일만 사용 | [32eae2b8-2111-431f-9263-e8e1120d0a97](../azure/32eae2b8-2111-431f-9263-e8e1120d0a97.md) |
>| 프로필 | 위임 | 어떤 데이터도 수집하지 않지만 사용자가 자동 등록 기능을 사용할 수 있도록 전자 메일만 사용 | [32eae2b8-2111-431f-9263-e8e1120d0a97](../azure/32eae2b8-2111-431f-9263-e8e1120d0a97.md) |
