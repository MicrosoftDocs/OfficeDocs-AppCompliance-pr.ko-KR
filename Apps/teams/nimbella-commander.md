---
title: Nimbella의 사령관에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Commander에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/be4751a5-db56-4e45-bb27-397e0aa614b1" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002015" target="_blank">AppSource에서 보기</a>
...
| 파트너 회사 이름 | Nimbella |
| 회사 웹 사이트 | [https://www.nimbella.com](https://www.nimbella.com) |
| 앱의 사용 약관 | [https://nimbella.com/terms](https://nimbella.com/terms) |
...
| 앱에서 사용하는 호스팅 클라우드 공급자는 무엇인가요? | Azure, GCP, DigitalOcean |
...
이 정보는 Nimbella에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
