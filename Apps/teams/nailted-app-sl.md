---
title: Application Information for Nailted by NAILTED APP S.L.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/21/2021
...
description: Nailted에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/1a199d17-c299-4634-a124-075e0c119d71" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003375" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

NAILTED APP S.L에서 제공하는 정보 Microsoft에 다음을 수행합니다.
...
| 파트너 회사 이름 | NAILTED APP S.L. |
| 회사 웹 사이트 | [https://nailted.com](https://nailted.com) |
| 앱의 사용 약관 | [https://nailted.com/legal/terms](https://nailted.com/legal/terms) |
| 앱의 핵심 기능 | 최신 Hr &amp; 팀을 위한 직원 참여 플랫폼입니다. |
| 회사 본사 위치 | 스페인 |
| 앱 정보 페이지 | |
| 앱을 실행하는 데 사용되는 호스팅 환경 또는 서비스 모델은 무엇인가요? | Paas |
| 앱에서 사용하는 호스팅 클라우드 공급자는 무엇인가요? | Heroku |
...
이 정보는 NAILTED APP S.L에서 제공되었습니다. 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 설명합니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | tenantId 및 email |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | tenantId 및 email |
...
| 개인 정보 취급 방침 URL | https://nailted.com/legal/privacy |
...
| 앱에서 위의 라이브러리 중 하나를 사용하지 않는 경우 어떤 인증 라이브러리 또는 라이브러리를 사용하나요? | Microsoft 인증 라이브러리의 최신 버전을 사용합니다. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 응용 프로그램 | 그룹에 액세스하는 데 사용됩니다. | [52b2da9b-4cd6-4334-be22-4a3b1b99bac7](../azure/52b2da9b-4cd6-4334-be22-4a3b1b99bac7.md) |
>| TeamsAppInstallation.ReadWriteForUser | 응용 프로그램 | 사용자는 앱을 설치할 사용자를 선택할 수 있습니다. 따라서 이 권한을 사용하여 앱을 설치합니다. | [52b2da9b-4cd6-4334-be22-4a3b1b99bac7](../azure/52b2da9b-4cd6-4334-be22-4a3b1b99bac7.md) |
>| User.Read.All | 응용 프로그램 | 사용자 정보를 읽는 데 사용됨 | [52b2da9b-4cd6-4334-be22-4a3b1b99bac7](../azure/52b2da9b-4cd6-4334-be22-4a3b1b99bac7.md) |
>| 전자 메일 | 응용 프로그램 | 동기화하기 위해 직원의 전자 메일에 액세스 | [52b2da9b-4cd6-4334-be22-4a3b1b99bac7](../azure/52b2da9b-4cd6-4334-be22-4a3b1b99bac7.md) |
>| offline_access | 응용 프로그램 | 사용자가 직원을 동기화하고 애플리케이션을 설치할 수 있는 온라인 상태가 아닌 경우 이 권한을 사용하여 API에 액세스할 수 있습니다. | [52b2da9b-4cd6-4334-be22-4a3b1b99bac7](../azure/52b2da9b-4cd6-4334-be22-4a3b1b99bac7.md) |
