---
title: 정전된 APP S.L에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/21/2021
...
description: 나타남, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용 가능한 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/1a199d17-c299-4634-a124-075e0c119d71" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003375" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

정적 앱 S.L에서 제공하는 정보입니다. Microsoft에:
...
| 회사의 웹 사이트 | [https://nailted.com](https://nailted.com) |
| 앱 사용 약관 | [https://nailted.com/legal/terms](https://nailted.com/legal/terms) |
| 앱의 핵심 기능 | 최신 사용자 HR 팀을 위한 직원 &amp; 참여 플랫폼입니다. |
| 회사 본사 위치 | 스페인 |
| 앱 정보 페이지 | |
| 앱을 실행하기 위해 사용되는 호스팅 환경 또는 서비스 모델은 무엇입니까? | Paas |
| 앱에서 어떤 호스팅 클라우드 공급자를 사용하나요? | Heroku |
...
이 정보는 나만의 앱 S.L에서 제공됩니다. 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터를 통해 조직이 하게 될 컨트롤에 대한 정보를 제공합니다.
...
| 데이터베이스에 저장되는 데이터는 무엇입니까? | tenantId 및 email |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | application | 그룹에 액세스하는 데 사용됩니다. | [52b2da9b-4cd6-4334-be22-4a3b1b99bac7](../azure/52b2da9b-4cd6-4334-be22-4a3b1b99bac7.md) |
>| TeamsAppInstallation.ReadWriteForUser | application | 사용자는 앱을 설치할 사용자를 선택할 수 있습니다. 따라서 이 권한을 사용하여 앱을 설치합니다. | [52b2da9b-4cd6-4334-be22-4a3b1b99bac7](../azure/52b2da9b-4cd6-4334-be22-4a3b1b99bac7.md) |
>| User.Read.All | application | 사용자 정보를 읽는 데 사용됩니다. | [52b2da9b-4cd6-4334-be22-4a3b1b99bac7](../azure/52b2da9b-4cd6-4334-be22-4a3b1b99bac7.md) |
>| 전자 메일 | application | 직원의 전자 메일에 액세스하여 동기화 | [52b2da9b-4cd6-4334-be22-4a3b1b99bac7](../azure/52b2da9b-4cd6-4334-be22-4a3b1b99bac7.md) |
>| offline_access | application | 사용자가 온라인이 아닌 경우 직원을 동기화하고 응용 프로그램을 설치할 수 있도록 이 권한을 사용하여 api에 액세스할 수 있습니다. | [52b2da9b-4cd6-4334-be22-4a3b1b99bac7](../azure/52b2da9b-4cd6-4334-be22-4a3b1b99bac7.md) |
