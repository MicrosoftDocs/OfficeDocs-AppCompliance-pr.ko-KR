...
| 회사의 웹 사이트 | [https://guidespark.com](https://guidespark.com) |
| 앱 사용 약관 | [https://www.guidespark.com/terms/](https://www.guidespark.com/terms/) |
| 앱의 핵심 기능 | 대상을 대상으로 하여 조직 변경을 주도하고 GuideSpark 통신 클라우드를 통해 참여 데이터를 추적합니다. 배달 채널을 확장하고 효과적인 내부 통신을 촉진할 수 있는 사용자에 도달합니다. |
| 회사 본사 위치 | 미국 |
