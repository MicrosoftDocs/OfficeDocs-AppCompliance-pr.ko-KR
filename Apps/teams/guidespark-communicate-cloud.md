---
title: GuideSpark Communicate Cloud by GuideSpark에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/14/2021
...
description: GuideSpark Communicate Cloud에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/34b870ca-2417-4660-b835-ebb18ee7ccf9" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003348" target="_blank">AppSource에서 보기</a>
...
| 회사 웹 사이트 | [https://guidespark.com](https://guidespark.com) |
| 앱의 사용 약관 | [https://www.guidespark.com/terms/](https://www.guidespark.com/terms/) |
| 앱의 핵심 기능 | GuideSpark Communicate Cloud를 통해 대상 그룹을 대상으로 지정하고 참여 데이터를 추적하여 조직의 변화를 주도합니다. 배달 채널을 확장하고 효과적인 내부 통신을 용이하게 하기 위해 사람들이 있는 곳에 도달합니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://www.guidespark.com/change-communications-software/](https://www.guidespark.com/change-communications-software/) |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직의 제어에 대한 GuideSpark에서 제공되었습니다.
