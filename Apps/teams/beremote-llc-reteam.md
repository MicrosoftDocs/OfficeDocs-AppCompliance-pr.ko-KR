---
title: BeRemote LLC의 ReTeam에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/28/2021
...
description: ReTeam, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/92c90c0c-9a22-42ae-be52-c078eae02dea" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003293" target="_blank">AppSource에서 보기</a>
...
| 회사 웹 사이트 | [https://www.beremote.com](https://www.beremote.com) |
| 앱의 사용 약관 | [https://www.beremote.com/terms-of-use](https://www.beremote.com/terms-of-use) |
| 앱의 핵심 기능 | ReTeam은 전문 팀, 코치 및 멘토에게 참여와 사회적 응집력을 위한 도구를 제공합니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
...
이 정보는 BeRemote LLC에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
