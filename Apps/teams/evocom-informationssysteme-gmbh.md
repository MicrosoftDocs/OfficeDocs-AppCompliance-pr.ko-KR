...
* <a href="https://teams.microsoft.com/l/app/8681b4f9-a5cd-4dd7-9721-09f015dae618" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002050" target="_blank">앱소스에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

에보콤 정보 시스템 시스템 GmbH에서 마이크로소프트에 제공 하는 정보:
...
| 파트너 웹사이트의 URL | [https://www.evocom.de/](https://www.evocom.de/) |
| Teams 응용 프로그램 정보 페이지의 URL | [https://evocom.de/microsoft365](https://evocom.de/microsoft365) |
| 개인정보 처리방침의 URL | [https://www.evocom.de/privacy](https://www.evocom.de/privacy) |
| 이용 약관의 URL | [https://www.evocom.de/termsofuse](https://www.evocom.de/termsofuse) |
...
이 정보는 Evocom Informationssysteme GmbH에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직이 가질 수 있는 제어에 대해 제공했습니다.
...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| User.Read | 위임 | 이름, 전자 메일- Adress, 사진, ID. 성능 | 이름, 전자 메일- Adress, 사진, ID. 성능 | 3e745135-a761-48a7-ab54-5c0277b2e642 |
>| User.ReadBasic.All | 위임 | 이름, 전자 메일- Adress, 사진, ID. 성능 | 이름, 전자 메일- Adress, 사진, ID. 성능 | 3e745135-a761-48a7-ab54-5c0277b2e642 |
...
>|:--------------------------------|:---------------------|:--------------------------|
>| 개인화. 개인 알림, 전자 메일 메시지. | 이름, 전자 메일- Adress, 사진, ID | 성능. |
...
>MSAL을 사용하여 인증된 사용자 또는 등록된 Azure 앱에 의해.
...
<iframe height='1020' title='Microsoft Cloud App Security 정보' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/36416' frameborder='no' style='width: 100%;'></iframe>

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/36416" target="_blank">새 탭에서 보기</a>
...
이 정보는 이 앱이 인증, 권한 부여, 응용 프로그램 등록 모범 사례 및 기타 ID 기준을 처리하는 방법에 대해 Evocom Informationssysteme GmbH에서 제공했습니다.
