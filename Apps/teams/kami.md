---
title: Kami by Kami에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/31/2022
...
description: Kami에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/95b82c84-8994-45f6-946a-dda105f9d5df" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004148" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Kami에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | 카 |
| 회사 웹 사이트 | [https://kamiapp.com](https://kamiapp.com) |
| 앱의 사용 약관 | [https://kamiapp.com/terms-of-service/](https://kamiapp.com/terms-of-service/) |
| 앱의 핵심 기능 | 모든 사람들이 지금 Microsoft Teams 위해 카미 &#8211; 함께 배우는 것을 좋아하도록 힘을 실어줍니다. |
| 회사 본사 위치 | 뉴질랜드 |
| 앱 정보 페이지 | |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 Kami에서 제공했습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 사용자 프로필(이름, 전자 메일). 파일 및 메타데이터를 OneDrive. |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 사용자 프로필 데이터(이름, 전자 메일, ID). 파일 메타데이터(파일 이름, 항목 ID, 드라이브 ID)를 OneDrive. 문서 주석. |
...
| 잠재적인 보안 이벤트를 검색하기 위해 인간 또는 자동화된 도구에서 모든 로그를 정기적으로 검토합니까? | 아니오 |
...
| 개인 정보 취급 방침 URL | https://www.kamiapp.com/privacy-policy/ |
...
| Microsoft 365 앱 및 추가 기능은 Microsoft Graph 외부에서 추가 Microsoft API를 사용할 수 있습니다. 앱 또는 추가 기능에서 추가 Microsoft API를 사용하나요? | 아니오 |

#### <a name="data-access-using-microsoft-graph"></a>Microsoft Graph 사용하여 데이터 액세스

>|   **Graph 권한**  | **사용 권한 유형** |          **정당화**          | **앱 ID Azure AD** |
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite.All | 위임 | 사용자가 Kami에서 OneDrive 파일을 열고 업데이트하고 내보내고 SharePoint 수 있도록 합니다. | [5fb90a92-665c-4ec3-863e-e37572074eb2](../azure/5fb90a92-665c-4ec3-863e-e37572074eb2.md) |
>| User.Read | 위임 | Kami 프로필을 채우기 위한 사용자 프로필 데이터에 액세스하려면 전자 메일 및 이름 등을 입력합니다. | [5fb90a92-665c-4ec3-863e-e37572074eb2](../azure/5fb90a92-665c-4ec3-863e-e37572074eb2.md) |
