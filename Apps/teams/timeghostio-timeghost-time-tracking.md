---
title: timeghost에 대한 애플리케이션 정보 - timeghost.io 의한 시간 추적
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/23/2022
...
description: timeghost에 사용할 수 있는 모든 보안 및 규정 준수 정보 - 시간 추적, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
ms.locfileid: "66540827"
---
# <a name="timeghost---time-tracking"></a>timeghost - 시간 추적

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 6월 23일</p>

* <a href="https://teams.microsoft.com/l/app/e3956558-7399-4ec1-848a-c61a2aa95bc1" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001532" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

microsoft에 timeghost.io 제공하는 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | timeghost - 시간 추적 |
| ID | WA200001532 |
| 지원되는 Office 365 클라이언트 | Microsoft Teams |
| 파트너 회사 이름 | timeghost.io |
| 회사 웹 사이트 | [https://timeghost.io](https://timeghost.io) |
| 앱의 사용 약관 | [https://timeghost.io/terms-and-conditions/](https://timeghost.io/terms-and-conditions/) |
| 앱의 핵심 기능 | Timeghost는 Office 365 위해 특별히 설계된 시간 추적 도구입니다. |
| 회사 본사 위치 | 독일 |
| 앱 정보 페이지 | [https://timeghost.io](https://timeghost.io) |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직의 제어에 대한 timeghost.io 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 사용자 프로필 데이터, 사용자 메일 데이터, 사용자 일정 데이터 |
...
| 다음을 위해 MFA(다단계 인증)를 사용하도록 설정했습니다. | DNSManagement, CodeRepositories, Credential |
...
| 개인 정보 취급 방침 URL | https://timeghost.io/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | 위임 | Microsoft 365 앱을 timeghost에 통합하고 특정 Outlook 일정 이벤트를 timeghost Feed에 표시합니다. | [f6f894ce-5b44-4c9b-aff4-253d2fbe8a99](../azure/f6f894ce-5b44-4c9b-aff4-253d2fbe8a99.md) |
>| People.Read | 위임 | Microsoft 365 앱을 timeghost에 통합하고 표시하기 위해 예를 들어 Microsoft 365 프로필에 연결된 사용자 아바타를 표시합니다. | [f6f894ce-5b44-4c9b-aff4-253d2fbe8a99](../azure/f6f894ce-5b44-4c9b-aff4-253d2fbe8a99.md) |
>| User.Read | 위임 | Microsoft 365 앱을 timeghost에 통합하고 예를 들어 회사의 다른 사용자도 timeghost를 사용한다는 것을 사용자에게 표시합니다. | [f6f894ce-5b44-4c9b-aff4-253d2fbe8a99](../azure/f6f894ce-5b44-4c9b-aff4-253d2fbe8a99.md) |
>| User.ReadBasic.All | 위임 | Microsoft 365 앱을 timeghost에 통합하고 표시하기 위해 예를 들어 Microsoft 365 프로필에 연결된 사용자 아바타를 표시합니다. | [f6f894ce-5b44-4c9b-aff4-253d2fbe8a99](../azure/f6f894ce-5b44-4c9b-aff4-253d2fbe8a99.md) |
>| openid | 위임 | 내부 사용자 ID  | [f6f894ce-5b44-4c9b-aff4-253d2fbe8a99](../azure/f6f894ce-5b44-4c9b-aff4-253d2fbe8a99.md) |
>| 프로필 | 위임 | Microsoft 365 앱을 timeghost에 통합하고 표시하기 위해 예를 들어 Microsoft 365 프로필에 연결된 사용자 아바타를 표시합니다. | [f6f894ce-5b44-4c9b-aff4-253d2fbe8a99](../azure/f6f894ce-5b44-4c9b-aff4-253d2fbe8a99.md) |
