...
| 회사의 웹 사이트 | [https://thoughtwire.com](https://thoughtwire.com) |
| 앱 사용 약관 | [https://www.thoughtwire.com/end-user-license-agreement/](https://www.thoughtwire.com/end-user-license-agreement/) |
| 앱의 핵심 기능 | ThoughtWire 앱은 코드 파란색 이벤트를 61% 줄이는 것으로 입증된 고급 검색 및 개입 도구인 EarlyWarning을 지원합니다. 조기 경고 솔루션은 환자 활력에 따라 환자의 밝기를 감지하고, 환자에게 부정적인 건강 이벤트를 알리고, 조치를 취할 수 있도록 디자인되었습니다. 응답 팀 직원은 환자 컨텍스트에 액세스할 수 있으며 응답 팀의 상태 및 가용성을 인식하여  간소화된 응답 및 환자 관리 워크플로를 허용합니다. |
| 회사 본사 위치 | 캐나다 |
| 앱 정보 페이지 | |
...
| 어떤 SOC 2 인증을 획득했나요? |   |
| 가장 최근 SOC2 인증 날짜 |  2021-03-31 |
| 앱이 SOC(서비스 조직 제어)를 준수하나요? | 예 |
| 가장 최근 SOC3 인증 날짜 |  2021-03-31 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.Create | application | 응용 프로그램에서 병원 구/단위에 대한 그룹/팀을 만들 수 있습니다. | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](https://docs.microsoft.com/microsoft-365-app-certification/azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c) |
>| Group.ReadWrite.All | application | 응용 프로그램에서 만들/다시 만들어야 하는 그룹을 결정하고 구성원 자격을 관리하는 데 필요합니다. | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](https://docs.microsoft.com/microsoft-365-app-certification/azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c) |
>| GroupMember.ReadWrite.All | application | 응용 프로그램에서 그룹 구성원을 관리할 수 있도록 필수입니다. 예: 교대 근무가 변경될 때 팀에서 간호사 추가/제거 | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](https://docs.microsoft.com/microsoft-365-app-certification/azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c) |
>| TeamMember.ReadWrite.All | application | 응용 프로그램에서 그룹 구성원을 관리할 수 있도록 필수입니다. 예: 교대 근무가 변경될 때 팀에서 간호사 추가/제거 | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](https://docs.microsoft.com/microsoft-365-app-certification/azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c) |
>| TeamsAppInstallation.ReadWriteForTeam | application | 응용 프로그램에서 작성/관리하는 팀에 ThoughtWire 봇을 자동으로 설치할 수 있습니다. | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](https://docs.microsoft.com/microsoft-365-app-certification/azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c) |
>| User.Read | application | 응용 프로그램에서 멤버 자격을 관리하고 사용자 이름을 검색하여 응용 프로그램 내에서 사용자를 ID로 검색할 때 필요한 경우 사용자의 AADID/사용자 이름을 검색하도록 허용합니다. | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](https://docs.microsoft.com/microsoft-365-app-certification/azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c) |
