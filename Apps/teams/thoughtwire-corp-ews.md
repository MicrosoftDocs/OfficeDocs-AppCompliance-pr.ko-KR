---
title: ThoughtWire Corp.의 ThoughtWire EWS에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/15/2021
...
description: ThoughtWire EWS, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/ed27363f-755e-4658-b7bf-409d475959d6" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003239" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

ThoughtWire Corp.가 Microsoft에 제공한 정보:
...
| 회사 웹 사이트 | [https://thoughtwire.com](https://thoughtwire.com) |
| 앱의 사용 약관 | [https://www.thoughtwire.com/end-user-license-agreement/](https://www.thoughtwire.com/end-user-license-agreement/) |
| 앱의 핵심 기능 | ThoughtWire 앱은 코드 파랑 이벤트를 61% 줄이는 것으로 입증된 고급 검색 및 개입 도구인 EarlyWarning을 지원합니다. 조기 경고 솔루션은 환자 활력에 따라 환자 악화를 감지하고 임상의에게 불리한 건강 이벤트를 알리고 조치를 취할 수 있도록 설계되었습니다. 응답 팀 직원은 환자 컨텍스트에 액세스할 수 있으며 응답 팀의 상태 및 가용성을 인식하여 간소화된 응답 및 환자 치료 워크플로를 허용합니다. |
| 회사 본사 위치 | 캐나다 |
| 앱 정보 페이지 | |
...
이 정보는 ThoughtWire Corp.에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직의 제어에 대해 제공되었습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.Create | 응용 프로그램 | 애플리케이션에서 병원 병동/단위에 대한 그룹/팀을 만들 수 있습니다. | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](../azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c.md) |
>| Group.ReadWrite.All | 응용 프로그램 | 애플리케이션이 만들거나 다시 만들어야 할 수 있는 그룹을 결정하고 멤버 자격을 관리하는 데 필요합니다. | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](../azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c.md) |
>| GroupMember.ReadWrite.All | 응용 프로그램 | 애플리케이션에서 그룹 멤버 자격을 관리할 수 있도록 해야 합니다. 즉, 교대 근무가 변경됨에 따라 팀에서 간호사를 추가/제거합니다. | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](../azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c.md) |
>| TeamMember.ReadWrite.All | 응용 프로그램 | 애플리케이션에서 그룹 멤버 자격을 관리할 수 있도록 해야 합니다. 즉, 교대 근무가 변경됨에 따라 팀에서 간호사를 추가/제거합니다. | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](../azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c.md) |
>| TeamsAppInstallation.ReadWriteForTeam | 응용 프로그램 | 애플리케이션에서 ThoughtWire 봇을 만들고 관리하는 팀에 자동으로 설치할 수 있습니다. | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](../azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c.md) |
>| User.Read | 응용 프로그램 | 애플리케이션에서 멤버 자격을 관리하거나 사용자 이름을 검색하여 애플리케이션 내에서 사용자를 ID로 지정할 때 필요에 따라 사용자의 AADID/사용자 이름을 검색하도록 허용합니다. | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](../azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c.md) |
