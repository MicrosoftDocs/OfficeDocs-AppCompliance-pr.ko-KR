...
description: ThoughtWire EWS, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.Create | application | 응용 프로그램에서 병원 구/단위에 대한 그룹/팀을 만들 수 있습니다. | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](../azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c.md) |
>| Group.ReadWrite.All | application | 응용 프로그램에서 만들/다시 만들어야 하는 그룹을 결정하고 구성원 자격을 관리하는 데 필요합니다. | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](../azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c.md) |
>| GroupMember.ReadWrite.All | application | 응용 프로그램에서 그룹 구성원을 관리할 수 있도록 필수입니다. 예: 교대 근무가 변경될 때 팀에서 간호사 추가/제거 | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](../azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c.md) |
>| TeamMember.ReadWrite.All | application | 응용 프로그램에서 그룹 구성원을 관리할 수 있도록 필수입니다. 예: 교대 근무가 변경될 때 팀에서 간호사 추가/제거 | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](../azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c.md) |
>| TeamsAppInstallation.ReadWriteForTeam | application | 응용 프로그램에서 작성/관리하는 팀에 ThoughtWire 봇을 자동으로 설치할 수 있습니다. | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](../azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c.md) |
>| User.Read | application | 응용 프로그램에서 멤버 자격을 관리하고 사용자 이름을 검색하여 응용 프로그램 내에서 사용자를 ID로 검색할 때 필요한 경우 사용자의 AADID/사용자 이름을 검색하도록 허용합니다. | [49a15c37-4eca-48b1-a327-7a8b5a3b399c](../azure/49a15c37-4eca-48b1-a327-7a8b5a3b399c.md) |
