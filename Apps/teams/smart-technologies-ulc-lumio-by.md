---
title: SMART by SMART Technologies ULC의 Lumio 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2021
...
description: Lumio by SMART에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/e0ffcbc7-f3f2-46b7-a189-afd01c545782" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001874" target="_blank">AppSource에서 보기</a>
...
| 회사 웹 사이트 | [https://smarttech.com](https://smarttech.com) |
| 앱의 사용 약관 | [https://www.smarttech.com/legal/sls-terms](https://www.smarttech.com/legal/sls-terms) |
| 앱의 핵심 기능 | 활동, 평가 및 학생 공동 작업으로 수업을 변환합니다. |
| 회사 본사 위치 | 캐나다 |
| 앱 정보 페이지 | [https://www.smarttech.com/smart-learning-suite/](https://www.smarttech.com/smart-learning-suite/) |
...
이 정보는 SMART Technologies ULC에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 제공되었습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 위임 | 데이터는 데이터가 수집되지 않는 그룹 권한을 확인하는 데 사용됩니다.  | [14cf575a-fae2-48e2-af39-e3448d3a48bb](../azure/14cf575a-fae2-48e2-af39-e3448d3a48bb.md) |
>| Group.Read.All | 위임 | 해당 그룹이 속한 그룹이며, 기능을 확인하기 위해 학생 또는 교사 그룹의 일부인지 확인하는 데 사용됩니다. 수집된 데이터가 없습니다.  | [14cf575a-fae2-48e2-af39-e3448d3a48bb](../azure/14cf575a-fae2-48e2-af39-e3448d3a48bb.md) |
