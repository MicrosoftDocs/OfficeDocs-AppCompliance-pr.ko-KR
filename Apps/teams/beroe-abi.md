---
title: Abi by Beroe에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/29/2022
...
description: Abi, 해당 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/55560ea0-ae82-48b2-b71e-a45356f56bb1" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003862" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Beroe에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | Beroe |
| 회사 웹 사이트 | [https://www.beroeinc.com](https://www.beroeinc.com) |
| 앱의 사용 약관 | [https://www.beroeinc.com/terms/](https://www.beroeinc.com/terms/) |
| 앱의 핵심 기능 | Abi &#8211; AI 기반 디지털 조달 도우미 |
| 회사 본사 위치 | 인도 |
| 앱 정보 페이지 | [https://www.beroeinc.com/beroe-live-ai](https://www.beroeinc.com/beroe-live-ai) |
...
이 정보는 Beroe에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 이름, 성 &amp; 회사 전자 메일 ID |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 이름, 성, 회사 전자 메일 ID &amp; 대화 ID |
...
| 개인 정보 취급 방침 URL | https://www.beroeinc.com/privacy-policy/ |
