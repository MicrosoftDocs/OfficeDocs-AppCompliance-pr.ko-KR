---
title: 학교 일 헬싱키 Oy에 의해 학교 일에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/12/2021
...
description: 학교일에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/7caaa66b-34b0-4c15-a65d-dba6edf0c8fd" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001430" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

학교의 날 헬싱키 Oy가 Microsoft에 제공한 정보:
...
| 회사 웹 사이트 | [https://www.schoolday.com](https://www.schoolday.com) |
| 앱의 사용 약관 | [https://www.schoolday.com/eula](https://www.schoolday.com/eula) |
| 앱의 핵심 기능 | Microsoft Teams 학교 의 날과 학생 웰빙과 Social-Emotional Learning (SEL)를 향상! |
| 회사 본사 위치 | 핀란드 |
| 앱 정보 페이지 | [https://www.schoolday.com/en/resources/faq](https://www.schoolday.com/en/resources/faq) |
...
이 정보는 School Day Helsinki Oy에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| GroupMember.Read.All | 위임 | 그룹 이름 및 그룹 멤버 자격. 교사인 사용자는 그룹에서 학생을 학교 일에 추가할 수 있습니다. | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](../azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f.md) |
>| Team.ReadBasic.All | 위임 | 팀의 이름은 교사 사용자가 팀 및 그룹의 학생을 추가하려는 경우에 사용됩니다. | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](../azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f.md) |
>| User.Read | 위임 | 사용자 메일, 이름 및 ID 토큰은 사용자 관리 및 인증에 사용됩니다. | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](../azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f.md) |
>| User.ReadBasic.All | 위임 | 사용자 아바타에 사용할 사용자 프로필 사진입니다. | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](../azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f.md) |
>| 전자 메일 | 위임 | 계정 인증을 위해 사용자 전자 메일이 수집됩니다. | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](../azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f.md) |
>| offline_access | 위임 | 인증 - 액세스 토큰 새로 고침 더 원활한 사용자 환경. | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](../azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f.md) |
>| openid | 위임 | OpenID 로그인에 대한 사용자의 고유 식별자입니다.  | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](../azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f.md) |
>| 프로필 | 위임 | 사용자 관리 및 인증을 위해 기본 설정 사용자 이름 및 개체 ID입니다. | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](../azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f.md) |
