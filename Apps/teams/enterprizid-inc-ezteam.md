...
>|:----------------|:------------------------------------------------|:--------------------------------------------------------|:--------------------------------------------------|:--------------------|
>| AppCatalog.Read.All | 위임 | 요청 생성 프로세스에 Teams 수 있도록 앱에서 사용할 Teams 목록 | 해당 없음 | 2b1fb18f-54e4-4b08-9ef2-5610d0fffa8b |
...
>| Group.Read.All | 위임 | 앱이 그룹을 나열하고 로그인한 사용자를 대신하여 해당 속성 및 모든 그룹 구성원 자격을 읽을 수 있도록 허용합니다. 내 데이터 확인에 Teams  | 해당 없음 | 2b1fb18f-54e4-4b08-9ef2-5610d0fffa8b |
...
>| 프로필 | 위임 | 앱에서 사용자의 기본 프로필(이름, 사진, 사용자 이름)을 볼 수 있도록 허용합니다. | 해당 없음 | 2b1fb18f-54e4-4b08-9ef2-5610d0fffa8b |
...
<iframe height='1020' title='Microsoft Cloud App Security 정보' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/36552' frameborder='no'></iframe>
