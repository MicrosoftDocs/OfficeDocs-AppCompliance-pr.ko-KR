...
| 응용 프로그램 Teams 페이지의 URL입니다. | [https://enterprizid.com/discover/](https://enterprizid.com/discover/) |
...
>EndUser 및 Organization 전체 이름입니다. 보존 및 제거 정책은 개인 데이터 보존 섹션에서 찾을 https://enterprizid.com/privacy-policy &quot; 수 &quot; 있습니다.
...
<br />
- 리소스 소유자 암호 자격 증명(ROPC) 흐름 | | 앱에서 웹 API를 노출하나요? | 예 | | 사용 권한 모델에서 클라이언트 앱이 적절한 동의를 받은 경우 통화 성공만 허용하나요? | 예 | | 앱에서 미리 보기 API를 사용하나요? | 예 | | 앱에서 사용되지 않는 API를 사용하나요? | No |
