---
title: AIVISION PRODUCTS SRL의 Meetgeek에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/28/2022
...
description: Meetgeek에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/6f5cab29-c1ad-4048-bf96-fdbe54dba6ba" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003720" target="_blank">AppSource에서 보기</a>
...
| 회사 웹 사이트 | [https://meetgeek.ai](https://meetgeek.ai) |
| 앱의 사용 약관 | [https://meetgeek.ai/terms](https://meetgeek.ai/terms) |
| 앱의 핵심 기능 | 온라인 모임의 생산성을 최대화합니다! 자동으로 기록, 기록, 요약 공유 및 모임 인사이트 액세스 |
| 회사 본사 위치 | 루마니아 |
| 앱 정보 페이지 | [https://meetgeek.ai](https://meetgeek.ai) |
...
이 정보는 AIVISION PRODUCTS SRL에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 사용자 프로필 데이터, 일정의 온라인 모임 |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 사용자 프로필 데이터, 일정의 온라인 모임 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | 위임 | 사용자의 일정 데이터 동기화 | [3f1a3775-c192-4e8c-ae48-d70d144a46c2](../azure/3f1a3775-c192-4e8c-ae48-d70d144a46c2.md) |
>| OnlineMeetings.ReadWrite | 위임 | 사용자에 대한 온라인 모임 동기화 | [3f1a3775-c192-4e8c-ae48-d70d144a46c2](../azure/3f1a3775-c192-4e8c-ae48-d70d144a46c2.md) |
>| User.Read | 위임 | 로그인한 사용자 식별 | [3f1a3775-c192-4e8c-ae48-d70d144a46c2](../azure/3f1a3775-c192-4e8c-ae48-d70d144a46c2.md) |
>| 전자 메일 | 위임 | 로그인한 사용자 식별 | [3f1a3775-c192-4e8c-ae48-d70d144a46c2](../azure/3f1a3775-c192-4e8c-ae48-d70d144a46c2.md) |
>| offline_access | 위임 | 사용자의 일정 데이터 동기화 | [3f1a3775-c192-4e8c-ae48-d70d144a46c2](../azure/3f1a3775-c192-4e8c-ae48-d70d144a46c2.md) |
>| openid | 위임 | 로그인한 사용자 식별 | [3f1a3775-c192-4e8c-ae48-d70d144a46c2](../azure/3f1a3775-c192-4e8c-ae48-d70d144a46c2.md) |
>| 프로필 | 위임 | 로그인한 사용자 식별 | [3f1a3775-c192-4e8c-ae48-d70d144a46c2](../azure/3f1a3775-c192-4e8c-ae48-d70d144a46c2.md) |
>| Calls.AccessMedia.All | 위임 | Meetgeek 봇을 트리거하여 사용자의 MS Teams 호출에 조인 | [6f5cab29-c1ad-4048-bf96-fdbe54dba6ba](../azure/6f5cab29-c1ad-4048-bf96-fdbe54dba6ba.md) |
>| Calls.Initiate.All | 위임 | Meetgeek 봇을 트리거하여 사용자의 MS Teams 호출에 조인 | [6f5cab29-c1ad-4048-bf96-fdbe54dba6ba](../azure/6f5cab29-c1ad-4048-bf96-fdbe54dba6ba.md) |
>| Calls.InitiateGroupCall.All | 위임 | Meetgeek 봇을 트리거하여 사용자의 MS Teams 호출에 조인 | [6f5cab29-c1ad-4048-bf96-fdbe54dba6ba](../azure/6f5cab29-c1ad-4048-bf96-fdbe54dba6ba.md) |
>| Calls.JoinGroupCall.All | 위임 | Meetgeek 봇을 트리거하여 사용자의 MS Teams 호출에 조인 | [6f5cab29-c1ad-4048-bf96-fdbe54dba6ba](../azure/6f5cab29-c1ad-4048-bf96-fdbe54dba6ba.md) |
