...
description: CSA STAR 레지스트리의 Hive, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용 가능한 모든 보안 및 규정 준수 정보입니다.
...
| 파트너 회사 이름 | Hive |
| 회사의 웹 사이트 | [https://www.hive.com](https://www.hive.com) |
| 앱 사용 약관 | [https://hive.com/terms](https://hive.com/terms) |
| 앱의 핵심 기능 | Hive를 통해 팀이 보다 효율적으로 공동 작업할 수 있습니다. |
| 회사 본사 위치 | 미국 |
