---
title: DSMN8의 직원 지원에 대한 응용 프로그램 정보(DSMN8)
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/19/2022
...
description: DSMN8의 직원 지원에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보
...
* <a href="https://teams.microsoft.com/l/app/3cf056e3-1c08-4cda-b6d6-962f7c7a1f7c" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003677" target="_blank">AppSource의 보기</a>
...
| 파트너 회사 이름 | DSMN8 |
| 회사의 웹 사이트 | [https://dsmn8.com](https://dsmn8.com) |
| 앱 사용 약관 | [https://dsmn8.com/terms-and-conditions](https://dsmn8.com/terms-and-conditions) |
| 앱의 핵심 기능 |  DSMN8은 직원이 회사에서 승인한 회사 콘텐츠를 자신의 소셜 미디어 채널에 공유하여 회사 영향력을 행사할 수 있도록 하는 앱 기반 플랫폼입니다.  |
...
이 정보는 DSMN8에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직이 사용할 컨트롤에 대해 제공됩니다.
...
| 데이터베이스에 저장되는 데이터는 무엇입니까? | 직위, 이름, 성, 전자 메일 주소 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 둘 다 | 로그인 프로세스 중에 직위, 이름, 성 및 전자 메일 데이터를 읽고 앱에서 프로필을 만들 수 있습니다. | [3cf056e3-1c08-4cda-b6d6-962f7c7a1f7c](../azure/3cf056e3-1c08-4cda-b6d6-962f7c7a1f7c.md) |
