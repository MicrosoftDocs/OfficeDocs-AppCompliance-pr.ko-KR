---
title: 88 벤처 제한에 의해 미리 알림에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/29/2022
...
description: Remind에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://appsource.microsoft.com/product/office/WA200001444" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

88 Ventures Limited to Microsoft에서 제공하는 정보:
...
| 회사 웹 사이트 | [https://moonbearapps.com](https://moonbearapps.com) |
| 앱의 사용 약관 | [https://teamsreminder.app/#terms](https://teamsreminder.app/#terms) |
| 앱의 핵심 기능 | 자신 또는 팀 구성원에게 중요한 모임, 할 일 항목 또는 생일에 대해 상기시킵니다. 개인 미리 알림, 그룹 채팅 미리 알림 또는 채널 미리 알림을 설정합니다. 되풀이 미리 알림을 설정할 수도 있습니다(예: 매주 월요일 오전 9시에 팀 모임)! |
| 회사 본사 위치 | 홍콩 |
| 앱 정보 페이지 | [https://teamsreminder.app](https://teamsreminder.app) |
...
이 정보는 88 Ventures Limited에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직의 제어에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 아니요 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 다른 사용자에게 알림을 표시할 때 사용자 GUID 및 사용자 이름 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 위임 | 관리자가 사용자를 검색하여 라이선스에 할당할 때 사용됩니다. 이 기능의 사용은 전적으로 선택 사항이며 일반적인 앱 사용 중에는 필요하지 않습니다. | [88546d4f-9973-4716-98e4-cd181c04bc2d](../azure/88546d4f-9973-4716-98e4-cd181c04bc2d.md) |
>| People.Read.All | 위임 | 사용자가 라이선스에 사용자를 할당하려고 할 때 사용됩니다. | [88546d4f-9973-4716-98e4-cd181c04bc2d](../azure/88546d4f-9973-4716-98e4-cd181c04bc2d.md) |
