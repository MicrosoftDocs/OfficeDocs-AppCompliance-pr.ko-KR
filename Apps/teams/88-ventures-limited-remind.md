...
>|:----------------|:------------------------------------------------|:--------------------------------------------------------|:--------------------------------------------------|:--------------------|
>| Directory.Read.All | 위임 | 데이터베이스에 정보가 저장되지 않습니다. | 관리자가 공개 미리 알림을 설정한 사용자에 대한 조직의 사용자 디렉터리를 찾아볼 수 있도록 허용 | [88546d4f-9973-4716-98e4-cd181c04bc2d](https://docs.microsoft.com/microsoft-365-app-certification/azure/88546d4f-9973-4716-98e4-cd181c04bc2d) |
