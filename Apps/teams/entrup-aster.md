---
title: 엔터업별 Aster에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/29/2021
...
description: Aster에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/2d8e8042-66df-4605-8c3a-9ca8962f3e99" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002379" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Microsoft에 대한 Entrup에서 제공하는 정보:
...
| 파트너 회사 이름 | 엔트업(Entrup) |
| 회사 웹 사이트 | [https://asterapp.co](https://asterapp.co) |
| 앱의 사용 약관 | [https://asterapp.co/conditions-generales/](https://asterapp.co/conditions-generales/) |
| 앱의 핵심 기능 | 시간을 절약할 수 있는 모임 시간(분) |
| 회사 본사 위치 | 프랑스 |
| 앱 정보 페이지 | [https://asterapp.co/solution/](https://asterapp.co/solution/) |
| 앱을 실행하는 데 사용되는 호스팅 환경 또는 서비스 모델은 무엇인가요? |  |
| 앱에서 사용하는 호스팅 클라우드 공급자는 무엇인가요? | Azure, OVH Cloud(프랑스) |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대한 Entrup에서 제공되었습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 위임 | Sharepoint 문서의 Planner 작업을 보내기 위한 디렉터리 목록 | [27c89ce8-b449-4959-b801-988d8b727512](../azure/27c89ce8-b449-4959-b801-988d8b727512.md) |
>| Group.ReadWrite.All | 위임 | 기존 또는 만든 그룹에서 Sharepoint 문서의 Planner 작업을 보내기 위한 그룹 목록 | [27c89ce8-b449-4959-b801-988d8b727512](../azure/27c89ce8-b449-4959-b801-988d8b727512.md) |
>| Notes.ReadWrite.All | 위임 | OneNote에서 쓰기 위한 노트 내용 | [27c89ce8-b449-4959-b801-988d8b727512](../azure/27c89ce8-b449-4959-b801-988d8b727512.md) |
>| Tasks.ReadWrite.Shared | 위임 | 작업, 할당, 마감일 | [27c89ce8-b449-4959-b801-988d8b727512](../azure/27c89ce8-b449-4959-b801-988d8b727512.md) |
>| User.Read | 위임 | 사용자를 식별하기 위한 사용자 전자 메일 | [27c89ce8-b449-4959-b801-988d8b727512](../azure/27c89ce8-b449-4959-b801-988d8b727512.md) |
>| offline_access | 위임 | 수집된 데이터가 없습니다. 토큰을 새로 고치는 것처럼 보입니다. | [27c89ce8-b449-4959-b801-988d8b727512](../azure/27c89ce8-b449-4959-b801-988d8b727512.md) |
