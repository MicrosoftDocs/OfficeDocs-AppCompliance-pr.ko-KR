---
title: 스킬애트 연구소 Pvt에 의해 기술에 대한 응용 프로그램 정보. Ltd.
ms.author: elmalova
author: elenamalova
ms.date: 01/12/2021
ms.topic: article
...
description: Skillate에 대한 사용 가능한 모든 보안 및 규정 준수 정보 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보, CSA STAR 레지스트리의 보안/규정 준수 정보.
...
* <a href="https://teams.microsoft.com/l/app/b24691df-ba35-42e7-bd57-a7c7e57e49d6" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002490" target="_blank">앱소스에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

기술 연구소 Pvt에서 제공하는 정보. 마이크로소프트에 주식 회사:
...
| 파트너 웹사이트의 URL | [https://skillate.com/](https://skillate.com/) |
| Teams 응용 프로그램 정보 페이지의 URL | [https://www.skillate.com/features/intelligent-hiring/](https://www.skillate.com/features/intelligent-hiring/) |
| 개인정보 처리방침의 URL | [https://www.skillate.com/privacy-policy](https://www.skillate.com/privacy-policy) |
| 이용 약관의 URL | [https://www.skillate.com/terms-and-conditions](https://www.skillate.com/terms-and-conditions) |
...
이 정보는 스킬애트 연구소 Pvt에 의해 제공되었습니다. 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터를 통해 조직이 가질 수 있는 제어에 대해 Ltd.
...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| 전자 메일 | 위임 | 데이터는 Skillate의 최종 사용자에게 권한을 부여하기 위해 수집됩니다. | 우리는 Skillate 응용 프로그램에 사용자의 계정을 만들기 위해 만 이메일 주소를 저장 | ed4df345-c860-4ffe-b614-0460d9106f0f |
>| 오픈 ID | 위임 | 우리는 SSO를 사용하여 기술마이크로 소프트에서 사용자를 로깅하는 API를 사용 | 최종 사용자만 이름과 성을 저장합니다. | ed4df345-c860-4ffe-b614-0460d9106f0f |
...
>|:--------------------------------|:---------------------|:--------------------------|
>| 사용자가 메시징 확장을 사용하도록 승인하기 위해서만 전자 메일 주소를 사용하고 있습니다. | 계정을 만드는 동안 우리는 이메일, 이름과 성을 저장합니다. 그러나 앱 사용 중에 사용자는 고객 입력에 따라 더 많은 변수를 추가할 수 있습니다. | 우리는 계정을 승인하고 만들기 위해 최종 사용자의 이메일, 이름과 성만 저장합니다.  |
...
<iframe height='1020' title='Microsoft Cloud App Security 정보' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/36380' frameborder='no' style='width: 100%;'></iframe>

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/36380" target="_blank">새 탭에서 보기</a>
...
이 정보는 스킬애트 연구소 Pvt에 의해 제공되었습니다. 이 앱이 인증, 권한 부여, 응용 프로그램 등록 모범 사례 및 기타 ID 기준을 처리하는 방법에 대해 회사.
