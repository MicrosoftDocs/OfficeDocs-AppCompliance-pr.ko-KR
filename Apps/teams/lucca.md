---
title: Lucca by Lucca에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/20/2021
...
description: Lucca에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/53628f6a-ac66-4fde-8945-d639c8da4c0d" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001650" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Lucca에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | Lucca |
| 회사 웹 사이트 | [https://www.lucca.fr](https://www.lucca.fr) |
| 앱의 사용 약관 | [https://cdn2.hubspot.net/hubfs/1582050/3-DOWNLOAD_FILES/Ter...](https://cdn2.hubspot.net/hubfs/1582050/3-DOWNLOAD_FILES/TermsAndConditions.pdf) |
| 앱의 핵심 기능 | Lucca는 관리 및 HR 프로세스를 최적화하는 SaaS 솔루션을 개발합니다. 휴가 및 부재 관리, 비용 보고서, 시간 추적 등 특정 요구 사항에 대한 간단한 답변을 제공하는 소프트웨어 솔루션을 디자인합니다. |
| 회사 본사 위치 | 프랑스 |
| 앱 정보 페이지 | |
| 앱을 실행하는 데 사용되는 호스팅 환경 또는 서비스 모델은 무엇인가요? |  |
| 앱에서 사용하는 호스팅 클라우드 공급자는 무엇인가요? | SelfHosted |
...
이 정보는 Lucca에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 제공했습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMember.Read.All | 위임 | 데이터가 수집되지 않습니다. 이를 사용하여 표시할 계획을 필터링했습니다. 채널에 있는 사용자만 계획이 표시됩니다. | [53628f6a-ac66-4fde-8945-d639c8da4c0d](../azure/53628f6a-ac66-4fde-8945-d639c8da4c0d.md) |
>| Chat.ReadWrite | 응용 프로그램 | 데이터가 수집되거나 사용되지 않습니다. 앱은 하루 중 부재자를 포함하는 메시지만 게시합니다. | [53628f6a-ac66-4fde-8945-d639c8da4c0d](../azure/53628f6a-ac66-4fde-8945-d639c8da4c0d.md) |
>| Group.Read.All | 응용 프로그램 | GroupId를 수집하여 앱이 부재자를 사용하여 메시지를 보내야 하는 그룹을 알 수 있습니다.  | [53628f6a-ac66-4fde-8945-d639c8da4c0d](../azure/53628f6a-ac66-4fde-8945-d639c8da4c0d.md) |
>| User.Read | 위임 | 사용자를 로그인하는 데 사용됨 | [53628f6a-ac66-4fde-8945-d639c8da4c0d](../azure/53628f6a-ac66-4fde-8945-d639c8da4c0d.md) |
>| User.Read.All | 응용 프로그램 | 사용자 프로필을 읽는 데 사용됨 | [53628f6a-ac66-4fde-8945-d639c8da4c0d](../azure/53628f6a-ac66-4fde-8945-d639c8da4c0d.md) |
>| 전자 메일 | 위임 | 앱 탭에 사용자 전자 메일을 표시하는 데 사용됨 | [53628f6a-ac66-4fde-8945-d639c8da4c0d](../azure/53628f6a-ac66-4fde-8945-d639c8da4c0d.md) |
>| openid | 위임 | 사용자를 로그인하는 데 사용됨 | [53628f6a-ac66-4fde-8945-d639c8da4c0d](../azure/53628f6a-ac66-4fde-8945-d639c8da4c0d.md) |
>| 프로필 | 위임 | 앱 탭에 사용자 프로필을 표시하는 데 사용됩니다. | [53628f6a-ac66-4fde-8945-d639c8da4c0d](../azure/53628f6a-ac66-4fde-8945-d639c8da4c0d.md) |
