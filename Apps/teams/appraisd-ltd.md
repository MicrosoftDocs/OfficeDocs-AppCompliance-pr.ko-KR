---
title: Appraisd 주식회사의 Appraisd에 대한 애플리케이션 정보입니다.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/07/2021
...
description: Appraisd에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/4f037969-20ef-4a41-8330-422b7b115eb6" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003123" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Appraisd Ltd.에서 Microsoft에 제공한 정보:
...
| 회사 웹 사이트 | [https://www.appraisd.com](https://www.appraisd.com) |
| 앱의 사용 약관 | [https://www.appraisd.com/terms](https://www.appraisd.com/terms) |
| 앱의 핵심 기능 | 성능 검토, 목표 및 피드백으로 성능 문화 충전 |
| 회사 본사 위치 | 영국 및 북아일랜드(해당) |
| 앱 정보 페이지 | [https://www.appraisd.com](https://www.appraisd.com) |
...
이 정보는 Appraisd Ltd.에서 제공되었습니다. 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어할 수 있습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| People.Read | 위임 | 사용자 선택기는 사용자에게 팀 구성원 목록을 제공합니다. 이는 Appraisd 내에서 핵심 기능을 지원하기 위한 것입니다. | [4f037969-20ef-4a41-8330-422b7b115eb6](../azure/4f037969-20ef-4a41-8330-422b7b115eb6.md) |
>| User.Read | 위임 | 사용자의 이메일 주소(upn) 및 사용자 ID는 Appraisd 내에서 사용자를 찾아 해당 Teams 계정에 연결하기 위해 사용됩니다. | [4f037969-20ef-4a41-8330-422b7b115eb6](../azure/4f037969-20ef-4a41-8330-422b7b115eb6.md) |
>| User.ReadBasic.All | 위임 | 사용자 선택기는 팀 구성원에 대한 기본 정보를 사용자에게 제공합니다. 이는 Appraisd 내에서 핵심 기능을 지원하기 위한 것입니다. | [4f037969-20ef-4a41-8330-422b7b115eb6](../azure/4f037969-20ef-4a41-8330-422b7b115eb6.md) |
