...
description: CSA STAR 레지스트리의 elmah.io, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용 가능한 모든 보안 및 규정 준수 정보입니다.
...
| 파트너 회사 이름 | elmah.io |
| 회사의 웹 사이트 | [https://elmah.io](https://elmah.io) |
| 앱 사용 약관 | [https://elmah.io/legal/terms-of-use/](https://elmah.io/legal/terms-of-use/) |
| 앱의 핵심 기능 | elmah.io .NET 웹 개발자를 위한 오류 로깅 및 시간 모니터링 서비스입니다. elmah.io 모든 주요 웹 및 로깅 프레임워크와 통합되고 웹, Windows 응용 프로그램 전반에 걸쳐 광범위한 모니터링 환경을 제공합니다. |
| 회사 본사 위치 | 덴마크 |
| 앱 정보 페이지 | [https://docs.elmah.io/elmah-io-apps-teams/](https://docs.elmah.io/elmah-io-apps-teams/) |
...
이 정보는 elmah.io 수집 및 저장하는 방법과 앱이 수집하는 데이터를 통해 조직이 하게 될 컨트롤에 대한 정보를 제공합니다.
...
| 데이터베이스에 저장되는 데이터는 무엇입니까? | 이름 및 전자 메일 |
...
| 개인 정보 취급 방침 URL | https://elmah.io/legal/privacy-policy/ |
