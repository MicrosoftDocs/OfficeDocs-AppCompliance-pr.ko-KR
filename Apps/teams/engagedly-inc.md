---
title: 참여하는 Inc에 참여하는 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
ms.date: 11/10/2021
ms.topic: article
...
description: CSA STAR 레지스트리의 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보
...
ms.locfileid: "60923030"
---
# <a name="engagedly"></a>참여

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2021년 8월 21일</p>

* <a href="https://teams.microsoft.com/l/app/d794bf4c-ef30-4d92-9e2e-6944e9f1512e" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003446" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Engagedly Inc에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | Engagedly Inc |
| 회사의 웹 사이트 | [https://engagedly.com](https://engagedly.com) |
| 앱 사용 약관 | [https://engagedly.com/terms/](https://engagedly.com/terms/) |
| 앱의 핵심 기능 | 참여는 참여하는 성과 검토를 통해 지속적인 성과 관리를 제공하는 인재 관리 솔루션으로, 감성 시스템에 대한 직원 참여를 유도하며 다양한 분석 및 인력 계획 도구를 제공합니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
...
이 정보는 Engagedly Inc에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직에서 제공하는 컨트롤에 대해 제공합니다.
...
| 개인 정보 취급 방침 URL | https://engagedly.com/privacy/ |
