---
title: OfficeRnD의 OfficeRnD 하이브리드 작업용 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/11/2021
...
description: CSA STAR 레지스트리의 OfficeRnD 하이브리드 작업, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/ff19eb3c-6afa-4f33-acfd-df1338289524" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003460" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

OfficeRnD에서 Microsoft에 제공하는 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | OfficeRnD Hybrid Work |
| ID | WA200003460 |
| Office 365 클라이언트 지원 | Microsoft Teams |
| 파트너 회사 이름 | OfficeRnD |
| 회사의 웹 사이트 | [https://officernd.com](https://officernd.com) |
| 앱 사용 약관 | [https://officernd.com/terms](https://officernd.com/terms) |
| 앱의 핵심 기능 | 직원들이 책상, 회의실 및 기타 공간을 신속하게 찾아서 예약할 수 있도록 합니다. |
| 회사 본사 위치 | 영국 및 북아일랜드 (the) |
| 앱 정보 페이지 | [https://www.officernd.com/hybrid-workplace-management-softw...](https://www.officernd.com/hybrid-workplace-management-software/) |
...
이 정보는 OfficeRnD에서 이 앱이 조직 데이터를 수집 및 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직에서 제공하는 컨트롤에 대해 제공됩니다.
...
| 개인 정보 취급 방침 URL | https://officernd.com/privacy |
