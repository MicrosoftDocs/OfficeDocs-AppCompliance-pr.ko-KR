---
title: Pavestep by Pavestep에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/23/2022
...
description: Pavestep에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/aaa83b14-3857-43e0-88ca-b726f5df5db3" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004114" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Pavestep에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | Pavestep |
| 회사 웹 사이트 | [https://www.pavestep.com](https://www.pavestep.com) |
| 앱의 사용 약관 | [https://www.pavestep.com/user-agreement](https://www.pavestep.com/user-agreement) |
| 앱의 핵심 기능 | Pavestep은 직관적인 성능 관리 솔루션입니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
...
이 정보는 Pavestep에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 이름, 성, 전자 메일, 작업 역할 |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 이름, 성, 전자 메일, 작업 역할 |
