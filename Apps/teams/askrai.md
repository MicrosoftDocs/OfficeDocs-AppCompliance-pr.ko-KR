...
* <a href="https://teams.microsoft.com/l/app/1f36eaf6-30a3-4488-a73f-4754b91e865d" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001583" target="_blank">앱소스에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

askR.ai Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | askR.ai |
| 파트너 웹사이트의 URL | [https://en.askr.ai/](https://en.askr.ai/) |
| Teams 응용 프로그램 정보 페이지의 URL | [https://en.askr.ai](https://en.askr.ai) |
| 개인정보 처리방침의 URL | [https://en.askr.ai/privacy-policy-askr-ai](https://en.askr.ai/privacy-policy-askr-ai) |
| 이용 약관의 URL | [https://en.askr.ai/terms-of-use-askr-ai](https://en.askr.ai/terms-of-use-askr-ai) |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 조직에서 앱이 수집하는 데이터에 대한 제어에 대한 askR.ai 제공되었습니다.
...
>최종 사용자 식별 정보 또는 조직 정보가 기록되지 않습니다.

#### <a name="organizational-controls-for-data-stored-by-partner"></a>파트너가 저장한 데이터에 대한 조직 제어

조직의 관리자가 파트너 시스템에서 자신의 정보를 제어하는 방법을 설명해 보세요. 예를 들어 삭제, 보존, 감사, 보관, 최종 사용자 정책 등

>응용 프로그램 데이터는 고객이 저장하고 관리합니다. 이러한 데이터가 클라우드 서버에서 호스팅되면 암호화되며 일부 공인 시스템 관리자만 액세스할 수 있습니다. 이러한 개인은 ssh 키와 VPN을 기반으로 MFA 인증이 있습니다. IP 범위 필터링도 활성화됩니다.
...
<iframe height='1020' title='Microsoft Cloud App Security 정보' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/36145' frameborder='no' style='width: 100%;'></iframe>

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/36145" target="_blank">새 탭에서 보기</a>
...
이 정보는 이 앱이 인증, 권한 부여, 응용 프로그램 등록 모범 사례 및 기타 ID 기준을 처리하는 방법에 대해 askR.ai 제공되었습니다.
