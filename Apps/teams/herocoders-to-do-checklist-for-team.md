---
title: HeroCoders별 팀의 할 일 검사 목록에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/05/2022
...
description: 팀의 할 일 검사 목록, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
ms.locfileid: "66656367"
---
# <a name="to-do-checklist-for-team"></a>팀의 할 일 검사 목록

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 6월 16일</p>

* <a href="https://teams.microsoft.com/l/app/b08b0225-1f4b-4e82-879e-d4ef15b5bbda" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004362" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

HeroCoders에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | HeroCoders |
| 회사 웹 사이트 | [https://herocoders.com](https://herocoders.com) |
| 앱의 사용 약관 | [https://herocoders.com/legal/checklist-for-team#EULA](https://herocoders.com/legal/checklist-for-team#EULA) |
| 앱의 핵심 기능 | 모든 규모의 팀을 위한 고급 검사 목록입니다. |
| 회사 본사 위치 | 폴란드 |
| 앱 정보 페이지 | [https://herocoders.com](https://herocoders.com) |
...
이 정보는 HeroCoders에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | Azure AD ID |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | Azure AD ID |
...
| 개인 정보 취급 방침 URL | https://herocoders.com/legal/checklist-for-team#Privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| 전자 메일 | 위임 | SSO(Single Sign-On)를 사용하려면 | [777d9a9f-feef-48dd-b62d-562ff21aeda2](../azure/777d9a9f-feef-48dd-b62d-562ff21aeda2.md) |
>| offline_access | 위임 | 사용자가 로그인하지 않은 동안 검사 목록 항목에 대한 정보를 다른 사용자에게 표시할 수 있습니다. | [777d9a9f-feef-48dd-b62d-562ff21aeda2](../azure/777d9a9f-feef-48dd-b62d-562ff21aeda2.md) |
>| openid | 위임 | Azure Ad 계정으로 사용자를 로그인하려면 | [777d9a9f-feef-48dd-b62d-562ff21aeda2](../azure/777d9a9f-feef-48dd-b62d-562ff21aeda2.md) |
>| 프로필 | 위임 | 검사 목록의 기록에 사용자의 이름을 표시합니다. | [777d9a9f-feef-48dd-b62d-562ff21aeda2](../azure/777d9a9f-feef-48dd-b62d-562ff21aeda2.md) |
