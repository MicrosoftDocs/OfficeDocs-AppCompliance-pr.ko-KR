...
| 파트너 회사 이름 | ChurnZero |
| 회사의 웹 사이트 | [https://churnzero.net](https://churnzero.net) |
| 앱 사용 약관 | [https://churnzero.net/terms-of-use](https://churnzero.net/terms-of-use) |
| 앱의 핵심 기능 | ChurnZero는 구독 기업이 정체에 맞서고, 현재 계정을 확장하고, 제품 채택을 늘리고, 고객 환경을 최적화하는 데 도움이 되는 실시간 고객 성공 플랫폼입니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 위임 | ChurnZero 사용자와 상관 관계가 있는 위임 사용자의 Azure 개체 ID로, 향후 봇 세션 동안 해당 사용자를 식별하고 권한을 승인합니다. | [c2e66b59-725d-4c56-8a0e-ee2587031d9f](https://docs.microsoft.com/microsoft-365-app-certification/azure/c2e66b59-725d-4c56-8a0e-ee2587031d9f) |
