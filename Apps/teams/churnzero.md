---
title: ChurnZero의 ChurnZero에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/08/2021
...
description: ChurnZero에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/c2e66b59-725d-4c56-8a0e-ee2587031d9f" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002581" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

ChurnZero에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | ChurnZero |
| 회사 웹 사이트 | [https://churnzero.net](https://churnzero.net) |
| 앱의 사용 약관 | [https://churnzero.net/terms-of-use](https://churnzero.net/terms-of-use) |
| 앱의 핵심 기능 | ChurnZero는 구독 비즈니스가 변동을 방지하고, 현재 계정을 확장하고, 제품 채택을 늘리고, 고객 환경을 최적화하는 데 도움이 되는 실시간 고객 성공 플랫폼입니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대한 ChurnZero에서 제공되었습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 위임 | 이후 봇 세션 중에 해당 사용자를 식별하고 권한을 부여하기 위해 위임된 사용자의 Azure 개체 ID가 ChurnZero 사용자와 상호 연결됩니다. | [c2e66b59-725d-4c56-8a0e-ee2587031d9f](../azure/c2e66b59-725d-4c56-8a0e-ee2587031d9f.md) |
