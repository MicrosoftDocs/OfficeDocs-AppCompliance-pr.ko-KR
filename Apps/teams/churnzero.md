...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 위임 | ChurnZero 사용자와 상관 관계가 있는 위임 사용자의 Azure 개체 ID로, 향후 봇 세션 동안 해당 사용자를 식별하고 권한을 승인합니다. | [c2e66b59-725d-4c56-8a0e-ee2587031d9f](../azure/c2e66b59-725d-4c56-8a0e-ee2587031d9f.md) |
