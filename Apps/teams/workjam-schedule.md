---
title: WorkJam별 WorkJam 일정에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: WorkJam 일정, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/02cc7d46-7636-4f30-bae2-c5dfde32751c" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003058" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

WorkJam에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | WorkJam |
| 회사 웹 사이트 | [https://www.workjam.com](https://www.workjam.com) |
| 앱의 사용 약관 | [https://appcontent.workjam.com/en/terms-of-use/](https://appcontent.workjam.com/en/terms-of-use/) |
| 앱의 핵심 기능 | WorkJam은 디지털 작업 공간 솔루션 업계 리더가 일선 생산성 플랫폼 또는 일선 직원 솔루션 내에서 &#8212; 일선 인력을 오케스트레이션하도록 선택하는 솔루션입니다. 37개 이상의 언어로 제공되며 38개국 이상에 배포된 WorkJam은 시장 최고의 작업 관리, 교대 관리, 설문 조사 및 마이크로 학습 도구를 통해 총 인력 오케스트레이션을 제공합니다.  |
| 회사 본사 위치 | 캐나다 |
...
이 정보는 WorkJam에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsActivity.Send | 응용 프로그램 | 최종 사용자에게 알림 보내기 | [0b87cb84-073e-4cf6-a1ef-45d864ef2918](../azure/0b87cb84-073e-4cf6-a1ef-45d864ef2918.md) |
