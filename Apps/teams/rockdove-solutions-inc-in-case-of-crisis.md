---
title: RockDove Solutions, Inc.에 의한 위기의 경우 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/08/2022
...
description: In Case of Crisis, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 6월 8일</p>

* <a href="https://teams.microsoft.com/l/app/cf430644-447e-4572-8467-3892596d05c7" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003194" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

RockDove Solutions, Inc.에서 Microsoft에 제공한 정보:
...
| 회사 웹 사이트 | [https://www.rockdovesolutions.com](https://www.rockdovesolutions.com) |
| 앱의 사용 약관 | [https://www.rockdovesolutions.com/terms-of-use](https://www.rockdovesolutions.com/terms-of-use) |
| 앱의 핵심 기능 | In Case of Crisis는 동적 문제 및 위기 관리 수명 주기를 위해 특별히 설계된 플랫폼입니다. 이 앱을 통해 조직은 상황이 전개됨에 따라 응답 프로토콜 및 모범 사례를 포함하는 실행 가능한 플레이북을 쉽게 공유하고 활성화할 수 있습니다.  초기 보고부터 해결까지 비즈니스에 영향을 주는 문제의 전체 수명 주기를 관리하고 캡처할 수도 있습니다.   |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://www.rockdovesolutions.com/in-case-of-crisis/in-case...](https://www.rockdovesolutions.com/in-case-of-crisis/in-case-of-crisis-platform) |
...
이 정보는 RockDove Solutions, Inc.에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 회의 예약, 채널로 파일 공유 |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 회의 예약, 채널로 파일 공유 |
...
| 개인 정보 취급 방침 URL | https://www.rockdovesolutions.com/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | 위임 | 문제 관리 팀 구성원과 일정 초대 공유 | [6b4a2fee-5642-41a7-b452-d555fac690b0](../azure/6b4a2fee-5642-41a7-b452-d555fac690b0.md) |
>| Channel.ReadBasic.All | 위임 | 문제 관리 팀 구성원에 대한 파일을 업로드하고 공유할 수 있도록 | [6b4a2fee-5642-41a7-b452-d555fac690b0](../azure/6b4a2fee-5642-41a7-b452-d555fac690b0.md) |
>| Files.ReadWrite | 위임 | 문제 관리 일정 및 파일 변경 내용 및 알림 | [6b4a2fee-5642-41a7-b452-d555fac690b0](../azure/6b4a2fee-5642-41a7-b452-d555fac690b0.md) |
>| Files.ReadWrite.All | 위임 | 문제 관리 일정 및 파일 변경 내용 및 알림 | [6b4a2fee-5642-41a7-b452-d555fac690b0](../azure/6b4a2fee-5642-41a7-b452-d555fac690b0.md) |
>| Sites.ReadWrite.All | 위임 | 문제 관리 일정 및 사이트 변경 내용 및 알림 | [6b4a2fee-5642-41a7-b452-d555fac690b0](../azure/6b4a2fee-5642-41a7-b452-d555fac690b0.md) |
>| Team.ReadBasic.All | 위임 | 사용자가 문제 관리에 액세스할 수 있는 Teams를 나열할 수 있습니다. | [6b4a2fee-5642-41a7-b452-d555fac690b0](../azure/6b4a2fee-5642-41a7-b452-d555fac690b0.md) |
>| 전자 메일 | 위임 | OAuth 2.0 및 Azure Active Directory를 사용하는 기본 사용자 ID로 사용하기 때문입니다. | [6b4a2fee-5642-41a7-b452-d555fac690b0](../azure/6b4a2fee-5642-41a7-b452-d555fac690b0.md) |
>| offline_access | 위임 | 문제 관리 일정 및 파일 변경 내용 및 알림 | [6b4a2fee-5642-41a7-b452-d555fac690b0](../azure/6b4a2fee-5642-41a7-b452-d555fac690b0.md) |
>| openid | 위임 | SSO(Single Sign-On)에 사용됨 | [6b4a2fee-5642-41a7-b452-d555fac690b0](../azure/6b4a2fee-5642-41a7-b452-d555fac690b0.md) |
