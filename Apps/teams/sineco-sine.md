...
| 파트너 회사 이름 | Sine.co |
| 회사의 웹 사이트 | [https://www.sine.co](https://www.sine.co) |
| 앱 사용 약관 | [https://www.sine.co/terms/](https://www.sine.co/terms/) |
| 앱의 핵심 기능 | 방문자 및 근무자 안전, 보안, 규정 준수를 향상시키는 작업 공간 소프트웨어를 사인인회합니다. |
| 회사 본사 위치 | 오스트레일리아 |
...
이 정보는 Sine.co 수집 및 저장하는 방법과 앱이 수집하는 데이터를 통해 조직이 하게 될 컨트롤에 대한 정보를 제공합니다.
