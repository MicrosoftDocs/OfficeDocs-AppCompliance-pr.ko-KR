---
title: Sine.co Sine에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/20/2021
...
description: Sine에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/b0d37fb7-080f-4288-992b-36790712c016" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003244" target="_blank">AppSource에서 보기</a>
...
| 파트너 회사 이름 | Sine.co |
| 회사 웹 사이트 | [https://www.sine.co](https://www.sine.co) |
| 앱의 사용 약관 | [https://www.sine.co/terms/](https://www.sine.co/terms/) |
| 앱의 핵심 기능 | 방문자 및 작업자 안전, 보안, 규정 준수를 향상시키는 사인 작업 공간 소프트웨어입니다. |
| 회사 본사 위치 | 오스트레일리아 |
| 앱 정보 페이지 | [https://www.sine.co](https://www.sine.co) |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직의 제어에 대한 Sine.co 제공되었습니다.
