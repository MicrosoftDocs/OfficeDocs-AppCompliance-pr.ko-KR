---
title: operaLogica srl에 의한 Meety에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/20/2022
...
description: Meety에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/9a68d494-f5ae-4e0c-ad18-478bf6fcd101" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004258" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

operaLogica에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | operaLogica srl |
| 회사 웹 사이트 | [https://meety.business](https://meety.business) |
| 앱의 사용 약관 | [https://meety.business/termsofuse](https://meety.business/termsofuse) |
| 앱의 핵심 기능 | 모임 수집 및 구성 및 대상, 작업 및 모임 기록을 사용하여 모임 환경을 개선할 수 있습니다. |
| 회사 본사 위치 | 이탈리아 |
| 앱 정보 페이지 | |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대한 operaLogica srl에 의해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 전자 메일, 이름, 성, 모임 삽입됨 |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 전자 메일, 이름, 성, 모임 삽입됨 |
...
| 개인 정보 취급 방침 URL | https://meety.business/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | 위임 | 스레드에 모임을 추가할 수 있습니다. | [9a68d494-f5ae-4e0c-ad18-478bf6fcd101](../azure/9a68d494-f5ae-4e0c-ad18-478bf6fcd101.md) |
>| Chat.Read | 위임 | 모임에 대한 정보 읽기 | [9a68d494-f5ae-4e0c-ad18-478bf6fcd101](../azure/9a68d494-f5ae-4e0c-ad18-478bf6fcd101.md) |
>| Chat.ReadBasic | 위임 | 모임에 대한 정보 읽기 | [9a68d494-f5ae-4e0c-ad18-478bf6fcd101](../azure/9a68d494-f5ae-4e0c-ad18-478bf6fcd101.md) |
>| OnlineMeetingArtifact.Read.All | 위임 | 사용자의 환경을 높이기 위해 모임의 아티팩트 정보를 읽습니다. | [9a68d494-f5ae-4e0c-ad18-478bf6fcd101](../azure/9a68d494-f5ae-4e0c-ad18-478bf6fcd101.md) |
>| OnlineMeetings.Read | 위임 | 모임의 ID를 읽어 추가 데이터 추가 | [9a68d494-f5ae-4e0c-ad18-478bf6fcd101](../azure/9a68d494-f5ae-4e0c-ad18-478bf6fcd101.md) |
>| User.Read | 위임 | 앱을 사용하여 사용자에 대한 정보 가져오기 | [9a68d494-f5ae-4e0c-ad18-478bf6fcd101](../azure/9a68d494-f5ae-4e0c-ad18-478bf6fcd101.md) |
