---
title: Beekast by Beekast에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2021
...
description: Beekast에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://appsource.microsoft.com/product/office/WA200001447" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Beekast에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | Beekast |
| 회사 웹 사이트 | [https://www.beekast.com](https://www.beekast.com) |
| 앱의 사용 약관 | [https://www.beekast.com/terms/](https://www.beekast.com/terms/) |
| 앱의 핵심 기능 | Beekast는 모임 속도를 높이기 위한 공동 작업 플랫폼입니다. |
| 회사 본사 위치 | 프랑스 |
| 앱 정보 페이지 | [https://www.beekast.com](https://www.beekast.com) |
...
이 정보는 Beekast에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 위임 | 이메일, 이름 및 성: 이러한 데이터는 beekast 애플리케이션 내에서 공동 작업하는 데 사용됩니다. | [4d0997dc-df53-4b18-9df1-bb283f8a0377](../azure/4d0997dc-df53-4b18-9df1-bb283f8a0377.md) |
