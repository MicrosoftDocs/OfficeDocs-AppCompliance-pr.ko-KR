---
title: Intumit의 SmartWork by SmartWork에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: SmartWork에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://appsource.microsoft.com/product/office/WA200001149" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Intumit의 SmartWork에서 Microsoft에 제공한 정보:
...
| 회사 웹 사이트 | [https://www.intumit.com/english/](https://www.intumit.com/english/) |
| 앱의 사용 약관 | [https://www.intumit.com/english/TermsOfUse.html](https://www.intumit.com/english/TermsOfUse.html) |
| 앱의 핵심 기능 | SmartWork는 Microsoft Office 365 관련된 질문에 대답할 수 있는 대화 로봇입니다. |
| 회사 본사 위치 | 대만(중국) |
| 앱 정보 페이지 | |
...
이 정보는 Intumit의 SmartWork에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 위임 | userPrincipalName을 사용하여 사용자의 메일이 유효한 AAD 온 것인지 여부를 식별합니다. | [a938ae1e-a791-4751-9e6a-178c991fa0fa](../azure/a938ae1e-a791-4751-9e6a-178c991fa0fa.md) |
