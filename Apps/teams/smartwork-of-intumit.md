...
| 앱의 핵심 기능 | SmartWork는 사용자와 관련된 질문에 대답할 수 있는 대화 상자 Microsoft Office 365 |
| 회사 본사 위치 | 대만(중국 시국) |
| 앱 정보 페이지 | |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 위임 | userPrincipalName을 사용하여 사용자의 메일이 유효한 전자 메일에서 온 것인지 AAD 식별 | [a938ae1e-a791-4751-9e6a-178c991fa0fa](../azure/a938ae1e-a791-4751-9e6a-178c991fa0fa.md) |
