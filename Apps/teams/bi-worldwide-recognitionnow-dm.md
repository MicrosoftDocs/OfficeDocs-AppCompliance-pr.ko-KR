---
title: BI WORLDWIDE의 RecognitionNow DM에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/22/2022
...
description: RecognitionNow DM, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보
...
* <a href="https://teams.microsoft.com/l/app/af14ac7f-7a33-4d98-9c90-1e31285a5aa9" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003647" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

BI WORLDWIDE에서 Microsoft에 제공하는 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | RecognitionNow DM |
| ID | WA200003647 |
| Office 365 클라이언트 지원 | Microsoft Teams |
| 파트너 회사 이름 | BI WORLDWIDE |
| 회사의 웹 사이트 | [https://www.biworldwide.com](https://www.biworldwide.com) |
| 앱 사용 약관 | [https://recognition-now.biw.cloud/terms-and-conditions-dm](https://recognition-now.biw.cloud/terms-and-conditions-dm) |
| 앱의 핵심 기능 | 동일한 인식 프로그램 Teams 참가자에게 직접 인식을 보낼 수 있습니다. 이 추가 기능을 조직의 인식 프로그램과 함께 제공합니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
...
이 정보는 BI WORLDWIDE에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직에서 제공하는 컨트롤에 대해 제공됩니다.
...
| 앱이 SOX(Sarbanes-Oxley Act)를 준수하나요? | 아니오 |
...
| 개인 정보 취급 방침 URL | https://teams.recognitionnow.com/assets/images/privacy-policy.pdf |
| 앱이 법적 영향이나 유사한 영향을 미칠 수 있는 프로파일링을 포함하여 자동화된 의사 결정을 수행하나요? | 예 |
| 개인이 처리에 이의를 할 수 있는 옵션을 제공합니까? | 아니오 |
