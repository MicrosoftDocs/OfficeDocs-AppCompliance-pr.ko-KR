---
title: Unifon AS의 Bedriftsnett에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
ms.date: 11/29/2021
ms.topic: article
...
description: Bedriftsnett에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보
...
ms.locfileid: "62148667"
---
# <a name="bedriftsnett"></a>Bedriftsnett

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2021년 10월 8일</p>

* <a href="https://teams.microsoft.com/l/app/af9a1113-600a-4084-9e68-5f20fe25f4d8" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003490" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Unifon AS에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | Unifon AS |
| 회사의 웹 사이트 | [https://www.unifon.no](https://www.unifon.no) |
| 앱 사용 약관 | [https://www.unifon.no/avtalevilkar/](https://www.unifon.no/avtalevilkar/) |
| 앱의 핵심 기능 | Unifon Bedriftsnett는 이제 현재 유니버시티에서 직접 사용할 수 Microsoft Teams |
| 회사 본사 위치 | 노르웨이 |
| 앱 정보 페이지 | |
...
이 정보는 Unifon AS에서 이 앱이 조직 데이터를 수집 및 저장하는 방법 및 조직이 수집하는 데이터를 통해 조직이 제공하는 컨트롤에 대해 제공됩니다.
...
| 개인 정보 취급 방침 URL | https://www.unifon.no/personvern/ |
