...
description: imDocShare에 사용할 수 있는 모든 보안 및 규정 준수 정보, 해당 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보
