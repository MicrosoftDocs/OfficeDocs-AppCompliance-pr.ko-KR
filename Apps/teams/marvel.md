...
description: 안전, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보
...
| 파트너 회사 이름 | Marvel |
| 회사의 웹 사이트 | [https://marvelapp.com](https://marvelapp.com) |
| 앱 사용 약관 | [https://marvelapp.com/terms/](https://marvelapp.com/terms/) |
| 앱의 핵심 기능 | 도형 - 모든 사람을 위한 와이어프레임, 디자인 및 프로토타이핑 |
