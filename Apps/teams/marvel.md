...
description: Marvel에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/2e7fb70e-f75d-4e85-997e-90ce89000f43" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA104381801" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Marvel에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | Marvel |
| 회사 웹 사이트 | [https://marvelapp.com](https://marvelapp.com) |
| 앱의 사용 약관 | [https://marvelapp.com/terms/](https://marvelapp.com/terms/) |
| 앱의 핵심 기능 | 마블 - 모두를 위한 와이어프레임, 디자인 및 프로토타입 |
| 회사 본사 위치 | 영국 및 북아일랜드(해당) |
| 앱 정보 페이지 | [https://marvelapp.com](https://marvelapp.com) |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 Marvel에서 제공했습니다.
