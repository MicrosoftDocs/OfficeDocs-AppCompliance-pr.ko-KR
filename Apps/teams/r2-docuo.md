---
title: R2 Docuo의 Docuo에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/18/2021
...
description: Docuo, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용 가능한 모든 보안 및 규정 준수 정보
...
* <a href="https://teams.microsoft.com/l/app/2b4ebe4e-7500-4aa5-be83-3857bb2bff2e" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002937" target="_blank">AppSource의 보기</a>
...
| 파트너 회사 이름 | R2 Docuo |
| 회사의 웹 사이트 | [https://www.r2docuo.com](https://www.r2docuo.com) |
| 앱 사용 약관 | [https://www.r2docuo.com/en/legal-advice](https://www.r2docuo.com/en/legal-advice) |
| 앱의 핵심 기능 | 커넥트 없이 팀과 함께 Teams 효율적인 방식으로 워크플로를 관리합니다. |
| 회사 본사 위치 | 스페인 |
...
이 정보는 R2 Docuo에서 이 앱이 조직 데이터를 수집 및 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직에서 사용할 컨트롤에 대해 제공됩니다.
