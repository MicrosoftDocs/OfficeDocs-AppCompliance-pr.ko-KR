---
title: Grafana Labs의 Grafana OnCall에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/27/2022
...
description: Grafana OnCall에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/ed13a4a6-7d9c-4904-913c-402dbca12d1e" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004307" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Grafana Labs에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | Grafana Labs |
| 회사 웹 사이트 | [https://grafana.com](https://grafana.com) |
| 앱의 사용 약관 | [https://grafana.com/legal/terms/](https://grafana.com/legal/terms/) |
| 앱의 핵심 기능 | 통화 중 관리를 수행하는 가장 쉬운 방법 |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
...
이 정보는 Grafana Labs에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
...
| 개인 정보 취급 방침 URL | https://grafana.com/legal/terms |
| 앱이 법적 영향이나 유사한 영향을 미칠 수 있는 프로파일링을 포함하여 자동화된 의사 결정을 수행하나요? | 예 |
| 개인에게 처리에 이의를 제기할 수 있는 옵션이 제공되었나요? | 아니요 |
