---
title: 인스턴트 소프트웨어의 Self-Service 도우미에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
ms.date: 11/19/2021
ms.topic: article
...
description: CSA STAR 레지스트리의 보안/규정 준수 정보, Self-Service 도우미, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
