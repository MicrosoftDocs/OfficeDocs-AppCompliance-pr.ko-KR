---
title: 인스턴트 소프트웨어로 Self-Service 도우미에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/19/2021
...
description: CSA STAR 레지스트리의 안전 정보, Self-Service 도우미, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
---
# <a name="alloy-self-service-assistant"></a>Alloy 셀프 서비스 도우미

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2021년 7월 17일</p>

* <a href="https://teams.microsoft.com/l/app/da84bd82-1002-4487-be1a-ebec71d9a61a" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003492" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

소프트웨어를 통해 Microsoft에 제공되는 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | Alloy 셀프 서비스 도우미 |
| ID | WA200003492 |
| Office 365 클라이언트 지원 | Microsoft Teams |
| 파트너 회사 이름 | Alloy Software |
| 회사의 웹 사이트 | [https://alloysoftware.com](https://alloysoftware.com) |
| 앱 사용 약관 | [https://www.alloysoftware.com/resources/eula/](https://www.alloysoftware.com/resources/eula/) |
| 앱의 핵심 기능 | 서비스 데스크 티켓을 만들고, 서비스 기술 자료 검색하고, 요청을 승인합니다. |
| 회사 본사 위치 | 미국 of America |
| 앱 정보 페이지 | [https://docs.alloysoftware.com/alloynavigator/2021/docs/int...](https://docs.alloysoftware.com/alloynavigator/2021/docs/integrations/topics/microsoft-teams-bot.htm) |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직이 가진 컨트롤에 대한 소프트웨어를 통해 제공됩니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기반 인프라가 Microsoft 고객 또는 장치와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇입니까? | 사용자 전자 메일 주소, 고객 테넌트 |
| 앱에서 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기반 인프라에 Microsoft 고객 데이터가 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇입니까? | 고객 테넌트 |
...
| 가장 최근 SOC2 인증 날짜 |  2021-11-15 |
| 앱이 SOC(서비스 조직 제어)를 준수하나요? | 예 |
| 가장 최근 SOC3 인증 날짜 |  2021-11-09 |
...
| 개인 정보 취급 방침 URL | https://www.alloysoftware.com/resources/privacy/ |
