...
description: HitHorizons에 대해 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보
...
| 앱의 핵심 기능 | 유럽 및 그 이상에서 75M 이상 기업의 HitHorizons 데이터베이스에 Microsoft Teams |
| 회사 본사 위치 | 슬로바키아 |
| 앱 정보 페이지 | |
