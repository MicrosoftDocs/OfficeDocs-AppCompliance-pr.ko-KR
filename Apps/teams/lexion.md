---
title: Lexion별 어휘에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/20/2021
...
description: Lexion에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/e2b7f512-12eb-4ba7-8705-b512fb3c05ee" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003176" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Lexion에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | Lexion |
| 회사 웹 사이트 | [https://lexion.ai](https://lexion.ai) |
| 앱의 사용 약관 | [https://lexion.ai/terms](https://lexion.ai/terms) |
| 앱의 핵심 기능 | Lexion AI 기반 계약 수명 주기 관리를 위한 Microsoft Teams 봇입니다.  |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://lexion.ai](https://lexion.ai) |
...
이 정보는 Lexion에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
