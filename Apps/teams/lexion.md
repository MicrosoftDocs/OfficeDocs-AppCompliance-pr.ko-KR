...
| 파트너 회사 이름 | Lexion |
| 회사의 웹 사이트 | [https://lexion.ai](https://lexion.ai) |
| 앱 사용 약관 | [https://lexion.ai/terms](https://lexion.ai/terms) |
| 앱의 핵심 기능 | Microsoft Teams 기반 계약 수명 주기 관리를 위한 봇입니다.
 |
| 회사 본사 위치 | 미국 |
