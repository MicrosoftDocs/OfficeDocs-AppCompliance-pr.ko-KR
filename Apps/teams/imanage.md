...
description: cSA STAR 레지스트리의 iManage, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
| 파트너 회사 이름 | iManage |
| 회사의 웹 사이트 | [https://imanage.com](https://imanage.com) |
| 앱 사용 약관 | [https://support.imanage.com/worksite/iManage_Cloud_Services...](https://support.imanage.com/worksite/iManage_Cloud_Services_Agreement.pdf) |
| 앱의 핵심 기능 | iManage에서 콘텐츠를 저장하고 관리하면서 자유롭게 공동 작업을 할 수 있습니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://imanage.com/products/work/](https://imanage.com/products/work/) |
...
| 어떤 SOC 2 인증을 획득했나요? |   |
| 가장 최근 SOC2 인증 날짜 |  2021-04-16 |
| 앱이 SOC(서비스 조직 제어)를 준수하나요? | 예 |
| 가장 최근 SOC3 인증 날짜 |  2021-04-16 |
