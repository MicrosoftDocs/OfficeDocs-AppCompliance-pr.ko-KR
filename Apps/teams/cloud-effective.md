---
title: 클라우드 유효 클라우드에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
ms.date: 07/15/2021
ms.topic: article
...
* <a href="https://teams.microsoft.com/l/app/c976a771-1aa9-4e98-b87d-32f271bd6e7f" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002408" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

클라우드에서 Microsoft에 제공된 정보:
...
| 사용 약관 URL | [https://cloudeffective.com/term-of-use.php](https://cloudeffective.com/term-of-use.php) |
...
이 정보는 클라우드에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 조직이 수집하는 데이터를 통해 조직이 하게 될 컨트롤에 대한 클라우드 유효 정보를 제공합니다.
...
>|:----------------|:------------------------------------------------|:--------------------------------------------------------|:--------------------------------------------------|:--------------------|
>| User.ReadWrite.All | 위임 | 팀 이름과 구성원을 동기화하여 팀 구성원이 클라우드 MS-Teams 팀에 동일한 액세스 권한을 부여할 수 있도록 합니다.  | 사용자 프로필 이름, 제목 및 전자 메일 주소 - 사용자가 클라우드 및 클라우드 유효 둘 다에서 Teams 및 상관 관계가 있습니다.  | [50356ee3-b48b-424b-a7a7-35e53c2ce736](https://docs.microsoft.com/microsoft-365-app-certification/azure/50356ee3-b48b-424b-a7a7-35e53c2ce736) |
...
>수동 링크를 추가하는 기능을 제공하지만 파트너 데이터를 제어하지는 않습니다.
...
이 정보는 이 앱이 인증, 권한 부여, 응용 프로그램 등록 모범 사례 및 기타 ID 조건을 처리하는 방법에 대한 클라우드 유효에서 제공했습니다.
