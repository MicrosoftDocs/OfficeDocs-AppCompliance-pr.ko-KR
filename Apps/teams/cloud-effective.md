---
title: Cloud Effective by Cloud Effective에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Cloud Effective, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/c976a771-1aa9-4e98-b87d-32f271bd6e7f" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002408" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Cloud Effective에서 Microsoft에 제공하는 정보:
...
| 회사 웹 사이트 | [https://CloudEffective.com](https://CloudEffective.com) |
| 앱의 사용 약관 | [https://cloudeffective.com/term-of-use.php](https://cloudeffective.com/term-of-use.php) |
| 앱의 핵심 기능 | 협업을 최적화합니다. 아이디어를 결과로 바꾸는 팀, 목표, 프로젝트 및 작업을 관리합니다! |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://cloudeffective.com/products-pricing](https://cloudeffective.com/products-pricing) |
...
이 정보는 Cloud Effective에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.ReadWrite.All | 위임 | 팀 이름과 구성원을 동기화하여 MS-Teams 팀 구성원이 Cloud Effective에서 해당 팀에 동일한 액세스 권한을 갖도록 합니다.  | [50356ee3-b48b-424b-a7a7-35e53c2ce736](../azure/50356ee3-b48b-424b-a7a7-35e53c2ce736.md) |
