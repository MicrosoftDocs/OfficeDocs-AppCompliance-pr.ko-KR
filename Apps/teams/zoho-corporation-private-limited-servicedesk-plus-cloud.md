...
| 회사의 웹 사이트 | [https://www.manageengine.com/products/service-desk](https://www.manageengine.com/products/service-desk) |
| 앱 사용 약관 | [https://ondemand.manageengine.com/terms.html](https://ondemand.manageengine.com/terms.html) |
| 앱의 핵심 기능 | ServiceDesk Plus는 SaaS IT 지원 센터 관리 소프트웨어입니다. IT 서비스 관리를 위한 기능의 수를 통해 IT 관리자는 조직 내에서 지원 센터 작업을 효과적으로 구성할 수 있습니다. 기본적으로 ServiceDesk Plus(클라우드)는 Azure AD에서 작동합니다. 시작하려면 Azure AD 인스턴스의 계정을 사용하여 ServiceDesk Plus(클라우드)에 등록합니다. |
| 회사 본사 위치 | 미국 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 위임 | 로그인 및 사용자 프로필 읽기 | [127e5be9-da2c-4335-a284-da367379428a](../azure/127e5be9-da2c-4335-a284-da367379428a.md) |
>| offline_access | 위임 | 액세스 권한이 부여된 데이터에 대한 액세스 권한 유지 | [127e5be9-da2c-4335-a284-da367379428a](../azure/127e5be9-da2c-4335-a284-da367379428a.md) |
