---
title: ServiceDesk Plus Cloud by Zoho Corporation Private Limited에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/10/2022
...
description: ServiceDesk Plus Cloud에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://appsource.microsoft.com/product/office/WA200000037" target="_blank">AppSource에서 보기</a>
...
| 회사 웹 사이트 | [https://www.manageengine.com/products/service-desk](https://www.manageengine.com/products/service-desk) |
| 앱의 사용 약관 | [https://ondemand.manageengine.com/terms.html](https://ondemand.manageengine.com/terms.html) |
| 앱의 핵심 기능 | ServiceDesk Plus는 SaaS IT 지원 센터 관리 소프트웨어입니다. IT 서비스 관리를 위한 다양한 기능을 통해 IT 관리자는 조직 내에서 지원 센터 운영을 효과적으로 구성할 수 있습니다. 기본적으로 ServiceDesk Plus(클라우드)는 Azure AD 작동합니다. 시작하려면 Azure AD 인스턴스의 계정을 사용하여 ServiceDesk Plus(클라우드)에 등록합니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://help.sdpondemand.com/servicedeskplus_cloud_for_teams](https://help.sdpondemand.com/servicedeskplus_cloud_for_teams) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 위임 | 로그인 및 사용자 프로필 읽기 | [127e5be9-da2c-4335-a284-da367379428a](/microsoft-365-app-certification/azure/39cb9f28-b9d0-4bf7-a4f4-d9e38508a0db) |
>| offline_access | 위임 | 액세스 권한이 부여된 데이터에 대한 액세스 권한 유지 | [127e5be9-da2c-4335-a284-da367379428a](/microsoft-365-app-certification/azure/39cb9f28-b9d0-4bf7-a4f4-d9e38508a0db) |
