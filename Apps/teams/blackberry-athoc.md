---
title: BlackBerry AtHoc by BlackBerry에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/05/2021
...
description: BlackBerry AtHoc, 해당 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003065" target="_blank">AppSource에서 보기</a>
...
| 회사 웹 사이트 | [https://www.blackberry.com](https://www.blackberry.com) |
| 앱의 사용 약관 | [https://www.athoc.com/pss/terms.html#](https://www.athoc.com/pss/terms.html#) |
| 앱의 핵심 기능 | BlackBerry AtHoc을 Teams 통합하면 이미 인증을&#8217;익숙한 하나의 UI에서 모든 &#8211; 조직 전체에서 원활한 중요한 이벤트 관리를 제공합니다. Teams 벗어나지 않고 BlackBerry AtHoc 통합을 사용하면 응급 및 인시던트 관리자가 한 번의 클릭으로 경고를 게시할 수 &#8226; Teams 내에서 미리 설정된 배포 Teams &#8226; 그룹을 대상으로 &#8226; Teams 내에서 미리 설정된 배포 그룹을 대상으로 지정하여 실시간으로 인시던트 관리 |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://www.blackberry.com/us/en/products/blackberry-athoc](https://www.blackberry.com/us/en/products/blackberry-athoc) |
| 앱을 실행하는 데 사용되는 호스팅 환경 또는 서비스 모델은 무엇인가요? |  |
| 앱에서 사용하는 호스팅 클라우드 공급자는 무엇인가요? | Azure, AWS, SelfHosted |
...
이 정보는 BlackBerry에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Send | 위임 | Microsoft는 보안 주체 이름과 같은 사용자&#8217;기본 세부 정보에 액세스하고 팀으로 경고 카드를 보내기 위해 팀 일반 채널(로그인한 사용자에게 권한이 부여됨)에 연결합니다. | [f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7](../azure/f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7.md) |
>| Group.Read.All | 위임 | Microsoft는 보안 주체 이름과 같은 사용자&#8217;기본 세부 정보에 액세스하고 팀으로 경고 카드를 보내기 위해 팀 일반 채널(로그인한 사용자에게 권한이 부여됨)에 연결합니다. | [f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7](../azure/f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7.md) |
>| User.Read | 위임 | Microsoft는 보안 주체 이름과 같은 사용자&#8217;기본 세부 정보에 액세스하고 팀으로 경고 카드를 보내기 위해 팀 일반 채널(로그인한 사용자에게 권한이 부여됨)에 연결합니다. | [f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7](../azure/f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7.md) |
>| 전자 메일 | 위임 | Microsoft는 보안 주체 이름과 같은 사용자&#8217;기본 세부 정보에 액세스하고 팀으로 경고 카드를 보내기 위해 팀 일반 채널(로그인한 사용자에게 권한이 부여됨)에 연결합니다. | [f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7](../azure/f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7.md) |
>| openid | 위임 | Microsoft는 보안 주체 이름과 같은 사용자&#8217;기본 세부 정보에 액세스하고 팀으로 경고 카드를 보내기 위해 팀 일반 채널(로그인한 사용자에게 권한이 부여됨)에 연결합니다. | [f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7](../azure/f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7.md) |
>| 프로필 | 위임 | Microsoft는 보안 주체 이름과 같은 사용자&#8217;기본 세부 정보에 액세스하고 팀으로 경고 카드를 보내기 위해 팀 일반 채널(로그인한 사용자에게 권한이 부여됨)에 연결합니다. | [f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7](../azure/f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7.md) |
