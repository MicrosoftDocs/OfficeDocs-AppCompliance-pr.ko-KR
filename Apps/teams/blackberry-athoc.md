...
| 회사의 웹 사이트 | [https://www.blackberry.com](https://www.blackberry.com) |
| 앱 사용 약관 | [https://www.athoc.com/pss/terms.html#](https://www.athoc.com/pss/terms.html#) |
| 앱의 핵심 기능 | BlackBerry AtHoc를 Teams 통합하면 이미 인증된 친숙한 UI에서 &#8211; 전체 조직에서 매끄럽게 중요한 이벤트&#8217;있습니다. BlackBerry AtHo &#8226; c를 종료하지 않고도 BlackBerry AtHoc 통합을 통해 긴급 및 인시던트 관리자는 한 번의 클릭으로 경고를 &#8226; Teams &#8226; Collaborate에서 미리 설정한 메일 그룹을 대상으로 지정하여 Teams 인시던트 관리를 할 수 있습니다. Teams |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Send | 위임 | 사용자 계정&#8217;같은 기본 세부 정보에 액세스하고 팀에 경고 카드를 보낼 수 있는 팀 일반 채널(로그인한 사용자가 권한이 부여된)에 연결합니다. | [f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7](https://docs.microsoft.com/microsoft-365-app-certification/azure/f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7) |
>| Group.Read.All | 위임 | 사용자 계정&#8217;같은 기본 세부 정보에 액세스하고 팀에 경고 카드를 보낼 수 있는 팀 일반 채널(로그인한 사용자가 권한이 부여된)에 연결합니다. | [f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7](https://docs.microsoft.com/microsoft-365-app-certification/azure/f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7) |
>| User.Read | 위임 | 사용자 계정&#8217;같은 기본 세부 정보에 액세스하고 팀에 경고 카드를 보낼 수 있는 팀 일반 채널(로그인한 사용자가 권한이 부여된)에 연결합니다. | [f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7](https://docs.microsoft.com/microsoft-365-app-certification/azure/f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7) |
>| 전자 메일 | 위임 | 사용자 계정&#8217;같은 기본 세부 정보에 액세스하고 팀에 경고 카드를 보낼 수 있는 팀 일반 채널(로그인한 사용자가 권한이 부여된)에 연결합니다. | [f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7](https://docs.microsoft.com/microsoft-365-app-certification/azure/f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7) |
>| openid | 위임 | 사용자 계정&#8217;같은 기본 세부 정보에 액세스하고 팀에 경고 카드를 보낼 수 있는 팀 일반 채널(로그인한 사용자가 권한이 부여된)에 연결합니다. | [f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7](https://docs.microsoft.com/microsoft-365-app-certification/azure/f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7) |
>| 프로필 | 위임 | 사용자 계정&#8217;같은 기본 세부 정보에 액세스하고 팀에 경고 카드를 보낼 수 있는 팀 일반 채널(로그인한 사용자가 권한이 부여된)에 연결합니다. | [f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7](https://docs.microsoft.com/microsoft-365-app-certification/azure/f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7) |
