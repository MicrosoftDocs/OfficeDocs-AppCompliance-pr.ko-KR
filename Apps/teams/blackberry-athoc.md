...
| 앱의 핵심 기능 | BlackBerry AtHoc를 Teams 통합하면 이미 인증된 친숙한 UI에서 &#8211; 전체 조직에서 매끄럽게 중요한 이벤트&#8217;있습니다. BlackBerry AtHo &#8226; c 통합을 통해 긴급 및 인시던트 관리자는 한 번의 클릭으로 경고를 게시할 수 있습니다. &#8226; Teams &#8226; Collaborate에서 미리 설정한 메일 그룹을 대상으로 지정하여 Teams 인시던트 관리를 실시간으로 할 수 있습니다. Teams |
| 회사 본사 위치 | 미국 |
...
| 앱에서 어떤 호스팅 클라우드 공급자를 사용하나요? | Azure, AWS, SelfHosted |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Send | 위임 | 사용자 계정&#8217;같은 기본 세부 정보에 액세스하고 팀에 경고 카드를 보낼 수 있는 팀 일반 채널(로그인한 사용자가 권한이 부여된)에 연결합니다. | [f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7](../azure/f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7.md) |
>| Group.Read.All | 위임 | 사용자 계정&#8217;같은 기본 세부 정보에 액세스하고 팀에 경고 카드를 보낼 수 있는 팀 일반 채널(로그인한 사용자가 권한이 부여된)에 연결합니다. | [f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7](../azure/f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7.md) |
>| User.Read | 위임 | 사용자 계정&#8217;같은 기본 세부 정보에 액세스하고 팀에 경고 카드를 보낼 수 있는 팀 일반 채널(로그인한 사용자가 권한이 부여된)에 연결합니다. | [f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7](../azure/f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7.md) |
>| 전자 메일 | 위임 | 사용자 계정&#8217;같은 기본 세부 정보에 액세스하고 팀에 경고 카드를 보낼 수 있는 팀 일반 채널(로그인한 사용자가 권한이 부여된)에 연결합니다. | [f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7](../azure/f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7.md) |
>| openid | 위임 | 사용자 계정&#8217;같은 기본 세부 정보에 액세스하고 팀에 경고 카드를 보낼 수 있는 팀 일반 채널(로그인한 사용자가 권한이 부여된)에 연결합니다. | [f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7](../azure/f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7.md) |
>| 프로필 | 위임 | 사용자 계정&#8217;같은 기본 세부 정보에 액세스하고 팀에 경고 카드를 보낼 수 있는 팀 일반 채널(로그인한 사용자가 권한이 부여된)에 연결합니다. | [f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7](../azure/f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7.md) |
