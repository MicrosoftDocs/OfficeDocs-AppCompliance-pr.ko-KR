---
title: RingCentral, Inc.의 TELUS Business Connect에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/27/2022
...
description: TELUS Business Connect, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
| 회사 웹 사이트 | [https://www.telus.com](https://www.telus.com) |
| 앱의 사용 약관 | [https://www.telus.com/en/bc/business/support/article/busine...](https://www.telus.com/en/bc/business/support/article/business-connect-terms) |
| 앱의 핵심 기능 | 빠른 봇 명령 및 메시징 기능을 사용하여 Telus 비디오 또는 오디오 통화를 시작하고 조인합니다. |
| 회사 본사 위치 | 미국 |
