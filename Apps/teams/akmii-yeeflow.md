---
title: Akmii에 의해 예플로우에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
ms.date: 11/25/2020
ms.topic: article
...
description: Yeeflow에 대한 사용 가능한 모든 보안 및 규정 준수 정보 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보.
...
* <a href="https://teams.microsoft.com/l/app/7c10d6ae-b4ad-4221-b086-8518f5d4a1c4" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000089" target="_blank">앱소스에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Akmii에서 마이크로소프트에 제공하는 정보:
...
| 파트너 회사 이름 | Akmii |
| 파트너 웹사이트의 URL | [https://www.yeeflow.com](https://www.yeeflow.com) |
| Teams 응용 프로그램 정보 페이지의 URL | [www.yeeflow.com](www.yeeflow.com) |
| 개인정보 처리방침의 URL | [https://www.yeeflow.com/privacy](https://www.yeeflow.com/privacy) |
| 이용 약관의 URL | [https://www.yeeflow.com/terms](https://www.yeeflow.com/terms) |
...
이 정보는 Akmii에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터를 통해 조직이 가질 수 있는 제어에 대해 제공했습니다.
...
>|:--------------------------------|:---------------------|:--------------------------|
>| 사용자 친화적인 메시지를 보내고 사용자를 식별합니다. | 사용자 이메일 및 이름 | 사용자 알림을 보내고 사용자 이름 표시 |
...
>응용 프로그램 데이터는 데이터베이스에 저장됩니다. 승인된 운영 관리자만 사무실에서 데이터에 액세스할 수 있습니다(IP 범위제한)
...
<iframe height='1020' title='Microsoft Cloud App Security 정보' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/35741' frameborder='no' style='width: 100%;'></iframe>

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/35741" target="_blank">새 탭에서 보기</a>
...
이 정보는 Akmii에서 이 앱이 인증, 승인, 응용 프로그램 등록 모범 사례 및 기타 ID 기준을 처리하는 방법에 대해 제공했습니다.
