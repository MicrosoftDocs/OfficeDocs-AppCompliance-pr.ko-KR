---
title: Dost용 애플리케이션 정보 - ishield Technologies, Inc.의 포괄 언어 봇
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/13/2022
...
description: Dost - 포괄 언어 봇, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
ms.locfileid: "66547286"
---
# <a name="dost---inclusive-language-bot"></a>Dost - 포괄 언어 봇

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 5월 5일</p>

* <a href="https://teams.microsoft.com/l/app/14a29007-c5ca-4a2d-9228-b0217d8403d7" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004214" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

ishield Technologies, Inc.에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | ishield Technologies, Inc. |
| 회사 웹 사이트 | [https://ishield.ai](https://ishield.ai) |
| 앱의 사용 약관 | [https://ishield.ai/terms-of-service/](https://ishield.ai/terms-of-service/) |
| 앱의 핵심 기능 | Dost의 도움을 받아 팀 내에서 포용적인 업무 공간 메시징, 공동 작업 및 커뮤니케이션을 촉진합니다. Microsoft Teams 작업 영역에 Dost를 추가하면 Dost는 제안 및 교육 자료를 통해 메시징에 포괄 언어를 사용하도록 안내합니다.  Dost는 사용자가 무의식적 편견, 미세 공격 또는 비포괄 언어가 포함된 메시지를 수정하고 보다 포괄적으로 만들기 위한 권장 사항을 포함하는 메시지를 게시할 때 학습 순간을 실시간으로 표시합니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://getdost.com](https://getdost.com) |
...
이 정보는 ishield Technologies, Inc.에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 앱은 Teams 및 채팅 범위에서 MS Teams 메시지를 처리하지만 사용자 메시지 또는 세부 정보는 저장하지 않습니다. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Read.Group | 응용 프로그램 | Teams 범위에서 메시지를 읽어 비 포괄 언어로 사용자에게 피드백을 제공 | [01d607db-287c-4354-943d-f015ac938b90](../azure/01d607db-287c-4354-943d-f015ac938b90.md) |
>| ChatMessage.Read.Chat | 응용 프로그램 | 채팅 범위에서 메시지를 읽고 비 포괄 언어로 사용자에게 피드백을 제공 | [01d607db-287c-4354-943d-f015ac938b90](../azure/01d607db-287c-4354-943d-f015ac938b90.md) |
