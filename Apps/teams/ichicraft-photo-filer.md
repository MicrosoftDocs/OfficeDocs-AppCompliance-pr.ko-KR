---
title: Ichicraft의 사진 파일러에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: Photo Filer, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보
...
ms.locfileid: "64464027"
---
# <a name="photo-filer"></a>Photo Filer

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 2월 25일</p>

* <a href="https://teams.microsoft.com/l/app/28fdbeb3-f306-4d78-a1d8-2c1bef32e6ea" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003881" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Ichicraft에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | Ichicraft |
| 회사의 웹 사이트 | [https://photofiler.ichicraft.com](https://photofiler.ichicraft.com) |
| 앱 사용 약관 | [https://photofiler.ichicraft.com/terms/](https://photofiler.ichicraft.com/terms/) |
| 앱의 핵심 기능 | 사진을 공유하고 보관하는 가장 쉬운 Microsoft Teams. |
| 회사 본사 위치 | 네덜란드(the) |
| 앱 정보 페이지 | [https://photofiler.ichicraft.com](https://photofiler.ichicraft.com) |
...
이 정보는 Ichicraft에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직이 하게 될 컨트롤에 대해 제공했습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Send | 위임 | 사용자가 업로드한 사진에 대한 작은 요약이 있는 채팅 메시지를 만들 수 있습니다. | [e54fe734-bab8-48b2-9ec8-05c2545cc49d](../azure/e54fe734-bab8-48b2-9ec8-05c2545cc49d.md) |
>| Files.ReadWrite.All | 위임 | 문서 라이브러리의 폴더 구조 읽기 및 SharePoint. | [e54fe734-bab8-48b2-9ec8-05c2545cc49d](../azure/e54fe734-bab8-48b2-9ec8-05c2545cc49d.md) |
>| User.Read | 위임 | 사용자 프로필에서 읽습니다. | [e54fe734-bab8-48b2-9ec8-05c2545cc49d](../azure/e54fe734-bab8-48b2-9ec8-05c2545cc49d.md) |
