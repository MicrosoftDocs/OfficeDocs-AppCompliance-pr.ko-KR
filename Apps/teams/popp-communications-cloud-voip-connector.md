---
title: POPP Communications별 POPP Cloud VoIP 커넥터에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/01/2021
...
description: POPP Cloud VoIP Connector, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/b8e57f6b-31cf-468e-9e99-81f0395cb1f9" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003306" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

MICROSOFT에 대한 POPP Communications에서 제공하는 정보:
...
| 회사 웹 사이트 | [https://popp.com](https://popp.com) |
| 앱의 사용 약관 | [https://popp.com/pvnterms/](https://popp.com/pvnterms/) |
| 앱의 핵심 기능 | MaxUC 클라이언트를 사용하여 Microsoft Teams 호출 |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
...
이 정보는 POPP Communications에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직의 제어에 대해 제공되었습니다.
...
| 지원되는 정책 유형 나열 | 인증에 사용되는 MSAL 라이브러리에서 이러한 지원을 자동으로 제공하는 범위까지 조건부 액세스 정책입니다.  |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMember.Read.All | 위임 | 사용자 ID 및 현재 채널의 멤버 이름을 표시합니다. 앱은 이를 사용하여 사용자에게 호출할 채널 멤버 목록을 제공합니다. | [b8e57f6b-31cf-468e-9e99-81f0395cb1f9](../azure/b8e57f6b-31cf-468e-9e99-81f0395cb1f9.md) |
>| Chat.Read | 위임 |  어떤 데이터를 수집하거나 사용합니까? 데이터 수집 또는 사용에 대한 근거를 추가합니다. 사용자 ID 및 현재 채팅의 멤버 이름을 표시합니다. 앱은 이를 사용하여 사용자에게 전화를 걸 채팅 멤버 목록을 제공합니다. | [b8e57f6b-31cf-468e-9e99-81f0395cb1f9](../azure/b8e57f6b-31cf-468e-9e99-81f0395cb1f9.md) |
>| TeamMember.Read.All | 위임 | 사용자 ID 및 현재 팀 구성원의 이름을 표시합니다. 앱은 이를 사용하여 사용자에게 호출할 팀 구성원 목록을 표시합니다. | [b8e57f6b-31cf-468e-9e99-81f0395cb1f9](../azure/b8e57f6b-31cf-468e-9e99-81f0395cb1f9.md) |
>| User.Read.All | 위임 |  어떤 데이터를 수집하거나 사용합니까? 데이터 수집 또는 사용에 대한 근거를 추가합니다. 사용자의 비즈니스 및 휴대폰 번호입니다. 이러한 번호에 대한 전화 통화를 시작할 수 있도록 이 작업이 필요합니다. | [b8e57f6b-31cf-468e-9e99-81f0395cb1f9](../azure/b8e57f6b-31cf-468e-9e99-81f0395cb1f9.md) |
>| openid | 위임 | 사용자를 대신하여 나열된 다른 Graph API 엔드포인트에 액세스할 수 있도록 앱에 권한을 부여하는 사용자에 대한 권한 부여 토큰입니다. | [b8e57f6b-31cf-468e-9e99-81f0395cb1f9](../azure/b8e57f6b-31cf-468e-9e99-81f0395cb1f9.md) |
