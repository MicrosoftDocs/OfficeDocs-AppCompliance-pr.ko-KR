---
title: 바오 르 덕에 의해 스탠드 업 앨리스에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
ms.date: 12/16/2019
ms.topic: article
...
description: Standup Alice에 대한 사용 가능한 모든 보안 및 규정 준수 정보 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보.
...
* <a href="https://teams.microsoft.com/l/app/724b774e-aa53-4d2d-885b-6008c114cb37" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000758" target="_blank">앱소스에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

바오 르 둑에서 마이크로소프트에 제공 하는 정보:
...
| 파트너 웹사이트의 URL | [https://www.standupalice.com](https://www.standupalice.com) |
| 개인정보 처리방침의 URL | [https://www.standupalice.com/privacy](https://www.standupalice.com/privacy) |
| 이용 약관의 URL | [https://www.standupalice.com/terms](https://www.standupalice.com/terms) |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직이 가질 수 있는 제어에 대해 Bao Le Duc에서 제공했습니다.
...
>|:-------------------|:--------------------------|:--------------------------|
>| 구글 클라우드 - 우리는 구글 클라우드에 봇을 호스팅 |  | 해당 없음 |
...
>|:--------------------------------|:---------------------|:--------------------------|
>| 표시 이름을 사용하여 웹 앱및 스탠드업 보고서에 표시하여 의미 있는 표시를 합니다. 우리는 무료 평가판, 지불에 대해 Teams 관리자와 통신 할 수 있습니다. | 이름 및 이메일 주소를 표시합니다. |  |
...
>그것은 구글 클라우드에 저장 하고 우리는 구글 클라우드에 액세스 하기 위한 2FA.
...
<iframe height='1020' title='Microsoft Cloud App Security 정보' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/35837' frameborder='no' style='width: 100%;'></iframe>

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/35837" target="_blank">새 탭에서 보기</a>
