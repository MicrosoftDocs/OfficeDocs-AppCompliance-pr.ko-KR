---
title: Unit4 Business Software의 Wanda 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/15/2022
...
description: Wanda에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/73642721-0f64-4d3a-ab6c-2c1fe053aa80" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004038" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Unit4 Business Software에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | Unit4 Business Software |
| 회사 웹 사이트 | [https://www.unit4.com](https://www.unit4.com) |
| 앱의 사용 약관 | [https://www.unit4.com/terms-and-conditions](https://www.unit4.com/terms-and-conditions) |
| 앱의 핵심 기능 | Wanda를 사용하면 가장 일상적인 ERP 작업을 처리할 수 있습니다. |
| 회사 본사 위치 | 네덜란드 (the) |
| 앱 정보 페이지 | [https://get-wanda-help.u4pp.com](https://get-wanda-help.u4pp.com) |
...
이 정보는 Unit4 Business Software에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직의 제어에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 봇별 Microsoft Teams 사용자 ID |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 봇별 Microsoft Teams 사용자 ID |
...
| 가장 최근 SOC1 인증 날짜 | 2021-11-05 |
| 앱이 서비스 조직 컨트롤(SOC 2)을 준수하나요? | 예 |
| 어떤 SOC 2 인증을 달성했나요? | type2 |
| 가장 최근 SOC2 인증 날짜 | 2021-11-23 |
...
| 개인 정보 취급 방침 URL | https://info.unit4.com/rs/400-HYB-295/images/Unit4-People-Platform-Service-Description-v.1.1-September-2021-%28EN%29-%281%29.pdf |
