...
| 사용 약관 URL | [https://x0pa.com/terms-of-use](https://x0pa.com/terms-of-use) |
...
>현재 파트너 시스템으로 PII 정보가 전송되지는 않습니다. 정기적인 감사 및 시기적용 데이터 지우기가 수행됩니다.
...
이 정보는 X0PA AI 싱가포르에서 이 앱이 인증, 권한 부여, 응용 프로그램 등록 모범 사례 및 기타 ID 조건을 처리하는 방법에 대해 제공했습니다.
