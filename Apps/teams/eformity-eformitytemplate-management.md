---
title: eformity | 애플리케이션 정보 서식별 템플릿 관리
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/11/2022
...
description: eformity | 사용할 수 있는 모든 보안 및 규정 준수 정보 템플릿 관리, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보.
...
ms.locfileid: "64771453"
---
# <a name="eformity--template-management"></a>eformity | 템플릿 관리

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2021년 11월 19일</p>

* <a href="https://teams.microsoft.com/l/app/74843469-2e76-45e6-acdc-b755a4a4adf0" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003519" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Microsoft에 대한 eformity에서 제공하는 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | eformity - 템플릿 관리 |
| ID | WA200003519 |
| 지원되는 Office 365 클라이언트 | Microsoft Teams |
| 파트너 회사 이름 | eformity |
| 회사 웹 사이트 | [https://eformity.nl](https://eformity.nl) |
| 앱의 사용 약관 | [https://eformity.net/policies/terms-of-use](https://eformity.net/policies/terms-of-use) |
| 앱의 핵심 기능 | 중앙에서 관리되는 템플릿을 사용하여 Microsoft Teams 문서 및 프레젠테이션을 만듭니다. |
| 회사 본사 위치 | 네덜란드 (the) |
| 앱 정보 페이지 | |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대한 형식을 통해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 사용자 메일, 사용자 이름, 사용자 이름, 사용자 성 |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 사용자 메일, 사용자 이름, 사용자 이름, 사용자 성 |
...
| 개인 정보 취급 방침 URL | https://eformity.net/policies/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite.All | 위임 | 생성된 템플릿 저장 | [ff50870f-b19b-489c-9766-4bcee4e843eb](../azure/ff50870f-b19b-489c-9766-4bcee4e843eb.md) |
>| User.Read | 위임 | 플랫폼에서 사용자 프로필을 업데이트하기 위한 데이터 수집 | [ff50870f-b19b-489c-9766-4bcee4e843eb](../azure/ff50870f-b19b-489c-9766-4bcee4e843eb.md) |
>| openid | 위임 | 사용자의 로그인 | [ff50870f-b19b-489c-9766-4bcee4e843eb](../azure/ff50870f-b19b-489c-9766-4bcee4e843eb.md) |
>| 프로필 | 위임 | 사용자의 로그인 | [ff50870f-b19b-489c-9766-4bcee4e843eb](../azure/ff50870f-b19b-489c-9766-4bcee4e843eb.md) |
