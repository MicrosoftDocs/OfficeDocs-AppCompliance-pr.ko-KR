...
description: WorkplaceBuddy, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 위임 | 작업 공간에서 WorkplaceBuddy 탭이 작동하도록 Teams  채팅봇을 사용하여 특정 사용자를 대상으로 지정하기 위해 이 데이터를 동기화합니다. | [39073da9-c47c-4da8-b57a-3786461db8f4](../azure/39073da9-c47c-4da8-b57a-3786461db8f4.md) |
>| Group.Read.All | 위임 | 작업 공간에서 WorkplaceBuddy 탭이 작동하도록 Teams  채팅봇을 사용하여 특정 사용자를 대상으로 지정하기 위해 이 데이터를 동기화합니다. | [39073da9-c47c-4da8-b57a-3786461db8f4](../azure/39073da9-c47c-4da8-b57a-3786461db8f4.md) |
