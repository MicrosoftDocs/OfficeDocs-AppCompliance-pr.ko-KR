---
title: WorkplaceBuddy by WorkplaceBuddy에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: WorkplaceBuddy에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/6fef6052-d84d-4071-b679-8b542512a621" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001238" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

WorkplaceBuddy에서 Microsoft에 제공한 정보:
...
| 회사 웹 사이트 | [https://www.workplacebuddy.com](https://www.workplacebuddy.com) |
| 앱의 사용 약관 | [https://www.workplacebuddy.com/terms-of-use.pdf](https://www.workplacebuddy.com/terms-of-use.pdf) |
| 앱의 핵심 기능 | WorkplaceBuddy는 생산성을 높이는 데 도움이 됩니다. |
| 회사 본사 위치 | 네덜란드 (the) |
| 앱 정보 페이지 | [https://www.workplacebuddy.com](https://www.workplacebuddy.com) |
...
이 정보는 WorkplaceBuddy에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 위임 | Teams WorkplaceBuddy 탭이 작동하도록 하고 챗봇을 사용하여 특정 사용자를 대상으로 지정하기 위해 이 데이터를 동기화합니다. | [39073da9-c47c-4da8-b57a-3786461db8f4](../azure/39073da9-c47c-4da8-b57a-3786461db8f4.md) |
>| Group.Read.All | 위임 | Teams WorkplaceBuddy 탭이 작동하도록 하고 챗봇을 사용하여 특정 사용자를 대상으로 지정하기 위해 이 데이터를 동기화합니다. | [39073da9-c47c-4da8-b57a-3786461db8f4](../azure/39073da9-c47c-4da8-b57a-3786461db8f4.md) |
>| User.Read | 위임 | 사용자가 로그인할 수 있도록 이 데이터를 동기화합니다. | [39073da9-c47c-4da8-b57a-3786461db8f4](../azure/39073da9-c47c-4da8-b57a-3786461db8f4.md) |
>| User.ReadBasic.All | 위임 | 사용자가 로그인할 수 있도록 이 데이터를 동기화합니다. | [39073da9-c47c-4da8-b57a-3786461db8f4](../azure/39073da9-c47c-4da8-b57a-3786461db8f4.md) |
