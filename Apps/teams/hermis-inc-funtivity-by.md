---
title: Hermis, Inc.의 Hermis에 의한 재미에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/20/2022
...
description: Funtivity by Hermis, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
---
# <a name="funtivity-by-hermis"></a>에르미스의 재미

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 6월 19일</p>

* <a href="https://teams.microsoft.com/l/app/d75e14a9-9bfd-43b4-8430-7264da3b6995" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004244" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Hermis, Inc.가 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | Hermis, Inc. |
| 회사 웹 사이트 | [https://www.herm.is](https://www.herm.is) |
| 앱의 사용 약관 | [https://www.herm.is/terms](https://www.herm.is/terms) |
| 앱의 핵심 기능 | Hermis의 재미에는 팀 빌드, 컨퍼런스 브레이크 아웃 세션, 문화 행사 등 다양한 행사를 위한 다양한 활동 &amp; 콘텐츠가 있습니다. 매주 12개 이상의 다양한 활동과 세심하게 제작된 새로운 이벤트로 모든 사람이 즐길 수 있는 무언가가&#8217;. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://www.herm.is/integrations/funtivity-msteams](https://www.herm.is/integrations/funtivity-msteams) |
...
이 정보는 Hermis, Inc.에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 고객의 ID, 이름 &amp; 전자 메일은 Hermis에 사용자를 등록하는 데 사용됩니다. |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 사용자 이름 &amp; 전자 메일은 데이터베이스에 저장됩니다. 사용자 전자 메일은 AES-256-CBC를 사용하여 암호화됩니다. |
...
| 개인 정보 취급 방침 URL | https://www.herm.is/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 위임 | 사용자의 프로필 세부 정보를 사용하여 플랫폼에 사용자를 등록합니다. | [d75e14a9-9bfd-43b4-8430-7264da3b6995](../azure/d75e14a9-9bfd-43b4-8430-7264da3b6995.md) |
>| 전자 메일 | 위임 | 사용자의 프로필 세부 정보를 사용하여 플랫폼에 사용자를 등록합니다. | [d75e14a9-9bfd-43b4-8430-7264da3b6995](../azure/d75e14a9-9bfd-43b4-8430-7264da3b6995.md) |
>| openid | 위임 | 사용자의 프로필 세부 정보를 사용하여 플랫폼에 사용자를 등록합니다. | [d75e14a9-9bfd-43b4-8430-7264da3b6995](../azure/d75e14a9-9bfd-43b4-8430-7264da3b6995.md) |
>| 프로필 | 위임 | 사용자의 프로필 세부 정보를 사용하여 플랫폼에 사용자를 등록합니다. | [d75e14a9-9bfd-43b4-8430-7264da3b6995](../azure/d75e14a9-9bfd-43b4-8430-7264da3b6995.md) |
