---
title: Kickle의 Waldo에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/26/2021
...
description: Waldo에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보.
...
* <a href="https://teams.microsoft.com/l/app/1d041f16-ab49-4627-bfda-6b60ad2cab6a" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003139" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Kickle에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | Kickle |
| 회사 웹 사이트 | [https://hellowaldo.app](https://hellowaldo.app) |
| 앱의 사용 약관 | [https://hellowaldo.app/terms-and-conditions](https://hellowaldo.app/terms-and-conditions) |
| 앱의 핵심 기능 | 책상 예약, 주차 예약. 플렉스 사무실과 숙제는 간단했다! |
| 회사 본사 위치 | 프랑스 |
| 앱 정보 페이지 | [https://hellowaldo.app/takeatour/](https://hellowaldo.app/takeatour/) |
...
이 정보는 Kickle에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 제공했습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Chat.ReadBasic | 위임 | 채팅 기록에 따라 Waldo는 동료를 식별합니다. 이 목록은 나중에 일정 보기에서 상태를 표시하는 데 사용됩니다. | [c71a6f53-cf0c-426d-a826-cedae8b073f7](../azure/c71a6f53-cf0c-426d-a826-cedae8b073f7.md) |
>| User.Read | 위임 | 이 권한은 Microsoft Graph Toolkit 구성 요소 사용자가 사용합니다. | [c71a6f53-cf0c-426d-a826-cedae8b073f7](../azure/c71a6f53-cf0c-426d-a826-cedae8b073f7.md) |
>| User.ReadBasic.All | 위임 | 이 권한은 Microsoft Graph Toolkit 구성 요소 사용자가 사용합니다. | [c71a6f53-cf0c-426d-a826-cedae8b073f7](../azure/c71a6f53-cf0c-426d-a826-cedae8b073f7.md) |
>| offline_access | 위임 | 사용자를 대신하여 백그라운드 작업을 수행하는 데 앱에서 사용됨(인증을 위한 토큰 갱신) | [c71a6f53-cf0c-426d-a826-cedae8b073f7](../azure/c71a6f53-cf0c-426d-a826-cedae8b073f7.md) |
>| openid | 위임 | 인증에 필요 | [c71a6f53-cf0c-426d-a826-cedae8b073f7](../azure/c71a6f53-cf0c-426d-a826-cedae8b073f7.md) |
