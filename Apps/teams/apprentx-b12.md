---
title: Apprentx별 B12에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/11/2022
...
description: B12에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
ms.locfileid: "65548894"
---
# <a name="b12"></a>B12

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 4월 4일</p>

* <a href="https://teams.microsoft.com/l/app/a4a2213d-2466-473b-8772-021094c5f013" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004073" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Apprentx에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | Apprentx |
| 회사 웹 사이트 | [https://apprentx.rocks](https://apprentx.rocks) |
| 앱의 사용 약관 | [https://blogue.apprentx.rocks/terms-and-conditions](https://blogue.apprentx.rocks/terms-and-conditions) |
| 앱의 핵심 기능 | B12는 지식 강화와 연습을 결합하여 영향을 최대화합니다. |
| 회사 본사 위치 | 캐나다 |
| 앱 정보 페이지 | [https://apprentx.rocks/en/nos-solutions](https://apprentx.rocks/en/nos-solutions) |
...
이 정보는 Apprentx에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 선택적 SSO 기능에 대한 사용자 이름과 전자 메일이 포함된 ID 토큰을 처리합니다. |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 선택적 일정 동기화 기능에 대한 액세스 토큰을 저장합니다. |
...
| 개인 정보 취급 방침 URL | https://blogue.apprentx.rocks/en/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 위임 | SSO Teams | [228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a](../azure/228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a.md) |
>| 전자 메일 | 위임 | SSO Teams | [228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a](../azure/228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a.md) |
>| offline_access | 위임 | SSO Teams | [228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a](../azure/228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a.md) |
>| openid | 위임 | SSO Teams | [228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a](../azure/228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a.md) |
>| 프로필 | 위임 | SSO Teams | [228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a](../azure/228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a.md) |
>| Calendars.ReadWrite | 위임 | 일정 동기화 | [75932bb9-5e71-449a-b584-b5cc01c2d118](../azure/75932bb9-5e71-449a-b584-b5cc01c2d118.md) |
>| User.Read | 위임 | 일정 동기화 | [75932bb9-5e71-449a-b584-b5cc01c2d118](../azure/75932bb9-5e71-449a-b584-b5cc01c2d118.md) |
