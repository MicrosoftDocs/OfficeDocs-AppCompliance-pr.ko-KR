---
title: Efecte Oyj의 Efecte Service Management에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/16/2022
...
description: Efecte Service Management, 해당 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보
...
* <a href="https://teams.microsoft.com/l/app/1c20b1ea-7f9f-496a-a577-8b1bb1a28228" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003830" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Efecte Oyj가 Microsoft에 제공하는 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | Efecte Service Management |
| ID | WA200003830 |
| Office 365 클라이언트 지원 | Microsoft Teams |
| 파트너 회사 이름 | Efecte Oyj |
| 회사의 웹 사이트 | [https://www.efecte.com](https://www.efecte.com) |
| 앱 사용 약관 | [https://www.efecte.com/terms-of-service](https://www.efecte.com/terms-of-service) |
| 앱의 핵심 기능 | ESM(Efecte Service Management)에서 새 티켓에 대한 알림 수신 |
| 회사 본사 위치 | 핀란드 |
| 앱 정보 페이지 | [https://www.efecte.com/ms-teams-integration](https://www.efecte.com/ms-teams-integration) |
...
이 정보는 Efecte Oyj에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직이 사용할 컨트롤에 대해 제공됩니다.
...
| 개인 정보 취급 방침 URL | https://www.efecte.com/privacy-policy |
