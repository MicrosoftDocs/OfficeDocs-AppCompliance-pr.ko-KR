---
title: Newtech의 NewCOS에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/27/2021
...
description: NewCOS에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/205214d0-e04b-11e9-9332-5b5c97b60069" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001104" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Newtech에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | Newtech |
| 회사 웹 사이트 | [https://newtech.com.ar](https://newtech.com.ar) |
| 앱의 사용 약관 | [https://newtech.com.ar/termsofservice](https://newtech.com.ar/termsofservice) |
| 앱의 핵심 기능 | 지능형 통신 솔루션을 빠르고 쉽고 서비스 모드로 배포합니다. NewCOS 플랫폼을 사용하면 IT의 개입 없이 쉽고 빠르게 설치를 실행, 관리, 모니터링 및 지원할 수 있습니다.  우리는 기술을 채택하는 프로세스가 성공할 수 있도록 당신과 함께 이동합니다. 오늘날의 공동 작업 영역에서 변경 내용을 쉽게 적용할 수 있습니다. Microsoft 365 채택을 통해 조직 내에서 디지털 변환 프로세스를 가속화할 수 있습니다.  |
| 회사 본사 위치 | 아르헨티나 |
...
이 정보는 Newtech에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 제공되었습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| 프로필 | 모두 | 이 데이터는 앱 권한에 대한 인증에 사용됩니다. | [07d4a8e0-3d1d-4f70-bdc2-f46593d7fa0e](../azure/07d4a8e0-3d1d-4f70-bdc2-f46593d7fa0e.md) |
>| openid | 모두 | 사용량 Microsoft Teams 보고 및 거버넌스 | [ea4de024-dd5f-4d3e-a092-3b8de6c64200](../azure/ea4de024-dd5f-4d3e-a092-3b8de6c64200.md) |
