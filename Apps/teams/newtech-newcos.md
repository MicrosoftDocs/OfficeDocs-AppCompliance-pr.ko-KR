...
| 앱의 핵심 기능 | 지능형 통신 솔루션을 빠르고 쉽게 서비스 모드로 배포합니다. NewCOS 플랫폼을 사용하면 IT에 개입하지 않고도 설치를 쉽고 빠르게 실행, 관리, 모니터링 및 지원할 수 있습니다.  기술 채택 프로세스가 성공할 수 있도록 사용자와 함께 진행합니다. 오늘날의 공동 작업 영역의 변경 내용을 쉽게 적응할 수 있습니다. 조직의 채택을 Microsoft 365 조직 내에서 디지털 변환 프로세스를 가속화할 수 있습니다.  |
| 회사 본사 위치 | 아르헨티나 |
| 앱 정보 페이지 | [https://N.A](https://N.A) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| 프로필 | 둘 다 | 이 데이터는 앱 사용 권한에 대한 인증에 사용됩니다. | [07d4a8e0-3d1d-4f70-bdc2-f46593d7fa0e](../azure/07d4a8e0-3d1d-4f70-bdc2-f46593d7fa0e.md) |
>| openid | 둘 다 | Microsoft Teams 보고 및 거버넌스를 위해 사용 현황 관리 | [ea4de024-dd5f-4d3e-a092-3b8de6c64200](../azure/ea4de024-dd5f-4d3e-a092-3b8de6c64200.md) |
