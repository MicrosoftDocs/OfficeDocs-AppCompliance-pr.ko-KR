---
title: isolved에 의해 확인되는 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2022
...
description: CSA STAR 레지스트리의 보안 및 규정 준수 정보, 해당 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/287fab70-2e10-4bc3-9049-8991d7796d81" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004410" target="_blank">AppSource에서 보기</a>
...
| 파트너 회사 이름 | isolved |
| 회사 웹 사이트 | [https://www.isolvedhcm.com](https://www.isolvedhcm.com) |
| 앱의 사용 약관 | [https://www.isolvedhcm.com/legal/agreements/employee-terms-...](https://www.isolvedhcm.com/legal/agreements/employee-terms-and-conditions-for-use) |
| 앱의 핵심 기능 | Microsoft Teams 내에서 사람들이 HR 질문에 대한 답변을 빠르게 얻을 수 있도록 지원 |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://www.isolvedhcm.com/platform/enhancements/conversati...](https://www.isolvedhcm.com/platform/enhancements/conversational-virtual-assistant) |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 자세히 설명합니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | Microsoft Azure 테넌트 ID, Microsoft Azure 사용자 ID  |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | Microsoft Azure 테넌트 ID, Microsoft Azure 사용자 ID  |
...
| 가장 최근 SOC1 인증 날짜 | 2021-08-31 |
| 앱이 서비스 조직 컨트롤(SOC 2)을 준수하나요? | 예 |
| 어떤 SOC 2 인증을 달성했나요? | type1 |
| 가장 최근 SOC2 인증 날짜 | 2022-01-31 |
