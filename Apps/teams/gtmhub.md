...
| 앱의 핵심 기능 | MS 2016을 종료하지 않고도 OKRS를 보고 공유하고 업데이트할 Teams. 확인자 보기, 채널에서 공유 및 주요 결과 업데이트가 더 빨라진 적이 없습니다. 업데이트 환경은 Gtmhub에서처럼 매끄럽게 업데이트할 수 있습니다. Gtmhub 탭에서 모든 확인자 및 작업을 표시하는 허브에 액세스할 수 있습니다.  |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
