...
description: CSA STAR 레지스트리의 다중 승인 프로세스 LTAPP, 해당 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용 가능한 모든 보안 및 규정 준수 정보입니다.
...
| 회사의 웹 사이트 | [https://ltaddins.com](https://ltaddins.com) |
| 앱 사용 약관 | [https://ltaddins.com/terms.html](https://ltaddins.com/terms.html) |
| 앱의 핵심 기능 | 다중 승인 프로세스는 최종 사용자가 요청을 할 수 있는 사용하기 쉬운 응용 프로그램입니다. 앱은 완전히 사용자 지정이 가능하므로 관리자는 조직 사양과 일관성을 유지할 수 있습니다. |
| 회사 본사 위치 | 베트남 |
| 앱 정보 페이지 | |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 위임 | 사용자 정보 &amp; 테넌트 ID | [d2682b2a-2037-4545-94b6-3e7216ecca5f](../azure/d2682b2a-2037-4545-94b6-3e7216ecca5f.md) |
