---
title: BitFractal by BitFractal에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/03/2022
...
description: BitFractal, 해당 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 5월 24일</p>

* <a href="https://teams.microsoft.com/l/app/2908a48e-21b7-48e4-89fc-7f4a433952fa" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004172" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

BitFractal에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | BitFractal |
| 회사 웹 사이트 | [https://www.bitfractal.com](https://www.bitfractal.com) |
| 앱의 사용 약관 | [https://www.bitfractal.com/termsofuse](https://www.bitfractal.com/termsofuse) |
| 앱의 핵심 기능 | BitFractal은 Azure의 AI Cognitive Services를 Teams의 사용자 친화적인 인터페이스에 연결한 다음, 봇, 탭, 메시지 확장 등의 Teams 기능을 활용하여 생산성 및 공동 작업 계층을 추가하여 일상적인 프로세스를 자동화하는 간단하고 효율적인 방법으로 비즈니스 사용자에게 AI를 제공합니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://www.bitfractal.com](https://www.bitfractal.com) |
...
이 정보는 BitFractal에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 사용자 프로필 데이터(DisplayName, Email, ObjectId, TenantId) |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 사용자 프로필 데이터(DisplayName, Email, ObjectId, TenantId) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 위임 | 앱이 사용자와 상호 작용할 수 있도록 기본 사용자 프로필 정보 가져오기 | [6a1d567b-1106-46a0-83bc-ffe9ada78b9b](../azure/6a1d567b-1106-46a0-83bc-ffe9ada78b9b.md) |
>| User.Read | 위임 | 앱이 사용자와 상호 작용할 수 있도록 기본 사용자 프로필 정보 가져오기 | [8f261936-59e1-44b3-8234-a746c5e4eab7](../azure/8f261936-59e1-44b3-8234-a746c5e4eab7.md) |
>| User.Read | 위임 | 앱이 사용자와 상호 작용할 수 있도록 기본 사용자 프로필 정보 가져오기 | [fb5ad138-bf16-44c0-bdc2-2a9c0e6f246f](../azure/fb5ad138-bf16-44c0-bdc2-2a9c0e6f246f.md) |
