---
title: Solutions2Share GmbH의 Teams Manager에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/27/2021
...
description: Teams Manager, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
<p>개발자가 마지막으로 업데이트한 날짜: 2021년 9월 24일</p>

* <a href="https://teams.microsoft.com/l/app/87000000-3db9-bb44-5015-0b4a327a6597" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000764" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Solutions2Share GmbH에서 Microsoft에 제공하는 정보:
...
| 회사 웹 사이트 | [https://teams-manager.com](https://teams-manager.com) |
| 앱의 사용 약관 | [https://www.teams-manager.com/terms-of-use/](https://www.teams-manager.com/terms-of-use/) |
| 앱의 핵심 기능 | 승인 워크플로를 사용하여 복잡하고 사용자 지정 가능한 템플릿을 기반으로 새 Teams 만듭니다. Teams Manager는 기업이 Microsoft Teams 제어하고 거버넌스 기능으로 통제되지 않는 성장을 중지하는 동시에 사용자가 새로운 Teams 만들 수 있도록 지원합니다. |
| 회사 본사 위치 | 독일 |
| 앱 정보 페이지 | [https://teams-manager.com](https://teams-manager.com) |
...
이 정보는 Solutions2Share GmbH에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.ReadWrite.All | 모두 | 템플릿을 매핑하기 위해 TenantID 및 TeamId를 저장합니다.  | [b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7](../azure/b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7.md) |
>| Notes.ReadWrite.All | 응용 프로그램 | 없음 | [b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7](../azure/b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7.md) |
>| User.Read | 위임 | 없음 | [b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7](../azure/b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7.md) |
>| User.Read.All | 모두 | 승인자/관리자 섹션에 입력된 사용자의 ID를 저장합니다. | [b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7](../azure/b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7.md) |
>| User.ReadBasic.All | 위임 | 없음 | [b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7](../azure/b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7.md) |
