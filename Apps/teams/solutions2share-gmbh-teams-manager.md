...
| 응용 프로그램 Teams 페이지의 URL입니다. | [https://teams-manager.com](https://teams-manager.com) |
...
이 정보는 Solutions2Share GmbH에서 이 앱이 인증, 권한 부여, 응용 프로그램 등록 모범 사례 및 기타 ID 조건을 처리하는 방법에 대해 제공했습니다.
