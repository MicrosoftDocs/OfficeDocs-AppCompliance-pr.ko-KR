---
title: 더버의 더버 통합 통화 기록에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
ms.date: 12/09/2021
ms.topic: article
...
description: 더버 통합 통화 기록, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용할 수 있는 모든 보안 및 규정 준수 정보
...
ms.locfileid: "62148795"
---
# <a name="dubber-unified-call-recording"></a>Dubber 통합 통화 녹음/녹화

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2021년 11월 3일</p>

* <a href="https://teams.microsoft.com/l/app/f31b8e05-b927-4874-851e-997264d13151" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003570" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

더버가 Microsoft에 제공하는 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | Dubber 통합 통화 녹음/녹화 |
| ID | WA200003570 |
| Office 365 클라이언트 지원 | Microsoft Teams |
| 파트너 회사 이름 | Dubber |
| 회사의 웹 사이트 | [https://www.dubber.net](https://www.dubber.net) |
| 앱 사용 약관 | [https://www.dubber.net/terms](https://www.dubber.net/terms) |
| 앱의 핵심 기능 | 규정 준수, 판매 서비스 성능을 위한 통합 클라우드 통화 녹음 &amp; 음성 &amp; AI |
| 회사 본사 위치 | 오스트레일리아 |
| 앱 정보 페이지 | |
...
이 정보는 더버에서 이 앱이 조직 데이터를 수집 및 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직에서 제공하는 컨트롤에 대해 제공됩니다.
...
| 데이터베이스에 저장되는 데이터는 무엇입니까? | 고객 이름 및 Microsoft ID, 통화 녹음/모임 데이터 |
