...
| 회사의 웹 사이트 | [https://welllnesscoach.live](https://welllnesscoach.live) |
| 앱 사용 약관 | [https://www.wellnesscoach.live/terms-of-service](https://www.wellnesscoach.live/terms-of-service) |
| 앱의 핵심 기능 | 하루 동안 계속 이동하고 동기를 부여할 수 있는 빠른 정신적 및 물리적 관행  |
| 회사 본사 위치 | 미국 |
...
이 정보는 Meditation.live, Inc.에서 이 앱이 조직 데이터를 수집 및 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직에서 사용할 컨트롤에 대해 제공됩니다.
