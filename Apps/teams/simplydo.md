---
title: SimplyDo by SimplyDo에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/20/2022
...
description: SimplyDo에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/dbf692fe-35c1-4511-9178-9131e6511712" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004248" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

SimplyDo에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | SimplyDo |
| 회사 웹 사이트 | [https://www.simplydo.co.uk](https://www.simplydo.co.uk) |
| 앱의 사용 약관 | [https://www.simplydo.co.uk/terms-of-use](https://www.simplydo.co.uk/terms-of-use) |
| 앱의 핵심 기능 | SimplyDo를 통해 조직은 직원 기반 전체에서 아이디어와 통찰력을 포착하여 지속적인 개선과 혁신을 촉진할 수 있습니다. |
| 회사 본사 위치 | 영국 및 북아일랜드(해당) |
| 앱 정보 페이지 | [https://www.simplydo.co.uk/product](https://www.simplydo.co.uk/product) |
...
이 정보는 SimplyDo에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 사용자 프로필 데이터(이름, 부서, 직함, 전자 메일). |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 사용자 프로필 데이터(이름, 부서, 직함, 전자 메일) |
...
| 개인 정보 취급 방침 URL | https://www.simplydo.co.uk/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 위임 | Single Sign-On에 대한 프로필 데이터에 액세스하려면 | [dbf692fe-35c1-4511-9178-9131e6511712](../azure/dbf692fe-35c1-4511-9178-9131e6511712.md) |
>| 전자 메일 | 위임 | OpenID Connect 기능/로그인을 지원하려면 | [dbf692fe-35c1-4511-9178-9131e6511712](../azure/dbf692fe-35c1-4511-9178-9131e6511712.md) |
>| offline_access | 위임 | OpenID Connect 기능/로그인을 지원하려면 | [dbf692fe-35c1-4511-9178-9131e6511712](../azure/dbf692fe-35c1-4511-9178-9131e6511712.md) |
>| openid | 위임 | OpenID Connect 기능/로그인을 지원하려면 | [dbf692fe-35c1-4511-9178-9131e6511712](../azure/dbf692fe-35c1-4511-9178-9131e6511712.md) |
