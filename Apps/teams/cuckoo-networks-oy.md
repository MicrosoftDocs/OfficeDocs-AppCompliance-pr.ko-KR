---
title: Cuckoo Networks Oy의  Cuckoo에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/22/2022
...
description: CSA STAR 레지스트리의 Cuckoo, 해당 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
ms.locfileid: "66547421"
---
# <a name="cuckoo"></a>Cuckoo

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 6월 20일</p>

* <a href="https://teams.microsoft.com/l/app/71138876-8738-4935-95b6-ae7c2fbe4e54" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002750" target="_blank">AppSource에서 보기</a>
...
| 회사 웹 사이트 | [https://cuckoo.fi](https://cuckoo.fi) |
| 앱의 사용 약관 | [https://cuckoo.fi/terms-of-use/](https://cuckoo.fi/terms-of-use/) |
| 앱의 핵심 기능 | 재미 있고 쉬운, 당신의 에너지와 두뇌를 높일 수있는 게임 마이크로 브레이크 운동. |
| 회사 본사 위치 | 핀란드 |
| 앱 정보 페이지 | [https://cuckoo.fi](https://cuckoo.fi) |
...
이 정보는 Cuckoo Networks Oy에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 사용자 프로필 데이터, 테넌트 ID, 테넌트 이름 |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 사용자 활동 및 사용자 식별 정보 |
...
| 개인 정보 취급 방침 URL | https://cuckoo.fi/en/privacy-policy/ |
...
| 앱에서 위의 라이브러리 중 하나를 사용하지 않는 경우 어떤 인증 라이브러리 또는 라이브러리를 사용하나요? | passport-azure-ad, adal |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 위임 | Microsoft 로그인을 통해 서비스에 대한 사용자 인증 | [71138876-8738-4935-95b6-ae7c2fbe4e54](../azure/71138876-8738-4935-95b6-ae7c2fbe4e54.md) |
>| 전자 메일 | 위임 | 애플리케이션 이벤트, 사용 가능한 대회 및 고객 지원에 대한 정보를 고객에게 문의 | [71138876-8738-4935-95b6-ae7c2fbe4e54](../azure/71138876-8738-4935-95b6-ae7c2fbe4e54.md) |
>| offline_access | 위임 | Microsoft 로그인을 통해 서비스에 대한 사용자 인증 | [71138876-8738-4935-95b6-ae7c2fbe4e54](../azure/71138876-8738-4935-95b6-ae7c2fbe4e54.md) |
>| openid | 위임 | Microsoft 로그인을 통해 서비스에 대한 사용자 인증 | [71138876-8738-4935-95b6-ae7c2fbe4e54](../azure/71138876-8738-4935-95b6-ae7c2fbe4e54.md) |
>| 프로필 | 위임 | Microsoft 로그인을 통해 서비스에 대한 사용자 인증 | [71138876-8738-4935-95b6-ae7c2fbe4e54](../azure/71138876-8738-4935-95b6-ae7c2fbe4e54.md) |
