---
title: Appspace, Inc.의 Appspace에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2021
...
* <a href="https://teams.microsoft.com/l/app/a9a866c4-e5cf-47f2-932c-db14cb89008f" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001738" target="_blank">AppSource에서 보기</a>
...
| 회사 웹 사이트 | [https://www.appspace.com](https://www.appspace.com) |
| 앱의 사용 약관 | [https://www.appspace.com/legal/user-agreement/](https://www.appspace.com/legal/user-agreement/) |
| 앱의 핵심 기능 | Appspace는 어디서나 작업하는 조직 및 효율성으로 비즈니스를 돕는 커뮤니케이션 및 공간 관리 플랫폼입니다. |
| 회사 본사 위치 | 미국 |
...
이 정보는 Appspace, Inc.에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Team.ReadBasic.All | 위임 | 사용자가 속한 팀을 가져옵니다. | [a9a866c4-e5cf-47f2-932c-db14cb89008f](../azure/a9a866c4-e5cf-47f2-932c-db14cb89008f.md) |
>| User.ReadBasic.All | 위임 | 로그인한 사용자를 대신하여 조직의 다른 사용자의 기본 프로필 속성을 읽습니다. 여기에는 표시 이름, 이름과 성, 전자 메일 주소, 확장 프로그램 열기 및 사진이 포함됩니다. 또한 앱에서 로그인한 사용자의 전체 프로필을 읽을 수 있습니다. | [a9a866c4-e5cf-47f2-932c-db14cb89008f](../azure/a9a866c4-e5cf-47f2-932c-db14cb89008f.md) |
