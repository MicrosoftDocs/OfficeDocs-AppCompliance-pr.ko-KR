...
<p>최종 업데이트: 2021년 1월 22일</p>

* <a href="https://teams.microsoft.com/l/app/db8361d3-ad4e-4005-8805-ad59ff4805f3" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000798" target="_blank">앱소스에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

정보 시대 기술에서 Microsoft에 제공하는 정보:
...
| 파트너 웹사이트의 URL | [https://www.iat21.com/listy](https://www.iat21.com/listy) |
| Teams 응용 프로그램 정보 페이지의 URL | [https://www.iat21.com/listy](https://www.iat21.com/listy) |
| 개인정보 처리방침의 URL | [https://www.iat21.com/listy-privacy-policy](https://www.iat21.com/listy-privacy-policy) |
| 이용 약관의 URL | [https://www.iat21.com/listy-terms-of-service](https://www.iat21.com/listy-terms-of-service) |
...
이 정보는 정보 시대 기술에 의해 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직이 가질 수 있는 제어에 대해 제공되었습니다.
...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| 팀 설정.읽기.그룹 | 둘다 | 로컬 앱 계정을 만들기 위해 사용자가 데이터를 수동으로 채울 필요가 없도록 합니다. | 로컬 앱 계정을 만들기 위해 사용자가 데이터를 수동으로 채울 필요가 없도록 합니다. | 8aaa2b64-9a2c-403b-83c1-feaf774c764c |
...
이 정보는 정보 시대 기술에서 이 앱이 인증, 승인, 응용 프로그램 등록 모범 사례 및 기타 ID 기준을 처리하는 방법에 대해 제공했습니다.
