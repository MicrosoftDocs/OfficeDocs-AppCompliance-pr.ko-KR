---
title: Grow360의 Grow360에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/24/2022
...
description: Grow360에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보
...
* <a href="https://teams.microsoft.com/l/app/042d26ab-41cc-4a88-920a-3125ebfd7944" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002324" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Grow360에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | Grow360 |
| 회사의 웹 사이트 | [https://grow360.com](https://grow360.com) |
| 앱 사용 약관 | [https://grow360.com/terms](https://grow360.com/terms) |
| 앱의 핵심 기능 | GROW는 전문가와 팀이 동급 최고의 리더십 개발 솔루션을 통해 더 높은 성능을 달성하는 데 도움이 됩니다. 강력한 팀이 팀 구성원과 조직이 모두에게 선순환적 순환을 만들 수 있는 것으로 생각하고 있습니다. 팀이 정상 상태이면 팀 구성원이 번성합니다. 팀 구성원이 번성할 때 팀은 더 나은 기능을 합니다. |
| 회사 본사 위치 | 싱가포르 |
| 앱 정보 페이지 | [https://grow360.com/about](https://grow360.com/about) |
...
이 정보는 Grow360에서 이 앱이 조직 데이터를 수집 및 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직에서 제공하는 컨트롤에 대해 제공됩니다.
...
| 앱에서 TLS 1.1 이상을 지원하나요? | 아니요 |
| 앱 또는 기반 인프라에 Microsoft 고객 데이터가 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇입니까? | 이름 및 성, 전자 메일 주소 |
...
| 개인 정보 취급 방침 URL | https://grow360.com/privacy |
