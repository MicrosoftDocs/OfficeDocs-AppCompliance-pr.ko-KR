---
title: EnableUC의 Trivia Engine에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/09/2021
...
description: Trivia Engine에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보
...
* <a href="https://teams.microsoft.com/l/app/3bd813fa-a19a-4c06-b130-450b24b8ee08" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003412" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

EnableUC에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | EnableUC |
| 회사의 웹 사이트 | [https://www.triviaengine.com](https://www.triviaengine.com) |
| 앱 사용 약관 | [https://www.triviaengine.com/termsofuse.html](https://www.triviaengine.com/termsofuse.html) |
| 앱의 핵심 기능 | 기존 교육을 향상하고 게임 &#8220;사용하여 지식 보존을&#8221;. |
| 회사 본사 위치 | 캐나다 |
...
이 정보는 EnableUC에서 이 앱이 조직 데이터를 수집 및 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직이 하게 될 컨트롤에 대해 제공됩니다.
