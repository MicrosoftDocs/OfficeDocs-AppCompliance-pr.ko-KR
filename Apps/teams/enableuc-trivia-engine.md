---
title: EnableUC별 퀴즈 엔진에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/09/2021
...
description: Trivia Engine에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/3bd813fa-a19a-4c06-b130-450b24b8ee08" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003412" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

EnableUC에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | EnableUC |
| 회사 웹 사이트 | [https://www.triviaengine.com](https://www.triviaengine.com) |
| 앱의 사용 약관 | [https://www.triviaengine.com/termsofuse.html](https://www.triviaengine.com/termsofuse.html) |
| 앱의 핵심 기능 | &#8220;게임화&#8221; 사용하여 기존 교육을 개선하고 지식 보존을 개선합니다. |
| 회사 본사 위치 | 캐나다 |
| 앱 정보 페이지 | [https://www.triviaengine.com](https://www.triviaengine.com) |
...
이 정보는 EnableUC에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
...
| 앱에서 위의 라이브러리 중 하나를 사용하지 않는 경우 어떤 인증 라이브러리 또는 라이브러리를 사용하나요? | N/A - 최신 버전의 MSAL이 활용됩니다. |
