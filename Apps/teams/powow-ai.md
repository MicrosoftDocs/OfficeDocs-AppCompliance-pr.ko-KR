---
title: Powow AI에서 Powow에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/20/2021
...
description: Powow에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/5e6f557b-3d89-40e6-9d8e-0ccb5c956c22" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002952" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Powow AI에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | Powow AI |
| 회사 웹 사이트 | [https://www.powow.ai](https://www.powow.ai) |
| 앱의 사용 약관 | [https://www.powow.ai/legal/tos.pdf](https://www.powow.ai/legal/tos.pdf) |
| 앱의 핵심 기능 | Powow는 비즈니스 회의에서 AI의 기능을 발휘하는 SaaS 플랫폼입니다. 독점 AI 알고리즘을 사용하여 모임을 전사하고 분석하여 실행 가능한 인사이트를 얻습니다. Powow를 사용하면 조직 직원이 모임 검색, 분석 및 공동 작업을 통해 생산성을 확보하면서 더 적은 수의 모임에 참석할 수 있습니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://powow-ai.zendesk.com/hc/en-us](https://powow-ai.zendesk.com/hc/en-us) |
| 앱을 실행하는 데 사용되는 호스팅 환경 또는 서비스 모델은 무엇인가요? | Paas |
| 앱에서 사용하는 호스팅 클라우드 공급자는 무엇인가요? | Azure, GCP |
...
이 정보는 Powow AI에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 제공했습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 사용자 프로필 데이터, 사용자 전자 메일, 일정 이벤트 |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 사용자 프로필 데이터, 사용자 전자 메일, 일정 이벤트 |
...
| 개인 정보 취급 방침 URL | https://www.sembly.ai/wp-content/uploads/2021/09/privacy.pdf |
...
| 앱에서 위의 라이브러리 중 하나를 사용하지 않는 경우 어떤 인증 라이브러리 또는 라이브러리를 사용하나요? | Microsoft Teams 클라이언트 SDK |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ExternalItem.ReadWrite.All | 응용 프로그램 | 검색 커넥터에 사용됨(Microsoft 서비스 검색을 위해 Powow 데이터를 Microsoft 인덱스로 푸시하는 기능) | [d871e46e-e346-445d-bfe8-2a66419bf278](../azure/d871e46e-e346-445d-bfe8-2a66419bf278.md) |
>| User.Read | 위임 | 등록 및 로그인을 위해 로그인하고 사용자 프로필을 읽습니다. | [d871e46e-e346-445d-bfe8-2a66419bf278](../azure/d871e46e-e346-445d-bfe8-2a66419bf278.md) |
>| User.Read.All | 응용 프로그램 | 검색 커넥터에 사용됨(Microsoft 서비스 검색을 위해 Powow 데이터를 Microsoft 인덱스로 푸시하는 기능) | [d871e46e-e346-445d-bfe8-2a66419bf278](../azure/d871e46e-e346-445d-bfe8-2a66419bf278.md) |
>| 전자 메일 | 위임 | 등록 및 로그인에 대한 사용자의 이메일 주소 보기 | [d871e46e-e346-445d-bfe8-2a66419bf278](../azure/d871e46e-e346-445d-bfe8-2a66419bf278.md) |
>| offline_access | 위임 | 애플리케이션 내에서 사용자의 데이터에 액세스하려면(일정 업데이트 추적) | [d871e46e-e346-445d-bfe8-2a66419bf278](../azure/d871e46e-e346-445d-bfe8-2a66419bf278.md) |
>| openid | 위임 | 사용자 로그인 | [d871e46e-e346-445d-bfe8-2a66419bf278](../azure/d871e46e-e346-445d-bfe8-2a66419bf278.md) |
>| 프로필 | 위임 | 등록을 위해 사용자의 기본 프로필 정보에 액세스하려면 | [d871e46e-e346-445d-bfe8-2a66419bf278](../azure/d871e46e-e346-445d-bfe8-2a66419bf278.md) |
