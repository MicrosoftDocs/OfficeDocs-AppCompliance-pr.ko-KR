...
description: Taskworld, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용할 수 있는 모든 보안 및 규정 준수 정보
...
| 앱의 핵심 기능 | 작업에서 작업 Teams 더 효과적으로 공동 작업할 수 있습니다! |
| 회사 본사 위치 | 싱가포르 |
| 앱 정보 페이지 | |
