---
title: Quadrasystems.net Quadra Visitorz에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/13/2022
...
description: Quadra Visitorz, 해당 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/86458973-657f-4072-8e6a-f1baf684c62f" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004199" target="_blank">AppSource에서 보기</a>
...
| 앱의 핵심 기능 | Visitorz는 직관적이고 사용하기 쉽고 확장 가능한 방문자 관리 솔루션입니다. |
| 회사 본사 위치 | 인도 |
| 앱 정보 페이지 | |
