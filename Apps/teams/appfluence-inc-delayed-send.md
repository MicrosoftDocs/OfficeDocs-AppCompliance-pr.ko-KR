---
title: Appfluence Inc.의 지연 전송에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/27/2022
...
description: 지연된 보내기, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
ms.locfileid: "66247940"
---
# <a name="delayed-send"></a>지연된 보내기

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 6월 21일</p>

* <a href="https://teams.microsoft.com/l/app/ae64c32a-0eab-47d9-91e4-b693a99f7fc3" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004301" target="_blank">AppSource에서 보기</a>
...
| 앱의 사용 약관 | [https://delayedsend.com/eula](https://delayedsend.com/eula) |
| 앱의 핵심 기능 | 나중에 비공개 또는 그룹 채팅으로 메시지를 보내도록 예약합니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://delayedsend.com](https://delayedsend.com) |
...
| 앱에서 처리되는 데이터는 무엇인가요? | 사용자가 메시지를 보낼 위치를 선택할 수 있도록 Teams의 그룹 및 개인 채팅 목록입니다. |
...
| 앱에서 위의 라이브러리 중 하나를 사용하지 않는 경우 어떤 인증 라이브러리 또는 라이브러리를 사용하나요? | next-auth/react |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Chat.ReadBasic | 위임 | 메시지를 보내는 위치를 이해할 수 있도록 채팅에 있는 사용자를 표시합니다. | [93b661be-66e3-4468-b802-64bb952f1471](../azure/93b661be-66e3-4468-b802-64bb952f1471.md) |
>| ChatMessage.Send | 위임 | 사용자를 대신하여 메시지 보내기 | [93b661be-66e3-4468-b802-64bb952f1471](../azure/93b661be-66e3-4468-b802-64bb952f1471.md) |
>| User.Read | 위임 | 사용자 로그인 및 사용자 이름 알아보기 | [93b661be-66e3-4468-b802-64bb952f1471](../azure/93b661be-66e3-4468-b802-64bb952f1471.md) |
>| User.ReadBasic.All | 위임 | 지연된 메시지의 대상을 선택할 수 있도록 허용하려면 사용자의 협력자 목록을 참조하세요. | [93b661be-66e3-4468-b802-64bb952f1471](../azure/93b661be-66e3-4468-b802-64bb952f1471.md) |
>| offline_access | 위임 | 앱이 메시지 배달 일정 시간에 사용자 역할을 하도록 허용 | [93b661be-66e3-4468-b802-64bb952f1471](../azure/93b661be-66e3-4468-b802-64bb952f1471.md) |
