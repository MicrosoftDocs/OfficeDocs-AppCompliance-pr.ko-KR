---
title: Expensya의 Expensya에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/04/2022
...
description: Expensya에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/acbc0cba-5e0a-4bb5-a15c-21bce2863f01" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003924" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Expensya에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | Expensya |
| 회사 웹 사이트 | [https://www.expensya.com](https://www.expensya.com) |
| 앱의 사용 약관 | [https://www.expensya.com/en/tou](https://www.expensya.com/en/tou) |
| 앱의 핵심 기능 | Expensya는 송장 처리에서 회사 카드에 이르는 비즈니스 지출(종단 간)을 자동화합니다. |
| 회사 본사 위치 | 프랑스 |
| 앱 정보 페이지 | |
...
이 정보는 Expensya에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 회사 프로필, 사용자(직원) 프로필 및 비즈니스 지출 항목 |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | Microsoft Graph 토큰(Teams!에 통합됨) |
...
| 개인 정보 취급 방침 URL | https://www.expensya.com/en/legal |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 응용 프로그램 | 사용자 전체 이름 및 전자 메일이 필요합니다. | [6ce7c411-d7c9-4c4f-882e-164447c9b44a](../azure/6ce7c411-d7c9-4c4f-882e-164447c9b44a.md) |
