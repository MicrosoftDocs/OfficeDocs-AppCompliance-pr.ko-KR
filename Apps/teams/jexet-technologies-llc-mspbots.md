---
title: Jexet Technologies LLC의 MSPBots에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
ms.date: 11/23/2021
ms.topic: article
...
description: MSPBots에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보
...
* <a href="https://teams.microsoft.com/l/app/10fcc57c-8d49-4f94-a516-a75de60bc969" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001128" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Jexet Technologies LLC에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | Jexet Technologies LLC |
| 회사의 웹 사이트 | [https://mspbots.ai](https://mspbots.ai) |
| 앱 사용 약관 | [https://mspbots.ai/termsofuse/](https://mspbots.ai/termsofuse/) |
| 앱의 핵심 기능 | 비즈니스 인텔리전스 플랫폼, 사용자 지정 가능한 봇을 사용하여 IT 관리 서비스 공급자 비즈니스의 반복적인 작업을 자동화합니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
...
이 정보는 Jexet Technologies LLC에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터에 대해 조직이 가지는 컨트롤에 대해 제공됩니다.
...
| 개인 정보 취급 방침 URL | https://mspbots.ai/home/data-security/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Send | application | 채널로 메시지 보내기 | [a2af9d71-95f1-4236-be2c-c105ab9b7ee9](https://docs.microsoft.com/microsoft-365-app-certification/azure/a2af9d71-95f1-4236-be2c-c105ab9b7ee9) |
>| ChatMessage.Send | application | 채팅으로 메시지 보내기 | [a2af9d71-95f1-4236-be2c-c105ab9b7ee9](https://docs.microsoft.com/microsoft-365-app-certification/azure/a2af9d71-95f1-4236-be2c-c105ab9b7ee9) |
>| 프로필 | application | 앱 사용자 정보 사용 | [a2af9d71-95f1-4236-be2c-c105ab9b7ee9](https://docs.microsoft.com/microsoft-365-app-certification/azure/a2af9d71-95f1-4236-be2c-c105ab9b7ee9) |
