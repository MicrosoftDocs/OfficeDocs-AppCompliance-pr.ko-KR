---
title: Squadify Holdings Pty Ltd에 의한 스쿼드화 신청 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/05/2022
...
description: Squadify에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
ms.locfileid: "66765170"
---
# <a name="squadify"></a>스쿼드화(Squadify)

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 6월 4일</p>

* <a href="https://teams.microsoft.com/l/app/110107b9-4326-43d8-bf43-bf10fcdce8ad" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004349" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Squadify Holdings Pty Ltd에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | 스쿼드피 홀딩스 Pty Ltd |
| 회사 웹 사이트 | [https://www.squadify.net](https://www.squadify.net) |
| 앱의 사용 약관 | [https://www.squadify.net/mst-terms-of-use](https://www.squadify.net/mst-terms-of-use) |
| 앱의 핵심 기능 | Microsoft Teams용 Squadify를 사용하면 팀 피드백, 대화 및 실행 가능한 인사이트를 수집할 수 있습니다. Microsoft Teams용 Squadify를 사용하면 1번의 클릭으로 스쿼드 만들기를 설정하고 Microsoft Teams의 팀과 일치시킬 수 있습니다. 또한 Squadifys를 시작하고, 진행 상황을 추적하고, 팀 성과에 대한 인사이트를 생성하여 올바른 대화를 만들 수 있습니다. |
| 회사 본사 위치 | 오스트레일리아 |
| 앱 정보 페이지 | [https://www.squadify.net/our-product](https://www.squadify.net/our-product) |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 보유할 제어에 대해 Squadify Holdings Pty Ltd에서 제공했습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 사용자 전체 이름 및 전자 메일 주소 |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 사용자 전체 이름 및 전자 메일 주소 |
| 기본 침입이 Microsoft 고객 데이터를 처리하거나 저장하는 경우 이 데이터는 지리적으로 저장되는 위치는 어디인가요? | 오스트레일리아 |
...
| 개인 정보 취급 방침 URL | https://www.squadify.net/privacy-policy |
