...
description: Wisembly에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/b63d5c73-8c76-4d8b-b0dc-ca35c6e37a90" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001554" target="_blank">AppSource에서 보기</a>
...
| 파트너 회사 이름 | Wisembly |
| 회사 웹 사이트 | [https://wisembly.com](https://wisembly.com) |
| 앱의 사용 약관 | [https://wisembly.com/en/condition-of-sale.html](https://wisembly.com/en/condition-of-sale.html) |
| 앱의 핵심 기능 | 간단하고 매력적인 가상 및 하이브리드 이벤트 세미나, 컨퍼런스, 워크샵 만들기... 사용자 지정 가능한 홈페이지, 등록, 워크샵 및 본회의 구성, 비디오 도구, 대화형 기능 등 원하는 대로 이벤트 프로젝트를 처음부터 끝까지 안내합니다. |
| 회사 본사 위치 | 프랑스 |
| 앱 정보 페이지 | [https://wisembly.com](https://wisembly.com) |
...
이 정보는 Wisembly에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 제공했습니다.
