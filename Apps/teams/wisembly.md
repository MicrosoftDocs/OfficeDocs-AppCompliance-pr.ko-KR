...
| 파트너 회사 이름 | Wisembly |
| 회사의 웹 사이트 | [https://wisembly.com](https://wisembly.com) |
| 앱 사용 약관 | [https://wisembly.com/en/condition-of-sale.html](https://wisembly.com/en/condition-of-sale.html) |
| 앱의 핵심 기능 | 간편하고 매력적인 가상 및 하이브리드 이벤트 만들기 세미나, 회의, 워크숍... Wisembly는 사용자 지정 가능한 홈페이지, 등록, 워크숍 및 회의 세션 구성, 비디오 도구, 대화형 기능 등 필요한 모든 작업을 시작부터 완료까지 안내합니다. |
| 회사 본사 위치 | 프랑스 |
