...
description: CSA STAR 레지스트리의 Geekbot, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
| 회사의 웹 사이트 | [https://geekbot.com](https://geekbot.com) |
| 앱 사용 약관 | [https://geekbot.com/tos/](https://geekbot.com/tos/) |
| 앱의 핵심 기능 | 비동기 독립 실행, 조사 및 설문 조사를 실행하여 표준 시간대에 걸쳐 팀 지식을 공유합니다. |
| 회사 본사 위치 | 키프로스 |
| 앱 정보 페이지 | [https://help.geekbot.com/en/](https://help.geekbot.com/en/) |
...
| 데이터베이스에 저장되는 데이터는 무엇입니까? | 사용자 프로필 데이터, 사용자 메일 데이터, Microsoft Teams 팀 데이터(팀 ID, 채널 데이터), 보고서 |
...
| 개인 정보 취급 방침 URL | https://geekbot.com/privacy/ |
