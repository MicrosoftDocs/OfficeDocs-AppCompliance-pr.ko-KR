---
title: PostBeyond의 PostBeyond에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: PostBeyond에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/6e588f9e-5271-4583-b373-7991497deaec" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002658" target="_blank">AppSource에서 보기</a>
...
| 회사 웹 사이트 | [https://www.postbeyond.com](https://www.postbeyond.com) |
| 앱의 사용 약관 | [https://www.postbeyond.com/terms-of-use/](https://www.postbeyond.com/terms-of-use/) |
| 앱의 핵심 기능 | PostBeyond에서 제공하는 직원 옹호를 통해 브랜드 가시성, 참여도 및 측정 가능한 결과를 높이기 위해 소셜 미디어 옹호자를 활성화합니다. 직원 소셜 네트워크에서 최고의 콘텐츠를 증폭하여 브랜드에 주의를 기울여야 합니다. 우리는 마케터에게 강력하고 직원들을 위해 유쾌하게 쉽게 직원 옹호를 확장할 수 있도록 합니다.  |
| 회사 본사 위치 | 캐나다 |
...
이 정보는 PostBeyond에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
