---
title: Noctilucent BV의 CorporateFitness.app 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/19/2022
...
description: CSA STAR 레지스트리의 CorporateFitness.app, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
ms.locfileid: "65587017"
---
# <a name="corporatefitnessapp"></a>CorporateFitness.app

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 5월 17일</p>

* <a href="https://teams.microsoft.com/l/app/3b51162a-9157-40b8-91b5-0f29efeaf1ec" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004093" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Noctilucent BV에서 Microsoft에 제공한 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | CorporateFitness.app |
| ID | WA200004093 |
| 지원되는 Office 365 클라이언트 | Microsoft Teams |
| 파트너 회사 이름 | Noctilucent BV |
| 회사 웹 사이트 | [https://corporatefitness.app](https://corporatefitness.app) |
| 앱의 사용 약관 | [https://corporatefitness.app/termsofservice](https://corporatefitness.app/termsofservice) |
| 앱의 핵심 기능 | 팀에 도전하세요! 웰빙을 높이기 위한 단계 및 피트니스 과제. 10개 이상의 앱 및 감시 통합 |
| 회사 본사 위치 | 네덜란드 (the) |
| 앱 정보 페이지 | [https://corporatefitness.app/microsoft-teams](https://corporatefitness.app/microsoft-teams) |
...
이 정보는 Noctilucent BV에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 프로필 데이터 사용 |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 직원 정보 |
...
| 개인 정보 취급 방침 URL | https://corporatefitness.app/privacypolicy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 위임 | 사용자 프로필 데이터 가져오기 | [5d1cde38-6b6f-4a7c-ab8a-12bb0d449c1d](../azure/5d1cde38-6b6f-4a7c-ab8a-12bb0d449c1d.md) |
>| 전자 메일 | 위임 | 사용자 전자 메일 가져오기 | [5d1cde38-6b6f-4a7c-ab8a-12bb0d449c1d](../azure/5d1cde38-6b6f-4a7c-ab8a-12bb0d449c1d.md) |
>| offline_access | 위임 | 사용자 프로필 데이터 가져오기 | [5d1cde38-6b6f-4a7c-ab8a-12bb0d449c1d](../azure/5d1cde38-6b6f-4a7c-ab8a-12bb0d449c1d.md) |
>| openid | 위임 | 사용자 프로필 데이터 가져오기 | [5d1cde38-6b6f-4a7c-ab8a-12bb0d449c1d](../azure/5d1cde38-6b6f-4a7c-ab8a-12bb0d449c1d.md) |
>| 프로필 | 위임 | 사용자 프로필 데이터 가져오기 | [5d1cde38-6b6f-4a7c-ab8a-12bb0d449c1d](../azure/5d1cde38-6b6f-4a7c-ab8a-12bb0d449c1d.md) |
