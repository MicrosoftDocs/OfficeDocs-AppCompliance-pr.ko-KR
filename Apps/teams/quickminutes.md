---
title: QuickMinutes별 QuickMinutes에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/18/2022
...
description: QuickMinutes, 해당 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
ms.locfileid: "66852716"
---
# <a name="quickminutes"></a>QuickMinutes

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 6월 9일</p>

* <a href="https://teams.microsoft.com/l/app/5f60fe53-d441-4320-8c26-13fdaee9b58a" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004414" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

QuickMinutes에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | QuickMinutes |
| 회사 웹 사이트 | [https://quickminutes.com](https://quickminutes.com) |
| 앱의 사용 약관 | [https://quickminutes.com/privacy#/terms_of_service](https://quickminutes.com/privacy#/terms_of_service) |
| 앱의 핵심 기능 | 스마트 디지털 도우미를 사용하여 모임 온라인 워크플로를 간소화합니다. |
| 회사 본사 위치 | 아일랜드 |
| 앱 정보 페이지 | [https://support.quickminutes.com/portal/en-gb/kb/articles/m...](https://support.quickminutes.com/portal/en-gb/kb/articles/microsoft-teams-integration-22-4-2020-1) |
...
이 정보는 QuickMinutes에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 사용자가 Microsoft SSO를 사용하여 QuickMinutes에 새 계정을 등록할 때 사용자 프로필 데이터를 사용하여 QuickMinutes DB의 사용자 정보를 채웁니다. QuickMinutes는 사용자 일정 데이터를 끌어와 QuickMinutes UI에 이벤트를 표시합니다. 이 정보는 QuickMinutes DB에 저장하지 않고 Graph API 정보를 검색하여 사용자에게 표시하기만 하면 됩니다.  |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 사용자 프로필 정보(예: 이름, 성, Email 및 프로필 사진). 또한 사용자에게 MS 액세스 및 새로 고침 토큰을 저장합니다. |
...
| 개인 정보 취급 방침 URL | https://quickminutes.com/privacy#/privacy_policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | 위임 | 일정 범위는 QuickMinutes에서 QuickMinutes 모임을 읽고 Microsoft 일정에 쓰는 데 사용됩니다. | [e340e520-b8f4-4752-8e1c-60270c863b12](../azure/e340e520-b8f4-4752-8e1c-60270c863b12.md) |
>| People.Read | 위임 | 사용자 범위는 QuickMinutes에서 QuickMinutes 조직 또는 그룹에 사용자를 추가할 때 Microsoft 사용자 연락처를 나열하는 데 사용됩니다. | [e340e520-b8f4-4752-8e1c-60270c863b12](../azure/e340e520-b8f4-4752-8e1c-60270c863b12.md) |
>| 전자 메일 | 위임 | 전자 메일 범위는 QuickMinutes가 전자 메일 클레임 형식으로 사용자의 기본 전자 메일 주소에 액세스할 수 있도록 하는 데 사용됩니다. | [e340e520-b8f4-4752-8e1c-60270c863b12](../azure/e340e520-b8f4-4752-8e1c-60270c863b12.md) |
>| openid | 위임 | openid 범위는 Microsoft ID 플랫폼 토큰 엔드포인트의 QuickMinutes에서 ID 토큰을 획득하는 데 사용됩니다. 이렇게 하면 QuickMinutes에서 토큰을 사용하여 사용자를 대신하여 Graph API 액세스할 수 있습니다. | [e340e520-b8f4-4752-8e1c-60270c863b12](../azure/e340e520-b8f4-4752-8e1c-60270c863b12.md) |
>| 프로필 | 위임 | 프로필 범위는 QuickMinutes에서 Microsoft SSO를 통해 등록하고 QuickMinutes 계정을 만들 때 사용자 프로필에 액세스하는 데 사용됩니다. | [e340e520-b8f4-4752-8e1c-60270c863b12](../azure/e340e520-b8f4-4752-8e1c-60270c863b12.md) |
