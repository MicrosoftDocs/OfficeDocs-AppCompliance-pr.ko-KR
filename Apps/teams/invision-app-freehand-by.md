---
title: InVision 앱에 의해 인비전에 의해 프리핸드에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
ms.date: 05/06/2021
ms.topic: article
...
description: InVision에 의해 Freehand에 대한 사용 가능한 모든 보안 및 규정 준수 정보 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보, CSA STAR 레지스트리의 보안/규정 준수 정보.
...
<p>최종 업데이트: 2021년 5월 6일</p>

* <a href="https://teams.microsoft.com/l/app/67cf2c5a-db0e-4256-a423-14010cbeafdd" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA104381362" target="_blank">앱소스에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Microsoft에 InVision 앱에서 제공하는 정보:
...
| 파트너 웹사이트의 URL | [https://www.invisionapp.com/](https://www.invisionapp.com/) |
| Teams 응용 프로그램 정보 페이지의 URL | [https://www.invisionapp.com/freehand](https://www.invisionapp.com/freehand) |
| 개인정보 처리방침의 URL | [https://www.invisionapp.com/privacy](https://www.invisionapp.com/privacy) |
| 이용 약관의 URL | [https://www.invisionapp.com/terms](https://www.invisionapp.com/terms) |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터를 통해 조직이 가질 수 있는 제어에 대해 InVision 앱에서 제공했습니다.
...
>시스템 및 응용 프로그램의 로그는 중앙 집중식 로그 관리 시스템과 SIEM 모두에 수집되며 데이터를 수정하거나 삭제하는 데 매우 제한된 액세스가 있습니다. SIEM은 또한 호스트 침입, 무결성, 네트워크 평판을 모니터링하고 이 정보를 클라우드트레일 이벤트와 상호 연관시지정합니다. 이 시스템은 전담 보안 팀에서 모니터링되며 24/7 온콜 엔지니어를 페이지로 페이지로 경고가 구성됩니다. 두 시스템의 로그는 1년 동안 유지됩니다.

#### <a name="organizational-controls-for-data-stored-by-partner"></a>파트너가 저장한 데이터에 대한 조직 제어

조직의 관리자가 파트너 시스템에서 자신의 정보를 제어하는 방법을 설명해 보세요. 예를 들어 삭제, 보존, 감사, 보관, 최종 사용자 정책 등

>제3자 위험 평가는 개인 정보를 처리하는 공급업체에서 수행됩니다. &#8221; &#8220;감사권과 실사가 중요도/위험 요소에 따라 매년 재발생하는 &#8220;포함하도록 계약조항이 추가되었습니다. 법률은 해당되는 경우 계약상 추가될 데이터 보호 부록과 InVision 요구 사항을 충족하는 허용 가능한 표준을 구현했습니다. 하위 프로세서는 암호화되지 않은 형식으로 고객 프로젝트 데이터에 액세스할 수 없습니다.
...
<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/20788" target="_blank">새 탭에서 보기</a>
...
이 정보는 이 앱이 인증, 권한 부여, 응용 프로그램 등록 모범 사례 및 기타 ID 기준을 처리하는 방법에 대해 InVision 앱에서 제공했습니다.
