---
title: 유형 IT 멕시코의 ACV에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/16/2022
...
description: ACV, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/0a3b1cc0-1cda-4373-90b9-7740e604c5e3" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004237" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

유형 IT 멕시코에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | Tangible IT Mexico |
| 회사 웹 사이트 | [https://www.tangibleit.com](https://www.tangibleit.com) |
| 앱의 사용 약관 | [https://www.acv.app/terms](https://www.acv.app/terms) |
| 앱의 핵심 기능 | 출석 제어를 관리하고, 대시보드를 통해 경영진의 가시성을 제공하고, 화이트보드를 사용하여 교육 환경을 용이하게 합니다. 학교를 미러링하는 솔루션의 모든 항목입니다. |
| 회사 본사 위치 | 멕시코 |
| 앱 정보 페이지 | [https://www.acv.app](https://www.acv.app) |
...
이 정보는 유형 IT 멕시코가 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 제공했습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 사용자 프로필 데이터, 인증을 위한 사용자 전자 메일 데이터입니다. |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 사용자 이름, 사용자 전자 메일, 사용자 역할, 학교 전화, 학교 주소, 학교 이름, 과목, 수업, 수업. |
...
| 개인 정보 취급 방침 URL | https://www.acv.app/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Send | 둘 다 | 화이트보드 공동 작업(기능) 링크를 채널에 게시하려면 | [317696ddd-0e3b-4117-9694-ca65942c02f3](../azure/317696dd-0e3b-4117-9694-ca65942c02f3.md) |
>| Group.ReadWrite.All | 둘 다 | 화이트보드 공동 작업(기능) 링크를 채널에 게시하려면 | [317696ddd-0e3b-4117-9694-ca65942c02f3](../azure/317696dd-0e3b-4117-9694-ca65942c02f3.md) |
>| User.Read | 둘 다 | 인증 프로세스가 수행되고 그룹에 속한 학생의 프로필에서 데이터를 가져옵니다. | [317696ddd-0e3b-4117-9694-ca65942c02f3](../azure/317696dd-0e3b-4117-9694-ca65942c02f3.md) |
>| 전자 메일 | 둘 다 | 인증 프로세스가 수행되고 그룹에 속한 학생의 프로필에서 데이터를 가져옵니다. | [317696ddd-0e3b-4117-9694-ca65942c02f3](../azure/317696dd-0e3b-4117-9694-ca65942c02f3.md) |
>| openid | 둘 다 | 인증 프로세스가 수행되고 그룹에 속한 학생의 프로필에서 데이터를 가져옵니다. | [317696ddd-0e3b-4117-9694-ca65942c02f3](../azure/317696dd-0e3b-4117-9694-ca65942c02f3.md) |
>| 프로필 | 둘 다 | 인증 프로세스가 수행되고 그룹에 속한 학생의 프로필에서 데이터를 가져옵니다. | [317696ddd-0e3b-4117-9694-ca65942c02f3](../azure/317696dd-0e3b-4117-9694-ca65942c02f3.md) |
