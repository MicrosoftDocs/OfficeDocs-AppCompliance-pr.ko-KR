---
title: Recruitday Inc.의 직원 추천에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/18/2021
...
description: 직원 추천에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/c179cdf6-f93d-4aa3-9e2d-e934e5a81846" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002708" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Recruitday Inc.가 Microsoft에 제공한 정보:
...
| 회사 웹 사이트 | [https://www.recruitday.com](https://www.recruitday.com) |
| 앱의 사용 약관 | [https://www.recruitday.com/terms-of-use](https://www.recruitday.com/terms-of-use) |
| 앱의 핵심 기능 | 친구를 참조하여 회사에서 작업을 열고 Microsoft Teams 사용하여 보상을 추적합니다. |
| 회사 본사 위치 | 필리핀(해당) |
| 앱 정보 페이지 | [https://employer.recruitday.com/solutions/employee-referral...](https://employer.recruitday.com/solutions/employee-referrals/microsoft-teams) |
...
이 정보는 Recruitday Inc.에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 제공되었습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 모두 | 이름 및 성(앱 사용자, 즉 직원)은 주로 HR 사용자가 추천 애플리케이션 추적 및 보상 지급을 위해 후보를 추천한 직원을 쉽게 식별하는 데 사용됩니다. 또한 시스템에서 생성된 전자 메일 알림을 보낼 때 직원을 올바르게 처리하는 데 사용됩니다. | [7414b436-87d1-4904-9d52-ff47885b89f1](../azure/7414b436-87d1-4904-9d52-ff47885b89f1.md) |
