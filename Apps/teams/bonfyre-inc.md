---
title: Bonfyre, Inc.의 Bonfyre에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/07/2022
...
description: Bonfyre에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/829fa155-8058-4b1e-b43a-86efb74da5d4" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004185" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Bonfyre, Inc.에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | Bonfyre, Inc |
| 회사 웹 사이트 | [https://bonfyreapp.com](https://bonfyreapp.com) |
| 앱의 사용 약관 | [https://bonfyreapp.com/terms-of-use-teams](https://bonfyreapp.com/terms-of-use-teams) |
| 앱의 핵심 기능 | 직원들이 매일 사용하는 업무 채널에 Bonfyre 참여 기능의 기능을 제공합니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://bonfyreapp.com/blog/bonfyre-now-integrates-with-mic...](https://bonfyreapp.com/blog/bonfyre-now-integrates-with-microsoft-teams) |
...
이 정보는 Bonfyre, Inc.에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 사용자가 제출한 콘텐츠 및 사용자 프로필 데이터입니다. |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 사용자 이름, 전자 메일 주소 및 프로필 사진.  이 정보는 고객 온보딩 중에 미리 공유될 수 있지만 사용자 프로필과 동기화하여 정보를 최신 상태로 유지합니다. |
...
| 개인 정보 취급 방침 URL | https://bonfyreapp.com/privacy-policy-teams |
