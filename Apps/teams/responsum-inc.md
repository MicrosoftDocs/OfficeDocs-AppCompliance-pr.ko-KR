---
title: Responsum Inc.의 Responsum에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
ms.date: 02/07/2022
ms.topic: article
...
description: Responsum, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보
...
* <a href="https://teams.microsoft.com/l/app/652dd9a4-1b9f-49a7-ac6f-dbfbc993f825" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003743" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Responsum Inc.에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | Responsum Inc. |
| 회사의 웹 사이트 | [https://www.responsum.ai](https://www.responsum.ai) |
| 앱 사용 약관 | [https://www.responsum.ai/terms-of-service](https://www.responsum.ai/terms-of-service) |
| 앱의 핵심 기능 | AI 판매 도우미를 사용하여 영업 도구 전체의 정보를 업데이트하고 팀의 지식에서 배워야 합니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
...
이 정보는 Responsum Inc.에서 제공합니다. 이 앱에서 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터에 대해 조직에서 제어할 수 있습니다.
