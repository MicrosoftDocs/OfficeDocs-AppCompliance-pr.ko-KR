---
title: Responsum Inc.의 Responsum에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/07/2022
...
description: Responsum에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/652dd9a4-1b9f-49a7-ac6f-dbfbc993f825" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003743" target="_blank">AppSource에서 보기</a>
...
| 회사 웹 사이트 | [https://www.responsum.ai](https://www.responsum.ai) |
| 앱의 사용 약관 | [https://www.responsum.ai/terms-of-service](https://www.responsum.ai/terms-of-service) |
| 앱의 핵심 기능 | 영업 도구 전반에서 정보를 업데이트하고 팀에 대한 지식을 통해 배울 수 있는 AI 영업 도우미입니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
...
이 정보는 Responsum Inc.에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 사용자 일정 이벤트 |
