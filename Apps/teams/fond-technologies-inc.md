---
title: Fond 기술, Inc.의 Fond에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/04/2022
...
description: Fond에 대해 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보
...
ms.locfileid: "63538156"
---
# <a name="fond"></a>Fond

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2021년 12월 17일</p>

* <a href="https://teams.microsoft.com/l/app/d25d7cc9-0a7e-41e2-ad98-f446141a8ffa" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003631" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Fond Technologies, Inc.에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | Fond Technologies, Inc. |
| 회사의 웹 사이트 | [https://fond.co](https://fond.co) |
| 앱 사용 약관 | [https://www.fond.co/tos/](https://www.fond.co/tos/) |
| 앱의 핵심 기능 | Fond를 통해 동료의 업적 축하 |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://fond.co/products/features/fond-teams-integration/](https://fond.co/products/features/fond-teams-integration/) |
...
이 정보는 Fond Technologies, Inc.에서 이 앱이 조직 데이터를 수집 및 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직이 제어할 수 있는 컨트롤에 의해 제공됩니다.
...
| 데이터베이스에 저장되는 데이터는 무엇입니까? | 고객 테넌트 ID, 팀 이름, 채널 이름, Webhook URL |
...
| 개인 정보 취급 방침 URL | https://www.fond.co/privacy/ |
