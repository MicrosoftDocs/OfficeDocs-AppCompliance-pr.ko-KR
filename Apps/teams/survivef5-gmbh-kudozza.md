---
title: surviveF5 GmbH의 Kudozza에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/03/2022
...
description: Kudozza에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/61a58a9f-3474-4d14-bda6-6547194a7381" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002599" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

surviveF5 GmbH에서 Microsoft에 제공하는 정보:
...
| 회사 웹 사이트 | [https://surviveF5.com](https://surviveF5.com) |
| 앱의 사용 약관 | [https://kudozza.com/terms](https://kudozza.com/terms) |
| 앱의 핵심 기능 | Kudozza를 사용하면 다른 팀원에게 Kudos에게 감사를 표할 수 있습니다. 그것은 이모티콘 참여와 같은 다양한 도구를 제공합니다, 카테고리 또는 순위는 Kudos의 제공 동기를 부여하기 위해. |
| 회사 본사 위치 | 독일 |
| 앱 정보 페이지 | [https://kudozza.com](https://kudozza.com) |
...
이 정보는 surviveF5 GmbH에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 사용자 프로필 데이터, 메시지 데이터(봇에 주소 지정) |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | userid, teamid, teamname, username, tenantid, messageid, messagetext |
...
| 개인 정보 취급 방침 URL | https://www.kudozza.com/privacy/ |
...
| 앱에서 위의 라이브러리 중 하나를 사용하지 않는 경우 어떤 인증 라이브러리 또는 라이브러리를 사용하나요? | MSAL이지만 Teams 최신 버전으로 업그레이드해야 합니다. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | 위임 | 팀 채널을 읽어 사용자에게 kudos를 게시하려는 채널을 선택할 수 있는 가능성을 제공합니다. | [69e59100-2fb7-4f6e-a311-987f52b3007b](../azure/69e59100-2fb7-4f6e-a311-987f52b3007b.md) |
>| Teams. ReadBasic.All | 위임 | 사용자는 명예를 게시하려는 팀과 채널을 선택할 수 있습니다. 팀 읽기 권한은 팀을 읽는 데 필요합니다. | [69e59100-2fb7-4f6e-a311-987f52b3007b](../azure/69e59100-2fb7-4f6e-a311-987f52b3007b.md) |
>| User.Read | 위임 | 사용자가 속한 팀 가져오기 | [69e59100-2fb7-4f6e-a311-987f52b3007b](../azure/69e59100-2fb7-4f6e-a311-987f52b3007b.md) |
>| User.ReadBasic.All | 위임 | 사용자 이름 읽기 | [69e59100-2fb7-4f6e-a311-987f52b3007b](../azure/69e59100-2fb7-4f6e-a311-987f52b3007b.md) |
