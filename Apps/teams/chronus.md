---
title: Chronus의 Chronus에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/10/2021
...
description: Chronus에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/bb32d4e5-ae29-4c59-ba7e-a11611ca9710" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003051" target="_blank">AppSource에서 보기</a>
...
| 파트너 회사 이름 | Chronus |
| 회사 웹 사이트 | [https://chronus.com](https://chronus.com) |
| 앱의 사용 약관 | [https://chronus.com/service-terms-conditions](https://chronus.com/service-terms-conditions) |
| 앱의 핵심 기능 | Chronus 소프트웨어는 세계&#8217;최대 규모의 조직에서 수천 개의 성공적인 멘토링 프로그램을 지원합니다. 멘토링 영향을 쉽게 시작, 관리 및 측정할 수 있습니다.  |
| 회사 본사 위치 | 미국 |
...
이 정보는 Chronus에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 제공되었습니다.
