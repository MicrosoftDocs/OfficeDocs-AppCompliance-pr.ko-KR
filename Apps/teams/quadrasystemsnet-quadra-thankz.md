...
description: CSA STAR 레지스트리의 Quadra Thankz, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/a013c4a4-0683-4125-8c05-4004c2c3cc6f" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003671" target="_blank">AppSource의 보기</a>
...
| 회사의 웹 사이트 | [https://www.quadrasystems.net](https://www.quadrasystems.net) |
| 앱 사용 약관 | [https://www.quadrasystems.net/tou](https://www.quadrasystems.net/tou) |
| 앱의 핵심 기능 | 감사의 핵심은 더 좋은 회사를 구축하는 데 핵심입니다. 익숙한 Microsoft Teams 인터페이스를 사용하여 매일 함께 작업하는 사용자와 연결하는 새로운 방법입니다.  감사합니다는 사람들이 재미있는 방식으로 서로를 인식하는 데 도움이 되는 도구입니다.&#160; 순위표, 예산 관리 및 컨트롤과 같은 기능을 가능하게 하는 풍부한 최종 사용자 및 엔터프라이즈 기능을 제공합니다. 감사는 직원들이 연결되고 감사하고 보상을 받는 데 도움이 됩니다. |
| 회사 본사 위치 | 인도 |
...
이 정보는 Quadrasystems.net 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터를 통해 조직이 제어할 수 있는 컨트롤에 대한 정보를 제공합니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read.All | application | 사용자의 관리자 정보를 얻은 경우  | [5d8eb1a9-2188-4292-86f6-f4964d49e8b3](../azure/5d8eb1a9-2188-4292-86f6-f4964d49e8b3.md) |
