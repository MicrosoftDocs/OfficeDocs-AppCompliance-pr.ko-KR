---
title: Quadrasystems.net 쿼드라 감사에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/19/2022
...
description: Quadra Thankz, 해당 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
ms.locfileid: "64880605"
---
# <a name="quadra-thankz"></a>Quadra Thankz

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 1월 19일</p>

* <a href="https://teams.microsoft.com/l/app/a013c4a4-0683-4125-8c05-4004c2c3cc6f" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003671" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

microsoft에 Quadrasystems.net 제공한 정보:
...
| 파트너 회사 이름 | Quadrasystems.net |
| 회사 웹 사이트 | [https://www.quadrasystems.net](https://www.quadrasystems.net) |
| 앱의 사용 약관 | [https://www.quadrasystems.net/tou](https://www.quadrasystems.net/tou) |
| 앱의 핵심 기능 | 감사는 더 행복한 회사를 구축하는 열쇠입니다. 친숙한 Microsoft Teams 인터페이스를 기반으로 하는 이 인터페이스는 매일 함께 일하는 사람들과 연결하는 새로운 방법입니다.  Thankz는 사람들이 재미있는 방식으로 서로를 인식할 수 있도록 도와주는 도구입니다.&#160; 순위표, 예산 및 컨트롤과 같은 기능을 지원하는 풍부한 최종 사용자 및 엔터프라이즈 기능을 제공합니다. 감사는 직원들이 연결되고, 감사하고, 보상을 받을 수 있도록 도와줍니다. |
| 회사 본사 위치 | 인도 |
| 앱 정보 페이지 | [https://www.quadrasystems.net/what-we-do/intelligent-ip-sol...](https://www.quadrasystems.net/what-we-do/intelligent-ip-solution/thankz) |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대한 Quadrasystems.net 제공되었습니다.
...
| 지원되는 정책 유형 나열 | 모든 AAD 조건부 액세스 정책  |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read.All | 응용 프로그램 | 사용자의 관리자 정보를 가져오려면  | [5d8eb1a9-2188-4292-86f6-f4964d49e8b3](../azure/5d8eb1a9-2188-4292-86f6-f4964d49e8b3.md) |
