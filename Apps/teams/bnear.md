---
title: bNear별 bNear에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/21/2022
...
description: bNear, 해당 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/5d655b39-963c-465a-89ab-bdad7ab7af7f" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004271" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

bNear에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | bNear |
| 회사 웹 사이트 | [https://bnear.io](https://bnear.io) |
| 앱의 사용 약관 | [https://bnear.io/terms](https://bnear.io/terms) |
| 앱의 핵심 기능 | bNear는 사용자와 팀을 위한 가상 공간입니다. 실제 사무실과 마찬가지로 연결 상태를 유지하세요! |
| 회사 본사 위치 | 독일 |
| 앱 정보 페이지 | [https://bnear.io](https://bnear.io) |
...
이 정보는 bNear에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 표시 이름, 전자 메일 주소, 팀 소속, 현재 Microsoft Teams 사용자 상태, 일별 일정 약속(제목, 설명, 시간, 참가자, 통화 링크)은 모임이 종료될 때까지 약속 날짜에 일시적으로 저장되며, 현재 실행 중인 통화(제목, 설명, 시간, 현재 참가자, 음소거 상태, 통화 링크)는 통화가 완료될 때까지 통화 중에 일시적으로 저장됩니다. |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 표시 이름, 전자 메일 주소, 팀 소속, 현재 Microsoft Teams 사용자 상태, 일별 일정 약속(제목, 설명, 시간, 참가자, 통화 링크)은 모임이 종료될 때까지 약속 날짜에 일시적으로 저장되며, 현재 실행 중인 통화(제목, 설명, 시간, 현재 참가자, 음소거 상태, 통화 링크)는 통화가 완료될 때까지 통화 중에 일시적으로 저장됩니다. |
...
| 개인 정보 취급 방침 URL | https://bnear.io/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | 응용 프로그램 | 모임 개요를 만들고 모임과 상호 작용합니다. | [5d655b39-963c-465a-89ab-bdad7ab7af7f](../azure/5d655b39-963c-465a-89ab-bdad7ab7af7f.md) |
>| Calls.InitiateGroupCall.All | 응용 프로그램 | 애플리케이션에서 호출을 시작합니다. | [5d655b39-963c-465a-89ab-bdad7ab7af7f](../azure/5d655b39-963c-465a-89ab-bdad7ab7af7f.md) |
>| Calls.JoinGroupCall.All | 응용 프로그램 | 애플리케이션에서 호출에 조인합니다. | [5d655b39-963c-465a-89ab-bdad7ab7af7f](../azure/5d655b39-963c-465a-89ab-bdad7ab7af7f.md) |
>| Group.ReadWrite.All | 위임 | 사용자에 대한 모든 팀을 나열하고 그룹을 만듭니다. | [5d655b39-963c-465a-89ab-bdad7ab7af7f](../azure/5d655b39-963c-465a-89ab-bdad7ab7af7f.md) |
>| GroupMember.Read.All | 응용 프로그램 | 모든 팀 구성원을 나열합니다. | [5d655b39-963c-465a-89ab-bdad7ab7af7f](../azure/5d655b39-963c-465a-89ab-bdad7ab7af7f.md) |
>| GroupMember.ReadWrite.All | 위임 | 모든 팀 구성원, 팀 룸을 나열하고 새 그룹을 만듭니다. | [5d655b39-963c-465a-89ab-bdad7ab7af7f](../azure/5d655b39-963c-465a-89ab-bdad7ab7af7f.md) |
>| Presence.ReadWrite.All | 응용 프로그램 | 팀의 모든 사용자에 대한 현재 상태 정보를 표시하고 사용자 상호 작용에 따라 새 현재 상태를 설정합니다. | [5d655b39-963c-465a-89ab-bdad7ab7af7f](../azure/5d655b39-963c-465a-89ab-bdad7ab7af7f.md) |
>| TeamMember.Read.All | 응용 프로그램 | 팀 룸에 팀의 모든 구성원을 표시합니다. | [5d655b39-963c-465a-89ab-bdad7ab7af7f](../azure/5d655b39-963c-465a-89ab-bdad7ab7af7f.md) |
>| TeamMember.ReadWrite.All | 위임 | 팀 룸에서 구성원을 추가하거나 제거합니다. | [5d655b39-963c-465a-89ab-bdad7ab7af7f](../azure/5d655b39-963c-465a-89ab-bdad7ab7af7f.md) |
>| Teams.Create | 위임 | 새 팀 룸을 위한 새 팀을 만듭니다. | [5d655b39-963c-465a-89ab-bdad7ab7af7f](../azure/5d655b39-963c-465a-89ab-bdad7ab7af7f.md) |
>| TeamsActivity.Send | 응용 프로그램 | 팀 구성원 앱 상호 작용에 대해 사용자에게 알립니다. | [5d655b39-963c-465a-89ab-bdad7ab7af7f](../azure/5d655b39-963c-465a-89ab-bdad7ab7af7f.md) |
>| User.Read.All | 응용 프로그램 | 사용자에 대한 라이브 업데이트를 가져옵니다. | [5d655b39-963c-465a-89ab-bdad7ab7af7f](../azure/5d655b39-963c-465a-89ab-bdad7ab7af7f.md) |
