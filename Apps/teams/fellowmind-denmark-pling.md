---
title: 펠로우마인드 덴마크의 Pling에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/05/2022
...
description: Pling, 해당 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/9ca359c6-8466-4519-b3b9-29573ebe39ca" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004294" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

페로마인드 덴마크가 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | Fellowmind Denmark |
| 회사 웹 사이트 | [https://intraactive.net](https://intraactive.net) |
| 앱의 사용 약관 | [https://intraactive.net/terms-of-use-pling](https://intraactive.net/terms-of-use-pling) |
| 앱의 핵심 기능 | 통합 앱 또는 Logic Apps 또는 Power Automate를 사용한 알림 |
| 회사 본사 위치 | 덴마크 |
| 앱 정보 페이지 | |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 페로마인드 덴마크에서 제공했습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | UPN |
...
| 개인 정보 취급 방침 URL | https://intraactive.net/privacy-policy-play |
...
| 지원되는 정책 유형 나열 | Microsoft Teams의 인증 체계가 기본이므로 모든 정책이 지원됩니다. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AppCatalog.Read.All | 위임 | 앱이 이미 설치되어 있는지 확인 | [78472101-8565-4ebe-a478-fbeb5ac8b1e0](../azure/78472101-8565-4ebe-a478-fbeb5ac8b1e0.md) |
>| Group.Read.All | 위임 | 사용자가 Pling 메시지를 받을 사용자를 선택할 수 있도록 모든 그룹 찾기 | [78472101-8565-4ebe-a478-fbeb5ac8b1e0](../azure/78472101-8565-4ebe-a478-fbeb5ac8b1e0.md) |
>| People.Read | 위임 | Pling 메시지를 보낼 때 적절한 대상 지정을 보장하기 위해 사용자에 대한 정보를 가져옵니다. | [78472101-8565-4ebe-a478-fbeb5ac8b1e0](../azure/78472101-8565-4ebe-a478-fbeb5ac8b1e0.md) |
>| User.Read | 위임 | 현재 사용자에 대한 정보를 가져와 현재 사용자가 누구인지, Pling에 이미 등록되어 있는지 확인합니다. | [78472101-8565-4ebe-a478-fbeb5ac8b1e0](../azure/78472101-8565-4ebe-a478-fbeb5ac8b1e0.md) |
>| User.ReadBasic.All | 위임 | 선택한 그룹에 따라 사용자를 찾아 메시지를 보낼 사용자 목록을 가져옵니다. | [78472101-8565-4ebe-a478-fbeb5ac8b1e0](../azure/78472101-8565-4ebe-a478-fbeb5ac8b1e0.md) |
>| Group.Read.All | 응용 프로그램 | 그룹에 메시지를 보낼 때 각 그룹을 조회하고 찾는 데 필요합니다. | [83797eec-6657-4fda-a566-d1ac05bfe874](../azure/83797eec-6657-4fda-a566-d1ac05bfe874.md) |
>| Organization.Read.All | 응용 프로그램 | 온보딩을 자동화하기 위해 Pling을 다운로드한 현재 조직에 대한 정보를 가져옵니다. | [83797eec-6657-4fda-a566-d1ac05bfe874](../azure/83797eec-6657-4fda-a566-d1ac05bfe874.md) |
>| TeamsAppInstallation.ReadWriteForUser.All | 응용 프로그램 | 사용자가 메시지를 받을 때 Pling이 자동으로 설치되는 사전 메시징에 필요합니다. | [83797eec-6657-4fda-a566-d1ac05bfe874](../azure/83797eec-6657-4fda-a566-d1ac05bfe874.md) |
