---
title: 민첩한 IS에 의해 민첩한 태스크 보드에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
ms.date: 11/03/2020
ms.topic: article
...
description: Agile Task Board에 대한 사용 가능한 모든 보안 및 규정 준수 정보 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보.
...
* <a href="https://appsource.microsoft.com/product/office/WA200002162" target="_blank">앱소스에서 보기</a>
...
| 파트너 회사 이름 | Agile-IS |
| 파트너 웹사이트의 URL | [https://www.agile-is.de/agiletaskboard?utm_medium=appsource...](https://www.agile-is.de/agiletaskboard?utm_medium=appsource&amp;utm_campaign=teams&amp;utm_source=manifest) |
| 개인정보 처리방침의 URL | [https://www.agile-is.de/en/telemetry](https://www.agile-is.de/en/telemetry) |
| 이용 약관의 URL | [https://www.agile-is.de/en/termsofuse](https://www.agile-is.de/en/termsofuse) |
...
이 정보는 Agile-IS에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직이 가질 수 있는 제어에 대해 제공했습니다.
...
>응용 프로그램 인사이트 원격 분석 데이터 내에서 도메인 이름과 해시된 사용자 ID를 수집합니다. 각 앱 인스턴스 내에서 원격 분석 데이터의 전송을 제어하고 끌 수 있습니다. 데이터의 후속 삭제는 당사에 요청해야 합니다.

#### <a name="organizational-controls-for-data-stored-by-partner"></a>파트너가 저장한 데이터에 대한 조직 제어

조직의 관리자가 파트너 시스템에서 자신의 정보를 제어하는 방법을 설명해 보세요. 예를 들어 삭제, 보존, 감사, 보관, 최종 사용자 정책 등

>응용 프로그램은 SharePoint 온라인 목록의 모든 데이터를 저장하고 앱의 각 인스턴스가 실행되는 동일한 사이트에 라이브러리를 문서화합니다. 이 데이터에 대한 액세스 제어는 고객의 테넌트 구성에 따라 다릅니다. 

라이선스 제어의 경우 도메인과 UPN은 Azure에서 호스팅되는 서비스로 전송됩니다. 이 정보는 Azure AD 인증에 의해 보호됩니다.
