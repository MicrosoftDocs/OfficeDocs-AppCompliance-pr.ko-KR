---
title: Smartnotation B.V별 Smartnotation에 대한 애플리케이션 정보입니다.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/09/2021
...
description: Smartnotation에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/424b1333-fbf0-4941-acbe-336bf1f316ae" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000681" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Smartnotation B.V에서 제공하는 정보입니다. Microsoft에 다음을 수행합니다.
...
| 회사 웹 사이트 | [https://www.smartnotation.com/landing/](https://www.smartnotation.com/landing/) |
| 앱의 사용 약관 | [https://www.smartnotation.com/public/tos.pdf](https://www.smartnotation.com/public/tos.pdf) |
| 앱의 핵심 기능 | 스마트 주석은 사용하기 쉬운 음성 지원 모임 시간(분) 솔루션입니다. 노트, 작업 및 결정은 관리하기 쉽고 정보를 항상 사용할 수 있습니다. 무엇보다도 불필요한 오버헤드를 제거하여 사용자와 팀이 핵심 비즈니스에 집중할 수 있습니다. Smartnotation을 MS Teams 완전히 통합할 수 있습니다. 커넥터를 추가하여 특정 프로젝트에 대한 모든 중요한 업데이트, 새 메모, 작업 및 의사 결정을 알리거나 탭을 구성하거나 Smartnotation을 직접 사용합니다. |
| 회사 본사 위치 | 네덜란드 (the) |
| 앱 정보 페이지 | [https://www.smartnotation.com/landing/integrations/](https://www.smartnotation.com/landing/integrations/) |
| 앱을 실행하는 데 사용되는 호스팅 환경 또는 서비스 모델은 무엇인가요? |  |
| 앱에서 사용하는 호스팅 클라우드 공급자는 무엇인가요? | Totaaldomein B.V. |
...
이 정보는 Smartnotation B.V에서 제공되었습니다. 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 설명합니다.
