...
| 회사의 웹 사이트 | [https://www.smartnotation.com/landing/](https://www.smartnotation.com/landing/) |
| 앱 사용 약관 | [https://www.smartnotation.com/public/tos.pdf](https://www.smartnotation.com/public/tos.pdf) |
| 앱의 핵심 기능 | Smartnotation은 사용하기 쉬운 음성 사용 가능 모임 시간 솔루션입니다. 메모, 작업 및 결정은 관리하기 쉬우며 항상 정보를 사용할 수 있습니다. 무엇보다도 불필요한 오버헤드를 제거하여 사용자와 팀이 핵심 비즈니스에 집중할 수 있도록 합니다. Smartnotation을 MS와 완전히 통합할 수 Teams. 특정 프로젝트에 대한 모든 중요 업데이트, 새 메모, 작업 및 결정에 대한 알림을 받을 커넥터를 추가하거나 탭을 구성하거나 Smartnotation을 직접 사용합니다. |
| 회사 본사 위치 | 네덜란드(the) |
...
| 앱에서 어떤 호스팅 클라우드 공급자를 사용하나요? | Totaaldomein B.V. |
