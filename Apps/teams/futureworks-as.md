---
title: Futureworks AS의 Futureworks에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/03/2022
...
description: Futureworks, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/80a90c8c-6199-454b-b0ff-bd5fba480275" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003510" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Futureworks AS에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | Futureworks AS |
| 회사의 웹 사이트 | [https://app.futureworks.com](https://app.futureworks.com) |
| 앱 사용 약관 | [https://www.futureworks.com/terms-of-service](https://www.futureworks.com/terms-of-service) |
| 앱의 핵심 기능 | OKR의 - 목표 및 주요 결과를 기반으로 하는 목표 및 성능 관리 플랫폼. |
| 회사 본사 위치 | 노르웨이 |
| 앱 정보 페이지 | [https://futureworks.no](https://futureworks.no) |
...
이 정보는 Futureworks AS에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직에서 사용할 컨트롤에 대해 제공됩니다.
