---
title: Smartsheet별 Smartsheet에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/23/2022
...
description: Smartsheet에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://appsource.microsoft.com/product/office/WA104380975" target="_blank">AppSource에서 보기</a>
...
| 회사 웹 사이트 | [https://www.smartsheet.com](https://www.smartsheet.com) |
| 앱의 사용 약관 | [https://pinpointprod.blob.core.windows.net/marketing/Partne...](https://pinpointprod.blob.core.windows.net/marketing/Partner_21474843641/Product_42949680935/Asset_06f25ae6-b277-42aa-b769-38e17926ebb4/SmartsheetUserAgreementSmartsh.pdf) |
| 앱의 핵심 기능 | Smartsheet는 조직 성취를 위한 선도적인 클라우드 기반 플랫폼으로, 팀과 조직이 대규모로 작업을 계획, 캡처, 관리, 자동화 및 보고할 수 있도록 하여 보다 효과적인 프로세스와 더 나은 비즈니스 결과를 제공합니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://help.smartsheet.com/articles/2476201-interact-with-...](https://help.smartsheet.com/articles/2476201-interact-with-smartsheet-items-in-microsoft-teams) |
...
이 정보는 Smartsheet에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
...
| 가장 최근 SOC2 인증 날짜 | 2021-12-06 |
| 앱이 서비스 조직 컨트롤(SOC 3)을 준수하나요? | 예 |
| 가장 최근 SOC3 인증 날짜 | 2021-12-06 |
...
| 개인 정보 취급 방침 URL | https://www.smartsheet.com/legal/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMember.Read.All | 응용 프로그램 | Smartsheet Tabs 애플리케이션을 허용하려면 채널 멤버를 읽고 스마트시트 자산을 공유할 수 있습니다. | [c68947ae-a07f-44ce-9a13-7b559251731d](../azure/c68947ae-a07f-44ce-9a13-7b559251731d.md) |
>| Directory.Read.All | 위임 | 앱이 사용자 및 그룹과 같은 조직의 데이터를 읽을 수 있도록 허용합니다. | [c68947ae-a07f-44ce-9a13-7b559251731d](../azure/c68947ae-a07f-44ce-9a13-7b559251731d.md) |
>| Group.Read.All | 위임 | 그룹의 멤버를 읽는 데 사용됩니다. | [c68947ae-a07f-44ce-9a13-7b559251731d](../azure/c68947ae-a07f-44ce-9a13-7b559251731d.md) |
>| Group.ReadWrite.All | 위임 | 그룹에 알림을 보내려면 | [c68947ae-a07f-44ce-9a13-7b559251731d](../azure/c68947ae-a07f-44ce-9a13-7b559251731d.md) |
>| User.Read.All | 위임 | 사용자의 전자 메일 주소를 기반으로 알림을 보내는 데 사용됩니다. | [c68947ae-a07f-44ce-9a13-7b559251731d](../azure/c68947ae-a07f-44ce-9a13-7b559251731d.md) |
>| offline_access | 위임 | 오프라인 사용을 허용합니다. | [c68947ae-a07f-44ce-9a13-7b559251731d](../azure/c68947ae-a07f-44ce-9a13-7b559251731d.md) |
