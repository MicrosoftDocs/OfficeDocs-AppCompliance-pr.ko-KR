---
title: CyTrack에서 CyRecord에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/23/2022
...
description: CyRecord에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/4073224c-6e1d-4e72-a754-510d91279b3b" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004280" target="_blank">AppSource에서 보기</a>
...
| 앱의 핵심 기능 | CyRecord는 외부 Microsoft Teams 전화 통화의 음성 녹음을 위해 고급 기능이 필요한 비즈니스 사용자를 대상으로 합니다.   통화 녹음은 전화 통화에 대한 명백한 사실을 제공하여 보다 신속한 분쟁 해결을 초래합니다. 수신 대기 및 교육을 통해 고객 서비스를 개선하고 규정 요구 사항 준수를 충족합니다. |
| 회사 본사 위치 | 오스트레일리아 |
| 앱 정보 페이지 | [https://web.cytrack.com/microsoft-teams/call-recording-for-...](https://web.cytrack.com/microsoft-teams/call-recording-for-microsoft-teams/) |
