---
title: Autopilot Workflow 솔루션의 Autopilot 워크플로에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
ms.date: 02/14/2022
ms.topic: article
...
description: Autopilot Workflows, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
---
# <a name="autopilot-workflows"></a>Autopilot 워크플로

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2021년 11월 17일</p>

* <a href="https://teams.microsoft.com/l/app/5aa677bf-b5a6-48bc-9a47-8892dbd316cb" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003745" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Autopilot Workflow 솔루션에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | Autopilot 워크플로 솔루션 |
| 회사의 웹 사이트 | [https://www.autopilot.co.za](https://www.autopilot.co.za) |
| 앱 사용 약관 | [https://cdn.autopilot.co.za/legal/Autopilot%20Client%20Term...](https://cdn.autopilot.co.za/legal/Autopilot%20Client%20Terms%20%20Conditions%2020160224.pdf) |
| 앱의 핵심 기능 | 유효성이 검사된 전자 양식 및 미리 구성된 프로세스는 작업을 수행하는 사용자에 관계없이 프로세스가 항상 일관된 방식으로 실행되도록 합니다. 수행된 작업의 포괄적인 감사 내적을 통해 모든 사람이 수행한 작업에 대한 책임이 유지될 수 있습니다. Autopilot은 직원이 퇴사할 때 연속성을 허용하고 새 직원에게 프로세스에 익숙해지기 위한 훌륭한 교육 도구 역할을 할 수 있습니다. 기본 제공 지침은 모든 방법을 안내합니다. |
| 회사 본사 위치 | 남아프리카 공화국 |
| 앱 정보 페이지 | |
...
이 정보는 Autopilot Workflow Solutions에서 이 앱이 조직 데이터를 수집 및 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직이 가지는 컨트롤에 대해 제공됩니다.
...
| 데이터베이스에 저장되는 데이터는 무엇입니까? | 클라이언트 Azure 테넌트 ID |
...
| 직원 계정을 프로비저닝, 수정 및 지우기 위한 프로세스를 설정하고 있나요? | 아니오 |
| 앱을 지원하는 네트워크 경계에 배포된 IDPS(침입 감지 및 방지) 소프트웨어가 있습니까? | 아니오 |
| 앱을 지원하는 모든 시스템 구성 요소에 이벤트 로깅이 설정되어 있나요? | 예 |
| 잠재적인 보안 이벤트를 감지하기 위해 수동 또는 자동화된 도구에서 정기적으로 모든 로그를 검토하나요? | 아니오|
| 보안 이벤트가 감지되면 직원에게 경고가 자동으로 발송되어 Triage가 발생하나요? | 예 |
| 공식적인 정보 보안 위험 관리 프로세스를 설정하고 있습니까? | 아니오 |
...
| 앱에 요청 시 개인의 개인 데이터 처리를 제한하거나 제한할 수 있는 기능이 있나요? | 아니오 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Teams. ReadBasic.All | application | 메시지 Teams 보내기 | [3970caf2-7c33-4668-8c74-91f3e094b789](https://docs.microsoft.com/microsoft-365-app-certification/azure/3970caf2-7c33-4668-8c74-91f3e094b789) |
>| TeamsActivity.Read | application | 메시지 Teams 보내기 | [3970caf2-7c33-4668-8c74-91f3e094b789](https://docs.microsoft.com/microsoft-365-app-certification/azure/3970caf2-7c33-4668-8c74-91f3e094b789) |
>| TeamsActivity.Send | application | 메시지 Teams 보내기 | [3970caf2-7c33-4668-8c74-91f3e094b789](https://docs.microsoft.com/microsoft-365-app-certification/azure/3970caf2-7c33-4668-8c74-91f3e094b789) |
>| User.Read.All | application | 메시지 Teams 보내기 | [3970caf2-7c33-4668-8c74-91f3e094b789](https://docs.microsoft.com/microsoft-365-app-certification/azure/3970caf2-7c33-4668-8c74-91f3e094b789) |
>| Group.Read.All | 위임 | Single Signin | [3bc7be07-dc8d-4dc4-a1be-0e8c7ebe9ebc](https://docs.microsoft.com/microsoft-365-app-certification/azure/3bc7be07-dc8d-4dc4-a1be-0e8c7ebe9ebc) |
>| User.Read | 위임 | Single Signin | [3bc7be07-dc8d-4dc4-a1be-0e8c7ebe9ebc](https://docs.microsoft.com/microsoft-365-app-certification/azure/3bc7be07-dc8d-4dc4-a1be-0e8c7ebe9ebc) |
>| User.Read.All | 위임 | Single Signin | [3bc7be07-dc8d-4dc4-a1be-0e8c7ebe9ebc](https://docs.microsoft.com/microsoft-365-app-certification/azure/3bc7be07-dc8d-4dc4-a1be-0e8c7ebe9ebc) |
