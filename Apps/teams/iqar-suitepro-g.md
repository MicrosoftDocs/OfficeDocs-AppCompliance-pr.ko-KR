...
| 앱의 핵심 기능 | SuitePro-G est un outil collaboratif et intuitif pour la gestion de votre portefeuille de projets. Connectez votre outil de pilotage de projets en 3 cliques et gardez une &#233;quipe projet impliqu&#233;e, pilot&#233;e et connect&#233;e.  SuitePro-G는 프로젝트 포트폴리오를 관리할 수 있는 공동 작업 및 직관적인 솔루션입니다. 커넥트 3회 클릭으로 프로젝트 관리 도구를 구성하고 연결하고 프로젝트 팀을 구성하고 연결합니다.  |
| 회사 본사 위치 | 프랑스 |
| 앱 정보 페이지 | |
