---
title: SaltFlat Limited의 SkilledHuman에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/24/2021
...
description: SkilledHuman, 해당 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/7c44d518-b820-461c-bbbd-2cbbd83aa3bc" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002603" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Microsoft로 제한되는 SaltFlat에서 제공하는 정보:
...
| 회사 웹 사이트 | [https://skilledhuman.org](https://skilledhuman.org) |
| 앱의 사용 약관 | [https://skilledhuman.org/terms](https://skilledhuman.org/terms) |
| 앱의 핵심 기능 | Professional Skills Framework |
| 회사 본사 위치 | 영국 및 북아일랜드(해당) |
| 앱 정보 페이지 | [https://skilledhuman.org/teamsapp](https://skilledhuman.org/teamsapp) |
...
이 정보는 SaltFlat Limited에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
