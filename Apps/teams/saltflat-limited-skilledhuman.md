...
description: SkilledHuman, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용할 수 있는 모든 보안 및 규정 준수 정보
...
| 회사의 웹 사이트 | [https://skilledhuman.org](https://skilledhuman.org) |
| 앱 사용 약관 | [https://skilledhuman.org/terms](https://skilledhuman.org/terms) |
| 앱의 핵심 기능 | Professional 기술 프레임워크 |
