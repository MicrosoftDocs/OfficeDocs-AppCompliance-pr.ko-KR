...
description: IQ, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/9d0bdc38-2705-4109-835f-3c14534f923f" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004126" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

NLSQL에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | NLSQL |
| 회사 웹 사이트 | [https://nlsql.com](https://nlsql.com) |
| 앱의 사용 약관 | [https://www.nlsql.com/terms_of_use](https://www.nlsql.com/terms_of_use) |
| 앱의 핵심 기능 | IQ는 관리자가 면접 질문을 생성하고 면접을 준비할 후보자를 지원합니다. 면접 질문 준비는 면접을 잘 준비하는 방법에 대한 완벽한 아이디어를 만드는 위치 입력에 따라 임의의 질문을 생성하는 인공 지능 소프트웨어입니다. 후보자는 더 나은 준비를 위해 면접 질문을 자유롭게 생성 할 수 있습니다. |
| 회사 본사 위치 | 영국 및 북아일랜드(해당) |
| 앱 정보 페이지 | [https://www.nlsql.com/blog/post/interview-questions-to-ask-...](https://www.nlsql.com/blog/post/interview-questions-to-ask-candidates-and-managers/) |
...
이 정보는 NLSQL에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 위임 | 로그인 및 사용자 프로필 읽기 | [f9555238-64f3-4ec2-a8fc-3787baa157aa](../azure/f9555238-64f3-4ec2-a8fc-3787baa157aa.md) |
