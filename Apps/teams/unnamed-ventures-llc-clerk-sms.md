---
title: 명명되지 않은 벤처스에 의해 서기 SMS에 대한 응용 프로그램 정보, LLC.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/04/2022
...
description: Clerk SMS, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
---
# <a name="clerk-sms"></a>서기 SMS

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2021년 10월 6일</p>

* <a href="https://teams.microsoft.com/l/app/88c50b69-8e4b-4383-b70f-c8295d5431a0" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003376" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

명명되지 않은 벤처스, LLC에서 제공하는 정보. Microsoft에 다음을 수행합니다.
...
| 파트너 회사 이름 | 이름없는 벤처스, LLC. |
| 회사 웹 사이트 | [https://clerk.chat/teams](https://clerk.chat/teams) |
| 앱의 사용 약관 | [https://clerk.chat/legal/terms/](https://clerk.chat/legal/terms/) |
| 앱의 핵심 기능 | Microsoft Teams 내에서 문자 메시지(SMS/MMS)를 보내고 받습니다.  |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://clerk.chat/teams](https://clerk.chat/teams) |
...
이 정보는 명명되지 않은 벤처스, LLC에 의해 제공되었습니다. 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 설명합니다.
...
| 개인 정보 취급 방침 URL | https://clerk.chat/legal/privacy |
