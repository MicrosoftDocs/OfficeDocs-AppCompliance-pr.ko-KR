---
title: Senso의 Senso에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/10/2021
...
description: Senso에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/3973b9d4-b50e-472d-8145-8967e01379b4" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002571" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Senso가 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | Senso |
| 회사 웹 사이트 | [https://www.senso.cloud](https://www.senso.cloud) |
| 앱의 사용 약관 | [https://www.senso.cloud/eula](https://www.senso.cloud/eula) |
| 앱의 핵심 기능 | 부적절한 메시지 및 이미지에 대한 키워드 및 이미지 분석  |
| 회사 본사 위치 | 영국 및 북아일랜드(해당) |
| 앱 정보 페이지 | [https://www.senso.cloud/safeguarding-microsoft-teams/](https://www.senso.cloud/safeguarding-microsoft-teams/) |
...
이 정보는 Senso에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 제공했습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | 응용 프로그램 | 모든 채널의 채널 이름 및 설명을 읽어 위반 플래그가 지정된 위치를 식별합니다.   | [a9d28fcf-036e-4a85-9003-332303e3a29b](../azure/a9d28fcf-036e-4a85-9003-332303e3a29b.md) |
>| ChannelMember.Read.All | 응용 프로그램 | 모든 채널의 구성원 목록 및 채팅 메시지를 읽습니다. | [a9d28fcf-036e-4a85-9003-332303e3a29b](../azure/a9d28fcf-036e-4a85-9003-332303e3a29b.md) |
>| ChannelMessage.Read.All | 응용 프로그램 | 모든 채널 메시지 읽기 | [a9d28fcf-036e-4a85-9003-332303e3a29b](../azure/a9d28fcf-036e-4a85-9003-332303e3a29b.md) |
>| Chat.Read.All | 응용 프로그램 | 모든 채팅 메시지 읽기 | [a9d28fcf-036e-4a85-9003-332303e3a29b](../azure/a9d28fcf-036e-4a85-9003-332303e3a29b.md) |
>| Directory.Read.All | 응용 프로그램 | 디렉터리 데이터 읽기 | [a9d28fcf-036e-4a85-9003-332303e3a29b](../azure/a9d28fcf-036e-4a85-9003-332303e3a29b.md) |
>| Files.Read.All | 응용 프로그램 | 모든 사이트 모음에서 파일 읽기 | [a9d28fcf-036e-4a85-9003-332303e3a29b](../azure/a9d28fcf-036e-4a85-9003-332303e3a29b.md) |
>| User.Read | 위임 | 로그인 및 사용자 프로필 읽기 | [a9d28fcf-036e-4a85-9003-332303e3a29b](../azure/a9d28fcf-036e-4a85-9003-332303e3a29b.md) |
>| User.Read.All | 응용 프로그램 | 모든 사용자의 전체 프로필 읽기 | [a9d28fcf-036e-4a85-9003-332303e3a29b](../azure/a9d28fcf-036e-4a85-9003-332303e3a29b.md) |
