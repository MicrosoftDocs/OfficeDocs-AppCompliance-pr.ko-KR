---
title: EFFENCY별 TeamGether에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/12/2021
...
description: TeamGether에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://appsource.microsoft.com/product/office/WA200002660" target="_blank">AppSource에서 보기</a>
...
| 파트너 회사 이름 | EFFENCY |
| 회사 웹 사이트 | [https://www.effency.fr](https://www.effency.fr) |
| 앱의 사용 약관 | [https://www.effency.fr/conditions-generales/](https://www.effency.fr/conditions-generales/) |
| 앱의 핵심 기능 | TeamGether는 EFFENCY에서 개발한 집단 효율성 분야의 선도적인 디지털 코칭 애플리케이션입니다. |
| 회사 본사 위치 | 프랑스 |
| 앱 정보 페이지 | [https://www.effency.fr/teams/](https://www.effency.fr/teams/) |
...
이 정보는 EFFENCY에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
