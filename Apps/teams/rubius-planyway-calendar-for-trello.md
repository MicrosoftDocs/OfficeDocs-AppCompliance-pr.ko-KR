---
title: Rubius의 Planyway Calendar for Trello에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
ms.date: 05/05/2021
ms.topic: article
...
* <a href="https://teams.microsoft.com/l/app/861228c3-eefd-462f-9b13-24dae6530ac3" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002712" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Rubius에서 Microsoft에 제공하는 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | Trello용 Planyway Calendar |
| ID | WA200002712 |
| Office 365 클라이언트 지원 | Microsoft Teams |
| 파트너 회사 이름 | Rubius |
| 회사의 웹 사이트 | [https://rubius.com](https://rubius.com) |
| 앱 사용 약관 | [https://planyway.com/legal/terms-of-use](https://planyway.com/legal/terms-of-use) |
| 앱의 핵심 기능 | Planyway는 일정을 관리하고, 프로젝트를 추적하고, 자원을 계획하기 위한 Trello의 팀 일정, 일정 및 시간 추적 도구입니다. Planyway를 사용하면 모든 팀 작업을 시각적으로 구성하고 간소화할 수 있습니다. 즉, 예정된 작업을 계획 및 우선 순위 지정하고, 일정 또는 일정에 작업을 할당 및 예약하고, 프로젝트 전체에서 팀 작업을 추적하고, 팀 가용성을 관리하고, 작업 및 프로젝트에 소요된 시간을 추적하고, 작업 및 개인 일정을 동기화할 수 있습니다. |
...
이 정보는 Rubius에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 조직에서 수집하는 데이터를 통해 조직이 제공하는 컨트롤에 대해 제공됩니다.
