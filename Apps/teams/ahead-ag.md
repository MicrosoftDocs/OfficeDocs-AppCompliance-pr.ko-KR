...
description: 미리 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
ms.locfileid: "66549543"
---
# <a name="ahead"></a>ahead

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 5월 20일</p>

* <a href="https://teams.microsoft.com/l/app/53360535-c93f-497f-b2a1-95bd9aa34283" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004202" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

미리 AG에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | ahead AG |
| 회사 웹 사이트 | [https://www.aheadintranet.com](https://www.aheadintranet.com) |
| 앱의 사용 약관 | [https://www.aheadintranet.com/terms-and-conditions](https://www.aheadintranet.com/terms-and-conditions) |
| 앱의 핵심 기능 | 직원에게 정보를 제공하고 참여를 유지하는 직원 참여 앱입니다. |
| 회사 본사 위치 | 스위스 |
| 앱 정보 페이지 | |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 미리 AG에서 제공했습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 앞의 인트라넷 제품의 올바른 작동과 관련된 데이터입니다. 여기에는 뉴스, 스토리, 특정 사용자 그룹에 대한 콘텐츠 대상 지정과 관련된 정보, 탐색 및 알림이 포함되나 이에 국한되지 않습니다. |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 앞의 인트라넷 제품의 올바른 작동과 관련된 데이터입니다. 여기에는 뉴스, 스토리, 특정 사용자 그룹에 대한 콘텐츠 대상 지정과 관련된 정보, 탐색 및 알림이 포함되나 이에 국한되지 않습니다. 사용자 관련 데이터는 Azure AD 읽기 전용 복사본입니다. 이는 사용자의 ID 및 이름 및 미리 관련성이 있는 것으로 표시된 Azure AD 그룹의 멤버 자격으로 제한됩니다. |
...
| 개인 정보 취급 방침 URL | https://www.aheadintranet.com/data-security |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 위임 | AD 그룹에 따른 대상 뉴스 | [53360535-c93f-497f-b2a1-95bd9aa34283](../azure/53360535-c93f-497f-b2a1-95bd9aa34283.md) |
>| Directory.Read.All | 응용 프로그램 | 푸시에 대한 AD 그룹에 따라 대상 뉴스 | [53360535-c93f-497f-b2a1-95bd9aa34283](../azure/53360535-c93f-497f-b2a1-95bd9aa34283.md) |
>| ExternalItem.Read.All | 위임 | 타사 원본에서 콘텐츠 검색(ServiceNow) | [53360535-c93f-497f-b2a1-95bd9aa34283](../azure/53360535-c93f-497f-b2a1-95bd9aa34283.md) |
>| Sites.Read.All | 위임 | SharePoint 사이트 콘텐츠 검색 | [53360535-c93f-497f-b2a1-95bd9aa34283](../azure/53360535-c93f-497f-b2a1-95bd9aa34283.md) |
>| User.Read | 위임 | 사용자 프로필 읽기 | [53360535-c93f-497f-b2a1-95bd9aa34283](../azure/53360535-c93f-497f-b2a1-95bd9aa34283.md) |
>| User.Read | 위임 | 사용자의 프로필 읽기(사진 등) | [53360535-c93f-497f-b2a1-95bd9aa34283](../azure/53360535-c93f-497f-b2a1-95bd9aa34283.md) |
>| User.Read.All | 위임 | 사용자의 프로필 읽기 | [53360535-c93f-497f-b2a1-95bd9aa34283](../azure/53360535-c93f-497f-b2a1-95bd9aa34283.md) |
>| User.Read.All | 응용 프로그램 | 검색에서 프로필 정보 읽기 | [53360535-c93f-497f-b2a1-95bd9aa34283](../azure/53360535-c93f-497f-b2a1-95bd9aa34283.md) |
