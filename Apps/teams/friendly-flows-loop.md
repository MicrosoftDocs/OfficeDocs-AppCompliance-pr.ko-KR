...
description: Loop, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
ms.locfileid: "64879755"
---
# <a name="loop"></a>Loop

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2021년 11월 10일</p>

* <a href="https://teams.microsoft.com/l/app/5dcf4bd7-eccd-4f6d-b5f0-a4e04aab4ff9" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003480" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Microsoft에 대한 친숙한 흐름에서 제공하는 정보:
...
| 파트너 회사 이름 | 친숙한 흐름 |
| 회사 웹 사이트 | [https://friendlyflows.com](https://friendlyflows.com) |
| 앱의 사용 약관 | [https://friendlyflows.com/terms-of-use/](https://friendlyflows.com/terms-of-use/) |
| 앱의 핵심 기능 | 적절한 시기에 사람들을 모아 프로젝트를 진행합니다. |
| 회사 본사 위치 | 네덜란드 (the) |
| 앱 정보 페이지 | [https://friendlyflows.com/loop/](https://friendlyflows.com/loop/) |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대한 친숙한 흐름에서 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 사용자 프로필, 사용자 입력 |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 사용자 프로필, 사용자 입력 |
...
| 개인 정보 취급 방침 URL | https://friendlyflows.com/privacy-policy/ |
...
| 앱에서 위의 라이브러리 중 하나를 사용하지 않는 경우 어떤 인증 라이브러리 또는 라이브러리를 사용하나요? | 없음 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 위임 | 인증 | [95a2eca4-fb4b-4488-8ba8-6bacf3812c76](../azure/95a2eca4-fb4b-4488-8ba8-6bacf3812c76.md) |
>| 전자 메일 | 위임 | 등록 | [95a2eca4-fb4b-4488-8ba8-6bacf3812c76](../azure/95a2eca4-fb4b-4488-8ba8-6bacf3812c76.md) |
>| 프로필 | 위임 | 인증 | [95a2eca4-fb4b-4488-8ba8-6bacf3812c76](../azure/95a2eca4-fb4b-4488-8ba8-6bacf3812c76.md) |
