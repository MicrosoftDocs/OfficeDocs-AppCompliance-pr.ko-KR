---
title: 친숙한 흐름의 루프에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/18/2021
...
* <a href="https://teams.microsoft.com/l/app/5dcf4bd7-eccd-4f6d-b5f0-a4e04aab4ff9" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003480" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Microsoft에 친숙한 흐름에서 제공하는 정보:
...
| 파트너 회사 이름 | 친숙한 흐름 |
| 회사의 웹 사이트 | [https://friendlyflows.com](https://friendlyflows.com) |
| 앱 사용 약관 | [https://friendlyflows.com/terms-of-use/](https://friendlyflows.com/terms-of-use/) |
| 앱의 핵심 기능 | 프로젝트를 위해 올바른 시기에 함께 작업할 수 있습니다. |
| 회사 본사 위치 | 네덜란드(the) |
...
이 정보는 이 앱이 조직 데이터를 수집 및 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직에서 제공하는 컨트롤에 대한 친숙한 흐름에서 제공됩니다.
...
| 데이터베이스에 저장되는 데이터는 무엇입니까? | 사용자 프로필, 사용자 입력 |
