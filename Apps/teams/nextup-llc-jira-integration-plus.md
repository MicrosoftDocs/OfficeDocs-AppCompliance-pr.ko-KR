---
title: Jira Integration Plus by Nextup, LLC에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/11/2022
...
description: Jira Integration Plus, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/a3394b99-8ae6-48cb-bb45-898fd4c49f93" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003847" target="_blank">AppSource에서 보기</a>
...
| 회사 웹 사이트 | [https://www.nextup.ai](https://www.nextup.ai) |
| 앱의 사용 약관 | [https://www.nextup.ai/terms](https://www.nextup.ai/terms) |
| 앱의 핵심 기능 | Teams 편집하거나 논의할 기존 Jira 문제를 찾거나 새 문제를 만듭니다. 메시지에서 문제를 보냅니다. 문제에 대해 언급하거나 세부 정보를 확인합니다. 상태를 변경하고, 할당하는 등. CLI(명령줄 인터페이스)를 통해 Jira를 사용합니다. 메모, 로그 작업 등 채널(커넥터)의 문제에 대한 알림을 받습니다. 메시징 확장을 사용하여 메시지에서 새 문제를 만듭니다. 보드(탭)를 사용하여 문제를 관리합니다. Teams 메시지 아래의 아이콘을 클릭하여 문제를 검색합니다. |
| 회사 본사 위치 | 미국 |
...
이 정보는 Nextup, LLC에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 고유 식별자 및 전자 메일 주소 |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 고유 식별자 및 전자 메일 주소 |
...
| 다음을 위해 MFA(다단계 인증)를 사용하도록 설정했습니다. | 자격 증명, DNSManagement |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AccessReview.Read.All | 모두 | 이 API를 사용하여 사용자가 애플리케이션에 액세스할 수 있는 권한이 있는지 확인합니다. | [0f22abfb-b687-489d-9fd6-ad1bc95d6d68](/microsoft-365-app-certification/azure/0f22abfb-b687-489d-9fd6-ad1bc95d6d68) |
>| AccessReview.ReadWrite.All | 모두 | 이 API를 사용하여 사용자가 애플리케이션에 액세스할 수 있는 권한이 있는지 확인합니다. | [0f22abfb-b687-489d-9fd6-ad1bc95d6d68](/microsoft-365-app-certification/azure/0f22abfb-b687-489d-9fd6-ad1bc95d6d68) |
>| Directory.Read.All | 모두 | 이 API를 사용하여 사용자가 Teams 애플리케이션 및 팀 및 채널에서 봇을 사용할 수 있는 권한이 있는지 확인합니다. | [0f22abfb-b687-489d-9fd6-ad1bc95d6d68](/microsoft-365-app-certification/azure/0f22abfb-b687-489d-9fd6-ad1bc95d6d68) |
>| Directory.Read.All | 모두 | 이 API를 사용하여 사용자가 Teams 애플리케이션 및 팀 및 채널에서 봇을 사용할 수 있는 권한이 있는지 확인합니다. | [0f22abfb-b687-489d-9fd6-ad1bc95d6d68](/microsoft-365-app-certification/azure/0f22abfb-b687-489d-9fd6-ad1bc95d6d68) |
>| Files.ReadWrite.All | 모두 | 이 API를 사용하여 Jira 문제에 연결할 수 있는 사용자의 파일을 허용합니다. | [0f22abfb-b687-489d-9fd6-ad1bc95d6d68](/microsoft-365-app-certification/azure/0f22abfb-b687-489d-9fd6-ad1bc95d6d68) |
>| Files.ReadWrite.All | 모두 | 이 API를 사용하여 Jira 문제에 연결할 수 있는 사용자의 파일을 허용합니다. | [0f22abfb-b687-489d-9fd6-ad1bc95d6d68](/microsoft-365-app-certification/azure/0f22abfb-b687-489d-9fd6-ad1bc95d6d68) |
>| Sites.Read.All | 모두 | 이 API를 사용하여 적절한 장소에서 티켓을 만들 수 있도록 사용자가 액세스할 수 있는 사이트를 확인합니다. | [0f22abfb-b687-489d-9fd6-ad1bc95d6d68](/microsoft-365-app-certification/azure/0f22abfb-b687-489d-9fd6-ad1bc95d6d68) |
>| Sites.Read.All | 모두 | 이 API를 사용하여 적절한 장소에서 티켓을 만들 수 있도록 사용자가 액세스할 수 있는 사이트를 확인합니다. | [0f22abfb-b687-489d-9fd6-ad1bc95d6d68](/microsoft-365-app-certification/azure/0f22abfb-b687-489d-9fd6-ad1bc95d6d68) |
>| User.ReadWrite.All | 모두 | 이 API를 사용하여 관리자가 조직에서 Jira와 함께 애플리케이션을 사용할 수 있도록 허용합니다. | [0f22abfb-b687-489d-9fd6-ad1bc95d6d68](/microsoft-365-app-certification/azure/0f22abfb-b687-489d-9fd6-ad1bc95d6d68) |
>| User.ReadWrite.All | 모두 | 이 API를 사용하여 관리자가 조직에서 Jira와 함께 애플리케이션을 사용할 수 있도록 허용합니다. | [0f22abfb-b687-489d-9fd6-ad1bc95d6d68](/microsoft-365-app-certification/azure/0f22abfb-b687-489d-9fd6-ad1bc95d6d68) |
