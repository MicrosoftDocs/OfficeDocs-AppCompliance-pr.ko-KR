---
title: DBit by Diamondsoft Solutions, LLC에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/29/2021
...
description: DBit에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
ms.locfileid: "64876435"
---
# <a name="dbit"></a>DBit

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2021년 11월 24일</p>

* <a href="https://teams.microsoft.com/l/app/b28bb657-8edd-47ae-a912-c5fc11b3e89e" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001536" target="_blank">AppSource에서 보기</a>
...
| 회사 웹 사이트 | [https://www.diamondsoftsolutions.com](https://www.diamondsoftsolutions.com) |
| 앱의 사용 약관 | [https://www.dbit.io/termsofuse.html](https://www.dbit.io/termsofuse.html) |
| 앱의 핵심 기능 | 번거로움이 적은 DBit 암호 관리 솔루션 DBit는 소규모에서 대규모 팀을 위한 암호 관리 도구입니다. DBit를 사용하면 팀 구성원 간에 암호를 안전하게 공유할 수 있습니다. 생성된 공유 암호 및 암호는 설정된 기간(분) 후에 자동으로 만료됩니다. 암호는 서버의 메모리에 암호화되며 디스크 스토리지에 저장되지 않습니다. 암호가 만료되면 서버의 메모리에서 암호가 제거됩니다. 이 응용 프로그램은 다이아몬드 소프트 솔루션, LLC에 의해 개발된다 |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
...
이 정보는 Diamondsoft Solutions, LLC에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | TenantId |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | TenantId |
