...
description: DBit에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보
...
| 회사의 웹 사이트 | [https://www.diamondsoftsolutions.com](https://www.diamondsoftsolutions.com) |
| 앱 사용 약관 | [https://www.dbit.io/termsofuse.html](https://www.dbit.io/termsofuse.html) |
| 앱의 핵심 기능 | DBit 암호 관리 솔루션으로, 덜 고민할 수 있습니다. DBit는 소규모 팀과 대규모 팀을 위한 암호 관리 도구입니다. DBit를 사용하면 팀 구성원 간에 암호를 안전하게 공유할 수 있습니다. 생성된 공유 암호와 암호는 설정된 기간(분)이 지난 후 자동으로 만료됩니다. 사용자의 암호는 서버의 메모리에 암호화되며 디스크 저장소에 저장되지 않습니다. 암호가 만료되면 서버의 메모리에서 제거됩니다. 이 앱은 Diamondsoft Solutions, LLC에 의해 개발됩니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
