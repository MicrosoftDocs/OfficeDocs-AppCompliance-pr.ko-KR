---
title: FireHydrant의 FireHydrant에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/14/2022
...
description: FireHydrant, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용 가능한 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/c18f3920-4098-4907-bc92-43c8559b5e18" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003794" target="_blank">AppSource의 보기</a>
...
| 회사의 웹 사이트 | [https://firehydrant.io](https://firehydrant.io) |
| 앱 사용 약관 | [https://app.firehydrant.io/legal/ssa](https://app.firehydrant.io/legal/ssa) |
| 앱의 핵심 기능 | 인시던트 관리 및 FireHydrant.io. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
...
이 정보는 FireHydrant에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직에서 제공하는 컨트롤에 대해 제공됩니다.
...
| 데이터베이스에 저장되는 데이터는 무엇입니까? | 팀 ID, 테넌트 ID, 메시지, 사용자 이름 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.Create | 위임 | FireHydrant는 사용자를 대신하여 인시던트 관리 채널을 만듭니다. | [00485db5-81b3-4299-833a-8d6c366d0ac0](../azure/00485db5-81b3-4299-833a-8d6c366d0ac0.md) |
