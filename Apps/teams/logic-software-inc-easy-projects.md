---
title: 로직 소프트웨어 Inc.에 의해 쉬운 프로젝트에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
ms.date: 03/24/2021
ms.topic: article
...
description: EASY Project에 대한 사용 가능한 모든 보안 및 규정 준수 정보 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보.
...
<p>최종 업데이트: 2021년 3월 24일</p>

* <a href="https://teams.microsoft.com/l/app/ee27dd0c-3a49-4c09-8faa-6c6e0163bae5" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002647" target="_blank">앱소스에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

마이크로 소프트에 로직 소프트웨어 주식 회사에서 제공하는 정보 :
...
| 파트너 웹사이트의 URL | [https://www.easyprojects.net](https://www.easyprojects.net) |
| Teams 응용 프로그램 정보 페이지의 URL | [https://www.easyprojects.net](https://www.easyprojects.net) |
| 개인정보 처리방침의 URL | [https://www.easyprojects.net/privacy/](https://www.easyprojects.net/privacy/) |
| 이용 약관의 URL | [https://www.easyprojects.net/hosting-agreement/](https://www.easyprojects.net/hosting-agreement/) |
...
이 정보는 Logic Software Inc.에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직이 가질 수 있는 제어에 대해 제공했습니다.
...
<iframe height='1020' title='Microsoft Cloud App Security 정보' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/10134' frameborder='no' style='width: 100%;'></iframe>
...
이 정보는 이 앱이 인증, 승인, 응용 프로그램 등록 모범 사례 및 기타 ID 기준을 처리하는 방법에 대해 Logic Software Inc.에서 제공했습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| Microsoft 식별 플랫폼(Azure AD)과 통합합니까?  | 예 |
| Microsoft ID 플랫폼 통합 검사 목록에 설명된 모든 적용 가능한 모범 사례를 검토하고 준수했습니까?  | 예 |
| 앱에서 인증에 MSAL(Microsoft 인증 라이브러리)을 사용합니까? | 나 |
