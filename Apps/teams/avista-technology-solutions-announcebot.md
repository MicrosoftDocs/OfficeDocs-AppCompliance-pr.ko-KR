---
title: Avista 기술 솔루션의 AnnounceBot에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/17/2022
...
description: AnnounceBot에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/d13120dd-5961-4589-b470-19d9d01c6668" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003321" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Avista Technology Solutions에서 Microsoft에 제공하는 정보:
...
| 회사 웹 사이트 | [https://announcebot.in](https://announcebot.in) |
| 앱의 사용 약관 | [https://announcebot.in/terms.html](https://announcebot.in/terms.html) |
| 앱의 핵심 기능 | AnnounceBot을 사용하여 생일, 기념일 및 인사말 동료를 적시에 기원합니다. |
| 회사 본사 위치 | 인도 |
| 앱 정보 페이지 | [https://announcebot.in](https://announcebot.in) |
...
이 정보는 Avista Technology Solutions에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 아니요 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 이름입니다. 성 |
