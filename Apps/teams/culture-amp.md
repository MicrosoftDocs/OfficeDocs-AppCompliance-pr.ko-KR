---
title: 문화권별 문화권 앰프에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/06/2022
...
description: Culture Amp에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
ms.locfileid: "64698982"
---
# <a name="culture-amp"></a>문화권 앰프

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 4월 6일</p>

* <a href="https://teams.microsoft.com/l/app/13a11229-3c3e-49d5-843b-71d204a5b5ee" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001744" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Culture Amp에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | 문화권 앰프 |
| 회사 웹 사이트 | [https://www.cultureamp.com](https://www.cultureamp.com) |
| 앱의 사용 약관 | [https://www.cultureamp.com/terms/](https://www.cultureamp.com/terms/) |
| 앱의 핵심 기능 | 직원들이 피드백을 공유하고 Microsoft Teams 내에서 Culture Amp 인사이트에 액세스할 수 있도록 지원 |
| 회사 본사 위치 | 오스트레일리아 |
| 앱 정보 페이지 | |
...
이 정보는 Culture Amp에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 아니요 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 대화 참조 전자 메일 주소 |
| 기본 침입이 Microsoft 고객 데이터를 처리하거나 저장하는 경우 이 데이터는 지리적으로 저장되는 위치는 어디인가요? | 아일랜드, 미국 |
...
| 개인 정보 취급 방침 URL | https://www.cultureamp.com/terms/ |
