---
title: Think AI의 Thinky365-Autotask 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: Thinky365-Autotask, 해당 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/2291b3d5-ea1d-4605-9a94-ac4523b85c06" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004355" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Think AI에서 Microsoft에 제공하는 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | Thinky365-Autotask |
| ID | WA200004355 |
| 지원되는 Office 365 클라이언트 | Microsoft Teams |
| 파트너 회사 이름 | Think AI |
| 회사 웹 사이트 | [https://www.thinky365.com](https://www.thinky365.com) |
| 앱의 사용 약관 | [https://thinky365.com/terms-of-use/](https://thinky365.com/terms-of-use/) |
| 앱의 핵심 기능 | Autotask용 Thinky365 챗봇은 24&#215;7 가상 에이전트입니다. 이 챗봇을 사용하면 새롭고 혁신적인 방법으로 서비스 팀의 생산성을 높이는 동시에 고객의 전반적인 사용자 환경을 개선할 수 있습니다.  |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
...
이 정보는 Think AI에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 아니요 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | Microsoft Graph, CRM 및 Azure와 같은 서비스의 엔드포인트 |
