---
title: ModuleQ별 Q에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/31/2022
...
description: Q, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
ms.locfileid: "64878615"
---
# <a name="q"></a>Q

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 1월 29일</p>

* <a href="https://teams.microsoft.com/l/app/72bb25c7-3644-4318-8249-a08e5493a520" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA104381433" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

ModuleQ에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | ModuleQ |
| 회사 웹 사이트 | [https://moduleq.com](https://moduleq.com) |
| 앱의 사용 약관 | [https://moduleq.com/terms-of-service](https://moduleq.com/terms-of-service) |
| 앱의 핵심 기능 | Q는 신뢰할 수 있는 동료처럼 작동하여 고객 포커스를 추적하고 요청하기 전에 확인해야 하는 비즈니스 뉴스를 보냅니다. 톰슨 로이터의 모듈Q AI 및 지식 Graph. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://moduleq.com/product](https://moduleq.com/product) |
...
이 정보는 모듈Q에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 사용자 프로필 데이터, 사용자 전자 메일 메타데이터, 사용자 일정 메타데이터 |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 사용자 프로필 데이터, 사용자 전자 메일 메타데이터, 사용자 일정 메타데이터 |
...
| 앱에서 위의 라이브러리 중 하나를 사용하지 않는 경우 어떤 인증 라이브러리 또는 라이브러리를 사용하나요? | Microsoft.AspNetCore.Authentication.MicrosoftAccount |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | 응용 프로그램 | 제품 기능에 필요합니다. | [418a1ee4-ca76-4b38-b4b3-8cca25417a6c](../azure/418a1ee4-ca76-4b38-b4b3-8cca25417a6c.md) |
>| Group.Read.All | 위임 | 제품 기능에 필요합니다. | [418a1ee4-ca76-4b38-b4b3-8cca25417a6c](../azure/418a1ee4-ca76-4b38-b4b3-8cca25417a6c.md) |
>| Mail.Read | 응용 프로그램 | 제품 기능에 필요합니다. | [418a1ee4-ca76-4b38-b4b3-8cca25417a6c](../azure/418a1ee4-ca76-4b38-b4b3-8cca25417a6c.md) |
>| User.Read | 위임 | 제품 기능에 필요합니다. | [418a1ee4-ca76-4b38-b4b3-8cca25417a6c](../azure/418a1ee4-ca76-4b38-b4b3-8cca25417a6c.md) |
>| User.Read.All | 위임 | 제품 기능에 필요합니다. | [418a1ee4-ca76-4b38-b4b3-8cca25417a6c](../azure/418a1ee4-ca76-4b38-b4b3-8cca25417a6c.md) |
