---
title: Sift에 의한 Sift에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/26/2022
...
description: Sift에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
ms.locfileid: "65125372"
---
# <a name="sift"></a>구별

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 4월 25일</p>

* <a href="https://teams.microsoft.com/l/app/d2a1ed44-6cca-44d2-9b9c-1c9c1d597093" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002545" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Sift에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | 구별 |
| 회사 웹 사이트 | [https://www.justsift.com](https://www.justsift.com) |
| 앱의 사용 약관 | [https://www.justsift.com/sift-msteams-eula](https://www.justsift.com/sift-msteams-eula) |
| 앱의 핵심 기능 | 조직의 사용자 찾기, 검색 및 연결 |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://www.justsift.com/integrating-sift/with-microsoft-te...](https://www.justsift.com/integrating-sift/with-microsoft-teams) |
...
이 정보는 Sift에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | Teams 앱은 기본 프로필 정보를 요청하고 Azure AD 사용자의 모임 데이터를 보는 데 동의합니다. 또한 사용자로부터 추가 프로필 정보를 자발적으로 수집하여 플랫폼 내에서 프로필을 향상시킵니다. |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 관리자가 동의를 부여하면 Microsoft 그래프의 사용자 프로필 정보가 수집됩니다. |
...
| 개인 정보 취급 방침 URL | https://www.justsift.com/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.Read.All | 위임 | 그룹별로 검색된 사용자를 필터링하기 위해 Graph 그룹 정보를 검색합니다. | [270b510a-7cfb-4a9a-8071-5ceab03cf357](../azure/270b510a-7cfb-4a9a-8071-5ceab03cf357.md) |
>| User.Read.All | 위임 | 제품에서 직원 프로필을 프로비전하고 일관되게 업데이트하기 위해 Graph 사용자 개체를 검색합니다. | [270b510a-7cfb-4a9a-8071-5ceab03cf357](../azure/270b510a-7cfb-4a9a-8071-5ceab03cf357.md) |
>| OnlineMeetingArtifact.Read.All | 위임 | Teams 앱의 모임 확장의 경우 모임 참가자와 관련된 정보를 검색할 수 있는 권한이 필요합니다. | [d2a1ed44-6cca-44d2-9b9c-1c9c1d597093](../azure/d2a1ed44-6cca-44d2-9b9c-1c9c1d597093.md) |
>| OnlineMeetings.Read | 위임 | Teams 앱의 모임 확장의 경우 모임 참가자와 관련된 정보를 검색할 수 있는 권한이 필요합니다. | [d2a1ed44-6cca-44d2-9b9c-1c9c1d597093](../azure/d2a1ed44-6cca-44d2-9b9c-1c9c1d597093.md) |
