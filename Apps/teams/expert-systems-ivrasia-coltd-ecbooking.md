...
>|:------------------------|:--------------------|:------------------------------------|
>| Calendars.ReadWrite | application | 달력 읽기 쓰기 |
>| Calendars.ReadWrite | 위임 | 달력 읽기 쓰기 |
>| Mail.Send | 위임 | 메일 보내기 |
>| Mail.Send | application | 메일 보내기 |
>| User.Read | 위임 | 읽기 사용자 |
>| User.Read.All | application | 읽기 사용자 |
