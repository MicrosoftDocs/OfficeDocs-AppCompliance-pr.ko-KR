...
>사용자 전자 메일, 사용자 이벤트 등의 데이터가 저장됩니다. 
...
이 정보는 Expert Systems IVR(Asia) 2013에서 Co.Ltd. 이 앱이 인증, 권한 부여, 응용 프로그램 등록 모범 사례 및 기타 ID 기준을 처리하는 방법에 대한 정보를 제공합니다.
