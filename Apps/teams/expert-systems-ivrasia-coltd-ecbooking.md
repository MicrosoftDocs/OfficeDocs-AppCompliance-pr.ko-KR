---
title: Expert Systems IVR(아시아) Co.Ltd 의한 ecBooking에 대한 애플리케이션 정보입니다.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/19/2022
...
description: ecBooking에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://appsource.microsoft.com/product/office/WA200002096" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Expert Systems IVR(아시아) Co.Ltd 제공된 정보입니다. Microsoft에 다음을 수행합니다.
...
| 회사 웹 사이트 | [https://www.esi-asia.com](https://www.esi-asia.com) |
| 앱의 사용 약관 | [https://www.esi-asia.com/product/intelligent-room-booking-s...](https://www.esi-asia.com/product/intelligent-room-booking-system/#1598241760681-29d114e0-5c2b) |
| 앱의 핵심 기능 | 인텔리전트 시스템을 사용하여 모임 공간을 최적화하는 효과적인 예약 환경. |
| 회사 본사 위치 | 홍콩 |
| 앱 정보 페이지 | [https://www.esi-asia.com/product/intelligent-room-booking-s...](https://www.esi-asia.com/product/intelligent-room-booking-system/) |
...
이 정보는 전문가 시스템 IVR(아시아) Co.Ltd 제공되었습니다. 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 설명합니다.
...
| 기본 침입이 Microsoft 고객 데이터를 처리하거나 저장하는 경우 이 데이터는 지리적으로 저장되는 위치는 어디인가요? | 홍콩 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | 응용 프로그램 | 일정 읽기 쓰기 | [00ee4a74-9dc3-4bd9-9a6d-f18b640fd69d](../azure/00ee4a74-9dc3-4bd9-9a6d-f18b640fd69d.md) |
>| Calendars.ReadWrite | 위임 | 일정 읽기 쓰기 | [00ee4a74-9dc3-4bd9-9a6d-f18b640fd69d](../azure/00ee4a74-9dc3-4bd9-9a6d-f18b640fd69d.md) |
>| Mail.Send | 위임 | 메일 보내기 | [00ee4a74-9dc3-4bd9-9a6d-f18b640fd69d](../azure/00ee4a74-9dc3-4bd9-9a6d-f18b640fd69d.md) |
>| Mail.Send | 응용 프로그램 | 메일 보내기 | [00ee4a74-9dc3-4bd9-9a6d-f18b640fd69d](../azure/00ee4a74-9dc3-4bd9-9a6d-f18b640fd69d.md) |
>| User.Read | 위임 | 사용자 읽기 | [00ee4a74-9dc3-4bd9-9a6d-f18b640fd69d](../azure/00ee4a74-9dc3-4bd9-9a6d-f18b640fd69d.md) |
>| User.Read.All | 응용 프로그램 | 사용자 읽기 | [00ee4a74-9dc3-4bd9-9a6d-f18b640fd69d](../azure/00ee4a74-9dc3-4bd9-9a6d-f18b640fd69d.md) |
