...
| 회사의 웹 사이트 | [https://karmabot.chat/ms](https://karmabot.chat/ms) |
| 앱 사용 약관 | [https://karmabot.readme.io/docs/karma-end-user-license-agre...](https://karmabot.readme.io/docs/karma-end-user-license-agreement-eula) |
| 앱의 핵심 기능 | 원격 팀을 위한 참 채우기입니다. |
| 회사 본사 위치 | 뉴질랜드 |
| 앱 정보 페이지 | [https://karmabot.chat/ms](https://karmabot.chat/ms) |
...
| 데이터베이스에 저장되는 데이터는 무엇입니까? | 전자 메일 주소, 개별 인식 |
...
| 개인 정보 취급 방침 URL | https://karmabot.readme.io/docs/privacy-policy-for-microsoft-teams |
