...
* <a href="https://teams.microsoft.com/l/app/2bffa4e8-aac7-4d2e-976d-5a7db5c4b768" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001589" target="_blank">앱소스에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Viima 솔루션 Oy에서 마이크로소프트에 제공 하는 정보:
...
| 파트너 회사 이름 | Viima Solutions Oy |
| 파트너 웹사이트의 URL | [https://www.viima.com/](https://www.viima.com/) |
| Teams 응용 프로그램 정보 페이지의 URL | [https://www.viima.com/product](https://www.viima.com/product) |
| 개인정보 처리방침의 URL | [https://www.viima.com/privacy-policy](https://www.viima.com/privacy-policy) |
| 이용 약관의 URL | [https://www.viima.com/terms](https://www.viima.com/terms) |
...
이 정보는 Viima Solutions Oy에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직이 가질 수 있는 제어에 대해 제공했습니다.
...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| User.Read | 위임 |  이름과 성, UPN / 이메일 주소, 위치, 로케일, 부서, 사무실 위치. 이러한 사용자는 사용자를 로그인하고 앱 내에서 기본 프로필 정보를 제공하는 데 사용됩니다. | 사용자가 로그인할 수 있도록 하고 앱이 UPN 및 기본 프로필 정보에 액세스할 수 있도록 하여 자동 로그인을 가능하게 합니다. | b8ea7030-ce4d-4ecd-98d7-dc16d8298d1b |
...
>조직 이름, Viima 조직 ID, 최종 사용자 이메일 및 ID가 로그에 나타납니다. ISO27001 호환 제3자 감사 제어는 제한된 액세스 및 해당 데이터의 보관/삭제에 대한 통제입니다.

#### <a name="organizational-controls-for-data-stored-by-partner"></a>파트너가 저장한 데이터에 대한 조직 제어

조직의 관리자가 파트너 시스템에서 자신의 정보를 제어하는 방법을 설명해 보세요. 예를 들어 삭제, 보존, 감사, 보관, 최종 사용자 정책 등

>데이터는 AWS(아일랜드)에 저장됩니다. 데이터에 대한 액세스는 적절한 교육을 받았으며 2FA, 보호된 IP 범위(기업 네트워크에서만 액세스) 등과 같은 여러 보안 조치로 보호되는 공인 유지 관리 및 기술 지원 직원으로만 제한됩니다. 대책은 ISO27001호환및 제3자에 의해 감사됩니다.
...
<iframe height='1020' title='Microsoft Cloud App Security 정보' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/33480' frameborder='no' style='width: 100%;'></iframe>

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/33480" target="_blank">새 탭에서 보기</a>
...
이 정보는 Viima Solutions Oy에서 이 앱이 인증, 권한 부여, 응용 프로그램 등록 모범 사례 및 기타 ID 기준을 처리하는 방법에 대해 제공했습니다.
