---
title: Coeus Solutions GmbH의 BRAVO Workhub에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
ms.date: 02/07/2022
ms.topic: article
...
description: BRAVO Workhub에 사용할 수 있는 모든 보안 및 규정 준수 정보, 해당 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보
...
* <a href="https://teams.microsoft.com/l/app/53ab3c45-3531-47a8-b524-fe8b5fd539ef" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003694" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Coeus Solutions GmbH에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | Coeus Solutions GmbH |
| 회사의 웹 사이트 | [https://getbravo.io](https://getbravo.io) |
| 앱 사용 약관 | [https://getbravo.io/terms-and-conditions](https://getbravo.io/terms-and-conditions) |
| 앱의 핵심 기능 | BRAVO와의 통합으로 피어 투 피어 Microsoft Teams 쉽게 제공합니다. |
| 회사 본사 위치 | 독일 |
| 앱 정보 페이지 | |
...
이 정보는 Coeus Solutions GmbH에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직이 가지는 컨트롤에 대해 제공됩니다.
...
| 데이터베이스에 저장되는 데이터는 무엇입니까? | 사용자 Microsoft Teams 및 팀 ID를 데이터베이스에 저장합니다. |
...
| 개인 정보 취급 방침 URL | https://getbravo.io/privacy-policy |
