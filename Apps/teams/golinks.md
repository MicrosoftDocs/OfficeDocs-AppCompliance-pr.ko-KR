---
title: GoLinks의 GoLinks에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/18/2022
...
description: GoLinks에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보
...
* <a href="https://teams.microsoft.com/l/app/c1abaf93-e823-4e9a-a810-34a47e77ef71" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003853" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

GoLinks에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | GoLinks |
| 회사의 웹 사이트 | [https://www.golinks.io](https://www.golinks.io) |
| 앱 사용 약관 | [https://www.golinks.io/terms.php](https://www.golinks.io/terms.php) |
| 앱의 핵심 기능 | 이동 링크, 이동 링크, 이동/링크 또는 이동 링크라고 하는 GoLinks는 팀에서 공유하는 직관적이고 기억하기 쉬운 짧은 링크입니다. 길고 추한 URL을 브라우저, 전자 메일, 채팅 및 대화에서 직접 사용할 수 있는 사람이 읽을 수 있는 이동 링크로 변환합니다. GoLinks를 사용하면 회사에서 대규모로 작업 정보와 자원에 효율적으로 액세스하고 공유할 수 있습니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://www.golinks.io/golinks.php](https://www.golinks.io/golinks.php) |
...
이 정보는 GoLinks에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직에서 사용할 컨트롤에 대해 제공됩니다.
...
| 데이터베이스에 저장되는 데이터는 무엇입니까? | Microsoft의 테넌트 ID만 저장합니다. |
...
| 개인 정보 취급 방침 URL | https://www.golinks.io/privacy.php |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Read.Group | application | 메시지에 이동/링크가 포함되어 있는지 확인하려면 공용 채널의 메시지에 액세스해야 합니다. | [c1abaf93-e823-4e9a-a810-34a47e77ef71](../azure/c1abaf93-e823-4e9a-a810-34a47e77ef71.md) |
