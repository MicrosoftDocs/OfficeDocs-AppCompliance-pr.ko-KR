---
title: Optmyzr의 Optmyzr에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/26/2021
...
description: Optmyzr, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용 가능한 모든 보안 및 규정 준수 정보
...
* <a href="https://teams.microsoft.com/l/app/a8aefb12-8635-4f30-9759-e889fee14d28" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003395" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Optmyzr에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | Optmyzr |
| 회사의 웹 사이트 | [https://www.optmyzr.com](https://www.optmyzr.com) |
| 앱 사용 약관 | [https://www.optmyzr.com/information/terms-of-use/](https://www.optmyzr.com/information/terms-of-use/) |
| 앱의 핵심 기능 | https://www.optmyzr.com/information/terms-of-use/ |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://www.optmyzr.com/capabilities/reporting/](https://www.optmyzr.com/capabilities/reporting/) |
...
이 정보는 Optmyzr에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직이 하게 될 컨트롤에 대해 제공됩니다.
...
| 데이터베이스에 저장되는 데이터는 무엇입니까? | 사용자 프로필 - 식별자로 사용되는 전자 메일 주소 |
...
| 개인 정보 취급 방침 URL | https://www.optmyzr.com/information/privacy-policy/ |
