---
title: 손끝별 손끝 의사 결정 매트릭스에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/07/2022
...
description: Fingertip 의사 결정 매트릭스, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
---
# <a name="fingertip-decision-matrix"></a>손끝 의사 결정 매트릭스

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2021년 10월 6일</p>

* <a href="https://teams.microsoft.com/l/app/9d9390bb-2d73-4c5e-9609-0ee86fc620ce" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004070" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Fingertip에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | 손가락 |
| 회사 웹 사이트 | [https://www.fingertip.org](https://www.fingertip.org) |
| 앱의 사용 약관 | [https://www.fingertip.org/terms-of-use/](https://www.fingertip.org/terms-of-use/) |
| 앱의 핵심 기능 | 손끝 의사 결정 매트릭스는 여러 가지 요인을 고려해야 할 때 여러 가지 대안 중에서 결정하는 데 도움이 됩니다. 프로세스에 더 명확하고 투명성을 제공하고 편견의 영향을 줄이면서 대안의 우선 순위를 지정하는 데 도움이 됩니다. 의사 결정 매트릭스 by Fingertip을 사용하면 Microsoft Teams를 사용하여 보다 정확하게 의사 결정을 내릴 수 있습니다. |
| 회사 본사 위치 | 핀란드 |
| 앱 정보 페이지 | [https://www.fingertip.org/solutions/fingertip-decision-matr...](https://www.fingertip.org/solutions/fingertip-decision-matrix/) |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대한 Fingertip에서 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 사용자 프로필 정보, 테넌트 ID |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 사용자 프로필 정보, 테넌트 ID |
| 기본 침입이 Microsoft 고객 데이터를 처리하거나 저장하는 경우 이 데이터는 지리적으로 저장되는 위치는 어디인가요? | 핀란드 |
...
| 지원되는 정책 유형 나열 | 다단계 인증, Intune에 등록된 디바이스만 특정 서비스에 액세스할 수 있도록 허용, 사용자 위치 및 IP 범위 제한 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 위임 | 사용자 만들기를 위한 기본 프로필 정보 | [5a6a4d82-42ce-42c4-88f0-df529fe54dcc](../azure/5a6a4d82-42ce-42c4-88f0-df529fe54dcc.md) |
>| User.ReadBasic.All | 위임 | 사용자 만들기를 위한 기본 프로필 정보 | [5a6a4d82-42ce-42c4-88f0-df529fe54dcc](../azure/5a6a4d82-42ce-42c4-88f0-df529fe54dcc.md) |
>| 전자 메일 | 위임 | 사용자 만들기를 위한 기본 프로필 정보 | [5a6a4d82-42ce-42c4-88f0-df529fe54dcc](../azure/5a6a4d82-42ce-42c4-88f0-df529fe54dcc.md) |
>| offline_access | 위임 | 사용자가 연결을 끊는 경우 | [5a6a4d82-42ce-42c4-88f0-df529fe54dcc](../azure/5a6a4d82-42ce-42c4-88f0-df529fe54dcc.md) |
>| openid | 위임 | 서명하세요 | [5a6a4d82-42ce-42c4-88f0-df529fe54dcc](../azure/5a6a4d82-42ce-42c4-88f0-df529fe54dcc.md) |
>| 프로필 | 위임 | 사용자 만들기를 위한 기본 프로필 정보 | [5a6a4d82-42ce-42c4-88f0-df529fe54dcc](../azure/5a6a4d82-42ce-42c4-88f0-df529fe54dcc.md) |
