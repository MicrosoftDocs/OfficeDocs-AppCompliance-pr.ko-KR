---
title: Workday Peakon Employee Voice by Workday에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/26/2022
...
description: Workday Peakon Employee Voice, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
<p>개발자가 마지막으로 업데이트한 날짜: 2021년 7월 20일</p>

* <a href="https://teams.microsoft.com/l/app/1c37bec0-d522-4cba-9643-ddc79d841729" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003453" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Workday에서 Microsoft에 제공하는 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | Workday Peakon Employee Voice |
| ID | WA200003453 |
| 지원되는 Office 365 클라이언트 | Microsoft Teams |
| 파트너 회사 이름 | Workday |
| 회사 웹 사이트 | [https://www.workday.com/en-us/homepage.html](https://www.workday.com/en-us/homepage.html) |
| 앱의 사용 약관 | [https://nw.myworkday.com/workdaypeakonemployeevoiceforteams...](https://nw.myworkday.com/workdaypeakonemployeevoiceforteams/post-license/) |
| 앱의 핵심 기능 | 새 설문 조사에 대한 알림 받기 Microsoft Teams 아직 완료하지 않은 설문 조사에 대해 알려야 합니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://nw.myworkday.com/workdaypeakonemployeevoiceforteams](https://nw.myworkday.com/workdaypeakonemployeevoiceforteams) |
...
이 정보는 Workday에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 이메일 및 Azure Active Director ID - MS Teams 앱용 Peakon은 데이터를 직접 처리하지 않습니다.  |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 회사 ID, 애플리케이션 로그 |
...
| 개인 정보 취급 방침 URL | https://www.workday.com/en-us/privacy.html |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsAppInstallation.ReadWriteForUser.All | 응용 프로그램 | Azure Database 내에서 앱 설치 및 사용자 찾기   | [075a01db-a69f-4975-a713-aa85d004f3b5](../azure/075a01db-a69f-4975-a713-aa85d004f3b5.md) |
