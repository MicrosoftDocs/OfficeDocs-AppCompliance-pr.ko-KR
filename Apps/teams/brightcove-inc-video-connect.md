---
title: Brightcove의 Brightcove Video 커넥트 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/20/2021
...
description: Brightcove Video 커넥트, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/af7b350c-9e21-49a2-98b8-679327ed31c3" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003247" target="_blank">AppSource에서 보기</a>
...
| 회사 웹 사이트 | [https://www.brightcove.com/en/](https://www.brightcove.com/en/) |
| 앱의 사용 약관 | [https://www.brightcove.com/en/terms-and-conditions/](https://www.brightcove.com/en/terms-and-conditions/) |
| 앱의 핵심 기능 | Brightcove Video 커넥트 Microsoft Teams 내에서 직접 비디오 및 미디어 자산에 대한 공동 작업 옵션을 지원합니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://integrations.support.brightcove.com/teams/installat...](https://integrations.support.brightcove.com/teams/installation.html) |
...
이 정보는 Brightcove Inc.에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 제공되었습니다.
