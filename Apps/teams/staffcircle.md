...
description: StaffCircle, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보
...
| 회사의 웹 사이트 | [https://www.staffcircle.com](https://www.staffcircle.com) |
| 앱 사용 약관 | [https://www.staffcircle.com/terms](https://www.staffcircle.com/terms) |
| 앱의 핵심 기능 | 원격 작업자를 위한 내부 통신, 문화권, 참여 및 성능 관리 플랫폼 |
| 회사 본사 위치 | 영국 및 북아일랜드 (the) |
| 앱 정보 페이지 | [https://www.staffcircle.com/integrations/microsoft-teams-in...](https://www.staffcircle.com/integrations/microsoft-teams-integration/) |
