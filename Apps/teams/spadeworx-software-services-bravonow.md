---
title: SpadeWorx Software Services의 브라보나우 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/10/2021
...
description: 브라보나우에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보.
...
* <a href="https://teams.microsoft.com/l/app/272032ad-0c2e-4928-910e-5d52b19f70d5" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000157" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

SpadeWorx Software Services에서 Microsoft에 제공하는 정보:
...
| 회사 웹 사이트 | [https://www.spadeworx.com](https://www.spadeworx.com) |
| 앱의 사용 약관 | [https://docs.pozitive.io/BRAVO_TermsOfService.pdf](https://docs.pozitive.io/BRAVO_TermsOfService.pdf) |
| 앱의 핵심 기능 | 브라보는 피어 투 피어 직원 인식 플랫폼입니다. |
| 회사 본사 위치 | 인도 |
| 앱 정보 페이지 | [https://bravo.pozitive.io](https://bravo.pozitive.io) |
...
이 정보는 SpadeWorx Software Services에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 위임 | 사용자 이메일 주소입니다. | [272032ad-0c2e-4928-910e-5d52b19f70d5](../azure/272032ad-0c2e-4928-910e-5d52b19f70d5.md) |
