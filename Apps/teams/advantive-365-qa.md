...
description: 'CSA STAR 레지스트리의 365-QA에 대해 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보'
...
<p>개발자가 마지막으로 업데이트한 날짜: 2021년 12월 28일</p>
...
| 파트너 회사 이름 | Advantive |
| 회사의 웹 사이트 | [https://www.advantive.be](https://www.advantive.be) |
| 앱 사용 약관 | [https://www.advantive.be/terms-of-service-en/](https://www.advantive.be/terms-of-service-en/) |
| 앱의 핵심 기능 | Advantive는 Microsoft 기술을 사용하여 혁신적인 ICT 솔루션을 개발하고 구현하는 ICT 전문가의 열정적인 팀입니다. 표준 Microsoft 기능을 기반으로 최고 품질의 조언, 제품 및 서비스를 제공합니다. 이를 통해 Adventive는&#8217;효율성을 높이고 빠르게 변화하는 상황을 활용할 수 있습니다. 핵심 비즈니스는 조언, 개발, 구현, 프로젝트 지원 및 유지 관리가 포함된 서비스를 제공하는 것입니다. |
| 회사 본사 위치 | 벨기에 |
| 앱 정보 페이지 | [https://www.advantive.be/365-qa-how-to/](https://www.advantive.be/365-qa-how-to/) |
