---
title: ORCA SECURITY LTD의 Orca 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/31/2022
...
description: Orca에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
ms.locfileid: "65874287"
---
# <a name="orca"></a>Orca

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 5월 27일</p>

* <a href="https://teams.microsoft.com/l/app/50423b81-408b-4699-a850-9a0514ee42c3" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004132" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

ORCA SECURITY LTD에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | ORCA SECURITY LTD |
| 회사 웹 사이트 | [https://orca.security](https://orca.security) |
| 앱의 사용 약관 | [https://orca.security/terms-of-use](https://orca.security/terms-of-use) |
| 앱의 핵심 기능 | Microsoft Teams 대한 Orca Security는 클라우드 환경 보안 상태에 대한 실시간 그림을 제공합니다. 사용자는 두 도구를 하나의 보기로 결합하여 클라우드 환경의 보안 문제에 대한 생산적인 토론을 만들 수 있습니다. Orca 경고는 보안 위험 결과 및 위험을 초래하는 연결된 클라우드 리소스를 포함하는 특정 클라우드 위험을 자세히 설명합니다. |
| 회사 본사 위치 | 이스라엘 |
| 앱 정보 페이지 | |
...
이 정보는 ORCA SECURITY LTD에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | Teams 사용자 ID, 팀 ID, 팀 이름 |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | Teams 사용자 ID, 팀 ID, 팀 이름 |
...
| 개인 정보 취급 방침 URL | https://orca.security/privacy-policy/ |
