...
description: Teamhood에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보
...
| 회사의 웹 사이트 | [https://teamhood.com](https://teamhood.com) |
| 앱 사용 약관 | [https://teamhood.com/terms-of-use/](https://teamhood.com/terms-of-use/) |
| 앱의 핵심 기능 | Teamhood는 효율적인 일상적인 공동 작업을 위한 프로젝트 및 작업 관리 올인원 소프트웨어입니다. 팀에서는 모든 프로젝트 관리자와 팀 구성원이 작업 데이터를 계획, 실행 및 보고하는 데 필요한 기능을 제공합니다. |
| 회사 본사 위치 | 리투아니아 |
| 앱 정보 페이지 | [https://teamhood.com/features/teamhood-and-microsoft-teams-...](https://teamhood.com/features/teamhood-and-microsoft-teams-integration/) |
