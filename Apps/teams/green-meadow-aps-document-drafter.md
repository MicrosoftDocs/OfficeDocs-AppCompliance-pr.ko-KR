---
title: Green Meadow ApS의 문서 초안 작성자에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/06/2022
...
description: Document Drafter에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
ms.locfileid: "65357087"
---
# <a name="document-drafter"></a>문서 초안

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 2월 2일</p>

* <a href="https://teams.microsoft.com/l/app/6b96e77c-08d1-432e-819f-7dc7b6585a1a" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004059" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Green Meadow ApS에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | 그린 메도우 ApS |
| 회사 웹 사이트 | [https://gmeadow.com](https://gmeadow.com) |
| 앱의 사용 약관 | [https://tinyurl.com/2p9dw3tm](https://tinyurl.com/2p9dw3tm) |
| 앱의 핵심 기능 | Microsoft Teams 내에서 자동화된 문서를 사용하고 공동 작업합니다. |
| 회사 본사 위치 | 덴마크 |
| 앱 정보 페이지 | [https://gmeadow.com/document-drafter-inside-microsoft-teams/](https://gmeadow.com/document-drafter-inside-microsoft-teams/) |
...
이 정보는 Green Meadow ApS에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 전자 메일 ID, 이름 및 보안 그룹입니다. |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 전자 메일 ID, 이름 및 보안 그룹입니다. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 둘 다 | 애플리케이션에서 생성된 문서를 저장할 때 사용자가 폴더를 찾아보는 데 필요한 채널에서 사람 라이브러리를 읽으려면 | [1c529524-183e-40db-b1d7-1acf275354b4](../azure/1c529524-183e-40db-b1d7-1acf275354b4.md) |
>| Files.ReadWrite.All | 위임 | 사용자가 애플리케이션에서 생성된 문서를 저장하는 폴더를 찾아보거나 만들 수 있습니다. | [1c529524-183e-40db-b1d7-1acf275354b4](../azure/1c529524-183e-40db-b1d7-1acf275354b4.md) |
>| Group.ReadWrite.All | 위임 | 액세스 관리 목적으로 Teams 멤버를 식별합니다. | [1c529524-183e-40db-b1d7-1acf275354b4](../azure/1c529524-183e-40db-b1d7-1acf275354b4.md) |
>| TeamsActivity.Send | 위임 | 설문지/설문지 업데이트 등에 대한 메시지 보내기 | [1c529524-183e-40db-b1d7-1acf275354b4](../azure/1c529524-183e-40db-b1d7-1acf275354b4.md) |
>| User.Read.All | 위임 | 전체 프로필을 읽고 어떤 그룹 멤버 자격 사용자가 있는지 알아보려면 Teams 활동 피드로 메시지를 보내는 데 사용됩니다. | [1c529524-183e-40db-b1d7-1acf275354b4](../azure/1c529524-183e-40db-b1d7-1acf275354b4.md) |
>| 전자 메일 | 위임 | 백 엔드 시스템에서 사용자를 식별하기 위해 전자 메일 ID를 사용합니다. | [1c529524-183e-40db-b1d7-1acf275354b4](../azure/1c529524-183e-40db-b1d7-1acf275354b4.md) |
>| openid | 위임 | 사용자 인증. | [1c529524-183e-40db-b1d7-1acf275354b4](../azure/1c529524-183e-40db-b1d7-1acf275354b4.md) |
>| 프로필 | 위임 | 사용자의 아바타/사진을 가져오면 사용자 환경을 향상시킵니다(있는 경우). | [1c529524-183e-40db-b1d7-1acf275354b4](../azure/1c529524-183e-40db-b1d7-1acf275354b4.md) |
