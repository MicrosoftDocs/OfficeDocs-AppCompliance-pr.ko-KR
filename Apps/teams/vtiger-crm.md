---
title: Vtiger별 Vtiger CRM에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Vtiger CRM, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/08cb9b41-2ceb-4fe1-b85b-6eb6128aa138" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003089" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Vtiger에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | Vtiger |
| 회사 웹 사이트 | [https://www.vtiger.com](https://www.vtiger.com) |
| 앱의 사용 약관 | [https://www.vtiger.com/policy-legal-center/terms-of-service/](https://www.vtiger.com/policy-legal-center/terms-of-service/) |
| 앱의 핵심 기능 | Vtiger CRM을 커넥트 팀 내에서 거래, 사례, 작업 또는 연락처를 보고 공유합니다. |
| 회사 본사 위치 | 인도 |
| 앱 정보 페이지 | [https://help.vtiger.com/article/149601890-MS-Teams-and-Vtig...](https://help.vtiger.com/article/149601890-MS-Teams-and-Vtiger-CRM-Integration) |
...
이 정보는 Vtiger에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
...
| 지원되는 정책 유형 나열 | IP 주소에 따른 제한 사항입니다. 역할 및 프로필을 사용하여 데이터 액세스 제어 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 응용 프로그램 | AuthToken에 대해 확인하기 위해 이메일 주소를 가져옵니다. | [7a483472-4f1b-4c75-bff3-7a48dae227dc](../azure/7a483472-4f1b-4c75-bff3-7a48dae227dc.md) |
