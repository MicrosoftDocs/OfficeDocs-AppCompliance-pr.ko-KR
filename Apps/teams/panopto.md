...
* <a href="https://teams.microsoft.com/l/app/adb3c870-c01c-11eb-a2cc-4dbd838985a1" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003801" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Panopto에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | Panopto |
| 회사의 웹 사이트 | [https://www.panopto.com](https://www.panopto.com) |
| 앱 사용 약관 | [https://www.panopto.com/terms-of-service/](https://www.panopto.com/terms-of-service/) |
| 앱의 핵심 기능 | Teams 기록을 Panopto로 내보낼 수 있으며, 이 기록을 남기지 않고 Panopto 비디오를 검색, 공유 및 Teams.  모든 모임의 시각적 인덱스, 사람이 확인한 닫힌 캡션 등의 기능을 추가합니다. 이동하지 않고도 Panopto 기능 Teams: Panopto 폴더에 매핑된 새 채널 탭을 만들고, Panopto 비디오를 검색 및 공유하고, 예약된 모임에 Panopto 비디오를 표시하고, 새 Panopto 비디오가 준비되면 알림을 수신합니다. Panopto 사이트가 필요하세요? 시작 www.panopto.com/plans 방문합니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
...
이 정보는 Panopto에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직에서 제공하는 컨트롤에 대해 제공됩니다.
...
| 가장 최근 SOC2 인증 날짜 |  2021-08-19 |
| 앱이 SOC(서비스 조직 제어)를 준수하나요? | 예 |
| 가장 최근 SOC3 인증 날짜 |  2021-10-13 |
...
| 개인 정보 취급 방침 URL | https://www.panopto.com/privacy/ |
