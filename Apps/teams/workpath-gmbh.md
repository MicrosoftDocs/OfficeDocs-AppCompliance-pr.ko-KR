---
title: Workpath GmbH별 Workpath에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/07/2022
...
description: Workpath에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/8562f79a-0ba8-4555-a967-6e34bdfecca9" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003898" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Microsoft에 대한 Workpath GmbH에서 제공하는 정보:
...
| 파트너 회사 이름 | Workpath GmbH |
| 회사 웹 사이트 | [https://www.workpath.com/en/home](https://www.workpath.com/en/home) |
| 앱의 사용 약관 | [https://www.workpath.com/en/workpath-ms](https://www.workpath.com/en/workpath-ms) |
| 앱의 핵심 기능 | Workpath OKR을 사용하여 전략적 목표를 달성하세요. |
| 회사 본사 위치 | 독일 |
| 앱 정보 페이지 | [https://workpath.zendesk.com/hc/en-us/articles/455508104360...](https://workpath.zendesk.com/hc/en-us/articles/4555081043602-Using-the-MS-Teams-integration) |
...
이 정보는 Workpath GmbH에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
...
| 개인 정보 취급 방침 URL | https://www.workpath.com/en/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 위임 | 로그인한 사용자의 테넌트 읽기 | [dc8facfc-c606-44b4-a0ad-04f81446845c](../azure/dc8facfc-c606-44b4-a0ad-04f81446845c.md) |
