---
title: askR.ai 의해 Kaptain 찰리에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/29/2021
...
description: Kaptain Charlie에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://appsource.microsoft.com/product/office/WA200001583" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Microsoft에 askR.ai 제공한 정보:
...
| 파트너 회사 이름 | askR.ai |
| 회사 웹 사이트 | [https://en.askr.ai](https://en.askr.ai) |
| 앱의 사용 약관 | [https://en.askr.ai/terms-of-use-askr-ai](https://en.askr.ai/terms-of-use-askr-ai) |
| 앱의 핵심 기능 | 데이터와 채팅! askR.ai 개인 데이터 도우미인 경우 데이터가 있지만 액세스하는 기술 프로세스가 마음에 들지 않습니까? 데이터 도우미를 사용하여 질문에 답변하고 탐색하는 데 도움을 주세요! Microsoft Teams 첫 번째 데이터 도우미인 askR.ai 무엇인가요? - AI 기반 개인 데이터 도우미 - 인스턴트 KPI 및 데이터 viz 제공 - 특정 비즈니스 어휘 이해 - 경고 보내기 - 추가 분석 제안 |
| 회사 본사 위치 | 프랑스 |
| 앱 정보 페이지 | [https://en.askr.ai](https://en.askr.ai) |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직의 제어에 대한 askR.ai 제공되었습니다.
...
| 앱에서 위의 라이브러리 중 하나를 사용하지 않는 경우 어떤 인증 라이브러리 또는 라이브러리를 사용하나요? | OAuth 라이브러리 |
