...
| 앱의 핵심 기능 | Powell Teams 앱은 모든 회사 직원을 위한 스마트 대시보드를 제공하고, 모든 팀의 태그를 쉽게 구성 &amp; 하고, 가장 중요한 승격된 회사 팀을 검색하고, 마지막으로 미리 정의된 역할 기반 팀 템플릿을 사용하여 시간을 절약할 수 있도록 지원합니다. 또한 API를 사용하여 Powell Teams 데이터베이스에서 데이터 집합을 검색하고 작업할 수 있습니다(https://docapiteams.powell-software.com) 마지막으로 Logic Apps 및 Power Automate 대한 커넥터도 사용할 수 있음)https://docs.microsoft.com/en-us/connectors/powellteams) |
| 회사 본사 위치 | 프랑스 |
