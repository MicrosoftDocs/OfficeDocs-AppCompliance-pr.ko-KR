...
description: Rafiky, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용 가능한 모든 보안 및 규정 준수 정보
...
| 회사의 웹 사이트 | [https://rafiky.net/en/](https://rafiky.net/en/) |
| 앱 사용 약관 | [https://rafiky.net/en/terms-conditions/](https://rafiky.net/en/terms-conditions/) |
| 앱의 핵심 기능 | Rafiky는 온라인 이벤트에 대해 원격 동시 해석을 수행하도록 설계된 매우 유연하고 액세스 가능한 클라우드 플랫폼 솔루션입니다. 원격&#8217;혁신적인 비전입니다. 이 기능을 사용하면 전문 해석가가 언제 어디서나 작업할 수 있습니다. |
| 회사 본사 위치 | 이탈리아 |
| 앱 정보 페이지 | |
