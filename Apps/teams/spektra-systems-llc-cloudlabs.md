...
description: CloudLabs에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보
...
| 회사의 웹 사이트 | [https://cloudlabs.ai](https://cloudlabs.ai) |
| 앱 사용 약관 | [https://cloudlabs.ai/terms-of-use/](https://cloudlabs.ai/terms-of-use/) |
| 앱의 핵심 기능 | CloudLabs 연습 테스트를 연습하여 Microsoft 클라우드 기본 인증 준비 |
| 회사 본사 위치 | 미국 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 위임 | 이름, 전자 메일, - 개인 설정 환경 및 지원을 제공할 수 있습니다. | [539ffd4e-15ba-4d18-b136-0d73b67d05f0](../azure/539ffd4e-15ba-4d18-b136-0d73b67d05f0.md) |
