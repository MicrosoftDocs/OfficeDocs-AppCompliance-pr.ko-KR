---
title: In Summa의 Webdashboard에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/14/2021
...
description: Webdashboard에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/e0b1ef6e-9433-44ef-97eb-f1f97ff2aa1a" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002970" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

In Summa에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | In Summa |
| 회사 웹 사이트 | [https://www.webdashboard.com](https://www.webdashboard.com) |
| 앱의 사용 약관 | [https://webdashboard.com/wp-content/uploads/2021/06/Nederla...](https://webdashboard.com/wp-content/uploads/2021/06/Nederland-ICT-Voorwaarden-2014-EN.pdf) |
| 앱의 핵심 기능 | Webdashboard를 통한 단일 Sign-On 사용하여 모든 Power BI 보고서를 탭으로 포함 |
| 회사 본사 위치 | 네덜란드 (the) |
...
이 정보는 In Summa에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직의 제어에 대해 제공되었습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.ReadWrite.All | 응용 프로그램 | 사용자에 대한 Single Sign-On | [38b3f4fa-4229-4d51-9937-6e4515650c8c](../azure/38b3f4fa-4229-4d51-9937-6e4515650c8c.md) |
