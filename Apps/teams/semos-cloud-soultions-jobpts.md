---
title: Semos Cloud Soultions의 JobPts에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: JobPts에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/601a47bc-f201-4398-a0cb-593ea081f265" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001849" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Semos Cloud Soultions에서 Microsoft에 제공하는 정보:
...
| 회사 웹 사이트 | [https://semoscloud.com](https://semoscloud.com) |
| 앱의 사용 약관 | [https://semoscloud.com/terms-of-use/](https://semoscloud.com/terms-of-use/) |
| 앱의 핵심 기능 | MsTeams를 떠나지 않고도 잘 수행된 작업을 위해 동료를 쉽게 인식 |
| 회사 본사 위치 | 미국 |
...
이 정보는 Semos Cloud Soultions에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
...
>| 전자 메일 | 위임 | 이는 JobPts 도구의 사용자와 AzureAD 사용자를 매핑하는 데 사용됩니다. | [1ac9e5c6-4850-4864-96c5-b91e4512334e](../azure/1ac9e5c6-4850-4864-96c5-b91e4512334e.md) |
>| offline_access | 위임 | 데이터에 대한 액세스 유지 관리 | [1ac9e5c6-4850-4864-96c5-b91e4512334e](../azure/1ac9e5c6-4850-4864-96c5-b91e4512334e.md) |
>| openid | 위임 | 사용자가 회사 계정으로 로그인할 수 있도록 하려면 | [1ac9e5c6-4850-4864-96c5-b91e4512334e](../azure/1ac9e5c6-4850-4864-96c5-b91e4512334e.md) |
>| 프로필 | 위임 | JobPts가 사용자의 기본 정보를 볼 수 있도록 하려면(사용자 이름) | [1ac9e5c6-4850-4864-96c5-b91e4512334e](../azure/1ac9e5c6-4850-4864-96c5-b91e4512334e.md) |
