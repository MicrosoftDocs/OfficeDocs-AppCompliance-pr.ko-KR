...
| 파트너 회사 이름 | Koan, Inc. |
| 회사의 웹 사이트 | [https://www.koan.co](https://www.koan.co) |
| 앱 사용 약관 | [https://www.koan.co/terms-of-service](https://www.koan.co/terms-of-service) |
| 앱의 핵심 기능 | 목표 관리 및 상태 추적을 팀에 직접 Microsoft Teams 진행 상황을 보고 팀을 정렬합니다. Koan&#8217;통합을 통해 직원들은 업무를 떠나지 않고도 가장 중요한 업무에 집중할 Microsoft Teams. 쉽게 공유 상태의 긍정적인 팀 습관을 구축하고, wins를 인식하고, 문제를 조기 식별하여 주변의 모든 사용자에 대한 바를 높입니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | 위임 | 채널 ID 및 채널 이름이 사용됩니다. 사용자가 리플렉션 알림을 전달할 위치를 선택할 수 있도록 데이터를 사용 합니다. | [5b599e19-a609-432b-9074-c9d4457e8766](https://docs.microsoft.com/microsoft-365-app-certification/azure/5b599e19-a609-432b-9074-c9d4457e8766) |
>| Team.ReadBasic.All | 둘 다 | 팀 ID와 팀 이름이 모두 수집되고 사용됩니다. 사용자가 리플렉션 알림을 전달할 위치를 선택할 수 있도록 데이터를 사용 합니다. | [5b599e19-a609-432b-9074-c9d4457e8766](https://docs.microsoft.com/microsoft-365-app-certification/azure/5b599e19-a609-432b-9074-c9d4457e8766) |
>| User.Read | 위임 | 사용자 이름, 사용자 ID, 사용자 전자 메일 주소가 사용됩니다. 데이터를 사용하여 사용자 계정을 Microsoft Teams 있습니다. 인시에만 적용됩니다. | [5b599e19-a609-432b-9074-c9d4457e8766](https://docs.microsoft.com/microsoft-365-app-certification/azure/5b599e19-a609-432b-9074-c9d4457e8766) |
