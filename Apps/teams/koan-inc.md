---
title: Koan, Inc.의 Koan에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/18/2021
...
description: Koan에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보.
...
* <a href="https://teams.microsoft.com/l/app/dae2b2c3-b014-4188-a887-c87c3ca4a227" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002936" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Koan, Inc.에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | Koan, Inc. |
| 회사 웹 사이트 | [https://www.koan.co](https://www.koan.co) |
| 앱의 사용 약관 | [https://www.koan.co/terms-of-service](https://www.koan.co/terms-of-service) |
| 앱의 핵심 기능 | 목표 관리 및 상태 추적을 Microsoft Teams 직접 가져와 진행 상황을 확인하고 팀을 정렬합니다. Koan&#8217;통합을 통해 직원들은 Microsoft Teams 나가지 않고도 가장 중요한 업무에 집중할 수 있습니다. 상태를 공유하고, 승리를 인식하고, 문제를 조기에 식별하는 긍정적인 팀 습관을 쉽게 구축하여 주변의 다른 모든 사람들에게 기준을 높입니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://www.koan.co/how-it-works](https://www.koan.co/how-it-works) |
...
이 정보는 Koan, Inc.에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직의 제어에 대해 제공되었습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | 위임 | 채널 ID 및 채널 이름이 사용됩니다. 사용자가 리플렉션 알림을 제공할 위치를 선택할 수 있도록 데이터를 사용합니다. | [5b599e19-a609-432b-9074-c9d4457e8766](../azure/5b599e19-a609-432b-9074-c9d4457e8766.md) |
>| Team.ReadBasic.All | 모두 | 팀 ID와 팀 이름은 모두 수집되고 사용됩니다. 사용자가 리플렉션 알림을 제공할 위치를 선택할 수 있도록 데이터를 사용합니다. | [5b599e19-a609-432b-9074-c9d4457e8766](../azure/5b599e19-a609-432b-9074-c9d4457e8766.md) |
>| User.Read | 위임 | 사용자 이름, 사용자 ID, 사용자 전자 메일 주소가 사용됩니다. 데이터를 사용하여 Microsoft Teams Koan 간에 사용자 계정을 연결합니다. 언급 시에만 적용됩니다. | [5b599e19-a609-432b-9074-c9d4457e8766](../azure/5b599e19-a609-432b-9074-c9d4457e8766.md) |
