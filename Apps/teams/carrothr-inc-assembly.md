---
title: 캐럿HR Inc.의 어셈블리에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/08/2021
...
description: 어셈블리에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/3e674b5f-ba5d-41cc-8b06-e065b4394aeb" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002271" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

당근HR Inc.가 Microsoft에 제공한 정보:
...
| 회사 웹 사이트 | [https://www.joinassembly.com](https://www.joinassembly.com) |
| 앱의 사용 약관 | [https://joinassembly.com/terms-of-service](https://joinassembly.com/terms-of-service) |
| 앱의 핵심 기능 | 어셈블리는 직원 참여 및 인식 플랫폼입니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://www.joinassembly.com/about](https://www.joinassembly.com/about) |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 CarrotHR Inc.에서 제공했습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.Create | 위임 | 사용자가 앱에서 새로 만든 채널에 앱을 할당하도록 허용 | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](../azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905.md) |
>| Directory.Read.All | 응용 프로그램 | 어셈블리에서 멤버를 제대로 검색할 수 있도록 프로필을 동기화 상태로 유지 | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](../azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905.md) |
>| Group.Read.All | 위임 | 데이터를 관찰하여 올바른 그룹에 앱을 할당할 수 있는지 확인합니다. | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](../azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905.md) |
>| Teams. ReadBasic.All | 응용 프로그램 | 올바른 팀 탭에 앱을 할당하는 기능 | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](../azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905.md) |
>| TeamsTab.Create | 응용 프로그램 | 앱을 채널/팀에 제대로 추가할 수 있도록 이 기능을 사용합니다. | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](../azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905.md) |
>| 전자 메일 | 위임 | 사용자의 전자 메일을 통해 특정 계정에 대한 액세스 권한을 부여할 수 있습니다. | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](../azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905.md) |
>| 프로필 | 위임 | 어셈블리를 자동으로 입력하고 Microsoft Teams 변경 내용과 동기화를 유지하는 사용자 이름 | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](../azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905.md) |
