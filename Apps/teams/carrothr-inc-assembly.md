...
* <a href="https://teams.microsoft.com/l/app/3e674b5f-ba5d-41cc-8b06-e065b4394aeb" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002271" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

CarrotHR Inc.에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | CarrotHR Inc. |
| 회사의 웹 사이트 | [https://www.joinassembly.com](https://www.joinassembly.com) |
| 앱 사용 약관 | [https://joinassembly.com/terms-of-service](https://joinassembly.com/terms-of-service) |
| 앱의 핵심 기능 | 어셈블리는 직원 참여 및 인식 플랫폼입니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
...
이 정보는 CarrotHR Inc.에서 이 앱이 조직 데이터를 수집 및 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직에서 사용할 컨트롤에 대해 제공됩니다.
...
| 가장 최근 SOC1 인증 날짜 |  2020-09-01 |
| 앱이 SOC(서비스 조직 제어)를 준수하나요? | 예 |
| 어떤 SOC 2 인증을 획득했나요? |   |
| 가장 최근 SOC2 인증 날짜 |  2021-02-28 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.Create | 위임 | 사용자가 앱에서 만든 채널에 앱을 할당할 수 있도록 허용 | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](https://docs.microsoft.com/microsoft-365-app-certification/azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905) |
>| Directory.Read.All | application | 어셈블리에서 구성원을 제대로 검색할 수 있도록 프로필을 동기화된 것으로 유지 | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](https://docs.microsoft.com/microsoft-365-app-certification/azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905) |
>| Group.Read.All | 위임 | 데이터를 관찰하여 앱이 올바른 그룹에 할당될 수 있는지 확인합니다. | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](https://docs.microsoft.com/microsoft-365-app-certification/azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905) |
>| Teams. ReadBasic.All | application | 올바른 팀 탭에 앱을 할당하는 능력 | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](https://docs.microsoft.com/microsoft-365-app-certification/azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905) |
>| TeamsTab.Create | application | 이 기능을 사용하여 앱을 채널/팀에 올바르게 추가하도록 허용합니다. | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](https://docs.microsoft.com/microsoft-365-app-certification/azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905) |
>| 전자 메일 | 위임 | 특정 계정에 대한 액세스 권한을 부여할 수 있도록 사용자의 전자 메일 | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](https://docs.microsoft.com/microsoft-365-app-certification/azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905) |
>| 프로필 | 위임 | 어셈블리를 자동으로 입력하고 변경 내용과 동기화를 유지할 사용자 Microsoft Teams | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](https://docs.microsoft.com/microsoft-365-app-certification/azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905) |
