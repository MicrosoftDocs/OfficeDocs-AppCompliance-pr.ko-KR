---
title: SysAid별 SysAid에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/03/2022
...
description: SysAid에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
ms.locfileid: "64880516"
---
# <a name="sysaid"></a>SysAid

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 1월 3일</p>

* <a href="https://teams.microsoft.com/l/app/932c8be4-fac6-4df3-9e15-bc542f4ef88e" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003221" target="_blank">AppSource에서 보기</a>
...
| 파트너 회사 이름 | SysAid |
| 회사 웹 사이트 | [https://www.sysaid.com](https://www.sysaid.com) |
| 앱의 사용 약관 | [https://www.sysaid.com/wp-content/uploads/service-agreement...](https://www.sysaid.com/wp-content/uploads/service-agreement-cloud.pdf) |
| 앱의 핵심 기능 | 봇을 사용하여 Microsoft Teams SysAid 티켓 만들기 |
| 회사 본사 위치 | 이스라엘 |
| 앱 정보 페이지 | |
...
이 정보는 SysAid에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
