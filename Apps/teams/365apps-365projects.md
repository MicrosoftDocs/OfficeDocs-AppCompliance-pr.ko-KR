---
title: 365Apps별 365Projects에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/03/2022
...
description: 365Projects, 해당 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://appsource.microsoft.com/product/office/WA200002160" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

365Apps에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | 365Apps |
| 회사 웹 사이트 | [https://365apps.com.au](https://365apps.com.au) |
| 앱의 사용 약관 | [https://365projects.app/eula](https://365projects.app/eula) |
| 앱의 핵심 기능 | 프로젝트를 &amp; 함께 Microsoft Teams Project 만들기, 기존/새 채널에 연결 |
| 회사 본사 위치 | 오스트레일리아 |
| 앱 정보 페이지 | [https://365projects.app](https://365projects.app) |
...
이 정보는 365Apps에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 아니요 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 고객 전자 메일 주소 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Tasks.ReadWrite | 위임 | Planner 작업 읽기 및 업데이트 | [99a0a9b1-5d28-45df-9f99-792aa32795f4](../azure/99a0a9b1-5d28-45df-9f99-792aa32795f4.md) |
>| User.Read | 위임 | 사용자 전자 메일 읽기 | [99a0a9b1-5d28-45df-9f99-792aa32795f4](../azure/99a0a9b1-5d28-45df-9f99-792aa32795f4.md) |
