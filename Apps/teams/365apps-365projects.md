...
description: 365Project에 대한 모든 사용 가능한 보안 및 규정 준수 정보 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보.
...
ms.locfileid: "52553469"
---
# <a name="365projects"></a>365Projects

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>최종 업데이트: 2021년 3월 16일</p>

* <a href="https://teams.microsoft.com/l/app/a9c31598-b014-4e20-b3bd-3d275fa738d3" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002160" target="_blank">앱소스에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

마이크로 소프트에 365앱에서 제공하는 정보 :
...
| 파트너 회사 이름 | 365Apps |
| 파트너 웹사이트의 URL | [https://365projects.app](https://365projects.app) |
| Teams 응용 프로그램 정보 페이지의 URL | [https://365projects.app](https://365projects.app) |
| 개인정보 처리방침의 URL | [https://365projects.app/privacy](https://365projects.app/privacy) |
| 이용 약관의 URL | [https://365projects.app/eula](https://365projects.app/eula) |
...
이 정보는 365Apps에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직이 가질 수 있는 제어에 대해 제공했습니다.
...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| 채널.읽기기본.모든 것 | 위임 | 프로젝트와 채널을 연결하는 팀 내채널 | 프로젝트와 채널을 연결하는 팀 내채널 | 99a0a9b1-5d28-45df-9f99-792aaa32795f4 |
>| Group.Read.All | 위임 | 팀 플래너 / 플래너 작업을 얻을, 다른 최소 권한 범위는 응용 프로그램이 사용자 계획 및 계획 작업을 얻을 수 있지만 슬프게도이 것을 허용하는 범위가없는 경우 더 좋을 것입니다 | DB에 저장하지 않음 | 99a0a9b1-5d28-45df-9f99-792aaa32795f4 |
>| Group.ReadWrite.All | 신청 | Teams 만들기  | DB에 저장되지 않음 | 99a0a9b1-5d28-45df-9f99-792aaa32795f4 |
>| 사람들.읽기 | 위임 | 사용자 이름, 팀 멤버로 추가하거나 그들에게 작업을 할당 | 사용자 Guid는 작업 할당에 저장됩니다. | 99a0a9b1-5d28-45df-9f99-792aaa32795f4 |
>| 팀.읽기 기본.모든 | 위임 | 팀 이름에 합류하여 프로젝트를 Teams 채널로 연결합니다. | Team Guid는 링크를 설정하기 위해 프로젝트 메타데이터에 저장됩니다. | 99a0a9b1-5d28-45df-9f99-792aaa32795f4 |
>| User.Read | 위임 | 헤더에 표시할 사용자 정보 얻기  | 테넌트를 처음 프로비저닝할 때 사용자 전자 메일이 소유자로 저장됩니다. | 99a0a9b1-5d28-45df-9f99-792aaa32795f4 |
>| User.Read.All | 위임 | 작업 할당을 업데이트하려면 사용자 읽기 | 사용자 Guid만 저장되지 않는 개인 식별 정보는 DB에 저장되지 않습니다. | 99a0a9b1-5d28-45df-9f99-792aaa32795f4 |
...
>앱은 앱 관리자의 Guid와 별도로 사용자 데이터를 저장하지 않습니다(첫 번째 사용자는 테넌트 내에서 앱을 사용합니다). 
...
이 정보는 이 앱이 인증, 권한 부여, 응용 프로그램 등록 모범 사례 및 기타 ID 기준을 처리하는 방법에 대해 365Apps에서 제공되었습니다.
...
| 앱의 경우 무엇을 사용하지 않으려습니까? | ,<br/>- OAuth2 암시적 Flow, SPA에 필요한 경우가 아니면<br/> |
| 앱에서 웹 API가 노출됩니까? | 예 |
