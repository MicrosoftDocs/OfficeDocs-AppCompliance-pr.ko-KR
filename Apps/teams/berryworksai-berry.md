---
title: Berryworks.ai 별 Berry에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/31/2022
...
description: Berry에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/3694c470-c14b-11ec-97bc-6b8526f20a81" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004138" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Microsoft에 Berryworks.ai 제공하는 정보:
...
| 파트너 회사 이름 | Berryworks.ai |
| 회사 웹 사이트 | [https://berryworks.ai](https://berryworks.ai) |
| 앱의 사용 약관 | [https://www.berryworks.ai/tnc/](https://www.berryworks.ai/tnc/) |
| 앱의 핵심 기능 | 직원과 상호 작용하고, 감정을 실시간으로 해석하고, 책임을 추진합니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://berryworks.ai/teams-integration/](https://berryworks.ai/teams-integration/) |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대한 Berryworks.ai 제공되었습니다.
...
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 테넌트 ID, 사용자 통신 ID와 같은 테넌트 정보 |
