---
title: Stylebot Inc.의 Stylebot 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/07/2021
...
description: Stylebot에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
ms.locfileid: "64880535"
---
# <a name="stylebot"></a>Stylebot

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2021년 12월 7일</p>

* <a href="https://teams.microsoft.com/l/app/db9c0532-d5d9-4e1b-839f-3952c88c8ee2" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003177" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Stylebot Inc.가 Microsoft에 제공한 정보:
...
| 회사 웹 사이트 | [https://www.stylebot.app](https://www.stylebot.app) |
| 앱의 사용 약관 | [https://www.stylebot.app/apptermsofservice](https://www.stylebot.app/apptermsofservice) |
| 앱의 핵심 기능 | Stylebot은 최신 언어 및 스타일 설명서를 손쉽게 배치하여 쓰기를 향상시킵니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://www.stylebot.app/msteamshelp](https://www.stylebot.app/msteamshelp) |
...
이 정보는 Stylebot Inc.에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직의 제어에 대해 제공되었습니다.
