...
description: StarLeaf에 대한 사용 가능한 모든 보안 및 규정 준수 정보 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보.
...
* <a href="https://teams.microsoft.com/l/app/220b3db0-e3be-40df-8148-f0e0c33a986a" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000185" target="_blank">앱소스에서 보기</a>
...
| 개인정보 처리방침의 URL | [https://support.starleaf.com/legal-information/starleaf-pri...](https://support.starleaf.com/legal-information/starleaf-privacy-notice/) |
| 이용 약관의 URL | [https://support.starleaf.com/legal-information/starleaf-clo...](https://support.starleaf.com/legal-information/starleaf-cloud-services-customer-terms-of-use/) |
...
>|:--------------------------------|:---------------------|:--------------------------|
>| 봇은 봇을 통해 회의를 예약하는 사용자/호스트를 대신하여 회의를 예약하기 위해 팀 명단에 액세스합니다. 이를 통해 StarLeaf는 회의에 참여할 수 있는 버튼 하나로 원활한 조인 경험을 제공할 수 있습니다. | 이름, 성, 이메일 주소입니다. 이를 통해 StarLeaf 봇은 봇과 상호 작용한 사용자/호스트를 대신하여 회의를 예약하고 팀의 다른 구성원을 회의에 초대할 수 있습니다. |  |
