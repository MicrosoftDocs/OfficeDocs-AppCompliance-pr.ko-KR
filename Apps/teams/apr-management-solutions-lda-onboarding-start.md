---
title: APR에서 온보딩 시작 - 관리 솔루션 Lda에 대한 애플리케이션 정보입니다.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/17/2022
...
description: 온보딩 시작, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
ms.locfileid: "65455029"
---
# <a name="onboarding-start"></a>온보딩 시작

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 4월 8일</p>

* <a href="https://teams.microsoft.com/l/app/35729029-db8c-4cf5-b71f-9dc9511e0563" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004025" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

APR에서 제공하는 정보 - 관리 솔루션 Lda. Microsoft에 다음을 수행합니다.
...
| 파트너 회사 이름 | APR - 관리 솔루션 Lda. |
| 회사 웹 사이트 | [https://www.apr.pt](https://www.apr.pt) |
| 앱의 사용 약관 | [https://www.apr.pt/terms-and-conditions/](https://www.apr.pt/terms-and-conditions/) |
| 앱의 핵심 기능 | 조직의 온보딩 프로세스를 자동화하고 신입 사원에게 쉽게 전달합니다. |
| 회사 본사 위치 | 포르투갈 |
| 앱 정보 페이지 | |
...
이 정보는 APR - 관리 솔루션 Lda에서 제공되었습니다. 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 설명합니다.
...
| 개인 정보 취급 방침 URL | https://www.apr.pt/privacy-statement/ |
