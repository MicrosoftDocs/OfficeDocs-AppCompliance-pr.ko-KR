...
| 파트너 회사 이름 | Good4work |
| 회사의 웹 사이트 | [https://good4work.com/#product](https://good4work.com/#product) |
| 앱 사용 약관 | [https://good4work.com/good4work-terms/](https://good4work.com/good4work-terms/) |
| 앱의 핵심 기능 | Good4work는 분산된 팀이 팀워크를 개선할 수 있는 팀 참여 도구입니다. 동시에 팀과 사용자에 대한 인사이트를 제공합니다. 이 매크로는 사용자 위치를 포함하여 Microsoft Teams. 팀 구성원에게 kudos를 보내서&#8217; 긍정적인 영향을 인식할 수 있습니다. Good4work는 신뢰와 공감의 문화를 확산하여 동기를 부여하는 가상 환경을 조성하는 것을 목표로 합니다. |
| 회사 본사 위치 | 미국 |
