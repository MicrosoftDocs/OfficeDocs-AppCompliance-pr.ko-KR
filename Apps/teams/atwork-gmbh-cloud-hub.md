---
title: Atwork GmbH별 클라우드 허브에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/22/2021
...
description: Cloud Hub에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
ms.locfileid: "64877785"
---
# <a name="cloud-hub"></a>Cloud Hub

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2021년 11월 22일</p>

* <a href="https://teams.microsoft.com/l/app/0c46172d-7923-422d-902e-f27aaad6994d" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003034" target="_blank">AppSource에서 보기</a>
...
| 회사 웹 사이트 | [https://www.atwork-it.com](https://www.atwork-it.com) |
| 앱의 사용 약관 | [https://www.atwork-it.com/eula](https://www.atwork-it.com/eula) |
| 앱의 핵심 기능 | Cloud Hub는 Microsoft Teams 위한 비즈니스 앱입니다. 이를 통해 사용자는 Microsoft Message Center의 새로운 기능 및 변경된 기능, 계획된 유지 관리 및 기타 중요한 공지를 포함하여 예정된 변경 내용을 추적할 수 있습니다. Microsoft Teams 앱 바에 Cloud Hub 앱을 고정할 수 있습니다. 앱은 현재 영어로 지원되며 비용 없이 지원됩니다.  |
| 회사 본사 위치 | 오스트리아 |
...
이 정보는 Atwork GmbH에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 사용자 데이터, 로그인 데이터, 인증 데이터, 테넌트 데이터, Azure 서비스 데이터, Graph 데이터, Office 365 관리 데이터 |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | Graph 데이터, Office 365 관리 데이터 |
| 기본 침입이 Microsoft 고객 데이터를 처리하거나 저장하는 경우 이 데이터는 지리적으로 저장되는 위치는 어디인가요? | 오스트리아 |
...
| 앱에서 위의 라이브러리 중 하나를 사용하지 않는 경우 어떤 인증 라이브러리 또는 라이브러리를 사용하나요? | 최신 버전 |
| 앱에서 조건부 액세스 정책을 지원하나요? | 예 |
| 지원되는 정책 유형 나열 | 다중 테넌트 앱은 고객&#180;설정에 따라 달라집니다. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | 응용 프로그램 | 메시지 센터에서 메시지를 게시할 채널을 선택하는 데 사용됩니다. | [b5d4e933-e001-4168-83f8-abdd974877bd](../azure/b5d4e933-e001-4168-83f8-abdd974877bd.md) |
>| Mail.Send | 응용 프로그램 | 앱에서 채널 또는 개별 사용자로 직접 메일을 보내는 데 사용됩니다.  | [b5d4e933-e001-4168-83f8-abdd974877bd](../azure/b5d4e933-e001-4168-83f8-abdd974877bd.md) |
>| TeamSettings.Read.All | 응용 프로그램 | 메시지 센터에서 메시지를 게시할 팀을 선택하는 데 사용됩니다. | [b5d4e933-e001-4168-83f8-abdd974877bd](../azure/b5d4e933-e001-4168-83f8-abdd974877bd.md) |
>| User.Read.All | 응용 프로그램 | 전자 메일을 보낼 사람을 선택하는 데 사용됩니다. | [b5d4e933-e001-4168-83f8-abdd974877bd](../azure/b5d4e933-e001-4168-83f8-abdd974877bd.md) |
