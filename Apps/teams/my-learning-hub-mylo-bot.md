---
title: Mylo Bot by Mylo Bot의 응용 프로그램 Learning 허브
ms.author: elmalova
author: elenamalova
ms.date: 02/17/2022
ms.topic: article
...
description: Mylo Bot, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용할 수 있는 모든 보안 및 규정 준수 정보
...
* <a href="https://teams.microsoft.com/l/app/eac616cb-4d81-4167-9f87-cab9fa54cf7d" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003783" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

My Learning Hub에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | 내 Learning 허브 |
| 회사의 웹 사이트 | [https://mylearninghub.com](https://mylearninghub.com) |
| 앱 사용 약관 | [https://mylearninghub.com/files/terms_and_conditions.pdf](https://mylearninghub.com/files/terms_and_conditions.pdf) |
| 앱의 핵심 기능 | 직원들이 필요한 시점에 관련 학습 콘텐츠를 찾을 수 있도록 합니다. |
| 회사 본사 위치 | 영국 및 북아일랜드 (the) |
| 앱 정보 페이지 | |
| 앱을 실행하기 위해 사용되는 호스팅 환경 또는 서비스 모델은 무엇입니까? | 이아스 |
| 앱에서 어떤 호스팅 클라우드 공급자를 사용하나요? | 기타, Aws |
...
이 정보는 My Learning Hub에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터에 대해 조직이 제어할 수 있는 컨트롤에 의해 제공됩니다.
