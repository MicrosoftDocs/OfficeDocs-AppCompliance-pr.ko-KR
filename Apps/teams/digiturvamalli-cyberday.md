---
title: Digiturvamalli의 Cyberday에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Cyberday에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/a8e43ae4-a97b-4d1a-b364-b27794da19a4" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001774" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Digiturvamalli에서 Microsoft에 제공하는 정보:
...
| 회사 웹 사이트 | [https://cyberday.ai](https://cyberday.ai) |
| 앱의 사용 약관 | [https://cyberday.ai/terms-of-use](https://cyberday.ai/terms-of-use) |
| 앱의 핵심 기능 | Cyberday는 고객이 선택한 보안 프레임워크를 준수할 수 있도록 안내하는 정보 보안 관리 시스템입니다. |
| 회사 본사 위치 | 핀란드 |
| 앱 정보 페이지 | [https://cyberday.ai](https://cyberday.ai) |
...
이 정보는 Digiturvamalli에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 위임 | 전자 메일을 사용하여 이 사용자가 있는 앱 관리자의 사용자 + 표시 식별 | [1c7d277c-ff8a-4ea4-bc14-7d06314f8941](../azure/1c7d277c-ff8a-4ea4-bc14-7d06314f8941.md) |
>| openid | 위임 | 사용자 ID를 사용하여 사용자 식별 | [1c7d277c-ff8a-4ea4-bc14-7d06314f8941](../azure/1c7d277c-ff8a-4ea4-bc14-7d06314f8941.md) |
