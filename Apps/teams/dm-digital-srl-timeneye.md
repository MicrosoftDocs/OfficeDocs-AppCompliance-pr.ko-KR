---
title: DM Digital SRL별 Timeneye에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/01/2021
...
description: Timeneye에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/015bf4ec-bc37-4931-9862-ef8686da652b" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001950" target="_blank">AppSource에서 보기</a>
...
| 회사 웹 사이트 | [https://www.dmdigital.it](https://www.dmdigital.it) |
| 앱의 사용 약관 | [https://www.timeneye.com/terms-and-conditions](https://www.timeneye.com/terms-and-conditions) |
| 앱의 핵심 기능 | Microsoft Teams 직접 작업에 소요된 시간을 추적합니다. |
| 회사 본사 위치 | 이탈리아 |
| 앱 정보 페이지 | |
...
이 정보는 DM Digital SRL에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 제공되었습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | 위임 | 이벤트 시작/종료 DateTime, 이벤트 주체, 이벤트 ID, 이벤트 웹 URI. 일정 이벤트를 기반으로 제안을 생성합니다. | [56412014-bafe-474e-95b4-ebfea106a167](../azure/56412014-bafe-474e-95b4-ebfea106a167.md) |
>| Calendars.Read.Shared | 위임 | 이벤트 시작/종료 DateTime, 이벤트 주체, 이벤트 ID, 이벤트 웹 URI. 이 정보를 사용하여 일정 이벤트를 기반으로 제안을 생성합니다. | [56412014-bafe-474e-95b4-ebfea106a167](../azure/56412014-bafe-474e-95b4-ebfea106a167.md) |
>| Directory.Read.All | 위임 | 사용자의 그룹 ID입니다. 이 정보를 사용하여 사용자가 속한 그룹을 확인하여 그룹의 플래너를 동기화할 수 있습니다. | [56412014-bafe-474e-95b4-ebfea106a167](../azure/56412014-bafe-474e-95b4-ebfea106a167.md) |
>| Group.Read.All | 위임 | 그룹 이름, 그룹 ID입니다. 플래너 프로젝트를 동기화하는 동안 이러한 정보를 사용합니다. | [56412014-bafe-474e-95b4-ebfea106a167](../azure/56412014-bafe-474e-95b4-ebfea106a167.md) |
>| Tasks.Read | 위임 | 작업 목록 이름, 작업 목록 ID입니다. 플래너 프로젝트를 동기화하는 동안 이 정보를 사용합니다. | [56412014-bafe-474e-95b4-ebfea106a167](../azure/56412014-bafe-474e-95b4-ebfea106a167.md) |
...
>| User.ReadBasic.All | 위임 | 사용자 이름, 전자 메일. 사용자가 Planner/Microsoft에서 서비스로 다른 사용자를 가져올 수 있도록 이 정보를 사용합니다. | [56412014-bafe-474e-95b4-ebfea106a167](../azure/56412014-bafe-474e-95b4-ebfea106a167.md) |
...
>| offline_access | 위임 | 사용자가 온라인 상태가 아닌 동안 플래너/일정을 동기화하는 데 필요한 권한입니다. | [56412014-bafe-474e-95b4-ebfea106a167](../azure/56412014-bafe-474e-95b4-ebfea106a167.md) |
