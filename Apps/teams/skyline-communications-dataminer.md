---
title: Skyline Communications의 DataMiner에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/22/2021
...
description: DataMiner에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보
...
* <a href="https://teams.microsoft.com/l/app/9a09d087-5d07-4481-b34f-cd053eab7925" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003501" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Skyline Communications에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | Skyline Communications |
| 회사의 웹 사이트 | [https://www.skyline.be](https://www.skyline.be) |
| 앱 사용 약관 | [https://dataminer.services/terms/terms-of-service.html](https://dataminer.services/terms/terms-of-service.html) |
| 앱의 핵심 기능 | Skyline Communications는 ICT 미디어 및 광대역 산업을 위한 종단 간 다중 공급업체 NMS, OSS 및 오케스트레이션 소프트웨어 솔루션의 글로벌 선두 업체입니다. 다양한 우수상을 받은 플래그십 DataMiner 네트워크 관리 플랫폼은 가장 복잡한 기술 에코시스템을 종단으로 통합할 수 있으며 전 세계 주요 운영자에 의해 배포되었습니다. |
| 회사 본사 위치 | 벨기에 |
| 앱 정보 페이지 | [https://www.skyline.be/dataminer/cloud-services](https://www.skyline.be/dataminer/cloud-services) |
...
이 정보는 Skyline Communications에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직이 사용할 컨트롤에 대해 제공됩니다.
...
| 개인 정보 취급 방침 URL | https://dataminer.services/terms/privacy.html |
