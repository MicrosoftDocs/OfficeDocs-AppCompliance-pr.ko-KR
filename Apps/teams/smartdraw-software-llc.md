---
title: SmartDraw Software, LLC의 SmartDraw 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/29/2021
...
description: SmartDraw에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/b1879f1f-dba8-49d6-81a1-21ec15e4f94b" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003505" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

SmartDraw Software, LLC에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | SmartDraw Software, LLC |
| 회사 웹 사이트 | [https://www.smartdraw.com](https://www.smartdraw.com) |
| 앱의 사용 약관 | [https://www.smartdraw.com/support/terms-of-service.pdf](https://www.smartdraw.com/support/terms-of-service.pdf) |
| 앱의 핵심 기능 | 순서 &amp; 도, UML, ERD, 기술 다이어그램 등을 쉽게 만들 수 있는 강력한 도구입니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://www.smartdraw.com/features](https://www.smartdraw.com/features) |
...
이 정보는 SmartDraw Software, LLC에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | sso auth 메타 데이터, oauth 토큰  |
