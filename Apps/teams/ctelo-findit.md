---
title: CTELO의 Findit에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/14/2022
...
description: Findit에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보
...
* <a href="https://teams.microsoft.com/l/app/ccb8d21c-9c7b-492f-b372-438621384db8" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003849" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

CTELO에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | CTELO |
| 회사의 웹 사이트 | [https://www.ctelo.com](https://www.ctelo.com) |
| 앱 사용 약관 | [https://www.ctelo.com/terms-conditions](https://www.ctelo.com/terms-conditions) |
| 앱의 핵심 기능 | 동료 무료 일정 슬롯을 찾아 상태 Teams 연락처 정보를 검색합니다. |
| 회사 본사 위치 | 노르웨이 |
| 앱 정보 페이지 | |
...
이 정보는 CTELO에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직이 하게 될 컨트롤에 대해 제공됩니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | 위임 | 앱에서 사용자 일정의 이벤트를 읽을 수 있도록 허용합니다. | [2e57054c-4326-46ed-8482-40d9a6d20e79](../azure/2e57054c-4326-46ed-8482-40d9a6d20e79.md) |
...
>| Presence.Read.All | 위임 | 앱에서 모든 사용자의 현재 상태 정보를 읽을 수 있도록 허용합니다. | [2e57054c-4326-46ed-8482-40d9a6d20e79](../azure/2e57054c-4326-46ed-8482-40d9a6d20e79.md) |
...
>| User.Read.All | 위임 | 앱에서 모든 사용자 프로필을 읽을 수 있도록 허용합니다. | [2e57054c-4326-46ed-8482-40d9a6d20e79](../azure/2e57054c-4326-46ed-8482-40d9a6d20e79.md) |
