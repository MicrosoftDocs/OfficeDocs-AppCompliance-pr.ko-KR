---
title: CTELO에서 Findit에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/14/2022
...
description: Findit에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
ms.locfileid: "64881371"
---
# <a name="findit"></a>Findit

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 1월 25일</p>

* <a href="https://teams.microsoft.com/l/app/ccb8d21c-9c7b-492f-b372-438621384db8" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003849" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

CTELO에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | CTELO |
| 회사 웹 사이트 | [https://www.ctelo.com](https://www.ctelo.com) |
| 앱의 사용 약관 | [https://www.ctelo.com/terms-conditions](https://www.ctelo.com/terms-conditions) |
| 앱의 핵심 기능 | 동료에게 무료 일정 슬롯, Teams 상태 및 연락처 정보를 찾습니다. |
| 회사 본사 위치 | 노르웨이 |
| 앱 정보 페이지 | |
...
이 정보는 CTELO에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 일정 항목 및 연락처 정보입니다. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | 위임 | 앱이 사용자 일정에서 이벤트를 읽을 수 있도록 허용합니다. | [2e57054c-4326-46ed-8482-40d9a6d20e79](../azure/2e57054c-4326-46ed-8482-40d9a6d20e79.md) |
>| Contacts.Read | 위임 | 앱에서 사용자 연락처를 읽을 수 있도록 허용합니다. | [2e57054c-4326-46ed-8482-40d9a6d20e79](../azure/2e57054c-4326-46ed-8482-40d9a6d20e79.md) |
>| Group.Read.All | 위임 | 앱에서 사용자 그룹을 읽을 수 있도록 허용합니다. | [2e57054c-4326-46ed-8482-40d9a6d20e79](../azure/2e57054c-4326-46ed-8482-40d9a6d20e79.md) |
>| Presence.Read.All | 위임 | 앱이 모든 사용자의 현재 상태 정보를 읽을 수 있도록 허용합니다. | [2e57054c-4326-46ed-8482-40d9a6d20e79](../azure/2e57054c-4326-46ed-8482-40d9a6d20e79.md) |
>| User.Read | 위임 | 앱에서 사용자 프로필을 읽을 수 있도록 허용합니다. | [2e57054c-4326-46ed-8482-40d9a6d20e79](../azure/2e57054c-4326-46ed-8482-40d9a6d20e79.md) |
>| User.Read.All | 위임 | 앱이 모든 사용자 프로필을 읽을 수 있도록 허용합니다. | [2e57054c-4326-46ed-8482-40d9a6d20e79](../azure/2e57054c-4326-46ed-8482-40d9a6d20e79.md) |
