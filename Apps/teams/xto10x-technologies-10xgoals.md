...
| 앱의 핵심 기능 | 10xGoals는 팀 전체의 포커스, 맞춤, 공동 작업 및 가시성을 통해 전략을 실행하도록 추진하는 도구입니다. 10xGoals &lt;&gt; Microsoft Teams 통합하면 여기에서 전체 실행을 관리할 수 있습니다. 먼저 사용자는 시간을 보다 효율적으로 관리하기 위해 할당된 목표에 대한 설명을 수락/거절할 수 있습니다. 이 앱을 사용하려면 사용자에게 활성 10xGoals 구독이 있어야 합니다. |
| 회사 본사 위치 | 인도 |
| 앱 정보 페이지 | |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | application | 사용자가 전자 메일 및 Azure ID를 반치하여 앱이 모든 사용자에 대해 사전적으로 앱을 설치할 수 있도록 합니다.  | [950aa4fb-0583-4b13-9b5f-bbc92b9cc376](https://docs.microsoft.com/microsoft-365-app-certification/azure/950aa4fb-0583-4b13-9b5f-bbc92b9cc376) |
>| TeamsAppInstallation.ReadWriteSelfForUser.All | application | 앱이 관리자를 위해 설치된 teamsAppDefinition을 반출한 다음 모든 사용자에 대해 사전적으로 자체적으로 설치할 수 있도록 하는 것이 필요합니다.  | [950aa4fb-0583-4b13-9b5f-bbc92b9cc376](https://docs.microsoft.com/microsoft-365-app-certification/azure/950aa4fb-0583-4b13-9b5f-bbc92b9cc376) |
