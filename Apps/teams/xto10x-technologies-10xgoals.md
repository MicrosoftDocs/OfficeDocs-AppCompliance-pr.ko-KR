---
title: xto10x Technologies별 10xGoals에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: 10xGoals에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/950aa4fb-0583-4b13-9b5f-bbc92b9cc376" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003122" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

xto10x Technologies에서 Microsoft에 제공하는 정보:
...
| 회사 웹 사이트 | [https://www.xto10x.com/10xgoals/](https://www.xto10x.com/10xgoals/) |
| 앱의 사용 약관 | [https://www.xto10x.com/security/terms-of-use/](https://www.xto10x.com/security/terms-of-use/) |
| 앱의 핵심 기능 | 10xGoals는 팀 전체의 포커스, 맞춤, 공동 작업 및 가시성을 사용하여 전략을 실행하도록 유도하는 도구입니다. 10xGoals &lt;&gt; Microsoft Teams 통합을 사용하면 여기에서 전체 실행을 관리할 수 있습니다. 먼저 사용자는 시간을 더 잘 관리하기 위해 할당된 목표에 대한 의견을 수락/거절/거부할 수 있습니다. 이 앱을 사용하려면 사용자에게 활성 10xGoals 구독이 있어야 합니다. |
| 회사 본사 위치 | 인도 |
| 앱 정보 페이지 | [https://www.xto10x.com/10xgoals/](https://www.xto10x.com/10xgoals/) |
...
이 정보는 xto10x Technologies에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 응용 프로그램 | 앱이 조직의 모든 사용자에 대해 앱을 사전에 설치할 수 있도록 사용자 이메일 및 Azure ID가 페치됩니다.  | [950aa4fb-0583-4b13-9b5f-bbc92b9cc376](../azure/950aa4fb-0583-4b13-9b5f-bbc92b9cc376.md) |
>| TeamsAppInstallation.ReadWriteSelfForUser.All | 응용 프로그램 | 앱이 관리자를 위해 설치된 teamsAppDefinition을 가져온 다음 조직의 모든 사용자를 위해 사전에 설치할 수 있도록 해야 합니다.  | [950aa4fb-0583-4b13-9b5f-bbc92b9cc376](../azure/950aa4fb-0583-4b13-9b5f-bbc92b9cc376.md) |
