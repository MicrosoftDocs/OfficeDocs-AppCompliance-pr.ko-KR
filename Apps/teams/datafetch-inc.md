---
title: DataFetch, Inc.의 DataFetch에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/18/2022
...
description: DataFetch에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/d6756140-a823-11ea-94d9-ddbe638eaf6b" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003961" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

DataFetch, Inc에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | DataFetch, Inc. |
| 회사 웹 사이트 | [https://datafetch.io](https://datafetch.io) |
| 앱의 사용 약관 | [https://datafetch.io/terms](https://datafetch.io/terms) |
| 앱의 핵심 기능 | 연결된 데이터 원본 검색 |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
...
이 정보는 DataFetch, Inc.에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 아니요 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | id, name, tenantId, tenantName |
...
| 개인 정보 취급 방침 URL | https://datafetch.io/privacy-policy |
...
| 지원되는 정책 유형 나열 | 데이터 원본을 소유하는 대신 구독하는 사용자는 삭제할 수 없습니다. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsAppInstallation.ReadWriteForUser | 위임 | 사용자의 설치된 Teams 앱 관리 | [b3af1387-3ee6-4074-a594-7a768cd00d44](../azure/b3af1387-3ee6-4074-a594-7a768cd00d44.md) |
>| TeamsAppInstallation.ReadWriteSelfForUser | 위임 | Teams 앱이 사용자에 대해 자체 관리하도록 허용 | [b3af1387-3ee6-4074-a594-7a768cd00d44](../azure/b3af1387-3ee6-4074-a594-7a768cd00d44.md) |
>| User.Read | 위임 | 로그인 및 사용자 프로필 읽기 | [b3af1387-3ee6-4074-a594-7a768cd00d44](../azure/b3af1387-3ee6-4074-a594-7a768cd00d44.md) |
>| 전자 메일 | 위임 | 사용자의 전자 메일 주소 보기 | [b3af1387-3ee6-4074-a594-7a768cd00d44](../azure/b3af1387-3ee6-4074-a594-7a768cd00d44.md) |
>| offline_access | 위임 | 액세스 권한이 부여된 데이터에 대한 액세스 권한 유지 | [b3af1387-3ee6-4074-a594-7a768cd00d44](../azure/b3af1387-3ee6-4074-a594-7a768cd00d44.md) |
>| openid | 위임 | 사용자 ID 서명 | [b3af1387-3ee6-4074-a594-7a768cd00d44](../azure/b3af1387-3ee6-4074-a594-7a768cd00d44.md) |
>| 프로필 | 위임 | 사용자의 기본 프로필 보기 | [b3af1387-3ee6-4074-a594-7a768cd00d44](../azure/b3af1387-3ee6-4074-a594-7a768cd00d44.md) |
