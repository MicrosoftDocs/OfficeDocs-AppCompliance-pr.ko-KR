---
title: 프로세스 스트리트별 프로세스 스트리트에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/13/2022
...
description: 프로세스 스트리트, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
ms.locfileid: "64838805"
---
# <a name="process-street"></a>프로세스 거리

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 3월 4일</p>

* <a href="https://teams.microsoft.com/l/app/6910821c-1244-4a0b-9d64-f0fc396b8e7c" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003933" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Process Street에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | 프로세스 거리 |
| 회사 웹 사이트 | [https://www.process.st](https://www.process.st) |
| 앱의 사용 약관 | [https://www.process.st/terms/](https://www.process.st/terms/) |
| 앱의 핵심 기능 | 핵심 프로세스를 빌드, 공유 및 자동화하기 위한 최신 프로세스 관리 플랫폼입니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
...
이 정보는 Process Street에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
...
| 개인 정보 취급 방침 URL | https://www.process.st/help/docs/gdpr-statement/ |
