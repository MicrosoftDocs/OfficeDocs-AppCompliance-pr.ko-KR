...
description: 스마일백에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보
...
* <a href="https://teams.microsoft.com/l/app/273e3385-93c3-4054-8c03-328b8c3fd9af" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002623" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

스마일백에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | SmileBack |
| 회사의 웹 사이트 | [https://smileback.com](https://smileback.com) |
| 앱 사용 약관 | [https://smileback.com/terms](https://smileback.com/terms) |
| 앱의 핵심 기능 | 스마일백은 관리 서비스 공급자, 지원 센터 및 IT 지원 팀용으로 설계된 고객 만족도 플랫폼입니다. CSAT + NPS&#174; 도구를 사용하면 IT 전문가가 고객 피드백을 수집, 보고 및 작업할 수 있습니다. CSAT(고객 만족도 설문 조사)는 현재 고객 만족도의 이해를 지원하여 모든 고객 상호 작용(지원 티켓)을 즉각적으로 직접 측정할 수 있도록 합니다. NPS&#174;(순 홍보자 점수)는 전반적인 고객 관계에 대한 정보를 제공합니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
| 앱을 실행하기 위해 사용되는 호스팅 환경 또는 서비스 모델은 무엇입니까? |  |
| 앱에서 어떤 호스팅 클라우드 공급자를 사용하나요? | AWS, Heroku |
...
이 정보는 스마일백에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 조직에서 수집하는 데이터를 통해 조직이 제공하는 컨트롤에 대해 제공됩니다.
