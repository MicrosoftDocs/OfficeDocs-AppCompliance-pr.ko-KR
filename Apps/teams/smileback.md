---
title: 스마일백에 의한 스마일백에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2021
...
description: SmileBack에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
| 파트너 회사 이름 | SmileBack |
| 회사 웹 사이트 | [https://smileback.com](https://smileback.com) |
| 앱의 사용 약관 | [https://smileback.com/terms](https://smileback.com/terms) |
| 앱의 핵심 기능 | SmileBack은 관리 서비스 공급자, 지원 센터 및 IT 지원 팀을 위해 설계된 고객 만족 플랫폼입니다. CSAT + NPS&#174; 도구는 IT 전문가가 고객 피드백을 수집, 보고 및 조치를 수행하는 데 도움이 됩니다. CSAT(고객 만족도 설문 조사)는 현재 고객 만족도를 이해하는 데 도움이 되므로 모든 고객 상호 작용(지원 티켓)을 즉각적이고 직접적으로 측정할 수 있습니다. NPS&#174;(순 프로모터 점수)는 전체 고객 관계에 대한 인사이트를 제공합니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
| 앱을 실행하는 데 사용되는 호스팅 환경 또는 서비스 모델은 무엇인가요? |  |
| 앱에서 사용하는 호스팅 클라우드 공급자는 무엇인가요? | AWS, Heroku |
...
이 정보는 SmileBack에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
