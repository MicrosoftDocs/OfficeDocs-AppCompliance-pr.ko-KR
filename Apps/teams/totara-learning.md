---
title: Totara by Totara Learning 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/09/2021
...
description: Totara에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/5022e09d-d2f9-499f-8925-554c324ad23a" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003222" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Totara가 Microsoft에 Learning 제공한 정보:
...
| 회사 웹 사이트 | [https://www.totaralearning.com](https://www.totaralearning.com) |
| 앱의 사용 약관 | [https://www.totaralearning.com/en/solutions/totara-cloud/te...](https://www.totaralearning.com/en/solutions/totara-cloud/terms-of-service) |
| 앱의 핵심 기능 | Microsoft Teams용 Totara 앱은 Totara Cloud 구독자에게 학습에 액세스하고 Microsoft Teams 내에서 다른 사용자와 공동 작업할 수 있는 기능을 제공합니다. 이 앱을 사용하면 사용자가 할당된 학습에 액세스하고, 학습 콘텐츠를 탐색하고, 재생 목록 및 리소스를 만들고, 상호 작용하고, 공유할 수 Microsoft Teams. |
| 회사 본사 위치 | 뉴질랜드 |
...
이 정보는 Totara Learning 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직의 제어에 대해 제공되었습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 위임 | 이메일 주소를 통해 팀 사용자를 로컬 시스템 사용자에 연결하려면 | [5022e09d-d2f9-499f-8925-554c324ad23a](../azure/5022e09d-d2f9-499f-8925-554c324ad23a.md) |
