---
title: Flipick Pvt Ltd의 LTI 클라이언트에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/05/2021
...
description: LTI 클라이언트, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용할 수 있는 모든 보안 및 규정 준수 정보
...
ms.locfileid: "63548466"
---
# <a name="lti-client"></a>LTI 클라이언트

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2021년 10월 5일</p>

* <a href="https://teams.microsoft.com/l/app/bfed1af2-2c16-4536-9780-8e21d7fc7d79" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003313" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Flipick Pvt Ltd에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | Flipick Pvt Ltd |
| 회사의 웹 사이트 | [https://flipick.com](https://flipick.com) |
| 앱 사용 약관 | [https://flipick.com/terms-of-use/](https://flipick.com/terms-of-use/) |
| 앱의 핵심 기능 | 앱은 과정을 시작하기 위한 LTI(Learning 도구 상호 Learning) 서버가 있는 SSO(Single Sign On)를 제공합니다. LTI 도구 소비자로, BLTI(Basic LTI)를 지원하고 있습니다. |
| 회사 본사 위치 | 인도 |
| 앱 정보 페이지 | |
...
이 정보는 Flipick Pvt Ltd에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직이 하게 될 컨트롤에 대해 제공됩니다.
