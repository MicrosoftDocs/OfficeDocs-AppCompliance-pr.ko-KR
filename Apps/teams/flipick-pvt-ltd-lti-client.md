---
title: Flipick Pvt Ltd의 LTI 클라이언트에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/05/2021
...
description: LTI 클라이언트에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/bfed1af2-2c16-4536-9780-8e21d7fc7d79" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003313" target="_blank">AppSource에서 보기</a>
...
| 회사 웹 사이트 | [https://flipick.com](https://flipick.com) |
| 앱의 사용 약관 | [https://flipick.com/terms-of-use/](https://flipick.com/terms-of-use/) |
| 앱의 핵심 기능 | 앱은 과정을 시작하는 LTI(Learning Tools 상호 운용성) 서버가 있는 SSO(Single Sign On)를 제공합니다. LTI 도구 소비자이며 BLTI(기본 LTI)를 지원합니다. |
| 회사 본사 위치 | 인도 |
| 앱 정보 페이지 | |
...
이 정보는 Flipick Pvt Ltd에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 제공되었습니다.
