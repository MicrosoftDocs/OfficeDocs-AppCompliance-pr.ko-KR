---
title: PT Privy Identitas Digital의 PrivyNow에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/14/2022
...
description: PrivyNow에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
ms.locfileid: "66547261"
---
# <a name="privynow"></a>PrivyNow

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 3월 2일</p>

* <a href="https://teams.microsoft.com/l/app/00e595af-26e4-46b9-97d1-46e0831b1f02" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004229" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Microsoft에 PT Privy Identitas Digital에서 제공하는 정보:
...
| 파트너 회사 이름 | PT Privy Identitas Digital |
| 회사 웹 사이트 | [https://privynow.com/about-us/](https://privynow.com/about-us/) |
| 앱의 사용 약관 | [https://privynow.com/terms-of-use/](https://privynow.com/terms-of-use/) |
| 앱의 핵심 기능 | 모든 종류의 문서에 서명하는 것은 일상 생활에서 필수적인 부분이며 모든 것을 변경하는 것을 지연합니다. PrivyNow를 사용하여 거래를 신속하게 종료합니다. 1분 안에 문서를 업로드하고 공유합니다.   이 앱을 사용하려면 활성 PrivyNow 계정이 있어야 합니다. 자세한 내용은 PrivyNow.com 통해 등록하거나 지원 팀에 문의하세요. |
| 회사 본사 위치 | 인도네시아 |
| 앱 정보 페이지 | [https://privynow.com/guide/](https://privynow.com/guide/) |
...
이 정보는 PT Privy Identitas Digital에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 전체 이름, 전자 메일 |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 전체 이름, 전자 메일 |
| 기본 침입이 Microsoft 고객 데이터를 처리하거나 저장하는 경우 이 데이터는 지리적으로 저장되는 위치는 어디인가요? | 인도네시아 |
...
| 개인 정보 취급 방침 URL | https://privynow.com/terms-of-use/ |
