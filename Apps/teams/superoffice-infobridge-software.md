---
title: SuperOffice InfoBridge 소프트웨어의 SuperOffice에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/10/2021
...
description: SuperOffice, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용할 수 있는 모든 보안 및 규정 준수 정보
...
* <a href="https://teams.microsoft.com/l/app/4f9a1c49-28e3-443c-9007-67c7819407bc" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003364" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

SuperOffice InfoBridge 소프트웨어에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | SuperOffice InfoBridge 소프트웨어 |
| 회사의 웹 사이트 | [https://infobridge.com](https://infobridge.com) |
| 앱 사용 약관 | [https://msteams.superofficeapps.com/Home/TermsAndConditions](https://msteams.superofficeapps.com/Home/TermsAndConditions) |
| 앱의 핵심 기능 | SuperOffice CRM에서 고객, 프로젝트 및 판매에 어떤 일이 일어나는지에 대해 알려야 합니다. |
| 회사 본사 위치 | 네덜란드(the) |
| 앱 정보 페이지 | [https://msteams.superofficeapps.com](https://msteams.superofficeapps.com) |
...
이 정보는 SuperOffice InfoBridge Software에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직이 사용할 컨트롤에 대해 제공됩니다.
...
| 개인 정보 취급 방침 URL | https://msteams.superofficeapps.com/Home/PrivacyPolicy |
