...
* <a href="https://appsource.microsoft.com/product/office/WA200001616" target="_blank">앱소스에서 보기</a>
...
>이 응용 프로그램은 수집하고 EUII 및 OII를 포함한 조직 데이터를 저장하지 않습니다.

#### <a name="organizational-controls-for-data-stored-by-partner"></a>파트너가 저장한 데이터에 대한 조직 제어

조직의 관리자가 파트너 시스템에서 자신의 정보를 제어하는 방법을 설명해 보세요. 예를 들어 삭제, 보존, 감사, 보관, 최종 사용자 정책 등

>이 응용 프로그램을 사용하여 촬영 된 모든 데이터는 안전하게 Zoho 노트북 서버에 저장됩니다. 모든 데이터는 EAR입니다. 따라서 사용자를 제외한 누구도 데이터를 볼 수 없습니다.
...
<iframe height='1020' title='Microsoft Cloud App Security 정보' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/21298' frameborder='no' style='width: 100%;'></iframe>

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/21298" target="_blank">새 탭에서 보기</a>
