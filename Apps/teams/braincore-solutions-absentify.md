---
title: BrainCore 솔루션의 부재에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/07/2022
...
description: CSA STAR 레지스트리의 부재, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/fbd349eb-146f-4e94-af76-df4754f40749" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003833" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Microsoft에 BrainCore Solutions에서 제공하는 정보:
...
| 파트너 회사 이름 | BrainCore Solutions |
| 회사 웹 사이트 | [https://braincore.solutions](https://braincore.solutions) |
| 앱의 사용 약관 | [https://absentify.com/terms-and-conditions](https://absentify.com/terms-and-conditions) |
| 앱의 핵심 기능 | 직원 휴가를 처리하는 가장 쉬운 방법 - Microsoft Teams |
| 회사 본사 위치 | 스위스 |
| 앱 정보 페이지 | [https://absentify.com](https://absentify.com) |
...
이 정보는 BrainCore Solutions에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | Microsoft 사용자 ID, 전자 메일, DisplayName |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | Microsoft 사용자 ID, 전자 메일, DisplayName |
...
| 개인 정보 취급 방침 URL | https://absentify.com/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsActivity.Send | 응용 프로그램 | 선택 사항. Microsoft Teams 알림을 보내려면 | [0f5eabc0-89bf-4cc6-80d1-10094b5919d2](/microsoft-365-app-certification/azure/0f5eabc0-89bf-4cc6-80d1-10094b5919d2) |
>| Calendars.ReadWrite | 위임 | 선택 사항: 부재에 대한 Outlook 일정 항목을 자동으로 만들려면 | [3dbcb38b-8d2f-4e97-9bd1-975fb770b31c](/microsoft-365-app-certification/azure/3dbcb38b-8d2f-4e97-9bd1-975fb770b31c) |
>| User.Read | 위임 | 로그인의 경우 | [4dce2abf-3f8e-4281-9f7a-d602fc391886](/microsoft-365-app-certification/azure/4dce2abf-3f8e-4281-9f7a-d602fc391886) |
>| User.ReadBasic.All | 위임 | 선택 사항: 사용자의 Microsoft 프로필 사진을 보려면 | [4dce2abf-3f8e-4281-9f7a-d602fc391886](/microsoft-365-app-certification/azure/4dce2abf-3f8e-4281-9f7a-d602fc391886) |
