...
| 회사의 웹 사이트 | [https://crowdcast.jp/ja/](https://crowdcast.jp/ja/) |
| 앱 사용 약관 | [https://go.microsoft.com](https://go.microsoft.com) |
| 앱의 핵심 기능 | 실시간 경비 관리를 통해 작업 스타일을 변경합니다. Staple을 사용하면 회사에 쉽게 경비 제출, 승인 및 추적을 할 수 있습니다. 사용자와 Microsoft 서비스 쉽게 상호 작용할 수 있습니다. |
| 회사 본사 위치 | 일본 |
| 앱 정보 페이지 | |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Organization.Read.All | application | 테넌트 ID를 수집하는 데 사용됩니다. 플랫폼에서 인증하는 사용자가 특정 테넌트의 구성원이 되도록 하는 데 사용됩니다. | [ac9ca94a-e666-4f61-959a-12c063e13e69](https://docs.microsoft.com/microsoft-365-app-certification/azure/ac9ca94a-e666-4f61-959a-12c063e13e69) |
>| TeamsAppInstallation.ReadWriteSelfForUser.All | application | Teams 앱의 사용자 팀에 자체 설치 | [ac9ca94a-e666-4f61-959a-12c063e13e69](https://docs.microsoft.com/microsoft-365-app-certification/azure/ac9ca94a-e666-4f61-959a-12c063e13e69) |
>| AppCatalog.Read.All | 위임 | 사용자의 앱 카탈로그를 읽어 Teams 앱이 설치되어 있는지 확인합니다. | [bbdcd676-7448-453c-bec7-70e5384bc290](https://docs.microsoft.com/microsoft-365-app-certification/azure/bbdcd676-7448-453c-bec7-70e5384bc290) |
>| User.Read | 위임 | 올바른 사용자에게 메시지를 보내기 위해 사용자의 ID를 읽는 데 사용됩니다. | [bbdcd676-7448-453c-bec7-70e5384bc290](https://docs.microsoft.com/microsoft-365-app-certification/azure/bbdcd676-7448-453c-bec7-70e5384bc290) |
>| openid | 위임 | 기본 프로필 정보를 읽기 위해 사용자 로그인 | [bbdcd676-7448-453c-bec7-70e5384bc290](https://docs.microsoft.com/microsoft-365-app-certification/azure/bbdcd676-7448-453c-bec7-70e5384bc290) |
