---
title: 주식회사 크라우드캐스트의 스테이플에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/27/2021
...
description: 스테이플에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/ac9ca94a-e666-4f61-959a-12c063e13e69" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003281" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Crowd Cast, Ltd.에서 Microsoft에 제공한 정보:
...
| 회사 웹 사이트 | [https://crowdcast.jp/ja/](https://crowdcast.jp/ja/) |
| 앱의 사용 약관 | [https://go.microsoft.com](https://go.microsoft.com) |
| 앱의 핵심 기능 | 실시간 비용 관리를 사용하여 작업 스타일을 변경합니다. 스테이플을 사용하면 회사에 대한 간편한 비용 제출, 승인 및 추적이 가능합니다. Microsoft 서비스 연결하여 제품과 쉽게 상호 작용할 수 있습니다. |
| 회사 본사 위치 | 일본 |
| 앱 정보 페이지 | [https://intercom.help/staple/ja](https://intercom.help/staple/ja) |
...
이 정보는 Crowd Cast, Ltd.에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직의 제어에 대해 제공되었습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Organization.Read.All | 응용 프로그램 | 테넌트 ID를 수집하는 데 사용됩니다. 플랫폼에서 인증하는 사용자가 특정 테넌트의 구성원인지 확인하는 데 사용됩니다. | [ac9ca94a-e666-4f61-959a-12c063e13e69](../azure/ac9ca94a-e666-4f61-959a-12c063e13e69.md) |
>| TeamsAppInstallation.ReadWriteSelfForUser.All | 응용 프로그램 | Teams 앱이 사용자 팀에 자체 설치 | [ac9ca94a-e666-4f61-959a-12c063e13e69](../azure/ac9ca94a-e666-4f61-959a-12c063e13e69.md) |
>| AppCatalog.Read.All | 위임 | 사용자의 앱 카탈로그를 읽어 팀 앱이 설치되어 있는지 확인합니다. | [bbdcd676-7448-453c-bec7-70e5384bc290](../azure/bbdcd676-7448-453c-bec7-70e5384bc290.md) |
>| User.Read | 위임 | 사용자의 ID를 읽어 올바른 사용자에게 메시지가 전송되도록 하는 데 사용됩니다. | [bbdcd676-7448-453c-bec7-70e5384bc290](../azure/bbdcd676-7448-453c-bec7-70e5384bc290.md) |
>| openid | 위임 | 기본 프로필 정보를 읽으려면 사용자 로그인 | [bbdcd676-7448-453c-bec7-70e5384bc290](../azure/bbdcd676-7448-453c-bec7-70e5384bc290.md) |
