---
title: 슬라이도별 슬라이도에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/02/2022
...
description: 슬라이도에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/1517b59d-6d65-4316-a708-035adc659394" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002357" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

슬라이도에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | Slido |
| 회사 웹 사이트 | [https://www.sli.do](https://www.sli.do) |
| 앱의 사용 약관 | [https://www.sli.do/terms](https://www.sli.do/terms) |
| 앱의 핵심 기능 | 슬라이더는 라이브 및 가상 모임 및 이벤트를 위한 궁극적인 QA&amp; 및 폴링 플랫폼입니다. 대화형 QA&amp;, 라이브 설문 조사 및 대상 그룹에 대한 인사이트를 제공합니다. |
| 회사 본사 위치 | 슬로바키아 |
| 앱 정보 페이지 | [https://www.sli.do/product](https://www.sli.do/product) |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 슬라이도에서 제공했습니다.
