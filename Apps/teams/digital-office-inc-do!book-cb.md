...
description: Do!book CB, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보
...
* <a href="https://teams.microsoft.com/l/app/92abac76-5f78-472f-8dfa-e7c23564cd92" target="_blank">Teams 스토어의 보기</a>
...
| 회사의 웹 사이트 | [https://www.do-tools.net](https://www.do-tools.net) |
| 앱 사용 약관 | [https://www.do-tools.net/agreements/legal/dobookCB_Terms.pdf](https://www.do-tools.net/agreements/legal/dobookCB_Terms.pdf) |
| 앱의 핵심 기능 | 재료 공유 보드를 통해 &quot;모임을 더욱 편리하게 만들 수 있습니다&quot;. |
| 회사 본사 위치 | 일본 |
...
이 정보는 디지털 Office Inc.에서 이 앱이 조직 데이터를 수집 및 저장하는 방법과 조직이 수집하는 데이터를 통해 조직이 하게 될 컨트롤에 대해 제공합니다.
