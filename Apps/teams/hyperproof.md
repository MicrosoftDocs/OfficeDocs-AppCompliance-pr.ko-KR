...
* <a href="https://teams.microsoft.com/l/app/1683c88b-f5ca-4acc-a777-c1e3cf820ef5" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002692" target="_blank">앱소스에서 보기</a>
...
| 파트너 웹사이트의 URL | [https://hyperproof.io/](https://hyperproof.io/) |
| Teams 응용 프로그램 정보 페이지의 URL | [https://hyperproof.io/product](https://hyperproof.io/product) |
| 개인정보 처리방침의 URL | [https://hyperproof.io/privacy-policy/](https://hyperproof.io/privacy-policy/) |
| 이용 약관의 URL | [https://hyperproof.io/terms-of-use/](https://hyperproof.io/terms-of-use/) |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직에 대한 제어에 대한 하이퍼루프에서 제공되었습니다.
...
<iframe height='1020' title='Microsoft Cloud App Security 정보' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/37868' frameborder='no' style='width: 100%;'></iframe>

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/37868" target="_blank">새 탭에서 보기</a>
...
이 정보는 이 앱이 인증, 권한 부여, 응용 프로그램 등록 모범 사례 및 기타 ID 기준을 처리하는 방법에 대한 하이퍼루프에서 제공되었습니다.
