---
title: Vizir.co Vizir에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/25/2022
...
description: Ask Vizir, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
ms.locfileid: "65069700"
---
# <a name="ask-vizir"></a>Vizir에게 질문하기

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 4월 22일</p>

* <a href="https://teams.microsoft.com/l/app/7b0641d9-8e1f-4415-99da-c80f8c175c69" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003119" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Microsoft에 Vizir.co 제공하는 정보:
...
| 파트너 회사 이름 | Vizir.co |
| 회사 웹 사이트 | [https://www.vizir.co](https://www.vizir.co) |
| 앱의 사용 약관 | [https://vizir.co/mentions-legales](https://vizir.co/mentions-legales) |
| 앱의 핵심 기능 | Vizir 봇을 요청하면 프랑스의 팀 사용자가 Microsoft Office 365 제품을 사용할 수 있습니다. Microsoft France와 파트너 관계로 제작 |
| 회사 본사 위치 | 프랑스 |
| 앱 정보 페이지 | [https://www.vizir.co](https://www.vizir.co) |
| 앱을 실행하는 데 사용되는 호스팅 환경 또는 서비스 모델은 무엇인가요? | Paas |
| 앱에서 사용하는 호스팅 클라우드 공급자는 무엇인가요? | OVH, Aws |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대한 Vizir.co 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 사용자 전자 메일, 이름, 성 |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 사용자 전자 메일, 이름, 성 |
...
| 개인 정보 취급 방침 URL | https://www.vizir.co/politique-confidentialite/ |
