---
title: Anaek의 AttendanceBot에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/07/2022
...
description: AttendanceBot에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 7월 6일</p>

* <a href="https://teams.microsoft.com/l/app/77231724-5a80-4edf-ad93-dfd2e61207fa" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA104381652" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Anaek에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | Anaek |
| 회사 웹 사이트 | [https://www.harmonizehq.com](https://www.harmonizehq.com) |
| 앱의 사용 약관 | [https://www.attendancebot.com/attendance/tos/](https://www.attendancebot.com/attendance/tos/) |
| 앱의 핵심 기능 | 시간, 출석, PTO, 시간 제한, 하이브리드 작업, &amp; 교대 근무 계획을 추적하는 최신 HR |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://www.attendancebot.com](https://www.attendancebot.com) |
...
이 정보는 Anaek에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 제어에 대해 제공되었습니다.
...
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 액세스 토큰, 테넌트 데이터(테넌트 ID, 이름, 팀 세부 정보), 사용자 데이터(이름, 이메일) |
...
| 개인 정보 취급 방침 URL | https://www.attendancebot.com/attendance/privacy/ |
