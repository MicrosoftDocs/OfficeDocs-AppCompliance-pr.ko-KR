...
description: CSA STAR 레지스트리의 enmacc, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
| 파트너 회사 이름 | enmacc |
| 회사의 웹 사이트 | [https://enmacc.com](https://enmacc.com) |
| 앱 사용 약관 | [https://enmacc.com/terms_en.html](https://enmacc.com/terms_en.html) |
| 앱의 핵심 기능 | 모든 enmacc 실시간 에너지 거래 활동을 Microsoft Teams. |
| 회사 본사 위치 | 독일 |
| 앱 정보 페이지 | |
