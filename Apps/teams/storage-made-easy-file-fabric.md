---
title: 쉽게 만든 Storage 파일 패브릭에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: File Fabric에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/bd063a87-1e4d-42cf-baea-8cab71839e35" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003017" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Storage Microsoft에서 제공하는 정보:
...
| 회사 웹 사이트 | [https://storagemadeeasy.com](https://storagemadeeasy.com) |
| 앱의 사용 약관 | [https://www.storagemadeeasy.com/terms](https://www.storagemadeeasy.com/terms) |
| 앱의 핵심 기능 | Azure Files, Azure Blob Storage 및 기타 스토리지에 저장된 파일을 검색, 찾아보기, 편집 및 공유합니다. |
...
| 앱에서 사용하는 호스팅 클라우드 공급자는 무엇인가요? | SelfHosted, Azure, AWS, GCP, IBMCloud, 사용자는 Wasabi, Backblaze, Cloudian, Dropbox, Box.com, Salesforce, S3 호환, FTP 및 WebDAV 서비스와 연결할 수 있습니다. |
...
이 정보는 Storage Made Easy에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 제공했습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite | 응용 프로그램 | 사용자가 앱을 통해 지정된 파일을 다운로드, 업로드 또는 편집할 때 파일 데이터를 읽거나 씁니다. | [0752d800-857f-49bd-87eb-e60985516c67](../azure/0752d800-857f-49bd-87eb-e60985516c67.md) |
>| Sites.ReadWrite.All | 응용 프로그램 | 모든 사용자&#8217;파일 및 폴더에 대해 수집된 메타데이터는 모든 파일 서비스에서 페더레이션된 보기를 제공합니다. | [0752d800-857f-49bd-87eb-e60985516c67](../azure/0752d800-857f-49bd-87eb-e60985516c67.md) |
