---
title: 클라우드 커버 IT의 check.it 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/21/2022
...
description: CSA STAR 레지스트리의 check.it, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/b5107b74-70ca-443e-be2a-61b14ba5341d" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003604" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

클라우드 커버 IT에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | IT를 다루는 클라우드 |
| 회사의 웹 사이트 | [https://www.cloudcoverit.co.uk](https://www.cloudcoverit.co.uk) |
| 앱 사용 약관 | [https://www.cloudcoverit.co.uk/terms](https://www.cloudcoverit.co.uk/terms) |
| 앱의 핵심 기능 | 템플릿 기반 검사 목록을 만들어 그룹, 팀 또는 자신과 공유합니다. |
...
이 정보는 클라우드 커버 IT에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직이 하게 될 컨트롤에 대해 제공됩니다.
...
| 데이터베이스에 저장되는 데이터는 무엇입니까? | 테넌트, 채널 및 대화 ID |
...
| 개인 정보 취급 방침 URL | https://www.cloudcoverit.co.uk/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 위임 | Active Directory ID 액세스 | [898cccfe-ed44-4140-ad2f-c5dd98a12820](../azure/898cccfe-ed44-4140-ad2f-c5dd98a12820.md) |
