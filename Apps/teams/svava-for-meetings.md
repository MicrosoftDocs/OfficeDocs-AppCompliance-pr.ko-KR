---
title: Svava의 모임용 Svava에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/17/2021
...
| 회사 본사 위치 | 스웨덴 |
| 앱 정보 페이지 | [https://svava.io](https://svava.io) |
...
이 정보는 Svava에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직에서 제공하는 컨트롤에 대해 제공됩니다.
