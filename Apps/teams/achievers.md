...
description: 달성자에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/76903584-359f-4e1e-9f6e-741f48322709" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000573" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

달성자가 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | Achievers |
| 회사 웹 사이트 | [https://www.achievers.com](https://www.achievers.com) |
| 앱의 사용 약관 | [https://developer.achievers.com/docs/achievers-terms-of-use](https://developer.achievers.com/docs/achievers-terms-of-use) |
| 앱의 핵심 기능 | Microsoft 에코시스템 내에서 마찰이 적어 달성자 플랫폼에서 동료에 대한 인식을 만듭니다. |
| 회사 본사 위치 | 캐나다 |
| 앱 정보 페이지 | [https://www.achievers.com/connect/teams/](https://www.achievers.com/connect/teams/) |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 달성자가 제공했습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 아니오 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 테넌트 ID, 사용자 ID, 사용자 전자 메일, 사용자 로캘, 봇 ID, 봇 이름, 봇 서비스 URL |
...
| 개인 정보 취급 방침 URL | https://over.achievers.com/ilr_privacy_policy |
