---
title: Aimful의 Aimful에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
ms.date: 01/31/2022
ms.topic: article
...
description: Aimful, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보
...
ms.locfileid: "62306071"
---
# <a name="aimful"></a>목표

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 1월 28일</p>

* <a href="https://teams.microsoft.com/l/app/7da7691c-e47a-479e-9bb2-cda07cffd0e5" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003698" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Aimful에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | 목표 |
| 회사의 웹 사이트 | [https://aimful.io](https://aimful.io) |
| 앱 사용 약관 | [https://aimful.io/terms-and-conditions/](https://aimful.io/terms-and-conditions/) |
| 앱의 핵심 기능 | 팀 또는 회사에서 모임 문화 혁신을 장려  |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
...
이 정보는 Aimful에서 이 앱이 조직 데이터를 수집 및 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직이 제공하는 컨트롤에 대해 제공됩니다.
...
| 데이터베이스에 저장되는 데이터는 무엇입니까? | 일정의 이벤트, 사용자 전자 메일 및 시간 표시 |
...
| 앱이 COPPA(온라인 개인 정보 보호법)를 준수하나요? | 아니오 |
...
| 개인 정보 취급 방침 URL | https://aimful.io/policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | 위임 | 일정 이벤트 액세스 | [93544582-de9c-42a0-baa5-df3d25e9bd48](https://docs.microsoft.com/microsoft-365-app-certification/azure/93544582-de9c-42a0-baa5-df3d25e9bd48) |
>| MailboxSettings.Read | 위임 | 사용자의 시간제어 액세스 | [93544582-de9c-42a0-baa5-df3d25e9bd48](https://docs.microsoft.com/microsoft-365-app-certification/azure/93544582-de9c-42a0-baa5-df3d25e9bd48) |
