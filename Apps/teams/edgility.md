---
title: Edgility별 Edgility에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/14/2022
...
description: Edgility, 해당 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/fe2f94eb-7164-4fcd-a2c7-16db90307caa" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003970" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Microsoft에 Edgility에서 제공하는 정보:
...
| 파트너 회사 이름 | Edgility |
| 회사 웹 사이트 | [https://edgility.com.au](https://edgility.com.au) |
| 앱의 사용 약관 | [https://www.edgility.com.au/legal/](https://www.edgility.com.au/legal/) |
| 앱의 핵심 기능 | Edgility는 통합 엔터프라이즈 통신 도구 개발의 선두 주체입니다. 이러한 SMS 솔루션을 통해 조직은 이미 사용하는 플랫폼을 사용하여 비즈니스에 중요한 것을 사람들에게 알리고, 홍보하고, 경고하고, 알리는 프로세스를 간소화할 수 있습니다. 여기에는 Excel, Outlook 및 Teams 같은 Microsoft 제품이 포함됩니다. 사용자는 Microsoft Outlook 및 Teams SMS를 수신하여 이 효과적인 대화형 도구를 활용할 수 있습니다. |
| 회사 본사 위치 | 오스트레일리아 |
| 앱 정보 페이지 | [https://www.edgility.com.au/microsoft/teams/](https://www.edgility.com.au/microsoft/teams/) |
...
이 정보는 Edgility에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 이름 |
