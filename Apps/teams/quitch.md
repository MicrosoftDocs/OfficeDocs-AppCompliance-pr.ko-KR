---
title: Quitch로 Quitch에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/21/2022
...
description: Quitch, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용 가능한 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/f2125454-678c-4f97-90cc-dfe4742f4711" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003683" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Quitch에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | Quitch |
| 회사의 웹 사이트 | [https://quitch.com](https://quitch.com) |
| 앱 사용 약관 | [https://quitch.com/user-terms-of-service/](https://quitch.com/user-terms-of-service/) |
| 앱의 핵심 기능 | 모임을 위한 대화형 Microsoft Teams 퀴즈 |
| 회사 본사 위치 | 오스트레일리아 |
| 앱 정보 페이지 | [https://quitch.com/microsoft-teams/](https://quitch.com/microsoft-teams/) |
...
이 정보는 Quitch에서 이 앱이 조직 데이터를 수집 및 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직에서 제공하는 컨트롤에 대해 제공됩니다.
...
| 데이터베이스에 저장되는 데이터는 무엇입니까? | 사용자 전자 메일만 수집 |
...
| 개인 정보 취급 방침 URL | https://quitch.com/privacy-policy/ |
