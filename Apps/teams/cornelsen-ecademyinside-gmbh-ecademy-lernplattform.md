---
title: GmbH 내부 코넬슨 eCademy에 의해 eCademy Lernplattform에 &amp; 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/20/2021
...
description: eCademy Lernplattform, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/8b1066b0-59c2-4a7b-8ac6-f43edcfe5eef" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002717" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

GmbH 내에서 코넬슨 eCademy &amp; 가 Microsoft에 제공하는 정보:
...
| 회사 웹 사이트 | [https://www.ecademy-learning.com](https://www.ecademy-learning.com) |
| 앱의 사용 약관 | [https://www.ecademy-learning.com/agb/](https://www.ecademy-learning.com/agb/) |
| 앱의 핵심 기능 | 혁신적인 교육과 학습을 가능하게 하고자 하는 트레이너와 연수생을 위해 eCademy Lernplattform은 언제든 개인적이고 실용적인 학습 경로를 열어 주는 디지털 학습 솔루션입니다. 우리는 기업과 교육 기관이 미래의 노동 시장을 위해 숙련 된 노동자와 직원을 성공적으로 교육하고 개발하고 증가하는 수요와 점점 더 다른 유형의 인재 풀에 직면하여 더 나은 성과를 발휘 할 수 있도록 도와줍니다. |
| 회사 본사 위치 | 독일 |
| 앱 정보 페이지 | [https://www.ecademy-learning.com](https://www.ecademy-learning.com) |
...
이 정보는 GmbH 내에서 Cornelsen eCademy &amp; 에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
