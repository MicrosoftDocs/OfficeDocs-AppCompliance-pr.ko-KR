---
title: UKG, Inc.의 UKG Pro 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/12/2021
...
description: UKG Pro 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보.
...
* <a href="https://teams.microsoft.com/l/app/f2120944-5201-4c71-8314-770f7806fff0" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003173" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

UKG, Inc.에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | UKG, Inc. |
| 회사 웹 사이트 | [https://ukg.com](https://ukg.com) |
| 앱의 사용 약관 | [https://ukg.com](https://ukg.com) |
| 앱의 핵심 기능 | 직원 정보에 쉽게 액세스하고, 급여 세부 정보를 보고, 요청 시 다른 HR 작업을 완료합니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://ukg.com](https://ukg.com) |
...
이 정보는 UKG, Inc.에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 제공되었습니다.
