...
description: Humu, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용할 수 있는 모든 보안 및 규정 준수 정보
...
| 파트너 회사 이름 | Humu Inc. |
| 회사의 웹 사이트 | [https://www.humu.com](https://www.humu.com) |
| 앱 사용 약관 | [https://www.humu.com/humu-for-microsoft-teams-license](https://www.humu.com/humu-for-microsoft-teams-license) |
| 앱의 핵심 기능 | Humu는 조직이 매주 쉽게 개선할 수 있는 작업 관리 플랫폼입니다. Humu는 비즈니스 전략을 조직 내 모든 사용자에 대해 개인적으로 관련된 작업으로 변환합니다. 주요 초점은 조직을 대규모로 개선하는 데 중점을 두어 생산성, 공동 작업, 혁신적 및 포괄적 인력을 생성합니다. Humu를 사용하면 변경을 더 쉽게 하여 작업을 개선할 수 있습니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
