---
title: Humu Inc.의 Humu에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/01/2021
...
description: Humu에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/7fbbb34f-a0fa-471b-9c2a-abc15daad3cb" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003302" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Humu Inc.가 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | Humu Inc. |
| 회사 웹 사이트 | [https://www.humu.com](https://www.humu.com) |
| 앱의 사용 약관 | [https://www.humu.com/humu-for-microsoft-teams-license](https://www.humu.com/humu-for-microsoft-teams-license) |
| 앱의 핵심 기능 | Humu는 조직이 매주 쉽게 개선할 수 있는 작업 관리 플랫폼입니다. Humu는 비즈니스 전략을 조직 내의 모든 사람에게 개인적으로 관련된 작업으로 변환합니다. 우리의 주요 초점은 조직 개선을 대규모로 추진하여 생산성, 협력, 혁신 및 포용적 인력을 창출하는 것입니다. Humu는 변화를 더 쉽게 만들어 더 나은 작업을 수행합니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 Humu Inc.에서 제공했습니다.
