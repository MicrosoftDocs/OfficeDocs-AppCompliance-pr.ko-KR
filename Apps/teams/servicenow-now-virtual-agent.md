---
title: ServiceNow별 Now 가상 에이전트에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/18/2022
...
description: Now Virtual Agent, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
| 회사 웹 사이트 | [https://www.servicenow.com](https://www.servicenow.com) |
| 앱의 사용 약관 | [https://www.servicenow.com/terms-of-use.html](https://www.servicenow.com/terms-of-use.html) |
| 앱의 핵심 기능 | Now 가상 에이전트를 사용하면 Microsoft Teams에서 직접 일상적인 ServiceNow 작업을 수행할 수 있으므로 채팅을 사용하여 보다 효율적으로 작업할 수 있습니다.  |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://store.servicenow.com](https://store.servicenow.com) |
...
이 정보는 ServiceNow에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
...
| 지원되는 정책 유형 나열 | 관리자는 특정 MS Teams 테넌트에 대한 앱을 차단/차단 해제하도록 선택할 수 있습니다. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsAppInstallation.ReadWriteForUser | 위임 | 이제 가상 에이전트는 이 권한을 사용하여 로그인한 사용자에 대해 설치된 Teams 앱을 읽고, 설치하고, 업그레이드하고, 제거합니다.  | [5a87eaa0-a00c-4382-9bdd-cdada0b6820f](../azure/5a87eaa0-a00c-4382-9bdd-cdada0b6820f.md) |
>| User.ReadBasic.All | 위임 | 앱은 이 권한을 사용하여 사용자의 프로필을 읽습니다. | [5a87eaa0-a00c-4382-9bdd-cdada0b6820f](../azure/5a87eaa0-a00c-4382-9bdd-cdada0b6820f.md) |
>| offline_access | 위임 | 새로 고침 토큰을 가져오는 데 필요합니다. 엔드포인트 /authorize를 사용하고 있습니다. | [5a87eaa0-a00c-4382-9bdd-cdada0b6820f](../azure/5a87eaa0-a00c-4382-9bdd-cdada0b6820f.md) |
>| openid | 위임 | 이제 가상 에이전트 앱에서 OIDC(OpenID Connect) 인증 프로토콜을 사용합니다. | [5a87eaa0-a00c-4382-9bdd-cdada0b6820f](../azure/5a87eaa0-a00c-4382-9bdd-cdada0b6820f.md) |
