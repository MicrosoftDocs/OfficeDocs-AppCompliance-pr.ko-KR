---
title: harmon.ie 이메일 TeamMate에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/10/2021
...
description: 메일 TeamMate, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://appsource.microsoft.com/product/office/WA200002338" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Microsoft에 harmon.ie 제공하는 정보:
...
| 파트너 회사 이름 | harmon.ie |
| 회사 웹 사이트 | [https://harmon.ie](https://harmon.ie) |
| 앱의 사용 약관 | [https://harmon.ie/legal/teammate-eula](https://harmon.ie/legal/teammate-eula) |
| 앱의 핵심 기능 | 전자 메일 TeamMate를 사용하여 Microsoft Teams 대화에 전자 메일 추가  |
| 회사 본사 위치 | 이스라엘 |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직의 제어에 대한 harmon.ie 제공되었습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Chat.Read | 위임 | TeamMate에서 SharePoint/One 드라이브에 저장한 파일을 대화 채팅 구성원과 공유하기 위해 특정 대화의 채팅 구성원을 가져오는 데 필요합니다. | [74a31d8c-1ee9-4fb8-bc22-640ba5f457f4](../azure/74a31d8c-1ee9-4fb8-bc22-640ba5f457f4.md) |
>| Files.ReadWrite.All | 위임 | TeamMate에서 전자 메일 &amp; 첨부 파일을 SharePoint/Teams/OneDrive 저장해야 합니다. | [74a31d8c-1ee9-4fb8-bc22-640ba5f457f4](../azure/74a31d8c-1ee9-4fb8-bc22-640ba5f457f4.md) |
>| Mail.ReadWrite | 위임 | TeamMate에서 사용자의 전자 메일을 표시하고 Teams 저장된 전자 메일에 회신해야 합니다. | [74a31d8c-1ee9-4fb8-bc22-640ba5f457f4](../azure/74a31d8c-1ee9-4fb8-bc22-640ba5f457f4.md) |
>| People.Read | 위임 | TeamMate에서 사용자별 전자 메일을 검색하고 자주 연락하는 사용자를 제안해야 합니다. | [74a31d8c-1ee9-4fb8-bc22-640ba5f457f4](../azure/74a31d8c-1ee9-4fb8-bc22-640ba5f457f4.md) |
>| User.Read | 위임 | 을 사용하면 사용자가 자신의 계정으로 TeamMate에 로그인할 수 있으며 TeamMate에서 기본 사용자 프로필 정보를 볼 수 있습니다. | [74a31d8c-1ee9-4fb8-bc22-640ba5f457f4](../azure/74a31d8c-1ee9-4fb8-bc22-640ba5f457f4.md) |
>| User.ReadBasic.All | 위임 | TeamMate에서 OneDrive 저장된 공유 파일을 순서대로 채팅 구성원 전자 메일 주소를 확인하는 데 필요합니다.  | [74a31d8c-1ee9-4fb8-bc22-640ba5f457f4](../azure/74a31d8c-1ee9-4fb8-bc22-640ba5f457f4.md) |
