---
title: Akari Solutions 제한에 의한 ADI에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2021
...
description: ADI에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://appsource.microsoft.com/product/office/WA200002615" target="_blank">AppSource에서 보기</a>
...
| 회사 웹 사이트 | [https://akari.io](https://akari.io) |
| 앱의 사용 약관 | [https://akari.io/adi-terms-and-conditions/](https://akari.io/adi-terms-and-conditions/) |
| 앱의 핵심 기능 | ADI는 모든 접근성 요구 사항을 충족하고 변경 관리 프로그램을 보강하기 위해 여기에 있습니다. ADI에 Microsoft Teams 내에서 접근성 기능을 사용하는 방법에 대한 답변, 조언 및 정보를 제공하도록 요청할 수 있으며, 숨겨진 상황 장애와 도움이 될 수 있는 도구와 팁에 대해 알아볼 수 있습니다. ADI는 텍스트 기반 대화형 답변, 바이트 크기 비디오 및 다양한 소스의 개념적 링크를 혼합하여 답변합니다. |
| 회사 본사 위치 | 영국 및 북아일랜드(해당) |
| 앱 정보 페이지 | [https://akari.io/adi](https://akari.io/adi) |
...
이 정보는 Akari Solutions Limited에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직의 제어에 대해 제공되었습니다.
