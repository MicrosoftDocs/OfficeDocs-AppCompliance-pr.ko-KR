...
| 회사의 웹 사이트 | [https://akari.io](https://akari.io) |
| 앱 사용 약관 | [https://akari.io/adi-terms-and-conditions/](https://akari.io/adi-terms-and-conditions/) |
| 앱의 핵심 기능 | ADI는 모든 접근성 요구 사항을 충족하고 변경 관리 프로그램을 강화하는 데 도움이 됩니다. ADI에 Microsoft Teams 내에서 접근성 기능을 사용하는 방법에 대한 대답, 조언 및 정보를 제공하면 숨김 및 상황 장애와 도움이 될 수 있는 도구 및 팁에 대해 배울 수 있습니다. ADI는 다양한 원본의 텍스트 기반 대화 답변, 크기에 따라 크기가 정해진 비디오 및 개념 링크를 혼합하여 답변할 수 있습니다. |
