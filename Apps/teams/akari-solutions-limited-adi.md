...
<p>최종 업데이트: 2021년 4월 28일</p>

* <a href="https://teams.microsoft.com/l/app/de5717a1-6884-4b96-8b1e-ee17b5d778f3" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002615" target="_blank">앱소스에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

마이크로 소프트에 제한 아카리 솔루션에서 제공하는 정보 :
...
| 파트너 회사 이름 | Akari Solutions Limited |
| 파트너 웹사이트의 URL | [https://akari.io/adi/](https://akari.io/adi/) |
| Teams 응용 프로그램 정보 페이지의 URL | [https://akari.io/adi](https://akari.io/adi) |
| 개인정보 처리방침의 URL | [https://akari.io/adi-privacy-policy/](https://akari.io/adi-privacy-policy/) |
| 이용 약관의 URL | [https://akari.io/adi-terms-and-conditions/](https://akari.io/adi-terms-and-conditions/) |
...
이 정보는 Akari Solutions Limited에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직이 가질 수 있는 제어에 대해 제공했습니다.
...
>소수의 관리자는 PIM MFA를 통해 응용 프로그램 플랫폼 구성 요소에 액세스할 &amp; 수 있습니다.
...
<iframe height='1020' title='Microsoft Cloud App Security 정보' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/37587' frameborder='no' style='width: 100%;'></iframe>

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/37587" target="_blank">새 탭에서 보기</a>
...
이 정보는 Akari Solutions Limited에서 이 앱이 인증, 승인, 응용 프로그램 등록 모범 사례 및 기타 ID 기준을 처리하는 방법에 대해 제공했습니다.
