---
title: Wrike Inc.의 Wrike에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/05/2021
...
description: Wrike에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
| 파트너 회사 이름 | Wrike Inc. |
| 회사 웹 사이트 | [https://wrike.com](https://wrike.com) |
| 앱의 사용 약관 | [https://www.wrike.com/security/terms/](https://www.wrike.com/security/terms/) |
| 앱의 핵심 기능 | 모든 Wrike 프로젝트를 관리하고 작업을 공동 작업하며 Teams 바로 알림을 받습니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://wrike.com](https://wrike.com) |
