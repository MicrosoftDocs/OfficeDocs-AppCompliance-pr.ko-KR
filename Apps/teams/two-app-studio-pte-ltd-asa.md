---
title: 두 App Studio Pte Ltd.의 Asa 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/09/2021
...
description: Asa에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보
...
* <a href="https://teams.microsoft.com/l/app/2973405f-6e3b-45a3-a3a4-7c85d8d3be88" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003449" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Two App Studio Pte Ltd.에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | Two App Studio Pte Ltd. |
| 회사의 웹 사이트 | [https://asa.team](https://asa.team) |
| 앱 사용 약관 | [https://asa.team/terms](https://asa.team/terms) |
| 앱의 핵심 기능 | 원격 작업 영역 관리 도구 |
| 회사 본사 위치 | 싱가포르 |
| 앱 정보 페이지 | [https://asa.team](https://asa.team) |
...
이 정보는 Two App Studio Pte Ltd.에서 제공했습니다. 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직이 가지는 컨트롤에 대한 정보를 제공합니다.
...
| 데이터베이스에 저장되는 데이터는 무엇입니까? | microsoft tenantId 사용자가 봇 메시지를 보내는 사용자 및 그룹에 대한 것입니다. |
...
| 개인 정보 취급 방침 URL | https://asa.team/privacypolicy |
