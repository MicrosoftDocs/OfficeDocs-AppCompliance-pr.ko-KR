---
title: kitameraki 제한에 의한 서비스로 발권에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/06/2022
...
description: CSA STAR 레지스트리의 Ticketing As A Service, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
ms.locfileid: "65357120"
---
# <a name="ticketing-as-a-service"></a>서비스로 발권

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 4월 5일</p>

* <a href="https://teams.microsoft.com/l/app/aa6b770e-6b8c-4096-9648-5239295ecadc" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003945" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Kitameraki에서 제공하는 정보는 Microsoft로 제한됩니다.
...
| 회사 웹 사이트 | [https://TeamsWork.app](https://TeamsWork.app) |
| 앱의 사용 약관 | [https://TeamsWork.app/terms](https://TeamsWork.app/terms) |
| 앱의 핵심 기능 | 간단한 &amp; 직관적인 UI, 모바일 앱 준비, Single Sign-On, 보안 &amp; 준수, 고가용성, 분석 준비 완료 |
| 회사 본사 위치 | 홍콩 |
| 앱 정보 페이지 | [https://www.teamswork.app/ticketingapp](https://www.teamswork.app/ticketingapp) |
...
이 정보는 kitameraki에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직의 제어에 대해 제한됩니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | SaaS 구독 데이터, Teams 대화 참조 데이터, 티켓 데이터 |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | SaaS 구독 데이터, Teams 대화 참조 데이터, 티켓 데이터 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AppCatalog.Read.All | 위임 | 사용자에게 앱이 설치되어 있는지 확인하려면 | [aa6b770e-6b8c-4096-9648-5239295ecadc](../azure/aa6b770e-6b8c-4096-9648-5239295ecadc.md) |
>| Group.Read.All | 위임 | 팀의 구성원 및 소유자 목록을 얻으려면 애플리케이션 사용 사례에 중요합니다. | [aa6b770e-6b8c-4096-9648-5239295ecadc](../azure/aa6b770e-6b8c-4096-9648-5239295ecadc.md) |
>| TeamsAppInstallation.ReadWriteForUser | 위임 | 사용자에게 앱을 설치하여 ycan이 알림 봇에 연결되도록 하려면 | [aa6b770e-6b8c-4096-9648-5239295ecadc](../azure/aa6b770e-6b8c-4096-9648-5239295ecadc.md) |
>| User.Read.All | 위임 | 사용자의 전체 프로필을 얻으려면 | [aa6b770e-6b8c-4096-9648-5239295ecadc](../azure/aa6b770e-6b8c-4096-9648-5239295ecadc.md) |
>| offline_access | 위임 | 오프라인 상황에서 데이터에 액세스하려면 | [aa6b770e-6b8c-4096-9648-5239295ecadc](../azure/aa6b770e-6b8c-4096-9648-5239295ecadc.md) |
>| openid | 위임 | 사용자 자신으로 로그인하려면 | [aa6b770e-6b8c-4096-9648-5239295ecadc](../azure/aa6b770e-6b8c-4096-9648-5239295ecadc.md) |
>| 프로필 | 위임 | 사용자의 기본 프로필을 얻으려면 | [aa6b770e-6b8c-4096-9648-5239295ecadc](../azure/aa6b770e-6b8c-4096-9648-5239295ecadc.md) |
