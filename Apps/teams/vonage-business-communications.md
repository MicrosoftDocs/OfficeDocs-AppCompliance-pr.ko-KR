---
title: Vonage의 Vonage Business Communications에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/05/2021
...
description: Vonage Business Communications, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/47c6b242-a067-426c-9a02-0f680a42c488" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002988" target="_blank">AppSource에서 보기</a>
...
| 파트너 회사 이름 | Vonage |
| 회사 웹 사이트 | [https://www.vonage.com](https://www.vonage.com) |
| 앱의 사용 약관 | [https://www.vonage.com/legal/unified-communications/tos/glo...](https://www.vonage.com/legal/unified-communications/tos/global-vbc-tos/) |
| 앱의 핵심 기능 | vonage Business Communications for Teams Vonage Direct Routing을 통해 통화, SMS 및 MMS를 사용할 수 있습니다. |
| 회사 본사 위치 | 미국 |
...
이 정보는 Vonage에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 제어에 대해 제공되었습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsActivity.Send | 응용 프로그램 | 이 사용 권한으로 저장된 데이터가 없습니다. | [1d8a304e-ea67-4aa2-9345-2793419cf83f](../azure/1d8a304e-ea67-4aa2-9345-2793419cf83f.md) |
>| User.Read | 위임 | 나중에 이 사용자에게 알림을 보낼 수 있도록 Azure 사용자 ID 및 테넌트 ID를 가져옵니다. | [1d8a304e-ea67-4aa2-9345-2793419cf83f](../azure/1d8a304e-ea67-4aa2-9345-2793419cf83f.md) |
