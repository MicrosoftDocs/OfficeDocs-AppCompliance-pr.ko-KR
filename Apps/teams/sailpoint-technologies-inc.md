---
title: SailPoint Technologies, Inc.의 Sailpoint에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/01/2021
...
description: Sailpoint에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/ceca14aa-4fd9-4a8b-b51f-ee05bf98accc" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002761" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

SailPoint Technologies, Inc.에서 Microsoft에 제공한 정보:
...
| 회사 웹 사이트 | [https://sailpoint.com](https://sailpoint.com) |
| 앱의 사용 약관 | [https://www.sailpoint.com/legal/customer-agreements/](https://www.sailpoint.com/legal/customer-agreements/) |
| 앱의 핵심 기능 | SailPoint의 ID 보안 솔루션은 액세스 관리를 ID 보안과 결합하여 작업자가 더 이상 작업을 수행할 수&#8211;수 있도록 합니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
...
이 정보는 SailPoint Technologies, Inc.에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
