---
title: Avishkaram Technologies Pvt Ltd의 TagMyFav에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/14/2022
...
description: 'TagMyFav에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보'
...
* <a href="https://teams.microsoft.com/l/app/4adaed2f-7c6a-4128-ba20-4fb097581b1b" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002713" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Avishkaram Technologies Pvt Ltd에서 Microsoft에 제공하는 정보:
...
| 회사의 웹 사이트 | [https://www.avishkaram.com](https://www.avishkaram.com) |
| 앱 사용 약관 | [https://www.tagmyfav.com/terms-conditions](https://www.tagmyfav.com/terms-conditions) |
| 앱의 핵심 기능 | 관리용 TagMyFav를 Microsoft 365 쉽게 책갈피를 지정하여 공동 작업 통신을 용이하게 &amp; 합니다. Word &amp; 에서 문서를 만들거나 브라우저에서 리서치하는 동안 Microsoft Teams 전자 메일을 Outlook 공유 링크를 저장합니다. TagMyFav는 고객 지원, 기술 지원, 법률 실무자, &amp; 학생 교사, 마케팅, HR 등의 모든 산업에 적합합니다. 공동 작업 또는 연구에 유용한 링크를 구성하고 공유할 수 있습니다. |
| 회사 본사 위치 | 인도 |
...
이 정보는 Avishkaram Technologies Pvt Ltd에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직에서 제공하는 컨트롤에 대해 제공됩니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기반 인프라가 Microsoft 고객 또는 장치와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇입니까? | 사용자 프로필 데이터, 전자 메일 |
| 앱에서 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기반 인프라에 Microsoft 고객 데이터가 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇입니까? | 전자 메일, 이름, TimeZone, Microsoft Teams ID |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Contacts.Read | 위임 | 사용자의 연락처 읽기 | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](../azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7.md) |
>| User.Read | 위임 | 사용자 기본 프로필 정보 읽기 | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](../azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7.md) |
>| 전자 메일 | 위임 | 사용자 전자 메일 보기 | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](../azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7.md) |
>| offline_access | 위임 | 액세스 권한이 부여된 데이터에 대한 액세스 권한 유지 | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](../azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7.md) |
>| openid | 위임 | 사용자 로그인 | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](../azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7.md) |
>| 프로필 | 위임 | 사용자 프로필 보기 | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](../azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7.md) |
