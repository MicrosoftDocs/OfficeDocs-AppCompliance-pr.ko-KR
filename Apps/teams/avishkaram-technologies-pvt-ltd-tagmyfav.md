---
title: Avishkaram Technologies Pvt Ltd의 TagMyFav에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/14/2022
...
description: TagMyFav, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 3월 12일</p>

* <a href="https://teams.microsoft.com/l/app/4adaed2f-7c6a-4128-ba20-4fb097581b1b" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002713" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Avishkaram Technologies Pvt Ltd에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | Avishkaram Technologies Pvt Ltd |
| 회사 웹 사이트 | [https://www.avishkaram.com](https://www.avishkaram.com) |
| 앱의 사용 약관 | [https://www.tagmyfav.com/terms-conditions](https://www.tagmyfav.com/terms-conditions) |
| 앱의 핵심 기능 | Microsoft 365 TagMyFav를 사용하면 공동 작업 &amp; 통신을 더 쉽게 수행할 수 있는 간편한 책갈피 솔루션을 제공합니다. word에서 문서를 만들거나 브라우저에서 연구를 수행하는 동안 Outlook 전자 메일을 읽는 동안 Microsoft Teams 대화를 나누는 동안 공유 링크를 저장 &amp; 합니다. TagMyFav는 고객 지원, 기술 지원, 법률 실무자, 학생 &amp; 교사, 마케팅, HR 등과 같은 모든 산업에 적합하여 공동 작업 또는 연구에 유용한 링크를 구성하고 공유합니다. |
| 회사 본사 위치 | 인도 |
| 앱 정보 페이지 | [https://www.tagmyfav.com](https://www.tagmyfav.com) |
...
이 정보는 Avishkaram Technologies Pvt Ltd에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 사용자 프로필 데이터, 전자 메일 |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 전자 메일, 이름, TimeZone, Microsoft Teams ID |
...
| 개인 정보 취급 방침 URL | https://www.tagmyfav.com/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Contacts.Read | 위임 | 사용자의 연락처 읽기 | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](/microsoft-365-app-certification/azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7) |
>| User.Read | 위임 | 사용자 기본 프로필 정보 읽기 | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](/microsoft-365-app-certification/azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7) |
>| 전자 메일 | 위임 | 사용자 전자 메일 보기 | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](/microsoft-365-app-certification/azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7) |
>| offline_access | 위임 | 액세스 권한이 부여된 데이터에 대한 액세스 권한 유지 | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](/microsoft-365-app-certification/azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7) |
>| openid | 위임 | 사용자 로그인 | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](/microsoft-365-app-certification/azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7) |
>| 프로필 | 위임 | 사용자 프로필 보기 | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](/microsoft-365-app-certification/azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7) |
