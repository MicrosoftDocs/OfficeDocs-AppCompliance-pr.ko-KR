...
| 앱의 핵심 기능 | monday.com 운영 체제는 원격 팀 작업을 지원하여 모든 프로그램, 프로젝트 및 프로세스를 구성, 구성 및 간소화하는 다용도 작업 OS입니다.  또한 monday.com, 보기, 차트, 자동화 및 통합과 같은 구성 요소와 &#8211; 구성을 사용하여 프로세스, 프로젝트 및 일상 작업을 실행할 사용자 지정 워크플로 앱을 만들 수 있습니다. 새 monday.com 보드를 만들거나 기존 보드 내에서 직접 기존 Microsoft Teams 추가하고 하나의 공동 작업&#8217;작업의 작업을 쉽게 시각화할 수 있습니다. |
| 회사 본사 위치 | 이스라엘 |
| 앱 정보 페이지 | |
