---
title: monday.com monday.com 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/05/2021
...
description: monday.com 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://appsource.microsoft.com/product/office/WA200001798" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Microsoft에 monday.com 제공한 정보:
...
| 회사 웹 사이트 | [https://monday.com](https://monday.com) |
| 앱의 사용 약관 | [https://monday.com/l/legal/tos/](https://monday.com/l/legal/tos/) |
| 앱의 핵심 기능 | monday.com 모든 프로그램, 프로젝트 및 프로세스를 구성, 구성 및 간소화하는 원격 팀워크를 지원하는 다양한 작업 OS입니다.  monday.com 통해 보드, 보기, 차트, 자동화 및 통합과 같은 &#8211; 구성 요소를 사용하여 프로세스, 프로젝트 및 일상적인 작업을 실행하는 사용자 지정 워크플로 앱을 만들 수 있습니다. 새 monday.com 보드를 만들거나 Microsoft Teams 내에서 기존 보드를 추가하고 팀&#8217;작업을 하나의 공동 작업 영역에서 쉽게 시각화할 수 있습니다. |
| 회사 본사 위치 | 이스라엘 |
| 앱 정보 페이지 | |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대한 monday.com 제공되었습니다.
