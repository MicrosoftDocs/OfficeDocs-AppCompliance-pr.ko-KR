...
| 회사의 웹 사이트 | [https://monday.com](https://monday.com) |
| 앱 사용 약관 | [https://monday.com/l/legal/tos/](https://monday.com/l/legal/tos/) |
| 앱의 핵심 기능 | monday.com 운영 체제는 원격 팀 작업을 지원하여 모든 프로그램, 프로젝트 및 프로세스를 구성, 구성 및 간소화하는 다용도 작업 OS입니다.  또한 monday.com, 보기, &#8211; 자동화 및 통합과 같은 문서 블록을 사용하여 프로세스, 프로젝트 및 일상 작업을 실행할 사용자 지정 워크플로 앱을 만들 수 있습니다. 새 monday.com 보드를 만들거나 기존 사용자에 추가하여 Microsoft Teams 한 공동 작업 영역의 작업을 쉽게&#8217;쉽게 시각화할 수 있습니다. |
| 회사 본사 위치 | 이스라엘 |
| 앱 정보 페이지 | |
...
이 정보는 이 monday.com 수집 및 저장하는 방법과 앱이 수집하는 데이터를 통해 조직이 하게 될 컨트롤에 대한 정보를 제공합니다.
