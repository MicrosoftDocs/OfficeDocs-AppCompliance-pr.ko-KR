...
description: Beep에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
ms.locfileid: "66852706"
---
# <a name="beep"></a>경고음

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 5월 11일</p>

* <a href="https://teams.microsoft.com/l/app/6b8b29d8-5beb-4eae-915e-5a56a0e1f5a6" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004364" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Medxnote에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | Medxnote |
| 회사 웹 사이트 | [https://medxnote.com](https://medxnote.com) |
| 앱의 사용 약관 | [https://medxnote.com/terms-conditions/](https://medxnote.com/terms-conditions/) |
| 앱의 핵심 기능 | Microsoft Teams에서 MedxPlanner의 EPR 작업 통합을 사용하여 임상 협업을 향상시킵니다. |
| 회사 본사 위치 | 아일랜드 |
| 앱 정보 페이지 | |
...
이 정보는 Medxnote에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 테넌트 ID, 사용자 프로필, 태그 |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 테넌트 ID, 사용자 프로필, 태그 |
| 기본 침입이 Microsoft 고객 데이터를 처리하거나 저장하는 경우 이 데이터는 지리적으로 저장되는 위치는 어디인가요? | 영국 및 북아일랜드(해당) |
| 설정된 데이터 임대 및 폐기 프로세스가 있나요? | 아니요 |
| 계정이 종료된 후 데이터가 보존되는 기간은 얼마인가요? |  |
| 설정된 데이터 액세스 관리 프로세스가 있나요? | 아니요 |
...
| 개인 정보 취급 방침 URL | https://medxnote.com/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.ReadWrite.All | 둘 다 | 사용자의 조직 정보를 가져오고 있습니다. | [5d0905b2-a6de-4480-b5e0-059140592517](../azure/5d0905b2-a6de-4480-b5e0-059140592517.md) |
>| TeamsActivity.Send | 응용 프로그램 | 이 권한은 사용자에게 활동을 보내는 데 사용됩니다. 따라서 이 작업을 사용하여 사용자의 피드에 프로그래밍 활동을 만들어 작업이 업데이트되었다는 것을 알 수 있습니다. | [5d0905b2-a6de-4480-b5e0-059140592517](../azure/5d0905b2-a6de-4480-b5e0-059140592517.md) |
>| TeamworkTag.ReadWrite | 응용 프로그램 | Microsoft Teams의 팀 내에서 태그를 가져와서 만드는 데 이 권한을 사용하고 있습니다. 프로그래밍 방식으로 언급할 수 있도록 합니다. | [5d0905b2-a6de-4480-b5e0-059140592517](../azure/5d0905b2-a6de-4480-b5e0-059140592517.md) |
>| User.Read | 위임 | 이 권한을 사용하여 displayName, 메일, userPrincipalName, ID 및 사진과 같은 사용자의 기본 정보를 가져옵니다. | [5d0905b2-a6de-4480-b5e0-059140592517](../azure/5d0905b2-a6de-4480-b5e0-059140592517.md) |
>| User.Read.All | 응용 프로그램 | 이를 사용하여 총 속성을 가져옵니다. | [5d0905b2-a6de-4480-b5e0-059140592517](../azure/5d0905b2-a6de-4480-b5e0-059140592517.md) |
>| User.ReadWrite.All | 응용 프로그램 | 이를 사용하여 사용자의 조인된 팀을 가져옵니다. | [5d0905b2-a6de-4480-b5e0-059140592517](../azure/5d0905b2-a6de-4480-b5e0-059140592517.md) |
