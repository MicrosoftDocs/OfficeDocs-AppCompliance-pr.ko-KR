...
description: WNI로 공유 스레드에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보
...
---
# <a name="shared-thread-by-wni"></a>WNI로 공유 스레드
...
| 앱의 핵심 기능 | 다른 Microsoft Teams 채널의 대화 또는 Slack의 스레드와 연결할 Microsoft Teams 대화를 만듭니다.  설정이 시작된 후  |
| 회사 본사 위치 | 캐나다 |
| 앱 정보 페이지 | |
