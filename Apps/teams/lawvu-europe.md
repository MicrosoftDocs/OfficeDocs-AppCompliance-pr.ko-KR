---
title: LawVu에 의한 LawVu 유럽 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/04/2022
...
description: LawVu Europe에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
ms.locfileid: "64769111"
---
# <a name="lawvu-europe"></a>LawVu Europe

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 2월 22일</p>

* <a href="https://teams.microsoft.com/l/app/ce6fa59d-9c48-492c-b0e2-434abe99c355" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003931" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

LawVu에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | LawVu |
| 회사 웹 사이트 | [https://lawvu.com](https://lawvu.com) |
| 앱의 사용 약관 | [https://lawvu.com/wp-content/uploads/Std-Saas-Agreement-202...](https://lawvu.com/wp-content/uploads/Std-Saas-Agreement-2021.pdf) |
| 앱의 핵심 기능 | 비즈니스 사용자는 Teams 바로 법적 요청을 제기할 수 있습니다.  통합은 원래 메시지의 콘텐츠 및 첨부 파일을 포함한 모든 관련 필드를 캡처하고 LawVu에서 문제를 만들어 법률 팀&#8217;레코드 시스템의 일부가&#8217;. |
| 회사 본사 위치 | 뉴질랜드 |
...
이 정보는 LawVu에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | MS Teams 첨부 파일입니다. |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | MS 팀의 첨부 파일은 데이터 저장소로 가져옵니다. |
...
| 가장 최근 SOC1 인증 날짜 | 2021-02-28 |
| 앱이 서비스 조직 컨트롤(SOC 2)을 준수하나요? | 예 |
| 어떤 SOC 2 인증을 달성했나요? | type2 |
| 가장 최근 SOC2 인증 날짜 | 2021-02-11 |
...
| 개인 정보 취급 방침 URL | https://lawvu.com/trust-center/privacy/gdpr |
