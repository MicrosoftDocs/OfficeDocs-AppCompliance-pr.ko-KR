---
title: Adobe Systems Inc.의 Adobe Acrobat 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/09/2022
...
* <a href="https://teams.microsoft.com/l/app/10aea93d-20cf-44c2-b4a5-284c5ef2e6a5" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002564" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Adobe Systems Inc.에서 Microsoft에 제공한 정보:
...
| 회사 웹 사이트 | [https://www.adobe.com](https://www.adobe.com) |
| 앱의 사용 약관 | [https://www.adobe.com/legal/terms.html](https://www.adobe.com/legal/terms.html) |
| 앱의 핵심 기능 | adobe Acrobat for Microsoft Teams 통해 PDF 파일 형식의 제작자는 채널의 모든 사용자와 공동 작업하고 Teams 환경을 벗어나지 않고도 단일 PDF &#8211; 피드백을 수집할 수 있는 방법을 제공하고 있습니다. 다른 사용자가 문서에 대해 조치를 취할 때 활동 알림을 받습니다. 검토자는 서로&#8217;피드백을 보고 의견을 제시할 수 있으므로 충돌을 관리하는 데 더 적은 시간을 할애할&#8217;있습니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://helpx.adobe.com/document-cloud/help/microsoft-teams...](https://helpx.adobe.com/document-cloud/help/microsoft-teams.html) |
...
이 정보는 Adobe Systems Inc.에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | UserInfo, OAuth 리소스, 사용자 리소스,  |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | tenant_id, upn_hash, profile_and_token_info, oauth_state, ims_login_changed_at, preference_data, updated_at, created_at, expires_at |
...
| 앱에서 위의 라이브러리 중 하나를 사용하지 않는 경우 어떤 인증 라이브러리 또는 라이브러리를 사용하나요? | 인증 라이브러리를 사용하지 않고 OAuth 2.0 프로토콜을 직접 사용하고 있습니다. |
