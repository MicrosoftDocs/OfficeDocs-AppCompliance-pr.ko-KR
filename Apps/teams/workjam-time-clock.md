---
title: WorkJam의 WorkJam 시간 시계에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/13/2022
...
description: WorkJam Time Clock, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보
...
ms.locfileid: "63548216"
---
# <a name="workjam-time-clock"></a>WorkJam Time Clock

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2021년 12월 16일</p>

* <a href="https://teams.microsoft.com/l/app/c200f629-215e-46ad-a723-9c6b0b1f66f9" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003620" target="_blank">AppSource의 보기</a>
...
| 파트너 회사 이름 | WorkJam |
| 회사의 웹 사이트 | [https://www.workjam.com](https://www.workjam.com) |
| 앱 사용 약관 | [https://appcontent.workjam.com/en/terms-of-use/](https://appcontent.workjam.com/en/terms-of-use/) |
| 앱의 핵심 기능 | WorkJam은 디지털 작업 공간 솔루션 업계 리더가 일선 직원을 일선 생산성 플랫폼 또는 &#8212; 솔루션 내에서 오케스트레이션하기로 선택한 디지털 작업 공간 솔루션입니다. 37개가 넘게 제공되고 38개 국가에서 배포되는 WorkJam은 업계 최고의 작업 관리, 교대 관리, 설문 조사 및 마이크로 학습 도구를 통해 총 인력 오케스트레이션을 제공합니다.  |
| 회사 본사 위치 | 캐나다 |
| 앱 정보 페이지 | [https://www.workjam.com/portfolio-items/workjam-microsoft-t...](https://www.workjam.com/portfolio-items/workjam-microsoft-teams/) |
...
| 데이터베이스에 저장되는 데이터는 무엇입니까? | 사용자 관련 데이터 및 회사 관련 데이터 |
...
| 개인 정보 취급 방침 URL | https://www.workjam.com/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsActivity.Send | application | 사용자에게 알림을 보내기 위해 | [f3388437-b373-4ea7-bcbd-58ec773e0ecf](../azure/f3388437-b373-4ea7-bcbd-58ec773e0ecf.md) |
>| User.Read | 위임 | 사용자를 SSO로 설정하고 올바른 정보를 제공합니다. | [f3388437-b373-4ea7-bcbd-58ec773e0ecf](../azure/f3388437-b373-4ea7-bcbd-58ec773e0ecf.md) |
