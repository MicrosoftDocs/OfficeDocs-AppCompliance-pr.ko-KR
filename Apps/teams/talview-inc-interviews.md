---
title: Talview Inc.에 의해 탈뷰 인터뷰에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
ms.date: 02/12/2021
ms.topic: article
...
description: Talview 인터뷰에 사용할 수 있는 모든 보안 및 규정 준수 정보 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보, CSA STAR 레지스트리의 보안/규정 준수 정보.
...
* <a href="https://teams.microsoft.com/l/app/a4f18f5c-2c9f-4a39-affe-68791a02f418" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002437" target="_blank">앱소스에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Talview Inc.에서 마이크로소프트에 제공 하는 정보:
...
| 파트너 웹사이트의 URL | [https://talview.com](https://talview.com) |
| Teams 응용 프로그램 정보 페이지의 URL | [https://info.talview.com/talview-partners-microsoft-teams](https://info.talview.com/talview-partners-microsoft-teams) |
| 개인정보 처리방침의 URL | [https://talview.com/privacy](https://talview.com/privacy) |
| 이용 약관의 URL | [https://talview.com/terms](https://talview.com/terms) |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 조직에서 앱이 수집하는 데이터에 대한 제어에 대해 Talview Inc.에서 제공했습니다.
...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| User.Read | 위임 | 로그인 및 사용자 프로필 읽기 | 알림 및 인증을 위한 이메일 주소/사용자 이름 | 8b976ed7-cc69-482a-a020-19bdce1041c4 |
>| 전자 메일 | 위임 | 사용자 계정 매핑을 위한 사용자의 이메일 주소 보기 | 알림 및 인증을 위한 이메일 주소/사용자 이름 | 8b976ed7-cc69-482a-a020-19bdce1041c4 |
>| 오픈 ID | 위임 | 로그인하려면 플랫폼에 로그인합니다. | 알림 및 인증을 위한 이메일 주소/사용자 이름 | 8b976ed7-cc69-482a-a020-19bdce1041c4 |
>| 윤곽 | 위임 | 사용자의 기본 프로필 보기 | 알림 및 인증을 위한 이메일 주소/사용자 이름 | 8b976ed7-cc69-482a-a020-19bdce1041c4 |
...
이 정보는 이 앱이 인증, 권한 부여, 응용 프로그램 등록 모범 사례 및 기타 ID 기준을 처리하는 방법에 대해 Talview Inc에서 제공했습니다.
