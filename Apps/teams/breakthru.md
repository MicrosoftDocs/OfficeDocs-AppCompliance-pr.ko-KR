...
description: Breakthru에 대한 사용 가능한 모든 보안 및 규정 준수 정보 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보.
...
<p>최종 업데이트: 2021년 1월 16일</p>

* <a href="https://teams.microsoft.com/l/app/693aa4f0-e16c-11ea-ab9b-11514b3de7ae" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002243" target="_blank">앱소스에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

브레이크스루에서 마이크로소프트에 제공한 정보:
...
| 파트너 회사 이름 | Breakthru |
| 파트너 웹사이트의 URL | [https://breakthru.me](https://breakthru.me) |
| Teams 응용 프로그램 정보 페이지의 URL | [https://breakthru.me](https://breakthru.me) |
| 개인정보 처리방침의 URL | [https://breakthru.me/privacy](https://breakthru.me/privacy) |
| 이용 약관의 URL | [https://breakthru.me/terms](https://breakthru.me/terms) |
...
이 정보는 Breakthru에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직이 가질 수 있는 제어에 대해 제공했습니다.
...
>|:--------------------------------|:---------------------|:--------------------------|
>| 사용자의 기록 통계를 표시하려면  | 전자 메일 | 사용자 통계를 식별하려면 |
...
<iframe height='1020' title='Microsoft Cloud App Security 정보' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/36418' frameborder='no' style='width: 100%;'></iframe>

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/36418" target="_blank">새 탭에서 보기</a>
...
이 정보는 Breakthru에서 이 앱이 인증, 권한 부여, 응용 프로그램 등록 모범 사례 및 기타 ID 기준을 처리하는 방법에 대해 제공했습니다.
