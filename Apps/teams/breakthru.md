---
title: Breakthru by Breakthru에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2022
...
description: Breakthru, 해당 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
| 파트너 회사 이름 | Breakthru |
| 회사 웹 사이트 | [https://breakthru.me](https://breakthru.me) |
| 앱의 사용 약관 | [https://breakthru.me/terms](https://breakthru.me/terms) |
| 앱의 핵심 기능 | 공유하고 재생할 수있는 작은 휴식, 바로 당신의 하루에 내장. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://breakthru.me](https://breakthru.me) |
...
이 정보는 Breakthru에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 아니요 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 전자 메일 주소입니다. 테넌트 ID를 Microsoft Teams. Microsoft Teams ID입니다. 선택한 나누기 기록을 유지 관리하고 중단에 참여하도록 미리 알림을 설정할 수 있습니다. |
| 기본 침입이 Microsoft 고객 데이터를 처리하거나 저장하는 경우 이 데이터는 지리적으로 저장되는 위치는 어디인가요? | 미국, 독일, 영국 및 북아일랜드의 미국(the) |
...
| 개인 정보 취급 방침 URL | https://breakthru.me/privacy#h.wc7yv5k6csnq |
