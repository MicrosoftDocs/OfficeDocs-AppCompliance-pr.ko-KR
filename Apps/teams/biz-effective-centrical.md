---
title: Biz-Effective별 중심 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/08/2021
...
description: CSA STAR 레지스트리의 Centrical, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://appsource.microsoft.com/product/office/WA200001531" target="_blank">AppSource에서 보기</a>
...
| 회사 웹 사이트 | [https://centrical.com](https://centrical.com) |
| 앱의 사용 약관 | [https://centrical.com/terms](https://centrical.com/terms) |
| 앱의 핵심 기능 | 중심적 플랫폼은 직원들이 수행해야 하는 작업과 이를 진행하는 방법에 집중하도록 합니다. 측정된 작업의 데이터를 사용하여 숙련도를 구축하는 마이크로리닝을 프롬프트합니다. 인공 지능을 활용하여 직원 참여, 성과 및 마이크로 리더링을 개선합니다. Centrical 플랫폼은 웹 애플리케이션, 모바일 앱, Microsoft Teams 앱, Salesforce 및 SuccessFactors 앱을 통해 사용할 수 있습니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://centrical.com/solutions/solutions-by-use-case-2/mic...](https://centrical.com/solutions/solutions-by-use-case-2/microsoft-teams-gamification/) |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대한 Biz-Effective 제공되었습니다.
