...
description: CSA STAR 레지스트리의 Centrical, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보
...
| 회사의 웹 사이트 | [https://centrical.com](https://centrical.com) |
| 앱 사용 약관 | [https://centrical.com/terms](https://centrical.com/terms) |
| 앱의 핵심 기능 | 중심 플랫폼은 직원들이 수행해야 하는 작업과 중요한 작업 방식에 집중할 수 있는 플랫폼을 얻게 됩니다. 또한 측정된 작업의 데이터를 사용하여 마이크로리에이터스를 통해 능동적인 정보를 작성합니다. 인공 지능을 활용하여 직원 참여도, 성능 및 마이크로리닝을 향상합니다. Centrical 플랫폼은 웹 응용 프로그램, 모바일 앱, Microsoft Teams, Salesforce 및 SuccessFactors 앱을 통해 사용할 수 있습니다. |
| 회사 본사 위치 | 미국 |
