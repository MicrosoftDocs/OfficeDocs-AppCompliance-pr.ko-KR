---
title: Bigbrains의 BrainBot에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2021
...
description: BrainBot에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/3c95872f-ca12-456e-84b9-c717fe93330c" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA104381981" target="_blank">AppSource에서 보기</a>
...
| 앱의 사용 약관 | [https://brainbot.ai/terms/](https://brainbot.ai/terms/) |
| 앱의 핵심 기능 | BrainBot은 학습 과정에서 지식을 유지하는 데 도움이 되는 짧고 주기적인 상호 작용을 보냅니다. |
| 회사 본사 위치 | 미국 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 응용 프로그램 | 인증 프로세스의 일부로 전자 메일 주소 &amp; 전체 이름을 사용합니다. 또한 전자 메일 주소는 사용자가 구독할 때 사용자에게 학습 순서를 보내는 데 사용됩니다. | [b256b34a-b377-4fc2-b25a-a8f5f0594e86](../azure/b256b34a-b377-4fc2-b25a-a8f5f0594e86.md) |
