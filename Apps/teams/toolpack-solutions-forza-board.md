---
title: 도구 팩 솔루션별 Forza 보드에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/29/2022
...
description: Forza Board, 해당 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
ms.locfileid: "66656567"
---
# <a name="forza-board"></a>Forza 보드

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 6월 13일</p>

* <a href="https://teams.microsoft.com/l/app/b4db3055-5e98-4935-862e-7ffd42761eaa" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004274" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Toolpack Solutions에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | 도구 팩 솔루션 |
| 회사 웹 사이트 | [https://www.toolpack365.com](https://www.toolpack365.com) |
| 앱의 사용 약관 | [https://www.toolpack365.com/kontakt-og-vilkaar](https://www.toolpack365.com/kontakt-og-vilkaar) |
| 앱의 핵심 기능 | 더 나은 협업을 위해 지능형 KPI 및 보고를 통해 잠재력을 발휘합니다. |
| 회사 본사 위치 | 덴마크 |
| 앱 정보 페이지 | |
...
이 정보는 도구 팩 솔루션에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 전자 메일 및 이름 |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 전자 메일 및 이름 |
...
| 개인 정보 취급 방침 URL | https://www.toolpack365.com/cookie-og-privatlivspolitik |
