---
title: Avaamo의 Avaamo IT 도우미에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/01/2021
...
description: 'Avaamo IT 도우미, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보'
...
* <a href="https://teams.microsoft.com/l/app/ed016582-bd1f-4994-ba97-49daab163b19" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003362" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Avaamo에서 Microsoft에 제공한 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | Avaamo IT Assistant |
| ID | WA200003362 |
| Office 365 클라이언트 지원 | Microsoft Teams |
| 파트너 회사 이름 | Avaamo |
| 회사의 웹 사이트 | [https://avaamo.ai](https://avaamo.ai) |
| 앱 사용 약관 | [https://avaamo.ai/tos/](https://avaamo.ai/tos/) |
| 앱의 핵심 기능 | 지원 쿼리를 즉시 해결하는 지능형 Microsoft Office 365 도우미입니다. |
| 회사 본사 위치 | 미국 of America |
| 앱 정보 페이지 | [https://www.avaamo.ai/who-is-avaamo/](https://www.avaamo.ai/who-is-avaamo/) |
...
이 정보는 Avaamo에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직에서 제공하는 컨트롤에 대해 제공됩니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기반 인프라가 Microsoft 고객 또는 장치와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇입니까? | 사용자 프로필 데이터 |
...
| 개인 정보 취급 방침 URL | https://www.avaamo.ai/privacy/ |
