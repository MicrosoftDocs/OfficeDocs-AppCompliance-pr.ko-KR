---
title: Project Insight에 대한 응용 Project 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/22/2022
...
description: Project Insight, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
ms.locfileid: "63753857"
---
# <a name="project-insight"></a>Project 인사이트

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 3월 21일</p>

* <a href="https://teams.microsoft.com/l/app/57a8236b-4ed2-453e-b785-02a887e16a5b" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003171" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Microsoft에 Project 인사이트에서 제공하는 정보:
...
| 파트너 회사 이름 | Project 인사이트 |
| 회사의 웹 사이트 | [https://projectinsight.com](https://projectinsight.com) |
| 앱 사용 약관 | [https://projectinsight.com/legal/license-agreement](https://projectinsight.com/legal/license-agreement) |
| 앱의 핵심 기능 | Project 인사이트를 사용하면 팀에서 직접 작업, 프로젝트, 시간 및 비용을 관리할 수 Teams. |
| 회사 본사 위치 | 미국 |
...
이 정보는 Project 앱이 조직 데이터를 수집하고 저장하는 방법 및 조직이 앱에서 수집하는 데이터를 통해 조직이 제공하는 컨트롤에 대한 정보를 제공합니다.
...
| 데이터베이스에 저장되는 데이터는 무엇입니까? | 사용자 계정 ID |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsAppInstallation.ReadWriteForUser.All | 위임 | 테넌트의 사용자에 대해 앱을 설치할 Microsoft Teams | [2201df78-1d70-41da-ba2b-c19b00da1215](../azure/2201df78-1d70-41da-ba2b-c19b00da1215.md) |
>| User.Read.All | 위임 | 시스템과 테넌트 간에 사용자 Microsoft Teams 일치 | [2201df78-1d70-41da-ba2b-c19b00da1215](../azure/2201df78-1d70-41da-ba2b-c19b00da1215.md) |
