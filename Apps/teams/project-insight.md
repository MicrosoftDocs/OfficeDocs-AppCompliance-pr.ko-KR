---
title: Project Insight의 Project Insight에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/22/2022
...
description: Project Insight, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/57a8236b-4ed2-453e-b785-02a887e16a5b" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003171" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Project Insight에서 Microsoft에 제공한 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | Project Insight |
| ID | WA200003171 |
| 지원되는 Office 365 클라이언트 | Microsoft Teams |
| 파트너 회사 이름 | Project Insight |
| 회사 웹 사이트 | [https://projectinsight.com](https://projectinsight.com) |
| 앱의 사용 약관 | [https://projectinsight.com/legal/license-agreement](https://projectinsight.com/legal/license-agreement) |
| 앱의 핵심 기능 | Project Insight를 사용하면 팀이 Teams 직접 작업, 프로젝트, 시간 및 비용을 관리할 수 있습니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://projectinsight.com/features/microsoft-teams-integra...](https://projectinsight.com/features/microsoft-teams-integration) |
...
이 정보는 Project Insight에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 기본 사용자 프로필 정보 |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 사용자 계정 ID |
...
| 가장 최근 SOC1 인증 날짜 | 2022-01-18 |
| 앱이 서비스 조직 컨트롤(SOC 2)을 준수하나요? | 예 |
| 어떤 SOC 2 인증을 달성했나요? | type2 |
| 가장 최근 SOC2 인증 날짜 | 2022-01-18 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsAppInstallation.ReadWriteForUser.All | 위임 | Microsoft Teams 테넌트에서 사용자에 대해 앱을 설치할 수 있도록 허용하려면 | [2201df78-1d70-41da-ba2b-c19b00da1215](../azure/2201df78-1d70-41da-ba2b-c19b00da1215.md) |
>| User.Read.All | 위임 | 시스템과 Microsoft Teams 테넌트 간에 사용자 일치 | [2201df78-1d70-41da-ba2b-c19b00da1215](../azure/2201df78-1d70-41da-ba2b-c19b00da1215.md) |
>| offline_access | 위임 | 새로 고침 토큰을 요청하는 데 사용됩니다. | [2201df78-1d70-41da-ba2b-c19b00da1215](../azure/2201df78-1d70-41da-ba2b-c19b00da1215.md) |
