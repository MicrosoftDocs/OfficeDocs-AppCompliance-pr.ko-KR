---
title: Teamflect별 Teamflect에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/26/2021
...
description: Teamflect에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/e46015e9-f2ae-4dbc-be6b-f05043192e62" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001860" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Teamflect에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | Teamflect |
| 회사 웹 사이트 | [https://teamflect.com](https://teamflect.com) |
| 앱의 사용 약관 | [https://teamflect.com/terms](https://teamflect.com/terms) |
| 앱의 핵심 기능 | Teamflect는 Microsoft Teams용으로 빌드된 올인원 성능 관리 및 직원 참여 솔루션입니다. 1대1 모임, 목표/OKR, 피드백, 인식 및 작업 모듈을 통해 생산성을 향상시키고 참여도를 높일 수 있습니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
...
이 정보는 Teamflect에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | 응용 프로그램 | 이 권한을 사용하여 사용자 일정에 액세스하여 1대1 모임 식별 | [c5da92a9-873e-4ea1-86c7-03ec9c1384f0](../azure/c5da92a9-873e-4ea1-86c7-03ec9c1384f0.md) |
>| Directory.Read.All | 위임 | 회사 디렉터리 - 이 권한을 사용하여 최종 사용자가 검색을 수행할 때 동료 목록을 표시합니다. | [c5da92a9-873e-4ea1-86c7-03ec9c1384f0](../azure/c5da92a9-873e-4ea1-86c7-03ec9c1384f0.md) |
