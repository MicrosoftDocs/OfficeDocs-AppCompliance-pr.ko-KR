---
title: Weekdone의 Weekdone에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/28/2021
...
description: Weekdone에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보
...
* <a href="https://teams.microsoft.com/l/app/fa662fca-9224-49e3-9566-f66d2a6949af" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003399" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Weekdone Ltd에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | Weekdone Ltd |
| 회사의 웹 사이트 | [https://weekdone.com](https://weekdone.com) |
| 앱 사용 약관 | [https://weekdone.com/terms-of-service](https://weekdone.com/terms-of-service) |
| 앱의 핵심 기능 | 주간 체크 인 및 확인자 보기 및 업데이트, 업데이트에 대한 알림을 받을 수 있습니다. |
| 회사 본사 위치 | 에스토니아 |
| 앱 정보 페이지 | [https://weekdone.com/integrations/microsoft-teams](https://weekdone.com/integrations/microsoft-teams) |
...
이 정보는 Weekdone Ltd에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직에서 사용할 컨트롤에 대해 제공했습니다.
...
| 데이터베이스에 저장되는 데이터는 무엇입니까? | 장치의 IP 주소입니다. 고객의 이름 및 전자 메일 주소입니다. |
...
| 개인 정보 취급 방침 URL | https://weekdone.com/privacy |
