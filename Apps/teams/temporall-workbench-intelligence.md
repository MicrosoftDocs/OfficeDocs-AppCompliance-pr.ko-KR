---
title: Temporall별 Workbench Intelligence에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/24/2021
...
description: Workbench Intelligence에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/d5630318-189a-4912-abae-99b1f8f82cce" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002705" target="_blank">AppSource에서 보기</a>
...
| 파트너 회사 이름 | Temporall |
| 회사 웹 사이트 | [https://www.temporall.com](https://www.temporall.com) |
| 앱의 사용 약관 | [https://www.temporall.com/eula](https://www.temporall.com/eula) |
| 앱의 핵심 기능 | Workbench Intelligence는 더 빠르고 더 나은 결정을 내리는 데 도움이 되는 실시간 인사이트를 제공합니다. |
| 회사 본사 위치 | 영국 및 북아일랜드(해당) |
| 앱 정보 페이지 | [https://www.temporall.com/teams_intelligence/](https://www.temporall.com/teams_intelligence/) |
| 앱을 실행하는 데 사용되는 호스팅 환경 또는 서비스 모델은 무엇인가요? |  |
| 앱에서 사용하는 호스팅 클라우드 공급자는 무엇인가요? | GCP |
...
이 정보는 Temporall에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AppCatalog.Read.All | 위임 | 알려진 외부 ID에 대한 로컬 앱 ID를 가져올 수 있도록 설치된 팀 앱 목록을 가져옵니다. | [d5630318-189a-4912-abae-99b1f8f82cce](../azure/d5630318-189a-4912-abae-99b1f8f82cce.md) |
>| Channel.ReadBasic.All | 응용 프로그램 | 채널 ID &amp; 이름입니다. 근거: 채널의 조인/탈퇴를 허용하여 메시지 활동을 동기화합니다.  | [d5630318-189a-4912-abae-99b1f8f82cce](../azure/d5630318-189a-4912-abae-99b1f8f82cce.md) |
>| ChannelMessage.Read.All | 응용 프로그램 | 보낸 사람 &amp; 대상과 함께 메시지 활동 &amp; 유형입니다. 이러한 경로에서 받은 데이터: /teams/${teamId}/channels/${channelId}/messages /teams/${teamId}/channels/${channelId}/messages/${messageId}. 근거: 메시지 활동에 대한 메트릭 &amp; 보고서를 계산할 수 있습니다. 이는 사용자 &amp; 팀 간의 활동 다이어그램을 그릴 수 있도록 조직 네트워크 분석 모듈의 핵심을 형성합니다. | [d5630318-189a-4912-abae-99b1f8f82cce](../azure/d5630318-189a-4912-abae-99b1f8f82cce.md) |
>| Directory.Read.All | 응용 프로그램 | ClientId, 사용자 목록, 조직 및 하위 채널 목록. 근거: Temporall Workbench에 동기화 사용자를 읽 &amp; 는 데 필요 | [d5630318-189a-4912-abae-99b1f8f82cce](../azure/d5630318-189a-4912-abae-99b1f8f82cce.md) |
>| Group.ReadWrite.All | 응용 프로그램 | 그룹 ID &amp; 이름입니다. 근거: 각 그룹/채널에 앱을 설치하려면 | [d5630318-189a-4912-abae-99b1f8f82cce](../azure/d5630318-189a-4912-abae-99b1f8f82cce.md) |
>| TeamMember.Read.All | 응용 프로그램 | 팀에 대한 사용자 멤버 자격입니다. 근거: Teams 모든 사용자를 Temporall Workbench와 동기화할 수 있습니다. | [d5630318-189a-4912-abae-99b1f8f82cce](../azure/d5630318-189a-4912-abae-99b1f8f82cce.md) |
>| TeamsAppInstallation.ReadWriteForTeam.All | 응용 프로그램 | Team용으로 설치된 앱 목록을 읽습니다. 근거: 앱이 이미 설치되어 있는지 확인합니다. 그렇지 않으면 그래프 API를 통해 메시지 작업을 가져올 수 있도록 설치합니다. | [d5630318-189a-4912-abae-99b1f8f82cce](../azure/d5630318-189a-4912-abae-99b1f8f82cce.md) |
>| TeamsAppInstallation.ReadWriteForUser.All | 응용 프로그램 | 설치된 앱 목록을 읽습니다. 앱이 이미 설치되어 있는지 확인합니다. 그렇지 않으면 설문지를 통해 사용자와 소통하도록 설치합니다. | [d5630318-189a-4912-abae-99b1f8f82cce](../azure/d5630318-189a-4912-abae-99b1f8f82cce.md) |
>| User.Read | 위임 | 기본 사용자 &amp; 회사 정보입니다. 근거: 사용자별 메시지 활동을 분류하는 데 사용되는 봇은 자동 관리 메시징에 참여할 수 있습니다. | [d5630318-189a-4912-abae-99b1f8f82cce](../azure/d5630318-189a-4912-abae-99b1f8f82cce.md) |
