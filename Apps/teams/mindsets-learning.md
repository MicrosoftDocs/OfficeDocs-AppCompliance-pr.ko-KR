...
| 사용 약관 URL | [https://www.mindsets.com/terms](https://www.mindsets.com/terms) |
...
이 정보는 이 Learning 수집 및 저장하는 방법과 앱이 수집하는 데이터에 대해 조직이 제어할 수 있는 컨트롤에 대한 정보를 제공합니다.
...
>|:-----------------------------------------------------|:------------------------------|:----------------------------------------|
>| Amazon Web Services | 사용자 이름, 사용자 전자 메일 | 데이터 저장소 |
...
이 정보는 Mindsets에서 Learning 인증, 권한 부여, 응용 프로그램 등록 모범 사례 및 기타 ID 조건을 처리하는 방법에 대한 정보를 제공합니다.
