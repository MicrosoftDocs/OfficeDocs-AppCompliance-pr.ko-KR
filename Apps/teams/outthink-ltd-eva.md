---
title: OutThink Ltd에 의한 Eva에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: Eva에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/eddbe35e-8260-4878-99d2-946c4aac73f4" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004345" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

OutThink Ltd에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | OutThink Ltd |
| 회사 웹 사이트 | [https://www.outthink.io](https://www.outthink.io) |
| 앱의 사용 약관 | [https://outthink.io/wp-content/uploads/OutThink-SaaS-Terms-...](https://outthink.io/wp-content/uploads/OutThink-SaaS-Terms-and-Conditions.pdf) |
| 앱의 핵심 기능 | Eva는 조직 내에서 사이버 보안 인적 위험을 관리하려는 OutThink 클라이언트에 가상 지원을 제공하는 AI 도우미입니다.  직원에게 교육 진행 상황에 대한 정기적인 업데이트를 제공하고 성과에 대한 효과적인 피드백을 제공하여 사이버 보안 지식을 향상시킵니다. |
| 회사 본사 위치 | 영국 및 북아일랜드(해당) |
| 앱 정보 페이지 | [https://docs.outthink.io/integration-with-microsoft-teams/](https://docs.outthink.io/integration-with-microsoft-teams/) |
...
이 정보는 OutThink Ltd에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직의 제어에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 사용자 메일 데이터, 사용자 일정 약속 있음/없음 정보 |
...
| 개인 정보 취급 방침 URL | https://outthink.io/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | 위임 | Teams 앱을 통해 사이버 보안 교육 슬롯을 예약할 수 있도록 사용자 일정에서 사용 가능한 다음 무료 슬롯을 찾습니다. | [07c3de2f-6e55-4fae-8c97-90964ff2b934](../azure/07c3de2f-6e55-4fae-8c97-90964ff2b934.md) |
>| User.Read | 위임 | 지정된 회사 메일 주소를 가진 사용자에게 메시지를 보내기 위해 전자 메일 주소로 사용자를 식별합니다. | [07c3de2f-6e55-4fae-8c97-90964ff2b934](../azure/07c3de2f-6e55-4fae-8c97-90964ff2b934.md) |
