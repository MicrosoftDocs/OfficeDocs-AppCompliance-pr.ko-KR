...
description: SHL에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/0c52adc0-18a0-45ca-b6ee-154cf1ef87e2" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002887" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

SHL에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | SHL |
| 회사 웹 사이트 | [https://shl.com](https://shl.com) |
| 앱의 사용 약관 | [https://www.shl.com/en/terms-of-service/](https://www.shl.com/en/terms-of-service/) |
| 앱의 핵심 기능 | SHL은 HR 기술 및 정신 메트릭 과학 분야의 글로벌 리더로, 심층 인사이트를 통해 기업이 비즈니스 결과를 이끄는 강력한 인력 솔루션을 만들 수 있도록 지원합니다. SHL은 강력하고 투명한 AI 기술, 데이터 과학 및 객관성을 제공하여 기업이 디지털 시대에 성공하는 데 필요한 인력을 유치, 개발 및 성장시키는 데 도움을 줍니다. |
| 회사 본사 위치 | 영국 및 북아일랜드(해당) |
| 앱 정보 페이지 | [https://www.shl.com/en/about/](https://www.shl.com/en/about/) |
...
이 정보는 SHL에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read.Shared | 위임 | 사용 가능한 공유 Calander 슬롯 | [afd2c390-8b78-40fa-913b-7fc5911e884a](../azure/afd2c390-8b78-40fa-913b-7fc5911e884a.md) |
