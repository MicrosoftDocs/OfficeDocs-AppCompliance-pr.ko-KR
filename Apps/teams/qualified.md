...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| Channel.ReadBasic.All | application | 알림 채널을 선택할 수 있습니다. | 전자 메일 주소, 테넌트 ID, oauth 새로 고침 토큰 | 2c951ed5-c5c6-493f-9b02-4b42e3ba536c |
>| Team.ReadBasic.All | application | 알림 채널을 선택할 수 있도록 모든 팀에서 모든 채널을 찾을 수 있습니다. | 전자 메일 주소, 테넌트 ID, oauth 새로 고침 토큰 | 2c951ed5-c5c6-493f-9b02-4b42e3ba536c |
...
>|:-------------------|:-------------------|:--------------------------|:--------------------------|:---------------------------------------------------|:--------------------------|
>| 봇 프레임워크 API | 네. | 테넌트 ID, 팀 ID, 채널 ID | 테넌트 ID: service_url api 호출에 대한 확인 팀 ID의 + 채널 ID: 봇이 추가된 팀/채널을 확인 | 테넌트 ID, 팀 ID, 채널 ID | 테넌트 ID: service_url api 호출에 대한 확인 팀 ID의 + 채널 ID: 봇이 추가된 팀/채널을 확인 |
