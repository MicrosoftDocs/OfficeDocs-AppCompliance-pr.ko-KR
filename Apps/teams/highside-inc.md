---
title: HighSide, Inc.의 HighSide에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: HighSide에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/d4460828-ddde-4619-b40b-39412667f7a3" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003916" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

HighSide, Inc에서 Microsoft에 제공한 정보:
...
| 회사 웹 사이트 | [https://highside.io](https://highside.io) |
| 앱의 사용 약관 | [https://highside.io/terms-of-service](https://highside.io/terms-of-service) |
| 앱의 핵심 기능 | Microsoft Teams 대한 E2E 암호화된 메시징 &amp; 파일 |
| 회사 본사 위치 | 미국 |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 HighSide, Inc에서 제공했습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 사용자 Microsoft UUID, 사용자 이름, 사용자 전자 메일 주소 |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 사용자 Microsoft UUID, 사용자 이름, 사용자 전자 메일 주소 |
