---
title: My-Serious-Game의 EdMill에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/19/2021
...
description: EdMill에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/484aa99e-4b6b-4182-8c89-3ae4f85f0cd6" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002622" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

My-Serious-Game에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | My-Serious-Game |
| 파트너 웹 사이트의 URL | [https://www.my-serious-game.com](https://www.my-serious-game.com) |
| Teams 애플리케이션 정보 페이지의 URL | [https://www.edmill.com](https://www.edmill.com) |
| 개인 정보 취급 방침의 URL | [https://app.edmill.com/privacy-policy](https://app.edmill.com/privacy-policy) |
| 사용 약관 URL | [https://app.edmill.com/static/cgv.pdf](https://app.edmill.com/static/cgv.pdf) |
...
이 정보는 My-Serious-Game에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 제공되었습니다.
...
<iframe height='1020' title='Microsoft Cloud App Security 정보' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/36913' frameborder='no'></iframe>

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/36913" target="_blank">새 탭에서 보기</a>
...
이 정보는 My-Serious-Game에서 이 앱이 인증, 권한 부여, 애플리케이션 등록 모범 사례 및 기타 ID 기준을 처리하는 방법에 대해 제공했습니다.
