---
title: Grytics Companion 1339 SAS에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/15/2022
...
description: Grytics Companion, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
ms.locfileid: "66547452"
---
# <a name="grytics-companion"></a>Grytics Companion

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 6월 3일</p>

* <a href="https://teams.microsoft.com/l/app/54ab7c02-a92f-4a87-9f59-764e42009fbc" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004217" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

1339 SAS에서 Microsoft에 제공하는 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | Grytics Companion |
| ID | WA200004217 |
| 지원되는 Office 365 클라이언트 | Microsoft Teams |
| 파트너 회사 이름 | 1339 SAS |
| 회사 웹 사이트 | [https://grytics.com](https://grytics.com) |
| 앱의 사용 약관 | [https://grytics.com/terms](https://grytics.com/terms) |
| 앱의 핵심 기능 | 사용자는 Grytics 계정에 추가된 비즈니스 소셜 네트워크의 추세 &amp; 활동을 분석 &amp; 할 수 있습니다. |
| 회사 본사 위치 | 프랑스 |
| 앱 정보 페이지 | |
...
이 정보는 1339 SAS에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 전자 메일, 이름 |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 이름, 앱 사용자에 대한 전자 메일입니다.  |
| 기본 침입이 Microsoft 고객 데이터를 처리하거나 저장하는 경우 이 데이터는 지리적으로 저장되는 위치는 어디인가요? | 아일랜드, 프랑스 |
...
| 개인 정보 취급 방침 URL | https://grytics.com/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 응용 프로그램 | Grytics 관리자가 Grytics 사용자에게 Teams에서 앱을 사용하고 AAD의 사용자 ID와 일치하도록 권한을 부여할 수 있도록 하기 위해 필요합니다. | [94efdec0-aa15-42e4-b45a-cd6437be5752](../azure/94efdec0-aa15-42e4-b45a-cd6437be5752.md) |
>| User.Read | 위임 | SSO 인증 흐름에 필요 | [94efdec0-aa15-42e4-b45a-cd6437be5752](../azure/94efdec0-aa15-42e4-b45a-cd6437be5752.md) |
>| User.Read.All | 응용 프로그램 | Grytics 관리자가 Grytics 사용자에게 Teams에서 앱을 사용하고 AAD의 사용자 ID와 일치하도록 권한을 부여할 수 있도록 하기 위해 필요합니다. | [94efdec0-aa15-42e4-b45a-cd6437be5752](../azure/94efdec0-aa15-42e4-b45a-cd6437be5752.md) |
>| 전자 메일 | 위임 | SSO 인증 흐름에 필요 | [94efdec0-aa15-42e4-b45a-cd6437be5752](../azure/94efdec0-aa15-42e4-b45a-cd6437be5752.md) |
>| offline_access | 위임 | SSO 인증 흐름에 필요 | [94efdec0-aa15-42e4-b45a-cd6437be5752](../azure/94efdec0-aa15-42e4-b45a-cd6437be5752.md) |
>| 프로필 | 위임 | SSO 인증 흐름에 필요 | [94efdec0-aa15-42e4-b45a-cd6437be5752](../azure/94efdec0-aa15-42e4-b45a-cd6437be5752.md) |
