---
title: NimbleSoft Inc.의 PayaFy에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/28/2021
...
description: PayaFy, 해당 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/b6ecb389-d613-4d48-8e4b-90b3cc649fc0" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003397" target="_blank">AppSource에서 보기</a>
...
| 회사 웹 사이트 | [https://payafy.com](https://payafy.com) |
| 앱의 사용 약관 | [https://payafy.com/termsofservice](https://payafy.com/termsofservice) |
| 앱의 핵심 기능 | PayaFy를 사용하면 기업이 지불을 수락할 수 있습니다. 기존 Stripe 계정을 연결하거나 새 계정을 등록할 수 있습니다. |
| 회사 본사 위치 | 미국 |
...
이 정보는 NimbleSoft Inc.에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 이름 및 전자 메일 주소 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.ReadWrite.All | 모두 | 사용자 등록에 사용되는 기본 정보를 읽습니다. | [1e96a64b-9c1c-4cbc-b015-70243ea06c9b](../azure/1e96a64b-9c1c-4cbc-b015-70243ea06c9b.md) |
