---
title: NimbleSoft Inc.의 PayaFy에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
ms.date: 10/28/2021
ms.topic: article
...
description: PayaFy, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보
...
* <a href="https://teams.microsoft.com/l/app/b6ecb389-d613-4d48-8e4b-90b3cc649fc0" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003397" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

NimbleSoft Inc.에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | NimbleSoft Inc. |
| 회사의 웹 사이트 | [https://payafy.com](https://payafy.com) |
| 앱 사용 약관 | [https://payafy.com/termsofservice](https://payafy.com/termsofservice) |
| 앱의 핵심 기능 | PayaFy를 사용하면 기업이 지급을 수락할 수 있습니다. 기존 스트라이프 계정을 연결하거나 새 스트라이프 계정을 등록할 수 있습니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
...
이 정보는 NimbleSoft Inc.에서 제공했습니다. 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터에 대해 조직에서 사용할 컨트롤에 대해 제공합니다.
...
| 데이터베이스에 저장되는 데이터는 무엇입니까? | 이름 및 전자 메일 주소 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.ReadWrite.All | 둘 다 | 사용자 등록에 사용되는 기본 정보를 읽습니다. | [1e96a64b-9c1c-4cbc-b015-70243ea06c9b](https://docs.microsoft.com/microsoft-365-app-certification/azure/1e96a64b-9c1c-4cbc-b015-70243ea06c9b) |
