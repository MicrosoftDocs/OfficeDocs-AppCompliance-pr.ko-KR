---
title: SurveyMonkey의 SurveyMonkey에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/28/2021
...
description: SurveyMonkey에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
<p>개발자가 마지막으로 업데이트한 날짜: 2021년 10월 25일</p>

* <a href="https://teams.microsoft.com/l/app/0fd925a0-357f-4d25-8456-b3022aaa41a9" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA104381088" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

SurveyMonkey에서 Microsoft에 제공한 정보:
...
| 회사 웹 사이트 | [https://www.surveymonkey.com](https://www.surveymonkey.com) |
| 앱의 사용 약관 | [https://www.surveymonkey.com/mp/legal/terms-of-use/](https://www.surveymonkey.com/mp/legal/terms-of-use/) |
| 앱의 핵심 기능 | 설문 조사 및 빠른 설문 조사를 통해 직원 피드백과 감정을 공동 작업하고 캡처합니다. 결과를 한 곳에서 캡처하여 팀을 새로운 응답으로 최신 상태로 유지합니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://help.surveymonkey.com/articles/en_US/kb/Microsoft-T...](https://help.surveymonkey.com/articles/en_US/kb/Microsoft-Teams-Integration) |
...
이 정보는 SurveyMonkey에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직의 제어에 대해 제공되었습니다.
