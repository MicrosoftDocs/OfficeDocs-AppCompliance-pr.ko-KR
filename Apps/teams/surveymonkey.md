...
description: SurveyMonkey, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보
...
| 회사의 웹 사이트 | [https://www.surveymonkey.com](https://www.surveymonkey.com) |
| 앱 사용 약관 | [https://www.surveymonkey.com/mp/legal/terms-of-use/](https://www.surveymonkey.com/mp/legal/terms-of-use/) |
| 앱의 핵심 기능 | 설문 조사 및 빠른 설문 조사를 통해 직원 피드백과 감정을 공동으로 작업하고 캡처합니다. 결과를 한 장소에 캡처하여 팀을 새 응답으로 최신으로 유지할 수 있습니다. |
| 회사 본사 위치 | 미국 |
