---
title: Bigbrains의 더 큰 브레인 eLearning에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Big Brains eLearning, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/12345514-afee-abcd-acde-c5b34109abcd" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002366" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Bigbrains에서 Microsoft에 제공하는 정보:
...
| 회사 웹 사이트 | [https://getbiggerbrains.com](https://getbiggerbrains.com) |
| 앱의 사용 약관 | [https://getbiggerbrains.com/privacy-legal/](https://getbiggerbrains.com/privacy-legal/) |
| 앱의 핵심 기능 | 수상 경력에 빛나는 온라인 교육 과정 라이브러리는 이제 Microsoft Teams 내에서 직접 사용할 수 있습니다.  모든 채널에 더 큰 브레인 탭을 추가하여 180개 이상의 eLearning 과정과 3,000개가 넘는 비디오 레슨에 쉽게 액세스할 수 있습니다. 사용 가능한 항목에는 Microsoft Teams Office &amp; 365Microsoft Excel, Word, Outlook, PowerPoint, Power BI 및 비즈니스 항목이 포함됩니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://usedapplicensing001.azurewebsites.net/teamsApp/inde...](https://usedapplicensing001.azurewebsites.net/teamsApp/index.html) |
...
이 정보는 Bigbrains에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
...
| 가장 최근 SOC1 인증 날짜 | 2021-05-13 |
| 앱이 서비스 조직 컨트롤(SOC 2)을 준수하나요? | 예 |
| 가장 최근 SOC2 인증 날짜 | 2021-05-13 |
| 앱이 서비스 조직 컨트롤(SOC 3)을 준수하나요? | 예 |
| 가장 최근 SOC3 인증 날짜 | 2021-05-13 |
