---
title: MyCheckins by Cloud Catalogs LLC에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2022
...
description: MyCheckins에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/6f74dbb7-cd5c-48ac-b3f4-082eabef3808" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004375" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

클라우드 카탈로그 LLC에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | 클라우드 카탈로그 LLC |
| 회사 웹 사이트 | [https://mycheckins.io](https://mycheckins.io) |
| 앱의 사용 약관 | [https://mycheckins.io/terms-and-conditions](https://mycheckins.io/terms-and-conditions) |
| 앱의 핵심 기능 | Microsoft Teams에서 비동기 스탠드업, 회고 등을 실행합니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://mycheckins.io](https://mycheckins.io) |
...
이 정보는 Cloud Catalogs LLC에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 사용자 프로필 데이터, 사용자 Email, 봇으로 전송된 사용자 메시지 |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 사용자 프로필 데이터, 사용자 Email, 봇으로 전송된 사용자 메시지 |
...
| 개인 정보 취급 방침 URL | https://mycheckins.io/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 응용 프로그램 | 이름, 성 및 전자 메일 주소와 같은 사용자 세부 정보 가져오기 | [8f43fc50-571c-4eab-b6ea-675d55e1755e](../azure/8f43fc50-571c-4eab-b6ea-675d55e1755e.md) |
