...
description: 가케아이에 대해 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보
...
| 파트너 회사 이름 | KAKEAI |
| 회사의 웹 사이트 | [https://kakeai.co.jp](https://kakeai.co.jp) |
| 앱 사용 약관 | [https://kakeai.com/terms](https://kakeai.com/terms) |
| 앱의 핵심 기능 | 클라우드 시스템 KAKEAI;  통신의 &#8220;품질&#8221; 개선 |
| 회사 본사 위치 | 일본 |
