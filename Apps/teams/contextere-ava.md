...
description: 컨텍스트 AVA, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
| 회사의 웹 사이트 | [https://contextere.com](https://contextere.com) |
| 앱 사용 약관 | [https://contextere.com/wp-primary/wp-content/uploads/Contex...](https://contextere.com/wp-primary/wp-content/uploads/Contextere-End-User-License-Agreement-Microsoft-Challenge.pdf) |
| 앱의 핵심 기능 | AVA(Contextere Advanced Virtual Assistant)는 산업 근로자에 대한 직무 정보를 제공합니다. |
| 회사 본사 위치 | 캐나다 |
| 앱 정보 페이지 | |
