...
CoffeePals Technologies Inc.에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | CoffeePals Technologies Inc. |
| 회사의 웹 사이트 | [https://coffeepals.co](https://coffeepals.co) |
...
| 앱에서 어떤 호스팅 클라우드 공급자를 사용하나요? | Aws, MongoDB, Heroku |
...
이 정보는 CoffeePals Technologies Inc.에서 제공하는 정보입니다. 이 앱에서 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터에 대해 조직이 제어할 수 있습니다.
...
| 데이터베이스에 저장되는 데이터는 무엇입니까? | 사용자 프로필 데이터, 사용자 사용 현황 데이터, 사용자 전자 메일 주소, 사용자 일치 기록, 사용자 설정, 조직 설정, 조직 이름, 팀 이름, 조직 아바타, 보고 데이터 일치, 사용자 프로필 사진, 사용자 팀 구성원, 사용자 피드백 |
...
| 개인 정보 취급 방침 URL | https://coffeepals.co/privacy |
