---
title: 기니Pig 상태 기술 AB의 기니Pig에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/20/2022
...
description: GuineaPig에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보
...
* <a href="https://teams.microsoft.com/l/app/75b23a20-bc91-4485-b4a4-a156fe37fe9b" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003486" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

GuineaPig Health Technologies AB에서 Microsoft에 제공하는 정보:
...
| 회사 본사 위치 | 스웨덴 |
| 앱 정보 페이지 | [https://guineapig.app](https://guineapig.app) |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직이 제어할 수 있는 제어에 대해 GuineaPig Health Technologies AB에서 제공했습니다.
...
| 개인 정보 취급 방침 URL | https://www.guineapig.app/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 위임 | User.Read를 사용하여 사용자 이름과 같은 정보를 읽고 채팅 및 탭 등에서 사용합니다. 자세한 설명 https://www.guineapig.app/privacy-policy 을 참조하세요. | [d6a2090f-1447-456b-bd5f-121e4efd8c89](../azure/d6a2090f-1447-456b-bd5f-121e4efd8c89.md) |
