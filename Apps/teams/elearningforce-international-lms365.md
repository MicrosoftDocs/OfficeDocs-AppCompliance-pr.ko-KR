...
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 3월 28일</p>

* <a href="https://appsource.microsoft.com/product/web-apps/elearningforce.lms365_spfx" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

ELEARNINGFORCE International Aps에서 Microsoft에 제공하는 정보:
...
| 회사의 웹 사이트 | [https://lms365.com](https://lms365.com) |
| 앱 사용 약관 | [https://lms365.com/lms365-saas-terms/](https://lms365.com/lms365-saas-terms/) |
| 앱의 핵심 기능 | LMS365를 사용하면 조직에서 SharePoint, Teams 및 모바일 장치를 통해 Microsoft 365 플랫폼에 대한 교육을 전달하고 관리할 수 있으며 직원, 파트너 및 고객에게 친숙한 환경을 제공할 수 있습니다. |
| 회사 본사 위치 | 덴마크 |
| 앱 정보 페이지 | [https://www.elearningforce.com/teams](https://www.elearningforce.com/teams) |
...
| 앱에서 처리되는 데이터는 무엇입니까? | 사용자 프로필 데이터 - 참조 https://trustcenter.elearningforce.com/hc/en-us/articles/360017659377 |
| 앱에서 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기반 인프라에 Microsoft 고객 데이터가 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇입니까? | User Profile Data &amp; Training Records - see https://trustcenter.elearningforce.com/hc/en-us/articles/360009394437 |
| Microsoft 고객 데이터를 원본으로 사용하여 처리하거나 저장하는 경우 이 데이터는 지리적으로 저장되는 위치입니다. | 네덜란드(the), 독일, 영국 영국 및 북아일랜드(the), 일본, 오스트레일리아, 캐나다, 아일랜드 |
...
| 개인 정보 취급 방침 URL | https://lms365.com/privacy/ |
...
| 지원되는 정책 유형 나열 | 장치 플랫폼, 장치 상태, 클라이언트 앱 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| GroupMember.Read.All | application | 앱이 AD 그룹의 구성원을 확장하여 사용자 그룹을 교육에 등록할 수 있도록 허용 | [a1a0b277-0efb-4f00-9661-6d1a3df3cddc](../azure/a1a0b277-0efb-4f00-9661-6d1a3df3cddc.md) |
>| Mail.Send | 위임 | 앱에서 알림 전자 메일을 보낼 수 있습니다. 알림에 대한 전자 메일 계정을 구성하는 동안 사용 권한이 동적으로 요청됩니다. | [a1a0b277-0efb-4f00-9661-6d1a3df3cddc](../azure/a1a0b277-0efb-4f00-9661-6d1a3df3cddc.md) |
>| OnlineMeetings.ReadWrite | 위임 | 앱에서 온라인 모임 이벤트를 만들고, 읽고, 업데이트하고, 삭제할 수 있습니다. 알림에 대한 전자 메일 계정을 구성하는 동안 사용 권한이 동적으로 요청됩니다. | [a1a0b277-0efb-4f00-9661-6d1a3df3cddc](../azure/a1a0b277-0efb-4f00-9661-6d1a3df3cddc.md) |
>| RoleManagement.Read.Directory | application | 앱은 사용자가 가지는 역할과 사용자가 전역 관리자 및/또는 Office 365 관리자인지 SharePoint 수 있습니다. | [a1a0b277-0efb-4f00-9661-6d1a3df3cddc](../azure/a1a0b277-0efb-4f00-9661-6d1a3df3cddc.md) |
>| User.Invite.All | 위임 | 선택적 기능: 카탈로그 관리자가 게스트 사용자를 교육 카탈로그에 초대할 수 있도록 허용합니다. | [a1a0b277-0efb-4f00-9661-6d1a3df3cddc](../azure/a1a0b277-0efb-4f00-9661-6d1a3df3cddc.md) |
>| User.Read | 위임 | 사용자가 Azure AD의 고객&#8217;사용하여 앱에 로그인할 수 있도록 허용하고, 앱에서 로그인한 사용자의 프로필 및 기본 회사 정보를 읽을 수 있도록 합니다. | [a1a0b277-0efb-4f00-9661-6d1a3df3cddc](../azure/a1a0b277-0efb-4f00-9661-6d1a3df3cddc.md) |
>| User.Read.All | 위임 | 앱에서 전체 사용자 프로필을 읽을 수 있도록 허용합니다. 이&#8217;관리자 &amp; 를 읽고 보고서 관리자 대시보드에&#8217; 계층 구조를 작성하는 데 필요한 정보를 제공합니다. | [a1a0b277-0efb-4f00-9661-6d1a3df3cddc](../azure/a1a0b277-0efb-4f00-9661-6d1a3df3cddc.md) |
>| User.Read.All | application | 앱에서 전체 사용자 프로필을 읽을 수 있도록 허용합니다. 이&#8217;관리자 &amp; 를 읽고 보고서 관리자 대시보드에&#8217; 계층 구조를 작성하는 데 필요한 정보를 제공합니다. | [a1a0b277-0efb-4f00-9661-6d1a3df3cddc](../azure/a1a0b277-0efb-4f00-9661-6d1a3df3cddc.md) |
>| 프로필 | 위임 | 사용자에게 로그인에 사용된 계정을 표시하려면 LMS365에서 표시 이름, 이름 및 성, 전자 메일 주소 및 사진 등의 기본 프로필 정보를 표시하려면 이 권한이 필요합니다. | [a1a0b277-0efb-4f00-9661-6d1a3df3cddc](../azure/a1a0b277-0efb-4f00-9661-6d1a3df3cddc.md) |
