---
title: SOE Technologies의 휴미노에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/05/2021
...
description: huminos에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/c0b70874-2c95-4be7-a0cb-0d893e25a2a3" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003308" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

SOE Technologies에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | SOE 기술 |
| 회사 웹 사이트 | [https://www.myokr.co](https://www.myokr.co) |
| 앱의 사용 약관 | [https://www.myokr.co/terms](https://www.myokr.co/terms) |
| 앱의 핵심 기능 | 성능 가속화 |
| 회사 본사 위치 | 인도 |
| 앱 정보 페이지 | [https://www.myokr.co](https://www.myokr.co) |
...
이 정보는 SOE Technologies에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 제공되었습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | 위임 | 사용자 일정 세부 정보를 가져와 사용자 일정에서 1:1 모임 만들기, myOKR 플랫폼에서 만든 업데이트 또는 삭제 및 여유 시간 슬롯 표시 | [5f5ab403-96ae-46a9-b78e-a06d60cc9e4e](../azure/5f5ab403-96ae-46a9-b78e-a06d60cc9e4e.md) |
>| User.Read | 위임 | 사용자 azure 개체 ID를 사용하여 사용자가 전자 메일에 대해 Microsoft 인증을 사용하여 myOKR 앱에 로그인하도록 합니다. | [5f5ab403-96ae-46a9-b78e-a06d60cc9e4e](../azure/5f5ab403-96ae-46a9-b78e-a06d60cc9e4e.md) |
>| User.Read.All | 응용 프로그램 | myOKR 플랫폼과 사용자 정보를 동기화하고 위치, 부서 &amp; 관리자와 같은 다양한 사용자 인하에 따라 관리자에게 myOKR 애플리케이션 분석을 표시합니다. | [5f5ab403-96ae-46a9-b78e-a06d60cc9e4e](../azure/5f5ab403-96ae-46a9-b78e-a06d60cc9e4e.md) |
>| offline_access | 위임 | 사용자의 Azure Active Directory ID | [5f5ab403-96ae-46a9-b78e-a06d60cc9e4e](../azure/5f5ab403-96ae-46a9-b78e-a06d60cc9e4e.md) |
>| openid | 위임 | Microsoft 인증을 사용하여 사용자가 myOKR 앱에 로그인하도록 사용자 azure 개체 ID를 사용합니다. | [5f5ab403-96ae-46a9-b78e-a06d60cc9e4e](../azure/5f5ab403-96ae-46a9-b78e-a06d60cc9e4e.md) |
