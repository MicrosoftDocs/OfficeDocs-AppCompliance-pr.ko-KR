---
title: Media Interactiva Solutions의 MeasureUp에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: MeasureUp, 해당 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/bb1f94be-57aa-452c-9073-7fbb6b8b1797" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003111" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Media Interactiva Solutions에서 Microsoft에 제공하는 정보:
...
| 회사 웹 사이트 | [https://www.measureup.com](https://www.measureup.com) |
| 앱의 사용 약관 | [https://www.measureup.com/legal-notice](https://www.measureup.com/legal-notice) |
| 앱의 핵심 기능 | MeasureUp을 사용하여 팀의 기술을 더 효율적으로 평가하세요! |
| 회사 본사 위치 | 스페인 |
| 앱 정보 페이지 | [https://docs.measureup.com](https://docs.measureup.com) |
...
이 정보는 Media Interactiva Solutions에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 위임 | 등록하고 로그인을 허용하는 프로필 정보입니다. 사용자가 애플리케이션에 액세스할 때 Microsoft 프로필의 데이터는 플랫폼에서 사용자 프로필을 만드는 데 필요합니다. | [481280f4-a4ed-4862-a5a1-4de59da9dca5](../azure/481280f4-a4ed-4862-a5a1-4de59da9dca5.md) |
>| openid | 위임 | 등록하고 로그인을 허용하는 프로필 정보입니다. 사용자가 애플리케이션에 액세스할 때 Microsoft 프로필의 데이터는 플랫폼에서 사용자 프로필을 만드는 데 필요합니다. | [481280f4-a4ed-4862-a5a1-4de59da9dca5](../azure/481280f4-a4ed-4862-a5a1-4de59da9dca5.md) |
>| 프로필 | 위임 | 등록하고 로그인을 허용하는 프로필 정보입니다. 사용자가 애플리케이션에 액세스할 때 Microsoft 프로필의 데이터는 플랫폼에서 사용자 프로필을 만드는 데 필요합니다. | [481280f4-a4ed-4862-a5a1-4de59da9dca5](../azure/481280f4-a4ed-4862-a5a1-4de59da9dca5.md) |
