---
title: Media Interactiva 솔루션의 MeasureUp에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: MeasureUp, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용할 수 있는 모든 보안 및 규정 준수 정보
...
* <a href="https://teams.microsoft.com/l/app/bb1f94be-57aa-452c-9073-7fbb6b8b1797" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003111" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Media Interactiva 솔루션에서 Microsoft에 제공하는 정보:
...
| 회사의 웹 사이트 | [https://www.measureup.com](https://www.measureup.com) |
| 앱 사용 약관 | [https://www.measureup.com/legal-notice](https://www.measureup.com/legal-notice) |
| 앱의 핵심 기능 | MeasureUp을 사용하여 팀의 기술을 보다 효율적으로 평가하세요! |
| 회사 본사 위치 | 스페인 |
...
이 정보는 Media Interactiva Solutions에서 이 앱이 조직 데이터를 수집 및 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직이 가지는 컨트롤에 대해 제공됩니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 위임 | 로그인을 등록하고 허용할 프로필 정보입니다. 사용자가 응용 프로그램에 액세스할 때 플랫폼에서 사용자 프로필을 만드는 데 Microsoft 프로필의 데이터가 필요합니다. | [481280f4-a4ed-4862-a5a1-4de59da9dca5](../azure/481280f4-a4ed-4862-a5a1-4de59da9dca5.md) |
>| openid | 위임 | 로그인을 등록하고 허용할 프로필 정보입니다. 사용자가 응용 프로그램에 액세스할 때 플랫폼에서 사용자 프로필을 만드는 데 Microsoft 프로필의 데이터가 필요합니다. | [481280f4-a4ed-4862-a5a1-4de59da9dca5](../azure/481280f4-a4ed-4862-a5a1-4de59da9dca5.md) |
>| 프로필 | 위임 | 로그인을 등록하고 허용할 프로필 정보입니다. 사용자가 응용 프로그램에 액세스할 때 플랫폼에서 사용자 프로필을 만드는 데 Microsoft 프로필의 데이터가 필요합니다. | [481280f4-a4ed-4862-a5a1-4de59da9dca5](../azure/481280f4-a4ed-4862-a5a1-4de59da9dca5.md) |
