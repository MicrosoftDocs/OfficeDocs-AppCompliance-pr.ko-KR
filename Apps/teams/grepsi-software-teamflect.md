---
title: Grepsi Software의 Teamflect에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/26/2021
...
| 앱의 핵심 기능 | Teamflect는 Microsoft Teams 위해 빌드된 올인원 성능 관리 및 직원 참여 솔루션입니다. 1대1 모임, 목표/OKR, 피드백, 인식 및 작업 모듈을 통해 생산성을 향상시키고 참여도를 높일 수 있습니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
...
이 정보는 Grepsi Software에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 제공되었습니다.
