...
description: 팀플렉트, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보
...
| 회사의 웹 사이트 | [https://teamflect.com](https://teamflect.com) |
| 앱 사용 약관 | [https://teamflect.com/terms](https://teamflect.com/terms) |
| 앱의 핵심 기능 | Teamflect는 모든 사용자에 대해 구축된 올인원 성능 관리 및 직원 참여 Microsoft Teams. 일대일 모임, 목표/확인R, 피드백, 인식 및 작업 모듈을 통해 생산성을 향상하고 참여할 수 있습니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | application | 이 권한을 사용하여 사용자 일정에 액세스하여 일대일 모임을 식별합니다. | [c5da92a9-873e-4ea1-86c7-03ec9c1384f0](../azure/c5da92a9-873e-4ea1-86c7-03ec9c1384f0.md) |
>| Directory.Read.All | 위임 | 회사 디렉터리 - 이 권한을 사용하여 최종 사용자에게 검색을 수행할 때 동료 목록을 표시 | [c5da92a9-873e-4ea1-86c7-03ec9c1384f0](../azure/c5da92a9-873e-4ea1-86c7-03ec9c1384f0.md) |
