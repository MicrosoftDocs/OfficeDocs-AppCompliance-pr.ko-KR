---
title: COGNATA TECHNOLOGIES, LLC의 Qooper에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/25/2021
...
description: Qooper에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/fadca663-cc96-4756-8a3b-271000082238" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002964" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

COGNATA TECHNOLOGIES, LLC에서 Microsoft에 제공하는 정보:
...
| 회사 웹 사이트 | [https://qooper.io](https://qooper.io) |
| 앱의 사용 약관 | [https://qooper.io/terms-of-use](https://qooper.io/terms-of-use) |
| 앱의 핵심 기능 | 의미 있는 연결 콘텐츠를 사용하여 목표를 달성합니다 &amp; . 멘토링, 동료 코칭, 커뮤니티 학습 및 네트워킹을 통해 의미 있는 연결과 콘텐츠로 사람들을 둘러싸세요. Qooper는 모든 규모의 회사, 대학 및 비영리 업체와 협력하여 멘토링 프로그램 관리 작업을 자동화하고, 대화형 멘토링-학습 플랫폼에서 사람들을 연결하고, 프로그램 분석을 표시합니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://qooper.io](https://qooper.io) |
...
이 정보는 COGNATA TECHNOLOGIES, LLC에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
