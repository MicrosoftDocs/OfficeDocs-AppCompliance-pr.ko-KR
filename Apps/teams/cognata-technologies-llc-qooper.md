...
| 회사의 웹 사이트 | [https://qooper.io](https://qooper.io) |
| 앱 사용 약관 | [https://qooper.io/terms-of-use](https://qooper.io/terms-of-use) |
| 앱의 핵심 기능 | 의미 있는 연결 콘텐츠를 사용하여 목표를 달성 &amp; 합니다. 멘토링, 피어 코칭, 커뮤니티 학습 및 네트워킹을 통해 의미 있는 연결 및 콘텐츠로 사용자 둘러싸기 멘토링 프로그램 관리 작업을 자동화하고 대화형 멘토링 학습 플랫폼에서 사람들을 연결하고 프로그램 분석을 표시하기 위해 모든 규모에 대한 기업, 대학 및 비영리 기관과의 Qooper 파트너. |
| 회사 본사 위치 | 미국 |
