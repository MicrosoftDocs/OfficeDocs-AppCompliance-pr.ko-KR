---
title: Standuply Inc.의 Standuply에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/24/2022
...
description: Standuply, 해당 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/1250b735-e9df-4d5b-ae82-da96c55c64e4" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003001" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Standuply Inc.가 Microsoft에 제공한 정보:
...
| 회사 웹 사이트 | [https://standuply.com](https://standuply.com) |
| 앱의 사용 약관 | [https://standuply.com/terms](https://standuply.com/terms) |
| 앱의 핵심 기능 | 독립 실행형으로 관리 프로세스를 자동화하고 팀의 생산성을 높일 수 있는 내부 QA&amp; 시스템을 제공합니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://standuply.com](https://standuply.com) |
...
이 정보는 Standuply Inc.에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 의 P.3 https://standuply.com/privacy-policy |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 의 P.3 https://standuply.com/privacy-policy |
...
| 개인 정보 취급 방침 URL | https://standuply.com/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| MailboxSettings.Read | 응용 프로그램 | 사용자에게 개별 표준 시간대에 대한 보고서를 보내려면 | [e9f5cb58-89eb-4f80-9a6c-b73823b62176](../azure/e9f5cb58-89eb-4f80-9a6c-b73823b62176.md) |
>| User.Read | 위임 | 제품의 사용자에게 권한을 부여하려면 | [e9f5cb58-89eb-4f80-9a6c-b73823b62176](../azure/e9f5cb58-89eb-4f80-9a6c-b73823b62176.md) |
