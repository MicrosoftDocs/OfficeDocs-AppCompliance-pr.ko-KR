---
title: 뉴스 응용 프로그램 정보 - Jalios SA의 Jalios
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: News에 사용할 수 있는 모든 보안 및 규정 준수 정보 - Jalios, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보.
...
---
# <a name="news---jalios"></a>뉴스 - Jalios

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2021년 12월 21일</p>

* <a href="https://teams.microsoft.com/l/app/a8662bd0-31c6-4254-b48f-0f54d0b92fcb" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003889" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Jalios SA에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | Jalios SA |
| 회사 웹 사이트 | [https://www.jalios.com](https://www.jalios.com) |
| 앱의 사용 약관 | [https://jalios.com/msteams-app/termsofuse](https://jalios.com/msteams-app/termsofuse) |
| 앱의 핵심 기능 | 동적 및 사용자 지정 가능한 디지털 회사 신문  |
| 회사 본사 위치 | 프랑스 |
| 앱 정보 페이지 | |
...
이 정보는 Jalios SA에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 사용자 프로필 데이터, 사용자 전자 메일 데이터 |
...
| 개인 정보 취급 방침 URL | https://jalios.com/msteams-app/privacy |
...
| 앱에서 위의 라이브러리 중 하나를 사용하지 않는 경우 어떤 인증 라이브러리 또는 라이브러리를 사용하나요? | JavaScript 클라이언트 SDK Microsoft Teams |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 위임 | 사용자 지정 스키마 확장 속성 읽기  | [5159b699-a8c3-4170-ae49-c22ccb76cdde](../azure/5159b699-a8c3-4170-ae49-c22ccb76cdde.md) |
>| User.Read | 위임 | 사용자 데이터를 읽어 Jalios Workplace에 로그인합니다. | [5159b699-a8c3-4170-ae49-c22ccb76cdde](../azure/5159b699-a8c3-4170-ae49-c22ccb76cdde.md) |
>| offline_access | 위임 | SSO: 데이터에 대한 액세스 유지 관리 | [5159b699-a8c3-4170-ae49-c22ccb76cdde](../azure/5159b699-a8c3-4170-ae49-c22ccb76cdde.md) |
>| openid | 위임 | 사용자 로그인 | [5159b699-a8c3-4170-ae49-c22ccb76cdde](../azure/5159b699-a8c3-4170-ae49-c22ccb76cdde.md) |
