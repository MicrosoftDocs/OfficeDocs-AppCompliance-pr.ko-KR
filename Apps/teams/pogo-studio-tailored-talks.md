---
title: Pogo Studio의 맞춤형 대화에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/05/2022
...
description: 맞춤형 대화, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
ms.locfileid: "66656439"
---
# <a name="tailored-talks"></a>맞춤형 회담

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 5월 23일</p>

* <a href="https://teams.microsoft.com/l/app/a1f5ad93-accd-463f-a8d5-904c77015815" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004309" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Pogo Studio에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | Pogo Studio |
| 회사 웹 사이트 | [https://pogodigitalhealth.com](https://pogodigitalhealth.com) |
| 앱의 사용 약관 | [https://teams.tailored-talks.com/pdf/TermsOfUse.pdf](https://teams.tailored-talks.com/pdf/TermsOfUse.pdf) |
| 앱의 핵심 기능 | 맞춤형 토크를 사용하면 임상의가 환자와 맞춤형 프레젠테이션을 공유할 수 있습니다. |
...
이 정보는 Pogo Studio에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 테넌트 |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 테넌트, 전자 메일 |
...
| 개인 정보 취급 방침 URL | https://teams.tailored-talks.com/pdf/PrivacyPolicy.pdf |
...
| 지원되는 정책 유형 나열 | 정책은 관리자에게 액세스를 세밀하게 제어할 수 있는 특정 사용자 및 그룹을 대상으로 할 수 있습니다. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 응용 프로그램 | 사용자 식별 | [61f93bfb-a23c-4043-9187-fbd3326e614b](../azure/61f93bfb-a23c-4043-9187-fbd3326e614b.md) |
>| openid | 응용 프로그램 | 사용자 식별 | [61f93bfb-a23c-4043-9187-fbd3326e614b](../azure/61f93bfb-a23c-4043-9187-fbd3326e614b.md) |
>| 프로필 | 응용 프로그램 | 사용자 식별 | [61f93bfb-a23c-4043-9187-fbd3326e614b](../azure/61f93bfb-a23c-4043-9187-fbd3326e614b.md) |
