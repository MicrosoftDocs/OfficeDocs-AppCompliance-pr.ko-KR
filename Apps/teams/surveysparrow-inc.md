---
title: SurveySparrow inc.에 의한 SurveySparrow에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2021
...
description: SurveySparrow에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://appsource.microsoft.com/product/office/WA200002257" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

SurveySparrow Inc.에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | SurveySparrow inc. |
| 회사 웹 사이트 | [https://surveysparrow.com](https://surveysparrow.com) |
| 앱의 사용 약관 | [https://surveysparrow.com/legal/terms-of-service/](https://surveysparrow.com/legal/terms-of-service/) |
| 앱의 핵심 기능 | 매일 스탠드업, 매월 행복을 수행하고 직원 맥박을 쉽게 측정합니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://surveysparrow.com/apps/microsoft-teams-survey-integ...](https://surveysparrow.com/apps/microsoft-teams-survey-integration/) |
...
이 정보는 SurveySparrow inc.에서 제공되었습니다. 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어할 수 있습니다.
