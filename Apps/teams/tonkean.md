---
title: Tonkean by Tonkean에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/17/2022
...
description: Tonkean에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
ms.locfileid: "65455058"
---
# <a name="tonkean"></a>통케안 주

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 5월 16일</p>

* <a href="https://teams.microsoft.com/l/app/b7391d00-e8e4-4dc9-970e-ba3386144114" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA104381749" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Tonkean에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | 통케안 주 |
| 회사 웹 사이트 | [https://tonkean.com](https://tonkean.com) |
| 앱의 사용 약관 | [https://tonkean.com/terms/](https://tonkean.com/terms/) |
| 앱의 핵심 기능 | Tonkean은 조직 및 운영 팀이 복잡한 비즈니스 프로세스를 빠르게 자동화할 수 있도록 지원합니다. Tonkean은 코드 없이 솔루션 스튜디오에 빌드된 모든 비즈니스 프로세스를 실행, 모니터링 및 관리할 수 있는 구성 요소를 제공합니다.  |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://tonkean.com](https://tonkean.com) |
...
이 정보는 Tonkean에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 아니오 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 이름, 전자 메일, 사용자 ID입니다. 다른 데이터는 사용자 요청/최면에 저장될 수 있습니다. |
...
| 개인 정보 취급 방침 URL | https://tonkean.com/privacy |
