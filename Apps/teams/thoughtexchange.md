---
title: ThoughtExchange의 ThoughtExchange에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/01/2021
...
description: ThoughtExchange, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보
...
* <a href="https://teams.microsoft.com/l/app/56e9692f-606b-45ef-8c1f-12e1ea5e27db" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003378" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

ThoughtExchange에서 Microsoft에 제공한 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | ThoughtExchange |
| ID | WA200003378 |
| Office 365 클라이언트 지원 | Microsoft Teams |
| 파트너 회사 이름 | ThoughtExchange |
| 회사의 웹 사이트 | [https://thoughtexchange.com](https://thoughtexchange.com) |
| 앱 사용 약관 | [https://www.thoughtexchange.com/participant-leader-terms-of...](https://www.thoughtexchange.com/participant-leader-terms-of-use/) |
| 앱의 핵심 기능 | &#8220;ThoughtExchange는 리더가 위치와 상관없이 인력이나 커뮤니티의 모든 사용자로부터 신입하고 불안정한 입력을 얻을 수 있도록 도움을 줄 수 있습니다. ThoughtExchange는&#8217;그룹 또는 10,000명 그룹과는 무관하게 대규모로 중요한 토론을 진행하고 의사 결정을 내릴 수 &#8221; |
| 회사 본사 위치 | 캐나다 |
| 앱 정보 페이지 | [https://get.thoughtexchange.help/hc/en-us/articles/15000107...](https://get.thoughtexchange.help/hc/en-us/articles/1500010779682) |
...
이 정보는 ThoughtExchange에서 이 앱이 조직 데이터를 수집 및 저장하는 방법 및 조직이 수집하는 데이터를 통해 조직이 하게 될 컨트롤에 대해 제공했습니다.
...
| 개인 정보 취급 방침 URL | https://www.thoughtexchange.com/privacy-policy/ |
