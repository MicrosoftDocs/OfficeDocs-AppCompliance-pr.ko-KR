...
description: CSA STAR 레지스트리의 Gfacility, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보
...
* <a href="https://teams.microsoft.com/l/app/0f553268-ba1c-4bb0-953c-def3e00aac7d" target="_blank">Teams 스토어의 보기</a>
...
| 앱의 핵심 기능 | Microsoft Teams에서 Gfacility로 모임 추적 |
| 회사 본사 위치 | 벨기에 |
| 앱 정보 페이지 | |
