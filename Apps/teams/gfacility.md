---
title: Gfacility의 Gfacility에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
ms.date: 11/17/2021
ms.topic: article
...
description: Gfacility, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보
...
* <a href="https://teams.microsoft.com/l/app/0f553268-ba1c-4bb0-953c-def3e00aac7d" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003474" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Gfacility에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | Gfacility |
| 회사의 웹 사이트 | [https://gfacility.com](https://gfacility.com) |
| 앱 사용 약관 | [https://gfacility.com/terms-of-use](https://gfacility.com/terms-of-use) |
| 앱의 핵심 기능 | Gfacility를 통해 모임을 Microsoft Teams |
| 회사 본사 위치 | 벨기에 |
| 앱 정보 페이지 | |
...
이 정보는 Gfacility에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직이 하게 될 컨트롤에 대해 제공됩니다.
...
| 개인 정보 취급 방침 URL | https://gfacility.com/privacy-policy |
