---
title: MyWorkDrive에 의한 MyWorkDrive에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
ms.date: 01/13/2021
ms.topic: article
...
description: MyWorkDrive에 대한 사용 가능한 모든 보안 및 규정 준수 정보 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보.
...
* <a href="https://teams.microsoft.com/l/app/f4170c12-ec5c-47b9-834a-a4186cf27ec1" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002325" target="_blank">앱소스에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

마이크로 소프트에 MyWorkDrive에서 제공하는 정보 :
...
| 파트너 회사 이름 | MyWorkDrive |
| 파트너 웹사이트의 URL | [https://www.myworkdrive.com](https://www.myworkdrive.com) |
| Teams 응용 프로그램 정보 페이지의 URL | [https://www.myworkdrive.com/support/myworkdrive-teams-integ...](https://www.myworkdrive.com/support/myworkdrive-teams-integration/) |
| 개인정보 처리방침의 URL | [https://www.myworkdrive.com/privacy-policy/](https://www.myworkdrive.com/privacy-policy/) |
| 이용 약관의 URL | [https://www.myworkdrive.com/terms-of-service/](https://www.myworkdrive.com/terms-of-service/) |
...
이 정보는 MyWorkDrive에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직이 가질 수 있는 제어에 대해 제공했습니다.
...
>우리는 고객의 데이터를 저장하지 않습니다. 모든 데이터는 고객 서버에 남아 있습니다.
...
<iframe height='1020' title='Microsoft Cloud App Security 정보' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/36420' frameborder='no' style='width: 100%;'></iframe>

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/36420" target="_blank">새 탭에서 보기</a>
...
이 정보는 이 앱이 인증, 권한 부여, 응용 프로그램 등록 모범 사례 및 기타 ID 기준을 처리하는 방법에 대해 MyWorkDrive에서 제공했습니다.
