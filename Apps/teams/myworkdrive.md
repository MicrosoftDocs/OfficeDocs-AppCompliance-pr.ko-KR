...
description: MyWorkDrive, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용할 수 있는 모든 보안 및 규정 준수 정보
...
| 회사의 웹 사이트 | [https://www.myworkdrive.com](https://www.myworkdrive.com) |
| 앱 사용 약관 | [https://www.myworkdrive.com/terms-of-service/](https://www.myworkdrive.com/terms-of-service/) |
| 앱의 핵심 기능 | MyWorkDrive 앱을 사용하면 파일 공유에 저장된 회사 파일을 Microsoft Teams 공유하고 원격으로 액세스할 수 있는 기능으로 파일 공유 폴더에 액세스할 수 있습니다.   |
| 회사 본사 위치 | 미국 |
...
| 앱에서 어떤 호스팅 클라우드 공급자를 사용하나요? | Azure, Aws, 기타 |
