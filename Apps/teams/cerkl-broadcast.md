---
title: Cerkl을 통해 브로드캐스트에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/08/2021
...
description: 브로드캐스트, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/cfdaef91-3bae-4545-a571-b86b1685857f" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002697" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Cerkl에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | Cerkl |
| 회사 웹 사이트 | [https://cerkl.com](https://cerkl.com) |
| 앱의 사용 약관 | [https://cerkl.com/terms](https://cerkl.com/terms) |
| 앱의 핵심 기능 | Cerkl Broadcast는 직원 대상을 조직&#8217;중요한 커뮤니케이션과 연결합니다. 브로드캐스트는 동작 기반 개인 설정을 사용하여 적절한 채널에서 적절한 시간에 적절한 직원에게 올바른 메시지를 전달합니다. 이&#8217;경쟁에서 차별화되는 곳입니다 - 우리는 정통한 커뮤니케이터가 노력의 중복없이 채널을 통해 의사 소통할 수 있도록 합니다. 브로드캐스트는 또한 고객이 고객을 위해 어떤&#8217;작동하는지 알 수 있도록 도와주는 업계 최고의 메트릭을 제공합니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://cerkl.com/broadcast/microsoft-teams/](https://cerkl.com/broadcast/microsoft-teams/) |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 Cerkl에서 제공했습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 위임 | 사용자의 전자 메일이 수집되어 사용자가 현재 시스템에 있고 조직에서 추가되었는지 확인하는 데 사용됩니다. | [74ef25ab-3685-446c-aa43-4e9cc251ed62](../azure/74ef25ab-3685-446c-aa43-4e9cc251ed62.md) |
