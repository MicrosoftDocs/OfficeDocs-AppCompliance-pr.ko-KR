---
title: Skillsoft의 Skillsoft Percipio에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
ms.date: 10/26/2021
ms.topic: article
...
description: Skillsoft Percipio, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보
...
* <a href="https://teams.microsoft.com/l/app/858597e0-33db-4cc0-bd1e-466b6ceb977a" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003256" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Skillsoft에서 Microsoft에 제공하는 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | Skillsoft Percipio |
| ID | WA200003256 |
| Office 365 클라이언트 지원 | Microsoft Teams |
| 파트너 회사 이름 | Skillsoft |
| 회사의 웹 사이트 | [https://www.skillsoft.com](https://www.skillsoft.com) |
| 앱 사용 약관 | [https://www.skillsoft.com/terms-of-use](https://www.skillsoft.com/terms-of-use) |
| 앱의 핵심 기능 | Skillsoft Percipio는 Percipio 교육 콘텐츠 및 기능의 전체 제품군에 액세스할 수 있도록 합니다. |
| 회사 본사 위치 | 아일랜드 |
| 앱 정보 페이지 | |
...
이 정보는 Skillsoft에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 조직에서 수집하는 데이터를 통해 조직에서 제공하는 컨트롤에 대해 제공됩니다.
