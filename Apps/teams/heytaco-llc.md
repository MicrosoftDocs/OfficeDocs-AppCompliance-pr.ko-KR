---
title: HeyTaco, LLC의 HeyTaco에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
ms.date: 01/11/2022
ms.topic: article
...
description: HeyTaco에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보
...
<p>개발자가 마지막으로 업데이트한 날짜: 2021년 9월 26일</p>

* <a href="https://teams.microsoft.com/l/app/be8d11cf-265a-4974-9912-4ff28c29fc21" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001346" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

HeyTaco, LLC가 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | HeyTaco, LLC |
| 회사의 웹 사이트 | [https://www.heytaco.chat](https://www.heytaco.chat) |
| 앱 사용 약관 | [https://www.heytaco.chat/terms](https://www.heytaco.chat/terms) |
| 앱의 핵심 기능 | HeyTaco! 긍정적인 의사 소통을 원하고 인식, 감사 및 보상을 통해 사람들이 함께 모이면 더 강력한 회사 문화를 구축할 수 있습니다. 각 사람은 매일 다른 팀 구성원에게 5회의 태코를 제공합니다. 타코는 감사를 표시하고 작은 성과부터 큰 성과까지 모든 것을 인식할 수 있는 것입니다. 그러면 사람들은 누적된 타코를 사용하여 만든 흥미로운 개인 또는 팀 기반 보상을 교환할 수 있습니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
...
이 정보는 HeyTaco, LLC에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직이 가지는 컨트롤에 대해 제공됩니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기반 인프라가 Microsoft 고객 또는 장치와 관련된 데이터를 처리하나요? | 아니요 |
| 앱 또는 기반 인프라에 Microsoft 고객 데이터가 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇입니까? | 이름, 전자 메일, 아바타 |
...
| 개인 정보 취급 방침 URL | https://www.heytaco.chat/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| 전자 메일 | 위임 | 사용자 데이터 구성 | [be8d11cf-265a-4974-9912-4ff28c29fc21](https://docs.microsoft.com/microsoft-365-app-certification/azure/be8d11cf-265a-4974-9912-4ff28c29fc21) |
>| openid | 위임 | 사용자가 탭에 로그인할 수 있도록 허용 | [be8d11cf-265a-4974-9912-4ff28c29fc21](https://docs.microsoft.com/microsoft-365-app-certification/azure/be8d11cf-265a-4974-9912-4ff28c29fc21) |
>| 프로필 | 위임 | 사용자의 프로필 정보를 저장하려면 | [be8d11cf-265a-4974-9912-4ff28c29fc21](https://docs.microsoft.com/microsoft-365-app-certification/azure/be8d11cf-265a-4974-9912-4ff28c29fc21) |
