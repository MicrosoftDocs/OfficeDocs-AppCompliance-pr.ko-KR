---
title: Go1 by Go1에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/23/2021
...
description: Go1에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://appsource.microsoft.com/product/office/WA200001484" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Go1에서 Microsoft로 제공하는 정보:
...
| 파트너 회사 이름 | Go1 |
| 회사 웹 사이트 | [https://www.go1.com/user/login](https://www.go1.com/user/login) |
| 앱의 사용 약관 | [https://www.go1.com/en-au/terms/user-terms](https://www.go1.com/en-au/terms/user-terms) |
| 앱의 핵심 기능 | GO1 Teams 앱은 Microsoft Teams 내에서 학습 리소스를 찾고, 사용하고, 공유하고, 논의하는 데 도움이 됩니다. |
| 회사 본사 위치 | 오스트레일리아 |
| 앱 정보 페이지 | |
...
이 정보는 Go1에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite.All | 응용 프로그램 | 앱이 파일 데이터를 저장하지 않음 | [c859de61-8a6b-42e6-ba88-f639df33bc72](../azure/c859de61-8a6b-42e6-ba88-f639df33bc72.md) |
>| Group.ReadWrite.All | 응용 프로그램 | 앱 관리 학습 환경을 지원하기 위해 저장된 Teams 및 채널 이름 및 고유 ID | [c859de61-8a6b-42e6-ba88-f639df33bc72](../azure/c859de61-8a6b-42e6-ba88-f639df33bc72.md) |
>| User.Read.All | 응용 프로그램 | 직접 개인 학습자 환경을 제공하기 위해 저장된 사용자 이름 및 전자 메일 및 UPN | [c859de61-8a6b-42e6-ba88-f639df33bc72](../azure/c859de61-8a6b-42e6-ba88-f639df33bc72.md) |
