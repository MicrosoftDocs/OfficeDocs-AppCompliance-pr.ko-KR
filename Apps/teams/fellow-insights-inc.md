...
| 회사의 웹 사이트 | [https://fellow.app](https://fellow.app) |
| 앱 사용 약관 | [https://fellow.app/terms-of-use/](https://fellow.app/terms-of-use/) |
| 앱의 핵심 기능 | 동료는 팀이 생산적인 팀 모임과 의미 있는 1:1을 모으고, 공동 작업 모임 안안을 구축하고, 결정을 기록하고, 서로의 책임이 유지되는 장소입니다. |
| 회사 본사 위치 | 캐나다 |
...
| 데이터베이스에 저장되는 데이터는 무엇입니까? | 사용자 프로필 데이터(이름, 전자 메일, 아바타 등...), 일정 데이터(일정 목록, 이벤트, 참석자 등...), Teams 데이터(팀 이름, 팀 구성원 자격)입니다. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | 둘 다 | 동료는 모임 관리 앱으로, 효율적으로 작동하기 위해서는 사용자의 일정을 읽고 쓸 수 있는 액세스 권한이 필요합니다. | [f6671df0-1909-428c-91f7-1c42df04d3e4](../azure/f6671df0-1909-428c-91f7-1c42df04d3e4.md) |
>| Channel.ReadBasic.All | 위임 | 사용자가 동료에 나열된 특정 채널에 모임 메모를 게시할 수 있습니다. 채널이 존재하는 채널만 볼 수 있습니다. 메시지를 읽을 수 있는 기능을 제공하지는 않습니다. | [f6671df0-1909-428c-91f7-1c42df04d3e4](../azure/f6671df0-1909-428c-91f7-1c42df04d3e4.md) |
>| Directory.Read.All | application | (응용 프로그램에만 부여) 동료가 모든 사용자를 포함하여 사용자 디렉터리 정보를 동기화할 수 있도록 허용합니다. | [f6671df0-1909-428c-91f7-1c42df04d3e4](../azure/f6671df0-1909-428c-91f7-1c42df04d3e4.md) |
>| Group.Read.All | application | (응용 프로그램에만 부여) 동료가 사용자 및 그룹을 동기화할 수 있도록 허용합니다. | [f6671df0-1909-428c-91f7-1c42df04d3e4](../azure/f6671df0-1909-428c-91f7-1c42df04d3e4.md) |
>| People.Read | 위임 | 사용자가 메모를 보낼 Microsoft Teams 수 있도록 허용합니다. | [f6671df0-1909-428c-91f7-1c42df04d3e4](../azure/f6671df0-1909-428c-91f7-1c42df04d3e4.md) |
>| People.Read.All | application | (응용 프로그램에만 부여) 모든 사용자에 대한 프로필 정보에 대한 액세스를 허용합니다. | [f6671df0-1909-428c-91f7-1c42df04d3e4](../azure/f6671df0-1909-428c-91f7-1c42df04d3e4.md) |
>| Team.ReadBasic.All | 위임 | 동료가 메모를 보내고 동료 탭을 추가할 수 있도록 팀에 대한 기본 정보를 얻을 수 있습니다. | [f6671df0-1909-428c-91f7-1c42df04d3e4](../azure/f6671df0-1909-428c-91f7-1c42df04d3e4.md) |
>| User.Read | 위임 | 사용자가 동료에 로그인하고 기본 프로필 정보를 받을 수 있도록 허용합니다. | [f6671df0-1909-428c-91f7-1c42df04d3e4](../azure/f6671df0-1909-428c-91f7-1c42df04d3e4.md) |
>| User.Read.All | application | (응용 프로그램에만 부여) 모든 사용자에 대한 프로필 정보에 대한 액세스를 허용합니다. | [f6671df0-1909-428c-91f7-1c42df04d3e4](../azure/f6671df0-1909-428c-91f7-1c42df04d3e4.md) |
>| offline_access | 위임 | 동료는 백그라운드 동기화 &quot;를&quot; 위해 일정 데이터에 오프라인으로 액세스해야 합니다. | [f6671df0-1909-428c-91f7-1c42df04d3e4](../azure/f6671df0-1909-428c-91f7-1c42df04d3e4.md) |
