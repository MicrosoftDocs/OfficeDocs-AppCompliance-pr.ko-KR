...
| 앱의 핵심 기능 | Olive VLE은 강사 및 교육 공급자가 교육 과정, 교육 프로그램 및 학습자들을 만들고 관리하는 데 도움이 됩니다. 교육 공급자 관리자는 자체 온라인 과정, 테스트, 과제, 프로그램을 작성하고 학습자에게 할당할 수 있습니다. Microsoft Teams API를 사용하여 Graph 통합되어 있으므로 관리자가 Teams 강의실에서 비디오 강의실을 만들고 학습자들을 비디오 강의실로 초대할 수 있습니다. 학습자는 과정을 보고 이수하고 포트폴리오 증거를 관리할 수 있습니다. 관리자는 뉴스 피드를 게시할 수도 있습니다. |
| 회사 본사 위치 | 아일랜드 |
| 앱 정보 페이지 | |
