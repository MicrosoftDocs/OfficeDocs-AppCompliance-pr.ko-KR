---
title: OliveGroup의 OLIVE VLE에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/12/2021
...
description: OLIVE VLE에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보
...
* <a href="https://teams.microsoft.com/l/app/ccb8561b-4f4a-496f-898f-b27e681c3a62" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003331" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

OliveGroup에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | OliveGroup |
| 회사의 웹 사이트 | [https://www.olivegroup.io](https://www.olivegroup.io) |
| 앱 사용 약관 | [https://vle.olivegroup.io/termsofuse](https://vle.olivegroup.io/termsofuse) |
| 앱의 핵심 기능 | Olive VLE은 강사 및 교육 공급자가 교육 과정, 교육 프로그램 및 학습자들을 만들고 관리하는 데 도움이 됩니다. 교육 공급자 관리자는 자체 온라인 과정, 테스트, 과제, 프로그램을 작성하고 학습자에게 할당할 수 있습니다. Microsoft Teams 통합되어 Graph API를 사용하여 통합되어 있으므로 관리자가 Teams 강의실에서 비디오 강의실을 만들고 학습자들을 비디오 강의실로 초대할 수도 있습니다. 학습자는 과정을 보고 이수하고 포트폴리오 증거를 관리할 수 있습니다. 관리자는 뉴스 피드를 게시할 수도 있습니다. |
| 회사 본사 위치 | 아일랜드 |
| 앱 정보 페이지 | |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직에서 제공하는 컨트롤에 대해 OliveGroup에서 제공했습니다.
