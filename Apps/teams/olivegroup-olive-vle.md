---
title: OliveGroup의 OLIVE VLE에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/12/2021
...
description: OLIVE VLE, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/ccb8561b-4f4a-496f-898f-b27e681c3a62" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003331" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

OliveGroup에서 Microsoft에 제공하는 정보:
...
| 회사 웹 사이트 | [https://www.olivegroup.io](https://www.olivegroup.io) |
| 앱의 사용 약관 | [https://vle.olivegroup.io/termsofuse](https://vle.olivegroup.io/termsofuse) |
| 앱의 핵심 기능 | Olive VLE은 튜터와 교육 제공자가 과정, 견습 프로그램 및 학습자를 만들고 관리하는 데 도움이 됩니다. 교육 공급자 관리자는 자신의 온라인 과정, 테스트, 과제, 프로그램을 빌드하고 학습자에게 할당할 수 있습니다. Microsoft Teams Graph API를 사용하여 통합되므로 관리자는 Teams 내에서 비디오 교실을 만들고 학습자를 비디오 교실에 초대할 수도 있습니다. 학습자는 자신의 과정, 프로그램 및 포트폴리오 증거를 보고 수강할 수 있습니다. 관리자는 뉴스 피드를 게시할 수도 있습니다. |
| 회사 본사 위치 | 아일랜드 |
| 앱 정보 페이지 | |
...
이 정보는 OliveGroup에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 제어에 대해 제공되었습니다.
