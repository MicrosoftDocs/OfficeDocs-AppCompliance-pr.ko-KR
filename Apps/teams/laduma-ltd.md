---
title: Laduma Ltd.의 Laduma에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/11/2022
...
description: Laduma에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/3bcb0d8a-5ec8-4637-a946-958e5c0277fd" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003907" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Laduma Ltd.가 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | Laduma Ltd. |
| 회사 웹 사이트 | [https://laduma.com](https://laduma.com) |
| 앱의 사용 약관 | [https://laduma.com/terms-of-service/](https://laduma.com/terms-of-service/) |
| 앱의 핵심 기능 | Microsoft Teams 대한 무제한 화이트보드, 문서 및 애플리케이션 공유 |
...
이 정보는 Laduma Ltd.에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 사용자 프로필 데이터, 사용자 이벤트 데이터, GraphAPI 액세스 토큰, Microsoft Teams 채널, 일정 및 회의실 리소스 |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 사용자 프로필 데이터, 사용자 이벤트 데이터, GraphAPI 액세스 토큰, Microsoft Teams 채널, 일정 및 회의실 리소스 |
...
| 개인 정보 취급 방침 URL | https://laduma.com/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Application.Read.All | 응용 프로그램 | 일정에 모임을 추가하려고 할 때 애플리케이션이 설치되어 있는지 확인합니다. | [21759f96-a64d-450b-bf2a-b5e932d6ea01](../azure/21759f96-a64d-450b-bf2a-b5e932d6ea01.md) |
>| Calendars.Read | 모두 | 사용자의 일정에 모임을 추가해야 합니다. | [21759f96-a64d-450b-bf2a-b5e932d6ea01](../azure/21759f96-a64d-450b-bf2a-b5e932d6ea01.md) |
