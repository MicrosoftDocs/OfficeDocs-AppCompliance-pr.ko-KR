---
title: FinTech Studios의 FinTech Studios에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/13/2022
...
description: FinTech Studios에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
ms.locfileid: "64974392"
---
# <a name="fintech-studios"></a>FinTech Studios

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 3월 1일</p>

* <a href="https://teams.microsoft.com/l/app/65e85032-940c-4d03-ad03-029fe9fff997" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003969" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

FinTech Studios에서 Microsoft에 제공한 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | FinTech Studios |
| ID | WA200003969 |
| 지원되는 Office 365 클라이언트 | Microsoft Teams |
| 파트너 회사 이름 | FinTech Studios |
| 회사 웹 사이트 | [https://www.fintechstudios.com](https://www.fintechstudios.com) |
| 앱의 사용 약관 | [https://www.fintechstudios.com/eula](https://www.fintechstudios.com/eula) |
| 앱의 핵심 기능 | AI 기반 비즈니스 인텔리전스 |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://www.fintechstudios.com/products](https://www.fintechstudios.com/products) |
...
이 정보는 FinTech Studios에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 사용자 프로필 데이터, 팀 이름/ID, 채널 이름/ID(메시지 데이터 없음), 채팅 이름/ID(메시지 데이터 없음) |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 사용자 프로필 데이터(이름, 전자 메일, Microsoft Graph 액세스 + 새로 고침 토큰) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | 위임 | 사용자에게 애플리케이션의 작업 모듈에서 콘텐츠를 공유하도록 채널에 대한 메시지를 표시하려면 | [93b14320-d9b5-4876-b621-172af4d36985](../azure/93b14320-d9b5-4876-b621-172af4d36985.md) |
>| ChannelMessage.Send | 위임 | 애플리케이션의 작업 모듈에서 채널로 공유 콘텐츠를 보내려면 | [93b14320-d9b5-4876-b621-172af4d36985](../azure/93b14320-d9b5-4876-b621-172af4d36985.md) |
>| Chat.ReadBasic | 위임 | 사용자에게 애플리케이션의 작업 모듈에서 콘텐츠를 공유하라는 메시지를 표시하려면 | [93b14320-d9b5-4876-b621-172af4d36985](../azure/93b14320-d9b5-4876-b621-172af4d36985.md) |
>| ChatMessage.Send | 위임 | 애플리케이션의 작업 모듈에서 채팅에 공유 콘텐츠를 보내려면 | [93b14320-d9b5-4876-b621-172af4d36985](../azure/93b14320-d9b5-4876-b621-172af4d36985.md) |
>| Team.ReadBasic.All | 위임 | 사용자가 액세스할 수 있는 팀이 사용자가 사용할 수 있는 채널에 액세스할 수 있도록 해야 합니다. | [93b14320-d9b5-4876-b621-172af4d36985](../azure/93b14320-d9b5-4876-b621-172af4d36985.md) |
>| User.Read | 위임 | 사용자에 대한 식별 및 통신 정보를 얻으려면 | [93b14320-d9b5-4876-b621-172af4d36985](../azure/93b14320-d9b5-4876-b621-172af4d36985.md) |
