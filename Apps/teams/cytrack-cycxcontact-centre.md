---
title: CyTrack별 CyCX 연락처 센터에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/01/2022
...
description: CyCX Contact Center, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
ms.locfileid: "66656416"
---
# <a name="cycx--contact-centre"></a>CyCX 컨택 센터

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 5월 27일</p>

* <a href="https://teams.microsoft.com/l/app/4d7b80a9-d64d-4b54-a1db-259cc204b15d" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004350" target="_blank">AppSource에서 보기</a>
...
| 앱의 핵심 기능 | CyCX는 모임, 채팅 및 협업 외에도 음성 통화 및 컨택 센터 기능을 통해 고객 경험을 향상해야 하는 비즈니스 사용자를 대상으로 합니다.  CyCX는 Microsoft Teams를 위한 커뮤니케이션 및 공동 작업 플랫폼입니다.  Microsoft Teams 내에서 선택한 채널에서 고객을 만나보세요. CyTrack CyCX는 에이전트에게 고객의 전체적인 보기를 통해 통합된 단일 인터페이스를 제공하여 보다 심층적인 상호 작용을 가능하게 합니다. |
| 회사 본사 위치 | 오스트레일리아 |
| 앱 정보 페이지 | [https://web.cytrack.com/microsoft-teams/contact-centre-for-...](https://web.cytrack.com/microsoft-teams/contact-centre-for-microsoft-teams/) |
