---
title: BrightBits별 밝은 설문 조사를 위한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/17/2021
...
description: Bright Poll, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/3a3156c1-b214-4d42-bc25-6d36f6aabb5e" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002562" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

BrightBits에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | BrightBits |
| 회사 웹 사이트 | [https://brightbits.app](https://brightbits.app) |
| 앱의 사용 약관 | [https://brightbits.app/terms/](https://brightbits.app/terms/) |
| 앱의 핵심 기능 | 채팅 내 설문 조사를 통해 팀원의 피드백을 수집합니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://brightbits.app/bright-poll/](https://brightbits.app/bright-poll/) |
...
이 정보는 BrightBits에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
