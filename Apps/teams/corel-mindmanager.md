---
title: MindManager by Corel에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/29/2022
...
description: MindManager에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/cebe4a59-b076-47f3-a7bf-79148daf82f7" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002261" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Corel에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | Corel |
| 회사 웹 사이트 | [https://www.mindmanager.com](https://www.mindmanager.com) |
| 앱의 사용 약관 | [https://www.mindjet.com/go/mmcloudterms](https://www.mindjet.com/go/mmcloudterms) |
| 앱의 핵심 기능 | 지도를 공동 편집하고, 팀 대시보드를 관리하고, 순서도를 만들고, 프로젝트를 계속 볼 수 있습니다. |
| 회사 본사 위치 | 캐나다 |
| 앱 정보 페이지 | |
...
이 정보는 Corel에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
...
| 다음을 위해 MFA(다단계 인증)를 사용하도록 설정했습니다. | CodeRepositories |
...
| 가장 최근 SOC2 인증 날짜 | 2020-08-31 |
| 앱이 서비스 조직 컨트롤(SOC 3)을 준수하나요? | 예 |
| 가장 최근 SOC3 인증 날짜 | 2021-10-15 |
...
| 개인 정보 취급 방침 URL | https://www.corel.com/en/corel-privacy-policy/ |
...
| 앱에서 위의 라이브러리 중 하나를 사용하지 않는 경우 어떤 인증 라이브러리 또는 라이브러리를 사용하나요? | 인증을 위한 MS Teams JavaScript SDK |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Send | 위임 | 애플리케이션(MindManager)은 사용자에게 파일 작업을 수행할 수 있는 권한을 위임합니다.   | [51e2b67d-9854-446a-8da1-cdd89ef0b987](../azure/51e2b67d-9854-446a-8da1-cdd89ef0b987.md) |
>| Chat.Send | 위임 | 애플리케이션(MindManager)은 사용자에게 파일 작업을 수행할 수 있는 권한을 위임합니다.   | [51e2b67d-9854-446a-8da1-cdd89ef0b987](../azure/51e2b67d-9854-446a-8da1-cdd89ef0b987.md) |
>| Files.ReadWrite | 위임 | 애플리케이션(MindManager)은 사용자에게 파일 작업을 수행할 수 있는 권한을 위임합니다.   | [51e2b67d-9854-446a-8da1-cdd89ef0b987](../azure/51e2b67d-9854-446a-8da1-cdd89ef0b987.md) |
>| Sites.ReadWrite.All | 위임 | 애플리케이션(MindManager)은 사용자에게 파일 작업을 수행할 수 있는 권한을 위임합니다.   | [51e2b67d-9854-446a-8da1-cdd89ef0b987](../azure/51e2b67d-9854-446a-8da1-cdd89ef0b987.md) |
>| User.Read | 위임 | 애플리케이션(MindManager)은 사용자에게 파일 작업을 수행할 수 있는 권한을 위임합니다.   | [51e2b67d-9854-446a-8da1-cdd89ef0b987](../azure/51e2b67d-9854-446a-8da1-cdd89ef0b987.md) |
>| offline_access | 위임 | 애플리케이션(MindManager)은 사용자에게 파일 작업을 수행할 수 있는 권한을 위임합니다.   | [51e2b67d-9854-446a-8da1-cdd89ef0b987](../azure/51e2b67d-9854-446a-8da1-cdd89ef0b987.md) |
