---
title: SkyPoint Cloud Inc.의 SkyPoint Cloud에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/21/2022
...
description: SkyPoint Cloud에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
ms.locfileid: "64880563"
---
# <a name="skypoint-cloud"></a>SkyPoint Cloud

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 2월 21일</p>

* <a href="https://teams.microsoft.com/l/app/9637dd07-ec2d-48f7-83cd-bccad3be9fd4" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002580" target="_blank">AppSource에서 보기</a>
...
| 회사 웹 사이트 | [https://skypointcloud.com](https://skypointcloud.com) |
| 앱의 사용 약관 | [https://skypointcloud.com/terms/](https://skypointcloud.com/terms/) |
| 앱의 핵심 기능 | SkyPoint는 브랜드가 고객을 파악하고, 전략적 결정을 내리고, 지속적으로 올바른 조치를 취하여 소비자에게 더 나은 서비스를 제공하고 비즈니스를 계속 성장시키는 데 도움이 됩니다. Microsoft는 데이터 관리 및 통합, 개인 정보 규정 준수, 분석 및 인사이트 및 활성화 전반에 걸쳐 지능형 기능을 제공하는 고객 데이터 플랫폼입니다.  |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://skypointcloud.com/platform/](https://skypointcloud.com/platform/) |
...
이 정보는 SkyPoint Cloud Inc.에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 제공되었습니다.
