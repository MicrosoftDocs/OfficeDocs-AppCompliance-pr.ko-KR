...
description: SkyPoint 클라우드에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보
...
| 회사의 웹 사이트 | [https://skypointcloud.com](https://skypointcloud.com) |
| 앱 사용 약관 | [https://skypointcloud.com/terms/](https://skypointcloud.com/terms/) |
| 앱의 핵심 기능 | SkyPoint는 브랜드가 고객을 알고 전략적 의사 결정을 내릴 수 있도록 지원하며, 소비자에게 더 나은 서비스를 제공하고 비즈니스를 지속적으로 성장하기 위해 일관되게 올바른 조치를 취하는 데 도움이 됩니다. 데이터 관리 및 통합, 개인 정보 규정 준수, 분석 및 인사이트, 활성화 전반에 걸쳐 지능형 기능을 제공하는 고객 데이터 플랫폼입니다.  |
| 회사 본사 위치 | 미국 |
