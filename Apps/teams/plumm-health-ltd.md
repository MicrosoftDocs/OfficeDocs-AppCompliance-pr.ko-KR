---
title: Plumm Health LTD의 Plumm에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/14/2021
...
description: Plumm, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/d66da813-3337-4f88-8e08-f01c0bbb8f34" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003326" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Plumm Health LTD에서 Microsoft에 제공하는 정보:
...
| 회사 웹 사이트 | [https://www.plummhealth.com](https://www.plummhealth.com) |
| 앱의 사용 약관 | [https://www.plummhealth.com/terms-of-use](https://www.plummhealth.com/terms-of-use) |
| 앱의 핵심 기능 | Plumm은 직원들에게 정신적 복지에 필요한 지원을 제공합니다. 모든 플럼 회원은 150 개 이상의 공인 치료사, 치료사 주도 웰빙 과정의 디지털 라이브러리, 채팅 치료 및 유도 중재의 글로벌 네트워크로 고품질의 정신 건강 지원에 액세스 할 수 &#8211;. 사용자는 1:1 온라인 비디오 치료를 위해 치료사와 연결하거나 요구 사항에 대해 개인적으로 채팅 할 수 있습니다. 치료사가 주도하는 온라인 과정과 명상은 자가 진단 지원을 제공합니다. |
...
이 정보는 Plumm Health LTD에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsActivity.Send | 응용 프로그램 | 이 권한에서 userID를 사용합니다. 이는 서비스 사용량에 따라 사용자에게 필수 알림을 보내는 데 사용됩니다. 이는 사용자가 앱에서 자신의 계정에 대한 적절한 알림을 수신하기 위해 중요합니다. | [b1d1c038-a1f3-4802-be93-0f4a66589e73](../azure/b1d1c038-a1f3-4802-be93-0f4a66589e73.md) |
>| TeamsAppInstallation.ReadWriteForUser.All | 응용 프로그램 | 이 사용 권한을 사용하여 설치 ID를 받습니다. 이는 각 개별 사용자에 대해 적절하고 올바른 알림을 보낼 수 있도록 하는 데 중요합니다. | [b1d1c038-a1f3-4802-be93-0f4a66589e73](../azure/b1d1c038-a1f3-4802-be93-0f4a66589e73.md) |
>| User.Read | 위임 | 이 권한을 통해 사용자의 이름, 사진 및 전자 메일을 수집하고 있습니다. 이는 개별 사용자를 식별할 수 있도록 하기 위해 필요하며, 이러한 데이터 요소는 개별 프로필 페이지 및 이메일/알림 통신과 같은 필요한 위치에 표시되어야 합니다. | [b1d1c038-a1f3-4802-be93-0f4a66589e73](../azure/b1d1c038-a1f3-4802-be93-0f4a66589e73.md) |
>| User.Read.All | 응용 프로그램 | 이 권한을 통해 앱은 로그인한 사용자 없이 사용자 프로필을 읽을 수 있습니다. 여기서는 현재 이름, 프로필 사진 및 전자 메일만 수집하고 있습니다. 이는 개별 사용자를 식별할 수 있도록 하기 위해 필요하며, 이러한 데이터 요소는 개별 프로필 페이지 및 이메일/알림 통신과 같은 필요한 위치에 표시되어야 합니다. | [b1d1c038-a1f3-4802-be93-0f4a66589e73](../azure/b1d1c038-a1f3-4802-be93-0f4a66589e73.md) |
>| 전자 메일 | 위임 | 사용자의 전자 메일 ID가 수집됩니다. 서비스에 대한 액세스 권한을 사용자에게 부여하고 앱에 로그인하고 이 이메일 ID의 계정 및 서비스에 대한 알림을 받으려면 이 데이터가 필요합니다.  | [b1d1c038-a1f3-4802-be93-0f4a66589e73](../azure/b1d1c038-a1f3-4802-be93-0f4a66589e73.md) |
>| openid | 위임 | 이 권한의 경우 데이터를 수집하지 않습니다.  | [b1d1c038-a1f3-4802-be93-0f4a66589e73](../azure/b1d1c038-a1f3-4802-be93-0f4a66589e73.md) |
>| 프로필 | 위임 | 이 권한을 통해 사용자의 이름, 사진 및 전자 메일을 수집하고 있습니다. 이는 개별 사용자를 식별할 수 있도록 하기 위해 필요하며, 이러한 데이터 요소는 개별 프로필 페이지 및 이메일/알림 통신과 같은 필요한 위치에 표시되어야 합니다. | [b1d1c038-a1f3-4802-be93-0f4a66589e73](../azure/b1d1c038-a1f3-4802-be93-0f4a66589e73.md) |
