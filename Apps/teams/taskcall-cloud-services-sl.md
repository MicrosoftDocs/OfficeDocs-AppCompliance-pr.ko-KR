---
title: TaskCall의 TaskCall에 대한 응용 Cloud Services S.L.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: TaskCall에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보
...
* <a href="https://teams.microsoft.com/l/app/eea91208-6850-4a61-8508-64b6c45d23a1" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003914" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

TaskCall Cloud Services S.L. Microsoft에:
...
| 회사의 웹 사이트 | [https://taskcallapp.com](https://taskcallapp.com) |
| 앱 사용 약관 | [https://www.taskcallapp.com/terms-of-service](https://www.taskcallapp.com/terms-of-service) |
| 앱의 핵심 기능 | TaskCall의 Microsoft Teams 통합을 통해 인시던트가 작업 내에서 처리될 수 있도록 하여 IT-Ops 공동 작업을 간소화할 수 Microsoft Teams. |
| 회사 본사 위치 | 스페인 |
...
이 정보는 TaskCall Cloud Services S.L에서 제공됩니다. 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터를 통해 조직이 하게 될 컨트롤에 대한 정보를 제공합니다.
