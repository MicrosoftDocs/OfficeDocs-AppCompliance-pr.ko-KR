---
title: Application Information for TaskCall by TaskCall Cloud Services, S.L.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: TaskCall에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/eea91208-6850-4a61-8508-64b6c45d23a1" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003914" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

TaskCall Cloud Services, S.L에서 제공하는 정보 Microsoft에 다음을 수행합니다.
...
| 파트너 회사 이름 | TaskCall Cloud Services, S.L. |
| 회사 웹 사이트 | [https://taskcallapp.com](https://taskcallapp.com) |
| 앱의 사용 약관 | [https://www.taskcallapp.com/terms-of-service](https://www.taskcallapp.com/terms-of-service) |
| 앱의 핵심 기능 | TaskCall의 Microsoft Teams 양방향 통합은 Microsoft Teams 내에서 인시던트 처리를 허용하여 통신 및 IT-Ops 협업을 간소화합니다. |
| 회사 본사 위치 | 스페인 |
| 앱 정보 페이지 | [https://docs.taskcallapp.com/integrations/v1/microsoft-team...](https://docs.taskcallapp.com/integrations/v1/microsoft-teams-integration-guide) |
...
이 정보는 TaskCall Cloud Services, S.L에서 제공되었습니다. 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 설명합니다.
