...
description: Sitecore용 Proconnect, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용할 수 있는 모든 보안 및 규정 준수 정보
...
Subramanian Ramanathan에서 Microsoft에 제공한 정보:
...
| 회사의 웹 사이트 | [https://subbu.ca](https://subbu.ca) |
| 앱 사용 약관 | [https://github.com/SubbuRamanathan/sitecore-microsoft-teams...](https://github.com/SubbuRamanathan/sitecore-microsoft-teams-integration/blob/main/terms-of-use.md) |
| 앱의 핵심 기능 | 워크플로 게시 업데이트에 대한 즉각적인 경고를 통해 콘텐츠 제작 환경을 &amp; 향상합니다. 또한 이 커넥터에는 경고에 대한 적절한 작업이 포함되므로 콘텐츠 작성자가 작업을 더 빠르게 수행할 수 있습니다. 이 커넥터는 통신의 투명성을 설정하고 사이트/페이지 성능에 대한 정보도 포함합니다. |
| 회사 본사 위치 | 캐나다 |
| 앱 정보 페이지 | |
...
이 정보는 이 앱이 조직 데이터를 수집 및 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직이 제어할 수 있는 제어에 대해 서브라마니아 라나나탄에서 제공했습니다.
