---
title: QBURST TECHNOLOGIES PVT LTD의 패키지 통보신청 정보
ms.author: elmalova
author: elenamalova
ms.date: 03/25/2021
ms.topic: article
...
description: 패키지 노티피어에 대한 사용 가능한 모든 보안 및 규정 준수 정보 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보.
...
<p>최종 업데이트: 2021년 3월 25일</p>

* <a href="https://teams.microsoft.com/l/app/74d74206-0183-401d-932e-315f5021fdb1" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002737" target="_blank">앱소스에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

마이크로 소프트에 QBURST 기술 PVT 주식 회사에서 제공하는 정보 :

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | Package Notifier |
| ID | WA200002737 |
| 지원되는 Office 365 클라이언트 | Microsoft Teams |
| 파트너 회사 이름 | QBURST TECHNOLOGIES PVT LTD |
| 파트너 웹사이트의 URL | [https://package-notifier.qburst.in](https://package-notifier.qburst.in) |
| Teams 응용 프로그램 정보 페이지의 URL | [해당 없음](N/A) |
| 개인정보 처리방침의 URL | [https://package-notifier.qburst.in/privacy-policy.html](https://package-notifier.qburst.in/privacy-policy.html) |
| 이용 약관의 URL | [https://package-notifier.qburst.in/terms-and-conditions.html](https://package-notifier.qburst.in/terms-and-conditions.html) |
...
이 정보는 QBURST TECHNOLOGIES PVT LTD에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직이 가질 수 있는 제어에 대해 제공했습니다.
...
>|:-------------------|:-------------------|:--------------------------|:--------------------------|:---------------------------------------------------|:--------------------------|
>| Azure DevOps Services 휴식 API | 아니요 |  |  |  |  |
...
<iframe height='1020' title='Microsoft Cloud App Security 정보' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/37866' frameborder='no' style='width: 100%;'></iframe>

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/37866" target="_blank">새 탭에서 보기</a>
...
이 정보는 QBURST TECHNOLOGIES PVT LTD에서 이 앱이 인증, 승인, 응용 프로그램 등록 모범 사례 및 기타 ID 기준을 처리하는 방법에 대해 제공했습니다.
...
| 지원되는 정책 유형 목록 | 499b84ac-1321-427f-aa17-267ca6975798/user_impersonation offline_access |
