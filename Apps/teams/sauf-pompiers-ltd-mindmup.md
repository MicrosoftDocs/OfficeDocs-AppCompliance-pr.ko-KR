---
title: Sauf 폼페이어스(Sauf Pompiers Ltd)의 MindMup 신청 정보
ms.author: elmalova
author: elenamalova
ms.date: 08/06/2020
ms.topic: article
...
description: MindMup에 대한 사용 가능한 모든 보안 및 규정 준수 정보 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보.
...
* <a href="https://teams.microsoft.com/l/app/c12a3d54-d294-4a51-8cd3-4a48b6c7e6f2" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001759" target="_blank">앱소스에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Sauf Pompiers Ltd가 Microsoft에 제공한 정보:
...
| 파트너 웹사이트의 URL | [https://www.mindmup.com](https://www.mindmup.com) |
| 개인정보 처리방침의 URL | [https://www.mindmup.com/resources/privacy_policy.html](https://www.mindmup.com/resources/privacy_policy.html) |
| 이용 약관의 URL | [https://www.mindmup.com/resources/terms_gold.html](https://www.mindmup.com/resources/terms_gold.html) |
...
이 정보는 Sauf Pompiers Ltd가 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직이 가질 수 있는 제어에 대해 제공했습니다.
...
>|:-------------------|:--------------------------|:--------------------------|
>| 기본적인 사용자 프로필 정보를 유지, 문서 공유 지원 및 MindMup의 사용자 문서에 대한 보안 액세스 에 사용되는 AWS 스토리지 시스템 |  | 해당 없음 |
...
>보안 액세스 로그 레코드 사용자 ID, office 365 테넌트 ID 및 액세스 타임스탬프. 그들은 사기와 남용을 방지하기 위해 지속됩니다.

#### <a name="organizational-controls-for-data-stored-by-partner"></a>파트너가 저장한 데이터에 대한 조직 제어

조직의 관리자가 파트너 시스템에서 자신의 정보를 제어하는 방법을 설명해 보세요. 예를 들어 삭제, 보존, 감사, 보관, 최종 사용자 정책 등

>사용자 문서는 AWS(us-east-1)에 저장되며, 전송 시 암호화되고 나머지는 암호화됩니다. 데이터를 만든 사용자와 소유자가 명시적으로 문서를 공유한 사용자가 데이터를 사용할 수 있습니다.

모든 운영자/관리자 액세스는 2FA에 의해 보호됩니다.

사용자 및 클라이언트 관리자 액세스는 Microsoft/Azure AD 통합 인증에서 제공되며 SSO를 통해 직접 사용할 수 있는 2FA 옵션이 있습니다.
