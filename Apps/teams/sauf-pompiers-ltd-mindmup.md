...
| 응용 프로그램 Teams 페이지의 URL입니다. | [https://www.mindmup.com/tutorials/microsoft-teams.html](https://www.mindmup.com/tutorials/microsoft-teams.html) |
...
>|:----------------|:------------------------------------------------|:--------------------------------------------------------|:--------------------------------------------------|:--------------------|
>| Teams. ReadBasic.All | 위임 | 사용자의 팀 식별자 및 팀 이름 | 사용자가 구성원인 팀과 문서를 공유할 수 있도록 허용 | [c12a3d54-d294-4a51-8cd3-4a48b6c7e6f2](https://docs.microsoft.com/microsoft-365-app-certification/azure/c12a3d54-d294-4a51-8cd3-4a48b6c7e6f2) |
>| User.Read | 위임 | 사용자 식별자, 인증 후 표시할 전자 메일 주소 | 사용자 ID, 전자 메일 주소 | [c12a3d54-d294-4a51-8cd3-4a48b6c7e6f2](https://docs.microsoft.com/microsoft-365-app-certification/azure/c12a3d54-d294-4a51-8cd3-4a48b6c7e6f2) |
...
>|:-----------------------------------------------------|:------------------------------|:----------------------------------------|
>| MindMup에서 문서 공유 및 사용자 문서에 대한 보안 액세스를 지원하기 위해 기본 사용자 프로필 정보를 유지 하는 데 사용되는 AWS 저장소 시스템 | 테넌트 ID | 액세스 제어 |
...
이 정보는 Sauf Pompiers Ltd에서 이 앱이 인증, 권한 부여, 응용 프로그램 등록 모범 사례 및 기타 ID 조건을 처리하는 방법에 대해 제공했습니다.
