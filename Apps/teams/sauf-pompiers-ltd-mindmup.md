---
title: Sauf Pompiers Ltd.의 MindMup에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/09/2021
...
description: MindMup에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://appsource.microsoft.com/product/office/WA200001759" target="_blank">AppSource에서 보기</a>
...
| 회사 웹 사이트 | [https://www.mindmup.com](https://www.mindmup.com) |
| 앱의 사용 약관 | [https://www.mindmup.com/resources/terms_mindmup.html](https://www.mindmup.com/resources/terms_mindmup.html) |
| 앱의 핵심 기능 | MindMup을 사용하면 사용자가 마인드 맵, 거미 다이어그램, 개념 맵, 인수 시각화 및 계층 차트를 사용하여 아이디어를 쉽게 시각화할 수 있습니다. |
| 회사 본사 위치 | 영국 및 북아일랜드(해당) |
| 앱 정보 페이지 | [https://www.mindmup.com/tutorials/microsoft-teams.html](https://www.mindmup.com/tutorials/microsoft-teams.html) |
...
이 정보는 Sauf Pompiers Ltd에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Teams. ReadBasic.All | 위임 | 사용자에 대한 팀 식별자 및 팀 이름 | [c12a3d54-d294-4a51-8cd3-4a48b6c7e6f2](../azure/c12a3d54-d294-4a51-8cd3-4a48b6c7e6f2.md) |
>| User.Read | 위임 | 인증 후 표시할 사용자 식별자, 전자 메일 주소 | [c12a3d54-d294-4a51-8cd3-4a48b6c7e6f2](../azure/c12a3d54-d294-4a51-8cd3-4a48b6c7e6f2.md) |
