...
description: 간소화, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
ms.locfileid: "65692439"
---
# <a name="streamline"></a>간소화

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 4월 7일</p>

* <a href="https://teams.microsoft.com/l/app/aa6e7fb6-34ac-4947-9c13-3565c66e368b" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004100" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Finative에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | 유한 |
| 회사 웹 사이트 | [https://finative.it](https://finative.it) |
| 앱의 사용 약관 | [https://finative.it/streamline/terms-of-use/](https://finative.it/streamline/terms-of-use/) |
| 앱의 핵심 기능 | 모임 환경을 간소화하여 생산성을 높일 수 있습니다. |
| 회사 본사 위치 | 네덜란드 (the) |
| 앱 정보 페이지 | [https://finative.it/streamline/](https://finative.it/streamline/) |
...
이 정보는 Finative에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | Azure AD 사용자 ID |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 앱 내에서 만든 폴더에 대한 사용자 id, tenantid 및 OneDrive 링크 |
...
| 개인 정보 취급 방침 URL | https://finative.nl/streamline/privacy-statement |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | 위임 | 사용자의 작업을 기반으로 사용자 일정을 보고 편집하는 데 필요합니다. | [7f6565a7-45e4-4bba-94d4-bac64886ed83](../azure/7f6565a7-45e4-4bba-94d4-bac64886ed83.md) |
>| Files.ReadWrite.All | 위임 | 사용자&#8217;비즈니스용 OneDrive 첨부 파일 및 기타 파일을 저장하는 데 필요합니다. | [7f6565a7-45e4-4bba-94d4-bac64886ed83](../azure/7f6565a7-45e4-4bba-94d4-bac64886ed83.md) |
>| Notes.Create | 위임 | 모임의 안건에 따라 OneNotes를 만드는 데 필요합니다. | [7f6565a7-45e4-4bba-94d4-bac64886ed83](../azure/7f6565a7-45e4-4bba-94d4-bac64886ed83.md) |
>| User.Read | 위임 | 로그인하고 사용자&#8217;프로필을 읽어서 Streamline 앱에 대한 액세스를 인증하고 권한을 부여하는 데 필요합니다. | [7f6565a7-45e4-4bba-94d4-bac64886ed83](../azure/7f6565a7-45e4-4bba-94d4-bac64886ed83.md) |
>| User.ReadBasic.All | 위임 | 작업, 역할, 안건 항목 등에 다른 사용자를 검색하고 할당하는 데 필요합니다. 로그인한 사용자에게 액세스 권한이 있는 사용자만 표시됩니다. | [7f6565a7-45e4-4bba-94d4-bac64886ed83](../azure/7f6565a7-45e4-4bba-94d4-bac64886ed83.md) |
>| User.Read | 위임 | 로그인한 사용자에 대한 앱의 기본 정보 표시 | [c7cdd862-2527-49ea-b873-0c5f51a83292](../azure/c7cdd862-2527-49ea-b873-0c5f51a83292.md) |
>| 전자 메일 | 위임 | 사용자에게 환영 전자 메일을 보내려면 | [c7cdd862-2527-49ea-b873-0c5f51a83292](../azure/c7cdd862-2527-49ea-b873-0c5f51a83292.md) |
>| openid | 위임 | 사용자 로그인 | [c7cdd862-2527-49ea-b873-0c5f51a83292](../azure/c7cdd862-2527-49ea-b873-0c5f51a83292.md) |
>| 프로필 | 위임 | 로그인한 사용자에 대한 앱의 기본 정보 표시 | [c7cdd862-2527-49ea-b873-0c5f51a83292](../azure/c7cdd862-2527-49ea-b873-0c5f51a83292.md) |
