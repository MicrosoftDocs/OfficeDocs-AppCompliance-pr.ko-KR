---
title: AMEX GBT by 30SecondsToFly(태국) Co Ltd에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/28/2021
...
description: AMEX GBT, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/157b5ffb-b183-453c-b072-9c94bb6c694c" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003272" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Microsoft에 30SecondsToFly(태국) Co Ltd에서 제공하는 정보:
...
| 회사 웹 사이트 | [https://www.amexglobalbusinesstravel.com](https://www.amexglobalbusinesstravel.com) |
| 앱의 사용 약관 | [https://www.amexglobalbusinesstravel.com/terms-service/](https://www.amexglobalbusinesstravel.com/terms-service/) |
| 앱의 핵심 기능 | 여행 카운슬러와 채팅. 숙박 장소를 찾는 데 도움이 필요하거나 항공편을 놓친 경우 여행 카운슬러는 24/7 채팅을 할 수 있습니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
...
이 정보는 30SecondsToFly (태국) Co Ltd에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 제어에 대해 제공되었습니다.
