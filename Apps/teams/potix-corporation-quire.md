---
title: Potix Corporation의 Quire에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Quire에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
ms.locfileid: "64879665"
---
# <a name="quire"></a>Quire

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2021년 6월 9일</p>

* <a href="https://teams.microsoft.com/l/app/dfad3be2-e62c-49c5-9453-ccd30999f003" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002946" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Potix Corporation에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | Potix Corporation |
| 회사 웹 사이트 | [https://www.quire.io](https://www.quire.io) |
| 앱의 사용 약관 | [https://quire.io/terms](https://quire.io/terms) |
| 앱의 핵심 기능 | 계층 목록에서 목표를 세분화하기 위한 최고의 공동 작업 프로젝트 관리 소프트웨어입니다. |
| 회사 본사 위치 | 대만(중국) |
| 앱 정보 페이지 | [https://www.quire.io](https://www.quire.io) |
...
이 정보는 Potix Corporation에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
