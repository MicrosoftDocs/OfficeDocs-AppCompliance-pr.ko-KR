---
title: Hi5Technologies의 Hi5 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/21/2021
...
description: Hi5에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/ca334a56-72b5-4613-81d4-77b1148df03c" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001610" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Hi5Technologies에서 Microsoft에 제공한 정보:
...
| 회사 웹 사이트 | [https://www.get5.io](https://www.get5.io) |
| 앱의 사용 약관 | [https://www.get5.io/terms](https://www.get5.io/terms) |
| 앱의 핵심 기능 | 지속적인 인식과 피드백을 통해 문화권의 잠금을 해제합니다. Hi5는 관리자와 동료가 인정을 받을 수 있는 &amp; 매우 쉽고 재미있는 앱입니다. 누군가&#8217;훌륭한 일을 했나요? 그것은&#8217;간단합니다 - 그들에게 Hi5를주고 성공의 축하를 공유! 팀 구성원은 피어 투 피어 또는 팀 인식을 제공하고, Hi5 순위표 등을 볼 수 있습니다. |
| 회사 본사 위치 | 남아프리카 공화국 |
| 앱 정보 페이지 | [https://help.get5.io](https://help.get5.io) |
...
이 정보는 Hi5Technologies에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 위임 | Teams 사용자 세션 정보만 저장하고 사용자는 알림을 추가하여 이를 승인해야 합니다(언제든지 제거할 수 있음). 다른 정보는 저장되지 않습니다. | [7cb50e3e-0427-409e-90d2-638eb28217c3](../azure/7cb50e3e-0427-409e-90d2-638eb28217c3.md) |
>| 전자 메일 | 위임 | Teams 사용자 세션 정보만 저장하고 사용자는 알림을 추가하여 이를 승인해야 합니다(언제든지 제거할 수 있음). 다른 정보는 저장되지 않습니다. | [7cb50e3e-0427-409e-90d2-638eb28217c3](../azure/7cb50e3e-0427-409e-90d2-638eb28217c3.md) |
>| offline_access | 위임 | Teams 사용자 세션 정보만 저장하고 사용자는 알림을 추가하여 이를 승인해야 합니다(언제든지 제거할 수 있음). 다른 정보는 저장되지 않습니다. | [7cb50e3e-0427-409e-90d2-638eb28217c3](../azure/7cb50e3e-0427-409e-90d2-638eb28217c3.md) |
>| openid | 위임 | Teams 사용자 세션 정보만 저장하고 사용자는 알림을 추가하여 이를 승인해야 합니다(언제든지 제거할 수 있음). 다른 정보는 저장되지 않습니다. | [7cb50e3e-0427-409e-90d2-638eb28217c3](../azure/7cb50e3e-0427-409e-90d2-638eb28217c3.md) |
>| 프로필 | 위임 | Teams 사용자 세션 정보만 저장하고 사용자는 알림을 추가하여 이를 승인해야 합니다(언제든지 제거할 수 있음). 다른 정보는 저장되지 않습니다. | [7cb50e3e-0427-409e-90d2-638eb28217c3](../azure/7cb50e3e-0427-409e-90d2-638eb28217c3.md) |
