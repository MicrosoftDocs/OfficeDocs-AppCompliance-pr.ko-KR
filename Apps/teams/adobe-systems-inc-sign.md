...
>|:---------------------------------------|:-----------------------------------|:------------------------------------|
>| 채팅 메시지 및 인증 사용자 지정 | UserPrincipalName, name, email and objectId | 비동기 응답 및 인증을 사용자 지정하기 위해 이 정보를 저장합니다. |
...
이 정보는 Adobe Systems Inc.에서 이 앱이 인증, 권한 부여, 응용 프로그램 등록 모범 사례 및 기타 ID 조건을 처리하는 방법에 대해 제공합니다.
