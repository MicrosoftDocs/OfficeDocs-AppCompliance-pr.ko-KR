...
| 회사의 웹 사이트 | [https://www.forcemanager.com](https://www.forcemanager.com) |
| 앱 사용 약관 | [https://www.forcemanager.com/info/terms-and-conditions/](https://www.forcemanager.com/info/terms-and-conditions/) |
| 앱의 핵심 기능 | ForceManager는 홈, 사무실 또는 필드를 비롯한 다양한 작업 스타일에 대해 만들어진 전체 서비스 웹 및 모바일 앱이 있는 최고의 CRM입니다. 이 앱은 사용자 친숙한 인터페이스로 일상적인 어젠더 및 활동을 관리해야 하는 영업 담당자를 대상으로 합니다. |
| 회사 본사 위치 | 스페인 |
| 앱 정보 페이지 | |
