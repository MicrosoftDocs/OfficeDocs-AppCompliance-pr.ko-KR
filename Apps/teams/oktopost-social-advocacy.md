...
description: Social Advocacy, 해당 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보
...
| 파트너 회사 이름 | Oktopost |
| 회사의 웹 사이트 | [https://www.oktopost.com](https://www.oktopost.com) |
| 앱 사용 약관 | [https://www.oktopost.com/terms](https://www.oktopost.com/terms) |
| 앱의 핵심 기능 | Oktopost는 B2B에 대한 소셜 미디어 관리 및 직원 애용 플랫폼입니다. Oktopost를 사용하면 모든 소셜 미디어 활동을 한 장소에서 관리, 모니터링 및 측정할 수 있습니다. Oktopost에는 게시, 모니터링, 분석, 참여, 2) 직원 지지를 비롯한 소셜 미디어 관리의 두 가지 핵심 솔루션이 있으며, 이를 통해 시장은 직원의 공유 공유 프로그램을 관리할 수 있습니다. 또한 Oktopost 고유의 가치 제정을 통해 마케팅 사용자는 소셜 데이터를 마케팅 스택과 통합할 수 있습니다. |
| 회사 본사 위치 | 이스라엘 |
| 앱 정보 페이지 | [https://www.oktopost.com](https://www.oktopost.com) |
...
| 개인 정보 취급 방침 URL | https://www.oktopost.com/privacy |
