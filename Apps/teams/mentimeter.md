---
title: Mentimeter별 Mentimeter에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/25/2021
...
description: Mentimeter에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/6aa4a751-8a6a-429e-b924-1360ed272414" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002972" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Mentimeter가 Microsoft에 제공한 정보:
...
| 회사 웹 사이트 | [https://www.mentimeter.com](https://www.mentimeter.com) |
| 앱의 사용 약관 | [https://www.mentimeter.com/terms](https://www.mentimeter.com/terms) |
| 앱의 핵심 기능 | 참가자와 설문 조사, 퀴즈, Word 클라우드, QA&amp; 등을 참여시켜 실시간 입력을 캡처합니다.  |
| 회사 본사 위치 | 스웨덴 |
...
이 정보는 Mentimeter에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
