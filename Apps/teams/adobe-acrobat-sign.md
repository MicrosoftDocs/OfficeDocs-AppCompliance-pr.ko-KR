---
title: Adobe에서 Adobe Acrobat 서명에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/23/2022
...
description: Adobe Acrobat Sign, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://appsource.microsoft.com/product/office/WA104381233" target="_blank">AppSource에서 보기</a>
...
| 앱의 핵심 기능 | Teams Adobe Sign 기능을 활용할 때 문서 서명 워크플로를 간소화하고 놀라운 직원 및 고객 환경을 제공합니다. Microsoft에서 선호하는 전자 서명 솔루션인 Adobe Sign for Teams 사용하여 문서에 서명하고, 법적 구속력이 있는 전자 서명 및 승인을 위해 문서를 보내고, &#8212; 상태를 추적할 수 있습니다. |
| 회사 본사 위치 | 미국 |
...
>| offline_access | 위임 | 액세스 토큰을 새로 고치려면 현재 토큰이 만료된 경우 예를 들어 사용자가 서명&quot;에 대한 보내기 창에 &quot;있고 너무 오랫동안 비활성 상태로 두면 사용자를 활성 상태로 유지하기 위해 새 토큰을 새로 고쳐야 합니다. | [a9b0c190-bafb-49ca-a61a-dab99cf2c43b](../azure/a9b0c190-bafb-49ca-a61a-dab99cf2c43b.md) |
