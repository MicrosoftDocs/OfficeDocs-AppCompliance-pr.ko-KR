---
title: DeskNow GmbH의 DeskManager에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/16/2022
...
description: DeskManager, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/a6076464-2435-4fa2-b087-895274867ac8" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003831" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

DeskNow GmbH에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | DeskNow GmbH |
| 회사의 웹 사이트 | [https://desk-now.com](https://desk-now.com) |
| 앱 사용 약관 | [https://desk-now.com/en/useful/terms-conditions/](https://desk-now.com/en/useful/terms-conditions/) |
| 앱의 핵심 기능 | 사무실, 회의실 등 모든 기능을 제어할 수 있습니다. HybridWork는 국가, 사무실, 방, 책상 또는 사람 수에 상관없이 모두 하나씩 제공됩니다.  |
| 회사 본사 위치 | 독일 |
| 앱 정보 페이지 | |
| 앱을 실행하기 위해 사용되는 호스팅 환경 또는 서비스 모델은 무엇입니까? | 이아스 |
| 앱에서 어떤 호스팅 클라우드 공급자를 사용하나요? | Aws, 기타 |
...
이 정보는 DeskNow GmbH에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직이 하게 될 컨트롤에 대해 제공됩니다.
...
| 데이터베이스에 저장되는 데이터는 무엇입니까? | 사용자의 예약 세부 정보입니다. 사용자 프로필 데이터, 사용자 권한 |
...
| 개인 정보 취급 방침 URL | https://desk-now.com/en/useful/general-privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite.Shared | 둘 다 | 일정 동기화 | [e5d4c7df-50aa-4c15-aa06-c108d0225832](../azure/e5d4c7df-50aa-4c15-aa06-c108d0225832.md) |
>| GroupMember.ReadWrite.All | 둘 다 | 사용자 권한, 예약 권한 | [e5d4c7df-50aa-4c15-aa06-c108d0225832](../azure/e5d4c7df-50aa-4c15-aa06-c108d0225832.md) |
>| TeamMember.ReadWrite.All | 둘 다 | 사용자 권한, 예약 권한,  | [e5d4c7df-50aa-4c15-aa06-c108d0225832](../azure/e5d4c7df-50aa-4c15-aa06-c108d0225832.md) |
