---
title: IBV 솔루션의 Collaboard에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/24/2022
...
description: CSA STAR 레지스트리의 Collaboard, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/28ed14b8-5625-40e6-a17a-b56fa04fc76f" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002549" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

IBV 솔루션에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | IBV Solutions |
| 회사의 웹 사이트 | [https://www.collaboard.app](https://www.collaboard.app) |
| 앱 사용 약관 | [https://www.collaboard.app/terms](https://www.collaboard.app/terms) |
| 앱의 핵심 기능 | 콜라보드는 원격 작업을 위한 멋진 공동 작업 온라인 화이트보드입니다. |
| 회사 본사 위치 | 스위스 |
| 앱 정보 페이지 | [https://www.collaboard.app/product](https://www.collaboard.app/product) |
| 앱을 실행하기 위해 사용되는 호스팅 환경 또는 서비스 모델은 무엇입니까? | 하이브리드 |
| 앱에서 어떤 호스팅 클라우드 공급자를 사용하나요? | Azure, IBMCloud, Aws, 기타 |
...
이 정보는 IBV 솔루션에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직이 가지는 컨트롤에 대해 제공됩니다.
...
| 개인 정보 취급 방침 URL | https://www.collaboard.app/dpa |
