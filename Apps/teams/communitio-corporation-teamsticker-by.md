---
title: Communitio Corporation의 팀 스티커 신청 정보
ms.author: elmalova
author: elenamalova
ms.date: 01/05/2021
ms.topic: article
...
description: Communitio에 의해 Team스티커에 대한 가능한 모든 보안 및 규정 준수 정보 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보, CSA STAR 레지스트리의 보안 /규정 준수 정보.
...
<p>최종 업데이트: 2021년 1월 5일</p>

* <a href="https://teams.microsoft.com/l/app/bceca1f0-723f-44d0-b732-b3506c0a641d" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000894" target="_blank">앱소스에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Communitio Corporation에서 마이크로소프트에 제공한 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | TeamSticker by Communitio |
| ID | WA200000894 |
| 지원되는 Office 365 클라이언트 | Microsoft Teams |
| 파트너 회사 이름 | Communitio Corporation |
| 파트너 웹사이트의 URL | [https://www.teamsuite.biz/](https://www.teamsuite.biz/) |
| Teams 응용 프로그램 정보 페이지의 URL | [https://www.teamsuite.biz/feature/](https://www.teamsuite.biz/feature/) |
| 개인정보 처리방침의 URL | [https://www.teamsuite.biz/privacy/](https://www.teamsuite.biz/privacy/) |
| 이용 약관의 URL | [https://www.teamsuite.biz/terms/](https://www.teamsuite.biz/terms/) |
...
이 정보는 Communitio Corporation에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직이 가질 수 있는 제어에 대해 제공했습니다.
...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| 채팅.읽기 쓰기 | 신청 |  왜냐하면 응용 프로그램은 채팅을 게시하기 때문입니다. | 응용 프로그램은 데이터를 저장하지 않습니다. | bceca1f0-723f-44d0-b732-b3506c0a641d |
>| Group.ReadWrite.All | 둘다 | 응용 프로그램은 그룹 ID 및 그룹 이름을 수집합니다. | 응용 프로그램은 그룹 ID와 이름 쌍을 저장합니다. | bceca1f0-723f-44d0-b732-b3506c0a641d |
>| User.Read | 위임 | 응용 프로그램은 사용자의 프로필 이미지를 수집합니다. | 응용 프로그램은 사용자의 프로필 이미지를 저장하여 사용자 아이콘을 표시합니다. | bceca1f0-723f-44d0-b732-b3506c0a641d |
>| User.Read.All | 둘다 | 응용 프로그램은 카드를 보낼 사용자를 찾기 위해 사용자의 objectId / 이메일 / 이름을 수집합니다. | 응용 프로그램은 이 경우 데이터를 저장하지 않습니다. | bceca1f0-723f-44d0-b732-b3506c0a641d |
>| offline_access | 위임 | 응용 프로그램은 사용자의 api 토큰을 수집하여 User.Read / User.Read.All 을 백그라운드에서 사용합니다. | 응용 프로그램은 사용자의 api 토큰을 저장하여 User.Read / User.Read.All을 백그라운드에서 사용합니다. | bceca1f0-723f-44d0-b732-b3506c0a641d |
>| 오픈 ID | 위임 | 수집된 데이터가 없습니다. | 응용 프로그램은 이 권한을 사용하여 openid로 로그인합니다. | bceca1f0-723f-44d0-b732-b3506c0a641d |
>| 윤곽 | 위임 | 응용 프로그램은 사용자의 objectId / 이메일 / 이름을 수집합니다. | 응용 프로그램은 사용자의 objectId / 이메일 / 이름을 저장합니다. | bceca1f0-723f-44d0-b732-b3506c0a641d |
...
>|:--------------------------------|:---------------------|:--------------------------|
>| User.Read.All의 권한이 있기 때문입니다. | 아니요 |  |
...
<iframe height='1020' title='Microsoft Cloud App Security 정보' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/36366' frameborder='no' style='width: 100%;'></iframe>

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/36366" target="_blank">새 탭에서 보기</a>
...
이 정보는 이 앱이 인증, 승인, 응용 프로그램 등록 모범 사례 및 기타 ID 기준을 처리하는 방법에 대해 Communitio Corporation에서 제공했습니다.
