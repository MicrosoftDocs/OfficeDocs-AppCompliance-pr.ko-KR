...
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 1월 27일</p>

* <a href="https://teams.microsoft.com/l/app/bceca1f0-723f-44d0-b732-b3506c0a641d" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000894" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Communitio Corporation에서 Microsoft에 제공하는 정보:
...
이 정보는 Communitio Corporation에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직이 제어할 수 있는 방법에 대해 제공했습니다.
...
| 데이터베이스에 저장되는 데이터는 무엇입니까? | 사용자 프로필 데이터(전자 메일/이름/aad 개체 ID/사용자 프로필 이미지) |
| Microsoft 고객 데이터를 원본으로 사용하여 처리하거나 저장하는 경우 이 데이터는 지리적으로 저장되는 위치입니다. | 일본 |
...
| 개인 정보 취급 방침 URL | https://communitio.jp/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamMember.Read.All | application |  카드를 보낼 사람을 선택하려면 | [bceca1f0-723f-44d0-b732-b3506c0a641d](https://docs.microsoft.com/microsoft-365-app-certification/azure/bceca1f0-723f-44d0-b732-b3506c0a641d) |
>| TeamMember.Read.All | 위임 |  카드를 보낼 사람을 선택하려면 | [bceca1f0-723f-44d0-b732-b3506c0a641d](https://docs.microsoft.com/microsoft-365-app-certification/azure/bceca1f0-723f-44d0-b732-b3506c0a641d) |
>| User.Read | 위임 | 로그인한 사용자의 프로필 정보를 얻습니다. | [bceca1f0-723f-44d0-b732-b3506c0a641d](https://docs.microsoft.com/microsoft-365-app-certification/azure/bceca1f0-723f-44d0-b732-b3506c0a641d) |
>| User.Read.All | application |  카드를 보낼 사람을 선택하려면 | [bceca1f0-723f-44d0-b732-b3506c0a641d](https://docs.microsoft.com/microsoft-365-app-certification/azure/bceca1f0-723f-44d0-b732-b3506c0a641d) |
>| User.Read.All | 위임 |  카드를 보낼 사람을 선택하려면 | [bceca1f0-723f-44d0-b732-b3506c0a641d](https://docs.microsoft.com/microsoft-365-app-certification/azure/bceca1f0-723f-44d0-b732-b3506c0a641d) |
>| openid | 위임 |  로그인합니다. | [bceca1f0-723f-44d0-b732-b3506c0a641d](https://docs.microsoft.com/microsoft-365-app-certification/azure/bceca1f0-723f-44d0-b732-b3506c0a641d) |
>| 프로필 | 위임 | 로그인한 사용자의 프로필 정보를 얻습니다. | [bceca1f0-723f-44d0-b732-b3506c0a641d](https://docs.microsoft.com/microsoft-365-app-certification/azure/bceca1f0-723f-44d0-b732-b3506c0a641d) |
