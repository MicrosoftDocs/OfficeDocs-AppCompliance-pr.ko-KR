---
title: Startgrid의 Startgrid에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/09/2022
...
description: Startgrid, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보
...
* <a href="https://teams.microsoft.com/l/app/6624420b-7199-41d2-98ff-90d745e039a7" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003838" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Startgrid에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | Startgrid |
| 회사의 웹 사이트 | [https://app.startgrid.com](https://app.startgrid.com) |
| 앱 사용 약관 | [https://corp.startgrid.com/terms-of-use](https://corp.startgrid.com/terms-of-use) |
| 앱의 핵심 기능 | 문제를 더 빠르게 해결하기 위해 기술 솔루션을 찾고 공유하고 평가합니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://corp.startgrid.com/platform](https://corp.startgrid.com/platform) |
...
이 정보는 Startgrid에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직에서 제공하는 컨트롤에 대해 제공됩니다.
...
| 개인 정보 취급 방침 URL | https://corp.startgrid.com/privacy-policy |
