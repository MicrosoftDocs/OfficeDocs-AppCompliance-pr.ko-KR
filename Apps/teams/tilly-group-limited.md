---
title: TiLly by Tilly Group Limited에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/15/2022
...
description: tiLly에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
ms.locfileid: "66113055"
---
# <a name="tilly"></a>tiLly

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2021년 12월 6일</p>

* <a href="https://teams.microsoft.com/l/app/9f9d64e3-e479-4b7b-9c5e-c4e049a732aa" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003825" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

틸리 그룹이 Microsoft로 제한한 정보:
...
| 파트너 회사 이름 | Tilly 그룹 제한 |
| 회사 웹 사이트 | [https://tillygroup.co.uk](https://tillygroup.co.uk) |
| 앱의 사용 약관 | [https://www.tillygroup.co.uk/wp-content/uploads/2021/11/Til...](https://www.tillygroup.co.uk/wp-content/uploads/2021/11/Tilly-Group-Limited-tiLly-Terms-of-Use.pdf) |
| 앱의 핵심 기능 | 사용자 고유의 Microsoft Teams 봇으로 학습자 업스킬 참여, 권한 부여 및 지원 |
| 회사 본사 위치 | 영국 및 북아일랜드(해당) |
| 앱 정보 페이지 | [https://www.tillygroup.co.uk/wp-content/uploads/2021/11/BOT...](https://www.tillygroup.co.uk/wp-content/uploads/2021/11/BOT-Infographic-1.pdf) |
...
이 정보는 Tilly Group Limited에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 테넌트 ID, 비즈니스 이름, 연락처 세부 정보 사용자, 사용자 이름, 익명 사용자 ID, 질문 및 제공된 답변(이미지 및 첨부 파일 포함) |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 테넌트 ID, 비즈니스 이름, 연락처 세부 정보 사용자, 사용자 이름, 익명 사용자 ID, 질문 및 제공된 답변(이미지 및 첨부 파일 포함) |
...
| 개인 정보 취급 방침 URL | https://www.tillygroup.co.uk/wp-content/uploads/2021/11/Tilly-Group-Limited-tiLly-Privacy-Statement.pdf |
...
| 지원되는 정책 유형 나열 | 애플리케이션은 Azure AD 페더레이션되므로 모든 조건부 액세스 정책을 사용할 수 있습니다. |
