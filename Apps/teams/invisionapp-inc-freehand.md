...
ms.locfileid: "60412327"
---
# <a name="freehand"></a>프리 핸드
...
InVisionApp Inc.에서 Microsoft에 제공한 정보:
...
| 사용 약관 URL | [https://www.invisionapp.com/legal/terms-of-service](https://www.invisionapp.com/legal/terms-of-service) |
...
이 정보는 InVisionApp Inc.에서 제공했습니다. 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터에 대해 조직에서 제어할 수 있습니다.
...
>시스템 및 응용 프로그램의 로그는 데이터를 수정하거나 삭제할 수 있는 액세스가 매우 제한된 중앙 로그 관리 시스템과 SIEM에 모두 수집됩니다. 또한 SIEM은 호스트 침입, 무결성, 네트워크 신뢰도를 모니터링하고 이 정보를 클라우드트레이블 이벤트와 상관 관계가 있습니다. 시스템은 전담 보안 팀에서 모니터링하며, 경고는 24/7 oncall 엔지니어의 페이지로 구성됩니다. 두 시스템의 로그는 1년 동안 유지 관리됩니다.

#### <a name="organizational-controls-for-data-stored-by-partner"></a>파트너가 저장한 데이터에 대한 조직 제어

조직의 관리자가 파트너 시스템에서 정보를 제어하는 방법에 대해 설명하는 방법 삭제, 보존, 감사, 보관, 최종 사용자 정책 등

>제3자 위험 평가는 개인 정보를 처리하는 공급업체에 대해 수행됩니다. 조항은 중요도/위험 요인에 따라 &#8220;감사권&#8221; 및 실사 재평가를 포함하기 위해 계약적으로 추가되었습니다. 법률은 적용 가능한 경우 계약상 추가되는 데이터 보호 부록과 InVision 요구 사항을 충족하는 허용되는 표준을 구현했습니다. 하위 프로세스는 암호화되지 않은 형식으로 고객 프로젝트 데이터에 액세스할 수 없습니다.
...
이 정보는 InVisionApp Inc.에서 이 앱이 인증, 권한 부여, 응용 프로그램 등록 모범 사례 및 기타 ID 조건을 처리하는 방법에 대해 제공합니다.
