---
title: Solutions2Share GmbH의 파일 관리자에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/24/2022
...
description: CSA STAR 레지스트리의 파일 관리자, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용할 수 있는 모든 보안 및 규정 준수 정보
...
ms.locfileid: "64463998"
---
# <a name="file-manager"></a>파일 관리자

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2021년 12월 30일</p>

* <a href="https://teams.microsoft.com/l/app/4946e155-584a-412d-aac1-48975e073587" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003770" target="_blank">AppSource의 보기</a>
...
| 앱의 핵심 기능 | 관리 팀의 모든 팀을 통해 Microsoft Teams |
| 회사 본사 위치 | 독일 |
| 앱 정보 페이지 | [https://www.solutions2share.com/file-manager/](https://www.solutions2share.com/file-manager/) |
...
| 데이터베이스에 저장되는 데이터는 무엇입니까? | TenantID,사용자 계정 이름 |
