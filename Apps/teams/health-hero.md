---
title: Health Hero의 Health Hero에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/10/2021
...
description: Health Hero에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/1394c825-0026-4f33-bcc9-abaa9ae5d83b" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001405" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Health Hero가 Microsoft에 제공한 정보:
...
| 회사 웹 사이트 | [https://gohealthhero.com](https://gohealthhero.com) |
| 앱의 사용 약관 | [https://www.gohealthhero.com/terms](https://www.gohealthhero.com/terms) |
| 앱의 핵심 기능 | Health Hero를 사용하면 사용자가 정상 활동을 캡처하고 활동 지점을 받을 수 있습니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
...
이 정보는 Health Hero에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 응용 프로그램 | 계정을 만들기 위한 사용자 정보입니다. | [5f1f4eb7-479e-42f3-b86f-4c1f53e1c222](../azure/5f1f4eb7-479e-42f3-b86f-4c1f53e1c222.md) |
