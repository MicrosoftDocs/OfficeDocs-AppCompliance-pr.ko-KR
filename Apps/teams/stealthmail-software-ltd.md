...
<p>최종 업데이트: 2021년 3월 31일</p>

* <a href="https://teams.microsoft.com/l/app/1ed0a549-c730-44c7-a984-a8c658fe9807" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001748" target="_blank">앱소스에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

마이크로소프트에 스텔스 메일 소프트웨어 주식 회사에서 제공 하는 정보:
...
| 파트너 웹사이트의 URL | [https://stealthmail.com](https://stealthmail.com) |
| Teams 응용 프로그램 정보 페이지의 URL | [https://stealthmail.com/product/teams](https://stealthmail.com/product/teams) |
| 개인정보 처리방침의 URL | [https://stealthmail.com/privacy-statement](https://stealthmail.com/privacy-statement) |
| 이용 약관의 URL | [https://stealthmail.com/terms-and-conditions](https://stealthmail.com/terms-and-conditions) |
...
이 정보는 Stealthmail Software Ltd에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직이 가질 수 있는 제어에 대해 제공했습니다.
...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| 채널 메시지.읽기.모든 | 위임 | 응용 프로그램은 만든 보안 전자 메일에 참조와 함께 채널로 메시지를 보냅니다 | 무 | 1ed0a549-c730-44c7-a984-a8c658fe9807 |
>| 채널 메시지.보내기 | 위임 | 응용 프로그램은 만든 보안 전자 메일에 참조와 함께 채널로 메시지를 보냅니다 | 무 | 1ed0a549-c730-44c7-a984-a8c658fe9807 |
>| 채팅.읽기 쓰기 | 위임 | 응용 프로그램은 만든 보안 이메일에 참조와 채팅하는 메시지를 보냅니다 | 무 | 1ed0a549-c730-44c7-a984-a8c658fe9807 |
>| 그룹 멤버.읽기.모든 | 위임 | 응용 프로그램은 채널 회원이 그들을 위해 안전한 이메일을 만들기 위해 가져옵니다 | 무 | 1ed0a549-c730-44c7-a984-a8c658fe9807 |
>| User.Read.All | 위임 | 응용 프로그램은 그들을 위해 안전한 이메일을 만들기 위해 채팅 회원을 가져옵니다 | 무 | 1ed0a549-c730-44c7-a984-a8c658fe9807 |
>| User.ReadBasic.All | 위임 | 응용 프로그램은 그들을 위해 안전한 이메일을 만들기 위해 채팅 회원을 가져옵니다 | 무 | 1ed0a549-c730-44c7-a984-a8c658fe9807 |
>| 전자 메일 | 위임 | 사용자 인증 | 데이터베이스에 저장되지 않습니다. | 1ed0a549-c730-44c7-a984-a8c658fe9807 |
...
>우리는 그들의 시스템에서 파트너의 데이터를 제어 할 수 없습니다.
...
이 정보는 이 앱이 인증, 승인, 응용 프로그램 등록 모범 사례 및 기타 ID 기준을 처리하는 방법에 대해 Stealthmail Software Ltd에서 제공했습니다.
