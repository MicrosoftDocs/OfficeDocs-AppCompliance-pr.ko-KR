...
description: CSA STAR 레지스트리의 ContractZen, 데이터 처리 정책, 해당 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보
...
ContractZen에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | ContractZen |
| 회사의 웹 사이트 | [https://www.contractzen.com](https://www.contractzen.com) |
| 앱 사용 약관 | [https://my.contractzen.com/Terms](https://my.contractzen.com/Terms) |
| 앱의 핵심 기능 | 고급 계약 관리, 회의 관리, 엔터티 관리, 전자 서명 및 VDR(가상 데이터 룸)을 위한 보안 거버넌스 소프트웨어 |
| 회사 본사 위치 | 핀란드 |
| 앱 정보 페이지 | [https://appsource.microsoft.com/en-US/product/office/wa2000...](https://appsource.microsoft.com/en-US/product/office/wa200001389) |
...
이 정보는 ContractZen에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직에서 제공하는 컨트롤에 대해 제공됩니다.
...
| 개인 정보 취급 방침 URL | https://my.contractzen.com/Privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 위임 | 사용자 프로필 정보를 사용할 수 있도록 설정하려면 | [0492ead3-ee26-40df-9757-d95cc693d856](../azure/0492ead3-ee26-40df-9757-d95cc693d856.md) |
