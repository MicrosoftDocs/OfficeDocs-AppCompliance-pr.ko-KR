...
| 파트너 회사 이름 | YAROOMS |
| 회사의 웹 사이트 | [https://yarooms.com](https://yarooms.com) |
| 앱 사용 약관 | [https://www.yarooms.com/legal/terms-conditions/](https://www.yarooms.com/legal/terms-conditions/) |
| 앱의 핵심 기능 | Room &amp; Desk Booking Software |
| 회사 본사 위치 | 루마니아 |
| 앱 정보 페이지 | [https://yarooms.com/help](https://yarooms.com/help) |
| 앱을 실행하기 위해 사용되는 호스팅 환경 또는 서비스 모델은 무엇입니까? | 이아스 |
| 앱에서 어떤 호스팅 클라우드 공급자를 사용하나요? | Aws, Azure, GCP |
