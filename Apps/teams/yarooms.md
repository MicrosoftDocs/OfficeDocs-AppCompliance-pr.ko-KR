---
title: YAROOMS별 YAROOMS에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/15/2021
...
description: YAROOMS에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보.
...
* <a href="https://teams.microsoft.com/l/app/495f8194-bdf2-41a3-8292-3f53b004c2e6" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001225" target="_blank">AppSource에서 보기</a>
...
| 파트너 회사 이름 | YAROOMS |
| 회사 웹 사이트 | [https://yarooms.com](https://yarooms.com) |
| 앱의 사용 약관 | [https://www.yarooms.com/legal/terms-conditions/](https://www.yarooms.com/legal/terms-conditions/) |
| 앱의 핵심 기능 | 룸 &amp; 데스크 예약 소프트웨어 |
| 회사 본사 위치 | 루마니아 |
| 앱 정보 페이지 | [https://yarooms.com/help](https://yarooms.com/help) |
| 앱을 실행하는 데 사용되는 호스팅 환경 또는 서비스 모델은 무엇인가요? | Iaas |
| 앱에서 사용하는 호스팅 클라우드 공급자는 무엇인가요? | Aws, Azure, GCP |
...
이 정보는 YAROOMS에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
...
| 개인 정보 취급 방침 URL | https://www.yarooms.com/legal/privacy-policy |
