---
title: 실행 가능한 과학별 Rezolve.ai 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/03/2021
...
description: Rezolve.ai 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/762a660d-9fa5-461b-be81-310c102ba820" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002724" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

실행 가능한 과학에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | 실행 가능한 과학 |
| 회사 웹 사이트 | [https://www.rezolve.ai](https://www.rezolve.ai) |
| 앱의 사용 약관 | [https://www.rezolve.ai/generalTerms](https://www.rezolve.ai/generalTerms) |
| 앱의 핵심 기능 | 앱은 a) 티켓 만들기 및 업데이트 기능을 포함하여 포괄적인 Employee Service Desk 기능을 제공합니다. b) 답변 일상적인 질문 c) 프로비전 또는 온보딩과 같은 일반적인 작업 자동화  |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
...
이 정보는 Actionable Science에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
...
| 가장 최근 SOC1 인증 날짜 | 2019-12-31 |
| 앱이 서비스 조직 컨트롤(SOC 2)을 준수하나요? | 예 |
| 가장 최근 SOC2 인증 날짜 | 2019-12-31 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 위임 | 로그인 및 사용자 프로필 읽기 | [eb628055-f790-4ef0-9fce-ac95b4c61466](../azure/eb628055-f790-4ef0-9fce-ac95b4c61466.md) |
