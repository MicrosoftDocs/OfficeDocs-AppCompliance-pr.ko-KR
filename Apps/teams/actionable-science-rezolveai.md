...
| 파트너 회사 이름 | 실행 가능한 과학 |
| 회사의 웹 사이트 | [https://www.rezolve.ai](https://www.rezolve.ai) |
| 앱 사용 약관 | [https://www.rezolve.ai/generalTerms](https://www.rezolve.ai/generalTerms) |
| 앱의 핵심 기능 | 앱은 a) 티켓 만들기 및 업데이트 기능을 포함하여 포괄적인 직원 서비스 데스크 기능을 제공합니다. 티켓 만들기 및 업데이트 b) 루틴 질문에 답변 c) 프로비저닝 또는 온보더링과 같은 일반적인 작업 자동화  |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 위임 | 로그인 및 사용자 프로필 읽기 | [eb628055-f790-4ef0-9fce-ac95b4c61466](https://docs.microsoft.com/microsoft-365-app-certification/azure/eb628055-f790-4ef0-9fce-ac95b4c61466) |
