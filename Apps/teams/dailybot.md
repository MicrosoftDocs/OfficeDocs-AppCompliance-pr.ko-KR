...
description: DailyBot에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
ms.locfileid: "66915660"
---
# <a name="dailybot"></a>DailyBot

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 4월 27일</p>

* <a href="https://teams.microsoft.com/l/app/82bfb2e1-cad3-4e99-8995-5d140f295ef2" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001492" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

DailyBot에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | DailyBot |
| 회사 웹 사이트 | [https://www.dailybot.com](https://www.dailybot.com) |
| 앱의 사용 약관 | [https://www.dailybot.com/legal/terms-and-conditions](https://www.dailybot.com/legal/terms-and-conditions) |
| 앱의 핵심 기능 | DailyBot은 스탠드업, 일일 상태 보고서, 회고 및 정기 체크인을 자동화하여 모임의 필요성을 줄입니다. 팀의 동기를 추적하고 명성과 감사로 긍정적인 피드백을 촉진합니다. DailyBot에는 바로 가기/명령을 만들고 채팅 워크플로를 자동화하는 추가 기능이 포함되어 있습니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://www.dailybot.com/integrations/msteams](https://www.dailybot.com/integrations/msteams) |
...
이 정보는 DailyBot에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 사용자 Email, 테넌트 ID, MS 팀 리소스 ID 및 이름, 팀 채널 ID |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 사용자 Email, 테넌트 ID, MS 팀 리소스 ID 및 이름, 팀 채널 ID, DailyBot의 기능 및 워크플로에서 수집한 사용자 응답 콘텐츠(예: 체크 인, 설문 조사, 양식 또는 Kudos)입니다. |
...
| 개인 정보 취급 방침 URL | https://www.dailybot.com/legal/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 위임 | DailyBot은 팀에서 사용자의 기본 정보를 읽어야 합니다. 이는 온보딩 프로세스에 대한 좋은 사용자 환경을 제공하고 멤버 초대 프로세스를 더 쉽게 만드는 데 사용됩니다. | [82bfb2e1-cad3-4e99-8995-5d140f295ef2](../azure/82bfb2e1-cad3-4e99-8995-5d140f295ef2.md) |
