---
title: TNS Consulting ApS의 Desk 예약에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
ms.date: 02/11/2022
ms.topic: article
...
description: Desk 예약, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용할 수 있는 모든 보안 및 규정 준수 정보
...
ms.locfileid: "62795828"
---
# <a name="desk-reservations"></a>책상 예약

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2021년 11월 15일</p>

* <a href="https://teams.microsoft.com/l/app/5e73a3c5-eed6-4954-91ce-2a38394c2b4d" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003532" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

TNS Consulting Aps에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | TNS Consulting ApS |
| 회사의 웹 사이트 | [https://www.meetingroommap.net](https://www.meetingroommap.net) |
| 앱 사용 약관 | [https://www.meetingroommap.net/home/TermsAndConditions](https://www.meetingroommap.net/home/TermsAndConditions) |
| 앱의 핵심 기능 | 책상 또는 기타 매핑된 항목에 대한 예약을 합니다. |
| 회사 본사 위치 | 덴마크 |
| 앱 정보 페이지 | |
...
이 정보는 TNS Consulting ApS에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직이 제어할 수 있는 방법에 대해 제공합니다.
...
| 데이터베이스에 저장되는 데이터는 무엇입니까? | 등록 예약을 위한 전자 메일입니다. |
...
| 앱 및 이를 지원하는 구조에서 분기별 취약점 검색을 수행하나요? | 아니오 |
| 외부 네트워크 경계에 방화벽이 설치되어 있습니까? | 아니오 |
...
| 개인 정보 취급 방침 URL | https://www.meetingroommap.net/Home/Privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite | 위임 | 응용 프로그램 구성 파일 읽기 및 쓰기(기본 바닥 계획 + 위치 저장) | [c9b3645e-2695-46c5-970d-e06f5c74bcfa](https://docs.microsoft.com/microsoft-365-app-certification/azure/c9b3645e-2695-46c5-970d-e06f5c74bcfa) |
>| TeamMember.Read.All | 위임 | 동일한 팀의 다른 구성원의 예약을  시청합니다. | [c9b3645e-2695-46c5-970d-e06f5c74bcfa](https://docs.microsoft.com/microsoft-365-app-certification/azure/c9b3645e-2695-46c5-970d-e06f5c74bcfa) |
>| User.Read | 위임 | 예약 등록을 위한 로그인 및 전자 메일 읽기 | [c9b3645e-2695-46c5-970d-e06f5c74bcfa](https://docs.microsoft.com/microsoft-365-app-certification/azure/c9b3645e-2695-46c5-970d-e06f5c74bcfa) |
