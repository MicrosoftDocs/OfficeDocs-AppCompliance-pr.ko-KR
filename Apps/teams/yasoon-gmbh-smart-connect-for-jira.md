...
description: Jira용 Smart 커넥트, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보
...
| 앱의 핵심 기능 | yasoon은 &amp; Atlassian과 Atlassian 간의 똑똑하고 안전한 통합을 제공하는 데 Microsoft 서비스. Atlassian Jira와 Outlook Teams 도구를 제공합니다. 사용자용 Jira Microsoft Teams 채팅 및 대화를 Jira 문제에 연결하여 소프트웨어 및 비즈니스 팀이 함께 Teams 수 있습니다. |
| 회사 본사 위치 | 독일 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | 위임 | 사용 권한은 사용자가 Jira에서 이 가입 채널 중 하나를 선택할 수 있도록 하는 데 사용됩니다. | [89d5ca9f-d63b-4885-bd30-6e7433c1540c](../azure/89d5ca9f-d63b-4885-bd30-6e7433c1540c.md) |
>| ChannelMessage.Read.Group | application | 앱에서 Jira에 연결된 채널 메시지를 표시하는 데 허용합니다. | [89d5ca9f-d63b-4885-bd30-6e7433c1540c](../azure/89d5ca9f-d63b-4885-bd30-6e7433c1540c.md) |
>| ChannelMessage.Send | 위임 | 데이터가 사용 중이지 않습니다. 이 API는 사용자가 Jira의 채널 메시지에 회신할 수 있도록 하는 데 사용됩니다. | [89d5ca9f-d63b-4885-bd30-6e7433c1540c](../azure/89d5ca9f-d63b-4885-bd30-6e7433c1540c.md) |
>| ChannelSettings.Read.Group | application | 채널에 대한 세부 정보를 찾아보는 데 사용됩니다. | [89d5ca9f-d63b-4885-bd30-6e7433c1540c](../azure/89d5ca9f-d63b-4885-bd30-6e7433c1540c.md) |
>| Chat.ReadWrite | 위임 | 사용자가 채팅에 새 응답을 추가하고 Jira의 채팅 메시지를 볼 수 있도록 하는 데 사용됩니다. | [89d5ca9f-d63b-4885-bd30-6e7433c1540c](../azure/89d5ca9f-d63b-4885-bd30-6e7433c1540c.md) |
>| Member.Read.Group | application | 사용 권한 검사에 사용하면 앱에서 사용자의 팀 구성원 자격을 확인할 수 있습니다. | [89d5ca9f-d63b-4885-bd30-6e7433c1540c](../azure/89d5ca9f-d63b-4885-bd30-6e7433c1540c.md) |
>| Team.ReadBasic.All | 위임 | 사용 권한은 사용자가 Jira에서 이 참가 팀 중 하나를 선택할 수 있도록 하는 데 사용됩니다. | [89d5ca9f-d63b-4885-bd30-6e7433c1540c](../azure/89d5ca9f-d63b-4885-bd30-6e7433c1540c.md) |
>| TeamSettings.Read.Group | application | 앱에서 특정 기본값을 적용하기 위해 팀 설정을 읽을 수 있습니다. | [89d5ca9f-d63b-4885-bd30-6e7433c1540c](../azure/89d5ca9f-d63b-4885-bd30-6e7433c1540c.md) |
>| User.ReadBasic.All | 위임 | 사용자가 채널 메시지에서 @-mention에 대한 공동 작업자를 선택할 수 있습니다. | [89d5ca9f-d63b-4885-bd30-6e7433c1540c](../azure/89d5ca9f-d63b-4885-bd30-6e7433c1540c.md) |
