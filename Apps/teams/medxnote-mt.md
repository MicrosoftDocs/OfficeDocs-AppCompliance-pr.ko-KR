---
title: 메드노트에 의해 메드노트 MT에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
ms.date: 09/28/2020
ms.topic: article
...
description: Medxnote MT에 대한 사용 가능한 모든 보안 및 규정 준수 정보 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보.
...
* <a href="https://teams.microsoft.com/l/app/02ffb7cc-5fcd-4b31-bcbd-b24bbca74cc7" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001823" target="_blank">앱소스에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

메드노트가 마이크로소프트에 제공한 정보:
...
| 파트너 회사 이름 | Medxnote |
| 파트너 웹사이트의 URL | [https://medxnote.com](https://medxnote.com) |
| 개인정보 처리방침의 URL | [https://medxnote.com/privacy-policy/](https://medxnote.com/privacy-policy/) |
| 이용 약관의 URL | [https://medxnote.com/terms-conditions/](https://medxnote.com/terms-conditions/) |
...
이 정보는 Medxnote에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직에서 가질 수 있는 제어에 대해 제공했습니다.
...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| User.Read.All | 신청 | 우리는 사용자의 권한을 확인하기 위해 병원 측에서 사용되는 이름과 이메일을 캐싱하고 있습니다. | 메시지를 보낼 때 이름 및 이메일 주소가 추가되면 서버 측의 해당 데이터를 캐싱하고 있으며 병원 측에서 선택적 권한 검사에도 사용됩니다. | fc70bbbe-91c4-4d8f-a9c9-a022068d5752 |
>| 오픈 ID | 위임 | 작업 모듈에서 사용자에게 로그인하는 데 사용되는 세션 ID, 사용자 ID, 베어러 토큰 및 전자 메일을 캐싱하고 있습니다. | 작업 모듈에서 사용자에게 로그인하는 데 사용하는 경우 세션 ID, 사용, 이메일, 보유자 토큰을 저장합니다. | fc70bbbe-91c4-4d8f-a9c9-a022068d5752 |
...
>이메일 주소, 이름, 테넌트 ID, 채널 ID가 로그에 나타날 수 있습니다 모든 로그 데이터는 늦어도 1 개월 후에 자동으로 삭제됩니다.
이러한 액세스는 2FA가 적용된 액세스 권한이 있는 소수의 조직 관리자로 제한됩니다.

#### <a name="organizational-controls-for-data-stored-by-partner"></a>파트너가 저장한 데이터에 대한 조직 제어

조직의 관리자가 파트너 시스템에서 자신의 정보를 제어하는 방법을 설명해 보세요. 예를 들어 삭제, 보존, 감사, 보관, 최종 사용자 정책 등

>액세스는 2FA가 적용된 액세스 권한이 있는 소수의 조직 관리자로 제한됩니다.
중요한 시스템은 특정 IP 주소에서만 액세스할 수 있습니다.
