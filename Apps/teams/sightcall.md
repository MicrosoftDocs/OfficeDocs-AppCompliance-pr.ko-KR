---
title: SightCall의 SightCall에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
ms.date: 02/17/2022
ms.topic: article
...
description: SightCall, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용 가능한 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/c5312ffd-d146-4515-89e0-b43fa5282368" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003675" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

SightCall에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | SightCall |
| 회사의 웹 사이트 | [https://sightcall.com](https://sightcall.com) |
| 앱 사용 약관 | [https://sightcall.com/terms-conditions](https://sightcall.com/terms-conditions) |
| 앱의 핵심 기능 | SightCall은 엔터프라이즈급 비디오 클라우드 플랫폼입니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직이 하게 될 컨트롤에 대한 SightCall에서 제공했습니다.
...
| 가장 최근 SOC2 인증 날짜 |  2021-06-25 |
| 앱이 SOC(서비스 조직 제어)를 준수하나요? | 예 |
| 가장 최근 SOC3 인증 날짜 |  2021-06-25 |
...
| 개인 정보 취급 방침 URL | https://sightcall.com/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| 전자 메일 | 위임 | 로그인에 필요 | [c5312ffd-d146-4515-89e0-b43fa5282368](https://docs.microsoft.com/microsoft-365-app-certification/azure/c5312ffd-d146-4515-89e0-b43fa5282368) |
>| 프로필 | 위임 | 로그인에 필요 | [c5312ffd-d146-4515-89e0-b43fa5282368](https://docs.microsoft.com/microsoft-365-app-certification/azure/c5312ffd-d146-4515-89e0-b43fa5282368) |
