...
<p>최종 업데이트: 2021년 3월 29일</p>

* <a href="https://teams.microsoft.com/l/app/608c5480-b3aa-4a0f-8f26-b97715313f4a" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000197" target="_blank">앱소스에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Streem에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | Streem |
| 파트너 웹사이트의 URL | [https://streem.com.au](https://streem.com.au) |
| Teams 응용 프로그램 정보 페이지의 URL | [해당 없음](N/A) |
| 개인정보 처리방침의 URL | [https://streem.com.au/privacy](https://streem.com.au/privacy) |
| 이용 약관의 URL | [https://streem.com.au/terms/general](https://streem.com.au/terms/general) |
...
이 정보는 Streem에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직에서 가질 수 있는 제어에 대해 제공했습니다.
...
>|:--------------------------------|:---------------------|:--------------------------|
>| Streem 측의 고객 계정과 Teams 사용자 이름 일치 | 아니요 |  |
...
>확인된 기술 관리자만 데이터에 액세스할 수 있으며 모든 액세스 권한이 기록됩니다.
...
<iframe height='1020' title='Microsoft Cloud App Security 정보' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/36909' frameborder='no' style='width: 100%;'></iframe>

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/36909" target="_blank">새 탭에서 보기</a>
...
이 정보는 이 앱이 인증, 권한 부여, 응용 프로그램 등록 모범 사례 및 기타 ID 기준을 처리하는 방법에 대해 Streem에서 제공했습니다.
