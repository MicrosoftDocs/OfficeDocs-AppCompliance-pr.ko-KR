...
| 앱의 핵심 기능 | Streem은 오스트레일리아 및 뉴질랜드의 인쇄, 온라인, TV, 라디오 및 소셜 미디어 소스에서 콘텐츠를 수집하고 분석하여 실시간 미디어 모니터링 서비스를 제공합니다. 각 새로운 콘텐츠 조각은 고객이 관심 있는 키워드와 관련 알림 및 보고서가 전자 메일, &amp; 모바일 데스크톱 응용 프로그램 또는 Slack 및 보고서와의 통합을 통해 Microsoft Teams. |
| 회사 본사 위치 | 오스트레일리아 |
| 앱 정보 페이지 | |
