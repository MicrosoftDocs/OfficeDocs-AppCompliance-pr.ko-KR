---
title: Streem별 Streem에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/09/2022
...
description: Streem에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://appsource.microsoft.com/product/office/WA200000197" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Streem에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | Streem |
| 회사 웹 사이트 | [https://www.streem.com.au](https://www.streem.com.au) |
| 앱의 사용 약관 | [https://www.streem.com.au/terms](https://www.streem.com.au/terms) |
| 앱의 핵심 기능 | Streem은 오스트레일리아와 뉴질랜드의 인쇄, 온라인, TV, 라디오 및 소셜 미디어 원본에서 콘텐츠를 수집하고 분석하여 실시간 미디어 모니터링 서비스를 제공합니다. 각 새로운 콘텐츠는 고객이 관심 있는 키워드와 일치하며, 관련 경고 및 보고서는 이메일, 모바일 &amp; 데스크톱 애플리케이션 또는 Slack 및 Microsoft Teams 통합을 통해 전송됩니다. |
| 회사 본사 위치 | 오스트레일리아 |
| 앱 정보 페이지 | |
...
이 정보는 Streem에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
