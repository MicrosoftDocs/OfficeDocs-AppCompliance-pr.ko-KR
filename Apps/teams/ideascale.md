---
title: IdeaScale의 IdeaScale에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/21/2022
...
description: IdeaScale, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보
...
* <a href="https://teams.microsoft.com/l/app/a4de8de4-33b1-4e55-97ac-9f87b5978c0f" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003868" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

IdeaScale에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | IdeaScale |
| 회사의 웹 사이트 | [https://ideascale.com](https://ideascale.com) |
| 앱 사용 약관 | [https://ideascale.com/terms-and-conditions-of-use](https://ideascale.com/terms-and-conditions-of-use) |
| 앱의 핵심 기능 | IdeaScale은 혁신 팀을 위한 최고의 아이디어 관리 플랫폼입니다. 조직의 모든 사람이 커뮤니티의 다른 사용자들이 볼 수 있는 아이디어를 공유하고 피드백 및 리소스를 수집하여 이러한 아이디어를 새 제품 또는 프로젝트로 전환할 수 있습니다. 이제 IdeaScale 커뮤니티를 Microsoft Teams 작업 공간에 연결하여 아이디어를 관리할 수 Teams. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://ideascale.com/teams/](https://ideascale.com/teams/) |
...
이 정보는 IdeaScale에서 이 앱이 조직 데이터를 수집 및 저장하는 방법 및 조직이 수집하는 데이터를 통해 조직이 하게 될 컨트롤에 대해 제공됩니다.
...
| 개인 정보 취급 방침 URL | https://ideascale.com/privacy-policy |
