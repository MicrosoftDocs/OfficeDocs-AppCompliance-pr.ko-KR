...
* <a href="https://teams.microsoft.com/l/app/c5418a24-940a-4bf1-a802-8d9e633838fa" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001951" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Sensei Labs Inc.에서 Microsoft에 제공하는 정보:
...
| 파트너 웹 사이트의 URL | [https://www.senseilabs.com](https://www.senseilabs.com) |
...
이 정보는 Sensei Labs Inc.에서 이 앱이 조직 데이터를 수집 및 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직이 사용할 컨트롤에 대해 제공됩니다.
...
>Teams 구성원 자격을 만들 수 있습니다. 고객의 Teams 인스턴스와 해당 수행자 인스턴스 간의 연결입니다. 데이터가 수행자 고객인 한 보존됩니다. 고객의 수행자 인스턴스가 해제되거나 요청 시 제거
...
이 정보는 Sensei Labs Inc.에서 이 앱이 인증, 권한 부여, 응용 프로그램 등록 모범 사례 및 기타 ID 조건을 처리하는 방법에 대해 제공했습니다.
