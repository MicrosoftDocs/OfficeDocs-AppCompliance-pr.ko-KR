...
description: SENSEi Labs 컨덕터에 대한 사용 가능한 모든 보안 및 규정 준수 정보 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보.
...
* <a href="https://teams.microsoft.com/l/app/c5418a24-940a-4bf1-a802-8d9e633838fa" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001951" target="_blank">앱소스에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

마이크로소프트에 센시 연구소 에서 제공 하는 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | Sensei Labs Conductor |
| ID | WA200001951 |
| 지원되는 Office 365 클라이언트 | Microsoft Teams |
| 파트너 회사 이름 | Sensei Labs Inc. |
| 파트너 웹사이트의 URL | [https://www.senseilabs.com/conductor/?utm_campaign=msftteam...](https://www.senseilabs.com/conductor/?utm_campaign=msftteamslaunch&amp;utm_source=teamsappsource&amp;utm_medium=createdby&amp;utm_content=conductorlink) |
| Teams 응용 프로그램 정보 페이지의 URL | [해당 없음](N/A) |
| 개인정보 처리방침의 URL | [https://www.senseilabs.com/conductor/conductor-privacy-poli...](https://www.senseilabs.com/conductor/conductor-privacy-policy/) |
| 이용 약관의 URL | [https://www.senseilabs.com/conductor/msft-teams-terms-condi...](https://www.senseilabs.com/conductor/msft-teams-terms-conditions/) |
...
이 정보는 Sensei Labs Inc.에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직이 가질 수 있는 제어에 대해 제공했습니다.
...
>|:-------------------|:-------------------|:--------------------------|:--------------------------|:---------------------------------------------------|:--------------------------|
>| 봇 프레임워크 | 예 | Teams 인스턴스 ID | 조직과 연결된 응용 프로그램의 인스턴스에 Teams 인스턴스를 매핑하려면  | Teams 인스턴스 ID | 조직과 연결된 응용 프로그램의 인스턴스에 Teams 인스턴스를 매핑하려면  |
...
>|:--------------------------------|:---------------------|:--------------------------|
>| 봇 대화 중에 사람을 올바르게 해결합니다. Teams 사용자를 응용 프로그램에서 사용자에게 매핑하기 위해 | Teams 식별자, 이름, 이메일 주소 | 플랫폼에서 사용자에게 Teams 사용자를 매핑하려면 |
...
>Teams 팀 멤버십. 고객의 Teams 인스턴스와 컨덕터 인스턴스 간의 연결입니다. 데이터는 지휘자 고객인 한 유지됩니다. 고객의 도체 인스턴스가 폐기되거나 요청에 따라 제거
...
<iframe height='1020' title='Microsoft Cloud App Security 정보' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/36367' frameborder='no' style='width: 100%;'></iframe>

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/36367" target="_blank">새 탭에서 보기</a>
...
이 정보는 Sensei Labs Inc.에서 이 앱이 인증, 승인, 응용 프로그램 등록 모범 사례 및 기타 ID 기준을 처리하는 방법에 대해 제공했습니다.
