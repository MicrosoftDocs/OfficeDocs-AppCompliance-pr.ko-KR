---
title: Read AI, Inc.의 읽기 모임 탐색기를 위한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/15/2022
...
description: 읽기 모임 탐색기, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
ms.locfileid: "65357119"
---
# <a name="read-meeting-navigator"></a>모임 탐색기 읽기

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 4월 15일</p>

* <a href="https://teams.microsoft.com/l/app/18eb20ae-cd59-48c6-8060-fbe171a917e5" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003896" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Read AI, Inc.에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | Read AI, Inc. |
| 회사 웹 사이트 | [https://read.ai](https://read.ai) |
| 앱의 사용 약관 | [https://read.ai/tos](https://read.ai/tos) |
| 앱의 핵심 기능 | 대시보드를 읽고 감정, 참여도 및 전반적인 성능을 충족하는 측정값을 읽습니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://www.read.ai/product](https://www.read.ai/product) |
...
이 정보는 Read AI, Inc.에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 사용자 프로필 데이터, 모임 오디오 데이터 및 모임 비디오 데이터  |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 사용자 프로필 데이터, 오디오 및 비디오 데이터에서 파생된 집계 사용자 메트릭 |
...
| 개인 정보 취급 방침 URL | https://read.ai/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | 위임 | 사용자가 자신의 일정을 서비스와 연결하여 Azure 미디어 봇의 자동 디스패치를 사용하도록 설정할 수 있습니다. | [35e7f5d2-9978-464f-8710-c7a05d5b9fdf](../azure/35e7f5d2-9978-464f-8710-c7a05d5b9fdf.md) |
>| Calls.AccessMedia.All | 응용 프로그램 | 애플리케이션 처리를 위해 모임 오디오 및 비디오 데이터에 액세스 | [35e7f5d2-9978-464f-8710-c7a05d5b9fdf](../azure/35e7f5d2-9978-464f-8710-c7a05d5b9fdf.md) |
>| Calls.JoinGroupCall.All | 응용 프로그램 | 진행 중인 Teams 모임에 참가하려면 Azure 미디어 봇에 대한 조인 권한이 필요합니다. | [35e7f5d2-9978-464f-8710-c7a05d5b9fdf](../azure/35e7f5d2-9978-464f-8710-c7a05d5b9fdf.md) |
>| User.Read | 위임 | SSO 프로세스의 일환으로 사용자 프로필에 대한 읽기 권한을 요청하여 필요한 사용자 데이터에 액세스합니다. | [35e7f5d2-9978-464f-8710-c7a05d5b9fdf](../azure/35e7f5d2-9978-464f-8710-c7a05d5b9fdf.md) |
>| 전자 메일 | 위임 | 계정 만들기 프로세스의 일부로 이메일 주소가 필요합니다.  | [35e7f5d2-9978-464f-8710-c7a05d5b9fdf](../azure/35e7f5d2-9978-464f-8710-c7a05d5b9fdf.md) |
>| openid | 위임 | 사용자가 SSO를 통해 로그인할 수 있습니다. | [35e7f5d2-9978-464f-8710-c7a05d5b9fdf](../azure/35e7f5d2-9978-464f-8710-c7a05d5b9fdf.md) |
>| 프로필 | 위임 | 사용자 계정(이름 및 성, 특히)을 만들려면 사용자 프로필 데이터가 필요합니다. | [35e7f5d2-9978-464f-8710-c7a05d5b9fdf](../azure/35e7f5d2-9978-464f-8710-c7a05d5b9fdf.md) |
