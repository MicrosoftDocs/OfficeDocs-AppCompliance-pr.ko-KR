---
title: 스택 오버플로에 의한 Teams 스택 오버플로에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
ms.date: 08/06/2020
ms.topic: article
...
description: Teams 위한 스택 오버플로, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보, CSA STAR 레지스트리의 보안/규정 준수 정보에 대한 사용 가능한 모든 보안 및 규정 준수 정보.
...
* <a href="https://appsource.microsoft.com/product/office/WA200000739" target="_blank">앱소스에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

스택 오버플로에서 Microsoft로의 정보:
...
| 파트너 웹사이트의 URL | [https://stackoverflow.com](https://stackoverflow.com) |
| 개인정보 처리방침의 URL | [https://stackoverflow.com/legal/privacy-policy](https://stackoverflow.com/legal/privacy-policy) |
| 이용 약관의 URL | [https://stackoverflow.com/legal/terms-of-service/public](https://stackoverflow.com/legal/terms-of-service/public) |
...
이 정보는 스택 오버플로에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직이 가질 수 있는 제어에 대해 제공했습니다.
...
>|:--------------------------------|:---------------------|:--------------------------|
>| 봇은 대화 API를 사용하여 팀 채팅에 메시지를 직접 게시합니다. 봇은 또한 명단을 사용하여 사용자에게 직접 메시지를 전합니다. | 로스터의 데이터는 저장하지 않습니다. |  |
...
>아니요. MS Teams 사용자와 SO Teams 사용자의 매핑은 SO Teams 제품에서 발생합니다.
MS Teams 식별 가능한 ID를 전송하고 내부적으로 사용자를 매핑할 수 있습니다.
또한 MS Teams 는 봇 요청에 대한 JWT를 보내고(요청 위조 방지)를 전송하고 탭 요청은 SO 쿠키를 사용하여 유효성을 검사합니다.

#### <a name="organizational-controls-for-data-stored-by-partner"></a>파트너가 저장한 데이터에 대한 조직 제어

조직의 관리자가 파트너 시스템에서 자신의 정보를 제어하는 방법을 설명해 보세요. 예를 들어 삭제, 보존, 감사, 보관, 최종 사용자 정책 등

>우리는 ISO27001을 기반으로 보안 프로그램을 구축합니다. 데이터는 논리적으로 자체 SQL 스키마로 분리되어 별도의 데이터베이스 집합에 저장됩니다. 데이터는 팀의 요청에 의해서만 액세스할 수 있는 논리적으로 분리된 데이터 저장소에 저장됩니다.
