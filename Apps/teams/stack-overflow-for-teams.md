---
title: Stack Overflow별 Teams용 Stack Overflow에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: Teams용 Stack Overflow, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
ms.locfileid: "66656410"
---
# <a name="stack-overflow-for-teams"></a>Stack Overflow for Teams

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2021년 10월 11일</p>

* <a href="https://teams.microsoft.com/l/app/4783e622-5303-4ea7-a211-ef0dd405da73" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000739" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Stack Overflow에서 Microsoft로 제공하는 정보:
...
| 회사 웹 사이트 | [https://www.stackoverflow.com](https://www.stackoverflow.com) |
| 앱의 사용 약관 | [https://stackoverflow.com/legal/terms-of-service/teams](https://stackoverflow.com/legal/terms-of-service/teams) |
| 앱의 핵심 기능 | Teams용 스택 오버플로는 팀&#8217;질문과 답변을 위한 개인적이고 안전한 홈입니다. 더 이상 부실한 위키와 잃어버린 전자 메일을 파헤쳐 팀이 더 나은 제품을 구축하는 데 필요한 시간을 되돌릴&#8212;없습니다. Teams용 스택 오버플로&#8217; Microsoft Teams와의 통합은 Microsoft Teams 채팅 및 내부 지식 리포지토리를 연결합니다. 새 정보에 대한 알림을 최신 상태로 유지하고, 기존 답변을 검색하고, Microsoft Teams 플랫폼에서 바로 질문을 시작하세요. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://stackoverflow.co/teams/integrations/microsoft-teams](https://stackoverflow.co/teams/integrations/microsoft-teams) |
...
이 정보는 Stack Overflow에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | MS Teams 정보는 앱에서 수집 및 처리되어 표시되고 고객의 Stack Overflow for Teams 환경 내에서 참조됩니다. |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | MS Teams API 액세스 정보 |
...
| 개인 정보 취급 방침 URL | https://stackoverflow.com/legal/privacy-policy/integrations/ms-teams/teams-basic-business |
