---
title: KLIPPAS Technologies inc.의 Kippa 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/13/2021
...
description: Kippa에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/49d0e480-ede2-11ea-85fc-27f7e2c29730" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003327" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

KLIPPAS Technologies Inc.에서 Microsoft에 제공한 정보:
...
| 회사 웹 사이트 | [https://www.kippa.app](https://www.kippa.app) |
| 앱의 사용 약관 | [https://www.kippa.app/terms-of-service/](https://www.kippa.app/terms-of-service/) |
| 앱의 핵심 기능 | Microsoft Teams 내부에서 일회성 또는 반복되는 개인, 공유 또는 채널 미리 알림을 신속하게 설정합니다. |
| 회사 본사 위치 | 캐나다 |
| 앱 정보 페이지 | [https://www.kippa.app/kippa-app/](https://www.kippa.app/kippa-app/) |
...
이 정보는 KLIPPAS Technologies Inc.에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
...
| 지원되는 정책 유형 나열 | 사용자가 Kippa에 대한 액세스 권한을 얻기 위해 Teams 로그인해야 하기 때문에 Microsoft Teams 것과 동일합니다. |
