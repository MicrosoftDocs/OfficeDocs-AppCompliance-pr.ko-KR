---
title: Sense4code별 Scormium에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: Scormium에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
ms.locfileid: "66656434"
---
# <a name="scormium"></a>스콜미움 (동음이의)

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 6월 21일</p>

* <a href="https://teams.microsoft.com/l/app/ad42b2ed-c5ad-4f2c-99e3-5da268a9c967" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004358" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Sense4code에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | Sense4code |
| 회사 웹 사이트 | [https://en.scormium.com](https://en.scormium.com) |
| 앱의 사용 약관 | [https://en.scormium.com/podminky-a-pravidla-uziti](https://en.scormium.com/podminky-a-pravidla-uziti) |
| 앱의 핵심 기능 | Scormium을 사용하여 E-Learning, 이벤트 및 학습 경로의 힘을 즐기십시오.  |
| 회사 본사 위치 | 체코 |
| 앱 정보 페이지 | |
...
이 정보는 Sense4code에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 사용자의 전자 메일   |
| 앱이 TLS 1.1 이상을 지원하나요? | 아니요 |
...
| 개인 정보 취급 방침 URL | https://en.scormium.com/zasady-ochrany-soukromi |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 위임 | 로그인 및 사용자 프로필 읽기 | [ffdbe361-6168-42f7-beef-d1931b7922da](../azure/ffdbe361-6168-42f7-beef-d1931b7922da.md) |
