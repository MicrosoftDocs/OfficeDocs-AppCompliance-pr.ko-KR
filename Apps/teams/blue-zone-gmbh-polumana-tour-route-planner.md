---
title: 블루 존 GmbH별 폴루마나 투어 Route Planner에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: polumana Tour Route Planner에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
ms.locfileid: "66656368"
---
# <a name="polumana-tour-route-planner"></a>폴루마나 투어 루트 플래너

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 4월 5일</p>

* <a href="https://teams.microsoft.com/l/app/4b4b3e3d-a1eb-4b52-b0b9-ba1a79b6be79" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004331" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

블루 존 GmbH에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | 파란색 영역 GmbH |
| 회사 웹 사이트 | [https://blue-zone.de](https://blue-zone.de) |
| 앱의 사용 약관 | [https://azaap-disp-route-planning.azurewebsites.net/#/terms...](https://azaap-disp-route-planning.azurewebsites.net/#/termsofuse) |
| 앱의 핵심 기능 | 고객 방문에 대한 효율성 향상을 위한 Polumana 투어 &amp; Route Planner |
| 회사 본사 위치 | 독일 |
| 앱 정보 페이지 | |
...
이 정보는 블루존 GmbH에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 연락처, 전자 메일 주소 |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 전자 메일, 연락처 주소 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | 응용 프로그램 | 경로 최적화 후 새 약속을 만들고 기존 약속을 삭제해야 합니다. | [d361752a-c257-474d-bb79-324fbe4898b5](../azure/d361752a-c257-474d-bb79-324fbe4898b5.md) |
>| Contacts.Read | 응용 프로그램 | 약속을 만들기 위해 연락처를 읽어야 합니다. | [d361752a-c257-474d-bb79-324fbe4898b5](../azure/d361752a-c257-474d-bb79-324fbe4898b5.md) |
>| User.Read | 응용 프로그램 | 설정을 유지하려면 사용자의 전자 메일을 가져와야 합니다. | [d361752a-c257-474d-bb79-324fbe4898b5](../azure/d361752a-c257-474d-bb79-324fbe4898b5.md) |
