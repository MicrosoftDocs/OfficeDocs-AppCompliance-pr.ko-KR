---
title: Clixie 미디어 LLC의 Clixie에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/24/2022
...
description: Clixie, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용할 수 있는 모든 보안 및 규정 준수 정보
...
ms.locfileid: "64463929"
---
# <a name="clixie"></a>Clixie

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 3월 23일</p>

* <a href="https://teams.microsoft.com/l/app/3ff43e1b-180b-4aab-916e-e49aaaefbccb" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003880" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Clixie Media LLC에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | Clixie Media LLC |
| 회사의 웹 사이트 | [https://clixiemedia.com](https://clixiemedia.com) |
| 앱 사용 약관 | [https://clixiemedia.com/terms-and-conditions/](https://clixiemedia.com/terms-and-conditions/) |
| 앱의 핵심 기능 | Clixie는 라이브 또는 하이브리드 모임 세션 녹음/녹화를 사용하여 Clixie가 실시간으로 자동으로 업데이트하는 유용하고 매력적이며 기억하기 편리한 온디맨드 교육 모듈로 전환합니다. 인증 및 데이터를 통해 실제로 의사 결정을 내리는 데 사용할 수 있는 정보를 한눈에 볼 수 있습니다. 마이크로 학습, 잠금이 있는 장, 비디오 내 평가 /설문 조사, 적응 학습 및 게임 기능은 참여를 유도하도록 설계된 강력한 기능 중 일부입니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://clixiemedia.com](https://clixiemedia.com) |
...
이 정보는 Clixie Media LLC에서 이 앱이 조직 데이터를 수집 및 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직이 가지는 컨트롤에 대해 제공됩니다.
...
| 개인 정보 취급 방침 URL | https://clixiemedia.com/privacy-policy/ |
