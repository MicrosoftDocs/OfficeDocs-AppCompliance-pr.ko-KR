---
title: Deeplink SA별 Deeplink 챗봇에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/13/2022
...
description: 딥링크 챗봇에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보.
...
* <a href="https://teams.microsoft.com/l/app/9f859fc4-0b17-4bf7-abff-f50a73cbe5ab" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004200" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Deeplink SA에서 Microsoft에 제공하는 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | Deeplink Chatbot |
| ID | WA200004200 |
| 지원되는 Office 365 클라이언트 | Microsoft Teams |
| 파트너 회사 이름 | Deeplink SA |
| 회사 웹 사이트 | [https://www.deeplink.ai](https://www.deeplink.ai) |
| 앱의 사용 약관 | [https://www.deeplink.ai/en/terms/](https://www.deeplink.ai/en/terms/) |
| 앱의 핵심 기능 | Deeplink를 사용하면 AI로 구동되는 대화형 에이전트라고도 하는 완전히 사용자 지정 가능한 챗봇을 설치하고 일상적인 상호 작용의 중심에 있는 Microsoft Teams에서 액세스할 수 있습니다. Teams를 사용하면 기존 도우미에 새 터치포인트를 추가하고 IT 기술 지원팀, 자습서 봇 또는 구성 에이전트와 같은 고급 서비스에 직접 액세스할 수 있습니다. |
| 회사 본사 위치 | 스위스 |
| 앱 정보 페이지 | [https://www.deeplink.ai/en/integrations/msteams/](https://www.deeplink.ai/en/integrations/msteams/) |
...
이 정보는 Deeplink SA에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
