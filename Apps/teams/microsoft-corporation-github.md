...
| 회사의 웹 사이트 | [https://github.com](https://github.com) |
| 앱 사용 약관 | [https://github.com/site/terms](https://github.com/site/terms) |
| 앱의 핵심 기능 | GitHub 및 버전 제어를 위한 코드 호스팅 플랫폼입니다. 이를 통해 개발자는 소프트웨어 배송 계획 및 코딩에서 바로 프로젝트를 함께 작업할 수 있습니다. |
| 회사 본사 위치 | 미국 |
