---
title: Microsoft Corporation의 GitHub 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2021
...
description: GitHub, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/ca9e26b7-dce5-44a0-b2b7-a70a3d65ce25" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002077" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Microsoft Corporation에서 Microsoft에 제공한 정보:
...
| 회사 웹 사이트 | [https://github.com](https://github.com) |
| 앱의 사용 약관 | [https://github.com/site/terms](https://github.com/site/terms) |
| 앱의 핵심 기능 | GitHub 공동 작업 및 버전 제어를 위한 코드 호스팅 플랫폼입니다. 이를 통해 개발자는 계획 및 코딩에서 소프트웨어 배송에 이르기까지 프로젝트에서 함께 작업할 수 있습니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://teams.github.com](https://teams.github.com) |
...
이 정보는 Microsoft Corporation에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
