...
description: 50에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보.
...
ms.locfileid: "64875425"
---
# <a name="fifty"></a>Fifty

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2021년 6월 7일</p>

* <a href="https://teams.microsoft.com/l/app/383cc171-22d5-4df5-87d0-6c656ddcff32" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002393" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Microsoft에 50에서 제공하는 정보:
...
| 파트너 회사 이름 | Fifty |
| 회사 웹 사이트 | [https://app.fifty.do](https://app.fifty.do) |
| 앱의 사용 약관 | [https://app.fifty.do/CGUV.pdf](https://app.fifty.do/CGUV.pdf) |
| 앱의 핵심 기능 | 50은 맞춤형 과제를 제공하여 지식에서 행동으로 전환하는 데 도움이 됩니다. 이러한 과제는 핵심 기술을 통합하거나 개선하는 데 도움이 됩니다. |
| 회사 본사 위치 | 프랑스 |
| 앱 정보 페이지 | [https://www.fifty.do](https://www.fifty.do) |
...
이 정보는 50에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
