...
* <a href="https://teams.microsoft.com/l/app/383cc171-22d5-4df5-87d0-6c656ddcff32" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002393" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Microsoft에50에서 제공하는 정보:
...
| 파트너 회사 이름 | Fifty |
| 회사의 웹 사이트 | [https://app.fifty.do](https://app.fifty.do) |
| 앱 사용 약관 | [https://app.fifty.do/CGUV.pdf](https://app.fifty.do/CGUV.pdf) |
| 앱의 핵심 기능 | 50은 개인 설정된 과제를 제공하여 지식에서 작업으로 이동하는 데 도움이 됩니다. 이러한 과제는 핵심 기술을 통합하거나 개선하는 데 도움이 됩니다. |
| 회사 본사 위치 | 프랑스 |
...
이 정보는 이 앱이 조직 데이터를 수집 및 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직이 하게 될 컨트롤에 대해 50에서 제공했습니다.
