...
<p>최종 업데이트: 2021년 3월 8일</p>

* <a href="https://teams.microsoft.com/l/app/6b9cc557-e24a-4744-a370-407e717f2195" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002488" target="_blank">앱소스에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

ALVAO s.r.o에서 제공하는 정보 마이크로소프트에:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | Alvao Service Desk |
| ID | WA200002488 |
| 지원되는 Office 365 클라이언트 | Microsoft Teams |
| 파트너 회사 이름 | ALVAO s.r.o. |
| 파트너 웹사이트의 URL | [https://www.alvao.com/en/ ](https://www.alvao.com/en/ ) |
| Teams 응용 프로그램 정보 페이지의 URL | [https://doc.alvao.com/support/doc/en/alvao_10_4/modules/alv...](https://doc.alvao.com/support/doc/en/alvao_10_4/modules/alvao_teams_addin/default.aspx) |
| 개인정보 처리방침의 URL | [https://www.alvao.com/en/gdpr](https://www.alvao.com/en/gdpr) |
| 이용 약관의 URL | [https://www.alvao.com/en/storage/app/media/documents/licens...](https://www.alvao.com/en/storage/app/media/documents/license_SD_10.3_en.pdf) |
...
이 정보는 ALVAO s.r.o에서 제공되었습니다. 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터를 통해 조직에서 가질 수 있는 제어에 대해 설명합니다.
...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| User.Read | 위임 | 인증 토큰 | 사용자가 로그인하여 Office 365 계정을 Alvao 계정과 연결할 수 있습니다. | ef5fa233-c0bb-424e-b9dc-0466d46bade2 |
...
>데이터는 Microsoft Azure 클라우드에 저장됩니다. 데이터는 고위 경영진의 승인을 받아 디버깅 목적으로 엔지니어가 볼 수 있습니다. 데이터에 대한 액세스는 내부 VPN을 통해 제어됩니다.
...
<iframe height='1020' title='Microsoft Cloud App Security 정보' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/36558' frameborder='no' style='width: 100%;'></iframe>

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/36558" target="_blank">새 탭에서 보기</a>
...
이 정보는 ALVAO s.r.o에서 제공되었습니다. 이 앱이 인증, 권한 부여, 응용 프로그램 등록 모범 사례 및 기타 ID 기준을 처리하는 방법에 대해 설명합니다.
