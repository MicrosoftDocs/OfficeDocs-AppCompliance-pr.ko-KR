...
description: xMatters, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용할 수 있는 모든 보안 및 규정 준수 정보
...
| 회사의 웹 사이트 | [https://www.xmatters.com](https://www.xmatters.com) |
| 앱 사용 약관 | [https://www.xmatters.com/policy/terms-conditions](https://www.xmatters.com/policy/terms-conditions) |
| 앱의 핵심 기능 | 도구 모음 간 통신을 자동화하여 IT 문제 방지, 관리 및 해결 |
| 회사 본사 위치 | 미국 |
