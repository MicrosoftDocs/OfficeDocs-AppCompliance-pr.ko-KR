---
title: 채팅 앱, LLC에 의해 밝은 나를 생각 나게하기위한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/17/2021
...
description: Bright Remind Me, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/a66ea116-3ae1-495b-9f5f-b4b59f19945b" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003002" target="_blank">AppSource에서 보기</a>
...
| 앱의 핵심 기능 | 응답이 편리할 때 중요한 메시지를 미리 알림을 받습니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://brightbits.app/bright-remind-me/](https://brightbits.app/bright-remind-me/) |
...
이 정보는 Chat Apps, LLC에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직의 제어에 대해 제공되었습니다.
