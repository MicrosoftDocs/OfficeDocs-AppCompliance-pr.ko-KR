---
title: VisualSP별 VisualSP에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/08/2022
...
description: VisualSP에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://appsource.microsoft.com/product/office/WA200001426" target="_blank">AppSource에서 보기</a>
...
| 파트너 회사 이름 | VisualSP |
| 회사 웹 사이트 | [https://visualsp.com](https://visualsp.com) |
| 앱의 사용 약관 | [https://www.visualsp.com/terms-of-service](https://www.visualsp.com/terms-of-service) |
| 앱의 핵심 기능 | Microsoft 365 최종 사용자 교육 콘텐츠 및 사용자 지정 학습에 즉시 액세스 제공 |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://www.visualsp.com/products/microsoft-teams-training/](https://www.visualsp.com/products/microsoft-teams-training/) |
...
이 정보는 VisualSP에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 사용자 전자 메일 주소입니다. |
| 앱이 TLS 1.1 이상을 지원하나요? | 아니요 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 사용자 이름 및 전자 메일 주소 |
