...
| 파트너 회사 이름 | VisualSP |
| 회사의 웹 사이트 | |
| 앱 사용 약관 | [https://www.visualsp.com/terms-of-service](https://www.visualsp.com/terms-of-service) |
| 앱의 핵심 기능 | 최종 사용자 교육 Microsoft 365 사용자 지정 교육에 대한 즉각적인 액세스 제공 |
| 회사 본사 위치 |  |
| 앱 정보 페이지 | |
...
| 앱 및 추가 기능을 Microsoft 365 Microsoft 앱 외부에서 추가 Microsoft API를 사용할 Graph. 앱 또는 추가 기능에서 추가 Microsoft API를 사용하나요? |  |
