---
title: Brightidea by Brightidea에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/05/2021
...
description: Brightidea에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://appsource.microsoft.com/product/office/WA200002795" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Brightidea에서 Microsoft에 제공하는 정보:
...
| 회사 웹 사이트 | [https://brightidea.com](https://brightidea.com) |
| 앱의 사용 약관 | [https://www.brightidea.com/terms-of-use/](https://www.brightidea.com/terms-of-use/) |
| 앱의 핵심 기능 | 직원 아이디어를 수집하고 관리합니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | |
...
이 정보는 Brightidea에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
