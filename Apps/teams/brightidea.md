---
title: 브라이트 아이디어에 의해 브라이트 아이디어에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
ms.date: 04/14/2021
ms.topic: article
...
description: 브라이트아이디어, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보, CSA STAR 레지스트리의 보안/규정 준수 정보에 대한 사용 가능한 모든 보안 및 규정 준수 정보.
...
ms.locfileid: "52553289"
---
# <a name="brightidea"></a>Brightidea

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>최종 업데이트: 2021년 4월 14일</p>

* <a href="https://teams.microsoft.com/l/app/b37e415d-60f4-416d-81d6-2c5ab0b52ef6" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002795" target="_blank">앱소스에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

브라이트아이디어가 마이크로소프트에 제공한 정보:
...
| 파트너 회사 이름 | Brightidea |
| 파트너 웹사이트의 URL | [https://www.brightidea.com](https://www.brightidea.com) |
| 개인정보 처리방침의 URL | [https://www.brightidea.com/privacy/](https://www.brightidea.com/privacy/) |
| 이용 약관의 URL | [https://www.brightidea.com/terms-of-use/](https://www.brightidea.com/terms-of-use/) |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 조직에서 앱이 수집하는 데이터에 대한 제어에 대해 Brightidea에 의해 제공되었습니다.
...
>|:-------------------|:--------------------------|:--------------------------|
>| Amazon Web Services | 이메일 주소/도메인 | 아이디어 제출기를 브라이트 아이디어 계정에 Teams 일치하려면; 사용자 데이터베이스는 AWS에 있습니다. |
...
>|:--------------------------------|:---------------------|:--------------------------|
>| 브라이트 아이디어 계정에 Teams 아이디어 제출자 일치하려면 | 아니요 |  |
...
<iframe height='1020' title='Microsoft Cloud App Security 정보' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/13199' frameborder='no' style='width: 100%;'></iframe>

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/13199" target="_blank">새 탭에서 보기</a>
...
이 정보는 이 앱이 인증, 권한 부여, 응용 프로그램 등록 모범 사례 및 기타 ID 기준을 처리하는 방법에 대해 Brightidea에서 제공했습니다.
