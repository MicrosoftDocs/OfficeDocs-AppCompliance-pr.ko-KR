...
description: NE에 대해 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보
...
| 파트너 회사 이름 | NE |
| 회사의 웹 사이트 | [https://www.ne.se](https://www.ne.se) |
| 앱 사용 약관 | [https://www.ne.se/info/hj%c3%a4lp/allm%c3%a4nna-avtalsvillk...](https://www.ne.se/info/hj%c3%a4lp/allm%c3%a4nna-avtalsvillkor/fleranv%c3%a4ndare/) |
| 앱의 핵심 기능 | NE 고객이 팀 내에서 콘텐츠 서비스에 액세스할 수 있도록 하는 팀 앱입니다. 또한 사용자가 채팅에 메시지를 입력하여 NE 백과사전을 검색할 @ne 팀 메시지 확장을 추가합니다. |
| 회사 본사 위치 | 스웨덴 |
