---
title: Zavvy GmbH의 Zavvy에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: Zavvy에 사용할 수 있는 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/15562290-1f82-4829-9638-452633a217d8" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003965" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Zavvy GmbH에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | Zavvy GmbH |
| 회사 웹 사이트 | [https://www.zavvy.io](https://www.zavvy.io) |
| 앱의 사용 약관 | [https://www.zavvy.io/terms-conditions](https://www.zavvy.io/terms-conditions) |
| 앱의 핵심 기능 | Microsoft Teams 내에서 직접 사용자를 온보딩, 개발 및 연결합니다. |
| 회사 본사 위치 | 독일 |
| 앱 정보 페이지 | |
...
이 정보는 Zavvy GmbH에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 사용자 프로필 정보, 팀 정보 |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 앱이 설치된 팀의 사용자 ID, 테넌트 ID, 이름 및 ID입니다. |
...
| 개인 정보 취급 방침 URL | https://www.zavvy.io/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AppCatalog.Read.All | 위임 | 앱이 팀에 이미 설치되어 있는지 확인할 수 있도록 하려면 | [54a3aa2f-d1de-4565-800e-82f950e26306](../azure/54a3aa2f-d1de-4565-800e-82f950e26306.md) |
>| Channel.Create | 응용 프로그램 | 조직의 사용자에게 그룹 메시지를 보내야 하는 경우에 대비하여 채널을 만들 수 있습니다. | [54a3aa2f-d1de-4565-800e-82f950e26306](../azure/54a3aa2f-d1de-4565-800e-82f950e26306.md) |
>| ChannelMember.ReadWrite.All | 응용 프로그램 | 사용자 및 채널에 메시지를 보내려면  | [54a3aa2f-d1de-4565-800e-82f950e26306](../azure/54a3aa2f-d1de-4565-800e-82f950e26306.md) |
>| Group.Read.All | 응용 프로그램 | 관리자가 앱을 설치할 팀을 선택할 수 있도록 테넌트에 있는 모든 팀을 나열합니다. | [54a3aa2f-d1de-4565-800e-82f950e26306](../azure/54a3aa2f-d1de-4565-800e-82f950e26306.md) |
>| TeamMember.Read.All | 응용 프로그램 | 앱이 팀에 설치된 후 지정된 팀에서 사용자 및 Bot Framework ID를 찾으려면 | [54a3aa2f-d1de-4565-800e-82f950e26306](../azure/54a3aa2f-d1de-4565-800e-82f950e26306.md) |
>| TeamsAppInstallation.ReadWriteForTeam.All | 응용 프로그램 | 팀에 Zavvy Microsoft Teams 앱을 설치하려면 | [54a3aa2f-d1de-4565-800e-82f950e26306](../azure/54a3aa2f-d1de-4565-800e-82f950e26306.md) |
