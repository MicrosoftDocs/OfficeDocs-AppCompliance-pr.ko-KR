---
title: Captivate IO Ltd의 Captivate 허브에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/14/2021
...
description: CSA STAR 레지스트리의 Captivate 허브, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용 가능한 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/0ea8ef28-454a-4796-84dc-06c775639565" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003575" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Captivate IO Ltd에서 Microsoft에 제공한 정보:

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 이름 | The Captivate Hub |
| ID | WA200003575 |
| Office 365 클라이언트 지원 | Microsoft Teams |
| 파트너 회사 이름 | Captivate IO Ltd |
| 회사의 웹 사이트 | [https://captivat.io](https://captivat.io) |
| 앱 사용 약관 | [https://captivat.io/tos](https://captivat.io/tos) |
| 앱의 핵심 기능 | Captivate Hub는 여러 채널에서 인간/컴퓨터 대화를 지원하도록 설계된 코드 없는 Extensible 시스템입니다. 또한 다중 공급업체 디지털 도우미와 다양한 라이브 채팅 솔루션을 지원합니다. |
| 회사 본사 위치 | 영국 및 북아일랜드 (the) |
| 앱 정보 페이지 | [https://manual.captivat.io/docs/teams](https://manual.captivat.io/docs/teams) |
| 앱을 실행하기 위해 사용되는 호스팅 환경 또는 서비스 모델은 무엇입니까? | 이아스 |
| 앱에서 어떤 호스팅 클라우드 공급자를 사용하나요? | IBMCloud |
...
이 정보는 Captivate IO Ltd에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직이 제어할 수 있는 방법에 대해 제공했습니다.
...
| 데이터베이스에 저장되는 데이터는 무엇입니까? | 테넌트 ID, Teams 그룹, 채널 그룹 및 응용 프로그램에 연결된 팀 그룹에 포함된 사용자 |
...
| 개인 정보 취급 방침 URL | https://www.captivat.io/privacy-policy/ |
