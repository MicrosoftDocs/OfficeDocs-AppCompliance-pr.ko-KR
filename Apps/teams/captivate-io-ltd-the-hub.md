...
description: Captivate 허브, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용 가능한 모든 보안 및 규정 준수 정보입니다.
...
ms.locfileid: "61537923"
---
# <a name="the-captivate-hub"></a>Captivate 허브
