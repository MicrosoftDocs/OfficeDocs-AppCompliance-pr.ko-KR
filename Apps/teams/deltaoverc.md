---
title: DELTAoverC의 DELTAoverC에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/30/2021
...
description: DELTAoverC, 해당 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/01b1eb1e-cb02-4a41-bb8d-6811bc514606" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003286" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

DELTAoverC에서 Microsoft에 제공하는 정보:
...
| 회사 웹 사이트 | [https://DELTAoverC.into](https://DELTAoverC.into) |
| 앱의 사용 약관 | [https://go.microsoft.com](https://go.microsoft.com) |
| 앱의 핵심 기능 | DELTAoverC는 변경 이니셔티브 중에 내부 리더에게 실행 가능한 팀 수준 데이터를 제공하여 조직의 변화와 변화를 지원하도록 설계되었으며, 이를 통해 변경 저항 또는 낮은 참여 영역을 효과적으로 해결할 수 있습니다. 참여 최대화 - 실시간으로 참여 점수를 추적하여 중단 기간 동안 팀이 번창할 수 있도록 합니다. 위험 및 노력 감소 - 직원 수준 데이터를 분석하여 이러한 문제가 주요 과제로 이어지기 전에 문제를 예측합니다. |
| 회사 본사 위치 | 캐나다 |
...
이 정보는 DELTAoverC에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
...
| 다음을 위해 MFA(다단계 인증)를 사용하도록 설정했습니다. | DNSManagement |
...
| 개인 정보 취급 방침 URL | https://DELTAoverC.info/terms |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.Read.All | 모두 | 모든 그룹 읽기 | [8b893db3-8c29-4983-b905-ee0b3daa6a46](../azure/8b893db3-8c29-4983-b905-ee0b3daa6a46.md) |
>| Group.ReadWrite.All | 모두 | 모든 그룹 읽기 및 쓰기 | [8b893db3-8c29-4983-b905-ee0b3daa6a46](../azure/8b893db3-8c29-4983-b905-ee0b3daa6a46.md) |
>| User.Read | 위임 | 로그인 및 사용자 프로필 읽기 | [8b893db3-8c29-4983-b905-ee0b3daa6a46](../azure/8b893db3-8c29-4983-b905-ee0b3daa6a46.md) |
>| User.Read.All | 응용 프로그램 | 모든 사용자 전체 프로필 읽기 | [8b893db3-8c29-4983-b905-ee0b3daa6a46](../azure/8b893db3-8c29-4983-b905-ee0b3daa6a46.md) |
...
>| User.ReadWrite.All | 모두 | 모든 사용자 전체 프로필 읽기 및 쓰기 | [8b893db3-8c29-4983-b905-ee0b3daa6a46](../azure/8b893db3-8c29-4983-b905-ee0b3daa6a46.md) |
