...
description: CSA STAR 레지스트리의 텍스트, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용 가능한 모든 보안 및 규정 준수 정보입니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.ReadWrite.All | 위임 | 텍스트 BOT의 경우 인바운드 문자 메시지에 대한 향후 채널을 만들기 위한 팀 식별자를 캡처합니다. | [a622ceb4-b6e2-4557-8218-e22e80975ba4](../azure/a622ceb4-b6e2-4557-8218-e22e80975ba4.md) |
