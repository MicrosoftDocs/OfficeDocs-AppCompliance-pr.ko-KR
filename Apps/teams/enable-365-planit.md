---
title: 365를 사용하도록 설정하여 PlanIt에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/11/2022
...
description: PlanIt, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
ms.locfileid: "66765154"
---
# <a name="planit"></a>PlanIt

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2022년 7월 7일</p>

* <a href="https://teams.microsoft.com/l/app/49cd11e3-cd7c-422a-9e2c-98a0a40fa418" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004211" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Microsoft에 365 사용에서 제공하는 정보:
...
| 파트너 회사 이름 | 365 사용 |
| 회사 웹 사이트 | [https://www.enable.no](https://www.enable.no) |
| 앱의 사용 약관 | [https://www.enable.no/standard-contract-enable-planit-for-m...](https://www.enable.no/standard-contract-enable-planit-for-microsoft-store/) |
| 앱의 핵심 기능 | 연간 계획에 사용하기 쉬운 도구입니다. Planner에 연결된 원형 달력의 멋진 시각적 보기입니다.  |
| 회사 본사 위치 | 노르웨이 |
| 앱 정보 페이지 | [https://appsource.microsoft.com/en-us/product/office/WA2000...](https://appsource.microsoft.com/en-us/product/office/WA200004211) |
...
이 정보는 Enable 365에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 사용자 프로필 데이터, SharePoint 목록 및 Teams 일정 |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 사용자 및 Teams 라이선스 데이터 |
| 기본 침입이 Microsoft 고객 데이터를 처리하거나 저장하는 경우 이 데이터는 지리적으로 저장되는 위치는 어디인가요? | 아일랜드, 노르웨이 |
...
| 다음을 위해 MFA(다단계 인증)를 사용하도록 설정했습니다. | 자격 증명, CodeRepositories |
...
| 개인 정보 취급 방침 URL | https://www.enable.no/eighteen/enable-privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.ReadBasic.All | 위임 | 현재 사용자 식별 | [49cd11e3-cd7c-422a-9e2c-98a0a40fa418](../azure/49cd11e3-cd7c-422a-9e2c-98a0a40fa418.md) |
>| offline_access | 위임 | Teams 데이터 | [49cd11e3-cd7c-422a-9e2c-98a0a40fa418](../azure/49cd11e3-cd7c-422a-9e2c-98a0a40fa418.md) |
>| openid | 위임 | SSO | [49cd11e3-cd7c-422a-9e2c-98a0a40fa418](../azure/49cd11e3-cd7c-422a-9e2c-98a0a40fa418.md) |
>| 프로필 | 위임 | 현재 사용자 식별 | [49cd11e3-cd7c-422a-9e2c-98a0a40fa418](../azure/49cd11e3-cd7c-422a-9e2c-98a0a40fa418.md) |
