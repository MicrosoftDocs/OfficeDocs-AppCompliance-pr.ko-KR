...
description: TAMPLO, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보
...
| 파트너 회사 이름 | ITYSS |
| 회사의 웹 사이트 | [https://www.tamplo.com](https://www.tamplo.com) |
| 앱 사용 약관 | [https://www.tamplo.com/en/terms-conditions](https://www.tamplo.com/en/terms-conditions) |
| 앱의 핵심 기능 | TAMPLO는 모임을 작업 계획에 연결합니다. 온라인으로 모임을 준비하고 모든 팀원과 명확한 로드맵을 공유합니다. |
| 회사 본사 위치 | 프랑스 |
| 앱 정보 페이지 | [https://www.tamplo.com/en/user-guide/User-Guide.pdf](https://www.tamplo.com/en/user-guide/User-Guide.pdf) |
...
| 개인 정보 취급 방침 URL | https://www.tamplo.com/en/privacy-policy |
