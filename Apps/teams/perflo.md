...
description: Perflo, 데이터 처리 정책, CSA STAR 레지스트리의 Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보에 대해 사용할 수 있는 모든 보안 및 규정 준수 정보
...
* <a href="https://teams.microsoft.com/l/app/abce776c-943c-4f4b-9f8b-53aa73af701e" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003721" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Perflo에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | Perflo |
| 회사의 웹 사이트 | [https://www.perflo.co](https://www.perflo.co) |
| 앱 사용 약관 | [https://www.perflo.co/terms](https://www.perflo.co/terms) |
| 앱의 핵심 기능 | 팀에 마이크로 설문 조사를 보내고 관리자를 위한 보고서를 생성합니다. |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://www.perflo.co](https://www.perflo.co) |
...
이 정보는 Perflo에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직에서 제공하는 컨트롤에 대해 제공됩니다.
...
| 데이터베이스에 저장되는 데이터는 무엇입니까? | 채널, Teams, 사용자 프로필 이름, 프로필 사진, MS Teams ID |
...
| 개인 정보 취급 방침 URL | https://www.perflo.co/privacy |
