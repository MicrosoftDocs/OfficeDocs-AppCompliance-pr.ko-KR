---
title: Foxit Software Incorporated의 Foxit PDF 편집기 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: Foxit PDF 편집기, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보에 사용할 수 있는 모든 보안 및 규정 준수 정보입니다.
...
ms.locfileid: "66249782"
---
# <a name="foxit-pdf-editor"></a>Foxit PDF 편집기

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2021년 8월 19일</p>

* <a href="https://teams.microsoft.com/l/app/959a79dd-69d0-4d05-b9a8-b9f02e28c049" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003703" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Microsoft에 통합된 Foxit Software에서 제공하는 정보:
...
| 파트너 회사 이름 | Foxit 소프트웨어 통합됨 |
| 회사 웹 사이트 | [https://www.foxit.com](https://www.foxit.com) |
| 앱의 사용 약관 | [https://www.foxit.com/product/terms-of-service.html](https://www.foxit.com/product/terms-of-service.html) |
| 앱의 핵심 기능 | Microsoft Teams용 Foxit PDF 편집기를 사용하면 Microsoft Teams: 1.Secure 공동 작업-PDF 공유 및 채널의 모든 사용자와 공동 작업, Microsoft SharePoint의 모든 사용자와 공동 작업, 2.고품질 보기&#65307; 한 드라이브에서 문서를 저장하지 않고도 문서로 더 많은 작업을 수행할 수 있습니다. Microsoft Teams&#65307; 3.텍스트 태그를 통해 문서에 대한 PDF-Provide 피드백에 주석을 달고 PDF 도구에 주석을 추가합니다. |
| 회사 본사 위치 | 중국 |
| 앱 정보 페이지 | |
...
이 정보는 Foxit Software Incorporated에서 제공되었습니다. 이 앱은 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어할 수 있습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | 전자 메일 및 사용자 이름 |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | 전자 메일, 사용자 이름, 사용자 ID |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite.All | 위임 | 사용자 문서를 읽고 문서를 저장합니다. | [959a79ddd-69d0-4d05-b9a8-b9f02e28c049](../azure/959a79dd-69d0-4d05-b9a8-b9f02e28c049.md) |
