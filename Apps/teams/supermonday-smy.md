---
title: Supermonday별 Smy에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/29/2022
...
description: Smy에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/2858d81b-9eb1-4ba1-a79b-b42390bb0015" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004190" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Supermonday에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | 슈퍼먼데이 |
| 회사 웹 사이트 | [https://supermonday.io](https://supermonday.io) |
| 앱의 사용 약관 | [https://supermonday.io/conditions-generales-de-vente](https://supermonday.io/conditions-generales-de-vente) |
| 앱의 핵심 기능 | Smy l'application de Supermonday pour Microsoft Teams |
| 회사 본사 위치 | 프랑스 |
| 앱 정보 페이지 | |
...
이 정보는 Supermonday에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.

| **정보** | **응답** |
|:----------------|:-------------|
| 앱 또는 기본 인프라가 Microsoft 고객 또는 해당 디바이스와 관련된 데이터를 처리하나요? | 예 |
| 앱에서 처리되는 데이터는 무엇인가요? | Microsoft 사용자, Microsoft 그룹, Outlook 일정 가용성 |
| 앱이 TLS 1.1 이상을 지원하나요? | 예 |
| 앱 또는 기본 인프라가 Microsoft 고객 데이터를 저장하나요? | 예 |
| 데이터베이스에 저장되는 데이터는 무엇인가요? | Microsoft 사용자, Microsoft 그룹 |
...
| 개인 정보 취급 방침 URL | https://supermonday.io/politique-de-confidentialite |
