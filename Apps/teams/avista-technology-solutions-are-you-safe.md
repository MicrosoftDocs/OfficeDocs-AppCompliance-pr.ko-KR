---
title: Avista 기술 솔루션에 금고 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/21/2022
...
description: CSA STAR 레지스트리에서 사용 가능한 모든 보안 및 규정 준수 금고, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 보안/규정 준수 정보
...
ms.locfileid: "64463902"
---
# <a name="are-you-safe"></a>현재 금고?

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>개발자가 마지막으로 업데이트한 날짜: 2021년 12월 2일</p>

* <a href="https://teams.microsoft.com/l/app/884e521a-dadc-41e9-a8af-fcaa907e783e" target="_blank">저장소의 Teams 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003863" target="_blank">AppSource의 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Avista 기술 솔루션에서 Microsoft에 제공하는 정보:
...
| 파트너 회사 이름 | Avista Technology Solutions |
| 회사의 웹 사이트 | [https://safetybot.in](https://safetybot.in) |
| 앱 사용 약관 | [https://safetybot.in/terms.html](https://safetybot.in/terms.html) |
| 앱의 핵심 기능 | &quot;AreYouSafe?&quot; bot은 개인 설정 위기 관리 도우미입니다. 안전 관리자 및 HR 담당자가 비상 시 설정 및 사용하기에 이상적입니다.  이 앱을 사용하기 위해 다른 소프트웨어나 서비스가 필요하지 않습니다. 봇은 사용하기 쉬우며 위기 전반에 걸쳐 Teams 앱과 외부 앱을 교환할 필요 없이 사용할 수 있습니다.  봇을 사용하여 주요 인시던트의 영향을 받는 직원의 상태를 알 수 있습니다. &quot;AreYouSafe?&quot; bot은 실시간 업데이트를 제공하여 필요한 사용자에게 지원을 제공합니다. |
| 회사 본사 위치 | 인도 |
| 앱 정보 페이지 | [https://safetybot.in](https://safetybot.in) |
...
이 정보는 Avista Technology Solutions에서 이 앱이 조직 데이터를 수집하고 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직이 가지는 컨트롤에 대해 제공됩니다.
