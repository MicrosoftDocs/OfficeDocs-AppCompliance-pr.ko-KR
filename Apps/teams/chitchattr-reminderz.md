---
title: 치트챗트르의 미리 알림 에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
ms.date: 12/09/2020
ms.topic: article
...
description: 미리 알림에 대한 사용 가능한 모든 보안 및 규정 준수 정보 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보, CSA STAR 레지스트리의 보안/규정 준수 정보.
...
<p>최종 업데이트: 2020년 12월 9일</p>

* <a href="https://teams.microsoft.com/l/app/672c12b8-883e-4138-8318-224420bdafe8" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001976" target="_blank">앱소스에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

ChitChattr에서 마이크로소프트에 제공 하는 정보:
...
| 파트너 웹사이트의 URL | [https://www.chitchattr.com?p=reminderz](https://www.chitchattr.com?p=reminderz) |
| Teams 응용 프로그램 정보 페이지의 URL | [https://www.chitchattr.com/reminderz/](https://www.chitchattr.com/reminderz/) |
| 개인정보 처리방침의 URL | [https://www.chitchattr.com/privacy?p=reminderz](https://www.chitchattr.com/privacy?p=reminderz) |
| 이용 약관의 URL | [https://www.chitchattr.com/termsofuse?p=reminderz](https://www.chitchattr.com/termsofuse?p=reminderz) |
...
이 정보는 ChitChattr에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대한 조직이 가질 수 있는 제어에 대해 제공했습니다.
...
>|:--------------------------------|:---------------------|:--------------------------|
>| 메시지를 보낸 사용자의 이름을 미리 알림에 표시하기 위해 사용자 이름이 검색됩니다.  | 사용자 표시 이름 | 라이선스 쿼리를 위해 식별을 위해 이름이 저장됩니다(사용자가 라이선스에 문의하는 경우 현재 라이선스가 부여된 사용자를 결정해야 합니다).  |
...
>Azure 호스팅 서비스(Mongo Atlas 포함)만 사용하며 이러한 서비스의 데이터를 완전히 제어할 수 있습니다.
...
이 정보는 이 앱이 인증, 승인, 응용 프로그램 등록 모범 사례 및 기타 ID 기준을 처리하는 방법에 대해 ChitChattr에서 제공했습니다.
