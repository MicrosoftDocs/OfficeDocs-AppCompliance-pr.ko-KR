...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 위임 | 전자 메일 주소 및 사용자의 ID.  사용자를 WorkBoard의 사용자 ID에 매핑하는 데 사용됩니다. | [User.Read](https://docs.microsoft.com/microsoft-365-app-certification/azure/User.Read) |
