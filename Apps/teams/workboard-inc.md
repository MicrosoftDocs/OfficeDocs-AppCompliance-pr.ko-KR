---
title: Workboard Inc.의 Workboard에 대한 응용 프로그램 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/21/2021
...
| 회사의 웹 사이트 | [https://www.workboard.com](https://www.workboard.com) |
| 앱 사용 약관 | [https://www.workboard.com/license/terms_of_use_v1.php](https://www.workboard.com/license/terms_of_use_v1.php) |
| 앱의 핵심 기능 | 조직을 통해 전략적 우선 순위를 조정하고 목표 및 주요 결과(확인자)를 기능 간 팀 및 개인에게 지역화합니다. 주요 결과 및 성공 메트릭에 대한 차트, 계산 및 진행 상황을 공유합니다.  |
| 회사 본사 위치 | 미국 |
...
이 정보는 Workboard Inc.에서 이 앱이 조직 데이터를 수집 및 저장하는 방법 및 앱이 수집하는 데이터를 통해 조직이 하게 될 컨트롤에 대해 제공합니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 위임 | 전자 메일 주소 및 사용자의 ID.  사용자를 WorkBoard의 사용자 ID에 매핑하는 데 사용됩니다. | [User.Read](../azure/User.Read.md) |
