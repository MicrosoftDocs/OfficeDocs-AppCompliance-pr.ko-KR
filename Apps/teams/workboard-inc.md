---
title: Workboard Inc.의 Workboard에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/21/2021
...
* <a href="https://teams.microsoft.com/l/app/28d0282b-3cd2-49f0-90bb-a016843750c6" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA104381599" target="_blank">AppSource에서 보기</a>

::: zone pivot="general"

### <a name="general-information"></a>일반 정보

Workboard Inc.에서 Microsoft에 제공한 정보:
...
| 파트너 회사 이름 | Workboard Inc. |
| 회사 웹 사이트 | [https://www.workboard.com](https://www.workboard.com) |
| 앱의 사용 약관 | [https://www.workboard.com/license/terms_of_use_v1.php](https://www.workboard.com/license/terms_of_use_v1.php) |
| 앱의 핵심 기능 | 조직을 통해 전략적 우선 순위를 조정하고 목표 및 주요 결과(OKR)를 상호 기능적인 팀 및 개인에게 지역화합니다. 주요 결과 및 성공 메트릭에 대한 진행률을 차트, 계산 및 공유합니다.  |
| 회사 본사 위치 | 미국 |
| 앱 정보 페이지 | [https://www.workboard.com/microsoft/](https://www.workboard.com/microsoft/) |
...
이 정보는 Workboard Inc.에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
...
| 가장 최근 SOC1 인증 날짜 | 2020-07-31 |
| 앱이 서비스 조직 컨트롤(SOC 2)을 준수하나요? | 예 |
| 가장 최근 SOC2 인증 날짜 | 2020-10-30 |
...
| 지원되는 정책 유형 나열 | WorkBoard는 앱 내에서 적용되는 자체 액세스 정책을 구현했습니다.  사용자의 조직, 팀 및 ID는 액세스 권한을 결정하는 데 사용됩니다. |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 위임 | 전자 메일 주소 및 사용자의 ID입니다.  사용자를 WorkBoard의 사용자 ID에 매핑하는 데 사용됩니다. | [](../azure/.md) |
