---
title: Neelix.IO Neelix.Team에 대한 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Neelix.Team에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/bed170ee-dbd7-4efa-b48e-b0937ded1689" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003047" target="_blank">AppSource에서 보기</a>
...
| 파트너 회사 이름 | Neelix.IO |
| 회사 웹 사이트 | [https://www.neelix.team](https://www.neelix.team) |
| 앱의 사용 약관 | [https://www.neelix.io/terms-of-use-en](https://www.neelix.io/terms-of-use-en) |
| 앱의 핵심 기능 | Neelix 플랫폼은 피드백 루프를 전체 주기로 관리합니다. 사용자는 진행 중인 경험, 회고 피드백 및 감정을 팀의 업무 일지에 채널링할 수 있습니다. |
| 회사 본사 위치 | 오스트레일리아 |
...
이 정보는 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 제어하는 방법에 대한 Neelix.IO 제공되었습니다.
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | 위임 | 앱은 MS Treams에서 피드백을 보낼 때 기본 기본 설정을 관리하는 사용자에게 편의를 제공하기 위해 채널 ID 및 이름을 사용합니다. | [6996cad6-a969-487a-9182-f4dc4c6c8803](../azure/6996cad6-a969-487a-9182-f4dc4c6c8803.md) |
>| Team.ReadBasic.All | 위임 | 앱은 MS Treams에서 피드백을 보낼 때 기본 기본 설정을 관리하는 사용자에게 편의를 제공하기 위해 팀 ID 및 이름을 사용합니다. | [6996cad6-a969-487a-9182-f4dc4c6c8803](../azure/6996cad6-a969-487a-9182-f4dc4c6c8803.md) |
>| 전자 메일 | 위임 | 전자 메일은 Neelix 내에서 사용자 등록의 일부로 사용됩니다. 초기 등록 후에는 알림에 전자 메일이 사용됩니다.  | [6996cad6-a969-487a-9182-f4dc4c6c8803](../azure/6996cad6-a969-487a-9182-f4dc4c6c8803.md) |
>| offline_access | 위임 | 새로 고침 토큰을 가져오는 데 사용됩니다. | [6996cad6-a969-487a-9182-f4dc4c6c8803](../azure/6996cad6-a969-487a-9182-f4dc4c6c8803.md) |
...
>| User.Read | 위임 | 봇 앱은 Neelix 핵심 플랫폼이 사용자를 식별할 수 있도록 정보 사용자를 보낼 수 있도록 user.read를 사용합니다. | [bed170ee-dbd7-4efa-b48e-b0937ded1689](../azure/bed170ee-dbd7-4efa-b48e-b0937ded1689.md) |
