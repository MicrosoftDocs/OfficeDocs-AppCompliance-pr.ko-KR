---
title: Vizito BV의 Vizito 애플리케이션 정보
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/15/2022
...
description: Vizito에 사용 가능한 모든 보안 및 규정 준수 정보, 데이터 처리 정책, Microsoft Cloud App Security 앱 카탈로그 정보 및 CSA STAR 레지스트리의 보안/규정 준수 정보입니다.
...
* <a href="https://teams.microsoft.com/l/app/b6e2ef19-7612-4ab7-a700-9669d49b88b9" target="_blank">Teams 스토어에서 보기</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003170" target="_blank">AppSource에서 보기</a>
...
| 파트너 회사 이름 | Vizito BV |
| 회사 웹 사이트 | [https://www.vizito.eu](https://www.vizito.eu) |
| 앱의 사용 약관 | [https://vizito.eu/terms-and-conditions](https://vizito.eu/terms-and-conditions) |
| 앱의 핵심 기능 | 방문자 도착에 대한 Teams 알림을 사용하여 SaaS 방문자 등록 |
| 회사 본사 위치 | 벨기에 |
| 앱 정보 페이지 | [https://www.vizito.eu](https://www.vizito.eu) |
...
이 정보는 Vizito BV에서 이 앱이 조직 데이터를 수집하고 저장하는 방법과 앱이 수집하는 데이터에 대해 조직에서 가질 컨트롤에 대해 제공되었습니다.
...
| 개인 정보 취급 방침 URL | https://vizito.eu/privacypolicy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 위임 | 사용자를 일치시켜 종료된 방문자 로그인에 대한 알림을 보냅니다. | [b6e2ef19-7612-4ab7-a700-9669d49b88b9](../azure/b6e2ef19-7612-4ab7-a700-9669d49b88b9.md) |
